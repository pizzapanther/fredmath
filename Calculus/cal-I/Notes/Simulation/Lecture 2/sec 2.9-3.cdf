...
NotebookDataLength[     38736,        892]
NotebookOptionsPosition[      6083,        134]
NotebookOutlinePosition[     39513,        904]
CellTagsIndexPosition[     39470,        901]
WindowTitle->Section 3.9, Figure 3.59
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`bValue$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0.1, 10, 0.01}, {
       Hold[
        Button[
        "\!\(TraditionalForm\`b = e\)", $CellContext`bValue$$ = E, BaseStyle -> 
     ...
     False, $CellContext`bValue$74309$$ = 
     0, $CellContext`showDerivative$74310$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`bValue$$ = 
         2, $CellContext`showDerivative$$ = False}, 
       "ControllerVariables" :> {
         Hold[$CellContext`bValue$$, $CellContext`bValue$74309$$, 0], 
         Hold[$CellContext`showDerivative$$, \
$CellContext`showDerivative$74310$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[{$CellContext`bValue$$^$CellContext`x, 
           ...
           PlotStyle -> {{Thick, Black}, {Thick, Dashed, Black}, 
             
             If[$CellContext`showDerivative$$, {Thick, $CellContext`bcR}, 
              None]}], 
          Graphics[{
            AbsolutePointSize[6], 
            Text["0", {0, 0}, {1.5, 1.5}], 
            ...
            "\!\(TraditionalForm\`y\)" == $CellContext`bValue$$^
              ...
              Sign[$CellContext`bValue$$ - 1], 1}], 
            Text[
             Row[{"slope", " = ", "ln\[ThinSpace]", $CellContext`bValue$$}], {
             Sign[$CellContext`bValue$$ - 1] 1.5, 1 + 
              Sign[$CellContext`bValue$$ - 1] Log[$CellContext`bValue$$]}, {-
              Sign[$CellContext`bValue$$ - 1], 1.5}], $CellContext`bcR, 
            If[$CellContext`showDerivative$$, 
             Text[
             "\!\(TraditionalForm\`y'\)" == $CellContext`bValue$$^
                "\!\(TraditionalForm\`x\)" 
               Row[{"ln\[ThinSpace]", $CellContext`bValue$$}], {(-4) 
               Sign[$CellContext`bValue$$ - 1], 2.75}, {-
               Sign[$CellContext`bValue$$ - 1], 1}], Black]}]}, AspectRatio -> 
         Automatic, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], AspectRatio -> Automatic, ImageSize -> 4 72, 
         PlotRange -> {-4, 4}, Ticks -> {
           Range[-3, 3], 
       ...
       "Specifications" :> {{{$CellContext`bValue$$, 2, 
         ...
         Button[
         "\!\(TraditionalForm\`b = e\)", $CellContext`bValue$$ = E, BaseStyle -> 
          11], Delimiter, {{$CellContext`showDerivative$$, False, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.9, Figure 3.59"], "Header"]}, {
   Cell[
    TextData["Section 3.9, Figure 3.59"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4806, 101, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature nJj97uwSlRxzlL#OdNMEuBEg *)
