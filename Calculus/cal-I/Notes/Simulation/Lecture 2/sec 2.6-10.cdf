...
NotebookDataLength[     38383,        882]
NotebookOptionsPosition[      5731,        124]
NotebookOutlinePosition[     39161,        894]
CellTagsIndexPosition[     39118,        891]
WindowTitle->Section 3.6, Figure 3.46
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 10, Typeset`show$$ = True, 
     ...
     Typeset`size$$ = {288., {137., 143.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$73406$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 10}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$73406$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F46[$CellContext`x], {$CellContext`x, 0, 1100}, 
           PlotStyle -> {{Thick, Black}}], 
          Graphics[{Black, 
            AbsolutePointSize[7], 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F46[$CellContext`xValue$$]}], 
            Line[{{0, 
               $CellContext`funcC3F46[$CellContext`xValue$$]}, {1100, 
               $CellContext`funcC3F46[$CellContext`xValue$$]}}], 
            Text[
             Framed[
              Pane[
              ...
              Background -> White], {50, 
              $CellContext`funcC3F46[$CellContext`xValue$$]}, {-1, -1.2}], 
            Text[
             Row[{"\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) = ", 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{452., {155., 160.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F46[
            Pattern[$CellContext`x, 
             Blank[]]] := (-0.02) $CellContext`x^2 + 50 $CellContext`x + 
           100, $CellContext`DisplayNumber[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F46[
            Pattern[$CellContext`x, 
             Blank[]]] := (-0.02) $CellContext`x^2 + 50 $CellContext`x + 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Figure 3.46"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Figure 3.46"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4454, 91, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature pI43afMUPGUFzL5QC9WtTWfF *)
