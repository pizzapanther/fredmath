...
NotebookDataLength[     38130,        880]
NotebookOptionsPosition[      5478,        122]
NotebookOutlinePosition[     38908,        892]
CellTagsIndexPosition[     38865,        889]
WindowTitle->Section 3.2, Figure 3.14
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = -4.2, Typeset`show$$ = True, 
     ...
     False, $CellContext`xValue$82467$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = -4.2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$82467$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F14[$CellContext`x], {$CellContext`x, -5, 2.5}, 
...
$CellContext`bcB, 
     ...
     Initialization:>({{$CellContext`funcC3F14[
          ...
          Attributes[Derivative] = {
           ...
           Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F14[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          0.5 (3 $CellContext`x + $CellContext`x^2/
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.2, Figure 3.14"], "Header"]}, {
   Cell[
    TextData["Section 3.2, Figure 3.14"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4201, 89, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature TJzOJ#snooTRWJ#l@6@Z8d1v *)
