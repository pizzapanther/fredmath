...
NotebookDataLength[     45607,       1029]
NotebookOptionsPosition[     12953,        271]
NotebookOutlinePosition[     46383,       1041]
CellTagsIndexPosition[     46340,       1038]
WindowTitle->Section 3.6, Figure 3.45
WindowFrame->Normal*)
...
FontSlant->\"Italic\"]\)", " = ", 
             Dynamic[100 $CellContext`hValue$$]}]}}]], 
...
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]],
     ...
     Typeset`skipInitDone$$ = False, $CellContext`hValue$73350$$ = 
     0, $CellContext`aValue$73351$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1.5, $CellContext`hValue$$ = 
         3.5}, "ControllerVariables" :> {
         Hold[$CellContext`hValue$$, $CellContext`hValue$73350$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$73351$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`resetAValue} = {1.5, False}]; Show[{
           Plot[{
             $CellContext`funcC3F45[$CellContext`x], \
(($CellContext`funcC3F45[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F45[$CellContext`aValue$$])/$CellContext`hValue$$) \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F45[$CellContext`aValue$$], 
             Derivative[
               1][$CellContext`funcC3F45][$CellContext`aValue$$] \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F45[$CellContext`aValue$$]}, {$CellContext`x, 0, 10}, 
            PlotRange -> {{-1.5, 11}, {-1, 11}}, 
            PlotStyle -> {{Thick, Black}, {
               AbsoluteThickness[1.5], 
               RGBColor[0, 0.6, 0.4]}, {Thick, $CellContext`bcR}}], 
           Graphics[{Black, 
             Text["\!\(TraditionalForm\`y = C(x)\)", {10, 
               $CellContext`funcC3F45[10]}, {1, 3}], 
             Text[
             "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]C = C(x + \
\[CapitalDelta]\[VeryThinSpace]x) - C(x)\)", {$CellContext`aValue$$ + \
$CellContext`hValue$$, ($CellContext`funcC3F45[$CellContext`aValue$$] + \
$CellContext`funcC3F45[$CellContext`aValue$$ + $CellContext`hValue$$])/
               2}, {-1.1, 0}], 
             Text[
             "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]x\)", \
{$CellContext`aValue$$ + $CellContext`hValue$$/2, 
               $CellContext`funcC3F45[$CellContext`aValue$$]}, {0, 1.5}], 
             Text["\!\(TraditionalForm\`P\)", {$CellContext`aValue$$, 
               $CellContext`funcC3F45[$CellContext`aValue$$]}, {1.5, -1.5}], 
             Text[
...
$CellContext`hValue$$]}, {-1.5, -1.5}], 
             Text[
              Framed[
               Pane[
               "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(tan\)]\\ gives\\ \
the\\ marginal\\ cost\\ C' \(\((x)\)\(.\)\)\)", {
                120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> 
               White], {(
                 10.5 - $CellContext`funcC3F45[$CellContext`aValue$$])/
                Derivative[
                1][$CellContext`funcC3F45][$CellContext`aValue$$] + \
$CellContext`aValue$$, 10.5}, {0, 0.5}], 
             Text[
              Framed[
               Pane[
               "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(sec\)]\\ gives\\ \
the\\ average\\ cost\\ \(\*FractionBox[\(\[CapitalDelta]\[VeryThinSpace]C\), \
\(\[CapitalDelta]\[VeryThinSpace]x\)]\(.\)\)\)", {
                100, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> 
               White], {(
                 7 - $CellContext`funcC3F45[$CellContext`aValue$$])/(($\
CellContext`funcC3F45[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F45[$CellContext`aValue$$])/$CellContext`hValue$$) + \
$CellContext`aValue$$, 7}, {-0.5, -0.8}], $CellContext`bcR, 
             AbsoluteThickness[1], 
...
$CellContext`hValue$$]}}], Dashed, 
             Line[{{$CellContext`aValue$$, 
                $CellContext`funcC3F45[$CellContext`aValue$$]}, {0, 
                $CellContext`funcC3F45[$CellContext`aValue$$]}}], 
...
$CellContext`hValue$$]}}], 
             ...
             Arrow[{{0, 
                $CellContext`funcC3F45[$CellContext`aValue$$ + \
$CellContext`hValue$$]}, {
               0, $CellContext`funcC3F45[$CellContext`aValue$$ + \
$CellContext`hValue$$] - 1}}], 
             ...
             Point[{$CellContext`aValue$$ + $CellContext`hValue$$, 
               $CellContext`funcC3F45[$CellContext`aValue$$ + \
$CellContext`hValue$$]}]}]}, AspectRatio -> 1, ImageSize -> 6 72, 
...
$CellContext`hValue$$], 
              "\!\(TraditionalForm\`C(x + \
\[CapitalDelta]\[VeryThinSpace]x)\)"}}}]), "Specifications" :> {
         Pane[
         "Change location of point \!\(\*\nStyleBox[\"Q\",\n\
FontSlant->\"Italic\"]\)", {100, Automatic}, 
          BaseStyle -> {
...
FontSlant->\"Italic\"]\)"}, 0.01, 4.5, 0.01, ControlType -> Slider, ImageSize -> 
         ...
         Grid[{{
            ...
            Row[{"\[CapitalDelta]\[VeryThinSpace]\!\(\*\nStyleBox[\"x\",\n\
FontSlant->\"Italic\"]\)", " = ", 
              Dynamic[100 $CellContext`hValue$$]}]}}], Delimiter, 
         Pane[
         "Change location of points \!\(\*\nStyleBox[\"P\",\n\
FontSlant->\"Italic\"]\) and \!\(\*\nStyleBox[\"Q\",\n\
FontSlant->\"Italic\"]\)", {100, Automatic}, 
...
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]},
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{583., {233., 238.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`resetAValue = 
          False, $CellContext`funcC3F45[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F45[
            Pattern[$CellContext`x, 
             Blank[]]] := 1.5 Log[$CellContext`x - 1] + 4}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Figure 3.45"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Figure 3.45"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 11676, 238, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature cIzlELkLKPtpHI#i1HDNTiUI *)
