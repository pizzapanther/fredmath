...
NotebookDataLength[     41947,        949]
NotebookOptionsPosition[      9294,        191]
NotebookOutlinePosition[     42724,        961]
CellTagsIndexPosition[     42681,        958]
WindowTitle->Section 3.2, Figure 3.13
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = -4.8, Typeset`show$$ = True, 
     ...
     False, $CellContext`xValue$82401$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = -4.8}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$82401$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F13a[$CellContext`x], {$CellContext`x, -5, 5}, 
           PlotRange -> {-2, 5}, PlotStyle -> {{Thick, Black}}], 
          Plot[
           $CellContext`funcC3F13b[$CellContext`x], {$CellContext`x, -5, 5}, 
          ...
          Graphics[{Black, 
            ...
            "\!\(TraditionalForm\`y = f(x)\)", {5, 4}, {1.5, 
             1.5}], $CellContext`bcR, 
            Text[
            "\!\(TraditionalForm\`y = f' \((x)\)\)", {5, -1.25}, {1.5, -1}], 
            If[
             
             Or[$CellContext`xValue$$ < -2, -2 < $CellContext`xValue$$ < 
              0, $CellContext`xValue$$ > 0], {$CellContext`bcR, Thick, 
              Line[{{$CellContext`xValue$$, 
                  $CellContext`funcC3F13a[$CellContext`xValue$$]} - 
                Normalize[{1, 
                  Derivative[
                  1][$CellContext`funcC3F13a][$CellContext`xValue$$]}], \
{$CellContext`xValue$$, 
                  $CellContext`funcC3F13a[$CellContext`xValue$$]} + 
                Normalize[{1, 
                   Derivative[
            ...
            If[$CellContext`xValue$$ <= -2.1, {$CellContext`bcR, 
              Point[{$CellContext`xValue$$, 
                $CellContext`funcC3F13b[$CellContext`xValue$$]}], Black, 
              Text[
               Framed[
                Pane[
                "\!\(\*FormBox[GridBox[{\n   {\n    RowBox[{\n     \
...
TraditionalForm]\)", $CellContext`bcPBS], $CellContext`bcFO], {2.5, -1}, {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{431., {129., 134.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F13a[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{-$CellContext`x, $CellContext`x <= -2}, {$CellContext`x + 
              4, -2 <= $CellContext`x <= 0}, {
             4 - $CellContext`x/2, $CellContext`x >= 0}}], 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`funcC3F13b[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{-1, $CellContext`x <= -2.1}, {
             ...
             None, -0.1 < $CellContext`x < 0.1}, {(-1)/2, $CellContext`x >= 
              0.1}}], $CellContext`bcR = RGBColor[0.8, 0, 0.4], 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}}; {$CellContext`funcC3F13a[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{-$CellContext`x, $CellContext`x <= -2}, {$CellContext`x + 
              4, -2 <= $CellContext`x <= 0}, {
             4 - $CellContext`x/2, $CellContext`x >= 
              0}}], $CellContext`funcC3F13b[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{-1, $CellContext`x <= -2.1}, {
             None, -2.1 < $CellContext`x < -1.9}, {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.2, Figure 3.13"], "Header"]}, {
   Cell[
    TextData["Section 3.2, Figure 3.13"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8017, 158, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature SJ4zS1koBPvyxK5#J77YofRW *)
