...
NotebookDataLength[     41720,        945]
NotebookOptionsPosition[      9421,        195]
NotebookOutlinePosition[     42497,        957]
CellTagsIndexPosition[     42454,        954]
WindowTitle->Section 3.8, Exercise 80
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`c$$ = 1, $CellContext`k$$ = 
     1, $CellContext`showEllipseTangents$$ = 
     False, $CellContext`showParabolaTangents$$ = False, Typeset`show$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold[
        ...
        "\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)"}, 0.1, 4}, {
       Hold[
        Row[{
          Manipulate`Place[2]}]], Manipulate`Dump`ThisIsNotAControl}, {
       Hold["Show tangent lines"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`showParabolaTangents$$], False, 
        "\!\(TraditionalForm\`y = c\\ \*SuperscriptBox[\(x\), \(2\)]\)"}, {
       True, False}}, {{
        Hold[$CellContext`showEllipseTangents$$], False, 
        "\!\(TraditionalForm\`\*SuperscriptBox[\(x\), \(2\)] + 2 \
\*SuperscriptBox[\(y\), \(2\)] = k\)"}, {True, False}}}, Typeset`size$$ = {
     288., {143., 149.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`c$74018$$ = 
     0, $CellContext`k$74019$$ = 
     0, $CellContext`showParabolaTangents$74020$$ = 
     False, $CellContext`showEllipseTangents$74021$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`c$$ = 1, $CellContext`k$$ = 
         1, $CellContext`showEllipseTangents$$ = 
         False, $CellContext`showParabolaTangents$$ = False}, 
       "ControllerVariables" :> {
         Hold[$CellContext`c$$, $CellContext`c$74018$$, 0], 
         Hold[$CellContext`k$$, $CellContext`k$74019$$, 0], 
         Hold[$CellContext`showParabolaTangents$$, \
$CellContext`showParabolaTangents$74020$$, False], 
         Hold[$CellContext`showEllipseTangents$$, \
$CellContext`showEllipseTangents$74021$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          ParametricPlot[{$CellContext`x, $CellContext`c$$ $CellContext`x^2}, \
{$CellContext`x, -2, 2}, PlotStyle -> {Thick, Black}], 
          
          ParametricPlot[{$CellContext`k$$^Rational[1, 2] 
            Cos[$CellContext`\[Theta]], ($CellContext`k$$/2)^Rational[1, 2] 
            Sin[$CellContext`\[Theta]]}, {$CellContext`\[Theta], 0, 2 Pi}, 
           PlotStyle -> {{Thick, $CellContext`bcR}}], 
          
          Plot[{((2 $CellContext`c$$) ((-1 + (
                   1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
                  Rational[1, 2])/(4 $CellContext`c$$^2))^
               Rational[
                1, 2]) ($CellContext`x - ((-1 + (
                  1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
                 Rational[1, 2])/(4 $CellContext`c$$^2))^
              Rational[
               1, 2]) + (-1 + (1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
               Rational[1, 2])/(
             4 $CellContext`c$$), ((
               2 $CellContext`c$$) (-((-1 + (
                    1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
                ...
                Rational[
                 1, 2])) ($CellContext`x + ((-1 + (
                  ...
                  Rational[1, 2])/(4 $CellContext`c$$^2))^
               Rational[1, 2]) + (-1 + (
                1 + (8 $CellContext`c$$^2) $CellContext`k$$)^Rational[1, 2])/(
             4 $CellContext`c$$)}, {$CellContext`x, -2, 2}, PlotStyle -> 
           If[$CellContext`showParabolaTangents$$, {{Thick, 
               Lighter[$CellContext`bcB, 0.7]}}, None]], 
          ...
          Plot[{((-1)/((
             ...
             4 $CellContext`c$$), ((-1)/((
               ...
               Rational[1, 2]) + (-1 + (
                1 + (8 $CellContext`c$$^2) $CellContext`k$$)^Rational[1, 2])/(
             4 $CellContext`c$$)}, {$CellContext`x, -2, 2}, PlotStyle -> 
           If[$CellContext`showEllipseTangents$$, {{Thick, 
               Lighter[$CellContext`bcB, 0.7]}}, None]], 
          Graphics[{$CellContext`bcB, 
            AbsolutePointSize[7], 
            
            Point[{((-1 + (1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
                 Rational[1, 2])/(4 $CellContext`c$$^2))^
              Rational[
               1, 2], (-1 + (1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
                Rational[1, 2])/(4 $CellContext`c$$)}], 
            ...
            Point[{-((-1 + (1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
               ...
               Rational[
                1, 2], (-1 + (1 + (8 $CellContext`c$$^2) $CellContext`k$$)^
                Rational[1, 2])/(4 $CellContext`c$$)}]}]}, 
         PlotRange -> {{-2, 2}, {-2, 2}}, ImageSize -> 4 72, 
         BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.04}], Ticks -> {
           Range[-2, 2], 
           Range[-2, 2]}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}], 
       "Specifications" :> {{{$CellContext`c$$, 1, 
           "\!\(\*\nStyleBox[\"c\",\nFontSlant->\"Italic\"]\)"}, -4., 4., 
          Exclusions -> {0.}, ControlType -> Slider, ImageSize -> Small, 
          ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], {{$CellContext`k$$, 1, 
           "\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)"}, 0.1, 4, 
          ControlType -> Slider, ImageSize -> Small, ControlPlacement -> 2}, 
         Row[{
           Manipulate`Place[2]}], Delimiter, 
         "Show tangent lines", {{$CellContext`showParabolaTangents$$, False, 
           "\!\(TraditionalForm\`y = c\\ \*SuperscriptBox[\(x\), \(2\)]\)"}, {
          True, False}, ControlType -> 
          Checkbox}, {{$CellContext`showEllipseTangents$$, False, 
           "\!\(TraditionalForm\`\*SuperscriptBox[\(x\), \(2\)] + 2 \
\*SuperscriptBox[\(y\), \(2\)] = k\)"}, {True, False}, ControlType -> 
          Checkbox}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{430., {161., 166.}},
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.8\"", "\", Exercise \"", "\"80\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.8, Exercise 80"], "Header"]}, {
   Cell[
    TextData["Section 3.8, Exercise 80"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8144, 162, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 9Ljj8skv9yVObIO56u296NOO *)
