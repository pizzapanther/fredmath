...
NotebookDataLength[     40136,        919]
NotebookOptionsPosition[      7479,        161]
NotebookOutlinePosition[     40913,        931]
CellTagsIndexPosition[     40870,        928]
WindowTitle->Section 3.10, Figure 3.66
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`angle$$ = 0, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`angle$$], 0, "plot inverse secant"}, 0, 
       3.1115926535897933`}}, Typeset`size$$ = {288., {144., 149.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`angle$74665$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`angle$$ = 0}, 
       "ControllerVariables" :> {
         Hold[$CellContext`angle$$, $CellContext`angle$74665$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           Sec[$CellContext`x], {$CellContext`x, 0.01, Pi}, 
           PlotStyle -> {Thick, $CellContext`bcR}, Exclusions -> {Pi/2}, 
           ExclusionsStyle -> {{Dashed, Gray}}], 
          
          Plot[$CellContext`x, {$CellContext`x, -3, 3}, 
           PlotStyle -> {Thick, $CellContext`bcG}], 
          ParametricPlot[{
            Sec[$CellContext`t], $CellContext`t}, {$CellContext`t, 
            0.01, $CellContext`angle$$ + 0.02}, 
           PlotStyle -> {Thick, $CellContext`bcB}, Exclusions -> {Pi/2}], 
          
          ParametricPlot[{{$CellContext`var, Pi/2}}, {$CellContext`var, -4, 
            4}, PlotStyle -> {{Dashed, Gray}}], 
          Graphics[{$CellContext`bcG, 
            Text["\!\(TraditionalForm\`y = x\)", {2, 2}, {-1.5, 1}], 
            AbsolutePointSize[6], $CellContext`bcR, 
            Point[{$CellContext`angle$$, 
              Sec[$CellContext`angle$$]}], 
            Text[
            "\!\(TraditionalForm\`y = sec\\ x\)", {1.25, 2.5}, {-1, 
             0}], $CellContext`bcB, 
            Point[{
              Sec[$CellContext`angle$$], $CellContext`angle$$}], 
            Text[
            "\!\(TraditionalForm\`\(TraditionalForm\`y = \
\*SuperscriptBox[\(sec\), \(-1\)] x\)\)", {2, 0.5}, {-1, -1}], Gray, 
            Arrowheads[0.04], 
            EdgeForm[$CellContext`bcR], 
            Opacity[0.5], 
            Lighter[$CellContext`bcR], 
            Rectangle[{0, -0.08}, {$CellContext`angle$$, 0.}], 
            If[Abs[$CellContext`angle$$] != 0, 
             Rectangle[{1, 0}, {
               If[$CellContext`angle$$ > Pi/2, 4, 
                Sec[$CellContext`angle$$]], 0.07}], 
             Lighter[$CellContext`bcR]], 
            If[Abs[$CellContext`angle$$] != 0, 
             Rectangle[{-4, 0}, {
               If[$CellContext`angle$$ > Pi/2, 
                Sec[$CellContext`angle$$], -4], 0.07}], 
             Lighter[$CellContext`bcR]], 
            ...
            If[Abs[$CellContext`angle$$] != 0, 
             Rectangle[{-0.07, -4}, {0., 
               If[$CellContext`angle$$ > Pi/2, 
                Sec[$CellContext`angle$$], -4]}], 
             Lighter[$CellContext`bcR]], 
            Rectangle[{0, 0}, {0.1, $CellContext`angle$$}], Black, 
            Opacity[1], 
            Text[
             Framed[
              Pane[
              "Domain of \!\(TraditionalForm\`\*SuperscriptBox[\(sec\), \
\(-1\)] x\): \!\(TraditionalForm\`x \[LessEqual] \(-1\)\\ or\\ x \
\[GreaterEqual] 1\)\nRange of \!\(TraditionalForm\`\*SuperscriptBox[\(sec\), \
\(-1\)] x\): \!\(TraditionalForm\`0 \[LessEqual] y \[LessEqual] \[Pi]\), \
\!\(TraditionalForm\`y \[NotEqual] \*FractionBox[\(\[Pi]\), \(2\)]\)", {
               110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], {-3.1, -3.2}, {-1, -1}]}]}, AspectRatio -> 
         Automatic, PlotRange -> {{-3.2, 3.2}, {-3.2, 3.2}}, 
         Ticks -> {{-1, 1, Pi/2, Pi}, {-1, 1, Pi/2, Pi}}, ImageSize -> 4 72, 
         Method -> {"AxesInFront" -> False}, BaseStyle -> {"Text", 13}, 
         AxesStyle -> Arrowheads[{0, 0.04}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}], 
       "Specifications" :> {{{$CellContext`angle$$, 0, "plot inverse secant"},
           0, 3.1115926535897933`, ControlType -> Trigger, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.10, Figure 3.66"], "Header"]}, {
   Cell[
    TextData["Section 3.10, Figure 3.66"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 6201, 128, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature GK4NrJlIvbEdCLORwmBJNy3a *)
