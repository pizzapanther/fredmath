...
NotebookDataLength[     38639,        889]
NotebookOptionsPosition[      5987,        131]
NotebookOutlinePosition[     39417,        901]
CellTagsIndexPosition[     39374,        898]
WindowTitle->Section 3.2, Figure 3.12
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = -4.8, Typeset`show$$ = True, 
     ...
     False, $CellContext`xValue$82340$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = -4.8}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$82340$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F12[$CellContext`x], {$CellContext`x, -5, 5}, 
            ...
            If[
             ...
             Or[$CellContext`xValue$$ < -2, -2 < $CellContext`xValue$$ < 
              ...
              Line[{{$CellContext`xValue$$, 
                  $CellContext`funcC3F12[$CellContext`xValue$$]} - 
                Normalize[{1, 
                  Derivative[
                  1][$CellContext`funcC3F12][$CellContext`xValue$$]}], \
{$CellContext`xValue$$, 
                  $CellContext`funcC3F12[$CellContext`xValue$$]} + 
                Normalize[{1, 
                   Derivative[
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{431., {106., 111.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F12[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F12[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{-$CellContext`x, $CellContext`x <= -2}, {$CellContext`x + 
              4, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.2, Figure 3.12"], "Header"]}, {
   Cell[
    TextData["Section 3.2, Figure 3.12"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4710, 98, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature gIzqp7XaFk83FL#2rfkLCdgA *)
