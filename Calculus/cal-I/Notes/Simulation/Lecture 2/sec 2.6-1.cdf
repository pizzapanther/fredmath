...
NotebookDataLength[     46285,       1039]
NotebookOptionsPosition[     13631,        281]
NotebookOutlinePosition[     47061,       1051]
CellTagsIndexPosition[     47018,       1048]
WindowTitle->Section 3.6, Figure 3.34
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1.5, $CellContext`hValue$$ = 4, 
...
FontSlant->\"Italic\"]\)"}, 0.01, 4.5, 0.01}, {
       Hold[
        Grid[{{
           Spacer[15], 
           
           Row[{"\[CapitalDelta]\[VeryThinSpace]\!\(\*\nStyleBox[\"t\",\n\
FontSlant->\"Italic\"]\)", " = ", 
...
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]],
     ...
     360., {194.90625, 201.09375}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`hValue$72671$$ = 
     0, $CellContext`aValue$72672$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1.5, $CellContext`hValue$$ = 
         4}, "ControllerVariables" :> {
         Hold[$CellContext`hValue$$, $CellContext`hValue$72671$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$72672$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`resetAValue} = {1.5, False}]; Grid[{{
            Show[{
              Plot[{
                $CellContext`funcC3F34[$CellContext`x], \
(($CellContext`funcC3F34[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F34[$CellContext`aValue$$])/$CellContext`hValue$$) \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F34[$CellContext`aValue$$], 
                Derivative[
                  1][$CellContext`funcC3F34][$CellContext`aValue$$] \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F34[$CellContext`aValue$$]}, {$CellContext`x, 0, 10}, 
               PlotRange -> {{-1.5, 11}, {-1, 11}}, 
               PlotStyle -> {{Thick, Black}, {
                  AbsoluteThickness[1.5], 
                  RGBColor[0, 0.6, 0.4]}, {Thick, $CellContext`bcR}}], 
              Graphics[{Black, 
                Text["\!\(TraditionalForm\`s = f(t)\)", {10, 
                  $CellContext`funcC3F34[10]}, {1, 3}], 
                Text[
                "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]s = f(a \
+ \[CapitalDelta]\[VeryThinSpace]t) - f(a)\)", {$CellContext`aValue$$ + \
$CellContext`hValue$$, ($CellContext`funcC3F34[$CellContext`aValue$$] + \
$CellContext`funcC3F34[$CellContext`aValue$$ + $CellContext`hValue$$])/
                  2}, {-1.1, 0}], 
                Text[
                "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]t\)", \
{$CellContext`aValue$$ + $CellContext`hValue$$/2, 
                  $CellContext`funcC3F34[$CellContext`aValue$$]}, {0, 1.5}], 
...
$CellContext`hValue$$]}, {-1.5, -1.5}], 
                Text[
                 Framed[
                  ...
                  Background -> 
                  White], {(
                    10.5 - $CellContext`funcC3F34[$CellContext`aValue$$])/
                   Derivative[
                   1][$CellContext`funcC3F34][$CellContext`aValue$$] + \
$CellContext`aValue$$, 10.5}, {0, 1}], 
                Text[
                 Framed[
                  Pane[
                  "\!\(TraditionalForm\`Secant\\ lines\\ give\\ average\\ \
\(\(velocities\)\(.\)\)\)", {
                   100, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                  Background -> 
                  White], {(
                    7 - $CellContext`funcC3F34[$CellContext`aValue$$])/(($\
CellContext`funcC3F34[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F34[$CellContext`aValue$$])/$CellContext`hValue$$) + \
...
$CellContext`hValue$$]}}], Dashed, 
                Line[{{$CellContext`aValue$$, 
                   $CellContext`funcC3F34[$CellContext`aValue$$]}, {0, 
                   $CellContext`funcC3F34[$CellContext`aValue$$]}}], 
...
$CellContext`hValue$$]}}], 
                ...
                Arrow[{{0, 
                   $CellContext`funcC3F34[$CellContext`aValue$$ + \
$CellContext`hValue$$]}, {
                  0, $CellContext`funcC3F34[$CellContext`aValue$$ + \
...
\[CapitalDelta]\[VeryThinSpace]t)\)"}}}]}, {
            Framed[
             Pane[
             "\!\(TraditionalForm\`v(a) = \(\*SubscriptBox[\(lim\), \(\
\[CapitalDelta]\[VeryThinSpace]t \[Rule] 0\)]\*FractionBox[\(\[CapitalDelta]\
\[VeryThinSpace]s\), \(\[CapitalDelta]\[VeryThinSpace]t\)] = \
\(\*SubscriptBox[\(lim\), \(\[CapitalDelta]\[VeryThinSpace]t \[Rule] \
0\)]\*FractionBox[\(f \((a + \[CapitalDelta]\[VeryThinSpace]t)\) - f \
\((a)\)\), \(\[CapitalDelta]\[VeryThinSpace]t\)] = f' \((a)\)\)\)\)", \
$CellContext`bcPBS], $CellContext`bcFO, Background -> White]}}, 
          BaseStyle -> {"TR"}]), "Specifications" :> {
         Pane[
         "Change location of point \!\(\*\nStyleBox[\"Q\",\n\
FontSlant->\"Italic\"]\)", {100, Automatic}, 
          BaseStyle -> {
           ...
           "\[CapitalDelta]\[VeryThinSpace]\!\(\*\nStyleBox[\"t\",\n\
FontSlant->\"Italic\"]\)"}, 0.01, 4.5, 0.01, ControlType -> Slider, ImageSize -> 
          Small}, 
         Grid[{{
            Spacer[15], 
...
FontSlant->\"Italic\"]\)", {100, Automatic}, 
          BaseStyle -> {
           ...
           "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 1.03, 3, 
          0.005, ControlType -> Slider, ImageSize -> Small}, Delimiter, 
         Button[
         "reset location of \!\(\*\nStyleBox[\"P\",\n\
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]},
        "Options" :> {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{508., {213., 219.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`resetAValue = 
          False, $CellContext`funcC3F34[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F34[
            Pattern[$CellContext`x, 
             Blank[]]] := 1.5 Log[$CellContext`x - 1] + 4}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Figure 3.34"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Figure 3.34"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 12354, 248, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature yKj#5J8avXoeHK51WqrKl8ZH *)
