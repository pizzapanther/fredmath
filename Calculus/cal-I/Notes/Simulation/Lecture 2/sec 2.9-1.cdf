...
NotebookDataLength[     38568,        889]
NotebookOptionsPosition[      5916,        131]
NotebookOutlinePosition[     39346,        901]
CellTagsIndexPosition[     39303,        898]
WindowTitle->Section 3.9, Figure 3.57
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0, $CellContext`steps$$ = {1}, 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       1 -> "plot \!\(TraditionalForm\`f\)", 2 -> 
        ...
        Hold[$CellContext`aValue$$], 0, "x"}, -5, 5, 0.1}}, Typeset`size$$ = {
     288., {143., 149.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`steps$74169$$ = 
     False, $CellContext`aValue$74170$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0, $CellContext`steps$$ = {1}},
        "ControllerVariables" :> {
         Hold[$CellContext`steps$$, $CellContext`steps$74169$$, False], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$74170$$, 0]}, 
       "OtherVariables" :> {
          ...
          Graphics[{
            ...
            If[
             MemberQ[$CellContext`steps$$, 1], {
              ...
              "\!\(TraditionalForm\`f(x) = \*SuperscriptBox[\(e\), \(x\)]\)", \
{-4, 1.5}, {-1, 0}], $CellContext`bcR, 
              Point[{$CellContext`aValue$$, E^$CellContext`aValue$$}]}, 
             Black], Black, 
            If[
            ...
            If[
             MemberQ[$CellContext`steps$$, 3], {
              Text[
              "\!\(TraditionalForm\`\*SuperscriptBox[\(f\), \(-1\)](x) = ln\\ \
x\)", {1.5, -4}, {-1, 0}], 
              Point[{E^$CellContext`aValue$$, $CellContext`aValue$$}]}, 
             Black], 
            If[
             And[
              MemberQ[$CellContext`steps$$, 3], 
              ...
              Arrow[{{$CellContext`aValue$$, E^$CellContext`aValue$$}, {
                E^$CellContext`aValue$$, $CellContext`aValue$$}}]}, Black]}]},
          PlotRange -> {{-5, 5}, {-5, 5}}, AspectRatio -> Automatic, 
         ImageSize -> 4 72, Ticks -> {
           Range[-5, 5], 
       ...
       "Specifications" :> {{{$CellContext`steps$$, {1}, ""}, {
          1 -> "plot \!\(TraditionalForm\`f\)", 2 -> 
           "plot \!\(TraditionalForm\`y = x\)", 3 -> 
           "plot \!\(TraditionalForm\`\*SuperscriptBox[\(f\), \(-1\)]\)"}, 
          ControlType -> CheckboxBar, Appearance -> 
          "Vertical"}, {{$CellContext`aValue$$, 0, "x"}, -5, 5, 0.1, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.9, Figure 3.57"], "Header"]}, {
   Cell[
    TextData["Section 3.9, Figure 3.57"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4639, 98, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature zK4kZmntmiFekL#Y2Uk4NEAw *)
