...
NotebookDataLength[     38991,        895]
NotebookOptionsPosition[      6338,        137]
NotebookOutlinePosition[     39768,        907]
CellTagsIndexPosition[     39725,        904]
WindowTitle->Section 3.4, Figure 3.28
WindowFrame->Normal*)
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       0 -> Pane[
         "\!\(TraditionalForm\`x = 0\)", {48, Automatic}, Alignment -> 
          Center], 1 -> 
        Pane["\!\(TraditionalForm\`x = 1\)", {48, Automatic}, Alignment -> 
          Center], 3 -> 
        Pane["\!\(TraditionalForm\`x = 3\)", {48, Automatic}, Alignment -> 
          Center], 4 -> 
        Pane["\!\(TraditionalForm\`x = 4\)", {48, Automatic}, Alignment -> 
          Center], 5 -> 
        Pane["\!\(TraditionalForm\`x = 5\)", {48, Automatic}, Alignment -> 
          Center]}}}, Typeset`size$$ = {252., {129., 134.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$72104$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 3}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$72104$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F28[$CellContext`x], {$CellContext`x, -0.5, 6}, 
           PlotStyle -> {{Thick, Black}}, PlotRange -> {-5, 5}, 
           Exclusions -> {2}, ExclusionsStyle -> {{$CellContext`bcR, Dashed, 
              AbsoluteThickness[1]}}], 
          Plot[
          Derivative[
             1][$CellContext`funcC3F28][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F28[$CellContext`xValue$$], {$CellContext`x, -0.5, 6}, 
           PlotStyle -> {{Thick, $CellContext`bcR}}], 
          Graphics[{
            Text[
            "\!\(TraditionalForm\`y = \*FractionBox[\(\*SuperscriptBox[\(x\), \
\(2\)] + 1\), \(\*SuperscriptBox[\(x\), \(2\)] - 4\)]\)", {3, 5}, {-1, 
             1}], $CellContext`bcB, 
            AbsolutePointSize[7], 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F28[$CellContext`xValue$$]}], \
$CellContext`bcR, 
            Text[
             Row[{"\!\(TraditionalForm\`\(\(y\)\(=\)\(\\ \)\)\)", 
               Expand[
                Rationalize[
                Derivative[1][$CellContext`funcC3F28][$CellContext`xValue$$] (
                   "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)" - \
$CellContext`xValue$$) + $CellContext`funcC3F28[$CellContext`xValue$$]]]}], {
             3, -2}, {-1, 1}]}]}, PlotRange -> {-5, 5}, AspectRatio -> 1, 
         Ticks -> {
           Range[0, 5], 
           Range[-5, 5]}, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], ImageSize -> 3.5 72, 
         AxesLabel -> {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{344., {146., 152.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F28[
            Pattern[$CellContext`x, 
             Blank[]]] := ($CellContext`x^2 + 1)/($CellContext`x^2 - 4), 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], 
          Attributes[Derivative] = {
           NHoldAll, ReadProtected}, $CellContext`bcB = 
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F28[
            Pattern[$CellContext`x, 
             Blank[]]] := ($CellContext`x^2 + 1)/($CellContext`x^2 - 4)}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.4, Figure 3.28"], "Header"]}, {
   Cell[
    TextData["Section 3.4, Figure 3.28"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5061, 104, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature NJzaQfA2aP2j4KkTTNqOFO3A *)
