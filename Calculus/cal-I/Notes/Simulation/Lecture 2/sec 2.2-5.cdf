...
NotebookDataLength[     45968,       1045]
NotebookOptionsPosition[     13314,        287]
NotebookOutlinePosition[     46744,       1057]
CellTagsIndexPosition[     46701,       1054]
WindowTitle->Section 3.2, Figure 3.17
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`drawDerivative$$ = 
     ...
     Typeset`size$$ = {432., {212., 217.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$82635$$ = 
     0, $CellContext`showHorizontalTangents$82636$$ = 
     False, $CellContext`drawDerivative$82637$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`drawDerivative$$ = 
         False, $CellContext`showHorizontalTangents$$ = 
         False, $CellContext`xValue$$ = -2}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$82635$$, 0], 
         Hold[$CellContext`showHorizontalTangents$$, \
$CellContext`showHorizontalTangents$82636$$, False], 
         Hold[$CellContext`drawDerivative$$, \
$CellContext`drawDerivative$82637$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F17b[$CellContext`x], {$CellContext`x, -3.1, \
$CellContext`xValue$$}, Exclusions -> {-1, 1}, PlotRange -> All, PlotStyle -> {
             
             If[$CellContext`drawDerivative$$, {Thick, $CellContext`bcR}, 
              None]}], 
          Plot[
           $CellContext`funcC3F17a[$CellContext`x], {$CellContext`x, -3, 3}, 
           Exclusions -> {-1, 1}, PlotRange -> All, 
          ...
          Graphics[{Black, Dashed, 
            ...
            Line[{{$CellContext`xValue$$, -3}, {$CellContext`xValue$$, 6}}], 
            If[$CellContext`showHorizontalTangents$$, {Gray, Dashed, 
              Line[{{(-1)/3, 0}, {(-1)/3, 
                 $CellContext`funcC3F17a[(-1)/3]}}], $CellContext`bcR, 
              AbsoluteThickness[2], 
              Dashing[{}], 
              Line[{{(-4)/3, 
                 $CellContext`funcC3F17a[(-1)/3]}, {2/3, 
                 $CellContext`funcC3F17a[(-1)/3]}}], 
              Text[
               Pane[
               "\!\(TraditionalForm\`f' \((\(-\*FractionBox[\(1\), \
\(3\)]\))\) = 0\)", BaseStyle -> {Background -> White}], {(-1)/3, 
                $CellContext`funcC3F17a[(-1)/3]}, {0, -2}], 
              AbsolutePointSize[7], $CellContext`bcR, 
              Point[{{(-1)/3, 0}}], $CellContext`bcB, 
              Point[{{(-1)/3, 
                 $CellContext`funcC3F17a[(-1)/3]}}]}, Black], 
            If[
...
{$CellContext`xValue$$, 
              ...
              Point[{$CellContext`xValue$$, 
                $CellContext`funcC3F17a[$CellContext`xValue$$]}]}, Black], 
            If[$CellContext`drawDerivative$$, {
              If[
               And[$CellContext`xValue$$ != -1, $CellContext`xValue$$ != 1], {
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], {(-2)/3, -2}, {
              ...
              If[(-1)/3 < $CellContext`xValue$$ < 1, {$CellContext`bcR, 
                Text[
                 Framed[
                  Pane[
                  "\!\(TraditionalForm\`f' \((x)\) > 0\)", \
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], {2, -2}, {0, 
                ...
                Text[
                 Framed[
                  ...
                  "negative slope", $CellContext`bcPBS], $CellContext`bcFO, 
                  Background -> White], {2, 2.25}, {0, -1}]}, Black]}, 
             Black]}]}, ImageSize -> 6 72, PlotRange -> {{-3, 3}, {-3, 3}}, 
       ...
       "Specifications" :> {{{$CellContext`xValue$$, -2, 
          ...
          1}, {{$CellContext`xValue$$, -2, ""}, -3, 3, 0.01, ControlType -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{575., {229., 235.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F17b[
            Pattern[$CellContext`x, 
             Blank[]]] := (-1 - 
            3 $CellContext`x)/((-1 + $CellContext`x)^3 (
             1 + $CellContext`x)^2), 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC3F17a[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          1/(($CellContext`x + 
          ...
          If[Abs[$CellContext`num - Round[$CellContext`num, 1]] < 0.001, 
            Round[$CellContext`num, 1], $CellContext`num], $CellContext`bcB = 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}}; {$CellContext`funcC3F17a[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          1/(($CellContext`x + 
            1) ($CellContext`x - 1)^2), $CellContext`funcC3F17b[
            Pattern[$CellContext`x, 
             Blank[]]] := (-1 - 
            3 $CellContext`x)/((-1 + $CellContext`x)^3 (
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.2, Figure 3.17"], "Header"]}, {
   Cell[
    TextData["Section 3.2, Figure 3.17"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 12037, 254, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 4JNgLVRrtAHf4J5uCNdE9Meq *)
