...
NotebookDataLength[     41964,        953]
NotebookOptionsPosition[      9307,        195]
NotebookOutlinePosition[     42741,        965]
CellTagsIndexPosition[     42698,        962]
WindowTitle->Section 3.10, Figure 3.63
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.5, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], 0.5, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -0.999, 0.999, 
       0.001}, {{
        Hold[$CellContext`xValue$$], 0.5, ""}, {-0.999 -> 
        Pane["\!\(TraditionalForm\`x \[Rule] \(-\*SuperscriptBox[\(1\), \
\(+\)]\)\)", {48, Automatic}, Alignment -> Center], 0 -> 
        Pane["\!\(TraditionalForm\`x = 0\)", {48, Automatic}, Alignment -> 
          Center], 0.999 -> 
        Pane["\!\(TraditionalForm\`x \[Rule] \*SuperscriptBox[\(1\), \
\(-\)]\)", {48, Automatic}, Alignment -> Center]}}}, Typeset`size$$ = {
     360., {180., 185.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$74506$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 0.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$74506$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F63[$CellContext`x], 
            Derivative[
            1][$CellContext`funcC3F63][$CellContext`x]}, {$CellContext`x, -2, 
            2}, PlotStyle -> {{Thick, Black}, {Thick, $CellContext`bcR}}], 
          
          ParametricPlot[{{-1, $CellContext`y}, {
            1, $CellContext`y}}, {$CellContext`y, -2, 2}, 
           PlotStyle -> {{Thick, Dashed, $CellContext`bcB}}], 
          Graphics[{Gray, 
            Line[{{$CellContext`xValue$$, -2}, {$CellContext`xValue$$, 2}}], 
            Black, 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`f(x) = \*SuperscriptBox[\(sin\), \(-1\)] \
x\)", $CellContext`bcPBS], $CellContext`bcFO, Background -> 
              White], {-2, -1}, {-1, -1}], $CellContext`bcR, 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`f' \((x)\) = \*FractionBox[\(1\), \
SqrtBox[\(1 - \*SuperscriptBox[\(x\), \(2\)]\)]]\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> White], {-2, 1}, {-1, 1}], Black, 
            If[$CellContext`xValue$$ > 0.8, {
              Text[
               Framed[
                Pane[
                "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(tan\)] \[Rule] \
\(\[Infinity]\\ \\ as\\ \\ x \[Rule] \*SuperscriptBox[\(1\), \(-\)]\)\)", {
                 70, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {1, 1}, {-1.2, 1}], 
              Text[
               Framed[
                Pane[
                "\!\(TraditionalForm\`f' \((x)\) \[Rule] \(\[Infinity]\\ as\\ \
x \[Rule] \*SuperscriptBox[\(1\), \(-\)]\)\)", {
                 70, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {1, 2}, {-1.2, 1}]}, Black], 
            If[$CellContext`xValue$$ < -0.8, {
              Text[
               Framed[
                Pane[
...
\((0)\) = 1\)\)", {
                ...
                Background -> White], {0.3, 0}, {-1.2, -1}], 
              Text[
               Framed[
                Pane[
                "\!\(TraditionalForm\`f' \((0)\) = 1\)", {
                 70, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {1, 1}, {-1.2, -1}]}, Black], 
            AbsolutePointSize[7], Thick, $CellContext`bcR, 
            Line[{{$CellContext`xValue$$, 
                $CellContext`funcC3F63[$CellContext`xValue$$]} + Normalize[{1, 
                 Derivative[
                 1][$CellContext`funcC3F63][$CellContext`xValue$$]}], \
{$CellContext`xValue$$, 
                $CellContext`funcC3F63[$CellContext`xValue$$]} - Normalize[{1, 
                Derivative[
                1][$CellContext`funcC3F63][$CellContext`xValue$$]}]}], Black, 
            
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F63[$CellContext`xValue$$]}], \
$CellContext`bcR, 
            Point[{$CellContext`xValue$$, 
              Derivative[
              1][$CellContext`funcC3F63][$CellContext`xValue$$]}]}]}, 
         PlotRange -> {{-2, 2}, {-2, 2}}, AspectRatio -> 1, 
         Ticks -> {{(-Pi)/2, -1, 1, Pi/2}, {(-Pi)/2, -1, 1, Pi/2}}, 
         BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.03}], 
         ImageSize -> 5 72, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}], 
       "Specifications" :> {{{$CellContext`xValue$$, 0.5, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -0.999, 
          0.999, 0.001, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`xValue$$, 0.5, ""}, {-0.999 -> 
           Pane["\!\(TraditionalForm\`x \[Rule] \(-\*SuperscriptBox[\(1\), \
\(+\)]\)\)", {48, Automatic}, Alignment -> Center], 0 -> 
           Pane["\!\(TraditionalForm\`x = 0\)", {48, Automatic}, Alignment -> 
             Center], 0.999 -> 
           Pane["\!\(TraditionalForm\`x \[Rule] \*SuperscriptBox[\(1\), \
\(-\)]\)", {48, Automatic}, Alignment -> Center]}, ControlType -> SetterBar, 
          Appearance -> "Vertical"}}, 
       "Options" :> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F63[
            Pattern[$CellContext`x, 
             Blank[]]] := ArcSin[$CellContext`x], 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F63[
            Pattern[$CellContext`x, 
             Blank[]]] := ArcSin[$CellContext`x]}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.10, Figure 3.63"], "Header"]}, {
   Cell[
    TextData["Section 3.10, Figure 3.63"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 8029, 162, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature FJzMb1Ss9m8uxIkyqrpgnnmb *)
