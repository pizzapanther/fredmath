...
NotebookDataLength[     41284,        950]
NotebookOptionsPosition[      8631,        192]
NotebookOutlinePosition[     42061,        962]
CellTagsIndexPosition[     42018,        959]
WindowTitle->Section 3.9, Figure 3.58
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`functionChoice$$ = 
     1, $CellContext`showDerivative$$ = False, $CellContext`xValue$$ = 0, 
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`functionChoice$$], 1, ""}, {
       1 -> Pane[
         "\!\(TraditionalForm\`y = ln\\ x\)", {72, Automatic}, Alignment -> 
          Center], 2 -> 
        Pane["\!\(TraditionalForm\`y = ln\\ \[LeftBracketingBar]x\
\[RightBracketingBar]\)", {72, Automatic}, Alignment -> Center]}}, {{
        Hold[$CellContext`showDerivative$$], False, "plot derivative"}, {
       True, False}}, {
       Hold[
        Row[{
     ...
     Typeset`size$$ = {288., {143., 149.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`functionChoice$74236$$ = 
     False, $CellContext`showDerivative$74237$$ = 
     False, $CellContext`xValue$74238$$ = 0}, 
...
$CellContext`functionChoice$74236$$, False], 
         Hold[$CellContext`showDerivative$$, \
$CellContext`showDerivative$74237$$, False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$74238$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            ...
            Log[
             Abs[$CellContext`x]], 1/$CellContext`x}, {$CellContext`x, -3, 3},
            PlotRange -> {{-3, 3}, {-3, 3}}, PlotStyle -> {
             If[$CellContext`functionChoice$$ == 1, {Thick, Black}, None], 
             If[
              
              And[$CellContext`showDerivative$$, \
$CellContext`functionChoice$$ == 1], {Thick, $CellContext`bcR}, None], 
             If[$CellContext`functionChoice$$ == 2, {Thick, Black}, None], 
             If[
...
$CellContext`functionChoice$$ == 2], {Thick, $CellContext`bcR}, None]}, 
          ...
          Graphics[{
            ...
            If[$CellContext`functionChoice$$ == 1, 
             If[$CellContext`xValue$$ > 0, {Black, 
               Disk[{$CellContext`xValue$$, 
                 Log[$CellContext`xValue$$]}, 0.08]}, {White, 
               Disk[{$CellContext`xValue$$, 0}, 0.08]}], Black], 
            If[$CellContext`functionChoice$$ == 2, 
             If[$CellContext`xValue$$ != 0., {Black, 
               Disk[{$CellContext`xValue$$, 
                 Log[
                  Abs[$CellContext`xValue$$]]}, 0.08]}, {White, 
               Disk[{$CellContext`xValue$$, 0}, 0.08]}], Black], 
            EdgeForm[$CellContext`bcR], 
            If[
             
             And[$CellContext`showDerivative$$, $CellContext`functionChoice$$ == 
              1], 
             If[$CellContext`xValue$$ > 0., {Gray, 
               ...
               Disk[{$CellContext`xValue$$, 1/$CellContext`xValue$$}, 
                0.08]}, {White, 
               Disk[{$CellContext`xValue$$, 0}, 0.08]}], Black], 
            If[
             ...
             If[$CellContext`xValue$$ != 0., {Gray, 
               ...
               Disk[{$CellContext`xValue$$, 1/$CellContext`xValue$$}, 
                0.08]}, {White, 
               Disk[{$CellContext`xValue$$, 0}, 0.08]}], Black], Black, 
            If[$CellContext`functionChoice$$ == 1, 
             Text["\!\(TraditionalForm\`y = ln\\ x\)", {1.5, 1.5}, {-1, 0}], 
             Text[
             "\!\(TraditionalForm\`y = ln | x | \)", {1.5, 1.5}, {-1, 
              0}]], $CellContext`bcR, 
            If[
             ...
             And[$CellContext`showDerivative$$, $CellContext`functionChoice$$ == 
              1], 
             Text[
             "\!\(TraditionalForm\`y' = \*FractionBox[\(1\), \(x\)], \\ x > 0\
\)", {0.5, 3}, {-1, 1}], $CellContext`bcR], 
            If[
             
             And[$CellContext`showDerivative$$, $CellContext`functionChoice$$ == 
              2], 
             Text[
             "\!\(TraditionalForm\`y' = \*FractionBox[\(1\), \(x\)], \\ x \
\[NotEqual] 0\)", {-3, -2}, {-1, -1}], $CellContext`bcR]}]}, 
         PlotRange -> {{-3, 3}, {-3, 3}}, AspectRatio -> 1, ImageSize -> 4 72,
          Ticks -> {
           Range[-5, 5], 
           Range[-5, 5]}, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], 
         AxesLabel -> {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.9, Figure 3.58"], "Header"]}, {
   Cell[
    TextData["Section 3.9, Figure 3.58"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7354, 159, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature #JNhXo3gDfAGyLO#uDct80SE *)
