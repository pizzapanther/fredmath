...
NotebookDataLength[     38577,        887]
NotebookOptionsPosition[      5925,        129]
NotebookOutlinePosition[     39355,        899]
CellTagsIndexPosition[     39312,        896]
WindowTitle->Section 3.1, Figure 3.02
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.1, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["Move point along path"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xValue$$], 0.1, ""}, 0.1, 3.9, 0.01}}, 
     Typeset`size$$ = {288., {142., 146.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$71117$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 0.1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$71117$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F2[$CellContext`x], 
            Derivative[
              1][$CellContext`funcC3F2][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F2[$CellContext`xValue$$]}, {$CellContext`x, 0, 4}, 
          ...
          Graphics[{Black, 
            ...
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F2[$CellContext`xValue$$]}], \
...
{$CellContext`xValue$$, 
         ...
         None, ImageSize -> 4 72], 
       "Specifications" :> {
        "Move point along path", {{$CellContext`xValue$$, 0.1, ""}, 0.1, 3.9, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{434., {159., 164.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F2[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F2[
            Pattern[$CellContext`x, 
             Blank[]]] := (2 Sin[(Pi/2) $CellContext`x - 0.7]) 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.1, Figure 3.02"], "Header"]}, {
   Cell[
    TextData["Section 3.1, Figure 3.02"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4648, 96, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature FLzGanaTEIQPkLOKwHfife0f *)
