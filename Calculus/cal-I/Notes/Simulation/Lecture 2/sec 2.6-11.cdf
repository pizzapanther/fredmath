...
NotebookDataLength[     42569,        973]
NotebookOptionsPosition[      9916,        215]
NotebookOutlinePosition[     43346,        985]
CellTagsIndexPosition[     43303,        982]
WindowTitle->Section 3.6, Figure 3.47
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showAverage$$ = 
     True, $CellContext`showMarginal$$ = True, $CellContext`xValue$$ = 10, 
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], 10, "items"}, 10, 1000, 10}, {{
        Hold[$CellContext`xValue$$], 10, ""}, 10, 1000, 10}, {{
        Hold[$CellContext`showAverage$$], True, "show average cost"}, {
       True, False}}, {{
        Hold[$CellContext`showMarginal$$], True, "show marginal cost"}, {
       True, False}}, {
       Hold[
        Column[{
          Manipulate`Place[1], 
     ...
     576., {149., 154.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$73468$$ = 
     0, $CellContext`showAverage$73469$$ = 
     False, $CellContext`showMarginal$73470$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showAverage$$ = 
         True, $CellContext`showMarginal$$ = True, $CellContext`xValue$$ = 
         10}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$73468$$, 0], 
         Hold[$CellContext`showAverage$$, $CellContext`showAverage$73469$$, 
          False], 
         Hold[$CellContext`showMarginal$$, $CellContext`showMarginal$73470$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
         Typeset`specs$$, Typeset`size$$, Typeset`update$$, 
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> GraphicsGrid[{{
           Show[{
             Plot[
              $CellContext`funcC3F47[$CellContext`x], {$CellContext`x, 0, 
               1100}, PlotStyle -> {{Thick, Black}}], 
             Graphics[{Black, 
               AbsolutePointSize[7], 
               Point[{$CellContext`xValue$$, 
                 $CellContext`funcC3F47[$CellContext`xValue$$]}], 
               Line[{{0, 
                  $CellContext`funcC3F47[$CellContext`xValue$$]}, {1100, 
                  $CellContext`funcC3F47[$CellContext`xValue$$]}}], 
               Text[
                Framed[
                 Pane[
                 ...
                 Background -> White], {50, 
                 $CellContext`funcC3F47[$CellContext`xValue$$]}, {-1, -1.2}], 
               
               Text[
                Row[{"\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) = ", 
                  Dynamic[$CellContext`xValue$$]}], 
                Scaled[{1, 0.1}], {1, -1}]}]}, 
            PlotRange -> {{-100, 1100}, {-2000, 37000}}, Ticks -> {
              Range[0, 1000, 200], 
              Range[0, 35000, 5000]}, BaseStyle -> {"Text", 13}, ImageSize -> 
            4 72, AspectRatio -> 1, 
            AxesLabel -> {
             "\!\(TraditionalForm\`x\)", 
              "\!\(TraditionalForm\`C\\ \((cost)\)\)"}], 
           Show[{
             Plot[{$CellContext`funcC3F47[$CellContext`x]/$CellContext`x, 
               Derivative[
               1][$CellContext`funcC3F47][$CellContext`x]}, {$CellContext`x, 
               0, 1100}, PlotStyle -> {
                
                If[$CellContext`showAverage$$, {Thick, $CellContext`bcG}, 
                 None], 
                
                If[$CellContext`showMarginal$$, {Thick, $CellContext`bcR}, 
                 None]}], 
             Graphics[{$CellContext`bcG, 
               AbsolutePointSize[7], 
               If[$CellContext`showAverage$$, {
                 
                 Point[{$CellContext`xValue$$, \
$CellContext`funcC3F47[$CellContext`xValue$$]/$CellContext`xValue$$}], 
                 
                 Line[{{0, \
$CellContext`funcC3F47[$CellContext`xValue$$]/$CellContext`xValue$$}, {
                   1100, $CellContext`funcC3F47[$CellContext`xValue$$]/$\
CellContext`xValue$$}}], 
                 Text[
                  Framed[
                   Pane[
                    ...
                    Round[$CellContext`funcC3F47[$CellContext`xValue$$]/$\
CellContext`xValue$$, 0.1]}], {
                    Automatic, 
                    Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                   Background -> White], {
                  50, $CellContext`funcC3F47[$CellContext`xValue$$]/$\
CellContext`xValue$$}, {-1, -1.2}]}, Black], $CellContext`bcR, 
               If[$CellContext`showMarginal$$, {
                 Point[{$CellContext`xValue$$, 
                   Derivative[
                   1][$CellContext`funcC3F47][$CellContext`xValue$$]}], 
                 Line[{{0, 
                    Derivative[
                    1][$CellContext`funcC3F47][$CellContext`xValue$$]}, {1100, 
                    Derivative[
                    1][$CellContext`funcC3F47][$CellContext`xValue$$]}}], 
                 Text[
                  Framed[
                   ...
                   Background -> White], {50, 
                   Derivative[
                   1][$CellContext`funcC3F47][$CellContext`xValue$$]}, {-1, 
                   1.2}]}, Black]}]}, PlotRange -> {{-10, 1100}, {-10, 100}}, 
            Ticks -> {
              Range[0, 1000, 200], 
              Range[0, 100, 25]}, BaseStyle -> {"Text", 13}, ImageSize -> 
            4 72, AspectRatio -> 1, 
            AxesLabel -> {
             "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
            Method -> {"AxesInFront" -> False}]}}, ImageSize -> 8 72], 
       "Specifications" :> {{{$CellContext`xValue$$, 10, "items"}, 10, 1000, 
          10, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`xValue$$, 10, ""}, 10, 1000, 10, ControlType -> 
          Trigger, DefaultDuration -> 10, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
         Delimiter, {{$CellContext`showAverage$$, True, 
           "show average cost"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 
          1}, {{$CellContext`showMarginal$$, True, "show marginal cost"}, {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{740., {166., 172.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F47[
            Pattern[$CellContext`x, 
             Blank[]]] := (-0.02) $CellContext`x^2 + 50 $CellContext`x + 
           100, $CellContext`bcPBS = 
          BaseStyle -> {
          ...
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC3F47[
            Pattern[$CellContext`x, 
             Blank[]]] := (-0.02) $CellContext`x^2 + 50 $CellContext`x + 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Figure 3.47"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Figure 3.47"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8639, 182, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature uJzRyzmnNF#awJOZNZdPk0Dj *)
