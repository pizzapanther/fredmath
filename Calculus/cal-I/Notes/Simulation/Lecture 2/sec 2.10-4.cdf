...
NotebookDataLength[     41986,        958]
NotebookOptionsPosition[      9329,        200]
NotebookOutlinePosition[     42763,        970]
CellTagsIndexPosition[     42720,        967]
WindowTitle->Section 3.10, Figure 3.65
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.5, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -2.99, 2.99, 
       0.01}, {{
        Hold[$CellContext`xValue$$], 0.5, ""}, {-2.99 -> 
        Pane["\!\(TraditionalForm\`x \[Rule] \(-\[Infinity]\)\)", {
          48, Automatic}, Alignment -> Center], 0 -> 
        Pane["\!\(TraditionalForm\`x = 0\)", {48, Automatic}, Alignment -> 
          Center], 2.99 -> 
        Pane["\!\(TraditionalForm\`x \[Rule] \[Infinity]\)", {48, Automatic}, 
          Alignment -> Center]}}}, Typeset`size$$ = {360., {122., 128.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$74614$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 0.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$74614$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F65[$CellContext`x], 
            Derivative[
            1][$CellContext`funcC3F65][$CellContext`x]}, {$CellContext`x, -3, 
            3}, PlotStyle -> {{Thick, Black}, {Thick, $CellContext`bcR}}], 
          
          ParametricPlot[{{$CellContext`x, (-Pi)/2}, {$CellContext`x, Pi/
             2}}, {$CellContext`x, -3, 3}, 
          ...
          Graphics[{Gray, 
            ...
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`f(x) = \*SuperscriptBox[\(tan\), \(-1\)] \
x\)", $CellContext`bcPBS], $CellContext`bcFO, Background -> 
              White], {-3, -1}, {-1, -1}], $CellContext`bcR, 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`f' \((x)\) = \*FractionBox[\(1\), \(1 + \
\*SuperscriptBox[\(x\), \(2\)]\)]\)", $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], {-3, Pi/2}, {-1, 1.5}], Black, 
            If[$CellContext`xValue$$ > 1.8, {
              Text[
               Framed[
                Pane[
                "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(tan\)] \[Rule] \
\(0\\ \\ as\\ \\ x \[Rule] \[Infinity]\)\)", {
                 Automatic, 
                  Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {0.2, -0.4}, {-1, 1}], 
              Text[
               Framed[
                Pane[
                "\!\(TraditionalForm\`f' \((x)\) \[Rule] \(0\\ as\\ x \[Rule] \
\[Infinity]\)\)", {
                 Automatic, 
                  Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {0.2, 1.5}, {-1, 1}]}, Black], 
            If[$CellContext`xValue$$ < -1.8, {
              Text[
               Framed[
                Pane[
...
\((0)\) = 1\)\)", {
            ...
            Line[{{$CellContext`xValue$$, 
                $CellContext`funcC3F65[$CellContext`xValue$$]} + Normalize[{1, 
                 Derivative[
                 1][$CellContext`funcC3F65][$CellContext`xValue$$]}], \
{$CellContext`xValue$$, 
                $CellContext`funcC3F65[$CellContext`xValue$$]} - Normalize[{1, 
                Derivative[
                1][$CellContext`funcC3F65][$CellContext`xValue$$]}]}], Black, 
            
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F65[$CellContext`xValue$$]}], \
$CellContext`bcR, 
            Point[{$CellContext`xValue$$, 
              Derivative[
              1][$CellContext`funcC3F65][$CellContext`xValue$$]}]}]}, 
       ...
       "Specifications" :> {{{$CellContext`xValue$$, 0.5, 
          ...
          Small}, {{$CellContext`xValue$$, 0.5, ""}, {-2.99 -> 
           Pane["\!\(TraditionalForm\`x \[Rule] \(-\[Infinity]\)\)", {
             48, Automatic}, Alignment -> Center], 0 -> 
           Pane["\!\(TraditionalForm\`x = 0\)", {48, Automatic}, Alignment -> 
             Center], 2.99 -> 
      ...
      ImageSizeCache->{503., {140., 145.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F65[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F65[
            Pattern[$CellContext`x, 
             Blank[]]] := ArcTan[$CellContext`x]}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.10, Figure 3.65"], "Header"]}, {
   Cell[
    TextData["Section 3.10, Figure 3.65"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 8051, 167, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature RLjfQ8KftNZl2K5fwdMv8EYr *)
