...
NotebookDataLength[     39994,        911]
NotebookOptionsPosition[      7691,        161]
NotebookOutlinePosition[     40771,        923]
CellTagsIndexPosition[     40728,        920]
WindowTitle->Section 3.4, Exercise 85a
WindowFrame->Normal*)
...
StyleBox[\"b\",\nFontSlant->\"Italic\"]\) to change their locations."], 
     ...
     288., {86., 92.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`aValue$72244$$ = {0, 
     0}, $CellContext`bValue$72245$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = {-1, 
          0}, $CellContext`bValue$$ = {1, 0}}, "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$72244$$, {0, 0}], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$72245$$, {0, 0}]}, 
       "OtherVariables" :> {
       ...
       Module[{$CellContext`cValue$}, $CellContext`cValue$ = (
           ...
           2; Show[{
            Plot[
             $CellContext`funcC3FP85a[$CellContext`x], {$CellContext`x, -2, 
              2}, PlotStyle -> {{Thick, Black}}], 
            Plot[{Derivative[1][$CellContext`funcC3FP85a][
                 Part[$CellContext`aValue$$, 1]] ($CellContext`x - 
                Part[$CellContext`aValue$$, 1]) + $CellContext`funcC3FP85a[
                Part[$CellContext`aValue$$, 1]], 
              Derivative[1][$CellContext`funcC3FP85a][
                 Part[$CellContext`bValue$$, 1]] ($CellContext`x - 
                Part[$CellContext`bValue$$, 1]) + $CellContext`funcC3FP85a[
...
{0, 2}, {0, 1}], 
              Text[
              "\!\(TraditionalForm\`c = \*FractionBox[\(a + b\), \(2\)]\)", {
               0, 2}, {0, 3}], $CellContext`bcB, 
              AbsolutePointSize[7], 
              Point[{
                Part[$CellContext`aValue$$, 1], 
                $CellContext`funcC3FP85a[
                 Part[$CellContext`aValue$$, 1]]}], 
              Point[{
       ...
       "Specifications" :> {{{$CellContext`aValue$$, {-1, 0}}, {-2, 0}, {2, 
...
StyleBox[\"b\",\nFontSlant->\"Italic\"]\) to change their locations."}, 
      ...
      ImageSizeCache->{314., {118., 124.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3FP85a[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3FP85a[
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.4\"", "\", Exercise \"", "\"85a\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.4, Exercise 85a"], "Header"]}, {
   Cell[
    TextData["Section 3.4, Exercise 85a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 6413, 128, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature xI4JYs04lAEqCLOBJAkculVT *)
