...
NotebookDataLength[     42760,        979]
NotebookOptionsPosition[     10090,        220]
NotebookOutlinePosition[     43537,        991]
CellTagsIndexPosition[     43494,        988]
WindowTitle->Section 3.6, Figure 3.40b
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showVelocity$$ = 
     True, $CellContext`tValue$$ = 0, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`tValue$$], 0, "time"}, 0, 5.16, 0.01}, {{
        Hold[$CellContext`tValue$$], 0, ""}, 0, 5.16, 0.01}, {{
        Hold[$CellContext`tValue$$], False, ""}, {
       0 -> Pane[
         "initial position", {108, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], 2 -> 
        Pane["maximum height", {108, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], 5.16 -> 
        Pane["strikes river", {108, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}]}}, {
     ...
     Typeset`size$$ = {576., {149., 154.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`tValue$73257$$ = 
     0, $CellContext`showVelocity$73258$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showVelocity$$ = 
         True, $CellContext`tValue$$ = 0}, "ControllerVariables" :> {
         Hold[$CellContext`tValue$$, $CellContext`tValue$73257$$, 0], 
         Hold[$CellContext`showVelocity$$, $CellContext`showVelocity$73258$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> GraphicsGrid[{{
           Graphics[{
             If[$CellContext`tValue$$ == 0, 
              Text[
               Framed[
                Pane[
                "Initial position\n\!\(TraditionalForm\`s(0) = 96\) ft\n\
\!\(TraditionalForm\`v(0) = 64\) ft/s", $CellContext`bcPBS], \
$CellContext`bcFO], {0.3, 90}, {-1, 1}], Black], 
             If[$CellContext`tValue$$ == 2, 
              Text[
               Framed[
                Pane[
                "Maximum height\n\!\(TraditionalForm\`s(2) = 160\) ft\n\
\!\(TraditionalForm\`v(2) = 0\)", $CellContext`bcPBS], $CellContext`bcFO], {
               0.3, 150}, {-1, 1}], Black], 
             If[$CellContext`tValue$$ == 5.16, 
              Text[
               Framed[
                Pane[
                "Splash!\n\!\(TraditionalForm\`s(5.16) = 0\) ft\n\
\!\(TraditionalForm\`v(5.16) = \(-101.1\)\) ft/s", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> LightBlue], {0.3, -10}, {-1, 1}], Black], 
             Black, 
             AbsolutePointSize[7], 
             Point[{0.75, 
               $CellContext`funcC3F40[$CellContext`tValue$$]}], 
             Line[{{0, 0}, {2, 0}}]}, PlotRange -> {{-0.5, 2}, {-100, 200}}, 
            ImageSize -> 4 72, Axes -> {False, True}, AspectRatio -> 1, 
            Ticks -> {None, 
              Range[-100, 200, 50]}, BaseStyle -> {"Text", 13}, 
            AxesLabel -> {None, "\!\(TraditionalForm\`s\)"}], 
           Show[{
             Plot[{
               $CellContext`funcC3F40[$CellContext`t], 
               Derivative[
               1][$CellContext`funcC3F40][$CellContext`t]}, {$CellContext`t, 
               0, 5.16}, PlotStyle -> {{Thick, Black}, 
                
                If[$CellContext`showVelocity$$, {Thick, $CellContext`bcR}, 
                 None]}], 
             Graphics[{Gray, 
               
               Line[{{$CellContext`tValue$$, -100}, {$CellContext`tValue$$, 
                  200}}], Black, 
               AbsolutePointSize[7], 
               ...
               Text[
                ...
                Row[{"Position: ", 
                  "\!\(TraditionalForm\`s = \(-16\) \*SuperscriptBox[\(t\), \
\(2\)] + 64  t + 96\)"}], {0.2, 190}, {-1, 1}], 
               If[$CellContext`showVelocity$$, {$CellContext`bcR, 
                 Point[{$CellContext`tValue$$, 
                   Derivative[
                   1][$CellContext`funcC3F40][$CellContext`tValue$$]}], 
                 Text[
                  
                  Row[{"Velocity: ", 
                    "\!\(TraditionalForm\`v = \(\*FractionBox[\(d\
\[VeryThinSpace]s\), \(d\[VeryThinSpace]t\)] = \(-32\) t + 64\)\)"}], {
                  0.2, -100}, {-1, -1}]}, Black]}]}, ImageSize -> 4 72, 
            AspectRatio -> 1, PlotRange -> {{-0.5, 5.5}, {-100, 200}}, Ticks -> {
              Range[0, 5], 
              Range[-100, 200, 50]}, BaseStyle -> {"Text", 13}, 
            AxesLabel -> {
             "\!\(TraditionalForm\`t\)", "\!\(TraditionalForm\`s\)"}]}}, 
         ImageSize -> 8 72], 
       "Specifications" :> {{{$CellContext`tValue$$, 0, "time"}, 0, 5.16, 
          0.01, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`tValue$$, 0, ""}, 0, 5.16, 0.01, ControlType -> 
          Trigger, DefaultDuration -> 10, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
         Delimiter, {{$CellContext`tValue$$, False, ""}, {
          0 -> Pane[
            "initial position", {108, Automatic}, 
             BaseStyle -> {
              LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           ...
           Pane["maximum height", {108, Automatic}, 
             BaseStyle -> {
              LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
               LineBreakWithin -> Automatic, Hyphenation -> True, 
               TextAlignment -> Left}], 5.16 -> 
           Pane[
            "strikes river", {108, Automatic}, 
             BaseStyle -> {
              LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
               LineBreakWithin -> Automatic, Hyphenation -> True, 
               TextAlignment -> Left}]}, ControlType -> SetterBar, Appearance -> 
          "Vertical", ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], {{$CellContext`showVelocity$$, True, 
           "show velocity"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 2}, 
         Row[{
           Manipulate`Place[2]}]}, 
       "Options" :> {
     ...
     Initialization:>({{$CellContext`bcPBS = 
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`funcC3F40[
            Pattern[$CellContext`t, 
             Blank[]]] := (-16) $CellContext`t^2 + 64 $CellContext`t + 
           96, $CellContext`t[
          ...
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC3F40[
            Pattern[$CellContext`t, 
             Blank[]]] := (-16) $CellContext`t^2 + 64 $CellContext`t + 96}}; 
         ...
         GridBox[{{"\"Section \"", "\"3.6\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"3\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"40b\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Figure 3.40b"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Figure 3.40b"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 8812, 187, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature VINEjXPhgwX6PK#l7srvntES *)
