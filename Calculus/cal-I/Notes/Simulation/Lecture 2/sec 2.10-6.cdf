...
NotebookDataLength[     39483,        906]
NotebookOptionsPosition[      6826,        148]
NotebookOutlinePosition[     40260,        918]
CellTagsIndexPosition[     40217,        915]
WindowTitle->Section 3.10, Figure 3.68
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`sValue$$ = 200, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`sValue$$], 200, 
        "\!\(\*\nStyleBox[\"s\",\nFontSlant->\"Italic\"]\)"}, 50, 600, 10}, {{
       
        Hold[$CellContext`sValue$$], 200, ""}, 50, 600, 1}}, 
     Typeset`size$$ = {512., {128.34375, 133.65625}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`sValue$74720$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`sValue$$ = 200}, 
       "ControllerVariables" :> {
         Hold[$CellContext`sValue$$, $CellContext`sValue$74720$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Show[{
             Plot[
              $CellContext`funcC3F68[$CellContext`s], {$CellContext`s, 0.1, 
               600}, PlotStyle -> {{Thick, Black}}], 
             Graphics[{Gray, 
               Line[{{$CellContext`sValue$$, 0}, {$CellContext`sValue$$, 2}}],
                Black, 
               Text[
               "\!\(TraditionalForm\`\[Theta] = \*SuperscriptBox[\(tan\), \
\(-1\)] \*FractionBox[\(150\), \(s\)]\)", {300, 0.8}, {-1, 1}], 
               Text[
                Framed[
                 Pane[
                 "As the shadow length increases, the angle of elevation \
decreases.", {150, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                 Background -> White], {100, 2}, {-1, 1}], $CellContext`bcR, 
               AbsolutePointSize[7], 
               Point[{$CellContext`sValue$$, 
                 $CellContext`funcC3F68[$CellContext`sValue$$]}]}]}, 
            BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.04}], 
            ImageSize -> 3.5 72, AspectRatio -> 1, AxesOrigin -> {0, 0}, 
            Ticks -> {
              Range[0, 600, 100], {1, Pi/2, 2}}, 
            PlotRange -> {{0, 600}, {0, 2}}, 
            AxesLabel -> {
             "\!\(TraditionalForm\`s\)", "\!\(TraditionalForm\`\[Theta]\)"}], 
           
           Graphics[{
             Text["150 ft", {0, 75}, {-2, 0}], 
             Text[
             "\!\(\*\nStyleBox[\"s\",\nFontSlant->\"Italic\"]\)", \
{(-$CellContext`sValue$$)/2, 0}, {0, 1}], 
             Text["\[ScriptL]", {(-$CellContext`sValue$$)/2, 75}, {2, -2}], 
             Text[
             "\[Theta]", {-$CellContext`sValue$$, 
               5}, {-1, -1}], $CellContext`bcR, Thick, 
             Circle[{-$CellContext`sValue$$, 0}, 50, {0, 
               ArcTan[150/$CellContext`sValue$$]}], 
             AbsoluteThickness[3], $CellContext`bcG, 
             Line[{{0, 0}, {0, 150}}], Thick, 
             GrayLevel[0.5], 
             Line[{{-$CellContext`sValue$$, 0}, {0, 0}}], Dashed, 
             Darker[Yellow], 
             
             Line[{{-$CellContext`sValue$$, 0}, {
               100, 150 (($CellContext`sValue$$ + 
                  100)/$CellContext`sValue$$)}}], 
             EdgeForm[
              Darker[Yellow]], Yellow, 
             
             Disk[{100, 
               150 (($CellContext`sValue$$ + 100)/$CellContext`sValue$$)}, 
              20]}, PlotRange -> {{-600, 150}, {-50, 325}}, AspectRatio -> 
            Automatic, BaseStyle -> {"Text", 13}, ImageSize -> 3.5 72]}}], 
       "Specifications" :> {{{$CellContext`sValue$$, 200, 
           "\!\(\*\nStyleBox[\"s\",\nFontSlant->\"Italic\"]\)"}, 50, 600, 10, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`sValue$$, 200, ""}, 50, 600, 1, ControlType -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{653., {146., 152.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F68[
            Pattern[$CellContext`s, 
             Blank[]]] := ArcTan[150/$CellContext`s], $CellContext`bcPBS = 
          BaseStyle -> {
          ...
          RGBColor[0, 0.6, 0.4]}; {$CellContext`funcC3F68[
            Pattern[$CellContext`s, 
             Blank[]]] := ArcTan[150/$CellContext`s]}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.10, Figure 3.68"], "Header"]}, {
   Cell[
    TextData["Section 3.10, Figure 3.68"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 5548, 115, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature SJ4fM4GtvnE0fJ##HoAmWzWf *)
