...
NotebookDataLength[     40622,        929]
NotebookOptionsPosition[      7965,        171]
NotebookOutlinePosition[     41399,        941]
CellTagsIndexPosition[     41356,        938]
WindowTitle->Section 3.11, Figure 3.69
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`tValue$$ = 1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`tValue$$], 1, "time"}, 1, 79, 1}, {{
        Hold[$CellContext`tValue$$], 1, ""}, 1, 79, 1}, {
       Hold[
        Grid[{{
           Manipulate`Place[1], 
           Manipulate`Place[2]}}, Alignment -> Left, Spacings -> 0]], 
       Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     584., {178.84375, 184.15625}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`tValue$74924$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, "Variables" :> {$CellContext`tValue$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`tValue$$, $CellContext`tValue$74924$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Graphics3D[{Orange, 
             ...
             Cone[{{0, 0, 0}, {
               0, 0, (120 ($CellContext`tValue$$/(3 Pi)))^(1/3)}}, 
              3 (120 ($CellContext`tValue$$/(3 Pi)))^(1/3)], Yellow, 
             Cuboid[{4, 4, 11}, {-4, -4, 14}], 
             Table[{Orange, 
               Sphere[{0, 0, 
                 Min[
                 12, 2 $CellContext`i - Mod[$CellContext`tValue$$/36, 12]]}, 
                1]}, {$CellContext`i, 1, 12}]}, 
            PlotRange -> {{-30, 30}, {-30, 30}, {0, 14}}, 
            ViewPoint -> {1, 1, 0.3}, Boxed -> False, Axes -> False, 
            ImageSize -> 4 72], 
           
           Grid[{{"time = ", $CellContext`tValue$$, "min"}, {
             "\!\(\*\nStyleBox[\"h\",\nFontSlant->\"Italic\"]\) = ", 
              Round[(120 ($CellContext`tValue$$/(3 Pi)))^(1/3), 0.1], "ft"}, {
             
             "\!\(TraditionalForm\`\*FractionBox[\(d\[VeryThinSpace]h\), \(d\
\[VeryThinSpace]t\)]\) = ", 
              Round[
              120/((9 Pi) (120 ($CellContext`tValue$$/(3 Pi)))^(2/3)), 0.001],
               "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"ft\",\n\
FontSlant->\"Plain\"], \"/\", \"min\"}],\n TraditionalForm]\)"}, {
             "\!\(\*\nStyleBox[\"r\",\nFontSlant->\"Italic\"]\) = ", 
              Round[3 (120 ($CellContext`tValue$$/(3 Pi)))^(1/3), 0.1], 
              "\!\(TraditionalForm\`ft/min\)"}, {
             "\!\(TraditionalForm\`\*FractionBox[\(d\[VeryThinSpace]r\), \(d\
\[VeryThinSpace]t\)]\) = ", 
              Round[
              3 (120/((9 Pi) (120 ($CellContext`tValue$$/(3 Pi)))^(2/3))), 
               0.001], "\!\(TraditionalForm\`ft/min\)"}, {
             "\!\(\*\nStyleBox[\"V\",\nFontSlant->\"Italic\"]\) = ", 
              Round[120 $CellContext`tValue$$, 0.1], 
              "\!\(\*SuperscriptBox[\(ft\), \(3\)]\)"}, {
             "\!\(TraditionalForm\`\*FractionBox[\(d\[VeryThinSpace]V\), \(d\
\[VeryThinSpace]t\)]\) = ", 120, 
              "\!\(\*FormBox[\n RowBox[{SuperscriptBox[\n   StyleBox[\"ft\",\n\
FontSlant->\"Plain\"], \"3\"], \"/\", \"min\"}],\n TraditionalForm]\)"}}, 
            Alignment -> {{Right, Right, Left}, Automatic}, 
            BaseStyle -> {"TR", 14}]}, {
           Show[{
             
             Plot[{(120 ($CellContext`t/(3 Pi)))^(1/3), 
               3 (120 ($CellContext`t/(3 Pi)))^(1/3)}, {$CellContext`t, 0, 
               78}, PlotStyle -> {{Thick, Black}, {Thick, $CellContext`bcR}}], 
             Graphics[{Black, 
               AbsolutePointSize[7], 
               
               Point[{$CellContext`tValue$$, (
                  120 ($CellContext`tValue$$/(3 Pi)))^(1/
                  3)}], $CellContext`bcR, 
               AbsolutePointSize[7], 
               
               Point[{$CellContext`tValue$$, 
                 3 (120 ($CellContext`tValue$$/(3 Pi)))^(1/3)}]}]}, 
            PlotRange -> {{0, 78}, {0, 30}}, Ticks -> {
              Range[0, 80, 10], 
              Range[0, 30, 10]}, AxesOrigin -> {0, 0}, AxesLabel -> {"Time", 
              Column[{
                Style["Radius", $CellContext`bcR], "Height"}, BaseStyle -> 
               "TR"]}, ImageSize -> 4 72, BaseStyle -> {"Text", 13}], 
           Show[{
             Plot[
             120 $CellContext`t, {$CellContext`t, 0, 78}, 
              PlotStyle -> {{Thick, Orange}}], 
             Graphics[{Orange, 
               AbsolutePointSize[7], 
               Point[{$CellContext`tValue$$, 120 $CellContext`tValue$$}]}]}, 
            PlotRange -> {{0, 78}, {0, 10000}}, Ticks -> {
              Range[0, 80, 10], 
              Range[0, 10000, 2000]}, AxesOrigin -> {0, 0}, 
            AxesLabel -> {"Time", 
              Column[{"", 
                Style["Volume", Orange]}, BaseStyle -> "TR"]}, ImageSize -> 
            4 72, BaseStyle -> {"Text", 13}]}}], 
       "Specifications" :> {{{$CellContext`tValue$$, 1, "time"}, 1, 79, 1, 
          ControlType -> Slider, ImageSize -> {200, Automatic}, 
          ControlPlacement -> 1}, {{$CellContext`tValue$$, 1, ""}, 1, 79, 1, 
      ...
      ImageSizeCache->{604., {216., 221.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{
         Attributes[PlotRange] = {ReadProtected}, $CellContext`t[
...
$CellContext`bcR = 
          RGBColor[
           0.8, 0, 0.4]}; {$CellContext`xRate = -120; $CellContext`yRate = \
-150; Null}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.11, Figure 3.69"], "Header"]}, {
   Cell[
    TextData["Section 3.11, Figure 3.69"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 6687, 138, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature AK4GCj96D1IZmLk0OqFntIM2 *)
