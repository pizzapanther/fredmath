...
NotebookDataLength[     45715,       1031]
NotebookOptionsPosition[     13061,        273]
NotebookOutlinePosition[     46491,       1043]
CellTagsIndexPosition[     46448,       1040]
WindowTitle->Section 3.1, Figure 3.10
WindowFrame->Normal*)
...
FontSlant->\"Italic\"]\)", {144, Automatic}, 
        ...
        "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]x\)"}, 0.01, 4.5,
        0.01}, {
       Hold[
        Grid[{{
           Spacer[10], 
...
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]],
     ...
     Typeset`skipInitDone$$ = False, $CellContext`hValue$71373$$ = 
     0, $CellContext`aValue$71374$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1.5, $CellContext`hValue$$ = 
         4}, "ControllerVariables" :> {
         Hold[$CellContext`hValue$$, $CellContext`hValue$71373$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$71374$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`resetAValue} = {1.5, False}]; Show[{
           Plot[{
             $CellContext`funcC3F10[$CellContext`x], \
(($CellContext`funcC3F10[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F10[$CellContext`aValue$$])/$CellContext`hValue$$) \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F10[$CellContext`aValue$$], 
             Derivative[
               1][$CellContext`funcC3F10][$CellContext`aValue$$] \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F10[$CellContext`aValue$$]}, {$CellContext`x, 0, 10}, 
           ...
           Graphics[{Black, 
             ...
             Text["\!\(TraditionalForm\`y = f(x)\)", {10, 
               $CellContext`funcC3F10[10]}, {1, 3}], 
             Text[
             "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]y = f(x + \
\[CapitalDelta]\[VeryThinSpace]x) - f(x)\)", {$CellContext`aValue$$ + \
$CellContext`hValue$$, ($CellContext`funcC3F10[$CellContext`aValue$$] + \
$CellContext`funcC3F10[$CellContext`aValue$$ + $CellContext`hValue$$])/
               2}, {-1.1, 0}], 
             Text[
             "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]x\)", \
{$CellContext`aValue$$ + $CellContext`hValue$$/2, 
               $CellContext`funcC3F10[$CellContext`aValue$$]}, {0, 1.5}], 
             Text["\!\(TraditionalForm\`P\)", {$CellContext`aValue$$, 
               $CellContext`funcC3F10[$CellContext`aValue$$]}, {1.5, -1.5}], 
             Text[
...
\((x)\) = \(\*SubscriptBox[\(lim\), \(\[CapitalDelta]\[VeryThinSpace]x \
...
\(d\[VeryThinSpace]x\)]\)\)\)", $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> 
               White], {(
                 10.5 - $CellContext`funcC3F10[$CellContext`aValue$$])/
                Derivative[
                1][$CellContext`funcC3F10][$CellContext`aValue$$] + \
...
\[VeryThinSpace]x\)]\)", $CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], {(
                 7 - $CellContext`funcC3F10[$CellContext`aValue$$])/(($\
CellContext`funcC3F10[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F10[$CellContext`aValue$$])/$CellContext`hValue$$) + \
...
$CellContext`hValue$$]}}], Dashed, 
             Line[{{$CellContext`aValue$$, 
                $CellContext`funcC3F10[$CellContext`aValue$$]}, {0, 
                $CellContext`funcC3F10[$CellContext`aValue$$]}}], 
...
$CellContext`hValue$$]}}], 
             ...
             Arrow[{{0, 
                $CellContext`funcC3F10[$CellContext`aValue$$ + \
$CellContext`hValue$$]}, {
               0, $CellContext`funcC3F10[$CellContext`aValue$$ + \
...
FontSlant->\"Italic\"]\)", {144, Automatic}, 
          BaseStyle -> {
           ...
           "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]x\)"}, 0.01, 
          4.5, 0.01, ControlType -> Slider, ImageSize -> Small}, 
         Grid[{{
            Spacer[10], 
...
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]},
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{603., {233., 239.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`resetAValue = 
          False, $CellContext`funcC3F10[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F10[
            Pattern[$CellContext`x, 
             Blank[]]] := 1.5 Log[$CellContext`x - 1] + 4}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.1, Figure 3.10"], "Header"]}, {
   Cell[
    TextData["Section 3.1, Figure 3.10"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 11784, 240, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature #IjA37r#MUblkLks15qGWxIW *)
