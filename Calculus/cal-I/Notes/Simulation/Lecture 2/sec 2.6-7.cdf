...
NotebookDataLength[     42108,        963]
NotebookOptionsPosition[      9438,        204]
NotebookOutlinePosition[     42885,        975]
CellTagsIndexPosition[     42842,        972]
WindowTitle->Section 3.6, Figure 3.40a
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`tValue$$ = 0, Typeset`show$$ = True, 
     ...
     False, $CellContext`tValue$73174$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, "Variables" :> {$CellContext`tValue$$ = 0}, 
       "ControllerVariables" :> {
         Hold[$CellContext`tValue$$, $CellContext`tValue$73174$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
         Typeset`specs$$, Typeset`size$$, Typeset`update$$, 
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> 
       Module[{$CellContext`showVelocity$ = False}, 
         GraphicsGrid[{{
            Graphics[{
...
$CellContext`bcPBS], $CellContext`bcFO], {0.3, 90}, {-1, 1}], Black], 
              If[$CellContext`tValue$$ == 2, 
               Text[
                Framed[
                 Pane[
                 "Maximum height\n\!\(TraditionalForm\`s(2) = 160\) ft", \
$CellContext`bcPBS], $CellContext`bcFO], {0.3, 150}, {-1, 1}], Black], 
              If[$CellContext`tValue$$ == 5.16, 
               Text[
                Framed[
                 Pane[
                 "Splash!\n\!\(TraditionalForm\`s(5.16) = 0\) ft", \
$CellContext`bcPBS], $CellContext`bcFO, Background -> LightBlue], {
                0.3, -10}, {-1, 1}], Black], Black, 
              AbsolutePointSize[7], 
              Point[{0.75, 
         ...
         GridBox[{{"\"Section \"", "\"3.6\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"3\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"40a\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Figure 3.40a"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Figure 3.40a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 8160, 171, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature wKzOYGuna@t8II#TTjWIdsKk *)
