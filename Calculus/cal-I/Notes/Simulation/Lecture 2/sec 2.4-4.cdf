...
NotebookDataLength[     40041,        913]
NotebookOptionsPosition[      7738,        163]
NotebookOutlinePosition[     40818,        925]
CellTagsIndexPosition[     40775,        922]
WindowTitle->Section 3.4, Exercise 85b
WindowFrame->Normal*)
...
StyleBox[\"b\",\nFontSlant->\"Italic\"]\) to change their locations."], 
     ...
     288., {93., 98.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`aValue$72303$$ = {0, 
     0}, $CellContext`bValue$72304$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = {
          0.3, 0}, $CellContext`bValue$$ = {3, 0}}, 
       "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$72303$$, {0, 0}], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$72304$$, {0, 0}]}, 
       "OtherVariables" :> {
       ...
       Module[{$CellContext`cValue$}, $CellContext`cValue$ = (
           ...
           Rational[1, 2]; Show[{
            Plot[
             $CellContext`funcC3FP85b[$CellContext`x], {$CellContext`x, 0, 4},
              PlotStyle -> {{Thick, Black}}], 
            Plot[{Derivative[1][$CellContext`funcC3FP85b][
                 Part[$CellContext`aValue$$, 1]] ($CellContext`x - 
                Part[$CellContext`aValue$$, 1]) + $CellContext`funcC3FP85b[
                Part[$CellContext`aValue$$, 1]], 
              Derivative[1][$CellContext`funcC3FP85b][
                 Part[$CellContext`bValue$$, 1]] ($CellContext`x - 
                Part[$CellContext`bValue$$, 1]) + $CellContext`funcC3FP85b[
            ...
            Graphics[{
              ...
              "\!\(TraditionalForm\`c = \*SqrtBox[\(a\\ b\)]\)", {
               0.25, 2}, {-1, 5}], $CellContext`bcB, 
              AbsolutePointSize[7], 
              Point[{
                Part[$CellContext`aValue$$, 1], 
                $CellContext`funcC3FP85b[
                 Part[$CellContext`aValue$$, 1]]}], 
              Point[{
       ...
       "Specifications" :> {{{$CellContext`aValue$$, {0.3, 0}}, {0.01, 0}, {4,
...
StyleBox[\"b\",\nFontSlant->\"Italic\"]\) to change their locations."}, 
      ...
      ImageSizeCache->{314., {125., 130.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3FP85b[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3FP85b[
           
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x^Rational[1, 2]}}; 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.4\"", "\", Exercise \"", "\"85b\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.4, Exercise 85b"], "Header"]}, {
   Cell[
    TextData["Section 3.4, Exercise 85b"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 6460, 130, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature lKjIT305OiQPLJO9FpFX@5q@ *)
