...
NotebookDataLength[     39816,        914]
NotebookOptionsPosition[      7159,        156]
NotebookOutlinePosition[     40593,        926]
CellTagsIndexPosition[     40550,        923]
WindowTitle->Section 3.10, Figure 3.64
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`angle$$ = Rational[-1, 2] Pi, 
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`angle$$], Rational[-1, 2] Pi, 
        "plot inverse tangent"}, Rational[-1, 2] Pi, 1.5407963267948965`}}, 
     Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`angle$74557$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`angle$$ = Rational[-1, 2] Pi}, 
       "ControllerVariables" :> {
         Hold[$CellContext`angle$$, $CellContext`angle$74557$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          ParametricPlot[{
            Tan[$CellContext`t], $CellContext`t}, {$CellContext`t, (-Pi)/2 + 
            0.01, $CellContext`angle$$ + 0.02}, 
           PlotStyle -> {Thick, $CellContext`bcB}], 
          
          ParametricPlot[{{(-Pi)/2, $CellContext`var}, {
            Pi/2, $CellContext`var}, {$CellContext`var, Pi/
             2}, {$CellContext`var, (-Pi)/2}}, {$CellContext`var, -4, 4}, 
           PlotStyle -> {{Dashed, Gray}}], 
          Graphics[{$CellContext`bcG, 
            Text["\!\(TraditionalForm\`y = x\)", {2, 1.7}], 
            AbsolutePointSize[6], $CellContext`bcR, 
            If[Abs[$CellContext`angle$$] != Pi/2, 
             Point[{$CellContext`angle$$, 
               Tan[$CellContext`angle$$]}], $CellContext`bcR], 
            Text[
            "\!\(TraditionalForm\`y = tan\\ x\)", {-1.5, -2.5}, {1, 
             1}], $CellContext`bcB, 
            If[Abs[$CellContext`angle$$] != Pi/2, 
             Point[{
               
               Tan[$CellContext`angle$$], $CellContext`angle$$}], \
$CellContext`bcB], 
            Text[
            "\!\(TraditionalForm\`\(TraditionalForm\`y = \
\*SuperscriptBox[\(tan\), \(-1\)] x\)\)", {-1.7, -1}, {1, -2}], Gray, 
            Arrowheads[0.04], 
            EdgeForm[$CellContext`bcR], 
            Opacity[0.5], 
            Lighter[$CellContext`bcR], 
            Rectangle[{(-Pi)/2, -0.07}, {$CellContext`angle$$, 0.}], 
            If[Abs[$CellContext`angle$$] != Pi/2, 
             Rectangle[{-4, 0}, {
               Tan[$CellContext`angle$$], 0.07}], 
             Lighter[$CellContext`bcR]], 
            ...
            If[Abs[$CellContext`angle$$] != Pi/2, 
             Rectangle[{-0.07, -4}, {0., 
               Tan[$CellContext`angle$$]}], 
             Lighter[$CellContext`bcR]], 
            Rectangle[{0, (-Pi)/2}, {0.1, $CellContext`angle$$}], Black, 
            Opacity[1], 
            Text[
             Framed[
              Pane[
              "Domain of \!\(TraditionalForm\`\*SuperscriptBox[\(tan\), \
\(-1\)] x\): \!\(TraditionalForm\`\(-\[Infinity]\) < x < \[Infinity]\)\nRange \
of \!\(TraditionalForm\`\*SuperscriptBox[\(tan\), \(-1\)] x\): \
\!\(TraditionalForm\`\(-\*FractionBox[\(\[Pi]\), \(2\)]\) < y < \
\*FractionBox[\(\[Pi]\), \(2\)]\)", {
               110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], {0.2, -0.5}, {-1, 1}]}]}, AspectRatio -> 
         Automatic, PlotRange -> {{-3, 3}, {-3, 3}}, 
         Ticks -> {{(-Pi)/2, -1, 1, Pi/2}, {(-Pi)/2, -1, 1, Pi/2}}, ImageSize -> 
         4 72, BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.04}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}], 
       "Specifications" :> {{{$CellContext`angle$$, Rational[-1, 2] Pi, 
           "plot inverse tangent"}, Rational[-1, 2] Pi, 1.5407963267948965`, 
          ControlType -> Trigger, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.10, Figure 3.64"], "Header"]}, {
   Cell[
    TextData["Section 3.10, Figure 3.64"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 5881, 123, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature bINzlXapGU#ahIOEiVkjnq1o *)
