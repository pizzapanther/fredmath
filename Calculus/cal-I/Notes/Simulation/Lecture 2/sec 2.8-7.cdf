...
NotebookDataLength[     41814,        948]
NotebookOptionsPosition[      9515,        198]
NotebookOutlinePosition[     42591,        960]
CellTagsIndexPosition[     42548,        957]
WindowTitle->Section 3.8, Exercise 81
WindowFrame->Normal*)
    ...
    DynamicModuleBox[{$CellContext`a$$ = 1, $CellContext`b$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold[
        ...
        Hold[$CellContext`b$$], 1, 
        "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0.1, 10, 0.1}, {
       ...
       Hold["Show tangent lines:"], Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        "\!\(TraditionalForm\`x\\ y = a\)"}, {True, False}}, {{
        Hold[$CellContext`showEllipseTangents$$], False, 
        "\!\(TraditionalForm\`\*SuperscriptBox[\(x\), \(2\)] - \
\*SuperscriptBox[\(y\), \(2\)] = b\)"}, {True, False}}}, Typeset`size$$ = {
     288., {143., 149.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`a$74089$$ = 
     0, $CellContext`b$74090$$ = 
     0, $CellContext`showParabolaTangents$74091$$ = 
     False, $CellContext`showEllipseTangents$74092$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       ...
       "ControllerVariables" :> {
         Hold[$CellContext`a$$, $CellContext`a$74089$$, 0], 
         Hold[$CellContext`b$$, $CellContext`b$74090$$, 0], 
         Hold[$CellContext`showParabolaTangents$$, \
$CellContext`showParabolaTangents$74091$$, False], 
         Hold[$CellContext`showEllipseTangents$$, \
$CellContext`showEllipseTangents$74092$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          ParametricPlot[{$CellContext`x, $CellContext`a$$/$CellContext`x}, \
{$CellContext`x, -4, 4}, PlotStyle -> {Thick, Black}, 
           Exclusions -> {$CellContext`x == 0}], 
          
          ParametricPlot[{$CellContext`b$$^Rational[1, 2] 
            Sec[$CellContext`\[Theta]], $CellContext`b$$^Rational[1, 2] 
            Tan[$CellContext`\[Theta]]}, {$CellContext`\[Theta], 0, 2 Pi}, 
           PlotStyle -> {{Thick, $CellContext`bcR}}, 
           Exclusions -> {$CellContext`\[Theta] == 
             Pi/2, $CellContext`\[Theta] == 3 (Pi/2)}], 
          
          Plot[{((-$CellContext`a$$)/($CellContext`b$$/
               2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
                Rational[1, 2])) ($CellContext`x + ($CellContext`b$$/
                 2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
                  Rational[1, 2])^
               Rational[1, 2]) - $CellContext`a$$/($CellContext`b$$/
              2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
               Rational[1, 2])^
            Rational[
             1, 2], ((-$CellContext`a$$)/($CellContext`b$$/
              ...
              Rational[1, 2]) + $CellContext`a$$/($CellContext`b$$/
               2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
                Rational[1, 2])^Rational[1, 2]}, {$CellContext`x, -4, 4}, 
           PlotStyle -> If[$CellContext`showParabolaTangents$$, {{Thick, 
               Lighter[$CellContext`bcB, 0.7]}}, None]], 
          
          Plot[{(($CellContext`b$$/
                2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
                 Rational[
                  1, 2])/$CellContext`a$$) ($CellContext`x + \
($CellContext`b$$/
                 2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
                  Rational[1, 2])^
               Rational[1, 2]) - $CellContext`a$$/($CellContext`b$$/
...
($CellContext`b$$/
              ...
              Rational[1, 2]) + $CellContext`a$$/($CellContext`b$$/
               2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
                Rational[1, 2])^Rational[1, 2]}, {$CellContext`x, -4, 4}, 
           PlotStyle -> If[$CellContext`showEllipseTangents$$, {{Thick, 
               Lighter[$CellContext`bcB, 0.7]}}, None]], 
            ...
            Point[{($CellContext`b$$/
              ...
              Rational[
               1, 2], $CellContext`a$$/($CellContext`b$$/
                2 + (1/2) (4 $CellContext`a$$^2 + $CellContext`b$$^2)^
                 Rational[1, 2])^Rational[1, 2]}]}]}, 
         PlotRange -> {{-4, 4}, {-4, 4}}, ImageSize -> 4 72, 
       ...
       "Specifications" :> {{{$CellContext`a$$, 1, 
          ...
          ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], {{$CellContext`b$$, 1, 
           "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0.1, 10, 0.1,
         ...
         "Show tangent lines:", {{$CellContext`showParabolaTangents$$, False, 
           "\!\(TraditionalForm\`x\\ y = a\)"}, {True, False}, ControlType -> 
          Checkbox}, {{$CellContext`showEllipseTangents$$, False, 
           "\!\(TraditionalForm\`\*SuperscriptBox[\(x\), \(2\)] - \
\*SuperscriptBox[\(y\), \(2\)] = b\)"}, {True, False}, ControlType -> 
          Checkbox}}, 
       "Options" :> {
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.8\"", "\", Exercise \"", "\"81\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.8, Exercise 81"], "Header"]}, {
   Cell[
    TextData["Section 3.8, Exercise 81"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8238, 165, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature HKjf2dIGW61mSK#UFzwVrQi9 *)
