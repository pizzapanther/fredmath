...
NotebookDataLength[     38199,        883]
NotebookOptionsPosition[      5547,        125]
NotebookOutlinePosition[     38977,        895]
CellTagsIndexPosition[     38934,        892]
WindowTitle->Section 3.3, Figure 3.24
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`bValue$$ = 1.5, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`bValue$$], 1.5, "\!\(TraditionalForm\`b\)"}, 1, 4, 
       0.01}, {
       Hold[
        Button[
     ...
     288., {101., 107.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`bValue$71922$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`bValue$$ = 1.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`bValue$$, $CellContext`bValue$71922$$, 0]}, 
       "OtherVariables" :> {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.3, Figure 3.24"], "Header"]}, {
   Cell[
    TextData["Section 3.3, Figure 3.24"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4270, 92, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature KJj20PPW7YJBHJOfReDhyNj4 *)
