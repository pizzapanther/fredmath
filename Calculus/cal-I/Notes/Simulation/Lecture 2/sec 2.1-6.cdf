...
NotebookDataLength[     38686,        888]
NotebookOptionsPosition[      6034,        130]
NotebookOutlinePosition[     39464,        900]
CellTagsIndexPosition[     39421,        897]
WindowTitle->Section 3.1, Figure 3.09
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 2, Typeset`show$$ = True, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xValue$71314$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$71314$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F09[$CellContext`x], 
            Derivative[
              1][$CellContext`funcC3F09][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F09[$CellContext`xValue$$]}, {$CellContext`x, -0.5, 6.5}, 
           PlotStyle -> {{Thick, Black}, {Thick, $CellContext`bcR}}], 
          Graphics[{
            Text[
            "\!\(TraditionalForm\`f(x) = \(-16\) \*SuperscriptBox[\(x\), \
\(2\)] + 96  x\)", {4.5, 155}, {-1, 1}], $CellContext`bcR, 
            Text[
            ...
            Text[
             Pane[
              ...
              Row[{"\!\(TraditionalForm\`f'\)", "(", $CellContext`xValue$$, 
                ")", " = ", 
                Round[
                 Derivative[1][$CellContext`funcC3F09][$CellContext`xValue$$],
              ...
              $CellContext`funcC3F09[$CellContext`xValue$$]}, {1.2, -1}], 
            Dashed, 
            AbsoluteThickness[1], 
            Line[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 
               $CellContext`funcC3F09[$CellContext`xValue$$]}}], \
$CellContext`bcB, 
            AbsolutePointSize[7], 
         ...
         AxesOrigin -> {0, 0}, AspectRatio -> 0.75, BaseStyle -> {"Text", 13},
          AxesStyle -> Arrowheads[{0, 0.04}], ImageSize -> 5 72], 
       "Specifications" :> {{{$CellContext`xValue$$, 2, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0, 6, 0.1, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`xValue$$, 2, ""}, 0, 6, 0.01, ControlType -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{503., {154., 160.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F09[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F09[
            Pattern[$CellContext`x, 
             Blank[]]] := (-16) $CellContext`x^2 + 96 $CellContext`x}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.1, Figure 3.09"], "Header"]}, {
   Cell[
    TextData["Section 3.1, Figure 3.09"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4757, 97, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature sL43ELmr4VZmYJ5TFzDNLwjB *)
