...
NotebookDataLength[     46488,       1036]
NotebookOptionsPosition[     13092,        267]
NotebookOutlinePosition[     46582,       1038]
CellTagsIndexPosition[     46539,       1035]
WindowTitle->Section 4.8, Figure 4.88
WindowFrame->Normal*)
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       ...
       Hold[
        Grid[{{
           Button[
            Style[
            "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] = 1.1\)", 
             11], $CellContext`initialRoot$$ = {1.1, 0}, Appearance -> 
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
        ...
        Hold[$CellContext`initialRoot$$], {1.1, 0}}, {-1.5, 0}, {1.5, 0}, {
       0.01, 0.1}}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`nValue$9715$$ = 
     False, $CellContext`initialRoot$9716$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`initialRoot$$ = {
         ...
         Hold[$CellContext`nValue$$, $CellContext`nValue$9715$$, False], 
         Hold[$CellContext`initialRoot$$, $CellContext`initialRoot$9716$$, {0,
           0}]}, "OtherVariables" :> {
       ...
       Module[{$CellContext`rootList$, $CellContext`xZero$}, 
         If[$CellContext`initialRoot$$ == {
          ...
          If[Abs[$CellContext`xZero$] <= 1, 
            ...
            Plot[
             $CellContext`funcC4F88[$CellContext`x], {$CellContext`x, -5, 5}, 
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], {{$CellContext`initialRoot$$, {1.1, 0}}, {-1.5, 0}, {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.8, Figure 4.88"], "Header"]}, {
   Cell[
    TextData["Section 4.8, Figure 4.88"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 12497, 244, 382, "Output"]
}
]
*)
...
(* NotebookSignature 0K4caI4nRwXr6IOUmd5aPYfx *)
