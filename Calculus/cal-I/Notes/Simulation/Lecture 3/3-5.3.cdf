...
NotebookDataLength[     38284,        881]
NotebookOptionsPosition[      4890,        112]
NotebookOutlinePosition[     38380,        883]
CellTagsIndexPosition[     38337,        880]
WindowTitle->Section 4.7, Figure 4.78
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`power$$ = 2, $CellContext`slope$$ = 100, 
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
       Hold["polynomial degree"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`power$$], 2, ""}, 2, 8, 1}, {
       Hold[
        Spacer[{0, 6}]], Manipulate`Dump`ThisIsNotAControl}, {
       Hold["slope of linear function"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`slope$$], 100, ""}, 100, 1000, 10}}, 
     Typeset`size$$ = {360., {112., 118.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`power$22424$$ = 0, $CellContext`slope$22425$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`power$$ = 2, $CellContext`slope$$ = 100}, 
       "ControllerVariables" :> {
         Hold[$CellContext`power$$, $CellContext`power$22424$$, 0], 
         Hold[$CellContext`slope$$, $CellContext`slope$22425$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`x}, {$CellContext`x, 0, 300}, PlotRange -> {0, 500000}, 
         PlotStyle -> {{Thick, $CellContext`bcB}, {Thick, $CellContext`bcR}}, 
         Epilog -> {
           Text[
            Style[
           ...
           Text[
            Style[
             ...
             Row[{"\!\(TraditionalForm\`y\)", " = ", $CellContext`slope$$ 
               "\!\(TraditionalForm\`x\)"}], $CellContext`bcR], {0, 
            300000}, {-1.5, 1}], 
           Text[
            Framed[
             Pane[
             "Polynomials (\!\(TraditionalForm\`degree > 1\)) grow faster \
than linear functions as \!\(TraditionalForm\`x \[Rule] \[Infinity]\).", {
              252, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], {0, 500000}, {-1.1, 1}]}, 
         BaseStyle -> {"Text", 13}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, AxesStyle -> 
         Arrowheads[{0, 0.03}], ImageSize -> 5 72, Ticks -> {
           Range[0, 300, 50], 
       ...
       "Specifications" :> {
        "polynomial degree", {{$CellContext`power$$, 2, ""}, 2, 8, 1, 
         ...
         Spacer[{0, 6}], 
         "slope of linear function", {{$CellContext`slope$$, 100, ""}, 100, 
          1000, 10, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        LabelStyle -> 11, Paneled -> False, Deployed -> True, 
         AppearanceElements -> "ResetButton", ControlPlacement -> Left}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{508., {130., 137.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.7, Figure 4.78"], "Header"]}, {
   Cell[
    TextData["Section 4.7, Figure 4.78"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 4295, 89, 294, "Output"]
}
]
*)
...
(* NotebookSignature CI42pRVPF3#nVKOds1ZbBxTe *)
