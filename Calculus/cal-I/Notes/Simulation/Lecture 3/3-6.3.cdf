...
NotebookDataLength[     46478,       1036]
NotebookOptionsPosition[     13082,        267]
NotebookOutlinePosition[     46572,       1038]
CellTagsIndexPosition[     46529,       1035]
WindowTitle->Section 4.8, Figure 4.86
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`initialRoot$$ = {
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["select initial value"], Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
        Grid[{{
           Button[
            Style[
       ...
       Hold["select approximation"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`nValue$$], 0, ""}, {
       0 -> Pane[
         "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\)", {48, 16}], 1 -> 
        Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] \[Rule] \
\*SubscriptBox[\(x\), \(1\)]\)", {48, 16}], 2 -> 
        Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(1\)] \[Rule] \
\*SubscriptBox[\(x\), \(2\)]\)", {48, 16}], 3 -> 
        Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(2\)] \[Rule] \
\*SubscriptBox[\(x\), \(3\)]\)", {48, 16}], 4 -> 
        Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(3\)] \[Rule] \
\*SubscriptBox[\(x\), \(4\)]\)", {48, 16}], 5 -> 
        Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(4\)] \[Rule] \
\*SubscriptBox[\(x\), \(5\)]\)", {48, 16}]}}, {
       Hold[
        Pane[
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
        ...
        Hold[$CellContext`initialRoot$$], {1., 0}}, {-1.5, 0}, {1.5, 0}, {
       0.01, 0.1}}, {{
        Hold[$CellContext`rootValue$$], 0.664449}, 0}, {{
        Hold[$CellContext`xMin$$], -2}, 0}, {{
        Hold[$CellContext`xMax$$], 2}, 0}, {{
        Hold[$CellContext`yMin$$], -1}, 0}, {{
        Hold[$CellContext`yMax$$], 2.7}, 0}}, Typeset`size$$ = {
     504., {153., 159.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`nValue$9589$$ = 
     False, $CellContext`initialRoot$9590$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`initialRoot$$ = {
         ...
         Hold[$CellContext`nValue$$, $CellContext`nValue$9589$$, False], 
         Hold[$CellContext`initialRoot$$, $CellContext`initialRoot$9590$$, {0,
           0}]}, "OtherVariables" :> {
       ...
       Module[{$CellContext`rootList$, $CellContext`xZero$}, 
         If[$CellContext`initialRoot$$ == {
          ...
          If[Abs[$CellContext`xZero$] <= 1, 
            ...
            NestList[# - $CellContext`funcC4F86[#]/Derivative[
             1][$CellContext`funcC4F86][#]& , $CellContext`xZero$, 7], 
            Drop[
             Quiet[
              
              NestWhileList[# - $CellContext`funcC4F86[#]/Derivative[
               1][$CellContext`funcC4F86][#]& , $CellContext`xZero$, # != 
               ComplexInfinity& ]], -1]]; Show[{
            Plot[
             $CellContext`funcC4F86[$CellContext`x], {$CellContext`x, -5, 5}, 
...
1\)]\)", {0.1, $CellContext`yMax$$}, {-1, 1}], 
              ...
              Text[
               Framed[
                Subscript["\!\(TraditionalForm\`x\)", 0], $CellContext`bcFO, 
                Background -> White], {$CellContext`xZero$, -0.2}, {0, 1}], 
              ...
              Text[
               Grid[
                ...
                Alignment -> {{Right, Center, "."}, 
                  Automatic}], {$CellContext`xMin$$, 2.3}, {Left, Top}], 
...
{$CellContext`yMin$$, $CellContext`yMax$$}}, ImageSize -> 7 72, 
           BaseStyle -> {"Text", 13}, Ticks -> {
             ...
             Range[$CellContext`yMin$$, $CellContext`yMax$$, 10]}, AxesStyle -> 
       ...
       "Specifications" :> {"select initial value", 
         Grid[{{
            Button[
             ...
             "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] = 1\)", 
              11], $CellContext`initialRoot$$ = {1., 0}, Appearance -> 
             "Palette", Alignment -> Left]}}, Spacings -> {0, 0}], Delimiter, 
         "select approximation", {{$CellContext`nValue$$, 0, ""}, {
          0 -> Pane[
            "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\)", {48, 16}], 
           1 -> Pane[
            "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] \[Rule] \
\*SubscriptBox[\(x\), \(1\)]\)", {48, 16}], 2 -> 
           Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(1\)] \[Rule] \
\*SubscriptBox[\(x\), \(2\)]\)", {48, 16}], 3 -> 
           Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(2\)] \[Rule] \
...
\*SubscriptBox[\(x\), \(4\)]\)", {48, 16}], 5 -> 
           Pane["\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(4\)] \[Rule] \
\*SubscriptBox[\(x\), \(5\)]\)", {48, 16}]}, ControlType -> SetterBar, 
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], {{$CellContext`initialRoot$$, {1., 0}}, {-1.5, 0}, {
          1.5, 0}, {0.01, 0.1}, ControlType -> Locator, 
          Exclusions :> {{0, 0}}}, {{$CellContext`rootValue$$, 0.664449}, 0, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{661., {174., 181.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4F86[
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.8, Figure 4.86"], "Header"]}, {
   Cell[
    TextData["Section 4.8, Figure 4.86"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 12487, 244, 382, "Output"]
}
]
*)
...
(* NotebookSignature CIzNfWP9LxBr3JkvY3B#Qz4N *)
