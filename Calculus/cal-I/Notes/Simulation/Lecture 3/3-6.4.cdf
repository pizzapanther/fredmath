...
NotebookDataLength[     46610,       1039]
NotebookOptionsPosition[     13214,        270]
NotebookOutlinePosition[     46704,       1041]
CellTagsIndexPosition[     46661,       1038]
WindowTitle->Section 4.8, Figure 4.87
WindowFrame->Normal*)
        ...
        Grid[{{
           Button[
            ...
            "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] = 0.15\)", 
             11], $CellContext`initialRoot$$ = {0.15, 0}, Appearance -> 
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
        ...
        Hold[$CellContext`initialRoot$$], {0.15, 0}}, {-0.05, 0}, {0.2, 0}, {
       0.001, 0.1}}, {{
        Hold[$CellContext`rootValue$$], 0.664449}, 0}, {{
        Hold[$CellContext`xMin$$], -0.05}, 0}, {{
        Hold[$CellContext`xMax$$], 0.2}, 0}, {{
        Hold[$CellContext`yMin$$], -0.05}, 0}, {{
        Hold[$CellContext`yMax$$], 0.2}, 0}}, Typeset`size$$ = {
     504., {152., 157.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`nValue$9654$$ = 
     False, $CellContext`initialRoot$9655$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`initialRoot$$ = {
         ...
         Hold[$CellContext`nValue$$, $CellContext`nValue$9654$$, False], 
         Hold[$CellContext`initialRoot$$, $CellContext`initialRoot$9655$$, {0,
           0}]}, "OtherVariables" :> {
       ...
       Module[{$CellContext`rootList$, $CellContext`xZero$}, 
         If[$CellContext`initialRoot$$ == {
          ...
          If[Abs[$CellContext`xZero$] <= 1, 
            ...
            Plot[
             $CellContext`funcC4F87[$CellContext`x], {$CellContext`x, -0.1, 
              0.2}, PlotStyle -> {Thick, $CellContext`bcB}], 
            Graphics[{
              Text[
...
1\)]\)", {0.03, $CellContext`yMax$$}, {-1, 1}], 
              ...
              Text[
               Framed[
                ...
                Background -> White], {$CellContext`xZero$, -0.02}, {0, 1}], 
...
$CellContext`bcFO, Background -> White], {
                   Part[$CellContext`rootList$, $CellContext`i + 1], -0.02}, {
                  0, 1}]}, {$CellContext`i, 1, 
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], {{$CellContext`initialRoot$$, {0.15, 0}}, {-0.05, 0}, {
          0.2, 0}, {0.001, 0.1}, ControlType -> Locator, 
          Exclusions :> {{0, 0}}}, {{$CellContext`rootValue$$, 0.664449}, 0, 
          ControlType -> None}, {{$CellContext`xMin$$, -0.05}, 0, ControlType -> 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.8, Figure 4.87"], "Header"]}, {
   Cell[
    TextData["Section 4.8, Figure 4.87"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 12619, 247, 378, "Output"]
}
]
*)
...
(* NotebookSignature 9LzmZUzfFbPSOL5i9BaJuacm *)
