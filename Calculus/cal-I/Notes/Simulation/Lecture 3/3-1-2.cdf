...
NotebookDataLength[     40834,        930]
NotebookOptionsPosition[      7439,        161]
NotebookOutlinePosition[     40929,        932]
CellTagsIndexPosition[     40886,        929]
WindowTitle->Section 4.1, Figure 4.05
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 1., Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], 1, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1, 8, 0.01}, {{
        Hold[$CellContext`xValue$$], 1, ""}, 1, 8, 0.01}}, Typeset`size$$ = {
     576., {165., 172.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$6740$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$6740$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC4F05[$CellContext`x], {$CellContext`x, 1, 8}, 
           PlotStyle -> {{Thick, Black}}], 
          Graphics[{$CellContext`bcR, 
            AbsoluteThickness[1], 
            Line[{{0, 
               $CellContext`funcC4F05[$CellContext`xValue$$]}, {9, 
               $CellContext`funcC4F05[$CellContext`xValue$$]}}], Dashed, 
            Line[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 
               $CellContext`funcC4F05[$CellContext`xValue$$]}}], Black, 
            Dashing[{}], 
            AbsolutePointSize[7], 
            If[$CellContext`xValue$$ >= 1.99, {Gray, 
              Line[{{2, 30}, {2, 
                 $CellContext`funcC4F05[2]}}], Black, 
              Text[
               Framed[
                Pane[
                "Local maximum:\nNo greater value of \!\(TraditionalForm\`f\) \
nearby.", {120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {2, 30}, {0, 1}], 
              Text["\!\(TraditionalForm\`c\)", {2, 0}, {0, 1.5}], 
              Point[{2, 
                $CellContext`funcC4F05[2]}], Black}, Black], 
            If[$CellContext`xValue$$ >= 1., {Gray, 
              Line[{{1, 15}, {1, 
                 $CellContext`funcC4F05[1]}}], Black, 
              Text[
               Framed[
                Pane[
                "Absolute minimum: \nNo smaller value of \
\!\(TraditionalForm\`f\) on \!\(TraditionalForm\`\([a, b]\)\).", {
                 120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {1, 15}, {0, -1}]}, Black], 
            If[$CellContext`xValue$$ >= 3.99, {Gray, 
              Line[{{4, 15}, {4, 
                 $CellContext`funcC4F05[4]}}], Black, 
              Text[
               Framed[
                Pane[
                "Local minimum:\nNo smaller value of \!\(TraditionalForm\`f\) \
nearby.", {120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {4, 15}, {0, -1}], 
              Text["\!\(TraditionalForm\`d\)", {4, 0}, {0, 1.5}], 
              Point[{4, 
                $CellContext`funcC4F05[4]}], Black}, Black], 
            If[$CellContext`xValue$$ >= 6.99, {Gray, 
              Line[{{7, 30}, {7, 
                 $CellContext`funcC4F05[7]}}], Black, 
              Text[
               Framed[
                Pane[
                "Absolute maximum:\nNo greater value of \
\!\(TraditionalForm\`f\) on \!\(TraditionalForm\`\([a, b]\)\). Also a local \
maximum.", {120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {7, 30}, {0, 1}], 
              Text["\!\(TraditionalForm\`e\)", {7, 0}, {0, 1.5}], 
              Point[{7, 
                $CellContext`funcC4F05[7]}], Black}, Black], Black, 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC4F05[$CellContext`xValue$$]}], 
            Point[{1, 
              $CellContext`funcC4F05[1]}], 
            Point[{8, 
              $CellContext`funcC4F05[8]}]}]}, PlotRange -> {{0, 9}, {-3, 30}},
          AspectRatio -> 0.6, Axes -> {True, False}, 
         AxesLabel -> {"\!\(TraditionalForm\`x\)", None}, 
         AxesOrigin -> {0, 0}, ImageSize -> 8 72, BaseStyle -> {"Text", 13}, 
         AxesStyle -> Arrowheads[{0, 0.025}], 
         Ticks -> {{{1, "\!\(TraditionalForm\`a\)"}, {
            8, "\!\(TraditionalForm\`b\)"}}, None}], 
       "Specifications" :> {{{$CellContext`xValue$$, 1, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1, 8, 0.01, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`xValue$$, 1, ""}, 1, 8, 0.01, ControlType -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{718., {183., 190.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4F05[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{-33 + 56 $CellContext`x - 
              25 $CellContext`x^2 + (13 $CellContext`x^3)/
               3 - $CellContext`x^4/4, 1 <= $CellContext`x <= 
              7}, {(241/12 - 12) ($CellContext`x - 8)^2 + 12, $CellContext`x > 
              7}}], $CellContext`bcR = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4F05[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{-33 + 56 $CellContext`x - 25 $CellContext`x^2 + 
              13 ($CellContext`x^3/3) - $CellContext`x^4/4, 
              1 <= $CellContext`x <= 
              7}, {(241/12 - 12) ($CellContext`x - 8)^2 + 12, $CellContext`x > 
              7}}]}}; Typeset`initDone$$ = True),
...
PluginOptions->{
 "InPlaceRect" -> {1045, 894}, "ContentHimetric" -> {27649, 23654}},
WindowTitle->"Section 4.1, Figure 4.05",
DockedCells->Cell[
  RawBoxes[
   TagBox[
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.1, Figure 4.05"], "Header"]}, {
   Cell[
    TextData["Section 4.1, Figure 4.05"], "Header"], "", 
   Cell[
    TextData[
...
StyleDefinitions->Notebook[{
  ...
  "10.0 for Microsoft Windows (32-bit) (July 1, 2014)", StyleDefinitions -> 
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 6844, 138, 400, "Output"]
}
]
*)
...
(* NotebookSignature mKzHqbrHTPmN6L#PyghuwRXf *)
