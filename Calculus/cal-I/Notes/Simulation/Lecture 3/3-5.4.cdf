...
NotebookDataLength[     38194,        882]
NotebookOptionsPosition[      4800,        113]
NotebookOutlinePosition[     38290,        884]
CellTagsIndexPosition[     38247,        881]
WindowTitle->Section 4.7, Figure 4.79
WindowFrame->Normal*)
    ...
    DynamicModuleBox[{$CellContext`base$$ = 2, $CellContext`power$$ = 2, 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
       ...
       Hold["polynomial degree"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`power$$], 2, ""}, 2, 7, 1}}, Typeset`size$$ = {
     360., {112., 118.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`base$22496$$ = 
     0, $CellContext`power$22497$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`base$$ = 2, $CellContext`power$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`base$$, $CellContext`base$22496$$, 0], 
         Hold[$CellContext`power$$, $CellContext`power$22497$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`base$$^$CellContext`x}, {$CellContext`x, 0, 30}, 
         PlotRange -> {0, 200000}, 
         PlotStyle -> {{Thick, $CellContext`bcB}, {Thick, $CellContext`bcG}}, 
         Epilog -> {
           Text[
            Style[
...
$CellContext`bcB], {0, 130000}, {-2, 1}], 
           Text[
            Style[
             ...
             Row[{"\!\(TraditionalForm\`y\)", " = ", $CellContext`base$$^
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.7, Figure 4.79"], "Header"]}, {
   Cell[
    TextData["Section 4.7, Figure 4.79"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 4205, 90, 294, "Output"]
}
]
*)
...
(* NotebookSignature WINyPbfJp2unqK#DsPNN1L9k *)
