...
NotebookDataLength[     38720,        889]
NotebookOptionsPosition[      5403,        122]
NotebookOutlinePosition[     38816,        891]
CellTagsIndexPosition[     38773,        888]
WindowTitle->Section 5.3, Figure 5.32
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 7, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], 7, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1.1, 9.5, 0.1}},
      Typeset`size$$ = {360., {115., 121.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$387364$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 7}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$387364$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC5F32[$CellContext`x], {$CellContext`x, 
            1, $CellContext`xValue$$}, PlotStyle -> {{Thin, Black}}, Filling -> 
           0, FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[
           $CellContext`funcC5F32[$CellContext`x], {$CellContext`x, 0, 10}, 
           PlotStyle -> {{Thick, Black}}], 
          Graphics[{
            Text["\!\(TraditionalForm\`y = f(t)\)", {9, 7}, {1, 1}], 
            Text[
             Framed[
              Style[
              "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\"A\", \"(\", \n   \
...
RowBox[{SubsuperscriptBox[\"\[Integral]\", \n    RowBox[{\" \", \"a\"}], \n   \
 RowBox[{\" \", \"x\"}]], \n   RowBox[{\n    RowBox[{\"f\", \"(\", \"t\", \")\
\"}], \" \", \"d\", \"\[VeryThinSpace]\", \"t\"}]}]}],\n TraditionalForm]\)", 
               Larger], $CellContext`bcFO, Background -> White], {2.5, 4.5}, {
             0, -1}], 
            Text[
             Framed[
             "constant", {
              RoundingRadius -> 5, FrameStyle -> $CellContext`bcB}, 
              Background -> White], {1, -2}, {0, -1}], 
            Text[
             Framed[
             "variable", {
              RoundingRadius -> 5, FrameStyle -> $CellContext`bcR}, 
              Background -> White], {$CellContext`xValue$$, -2}, {0, -1}], 
            Gray, 
            Arrowheads[{0, 0.03}], 
            Arrow[{{2.5, 4.5}, {(1 + $CellContext`xValue$$)/2, 2}}], Black, 
            Text[
            "\!\(TraditionalForm\`A(x)\)", {(1 + $CellContext`xValue$$)/2, 
              2}, {0, 1.5}]}]}, PlotRange -> {{-0.2, 10}, {-2, 7}}, ImageSize -> 
         5 72, AxesOrigin -> {0, 0}, Ticks -> {{{1, 
             Style[
             "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)", \
$CellContext`bcB]}, {$CellContext`xValue$$, 
             Style[
             "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", \
$CellContext`bcR]}}, None}, AxesStyle -> Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         BaseStyle -> {"Text", 13}], 
       "Specifications" :> {{{$CellContext`xValue$$, 7, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1.1, 9.5, 
          0.1, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{502., {133., 140.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F32[
            Pattern[$CellContext`x, 
             Blank[]]] := -Sin[(Pi/5) $CellContext`x] + 
           5, $CellContext`bcAreaPositiveColor = 
          RGBColor[0.796, 0.91, 0.855], $CellContext`bcFO = {
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`bcB = 
          RGBColor[0, 0.4, 0.8], $CellContext`bcR = RGBColor[0.8, 0, 0.4], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F32[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.3, Figure 5.32"], "Header"]}, {
   Cell[
    TextData["Section 5.3, Figure 5.32"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 4808, 99, 300, "Output"]
}
]
*)
...
(* NotebookSignature NJjsUHheg5TRHI50npdpNy1A *)
