...
NotebookDataLength[     42032,        944]
NotebookOptionsPosition[      8714,        177]
NotebookOutlinePosition[     42127,        946]
CellTagsIndexPosition[     42084,        943]
WindowTitle->Section 5.4, Figure 5.50
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0.5, $CellContext`bValue$$ = 
     3.5, $CellContext`showAvgValue$$ = False, Typeset`show$$ = True, 
...
{0.1839080459770115, -0.1839080459770115}}]],\n TraditionalForm]\)"}, {
     ...
     Typeset`size$$ = {360., {114., 121.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`aValue$388107$$ = 0, $CellContext`bValue$388108$$ = 
     0, $CellContext`showAvgValue$388109$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0.5, $CellContext`bValue$$ = 
         3.5, $CellContext`showAvgValue$$ = False}, 
       "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$388107$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$388108$$, 0], 
         Hold[$CellContext`showAvgValue$$, $CellContext`showAvgValue$388109$$,
           False]}, 
       "OtherVariables" :> {
...
$CellContext`bValue$$ = $CellContext`aValue$$ + 0.1]; 
        Module[{$CellContext`avgValue$}, $CellContext`avgValue$ = \
($CellContext`funcC5F50Antiderivative[$CellContext`bValue$$] - \
$CellContext`funcC5F50Antiderivative[$CellContext`aValue$$])/($CellContext`\
bValue$$ - $CellContext`aValue$$); Show[{
             Plot[
              $CellContext`funcC5F50[$CellContext`x], {$CellContext`x, -0.2, 
               4}, PlotStyle -> {{Thick, Black}}], 
             Plot[
              $CellContext`funcC5F50[$CellContext`x], {$CellContext`x, \
...
{$CellContext`bValue$$, "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}}, 
              ...
              If[$CellContext`showAvgValue$$, {{$CellContext`avgValue$, 
                 "\!\(TraditionalForm\`\*OverscriptBox[\(f\), \(_\)]\)"}}, 
               None]}, BaseStyle -> {"Text", 13}, ImageSize -> 5 72, 
...
{0.1839080459770115, -0.1839080459770115}}]],\n TraditionalForm]\)"}, {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{501., {132., 139.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F50Antiderivative[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          2 $CellContext`x + $CellContext`x ArcTan[2 (-2 + $CellContext`x)] - 
           2 (ArcTan[2 (-2 + $CellContext`x)] + (1/8) 
             Log[17 - 16 $CellContext`x + 
               4 $CellContext`x^2]), $CellContext`funcC5F50[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`bcAreaNegativeColor = 
          RGBColor[
           0.976, 0.871, 0.812], $CellContext`bcAreaNegativeBorderColor = 
          RGBColor[0.796, 0, 0.42]}; {$CellContext`funcC5F50[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          ArcTan[2 ($CellContext`x - 2)] + 
           2, $CellContext`funcC5F50Antiderivative[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          2 $CellContext`x + $CellContext`x ArcTan[2 (-2 + $CellContext`x)] - 
           2 (ArcTan[2 (-2 + $CellContext`x)] + (1/8) 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.4, Figure 5.50"], "Header"]}, {
   Cell[
    TextData["Section 5.4, Figure 5.50"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 8119, 154, 298, "Output"]
}
]
*)
...
(* NotebookSignature 8IjgzYKviTayFJ#bTxJkoiWk *)
