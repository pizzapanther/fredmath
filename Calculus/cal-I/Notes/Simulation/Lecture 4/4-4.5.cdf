...
NotebookDataLength[     41460,        948]
NotebookOptionsPosition[      8142,        181]
NotebookOutlinePosition[     41555,        950]
CellTagsIndexPosition[     41512,        947]
WindowTitle->Section 5.3, Figure 5.45
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showAreaFunction$$ = 
     False, $CellContext`xValue$$ = 1, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       17}, {{
        ...
        Hold[$CellContext`showAreaFunction$$], False, 
        "Show \!\(TraditionalForm\`A(x)\)"}, 0}}, Typeset`size$$ = {
     432., {137., 142.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$387602$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`showAreaFunction$$ = 
         False, $CellContext`xValue$$ = 1}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$387602$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC5F45[$CellContext`x], {$CellContext`x, 0, 16}, 
           PlotStyle -> {{Thick, Black}}, Filling -> 0, 
           FillingStyle -> {{$CellContext`bcAreaNegativeColor, 
              Opacity[0.4]}, {$CellContext`bcAreaPositiveColor, 
              Opacity[0.4]}}], 
          Plot[
           $CellContext`funcC5F45[$CellContext`x], {$CellContext`x, 
            0, $CellContext`xValue$$}, PlotStyle -> {{Thick, Black}}, Filling -> 
           0, FillingStyle -> {$CellContext`bcAreaNegativeColor, \
$CellContext`bcAreaPositiveColor}], 
          Plot[{
            $CellContext`funcC5F45[$CellContext`x], 
            $CellContext`funcC5F45Integral[$CellContext`x]}, {$CellContext`x, 
...
\)\(x\)\)]\(f(t)\)\\ d\[VeryThinSpace]t\)", $CellContext`bcFO, Background -> 
             ...
             Point[{$CellContext`xValue$$, 
               $CellContext`funcC5F45Integral[$CellContext`xValue$$]}]}, 
            Black], Black, 
           Text[
            Style[
            "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", \
       ...
       "Specifications" :> {{{$CellContext`xValue$$, 1, 
          ...
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", 
            "StepRightButton"}}, {{$CellContext`showAreaFunction$$, False, 
           "Show \!\(TraditionalForm\`A(x)\)"}, 0, ControlType -> None}}, 
       "Options" :> {
     ...
     Initialization:>({{$CellContext`funcC5F45[
          ...
          BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             ...
             Left, FontSize -> 13}}; {$CellContext`funcC5F45[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Sin[(Pi/4) $CellContext`x], $CellContext`funcC5F45Integral[
            Pattern[$CellContext`x, 
             Blank[]]] := -(4 (Cos[Pi ($CellContext`x/4)]/Pi)) + 4/Pi}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.3, Figure 5.45"], "Header"]}, {
   Cell[
    TextData["Section 5.3, Figure 5.45"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 7547, 158, 342, "Output"]
}
]
*)
...
(* NotebookSignature cINA8TqOqGKrnIkOqyJQiOuR *)
