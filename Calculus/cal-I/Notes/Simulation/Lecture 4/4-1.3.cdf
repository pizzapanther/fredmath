...
NotebookDataLength[     38217,        882]
NotebookOptionsPosition[      4900,        115]
NotebookOutlinePosition[     38313,        884]
CellTagsIndexPosition[     38270,        881]
WindowTitle->Section 5.1, Figure 5.07
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`nValue$$ = 6, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`nValue$$], 6, "\!\(TraditionalForm\`n\)"}, 6, 15, 
       1}}, Typeset`size$$ = {360., {63., 68.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`nValue$386481$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`nValue$$ = 6}, 
       "ControllerVariables" :> {
         Hold[$CellContext`nValue$$, $CellContext`nValue$386481$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Graphics[{
          ...
          Table[
           ...
           Point[{1 + $CellContext`i (8/$CellContext`nValue$$), 
             0}], {$CellContext`i, {
            0, 1, 2, 3, $CellContext`nValue$$ - 1, $CellContext`nValue$$}}], 
          Black, 
          Text["\[Ellipsis]", {6.7, 0}, {0, -2}], 
          Text["\[Ellipsis]", {6.7, 0}, {0, 2}], Black, 
          Table[
           
           Line[{{1 + $CellContext`i (8/$CellContext`nValue$$), 0.2}, {
             1 + $CellContext`i (8/$CellContext`nValue$$), 
              1}}], {$CellContext`i, {
            0, 1, 2, 3, $CellContext`nValue$$ - 1, $CellContext`nValue$$}}], 
          Table[
           Text[
           "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]x\)", {
            1 + ($CellContext`i + 1/2) (8/$CellContext`nValue$$), 0.8}, {
            0, -1}], {$CellContext`i, {0, 1, 2, $CellContext`nValue$$ - 1}}], 
          
          Arrowheads[{-0.02, 0.02}], 
          Table[
           
           Arrow[{{1 + $CellContext`i (8/$CellContext`nValue$$), 0.7}, {
             1 + ($CellContext`i + 1) (8/$CellContext`nValue$$), 
              0.7}}], {$CellContext`i, {0, 1, 2, $CellContext`nValue$$ - 1}}], 
          Text[
          "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]x = \
\*FractionBox[\(b - a\), \(n\)]\)", {5, 3}, {0, 1}], 
          Table[
           Text[
            Subscript["\!\(TraditionalForm\`x\)", 
             
             If[$CellContext`i == $CellContext`nValue$$ - 1, 
              "\!\(TraditionalForm\`n - 1\)", $CellContext`i]], {
            1 + $CellContext`i (8/$CellContext`nValue$$), 0}, {-1, 
             1.5}], {$CellContext`i, {1, 2, 3, $CellContext`nValue$$ - 1}}], 
          Text[
          "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] = a\)", {1, 0}, {
           0.75, 1.5}], 
          Text[
           
           Row[{"\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(n\)]\)", 
             "\!\(TraditionalForm\`\(\(\[InvisiblePostfixScriptBase]\)\(=\)\(\
b\)\)\)"}], {9, 0}, {-0.75, 1.5}]}, ImageSize -> 5 72, 
         PlotRange -> {{-0.5, 10.5}, {-1, 3}}, BaseStyle -> {"Text", 13}, 
         Axes -> {True, False}, Ticks -> {None, None}], 
       "Specifications" :> {{{$CellContext`nValue$$, 6, 
           "\!\(TraditionalForm\`n\)"}, 6, 15, 1, ControlType -> Slider, 
          ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{501., {80., 87.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({$CellContext`bcB = 
        RGBColor[0, 0.4, 0.8], $CellContext`i = 1, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.1, Figure 5.07"], "Header"]}, {
   Cell[
    TextData["Section 5.1, Figure 5.07"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 4305, 92, 194, "Output"]
}
]
*)
...
(* NotebookSignature HK4e8OtC0hARDIO@1X1RnpWA *)
