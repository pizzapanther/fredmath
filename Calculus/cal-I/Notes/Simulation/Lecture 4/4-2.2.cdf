...
NotebookDataLength[     59131,       1265]
NotebookOptionsPosition[     25812,        498]
NotebookOutlinePosition[     59225,       1267]
CellTagsIndexPosition[     59182,       1264]
WindowTitle->Section 5.2, Figure 5.17
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`intervals$$ = 6, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`intervals$$], 6, "\!\(TraditionalForm\`n\)"}, 2, 20,
        2}, {{
        Hold[$CellContext`intervals$$], 6, ""}, {
       6 -> "\!\(TraditionalForm\`n = 6\)"}}}, Typeset`size$$ = {
     360., {116., 122.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`intervals$2043$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`intervals$$ = 6}, 
       "ControllerVariables" :> {
         Hold[$CellContext`intervals$$, $CellContext`intervals$2043$$, 0]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Module[{$CellContext`x$}, 
           $CellContext`RiemannSum[
            $CellContext`funcC5F17[$CellContext`x$], {$CellContext`x$, 0, 
             3}, $CellContext`ComputationMethod -> 
            "Left", $CellContext`Intervals -> $CellContext`intervals$$, \
$CellContext`ShowPoints -> True, $CellContext`ShowAreaValue -> 
            False, $CellContext`AreaColor -> \
...
$CellContext`bcAreaPositiveBorderColor}]], 
          Graphics[{
            Text[
...
\(2\)]\)", {2.5, -7.5}, {1, -1}], 
            Text[
             Framed[
              Pane[
               Row[{"The positive contribution of the left Riemann sum is ", 
                 Round[
                  
                  Sum[$CellContext`funcC5F17[
                    0 + ($CellContext`i - 
                    1) ((1.5 + 0)/($CellContext`intervals$$/2))] ((1.5 + 
                    0)/($CellContext`intervals$$/2)), {$CellContext`i, 
                    1, $CellContext`intervals$$/2}], 0.001], " ."}], {
               135, Automatic}, $CellContext`bcPBS], $CellContext`bcFO], {0, 
             6}, {-1.1, 1}], 
            Text[
             Framed[
              Pane[
               Row[{"The negative contribution of the left Riemann sum is ", 
                 Round[
            ...
            Text[
             Framed[
              Pane[
               ...
               Row[{"The resulting left Riemann sum on \
\!\(TraditionalForm\`\([0, 3]\)\) is ", 
                 Round[
                  
                  Sum[$CellContext`funcC5F17[
                    0 + ($CellContext`i - 
                    1) ((3 + 0)/$CellContext`intervals$$)] ((3 + 
                    0)/$CellContext`intervals$$), {$CellContext`i, 
         ...
         PlotRange -> {{-0.2, 3.2}, {-7.5, 6}}, Ticks -> {
           Range[0, 3, 0.5], 
           Range[-8, 3, 2]}, AxesOrigin -> {0, 0}, BaseStyle -> {"Text", 13}, 
         ImageSize -> 5 72, AxesStyle -> Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}], 
       "Specifications" :> {{{$CellContext`intervals$$, 6, 
           "\!\(TraditionalForm\`n\)"}, 2, 20, 2, ControlType -> Slider, 
          ImageSize -> Small}, {{$CellContext`intervals$$, 6, ""}, {
          6 -> "\!\(TraditionalForm\`n = 6\)"}, ControlType -> SetterBar}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{501., {134., 141.}},
...
{$CellContext`i, 1, $CellContext`intervals}], "Trapezoid", 
          ...
          Options[$CellContext`RiemannSum] = {$CellContext`Intervals -> 
            ...
            "Uniform"}, $CellContext`funcC5F17[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          1 - $CellContext`x^2, $CellContext`bcAreaNegativeColor = 
          RGBColor[0.976, 0.871, 0.812], $CellContext`bcAreaPositiveColor = 
          RGBColor[
           0.796, 0.91, 0.855], $CellContext`bcAreaNegativeBorderColor = 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`funcC5F16[
            Pattern[$CellContext`x, 
             Blank[]]] := 1 - $CellContext`x^2, 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F17[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.2, Figure 5.17"], "Header"]}, {
   Cell[
    TextData["Section 5.2, Figure 5.17"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 25217, 475, 302, "Output"]
}
]
*)
...
(* NotebookSignature FJNkjIyKNkzlxJkVNaugGxWd *)
