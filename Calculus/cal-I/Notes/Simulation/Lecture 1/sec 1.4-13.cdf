...
NotebookDataLength[     41080,        938]
NotebookOptionsPosition[      8427,        180]
NotebookOutlinePosition[     41857,        950]
CellTagsIndexPosition[     41814,        947]
WindowTitle->Section 2.5, Figure 2.42
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`direction$$ = 1, $CellContext`xValue$$ = 1,
     ...
     False, $CellContext`direction$86699$$ = 
     False, $CellContext`xValue$86700$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = 1, $CellContext`xValue$$ = 
         1}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$86699$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$86700$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F42[$CellContext`x], {$CellContext`x, -5, 5}, 
           PlotStyle -> {Thick, Black}], 
          Graphics[{
            AbsoluteThickness[1.5], Dashed, {$CellContext`bcR, 
             Line[{{-5, 2}, {5, 2}}], 
             Line[{{-5, -2}, {5, -2}}]}, $CellContext`bcR, 
            Line[{{0, 
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], {$CellContext`xValue$$, 0}, {0, Sign[
                 $CellContext`funcC2F42[$CellContext`xValue$$]] 1.5}]], Black, 
            If[$CellContext`direction$$ == 1, 
             Text[
              Framed[
               Pane[
...
, \(x \[Rule] \(-\[Infinity]\)\)]f(x) = \(-2\)\)\)", $CellContext`bcPBS], \
$CellContext`bcFO], {-0.5, -2}, {1, 1.5}]], $CellContext`bcR, 
            Arrowheads[0.06], 
            Opacity[0.5], 
            AbsoluteThickness[5], 
            Dashing[{}], 
         ...
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, Ticks -> {
           ...
           Table[{$CellContext`i, ""}, {$CellContext`i, -3, 7}]}, ImageSize -> 
...
{{$CellContext`direction$$, 1, ""}, {-1 -> 
     ...
     Initialization:>({{$CellContext`funcC2F42[
            Pattern[$CellContext`x, 
             Blank[]]] := (10 $CellContext`x^3 - 3 $CellContext`x^2 + 8)/Sqrt[
           25 $CellContext`x^6 + $CellContext`x^4 + 2], $CellContext`bcR = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F42[
            Pattern[$CellContext`x, 
             Blank[]]] := (10 $CellContext`x^3 - 3 $CellContext`x^2 + 8)/(
            25 $CellContext`x^6 + $CellContext`x^4 + 2)^Rational[1, 2]}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.42"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.42"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7150, 147, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature SL43DJOqelG9zL#lPhTkrtlv *)
