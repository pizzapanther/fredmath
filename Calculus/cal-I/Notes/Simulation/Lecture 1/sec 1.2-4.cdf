...
NotebookDataLength[     38997,        900]
NotebookOptionsPosition[      6344,        142]
NotebookOutlinePosition[     39774,        912]
CellTagsIndexPosition[     39731,        909]
WindowTitle->Section 2.2, Figure 2.10
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 2.25, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["Near \!\(TraditionalForm\`x = 3\)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xValue$$], 2.25, "\!\(TraditionalForm\`x\)"}, 2.05, 
       3.95, 0.01}}, Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ =
      0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$85351$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 2.25}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$85351$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F10[$CellContext`x], {$CellContext`x, 0, 6}, 
           GridLines -> {
             Range[0, 6], 
          ...
          Graphics[{
            ...
            AbsoluteThickness[1], 
            Line[{{3, 0}, {3, 4}, {0, 4}}], White, 
            EdgeForm[Black], 
            Disk[{2, 
              $CellContext`funcC2F10[2]}, 0.12], 
            Disk[{3, 
              $CellContext`funcC2F10[3]}, 0.12], Black, 
            Disk[{2, 5}, 0.1], 
...
\!\(TraditionalForm\`f(x)\) approaches 4.", {
            ...
            If[1.999 < $CellContext`xValue$$ < 2.001, 
             ...
             Disk[{$CellContext`xValue$$, 
               $CellContext`funcC2F10[$CellContext`xValue$$]}, 0.1]], {
            White, 
             EdgeForm[Black], 
             Disk[{3, 4}, 0.12]}, 
            Dashing[{}], 
       ...
       "Specifications" :> {
        "Near \!\(TraditionalForm\`x = 3\)", {{$CellContext`xValue$$, 2.25, 
           "\!\(TraditionalForm\`x\)"}, 2.05, 3.95, 0.01, ControlType -> 
     ...
     Initialization:>({{$CellContext`funcC2F10[
          ...
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC2F10[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Sign[$CellContext`x - 2] Abs[$CellContext`x - 2]^(1/3) + 3}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.2, Figure 2.10"], "Header"]}, {
   Cell[
    TextData["Section 2.2, Figure 2.10"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5067, 109, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 3KNyTZye70R@#KkF9HIFNs1z *)
