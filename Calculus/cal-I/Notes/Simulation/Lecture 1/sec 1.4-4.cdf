...
NotebookDataLength[     42512,        958]
NotebookOptionsPosition[      9859,        200]
NotebookOutlinePosition[     43289,        970]
CellTagsIndexPosition[     43246,        967]
WindowTitle->Section 2.5, Figure 2.30
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showATan$$ = 
     True, $CellContext`showATanAsymptotes$$ = False, $CellContext`showTan$$ =
      True, $CellContext`showTanAsymptotes$$ = False, Typeset`show$$ = True, 
...
x\)"}, {True, False}}, {{
        ...
        "show horizontal asymptotes"}, {True, False}}}, Typeset`size$$ = {
     432., {216., 221.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showTan$86094$$ = 
     False, $CellContext`showTanAsymptotes$86095$$ = 
     False, $CellContext`showATan$86096$$ = 
     False, $CellContext`showATanAsymptotes$86097$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       ...
       "ControllerVariables" :> {
         Hold[$CellContext`showTan$$, $CellContext`showTan$86094$$, False], 
         Hold[$CellContext`showTanAsymptotes$$, \
$CellContext`showTanAsymptotes$86095$$, False], 
         Hold[$CellContext`showATan$$, $CellContext`showATan$86096$$, False], 
         
         Hold[$CellContext`showATanAsymptotes$$, \
$CellContext`showATanAsymptotes$86097$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           Tan[$CellContext`x], {$CellContext`x, (-Pi)/2, Pi/2}, PlotStyle -> {
             If[$CellContext`showTan$$, {Thick, $CellContext`bcB}, None]}, 
           Exclusions -> {(-Pi)/2, Pi/2}, ExclusionsStyle -> None], 
          Plot[{
            ArcTan[$CellContext`x], $CellContext`x}, {$CellContext`x, -5, 5}, 
           PlotStyle -> {
           ...
           If[$CellContext`showATan$$, 
            Text[
            "\!\(TraditionalForm\`y = \*SuperscriptBox[\(tan\), \(-1\)] x\)", \
{2.5, 
              ArcTan[2.5]}, {-1.1, 1}], Black], Dashed, 
           If[
            
            And[$CellContext`showTan$$, $CellContext`showTanAsymptotes$$], \
{$CellContext`bcB, 
             Line[{{(-Pi)/2, -5}, {(-Pi)/2, 5}}], 
             Line[{{Pi/2, -5}, {Pi/2, 5}}], Black, 
             Text[
              Framed[
              "\!\(TraditionalForm\`\*UnderscriptBox[\(lim\), \(x\\  \[Rule] \
\\ \[Pi]/\*SuperscriptBox[\(2\), \(-\)]\)]tan\\ x = \[Infinity]\)", {
               RoundingRadius -> 5, FrameStyle -> $CellContext`bcB, 
                Background -> White}], {Pi/2, 4}, {-1.1, 1}], 
             Text[
              Framed[
              "\!\(TraditionalForm\`\*UnderscriptBox[\(lim\), \(x\\  \[Rule] \
\\ \(-\[Pi]\)/\*SuperscriptBox[\(2\), \(+\)]\)]tan\\ x = \(-\[Infinity]\)\)", \
{RoundingRadius -> 5, FrameStyle -> $CellContext`bcB, Background -> 
                White}], {(-Pi)/2, -4}, {1.1, -1}]}, Black], 
           If[
            And[$CellContext`showATan$$, $CellContext`showATanAsymptotes$$], {
            Orange, 
             Line[{{-5, (-Pi)/2}, {5, (-Pi)/2}}], 
             ...
             Text[
              Framed[
              "\!\(TraditionalForm\`\*UnderscriptBox[\(lim\), \(x\\  \[Rule] \
\\ \[Infinity]\)]\*SuperscriptBox[\(tan\), \(-1\)]\\ x = \
\*FractionBox[\(\[Pi]\), \(2\)]\)", {
...
\(-\*FractionBox[\(\[Pi]\), \(2\)]\)\)", {
               RoundingRadius -> 5, FrameStyle -> Orange, Background -> 
                White}], {-4, (-Pi)/2}, {-1, 1.1}]}, Black], 
           If[
            
            And[$CellContext`showTan$$, $CellContext`showTanAsymptotes$$, \
$CellContext`showATan$$, $CellContext`showATanAsymptotes$$], {Black, 
             Text[
              Framed[
               Pane[
...
\(2\)]\) for \!\(TraditionalForm\`\*SuperscriptBox[\(tan\), \(-1\)] x\).", {
               ...
               RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}], {-4, Pi/
               2}, {-1, -1.1}], 
             Text[
              Framed[
               Pane[
...
\(-1\)] x\).", {2.25 72, Automatic}, 
         ...
         6 72], "Specifications" :> {{{$CellContext`showTan$$, True, 
           "show \!\(TraditionalForm\`y = tan\\ x\)"}, {True, False}, 
          ControlType -> 
...
x\)"}, {True, False}, ControlType -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{635., {233., 239.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({$CellContext`bcB = RGBColor[0, 0.4, 0.8], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.30"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.30"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8582, 167, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature uIj1sxtfDXfyGK5MocOOns9l *)
