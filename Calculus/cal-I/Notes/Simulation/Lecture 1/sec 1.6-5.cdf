...
NotebookDataLength[     44421,       1011]
NotebookOptionsPosition[     11767,        253]
NotebookOutlinePosition[     45197,       1023]
CellTagsIndexPosition[     45154,       1020]
WindowTitle->Section 2.7, Figure 2.67
WindowFrame->Normal*)
...
\[RightBracketingBar]\)\(<\)\)\) ", 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showRangeInterval$87518$$ = 
     False, $CellContext`epsilon$87519$$ = 
     0, $CellContext`showXInterval$87520$$ = False}, 
...
$CellContext`showRangeInterval$87518$$, False], 
         Hold[$CellContext`epsilon$$, $CellContext`epsilon$87519$$, 0], 
         Hold[$CellContext`showXInterval$$, \
$CellContext`showXInterval$87520$$, False]}, 
       "OtherVariables" :> {
             ...
             Text[
              Framed[
               Pane[
                ...
                Row[{"\!\(TraditionalForm\`0 < \[LeftBracketingBar]x - 2\
\[RightBracketingBar]\) < ", 
          ...
          Plot[
           $CellContext`funcC2F67[$CellContext`x], {$CellContext`x, 0, 6}, 
       ...
       "Specifications" :> {{{$CellContext`showRangeInterval$$, True, 
          ...
          ControlPlacement -> 1}, {{$CellContext`epsilon$$, 2, 
           Style["\[Epsilon]", 14]}, {
          2 -> Pane[2, {24, Automatic}, Alignment -> Center], 1 -> 
          ...
          2}, {{$CellContext`epsilon$$, 2, ""}, 0.1, 2, 0.1, ControlType -> 
...
\[RightBracketingBar]\)\(<\)\)\) ", 
     ...
     Initialization:>({{$CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC2F67[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{
             2 ($CellContext`x - 2) + 3, $CellContext`x < 
              2}, {(1/2) ($CellContext`x - 2) + 3, $CellContext`x >= 2}}], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F67[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{
             2 ($CellContext`x - 2) + 3, $CellContext`x < 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.7, Figure 2.67"], "Header"]}, {
   Cell[
    TextData["Section 2.7, Figure 2.67"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 10490, 220, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature ULjv1KJZ8N3QTLkMdsudvQZu *)
