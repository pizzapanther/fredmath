...
NotebookDataLength[     44444,       1011]
NotebookOptionsPosition[     11790,        253]
NotebookOutlinePosition[     45220,       1023]
CellTagsIndexPosition[     45177,       1020]
WindowTitle->Section 2.7, Figure 2.68
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`epsilon$$ = 
     ...
     True, $CellContext`showXInterval$$ = False, $CellContext`xInterval$$ = 1,
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold[
        ...
        Hold[$CellContext`showXInterval$$], False, "Show domain interval"}, {
       True, False}}, {{
...
3\[RightBracketingBar]\)\(<\)\)\) ", 
             Dynamic[$CellContext`epsilon$$]}], {120, Automatic}, 
           BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left, FontSize -> 11}], 2 -> Pane[
           
           Row[{"Symmetric interval centered at \!\(TraditionalForm\`x = 2\) \
that guarantees \!\(TraditionalForm\`\(\(\[LeftBracketingBar]g(x) - 3\
\[RightBracketingBar]\)\(<\)\)\) ", 
             Dynamic[$CellContext`epsilon$$]}], {120, Automatic}, 
           BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showRangeInterval$87587$$ = 
     False, $CellContext`epsilon$87588$$ = 
     0, $CellContext`showXInterval$87589$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`epsilon$$ = 
         1, $CellContext`showRangeInterval$$ = 
         True, $CellContext`showXInterval$$ = False, $CellContext`xInterval$$ = 
         1}, "ControllerVariables" :> {
         Hold[$CellContext`showRangeInterval$$, \
$CellContext`showRangeInterval$87587$$, False], 
         Hold[$CellContext`epsilon$$, $CellContext`epsilon$87588$$, 0], 
         Hold[$CellContext`showXInterval$$, \
$CellContext`showXInterval$87589$$, False]}, 
       "OtherVariables" :> {
          ...
          Graphics[{
            ...
            If[$CellContext`showXInterval$$, {
              ...
              Rectangle[{2 - $CellContext`epsilon$$/2, 0}, {
               2 + If[$CellContext`xInterval$$ == 2, $CellContext`epsilon$$/2,
                   2 $CellContext`epsilon$$], 6}]}, Black], 
            If[$CellContext`showRangeInterval$$, {
            ...
            If[$CellContext`showXInterval$$, {
              ...
              Line[{{2 + 
                 If[$CellContext`xInterval$$ == 2, $CellContext`epsilon$$/2, 
                   2 $CellContext`epsilon$$], 0}, {
                2 + If[$CellContext`xInterval$$ == 2, $CellContext`epsilon$$/
                   2, 2 $CellContext`epsilon$$], 6}}]}, Black], Black, 
            Opacity[1], 
            Text["\!\(TraditionalForm\`y = g(x)\)", {2, 4.5}, {-1, 1}], 
            If[
             And[$CellContext`showXInterval$$, $CellContext`xInterval$$ == 2], 
             Text[
              Framed[
               Pane[
                
                Row[{"\!\(TraditionalForm\`\(\(0\)\(<\)\(\[LeftBracketingBar]\
x - 2\[RightBracketingBar]\)\(<\)\(\\ \)\)\)", 
                  Round[$CellContext`epsilon$$/2, 0.01]}], {
                Automatic, Automatic}], {
               RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}, 
               Background -> White], {2, 0.5}, {0, 0}], Black]}], 
          Plot[
           $CellContext`funcC2F68[$CellContext`x], {$CellContext`x, 0, 6}, 
           PlotStyle -> {Thick, Black}, PlotRange -> {{0, 6}, {0, 6}}], 
          Graphics[{
            EdgeForm[Black], White, 
            Disk[{2, 3}, 0.07]}]}, PlotRange -> {{0, 6}, {0, 6}}, AspectRatio -> 
         1, Axes -> True, 
         AxesLabel -> {
       ...
       "Specifications" :> {{{$CellContext`showRangeInterval$$, True, 
           "Show range interval"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 1}, {{$CellContext`epsilon$$, 1, 
           Style["\[Epsilon]", 14]}, {
          2 -> Pane[2, {24, Automatic}, Alignment -> Center], 1 -> 
           Pane[1, {24, Automatic}, Alignment -> Center]}, ControlType -> 
          SetterBar, Enabled :> Dynamic[$CellContext`showRangeInterval$$], 
          Appearance -> "Vertical", ControlPlacement -> 
          2}, {{$CellContext`epsilon$$, 1, ""}, 0.1, 2, 0.1, ControlType -> 
          Slider, Enabled :> Dynamic[$CellContext`showRangeInterval$$], 
          Appearance -> "Vertical", ImageSize -> Small, ControlPlacement -> 
          3}, 
         Grid[{{
            Manipulate`Place[1], SpanFromLeft}, {
            Spacer[10], 
          ...
          Left], Delimiter, {{$CellContext`showXInterval$$, False, 
           "Show domain interval"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 4}, {{$CellContext`xInterval$$, 1, ""}, 
          Dynamic[{1 -> Pane[
...
3\[RightBracketingBar]\)\(<\)\)\) ", 
              ...
              Row[{
               "Symmetric interval centered at \!\(TraditionalForm\`x = 2\) \
that guarantees \!\(TraditionalForm\`\(\(\[LeftBracketingBar]g(x) - 3\
\[RightBracketingBar]\)\(<\)\)\) ", 
                Dynamic[$CellContext`epsilon$$]}], {120, Automatic}, 
              BaseStyle -> {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{536., {200., 206.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC2F68[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{
             2 ($CellContext`x - 2) + 3, $CellContext`x < 
              2}, {(1/2) ($CellContext`x - 2) + 3, $CellContext`x >= 2}}], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F68[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{
             2 ($CellContext`x - 2) + 3, $CellContext`x < 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.7, Figure 2.68"], "Header"]}, {
   Cell[
    TextData["Section 2.7, Figure 2.68"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 10513, 220, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature NKNn7XxeKje1oJOPxe9RXoEV *)
