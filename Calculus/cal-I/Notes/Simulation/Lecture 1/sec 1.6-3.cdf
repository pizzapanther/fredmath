...
NotebookDataLength[     45793,       1047]
NotebookOptionsPosition[     13139,        289]
NotebookOutlinePosition[     46569,       1059]
CellTagsIndexPosition[     46526,       1056]
WindowTitle->Section 2.7, Figure 2.62
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`delta$$ = Rational[
     1, 4], $CellContext`epsilon$$ = Rational[
     1, 8], $CellContext`showDomainInterval$$ = 
     True, $CellContext`showRangeInterval$$ = True, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        Rational[1, 8], 
        Style["\[Epsilon]", 14]}, {
       1 -> Pane[1, {24, Automatic}, Alignment -> Center], Rational[1, 2] -> 
       ...
       Rational[1, 4] -> 
        Pane["\!\(TraditionalForm\`1/4\)", {24, Automatic}, Alignment -> 
          Center], 1 -> Pane[1, {24, Automatic}, Alignment -> Center], 2 -> 
        Pane[2, {24, Automatic}, Alignment -> Center]}}, {{
        Hold[$CellContext`delta$$], 
        Rational[1, 4], 
       ...
       Hold[
        Grid[{{
           ...
           Row[{
             Style["\[Delta]", 14], " = ", 
             Dynamic[
              N[$CellContext`delta$$]]}], SpanFromLeft}}, Alignment -> Left]],
        Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     360., {183., 188.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showRangeInterval$87368$$ = 
     False, $CellContext`epsilon$87369$$ = 
     0, $CellContext`showDomainInterval$87370$$ = 
     False, $CellContext`delta$87371$$ = 0}, 
...
$CellContext`showRangeInterval$87368$$, False], 
         Hold[$CellContext`epsilon$$, $CellContext`epsilon$87369$$, 0], 
         Hold[$CellContext`showDomainInterval$$, \
$CellContext`showDomainInterval$87370$$, False], 
         Hold[$CellContext`delta$$, $CellContext`delta$87371$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Graphics[{
            ...
            Opacity[1], 
            Text["\!\(TraditionalForm\`y = f(x)\)", {0.5, 5.5}, {-1, 1}]}], 
          Plot[
           $CellContext`funcC2F62[$CellContext`x], {$CellContext`x, 0, 7}, 
...
$CellContext`showDomainInterval$$], {Black, 
              Text[
               Framed[
                Pane[
                "The condition \!\(TraditionalForm\`\[LeftBracketingBar]f(x) \
- L\[RightBracketingBar] < \[Epsilon]\) whenever \!\(TraditionalForm\`0 < \
\[LeftBracketingBar]x - a\[RightBracketingBar] < \[Delta]\) is not always \
satisfied with the current values of \[Epsilon] and \[Delta]. Either increase \
the value of \[Epsilon] or decrease the value of \[Delta].", {
       ...
       "Specifications" :> {{{$CellContext`showRangeInterval$$, True, 
          ...
          Dynamic[$CellContext`showRangeInterval$$], Appearance -> "Vertical",
           ControlPlacement -> 2}, {{$CellContext`epsilon$$, 
           Rational[1, 8], ""}, 0.1, 2, 0.1, ControlType -> Slider, Enabled :> 
          Dynamic[$CellContext`showRangeInterval$$], Appearance -> "Vertical",
         ...
         Grid[{{
          ...
          ControlPlacement -> 4}, {{$CellContext`delta$$, 
           Rational[1, 4], 
           Style["\[Delta]", 14]}, {
          Rational[1, 4] -> 
           Pane["\!\(TraditionalForm\`1/4\)", {24, Automatic}, Alignment -> 
          ...
          SetterBar, Enabled :> Dynamic[$CellContext`showDomainInterval$$], 
          ControlPlacement -> 5}, {{$CellContext`delta$$, 
           Rational[1, 4], 
           Style[" ", 14]}, 0.1, 2.5, 0.1, ControlType -> Slider, Enabled :> 
          Dynamic[$CellContext`showDomainInterval$$], ImageSize -> Small, 
          ControlPlacement -> 6}, 
         Grid[{{
            Manipulate`Place[4], SpanFromLeft}, {
            Spacer[10], 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{541., {200., 206.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC2F62[
            Pattern[$CellContext`x, 
             Blank[]]] := 3.5 + 0.5 $CellContext`x, $CellContext`DisplayNumber[
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}, 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F62[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.7, Figure 2.62"], "Header"]}, {
   Cell[
    TextData["Section 2.7, Figure 2.62"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 11862, 256, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature eKzosv5HAy6IDJ##XAMOEonu *)
