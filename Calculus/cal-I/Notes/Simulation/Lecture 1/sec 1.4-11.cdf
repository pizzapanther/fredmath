...
NotebookDataLength[     41047,        936]
NotebookOptionsPosition[      8394,        178]
NotebookOutlinePosition[     41824,        948]
CellTagsIndexPosition[     41781,        945]
WindowTitle->Section 2.5, Figure 2.39
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`direction$$ = 1, $CellContext`xValue$$ = 2,
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -8., 8., 0.01}},
      Typeset`size$$ = {360., {163., 168.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`direction$86566$$ = 
     False, $CellContext`xValue$86567$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = 1, $CellContext`xValue$$ = 
         2}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$86566$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$86567$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F39[$CellContext`x], {$CellContext`x, -5, 5}, 
           PlotStyle -> {Thick, Black}], 
          Graphics[{
            AbsoluteThickness[1.5], Dashed, {$CellContext`bcR, 
             Line[{{-5, 4}, {5, 4}}]}, $CellContext`bcR, 
            Line[{{0, 
               $CellContext`funcC2F39[$CellContext`xValue$$]}, \
{$CellContext`xValue$$, 
               $CellContext`funcC2F39[$CellContext`xValue$$]}, \
{$CellContext`xValue$$, 0}}], Black, 
            Text[
             Framed[
              Pane[
...
$CellContext`bcFO, Background -> White], {0, 
            ...
            Text[
             Pane[
             "\!\(TraditionalForm\`\(\(g(x)\)\(=\)\)\)\!\(\*FractionBox[\(40 \
\*SuperscriptBox[\(x\), \(4\)] + 4 \*SuperscriptBox[\(x\), \(2\)] - 1\), \(10 \
\*SuperscriptBox[\(x\), \(4\)] + 8 \*SuperscriptBox[\(x\), \(2\)] + 1\)]\)", 
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], {$CellContext`xValue$$, 0}, {0, Sign[
                 $CellContext`funcC2F39[$CellContext`xValue$$]] 1.5}]], Black, 
            If[$CellContext`direction$$ == 1, 
             Text[
              Framed[
               Pane[
...
\[Infinity]\)]g(x) = 4\)", $CellContext`bcPBS], $CellContext`bcFO], {1, 
             ...
             Text[
              Framed[
               Pane[
               "\!\(TraditionalForm\`\(TraditionalForm\`\*SubscriptBox[\(lim\)\
, \(x \[Rule] \(-\[Infinity]\)\)]g(x) = 4\)\)", $CellContext`bcPBS], \
$CellContext`bcFO], {-1, 4}, {1, -1}]], $CellContext`bcR, 
            Arrowheads[0.06], 
            Opacity[0.5], 
            AbsoluteThickness[5], 
            Dashing[{}], 
            Arrow[{{$CellContext`xValue$$, 0}, 
              ...
              If[$CellContext`direction$$ == 
               1, {$CellContext`xValue$$ + 1, 0}, {$CellContext`xValue$$ - 1, 
                0}]}], 
         ...
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, Ticks -> {
           ...
           Table[{$CellContext`i, ""}, {$CellContext`i, -2, 5}]}, ImageSize -> 
         5 72, AxesOrigin -> {0, 0}, AspectRatio -> Automatic, 
         PlotRange -> {{-5, 5}, {-3, 6}}, Method -> {"AxesInFront" -> False}],
        "Specifications" :> {
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) goes to ", \
{{$CellContext`direction$$, 1, ""}, {-1 -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{503., {180., 186.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F39[
            Pattern[$CellContext`x, 
             Blank[]]] := (40 $CellContext`x^4 + 4 $CellContext`x^2 - 1)/(
           10 $CellContext`x^4 + 8 $CellContext`x^2 + 1), $CellContext`bcR = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F39[
            Pattern[$CellContext`x, 
             Blank[]]] := (40 $CellContext`x^4 + 4 $CellContext`x^2 - 1)/(
           10 $CellContext`x^4 + 8 $CellContext`x^2 + 1)}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.39"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.39"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7117, 145, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature WKjIfVWYRTwSCL58QN@wmQ0M *)
