...
NotebookDataLength[     42589,        966]
NotebookOptionsPosition[      9936,        208]
NotebookOutlinePosition[     43366,        978]
CellTagsIndexPosition[     43323,        975]
WindowTitle->Section 2.3, Figure 2.15
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`deltaX$$ = Rational[
     1, 2], $CellContext`direction$$ = -1, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Rational[1, 2], "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 
       0.01, 0.99, 0.01}}, Typeset`size$$ = {360., {201.6875, 208.3125}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`direction$85665$$ = 
     False, $CellContext`deltaX$85666$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`deltaX$$ = 
         Rational[1, 2], $CellContext`direction$$ = -1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$85665$$, 
          False], 
         Hold[$CellContext`deltaX$$, $CellContext`deltaX$85666$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Show[{
             Plot[
              $CellContext`funcC2F15[$CellContext`x], {$CellContext`x, -1, 4},
             ...
             Graphics[{$CellContext`bcR, Dashed, 
               ...
               If[$CellContext`direction$$ == 1, 
                Text[
                "\!\(TraditionalForm\`x\)", {2 + $CellContext`deltaX$$, 0}, {
                 0, 1.5}], 
                Text[
                "\!\(TraditionalForm\`x\)", {1 + $CellContext`deltaX$$, 0}, {
                 0, 1.5}]], 
               Text[
                
                Row[{"(", "\!\(TraditionalForm\`a\)", ", ", 
                  "\!\(TraditionalForm\`f(a)\)", ")"}], {2, 3}, {1.1, -1.5}], 
               Black, 
               If[$CellContext`direction$$ == 1, 
                Text[
                 Framed[
                  Pane[
                  "As \!\(TraditionalForm\`x\) approaches \!\(TraditionalForm\
\`a\) from the right \[Ellipsis] \!\(TraditionalForm\`f(x)\) approaches \
\!\(TraditionalForm\`f(a)\).", {85, Automatic}, 
                   BaseStyle -> {
                    LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                    LineBreakWithin -> Automatic, Hyphenation -> True, 
                    TextAlignment -> Left, FontSize -> 11}], RoundingRadius -> 
                  5, FrameStyle -> Gray, Background -> White], {0, 2}, {-1.1, 
                 1.2}], 
                Text[
                 Framed[
                  Pane[
                  "As \!\(TraditionalForm\`x\) approaches \!\(TraditionalForm\
\`a\) from the left \[Ellipsis] \!\(TraditionalForm\`f(x)\) approaches \
\!\(TraditionalForm\`f(a)\).", {85, Automatic}, 
                   BaseStyle -> {
                    LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                    LineBreakWithin -> Automatic, Hyphenation -> True, 
                    TextAlignment -> Left, FontSize -> 12}], RoundingRadius -> 
                  5, FrameStyle -> Gray], {2, 3}, {-1.2, 
                 1.2}]], $CellContext`bcR, 
               Arrowheads[0.05], 
               Opacity[0.5], 
               AbsoluteThickness[4], 
               ...
               Opacity[1], 
               Text[
               "\!\(TraditionalForm\`y = f(x)\)", {0.5, 4.6}, {-1, 
                1}], $CellContext`bcB, 
               If[$CellContext`direction$$ == 1, 
                Disk[{2 + $CellContext`deltaX$$, 
                  $CellContext`funcC2F15[2 + $CellContext`deltaX$$]}, 0.07], 
                Disk[{1 + $CellContext`deltaX$$, 
                  $CellContext`funcC2F15[1 + $CellContext`deltaX$$]}, 0.07]], 
               
               Disk[{2, 3}, 0.07]}]}, PlotRange -> {{-0.5, 4}, {-0.5, 4.5}}, 
            Ticks -> {{{2, "\!\(TraditionalForm\`a\)"}}, {{
               3, "\!\(TraditionalForm\`f(a)\)"}, {
                $CellContext`funcC2F15[
                 
                 If[$CellContext`direction$$ == 1, 2 + $CellContext`deltaX$$, 
                  1 + $CellContext`deltaX$$]], 
                "\!\(TraditionalForm\`f(x)\)"}}}, AspectRatio -> 1, 
            AxesOrigin -> {0, 0}, 
            AxesLabel -> {
             "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
            BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.05}], 
            ImageSize -> 5 72]}, {
           Framed[
            Pane[
            " \!\(TraditionalForm\`\*UnderscriptBox[\(lim\), \(x \[Rule] \
a\)]f(x) = f(a)\) because \!\(TraditionalForm\`f(x) \[Rule] f(a)\) as\n\
\!\(TraditionalForm\`x \[Rule] a\) from both sides of \
\!\(TraditionalForm\`a\).", {3.5 72, Automatic}, 
             BaseStyle -> {
              LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
               LineBreakWithin -> Automatic, Hyphenation -> True, 
...
{{$CellContext`direction$$, -1, ""}, {-1 -> 
           Pane["left", {36, Automatic}, Alignment -> Center], 1 -> 
           Pane["right", {36, Automatic}, Alignment -> Center]}, ControlType -> 
          SetterBar}, Delimiter, {{$CellContext`deltaX$$, 
           Rational[1, 2], 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0.01, 0.99, 
          0.01, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{519., {220., 226.}},
     ...
     Initialization:>({{$CellContext`funcC2F15[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F15[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x + 1}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.3, Figure 2.15"], "Header"]}, {
   Cell[
    TextData["Section 2.3, Figure 2.15"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8659, 175, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature MLzBz0G8Si1TIJOiCvCGEAUw *)
