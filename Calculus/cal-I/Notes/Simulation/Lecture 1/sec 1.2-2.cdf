...
NotebookDataLength[     38997,        899]
NotebookOptionsPosition[      6344,        141]
NotebookOutlinePosition[     39774,        911]
CellTagsIndexPosition[     39731,        908]
WindowTitle->Section 2.2, Figure 2.08
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.25, Typeset`show$$ = True, 
       ...
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F8[$CellContext`x], {$CellContext`x, 0, 6}, 
           GridLines -> {
             Range[0, 6], 
          ...
          Graphics[{White, 
            EdgeForm[Black], 
            Disk[{2, 
              $CellContext`funcC2F8[2]}, 0.12], 
            Disk[{3, 
              $CellContext`funcC2F8[3]}, 0.12], Black, 
            Disk[{2, 5}, 0.1], 
...
\!\(TraditionalForm\`f(x)\) approaches 2.", {
            ...
            If[1.999 < $CellContext`xValue$$ < 2.001, 
             ...
             Disk[{$CellContext`xValue$$, 
               $CellContext`funcC2F8[$CellContext`xValue$$]}, 0.1]], {White, 
             EdgeForm[Black], 
             Disk[{3, 4}, 0.12]}, 
            ...
            Arrow[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$ - 0.7 
               Sign[$CellContext`xValue$$ - 1], 0}}], 
            Arrow[{{0, 
               $CellContext`funcC2F8[$CellContext`xValue$$]}, {
              0, $CellContext`funcC2F8[$CellContext`xValue$$] - 0.7 
       ...
       "Specifications" :> {
        "Near \!\(TraditionalForm\`x = 1\)", {{$CellContext`xValue$$, 0.25, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0.25, 1.9, 
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F8[
          ...
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC2F8[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Sign[$CellContext`x - 2] Abs[$CellContext`x - 2]^(1/3) + 3}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.2, Figure 2.08"], "Header"]}, {
   Cell[
    TextData["Section 2.2, Figure 2.08"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5067, 108, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature @I4xjvu0jbhNTLkFBIEd9w7@ *)
