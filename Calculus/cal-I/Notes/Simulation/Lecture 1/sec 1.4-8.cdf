...
NotebookDataLength[     40757,        932]
NotebookOptionsPosition[      8104,        174]
NotebookOutlinePosition[     41534,        944]
CellTagsIndexPosition[     41491,        941]
WindowTitle->Section 2.5, Figure 2.34
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`direction$$ = 1, $CellContext`xValue$$ = 1,
     ...
     False, $CellContext`direction$86330$$ = 
     False, $CellContext`xValue$86331$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = 1, $CellContext`xValue$$ = 
         1}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$86330$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$86331$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F34[$CellContext`x], {$CellContext`x, -2, 2}, 
           PlotStyle -> {Thick, Black}, PlotRange -> {-3, 3}], 
...
$CellContext`bcFO], {-0.1, 1.8}, {1, 1}]], Black, 
            ...
            If[$CellContext`direction$$ == 1, {$CellContext`bcR, Dashed, 
              ...
              Arrow[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$ + 0.5,
...
{-0.3, 2.8}, {1, 1}], $CellContext`bcB, 
            AbsolutePointSize[7], 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC2F34[$CellContext`xValue$$]}]}]}, 
         PlotRange -> {{-2.2, 2.2}, {-3, 3}}, AspectRatio -> 1, Ticks -> None,
          AxesOrigin -> {0, 0}, 
         AxesLabel -> {
...
{{$CellContext`direction$$, 1, ""}, {-1 -> 
     ...
     Initialization:>({{$CellContext`funcC2F34[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC2F34[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x^3}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.34"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.34"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6827, 141, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature zLj9mz1lVKeeEKOcETA8TAxk *)
