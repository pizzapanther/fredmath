...
NotebookDataLength[     46372,       1038]
NotebookOptionsPosition[     13718,        280]
NotebookOutlinePosition[     47148,       1050]
CellTagsIndexPosition[     47105,       1047]
WindowTitle->Section 2.1, Figure 2.06
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`timeValue$$ = 2, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["time"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`timeValue$$], 2, "\!\(TraditionalForm\`t\)"}, 0.1, 
       2.5, 0.001}}, Typeset`size$$ = {620., {238.34375, 243.65625}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`timeValue$85075$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`timeValue$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`timeValue$$, $CellContext`timeValue$85075$$, 0]}, 
       "OtherVariables" :> {
...
change in time: \!\(TraditionalForm\`\*SubscriptBox[\(v\), \(av\)] = \
...
\*SubscriptBox[\(t\), \(0\)]\)]\).", {165, Automatic}, 
                 ...
                 BaseStyle -> {
                  LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                   ...
                   TextAlignment -> Left, Background -> LightPurple}], {
                0.9, 70}, {-1, 1}], 
               Text[
               "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 s", {
                0.3, 80}, {-1, 
                 Sign[$CellContext`timeValue$$ - 1]}], 
               Text[
                Row[{"\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = ", 
                  Round[$CellContext`timeValue$$, 0.1], " s"}], {0.3, 
                 $CellContext`funcC2F1[$CellContext`timeValue$$]}, {-1, -
                 Sign[$CellContext`timeValue$$ - 1]}], Gray, 
               AbsolutePointSize[7], 
               Point[{{0.2, 
                  $CellContext`funcC2F1[1]}, {0.2, 
                  $CellContext`funcC2F1[$CellContext`timeValue$$]}}], 
               Polygon[{{0, 0}, {0.1, 0}, {0.1, 140}, {0, 140}}, VertexColors -> {
                  GrayLevel[0.4], 
                  GrayLevel[0.4], 
                  GrayLevel[0.9], 
                  GrayLevel[0.9]}], Dashed, $CellContext`bcR, 
               Line[{{0.3, 
                  $CellContext`funcC2F1[$CellContext`timeValue$$]}, {2.9, 
                  $CellContext`funcC2F1[$CellContext`timeValue$$]}}], 
               Line[{{0.3, 
                  $CellContext`funcC2F1[1]}, {2.9, 
                  $CellContext`funcC2F1[1]}}]}]}, Ticks -> {
              Range[0, 3, 0.5], {80, 
               Round[
                $CellContext`funcC2F1[$CellContext`timeValue$$], 1]}}, 
            PlotRange -> {{-0.25, 2.9}, {-10, 160}}, 
            BaseStyle -> {"Text", 12}, PlotLabel -> 
            Column[{}, ItemSize -> {1, 1}], ImageSize -> 4.25 72, AspectRatio -> 
            1/GoldenRatio, AxesLabel -> {
              Column[{}, ItemSize -> {1, 1}], 
              Column[{}, ItemSize -> {1, 1}]}, Axes -> True, 
            AxesStyle -> {LightPurple, Black}, Background -> LightPurple], 
           Show[{
             Plot[{
               $CellContext`funcC2F1[$CellContext`t], 
               Derivative[1][$CellContext`funcC2F1][1] ($CellContext`t - 
                 1) + $CellContext`funcC2F1[
                1], (($CellContext`funcC2F1[$CellContext`timeValue$$] - \
$CellContext`funcC2F1[1])/($CellContext`timeValue$$ - 1)) ($CellContext`t - 
                 1) + $CellContext`funcC2F1[1]}, {$CellContext`t, 0, 2.5}, 
...
\(\*SubscriptBox[\(t\), \(1\)] - \*SubscriptBox[\(t\), \(0\)]\)]\).", {
                 165, Automatic}, Alignment -> {Left, Top}, 
                 BaseStyle -> {
                  LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                   LineBreakWithin -> Automatic, Hyphenation -> True, 
                   TextAlignment -> Left, Background -> LightOrange}], {1, 
                72}, {-1, 1}], 
               AbsolutePointSize[8], $CellContext`bcB, 
               Point[{1, 
                 $CellContext`funcC2F1[1]}], 
               Point[{$CellContext`timeValue$$, 
                 $CellContext`funcC2F1[$CellContext`timeValue$$]}], Black, 
               Text["(1, 80)", {1, 80}, {1, -2}], Dashed, $CellContext`bcR, 
               Line[{{0, 
                  $CellContext`funcC2F1[$CellContext`timeValue$$]}, \
{$CellContext`timeValue$$, 
                  $CellContext`funcC2F1[$CellContext`timeValue$$]}}], 
               Line[{{0, 
                  $CellContext`funcC2F1[1]}, {1, 
                  $CellContext`funcC2F1[1]}}]}]}, Ticks -> {
              Range[0, 3, 0.5], {80, 
               Round[
                $CellContext`funcC2F1[$CellContext`timeValue$$], 1]}}, 
            ...
            AxesLabel -> {
             "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) (s)", 
              "\!\(\*\nStyleBox[\"s\",\nFontSlant->\"Italic\"]\) (ft)"}, 
            BaseStyle -> {"Text", 12}, AxesStyle -> Arrowheads[{0, 0.04}], 
            PlotLabel -> 
            Style["\!\(TraditionalForm\`s(t) = \(-16\) \
\*SuperscriptBox[\(t\), \(2\)] + 96  t\)", 13], ImageSize -> 4.25 72, 
...
is the limit of the average velocities as \!\(TraditionalForm\`t\) approaches \
1.", {216, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, Background -> 
                 White], {0, 160}, {-1.2, 1.1}], 
               Text[
               "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 s", {
                0.3, 80}, {-1, 1}], 
...
\[Rule] 1\)]\*FractionBox[\(s \((t)\) - s \((1)\)\), \(t - 1\)]\)"}, {
                 ...
                 Alignment -> {{Right, Center, Left}}], {0.3, 75}, {-1, 1}], 
               Gray, 
               AbsolutePointSize[7], 
               Point[{0.2, 
                 $CellContext`funcC2F1[1]}], 
            ...
            1/GoldenRatio, AxesLabel -> {
              Column[{}, ItemSize -> {1, 1}], 
              Column[{}, ItemSize -> {1, 1}]}, Axes -> True, AxesStyle -> {
...
\[Rule] 1\)]\*FractionBox[\(s \((t)\) - s \((1)\)\), \(t - 1\)]\)"}, {
               ...
               Text[
                Framed[
                 Pane[
                 "The slope of the tangent line at \!\(TraditionalForm\`\((1, \
80)\)\) is the limit of the slopes of the secant lines as \!\(TraditionalForm\
\`t\) approaches 1.", {
                  210, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                 Background -> White], {0, 170}, {-1.05, 1.05}]}]}, 
            Ticks -> {
              Range[0, 3, 0.5], {80}}, 
            ...
            Style["\!\(TraditionalForm\`s(t) = \(-16\) \
\*SuperscriptBox[\(t\), \(2\)] + 96  t\)", 13], ImageSize -> 4.25 72, 
            Background -> Darker[LightOrange, 0.1]]}}], 
       "Specifications" :> {
        Delimiter, 
         "time", {{$CellContext`timeValue$$, 2, "\!\(TraditionalForm\`t\)"}, 
          0.1, 2.5, 0.001, ControlType -> Slider, ImageSize -> Small, 
          Exclusions -> {1., 1}}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{760., {256., 262.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F1[
...
$CellContext`bcR = RGBColor[0.8, 0, 0.4], 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}}; {$CellContext`funcC2F1[
            Pattern[$CellContext`t, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.1, Figure 2.06"], "Header"]}, {
   Cell[
    TextData["Section 2.1, Figure 2.06"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 12441, 247, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature UIjvDbRENVZsPI5GdAG#V7s# *)
