...
NotebookDataLength[     45930,       1025]
NotebookOptionsPosition[     13276,        267]
NotebookOutlinePosition[     46706,       1037]
CellTagsIndexPosition[     46663,       1034]
WindowTitle->Section 2.1, Figure 2.02
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`avgVelocity$$ = {1, 3}, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["Average Velocity"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`avgVelocity$$], {1, 3}, ""}, {{0, 1} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 0 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1", {108, Automatic}, Alignment -> 
          Center], {0, 2} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 0 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 2", {108, Automatic}, Alignment -> 
          Center], {0, 3} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 0 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 3", {108, Automatic}, Alignment -> 
          Center], {1, 2} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 2", {108, Automatic}, Alignment -> 
          Center], {1, 3} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 3", {108, Automatic}, Alignment -> 
          Center], {1, 4} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 4", {108, Automatic}, Alignment -> 
          Center], {2, 3} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 2 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 3", {108, Automatic}, Alignment -> 
          Center], {2, 4} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 2 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 4", {108, Automatic}, Alignment -> 
     ...
     Typeset`size$$ = {360., {119., 125.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`avgVelocity$84864$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`avgVelocity$$ = {1, 3}}, 
       "ControllerVariables" :> {
         Hold[$CellContext`avgVelocity$$, $CellContext`avgVelocity$84864$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F1[$CellContext`t], {$CellContext`t, 0, 4}, 
           PlotStyle -> {Thick, Black}], 
          Graphics[{
            AbsolutePointSize[8], Dashed, 
            AbsoluteThickness[1], $CellContext`bcR, 
            Map[Line[{{0, 
                $CellContext`funcC2F1[#]}, {#, 
                $CellContext`funcC2F1[#]}}]& , $CellContext`avgVelocity$$], 
            Gray, 
            Dashing[{}], Thick, 
            Map[Arrow[{{-0.45, 0}, {-0.45, 
                $CellContext`funcC2F1[#]}}]& , $CellContext`avgVelocity$$], 
            If[$CellContext`avgVelocity$$ =!= {}, {$CellContext`bcR, Thick, 
              Line[{{
              ...
              Line[{{0, ((-($CellContext`funcC2F1[
                    
                    Part[$CellContext`avgVelocity$$, 
                    2]] - $CellContext`funcC2F1[
                    Part[$CellContext`avgVelocity$$, 1]]))/(
                   Part[$CellContext`avgVelocity$$, 2] - 
                   Part[$CellContext`avgVelocity$$, 1])) 
                  Part[$CellContext`avgVelocity$$, 1] + $CellContext`funcC2F1[
                  
                   Part[$CellContext`avgVelocity$$, 1]]}, {
                4.5, (($CellContext`funcC2F1[
               ...
               Row[{$CellContext`funcC2F1[
                ...
                Part[$CellContext`avgVelocity$$, 2], (1/
                 2) ($CellContext`funcC2F1[
                   ...
                   Part[$CellContext`avgVelocity$$, 
                    2]] + $CellContext`funcC2F1[
                   Part[$CellContext`avgVelocity$$, 1]])}, {-2, 0}], 
              Text[
...
\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 3", {108, Automatic}, 
           ...
           Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 to \
\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 4", {108, Automatic}, 
             Alignment -> Center], {2, 3} -> 
           Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 2 to \
\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 3", {108, Automatic}, 
             Alignment -> Center], {2, 4} -> 
           Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 2 to \
\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 4", {108, Automatic}, 
             Alignment -> Center], {} -> 
           Pane["None", {108, Automatic}, Alignment -> Center]}, ControlType -> 
          SetterBar, Appearance -> "Vertical", Alignment -> "Top"}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{512., {137., 142.}},
...
$CellContext`bcR = RGBColor[0.8, 0, 0.4], $CellContext`bcG = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F1[
            Pattern[$CellContext`t, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.1, Figure 2.02"], "Header"]}, {
   Cell[
    TextData["Section 2.1, Figure 2.02"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 11999, 234, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature QLjFiozrORHBtKkIcdNbG7xF *)
