...
NotebookDataLength[     40728,        937]
NotebookOptionsPosition[      8075,        179]
NotebookOutlinePosition[     41505,        949]
CellTagsIndexPosition[     41462,        946]
WindowTitle->Section 2.6, Figure 2.50
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`continuityChoice$$ = 1, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["interval"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`continuityChoice$$], 1, ""}, {
       1 -> Pane[
         "\!\(TraditionalForm\`\([a, b]\)\)", {108, Automatic}, Alignment -> 
          Left], 2 -> 
        Pane["\!\(TraditionalForm\`\([a, b)\)\\ \\ \\ y = f(x)\)", {
          108, Automatic}, Alignment -> Left], 3 -> 
        Pane["\!\(TraditionalForm\`\((a, b]\)\\ \\ \\ y = g(x)\)", {
          108, Automatic}, Alignment -> Left], 4 -> 
        Pane["\!\(TraditionalForm\`\((a, b)\)\)", {108, Automatic}, Alignment -> 
          Left]}}}, Typeset`size$$ = {288., {149., 154.}}, Typeset`update$$ = 
     0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`continuityChoice$86825$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`continuityChoice$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`continuityChoice$$, \
$CellContext`continuityChoice$86825$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F50[$CellContext`x], {$CellContext`x, 1, 4.5}, 
           PlotStyle -> {{Black, Thick}}], 
          Graphics[{
            EdgeForm[Black], 
            Switch[$CellContext`continuityChoice$$, 1, {
              Disk[{1, 
                $CellContext`funcC2F50[1]}, 0.075], 
              Disk[{4.5, 
                $CellContext`funcC2F50[4.5]}, 0.075], Black, 
              Text[
               Framed[
                Pane[
                "Continuous\non \!\(TraditionalForm\`\([a, b]\)\)", {
                 Automatic, 
                  Automatic}, $CellContext`bcPBS], $CellContext`bcFO], {5, 
               5}, {1, 1}]}, 2, {Black, 
              Disk[{1, 
                $CellContext`funcC2F50[1]}, 0.075], White, 
              Disk[{4.5, 
                $CellContext`funcC2F50[4.5]}, 0.075], Black, 
              Text["\!\(TraditionalForm\`y = f(x)\)", {1, 
                $CellContext`funcC2F50[1]}, {-1, -2}], 
              Text[
               Framed[
                Pane[
                "Continuous\non \!\(TraditionalForm\`\([a, b)\)\)", {
              ...
              Text[
               Framed[
                Pane[
                "Right-continuous\nat \!\(TraditionalForm\`x = a\)", {
                 Automatic, 
                  Automatic}, $CellContext`bcPBS], $CellContext`bcFO], {0, 
               3}, {-1.2, 1}]}, 3, {White, 
              Disk[{1, 
                $CellContext`funcC2F50[1]}, 0.075], Black, 
              Disk[{4.5, 
                $CellContext`funcC2F50[4.5]}, 0.075], Black, 
              Text["\!\(TraditionalForm\`y = g(x)\)", {1, 
                $CellContext`funcC2F50[1]}, {-1, -2}], 
              Text[
               Framed[
                Pane[
              ...
              Text[
               Framed[
                Pane[
                "Left-continuous\nat \!\(TraditionalForm\`x = b\)", {
                 Automatic, 
                  Automatic}, $CellContext`bcPBS], $CellContext`bcFO], {4, 
               1}, {1, 1}]}, 4, {White, 
              Disk[{1, 
                $CellContext`funcC2F50[1]}, 0.075], White, 
              Disk[{4.5, 
        ...
        "interval", {{$CellContext`continuityChoice$$, 1, ""}, {
          1 -> Pane[
           ...
           Pane["\!\(TraditionalForm\`\((a, b]\)\\ \\ \\ y = g(x)\)", {
             108, Automatic}, Alignment -> Left], 4 -> 
           Pane["\!\(TraditionalForm\`\((a, b)\)\)", {108, Automatic}, 
             Alignment -> Left]}, ControlType -> SetterBar, Appearance -> 
          "Vertical"}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{440., {166., 172.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F50[
            Pattern[$CellContext`x, 
             Blank[]]] := ((-1)/4) ($CellContext`x - 1)^2 + 
           4, $CellContext`bcPBS = 
          BaseStyle -> {
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F50[
            Pattern[$CellContext`x, 
             Blank[]]] := ((-1)/4) ($CellContext`x - 1)^2 + 4}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.50"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.50"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6798, 146, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature yJjxL8GY@Xp7#L#LM1kZRndu *)
