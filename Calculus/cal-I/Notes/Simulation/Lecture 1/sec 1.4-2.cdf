...
NotebookDataLength[     40355,        923]
NotebookOptionsPosition[      7685,        164]
NotebookOutlinePosition[     41132,        935]
CellTagsIndexPosition[     41089,        932]
WindowTitle->Section 2.4, Figure 2.23b
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`direction$$ = -1, $CellContext`xValue$$ = 
     1, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
       Hold[
       "\!\(TraditionalForm\`\(\(x\)\(\\ \)\(goes\)\(\\ \)\(to\)\(\\ \)\)\)"],
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -4.49, 4.49, 
       0.01}}, Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`direction$85998$$ = 
     False, $CellContext`xValue$85999$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = -1, $CellContext`xValue$$ = 
         1}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$85998$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$85999$$, 0]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Graphics[{$CellContext`bcR, Black, 
             ...
             Text[
              Framed[
               ...
               RoundingRadius -> 5, FrameStyle -> 
                GrayLevel[0.85]}], {$CellContext`xValue$$, 0}, {0, 1.5}], 
             Text[
              Framed[
               Pane[
               "\!\(TraditionalForm\`x \[Rule] \(-\[Infinity]\)\)", 
            ...
            Text["\!\(TraditionalForm\`f(x)\)", {0, 
              $CellContext`funcC2T6[$CellContext`xValue$$]}, {
             Sign[$CellContext`xValue$$] 1.25, 0}], 
            If[$CellContext`direction$$ == 1, {$CellContext`bcR, Dashed, 
              AbsoluteThickness[1.5], 
              Line[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 
                 $CellContext`funcC2T6[$CellContext`xValue$$]}, {0, 
                 $CellContext`funcC2T6[$CellContext`xValue$$]}}], 
              Opacity[0.5], 
              AbsoluteThickness[5], 
              Dashing[{}], 
...
\)\)\)", {{$CellContext`direction$$, -1, ""}, {-1 -> 
     ...
     Initialization:>({{$CellContext`funcC2T6[
          ...
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC2T6[
            Pattern[$CellContext`x, 
         ...
         GridBox[{{"\"Section \"", "\"2.4\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"2\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"23b\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.4, Figure 2.23b"], "Header"]}, {
   Cell[
    TextData["Section 2.4, Figure 2.23b"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 6407, 131, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 4Iz@mIx3HYl1cJO5SzSl#tKo *)
