...
NotebookDataLength[     44554,       1009]
NotebookOptionsPosition[     11900,        251]
NotebookOutlinePosition[     45330,       1021]
CellTagsIndexPosition[     45287,       1018]
WindowTitle->Section 2.7, Figure 2.63
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`epsilon$$ = 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       True, False}}, {{
        Hold[$CellContext`xValue$$], 1.3707963267948966`, ""}, 0.1, 2.6, 
       0.01}, {
       Hold[
        Grid[{{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showRangeInterval$87453$$ = 
     False, $CellContext`epsilon$87454$$ = 
     0, $CellContext`showDomainInterval$87455$$ = 
     False, $CellContext`showXValue$87456$$ = 
     False, $CellContext`xValue$87457$$ = 0}, 
...
$CellContext`showRangeInterval$87453$$, False], 
         Hold[$CellContext`epsilon$$, $CellContext`epsilon$87454$$, 0], 
         Hold[$CellContext`showDomainInterval$$, \
$CellContext`showDomainInterval$87455$$, False], 
         Hold[$CellContext`showXValue$$, $CellContext`showXValue$87456$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$87457$$, 0]}, 
       "OtherVariables" :> {
          ...
          Graphics[{
            ...
            If[$CellContext`showDomainInterval$$, {
              ...
              Line[{{Pi/2 + ArcTan[$CellContext`epsilon$$/3], 0}, {
                Pi/2 + ArcTan[$CellContext`epsilon$$/3], 10}}]}, Black]}], 
          Plot[
           $CellContext`funcC2F63[$CellContext`x], {$CellContext`x, 0, Pi}, 
           PlotStyle -> {Thick, Black}, PlotRange -> {0, 10}], 
          Graphics[{Black, 
            Text["\!\(TraditionalForm\`y = f(x)\)", {Pi, 1}, {1, -1}], Dashed, 
            ...
            If[$CellContext`showXValue$$, {
              ...
              Text["\!\(TraditionalForm\`f(x)\)", {0, 
                $CellContext`funcC2F63[$CellContext`xValue$$]}, {-1.5, -1.5}], 
              If[
              Abs[$CellContext`xValue$$ - Pi/2] < 
...
\[RightBracketingBar] < \[Epsilon]\\ \\ since\\ \\ 0 < \[LeftBracketingBar]x \
- a\[RightBracketingBar] < \[Delta]\)", {
                   Automatic, 
...
satisfied.", {Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
         ...
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, PlotLabel -> 
         Style["\!\(TraditionalForm\`\*SubscriptBox[\(lim\), \(x \[Rule] \
a\)]f(x) = L\)", 13], AspectRatio -> 1, ImageSize -> 5 72, Ticks -> {
           ...
           If[$CellContext`showRangeInterval$$, {{
             5 - $CellContext`epsilon$$, 
              "\!\(TraditionalForm\`L - \[Epsilon]\)"}, {
             5, "\!\(TraditionalForm\`L\)"}, {
             5 + $CellContext`epsilon$$, 
              "\!\(TraditionalForm\`L + \[Epsilon]\)"}}, {{
             5, "\!\(TraditionalForm\`L\)"}}]}, BaseStyle -> {"Text", 13}, 
       ...
       "Specifications" :> {{{$CellContext`showRangeInterval$$, True, 
          ...
          ControlPlacement -> 1}, {{$CellContext`epsilon$$, 2, 
           Style["\[Epsilon]", 14]}, 0.1, 4, 0.01, ControlType -> Slider, 
          Enabled :> Dynamic[$CellContext`showRangeInterval$$], Appearance -> 
         ...
         Delimiter, {{$CellContext`showXValue$$, False, 
          ...
          4}, {{$CellContext`xValue$$, 1.3707963267948966`, ""}, 0.1, 2.6, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{527., {197., 203.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC2F63[
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}}; {$CellContext`funcC2F63[
            Pattern[$CellContext`x, 
             Blank[]]] := 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.7, Figure 2.63"], "Header"]}, {
   Cell[
    TextData["Section 2.7, Figure 2.63"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 10623, 218, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature qKNjCEse1duS2LOQnjAiyp9a *)
