...
NotebookDataLength[     39332,        903]
NotebookOptionsPosition[      6679,        145]
NotebookOutlinePosition[     40109,        915]
CellTagsIndexPosition[     40066,        912]
WindowTitle->Section 2.6, Figure 2.51
WindowFrame->Normal*)
    ...
    DynamicModuleBox[{$CellContext`domain$$ = 1, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       ...
       1 -> Pane[
        ...
        Pane["\!\(TraditionalForm\`\((\(-\[Infinity]\), 0]\)\)", {
          48, Automatic}, Alignment -> Center], 3 -> 
        Pane["\!\(TraditionalForm\`\((0, \[Infinity])\)\)", {48, Automatic}, 
          Alignment -> Center], 4 -> 
        Pane["\!\(TraditionalForm\`x = 0\)", {48, Automatic}, Alignment -> 
          Center]}}}, Typeset`size$$ = {288., {144., 149.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`domain$86867$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`domain$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`domain$$, $CellContext`domain$86867$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F51[$CellContext`x], {$CellContext`x, -3, 0}, 
           PlotStyle -> {{Thick, 
              
              Switch[$CellContext`domain$$, 1, Black, 2, Black, 3, LightGray, 
               4, LightGray]}}], 
          Plot[
           $CellContext`funcC2F51[$CellContext`x], {$CellContext`x, 0, 3}, 
           PlotStyle -> {{Thick, 
              
              Switch[$CellContext`domain$$, 1, Black, 2, LightGray, 3, Black, 
               4, LightGray]}}], 
          Graphics[{Black, 
            Text["\!\(TraditionalForm\`y = f(x)\)", {-2, 8}, {-1, 1}], 
            Text[
             Framed[
              Pane[
               
               Switch[$CellContext`domain$$, 1, 
                "Discontinuous on \!\(TraditionalForm\`\((\(-\[Infinity]\), \
\[Infinity])\)\)", 2, 
                "Continuous on \!\(TraditionalForm\`\((\(-\[Infinity]\), 0]\)\
\)", 3, "Continuous on \!\(TraditionalForm\`\((0, \[Infinity])\)\)", 4, 
                "Left-continuous at \!\(TraditionalForm\`x = 0\)"], {
               100, Automatic}, 
               BaseStyle -> {
            ...
            Switch[$CellContext`domain$$, 1, Black, 2, Black, 3, LightGray, 4,
              Black], 
            Disk[{0, 1}, 0.2 Normalize[{7, 13}]], White, 
            Disk[{0, 5}, 0.2 Normalize[{7, 13}]]}]}, ImageSize -> 4 72, 
         AspectRatio -> 1, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.05}], Ticks -> {
           Range[-3, 3], 
           Range[0, 10, 2]}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         PlotRange -> {{-3.5, 3.5}, {-2, 11}}], 
       "Specifications" :> {
        "domain", {{$CellContext`domain$$, 1, ""}, {
          1 -> Pane[
           ...
           Pane["\!\(TraditionalForm\`\((\(-\[Infinity]\), 0]\)\)", {
             48, Automatic}, Alignment -> Center], 3 -> 
           Pane["\!\(TraditionalForm\`\((0, \[Infinity])\)\)", {
             48, Automatic}, Alignment -> Center], 4 -> 
           Pane["\!\(TraditionalForm\`x = 0\)", {48, Automatic}, Alignment -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{380., {161., 167.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F51[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{$CellContext`x^2 + 1, $CellContext`x < 0}, {
             3 $CellContext`x + 5, $CellContext`x > 0}}], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F51[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{$CellContext`x^2 + 1, $CellContext`x < 0}, {
             3 $CellContext`x + 5, $CellContext`x > 0}}]}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.51"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.51"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5402, 112, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature eIjC4zXVWjC4MLOo8NqV8Lzx *)
