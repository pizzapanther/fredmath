...
NotebookDataLength[     41392,        945]
NotebookOptionsPosition[      8722,        186]
NotebookOutlinePosition[     42169,        957]
CellTagsIndexPosition[     42126,        954]
WindowTitle->Section 2.4, Figure 2.23a
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`deltaX$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       Hold[
       "\!\(TraditionalForm\`x\\ goes\\ to\\ zero\\ from\\ \(\(the\)\(:\)\)\) \
"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`direction$$], -1, ""}, {-1 -> 
        Pane["left", {36, Automatic}, Alignment -> Center], 1 -> 
        Pane["right", {36, Automatic}, Alignment -> Center]}}, {{
        Hold[$CellContext`deltaX$$], 1, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0.01, 1.99, 
       0.01}}, Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`direction$85950$$ = 
     False, $CellContext`deltaX$85951$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`deltaX$$ = 
         1, $CellContext`direction$$ = -1}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$85950$$, 
          False], 
         Hold[$CellContext`deltaX$$, $CellContext`deltaX$85951$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2T6[$CellContext`x], {$CellContext`x, -5, 5}, 
           PlotStyle -> {Thick, Black}, PlotRange -> {-0.5, 10}, 
...
\)", BaseStyle -> {
            ...
            If[$CellContext`direction$$ == 1, {
              Text["\!\(TraditionalForm\`f(x)\)", {0, 
                $CellContext`funcC2T6[0 + $CellContext`deltaX$$]}, {
               1.25, 0}], $CellContext`bcR, Dashed, 
              AbsoluteThickness[1.5], 
              
              Line[{{0 + $CellContext`deltaX$$, 0}, {
                0 + $CellContext`deltaX$$, 
                 $CellContext`funcC2T6[0 + $CellContext`deltaX$$]}, {0, 
                 $CellContext`funcC2T6[0 + $CellContext`deltaX$$]}}], 
              Opacity[0.5], 
              AbsoluteThickness[5], 
              Dashing[{}], 
              ...
              Arrow[{{0 + $CellContext`deltaX$$, 0}, {
                0 + $CellContext`deltaX$$ - 1, 0}}]}, {
              Text["\!\(TraditionalForm\`f(x)\)", {0, 
                $CellContext`funcC2T6[-2 + $CellContext`deltaX$$]}, {-1.25, 
                0}], $CellContext`bcR, Dashed, 
              AbsoluteThickness[1.5], 
              
              Line[{{-2 + $CellContext`deltaX$$, 
                 0}, {-2 + $CellContext`deltaX$$, 
                 $CellContext`funcC2T6[-2 + $CellContext`deltaX$$]}, {0, 
                 $CellContext`funcC2T6[-2 + $CellContext`deltaX$$]}}], 
              Opacity[0.5], 
              AbsoluteThickness[5], 
              Dashing[{}], 
              
              Arrow[{{-2 + $CellContext`deltaX$$, 
                 0}, {-2 + $CellContext`deltaX$$ + 1, 0}}]}], Black, 
            Opacity[1], 
            Text[
            "\!\(TraditionalForm\`f(x) = \*FractionBox[\(1\), SuperscriptBox[\
\(x\), \(2\)]]\)", {1, 4.6}, {-1, 1}], 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`\*SubscriptBox[\(lim\), \(x \[Rule] \
0\)]\*FractionBox[\(1\), SuperscriptBox[\(x\), \(2\)]] = \[Infinity]\)", {
               Automatic, Automatic}, 
               BaseStyle -> {
                LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                 LineBreakWithin -> Automatic, Hyphenation -> True, 
                 TextAlignment -> Left, FontSize -> 13}], {
              RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}], {-4.5, 
              7}, {-1, 0}], $CellContext`bcB, 
            AbsolutePointSize[6], 
            If[$CellContext`direction$$ == 1, 
             Point[{0 + $CellContext`deltaX$$, 
               $CellContext`funcC2T6[0 + $CellContext`deltaX$$]}], 
             Point[{-2 + $CellContext`deltaX$$, 
               $CellContext`funcC2T6[-2 + $CellContext`deltaX$$]}]]}]}, 
         PlotRange -> {{-4.5, 4.5}, {-1.5, 8}}, AspectRatio -> 1, Ticks -> 
         None, AxesOrigin -> {0, 0}, 
         AxesLabel -> {
         ...
         ImageSize -> 4 72], 
       "Specifications" :> {
        "\!\(TraditionalForm\`x\\ goes\\ to\\ zero\\ from\\ \
\(\(the\)\(:\)\)\) ", {{$CellContext`direction$$, -1, ""}, {-1 -> 
           Pane["left", {36, Automatic}, Alignment -> Center], 1 -> 
           Pane["right", {36, Automatic}, Alignment -> Center]}, ControlType -> 
          SetterBar}, 
         Delimiter, {{$CellContext`deltaX$$, 1, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0.01, 1.99, 
          0.01, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, Paneled -> 
         False, Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{444., {161., 167.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2T6[
            Pattern[$CellContext`x, 
             Blank[]]] := 1/$CellContext`x^2, 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`bcB = 
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC2T6[
            Pattern[$CellContext`x, 
         ...
         GridBox[{{"\"Section \"", "\"2.4\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"2\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"23a\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.4, Figure 2.23a"], "Header"]}, {
   Cell[
    TextData["Section 2.4, Figure 2.23a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 7444, 153, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature nL40Tjlf6IWesK5CS@4LVnUj *)
