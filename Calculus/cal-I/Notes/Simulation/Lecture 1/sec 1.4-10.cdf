...
NotebookDataLength[     40996,        935]
NotebookOptionsPosition[      8343,        177]
NotebookOutlinePosition[     41773,        947]
CellTagsIndexPosition[     41730,        944]
WindowTitle->Section 2.5, Figure 2.38
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`direction$$ = 1, $CellContext`xValue$$ = 2,
     ...
     False, $CellContext`direction$86500$$ = 
     False, $CellContext`xValue$86501$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = 1, $CellContext`xValue$$ = 
         2}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$86500$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$86501$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F38[$CellContext`x], {$CellContext`x, -5, 5}, 
           PlotStyle -> {Thick, Black}, Exclusions -> {1., -1.}, 
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], {$CellContext`xValue$$, 0}, {0, Sign[
                 $CellContext`funcC2F38[$CellContext`xValue$$]] 1.5}]], Black, 
            If[$CellContext`direction$$ == 1, 
             Text[
              Framed[
               Pane[
...
, \(x \[Rule] \(-\[Infinity]\)\)]f(x) = 0\)\)", $CellContext`bcPBS], {
               RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85], Background -> 
                White}], {-0.8, -2}, {1, 1}]], $CellContext`bcR, 
            Arrowheads[0.06], 
            Opacity[0.5], 
            AbsoluteThickness[5], 
            Dashing[{}], 
         ...
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, Ticks -> {
           ...
           Table[{$CellContext`i, ""}, {$CellContext`i, -4, 4}]}, ImageSize -> 
         5 72, AxesOrigin -> {0, 0}, AspectRatio -> Automatic, 
         PlotRange -> {{-5, 5}, {-5, 5}}, Method -> {"AxesInFront" -> False}],
        "Specifications" :> {
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) goes to ", \
{{$CellContext`direction$$, 1, ""}, {-1 -> 
     ...
     Initialization:>({{$CellContext`funcC2F38[
           ...
           1), $CellContext`bcR = RGBColor[0.8, 0, 0.4], $CellContext`bcPBS = 
          BaseStyle -> {
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F38[
            Pattern[$CellContext`x, 
             Blank[]]] := (3 $CellContext`x + 2)/($CellContext`x^2 - 1)}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.38"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.38"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7066, 144, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature mKzqh46YaT@BUKOTtvkU75Eq *)
