...
NotebookDataLength[     40872,        934]
NotebookOptionsPosition[      8219,        176]
NotebookOutlinePosition[     41649,        946]
CellTagsIndexPosition[     41606,        943]
WindowTitle->Section 2.2, Figure 2.12
WindowFrame->Normal*)
    ...
    DynamicModuleBox[{$CellContext`deltaX$$ = Rational[
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Rational[1, 2], "x"}, 0.01, 0.99, 0.01}}, Typeset`size$$ = {
     288., {144., 149.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`direction$85456$$ = 
     False, $CellContext`deltaX$85457$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`deltaX$$ = 
         Rational[1, 2], $CellContext`direction$$ = -1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$85456$$, 
          False], 
         Hold[$CellContext`deltaX$$, $CellContext`deltaX$85457$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F12[$CellContext`x], {$CellContext`x, -1, 4}, 
          ...
          Graphics[{
            ...
            If[$CellContext`direction$$ == 1, 
             Line[{{2 + $CellContext`deltaX$$, 0}, {2 + $CellContext`deltaX$$, 
                $CellContext`funcC2F12[2 + $CellContext`deltaX$$]}, {0, 
                $CellContext`funcC2F12[2 + $CellContext`deltaX$$]}}], 
             Line[{{1 + $CellContext`deltaX$$, 0}, {1 + $CellContext`deltaX$$, 
...
\!\(TraditionalForm\`f(x) \[Rule] 3\)", {85, Automatic}, $CellContext`bcPBS], 
               RoundingRadius -> 5, FrameStyle -> Gray, Background -> 
               White], {0, 2}, {-1.1, 1.2}], 
             Text[
              Framed[
               Pane[
...
\!\(TraditionalForm\`f(x) \[Rule] 3\)", {85, Automatic}, $CellContext`bcPBS], 
               RoundingRadius -> 5, FrameStyle -> Gray], {2, 3}, {-1.2, 
              1.2}]], 
            RGBColor[0.8, 0, 0.4], 
            Arrowheads[0.05], 
            Opacity[0.5], 
            ...
            If[$CellContext`direction$$ == 1, {
              Arrow[{{0, 
                 $CellContext`funcC2F12[2 + $CellContext`deltaX$$]}, {
                0, $CellContext`funcC2F12[2 + $CellContext`deltaX$$] - 0.5}}], 
              
              Arrow[{{2 + $CellContext`deltaX$$, 0}, {
                2 + $CellContext`deltaX$$ - 0.5, 0}}]}, {
              Arrow[{{0, 
                 $CellContext`funcC2F12[1 + $CellContext`deltaX$$]}, {
                0, $CellContext`funcC2F12[1 + $CellContext`deltaX$$] + 0.5}}], 
              
              Arrow[{{1 + $CellContext`deltaX$$, 0}, {
                1 + $CellContext`deltaX$$ + 0.5, 0}}]}], Black, 
            Opacity[1], 
            Text[
            "\!\(TraditionalForm\`f(x) = \*FractionBox[\(\*SuperscriptBox[\(x\
\), \(3\)] - 8\), \(4 \((x - 2)\)\)]\)", {0.5, 4.6}, {-1, 
             1}], $CellContext`bcR, 
            EdgeForm[$CellContext`bcR], 
            If[$CellContext`direction$$ == 1, 
             Disk[{2 + $CellContext`deltaX$$, 
               $CellContext`funcC2F12[2 + $CellContext`deltaX$$]}, 0.07], 
             Disk[{1 + $CellContext`deltaX$$, 
               $CellContext`funcC2F12[1 + $CellContext`deltaX$$]}, 0.07]], 
            White, 
            EdgeForm[Black], 
            Disk[{2, 3}, 0.08]}]}, PlotRange -> {{-0.5, 4}, {-0.5, 4.5}}, 
         Ticks -> {
           Range[0, 3], 
...
{{$CellContext`direction$$, -1, ""}, {-1 -> 
          ...
          SetterBar}, Delimiter, {{$CellContext`deltaX$$, 
           Rational[1, 2], "x"}, 0.01, 0.99, 0.01, ControlType -> Slider, 
          ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{451., {161., 167.}},
     ...
     Initialization:>({{$CellContext`funcC2F12[
           ...
           4 ($CellContext`x - 2)), $CellContext`bcPBS = 
          BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left, FontSize -> 13}, $CellContext`bcR = RGBColor[0.8, 0, 0.4], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F12[
            Pattern[$CellContext`x, 
             Blank[]]] := ($CellContext`x^3 - 8)/(4 ($CellContext`x - 2))}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.2, Figure 2.12"], "Header"]}, {
   Cell[
    TextData["Section 2.2, Figure 2.12"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6942, 143, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature KLzp59Bwb8hu5K5XPLXhc8Ux *)
