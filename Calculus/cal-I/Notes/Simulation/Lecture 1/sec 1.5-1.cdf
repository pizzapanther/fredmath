...
NotebookDataLength[     37381,        859]
NotebookOptionsPosition[      4729,        101]
NotebookOutlinePosition[     38159,        871]
CellTagsIndexPosition[     38116,        868]
WindowTitle->Section 2.6, Figure 2.47
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`zoomFactor$$ = 1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`zoomFactor$$], 1, "zoom"}, 1, 5}}, 
     Typeset`size$$ = {360., {133., 139.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`zoomFactor$86770$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`zoomFactor$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`zoomFactor$$, $CellContext`zoomFactor$86770$$, 0]},
        "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[$CellContext`x 
           Sin[1/$CellContext`x], {$CellContext`x, \
(-0.3)/$CellContext`zoomFactor$$, 0.3/$CellContext`zoomFactor$$}, 
           PlotStyle -> {Thick, Black}], 
          Graphics[{Black, 
            Text[
             Framed[
             "Is \!\(TraditionalForm\`h\) continuous at \
\!\(TraditionalForm\`x = 0\)?", $CellContext`bcFO, Background -> 
              White], {(-0.3)/$CellContext`zoomFactor$$, 
              0.2/$CellContext`zoomFactor$$}, {-1, 1}]}]}, 
         PlotRange -> {{(-0.3)/$CellContext`zoomFactor$$, 
            0.3/$CellContext`zoomFactor$$}, {(-0.2)/$CellContext`zoomFactor$$,
             0.2/$CellContext`zoomFactor$$}}, PlotLabel -> 
         Style["\!\(\*FormBox[\n RowBox[{\n  RowBox[{\"h\", \"(\", \"x\", \")\
\"}], \"=\", \n  RowBox[{\"\[Piecewise]\", GridBox[{\n     {\n      \
RowBox[{\"x\", \" \", \"sin\", FractionBox[\"1\", \"x\"]}], \"if\", \n      \
RowBox[{\"x\", \"\[NotEqual]\", \"0\"}]},\n     {\"0\", \"if\", \n      \
RowBox[{\"x\", \"=\", \"0\"}]}\n    }]}]}],\n TraditionalForm]\)", Smaller], 
         Frame -> True, ImageSize -> 5 72, BaseStyle -> {"Text", 13}, 
         AxesStyle -> Arrowheads[{0, 0.04}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         FrameTicks -> {{{-0.2, -0.1, -0.05, 0, 0.05, 0.1, 0.2}, 
            None}, {{-0.2, -0.1, -0.05, 0, 0.05, 0.1, 0.2}, None}}], 
       "Specifications" :> {{{$CellContext`zoomFactor$$, 1, "zoom"}, 1, 5, 
          ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{525., {151., 156.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({$CellContext`bcFO = {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.47"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.47"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 3452, 68, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature WJ4O7bvZr9AtqKkUAvIbFKSw *)
