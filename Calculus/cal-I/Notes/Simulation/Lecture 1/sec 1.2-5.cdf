...
NotebookDataLength[     38119,        879]
NotebookOptionsPosition[      5467,        121]
NotebookOutlinePosition[     38897,        891]
CellTagsIndexPosition[     38854,        888]
WindowTitle->Section 2.2, Figure 2.11
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`accuratePlot$$ = 1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`accuratePlot$$], 1, ""}, {
       1 -> Pane[
         "computer generated plot", {144, Automatic}, Alignment -> Center], 2 -> 
        Pane["accurate plot", {144, Automatic}, Alignment -> Center]}}}, 
     Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`accuratePlot$85406$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`accuratePlot$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`accuratePlot$$, $CellContext`accuratePlot$85406$$, 
          False]}, 
       "OtherVariables" :> {
...
indicates that the function is undefined at this point.", {
       ...
       "Specifications" :> {{{$CellContext`accuratePlot$$, 1, ""}, {
          1 -> Pane[
            "computer generated plot", {144, Automatic}, Alignment -> Center],
            2 -> Pane[
            "accurate plot", {144, Automatic}, Alignment -> Center]}, 
          ControlType -> SetterBar, Appearance -> "Vertical"}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{476., {161., 167.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.2, Figure 2.11"], "Header"]}, {
   Cell[
    TextData["Section 2.2, Figure 2.11"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4190, 88, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature zL4ujHTXf#8wnIOBcC5oLFiF *)
