...
NotebookDataLength[     41122,        942]
NotebookOptionsPosition[      8469,        184]
NotebookOutlinePosition[     41899,        954]
CellTagsIndexPosition[     41856,        951]
WindowTitle->Section 2.5, Figure 2.41
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`direction$$ = 1, $CellContext`xValue$$ = 2,
     ...
     False, $CellContext`direction$86631$$ = 
     False, $CellContext`xValue$86632$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = 1, $CellContext`xValue$$ = 
         2}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$86631$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$86632$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F41[$CellContext`x], {$CellContext`x, -5, 5}, 
           PlotStyle -> {Thick, Black}, Exclusions -> {-1}, 
          ...
          Graphics[{Dashed, 
            ...
            AbsoluteThickness[1.5], {$CellContext`bcR, 
             Tooltip[
              Line[{{-5, -6}, {5, 14}}], 
              "Slant asymptote"]}, $CellContext`bcR, 
            Line[{{0, 
...
\*SuperscriptBox[\(x\), \(2\)] + 6  x - 2\), \(x + 1\)]\)", {0.5, 20}, {-1, 
            ...
            Text[
             Framed[
              Pane[
              "Slant\nasymptote", $CellContext`bcPBS], $CellContext`bcFO], \
{-3, 5}, {1, -1}], 
            Dashing[{}], 
            GrayLevel[0.8], 
            Line[{{-3, 5}, {-2, 0}}], Black, Dashed, 
            Text[
            "\!\(TraditionalForm\`l(x) = 2  x + 4\)", {-4.5, -8}, {-1, 1}], 
...
{{$CellContext`direction$$, 1, ""}, {-1 -> 
     ...
     Initialization:>({{$CellContext`funcC2F41[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F41[
            Pattern[$CellContext`x, 
             Blank[]]] := (2 $CellContext`x^2 + 6 $CellContext`x - 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.41"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.41"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7192, 151, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature SINSM1vREYkdTI#sYnfGqXBV *)
