...
NotebookDataLength[     40608,        931]
NotebookOptionsPosition[      7955,        173]
NotebookOutlinePosition[     41385,        943]
CellTagsIndexPosition[     41342,        940]
WindowTitle->Section 2.5, Figure 2.32
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`direction$$ = 1, $CellContext`xValue$$ = 2,
     ...
     False, $CellContext`direction$86216$$ = 
     False, $CellContext`xValue$86217$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = 1, $CellContext`xValue$$ = 
         2}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$86216$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$86217$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F32[$CellContext`x], {$CellContext`x, -10, 10}, 
           PlotStyle -> {Thick, Black}, Exclusions -> {$CellContext`x == 0}], 
          
          Graphics[{
            AbsoluteThickness[1.5], Dashed, {$CellContext`bcR, 
             Line[{{-10, 2}, {10, 2}}]}, $CellContext`bcR, 
            Line[{{0, 
...
$CellContext`bcPBS], $CellContext`bcFO], {$CellContext`xValue$$, 0}, {
              0, Sign[
                 $CellContext`funcC2F32[$CellContext`xValue$$]] 1.5}]], Black, 
            If[$CellContext`direction$$ == 1, 
             Text[
              Framed[
               Pane[
...
$CellContext`bcFO], {-3, 6}, {1, 1}]], $CellContext`bcR, 
            Arrowheads[0.06], 
            Opacity[0.5], 
            AbsoluteThickness[5], 
            Dashing[{}], 
         ...
         5 72, AxesOrigin -> {0, 0}, PlotRange -> {{-10, 10}, {-2, 10}}], 
       "Specifications" :> {
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) goes to ", \
{{$CellContext`direction$$, 1, ""}, {-1 -> 
     ...
     Initialization:>({{$CellContext`funcC2F32[
            Pattern[$CellContext`x, 
             Blank[]]] := 2 + 10/$CellContext`x^2, $CellContext`bcR = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F32[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.32"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.32"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6678, 140, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature zJzaNRgA7WbwMKk50PeCkQFw *)
