...
NotebookDataLength[     38597,        890]
NotebookOptionsPosition[      5928,        131]
NotebookOutlinePosition[     39375,        902]
CellTagsIndexPosition[     39332,        899]
WindowTitle->Section 2.6, Figure 2.56b
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`yValue$$ = 3, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`yValue$$], 3, 
        "\!\(\*\nStyleBox[\"L\",\nFontSlant->\"Italic\"]\)"}, 1.125, 4.875, 
       0.1}}, Typeset`size$$ = {252., {81., 86.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`yValue$87027$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`yValue$$ = 3}, 
       "ControllerVariables" :> {
         Hold[$CellContext`yValue$$, $CellContext`yValue$87027$$, 0]}, 
       "OtherVariables" :> {
            ...
            ReplaceAll[$CellContext`xVar, 
             N[
              Quiet[
               ...
               Solve[$CellContext`funcC2F56b[$CellContext`xVar] == \
$CellContext`yValue$$, $CellContext`xVar]]]], 
            Blank[Real]]; Show[{
            Plot[
             $CellContext`funcC2F56b[$CellContext`x], {$CellContext`x, 1, 4}, 
            ...
            Graphics[{
              ...
              Black, 
              Point[{{1, 
                 $CellContext`funcC2F56b[1]}, {4, 
                 $CellContext`funcC2F56b[4]}}], 
              Text["\!\(TraditionalForm\`y = f(x)\)", {1, 
                $CellContext`funcC2F56b[1]}, {-1.5, 0}], 
              Text[
              "\!\(TraditionalForm\`L\)", {0, $CellContext`yValue$$}, {2, 0}], 
              Table[{
                Text[
                 Subscript["\!\(TraditionalForm\`c\)", $CellContext`i], {
                  Part[$CellContext`xValues, $CellContext`i], 0}, {0, 1.5}], 
...
$CellContext`yValue$$}}]}, {$CellContext`i, 1, 
                Length[$CellContext`xValues]}]}]}, 
           PlotRange -> {{-1, 5}, {-1, 6}}, AxesOrigin -> {0, 0}, 
           AxesLabel -> {
            "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
           Ticks -> {{{1, "\!\(TraditionalForm\`a\)"}, {
              4, "\!\(TraditionalForm\`b\)"}}, {{
               $CellContext`funcC2F56b[1], "\!\(TraditionalForm\`f(a)\)"}, {
               $CellContext`funcC2F56b[4], "\!\(TraditionalForm\`f(b)\)"}}}, 
           BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.06}], 
           ImageSize -> 3.5 72]], 
       "Specifications" :> {{{$CellContext`yValue$$, 3, 
           "\!\(\*\nStyleBox[\"L\",\nFontSlant->\"Italic\"]\)"}, 1.125, 4.875,
           0.1, ControlType -> Slider, Appearance -> "Vertical", ImageSize -> 
          Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{309., {98., 104.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F56b[
            Pattern[$CellContext`x, 
             
             Blank[]]] := -((($CellContext`x - 1.5) ($CellContext`x - 
               2.5)) ($CellContext`x - 3.5)) + 3, 
          Attributes[Subscript] = {NHoldRest}, 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F56b[
            Pattern[$CellContext`x, 
             
             Blank[]]] := -((($CellContext`x - 1.5) ($CellContext`x - 
               2.5)) ($CellContext`x - 3.5)) + 3}}; Typeset`initDone$$ = True),
         ...
         GridBox[{{"\"Section \"", "\"2.6\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"2\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"56b\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.56b"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.56b"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 4650, 98, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature bJNunvcL5V2qZKk2U0LeL5og *)
