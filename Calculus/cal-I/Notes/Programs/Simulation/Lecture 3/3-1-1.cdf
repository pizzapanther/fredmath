...
NotebookDataLength[     41541,        944]
NotebookOptionsPosition[      8146,        175]
NotebookOutlinePosition[     41636,        946]
CellTagsIndexPosition[     41593,        943]
WindowTitle->Section 4.1, Figure 4.02
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`domainChoice$$ = 1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["interval of interest"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`domainChoice$$], 1, ""}, {
       1 -> Pane[
         "\!\(TraditionalForm\`\((\(-\[Infinity]\), \[Infinity])\)\)", {
          48, Automatic}, Alignment -> Center], 2 -> 
        Pane["\!\(TraditionalForm\`\([0, 2]\)\)", {48, Automatic}, Alignment -> 
          Center], 3 -> 
        Pane["\!\(TraditionalForm\`\((0, 2]\)\)", {48, Automatic}, Alignment -> 
          Center], 4 -> 
        Pane["\!\(TraditionalForm\`\((0, 2)\)\)", {48, Automatic}, Alignment -> 
          Center]}}}, Typeset`size$$ = {288., {160., 167.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`domainChoice$6693$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`domainChoice$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`domainChoice$$, $CellContext`domainChoice$6693$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           ...
           Module[{$CellContext`xMin$, $CellContext`xMax$}, 
            Switch[$CellContext`domainChoice$$, 
              1, {$CellContext`xMin$, $CellContext`xMax$} = {-2, 2}, 
              2, {$CellContext`xMin$, $CellContext`xMax$} = {0, 2}, 
              3, {$CellContext`xMin$, $CellContext`xMax$} = {0, 2}, 
              4, {$CellContext`xMin$, $CellContext`xMax$} = {0, 2}]; Show[{
               Plot[
                $CellContext`funcC4F02[$CellContext`x], {$CellContext`x, \
...
{1, 4}, {-1, 1}], 
                 AbsolutePointSize[7], 
                 EdgeForm[$CellContext`bcR], Thick, Black, 
                 If[$CellContext`domainChoice$$ == 1, {
                   Text[
                    Framed[
                    Pane[
                    "Absolute min of 0 at \!\(TraditionalForm\`x = 0\)", {
                    110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                    Background -> White], {-2.2, 1}, {-1, 1}], 
                   Text[
                    Framed[
                    Pane[
                    "No absolute max", {
                    110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                    Background -> White], {-2.2, 3.8}, {-1, 
                    1}], $CellContext`bcR, 
                   Point[{0, 0}]}, Black], 
                 If[$CellContext`domainChoice$$ == 2, {
                   Text[
                    Framed[
                    Pane[
                    "Absolute min of 0 at \!\(TraditionalForm\`x = 0\)", {
                   ...
                   Text[
                    Framed[
                    Pane[
                    "Absolute max of 4 at \!\(TraditionalForm\`x = 2\)", {
                    110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                    Background -> White], {-2.2, 3.8}, {-1, 
                    1}], $CellContext`bcR, 
                   Point[{0, 0}], 
                   Point[{2, 4}]}, Black], 
                 If[$CellContext`domainChoice$$ == 3, {
                   Text[
                    Framed[
                    Pane[
                    "No absolute min", {
                   ...
                   Point[{2, 4}], White, 
                   Disk[{0, 0}, 0.06]}, Black], 
                 If[$CellContext`domainChoice$$ == 4, {
                   Text[
                    Framed[
                    Pane[
                    "No absolute max or min", {
                    110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                    Background -> White], {-2.2, 3}, {-1, 1}], White, 
                   Disk[{0, 0}, 0.06], 
                   Disk[{2, 4}, 0.06]}, Black]}]}, 
              PlotRange -> {{-2.25, 2.25}, {-0.25, 4.25}}, AspectRatio -> 1, 
              ImageSize -> 4 72, Ticks -> {{0, 2}, {0, 4}}, 
              BaseStyle -> {"Text", 13}, AxesStyle -> 
              Arrowheads[{0, 0.04}]]]}, {
           Pane[
           "The function \!\(TraditionalForm\`f(x) = \*SuperscriptBox[\(x\), \
\(2\)]\) has different absolute extrema depending on the interval of \
interest.", {4 72}, $CellContext`bcPBS]}}, 
         BaseStyle -> {FontFamily -> "Times"}], 
       "Specifications" :> {
        "interval of interest", {{$CellContext`domainChoice$$, 1, ""}, {
          1 -> Pane[
            "\!\(TraditionalForm\`\((\(-\[Infinity]\), \[Infinity])\)\)", {
             48, Automatic}, Alignment -> Center], 2 -> 
           Pane["\!\(TraditionalForm\`\([0, 2]\)\)", {48, Automatic}, 
             Alignment -> Center], 3 -> 
           Pane["\!\(TraditionalForm\`\((0, 2]\)\)", {48, Automatic}, 
             Alignment -> Center], 4 -> 
           Pane["\!\(TraditionalForm\`\((0, 2)\)\)", {48, Automatic}, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{409., {178., 185.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4F02[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x^2, $CellContext`bcR = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4F02[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.1, Figure 4.02"], "Header"]}, {
   Cell[
    TextData["Section 4.1, Figure 4.02"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 7551, 152, 390, "Output"]
}
]
*)
...
(* NotebookSignature QK4cIMjb@Rj8hLOxvEJtlhqn *)
