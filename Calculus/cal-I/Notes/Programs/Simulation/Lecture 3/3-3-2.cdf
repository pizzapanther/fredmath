...
NotebookDataLength[     39350,        907]
NotebookOptionsPosition[      5955,        138]
NotebookOutlinePosition[     39445,        909]
CellTagsIndexPosition[     39402,        906]
WindowTitle->Section 4.4, Figure 4.51
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 75, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], 75, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0, 98, 0.1}}, 
     Typeset`size$$ = {432., {94., 100.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$8027$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 75}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$8027$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Graphics[{
          Inset[
           ...
           Plot[$CellContext`x (400 - 4 $CellContext`x), {$CellContext`x, 0, 
             100}, ImageSize -> 1.8 72, PlotStyle -> {{Black, 
               AbsoluteThickness[1]}}, Ticks -> None, Epilog -> {
              AbsolutePointSize[6], $CellContext`bcR, 
              
              Point[{$CellContext`xValue$$, $CellContext`xValue$$ (400 - 
                 4 $CellContext`xValue$$)}]}, 
            PlotRange -> {{0, 105}, {-100, 10200}}, 
            AxesLabel -> {"\!\(TraditionalForm\`x\)", "Area"}, 
            BaseStyle -> {"Text", 13}], {Left, Bottom}, {Left, Bottom}], 
          Lighter[$CellContext`bcR, 0.8], 
          Opacity[0.5], 
          
          Rectangle[{(-(400 - 4 $CellContext`xValue$$))/
            2, -$CellContext`xValue$$}, {(400 - 4 $CellContext`xValue$$)/2, 
            0}], 
          Opacity[1], $CellContext`bcB, Thick, 
          
          Line[{{(-(400 - 4 $CellContext`xValue$$))/2, 
             0}, {(-(400 - 4 $CellContext`xValue$$))/
             2, -$CellContext`xValue$$}}], 
          Line[{{(-(400 - 4 $CellContext`xValue$$))/6, 
             0}, {(-(400 - 4 $CellContext`xValue$$))/
             6, -$CellContext`xValue$$}}], 
          ...
          Line[{{(400 - 4 $CellContext`xValue$$)/
             2, -$CellContext`xValue$$}, {(-(400 - 4 $CellContext`xValue$$))/
             2, -$CellContext`xValue$$}}], Black, 
          Arrowheads[{-0.03, 0.03}], 
          AbsoluteThickness[1], 
          
          Arrow[{{(400 - 4 $CellContext`xValue$$)/2 + 10, 
             0}, {(400 - 4 $CellContext`xValue$$)/2 + 
             10, -$CellContext`xValue$$}}], 
          Text[
          "\!\(TraditionalForm\`x\)", {(400 - 4 $CellContext`xValue$$)/2 + 
            10, (-$CellContext`xValue$$)/2}, {-3, 0}], 
          
          Arrow[{{(400 - 4 $CellContext`xValue$$)/2, -$CellContext`xValue$$ - 
             10}, {(-(400 - 4 $CellContext`xValue$$))/
             2, -$CellContext`xValue$$ - 10}}], 
          Text[
          "\!\(TraditionalForm\`y\)", {0, -$CellContext`xValue$$ - 10}, {0, 
           2}], LightGray, 
          Rectangle[{-200, 0}, {200, 30}], Black, 
          Text["Barn", {0, 0}, {0, -2}], 
          ...
          Text[
           Framed[
            Pane[
            "Constraint: \!\(TraditionalForm\`4  x + y = 400\)", \
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], {0, -140}, {
           0, -1}]}, PlotRange -> {{-200, 200}, {-140, 40}}, 
         BaseStyle -> {"Text", 13}, ImageSize -> 6 72], 
       "Specifications" :> {{{$CellContext`xValue$$, 75, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0, 98, 0.1, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.4, Figure 4.51"], "Header"]}, {
   Cell[
    TextData["Section 4.4, Figure 4.51"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 5360, 115, 258, "Output"]
}
]
*)
...
(* NotebookSignature aIjgIpAH57o8UIky12m3yGuY *)
