...
NotebookDataLength[     43260,        980]
NotebookOptionsPosition[      9865,        211]
NotebookOutlinePosition[     43355,        982]
CellTagsIndexPosition[     43312,        979]
WindowTitle->Section 4.7, Figure 4.74
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`slopeF$$ = 
     4, $CellContext`slopeG$$ = 2, $CellContext`xValue$$ = 1, Typeset`show$$ =
      True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold[
        Pane[
        "Linear functions \!\(TraditionalForm\`f(x)\) and \!\(TraditionalForm\
\`g(x)\) where \!\(TraditionalForm\`f(a) = \(g(a) = 0\)\).", {144, Automatic},
          BaseStyle -> {
          LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
           Left}]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xValue$$], 1, "\!\(TraditionalForm\`x\)"}, -1, 1}, {{
        Hold[$CellContext`aValue$$], 1, "\!\(TraditionalForm\`a\)"}, 0, 4}, {
       Hold[
       "\!\(TraditionalForm\`f(x) = \*SubscriptBox[\(m\), \(f\)](x - a)\)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`slopeF$$], 4, 
        "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(f\)]\)"}, -5, 5, 0.1}, {
...
$CellContext`slopeF$$ = 4, BaseStyle -> 11]], 
       Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
       "\!\(TraditionalForm\`g(x) = \*SubscriptBox[\(m\), \(g\)](x - a)\)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`slopeG$$], 2, 
        "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(g\)]\)"}, -5, 5, 0.1}, {
...
$CellContext`slopeG$$ = 2, BaseStyle -> 11]], 
     ...
     288., {144., 150.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$22295$$ = 
     0, $CellContext`aValue$22296$$ = 0, $CellContext`slopeF$22297$$ = 
     0, $CellContext`slopeG$22298$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1, $CellContext`slopeF$$ = 
         4, $CellContext`slopeG$$ = 2, $CellContext`xValue$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$22295$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$22296$$, 0], 
         Hold[$CellContext`slopeF$$, $CellContext`slopeF$22297$$, 0], 
         Hold[$CellContext`slopeG$$, $CellContext`slopeG$22298$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
         Typeset`specs$$, Typeset`size$$, Typeset`update$$, 
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Plot[{
          $CellContext`funcC4F74[$CellContext`x, $CellContext`aValue$$, \
$CellContext`slopeF$$], 
          $CellContext`funcC4F74[$CellContext`x, $CellContext`aValue$$, \
$CellContext`slopeG$$]}, {$CellContext`x, -1, 5}, 
         PlotStyle -> {{Thick, $CellContext`bcR}}, 
         PlotRange -> {{-1, 5}, {-5, 5}}, AspectRatio -> 1, ImageSize -> 4 72,
          Ticks -> {{{$CellContext`aValue$$, ""}}, None}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, AxesStyle -> 
         Arrowheads[{0, 0.03}], BaseStyle -> {"Text", 13}, Epilog -> {
           Text[
           "\!\(TraditionalForm\`a\)", {$CellContext`aValue$$, 0}, {-1.5, 
            1.5}], 
           Text[
...
$CellContext`xValue$$, 
             $CellContext`funcC4F74[$CellContext`xValue$$ + \
...
$CellContext`aValue$$, $CellContext`aValue$$, $CellContext`slopeG$$]}}], 
           ...
           GrayLevel[0, 1], 
           AbsolutePointSize[6], 
           Point[{$CellContext`aValue$$ + $CellContext`xValue$$, 
             $CellContext`funcC4F74[$CellContext`xValue$$ + \
$CellContext`aValue$$, $CellContext`aValue$$, $CellContext`slopeG$$]}], 
           Point[{$CellContext`aValue$$ + $CellContext`xValue$$, 
             $CellContext`funcC4F74[$CellContext`xValue$$ + \
           ...
           Text[
            Framed[
             Pane[
              ...
              Row[{"\!\(TraditionalForm\`\*FractionBox[\(f \((x)\)\), \(g \
\((x)\)\)] = \(\*FractionBox[\(f' \((x)\)\), \(g' \((x)\)\)]\(=\)\(\\ \)\)\)", 
                RawBoxes[
                 FractionBox[$CellContext`slopeF$$, $CellContext`slopeG$$]], 
...
0\)\).", {144, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], Delimiter, {{$CellContext`xValue$$, 1, 
           "\!\(TraditionalForm\`x\)"}, -1, 1, ControlType -> Slider, 
          Exclusions -> {0}, ImageSize -> 
          Small}, {{$CellContext`aValue$$, 1, "\!\(TraditionalForm\`a\)"}, 0, 
          4, ControlType -> Slider, ImageSize -> Small}, Delimiter, 
         "\!\(TraditionalForm\`f(x) = \*SubscriptBox[\(m\), \(f\)](x - a)\)", \
{{$CellContext`slopeF$$, 4, 
           "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(f\)]\)"}, -5, 5, 0.1,
...
$CellContext`slopeF$$ = 4, BaseStyle -> 11], Delimiter, 
         "\!\(TraditionalForm\`g(x) = \*SubscriptBox[\(m\), \(g\)](x - a)\)", \
{{$CellContext`slopeG$$, 2, 
           "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(g\)]\)"}, -5, 5, 0.1,
           ControlType -> Slider, Exclusions -> {0}, ImageSize -> Small}, 
         Button[
         "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(g\)] = 2\)", \
$CellContext`slopeG$$ = 2, BaseStyle -> 11]}, 
       "Options" :> {
     ...
     Initialization:>({{$CellContext`funcC4F74[
            ...
            Pattern[$CellContext`m, 
             ...
             Blank[]]] := $CellContext`m ($CellContext`x - $CellContext`a), \
$CellContext`bcR = RGBColor[0.8, 0, 0.4], 
          Attributes[PlotRange] = {ReadProtected}, 
          Attributes[RawBoxes] = {ReadProtected}, $CellContext`bcPBS = 
          BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left, FontSize -> 13}, $CellContext`bcFO = {
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}}; {$CellContext`funcC4F74[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`a, 
             Blank[]], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.7, Figure 4.74"], "Header"]}, {
   Cell[
    TextData["Section 4.7, Figure 4.74"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 9270, 188, 358, "Output"]
}
]
*)
...
(* NotebookSignature 3JjVzggTN2sXvJkyshBFOkvE *)
