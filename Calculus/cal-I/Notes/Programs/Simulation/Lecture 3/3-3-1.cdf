...
NotebookDataLength[     40855,        931]
NotebookOptionsPosition[      7460,        162]
NotebookOutlinePosition[     40950,        933]
CellTagsIndexPosition[     40907,        930]
WindowTitle->Section 4.4, Figure 4.50
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`viewPoint$$ = {-1, -3, 
     10}, $CellContext`xValue$$ = 2, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], 2, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0, 20, 0.1}, {{
        Hold[$CellContext`xValue$$], 2, ""}, 0, 20, 0.1}, {
       Hold[
        Button[
        "maximum \!\(\*\nStyleBox[\"P\",\nFontSlant->\"Italic\"]\)", \
$CellContext`xValue$$ = 10, BaseStyle -> 11]], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`viewPoint$$], {-1, -3, 10}, "view"}, {{-1, -3, 10} -> 
        "3D", {0, 0, 
          DirectedInfinity[1]} -> "2D"}}, {
       Hold[
        Button["reset view", $CellContext`resetView = True, BaseStyle -> 11]],
        Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     288., {141., 147.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$7967$$ = 
     0, $CellContext`viewPoint$7968$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`viewPoint$$ = {-1, -3, 
          10}, $CellContext`xValue$$ = 2}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$7967$$, 0], 
         Hold[$CellContext`viewPoint$$, $CellContext`viewPoint$7968$$, 
          False]}, 
       "OtherVariables" :> {
       ...
       "Body" :> (If[$CellContext`resetView, $CellContext`resetView = False]; 
        Show[{
           
           ParametricPlot3D[{{$CellContext`x, 20 - $CellContext`x, 
              0}, {$CellContext`x, 
              20 - $CellContext`x, $CellContext`x (
               20 - $CellContext`x)}}, {$CellContext`x, 0, 20}, PlotStyle -> {{
               AbsoluteThickness[2], $CellContext`bcR}, {
               AbsoluteThickness[2], $CellContext`bcB}}, PlotPoints -> 100], 
           Graphics3D[{
             ...
             Polygon[{{0, 0, 0}, {20, 0, 0}, {20, 20, 0}, {0, 20, 0}}, 
              VertexColors -> {Pink, 
                Lighter[Pink, 0.6], White, 
                Lighter[Pink, 0.6]}], 
             Opacity[1], Black, 
             Point[{$CellContext`xValue$$, 20 - $CellContext`xValue$$, 0}], 
             
             Point[{$CellContext`xValue$$, 
               20 - $CellContext`xValue$$, $CellContext`xValue$$ (
                20 - $CellContext`xValue$$)}], Gray, 
             
             Line[{{$CellContext`xValue$$, 20 - $CellContext`xValue$$, 
                0}, {$CellContext`xValue$$, 
                20 - $CellContext`xValue$$, $CellContext`xValue$$ (
                 20 - $CellContext`xValue$$)}}], 
             
             Line[{{$CellContext`xValue$$, 20 - $CellContext`xValue$$, 
                0}, {$CellContext`xValue$$, 0, 0}}], 
             
             Line[{{$CellContext`xValue$$, 20 - $CellContext`xValue$$, 0}, {
               0, 20 - $CellContext`xValue$$, 0}}], $CellContext`bcR, 
             Text["\!\(TraditionalForm\`x + y = 20\)", {0, 20, 0}, {-2, -1}], 
             Black, 
             Text["\!\(TraditionalForm\`x\)", {20, 0, 0}, {0, 2}], 
             Text["\!\(TraditionalForm\`y\)", {0, 20, 0}, {2, -2}], 
             Text[
              
              Row[{"(", $CellContext`xValue$$, ", ", 
                20 - $CellContext`xValue$$, ")"}], {$CellContext`xValue$$, 
               20 - $CellContext`xValue$$, 0}, {1, 2}], 
             Text[
              Framed[
               Pane[
                ...
                Row[{"Objective function", "\n", "\!\(TraditionalForm\`P\)", 
                  " = ", $CellContext`xValue$$ (
                   20 - $CellContext`xValue$$)}], $CellContext`bcPBS], \
$CellContext`bcFO, Background -> White], {$CellContext`xValue$$, 
               20 - $CellContext`xValue$$, $CellContext`xValue$$ (
                20 - $CellContext`xValue$$)}, {0, -2}]}]}, 
          PlotRange -> {{-2, 22}, {-2, 22}, {0, 110}}, AspectRatio -> 1, 
          AxesOrigin -> {0, 0, 0}, Axes -> {True, True, False}, Ticks -> None,
           Boxed -> False, ViewPoint -> $CellContext`viewPoint$$, 
          ViewVertical -> {0, 0, 1}, BaseStyle -> {"Text", 13}, ImageSize -> 
          4 72, PreserveImageOptions -> False]), 
       "Specifications" :> {{{$CellContext`xValue$$, 2, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0, 20, 0.1, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`xValue$$, 2, ""}, 0, 20, 0.1, ControlType -> 
         ...
         "maximum \!\(\*\nStyleBox[\"P\",\nFontSlant->\"Italic\"]\)", \
$CellContext`xValue$$ = 10, BaseStyle -> 11], 
         Delimiter, {{$CellContext`viewPoint$$, {-1, -3, 10}, 
           "view"}, {{-1, -3, 10} -> "3D", {0, 0, 
             DirectedInfinity[1]} -> "2D"}, ControlType -> SetterBar}, 
         Button[
         "reset view", $CellContext`resetView = True, BaseStyle -> 11]}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
      ImageSizeCache->{446., {159., 166.}},
     ...
     Initialization:>({{$CellContext`bcR = 
          ...
          Attributes[PlotRange] = {
           ReadProtected}, $CellContext`viewPoint$$ = {-1, -3, 10}}; {Null}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.4, Figure 4.50"], "Header"]}, {
   Cell[
    TextData["Section 4.4, Figure 4.50"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 6865, 139, 352, "Output"]
}
]
*)
...
(* NotebookSignature 3Jj1X5ypE6BFzIkuQDW0IMI5 *)
