...
NotebookDataLength[     38358,        883]
NotebookOptionsPosition[      5318,        122]
NotebookOutlinePosition[     38454,        885]
CellTagsIndexPosition[     38411,        882]
WindowTitle->Section 4.4, Exercise 60
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`bPoint$$ = {
     0.03600000000000003, 0}, $CellContext`cPoint$$ = {2, 0}, Typeset`show$$ =
      True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold[
        Pane[
        "Drag \!\(\*\nStyleBox[\"B\",\nFontSlant->\"Italic\"]\) left and \
right to change the area of the arbelos.", {144, Automatic}, 
         BaseStyle -> {
          LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
           Left}]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`cPoint$$], {2, 0}}, {2, 0}, {2, 0}}, {{
        Hold[$CellContext`bPoint$$], {-0.5, 0}}, {-1.8, 0}, {1.8, 0}}}, 
     Typeset`size$$ = {360., {112., 117.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`cPoint$8392$$ = {0, 
     0}, $CellContext`bPoint$8393$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`bPoint$$ = {-0.5, 
           0}, $CellContext`cPoint$$ = {2, 0}}, "ControllerVariables" :> {
         Hold[$CellContext`cPoint$$, $CellContext`cPoint$8392$$, {0, 0}], 
         Hold[$CellContext`bPoint$$, $CellContext`bPoint$8393$$, {0, 0}]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Graphics[{
          ...
          Disk[{0, 0}, 
           Part[$CellContext`cPoint$$, 1], {0, Pi}], White, 
          
          Disk[{(Part[$CellContext`bPoint$$, 1] + 
             Part[$CellContext`cPoint$$, 1])/2, 0}, (
            Part[$CellContext`cPoint$$, 1] - Part[$CellContext`bPoint$$, 1])/
           2, {0, Pi}], 
          ...
          Disk[{(Part[$CellContext`bPoint$$, 1] - 
           ...
           2, {0, Pi}], 
          EdgeForm[White], 
          Rectangle[{-Part[$CellContext`cPoint$$, 1], -0.02}, {
            Part[$CellContext`cPoint$$, 1], 0.02}], Black, 
          Text[
          "\!\(\*\nStyleBox[\"A\",\nFontSlant->\"Italic\"]\)", \
-$CellContext`cPoint$$, {0, 1.5}], 
          Text[
          "\!\(\*\nStyleBox[\"B\",\nFontSlant->\"Italic\"]\)", \
$CellContext`bPoint$$, {0, 1.5}], 
          Text[
          "\!\(\*\nStyleBox[\"C\",\nFontSlant->\"Italic\"]\)", \
$CellContext`cPoint$$, {0, 1.5}], 
          Text[
          "\!\(\*\nStyleBox[\"D\",\nFontSlant->\"Italic\"]\)", \
$CellContext`bPoint$$ + {
            0, (2^2 - Part[$CellContext`bPoint$$, 1]^2)^Rational[1, 2]}, {
           0, -2}], 
          Line[{$CellContext`bPoint$$, {
             
             Part[$CellContext`bPoint$$, 1], (2^2 - 
              Part[$CellContext`bPoint$$, 1]^2)^Rational[1, 2]}}]}, 
         PlotRange -> {{-2.2, 2.2}, {-0.5, 2.3}}, BaseStyle -> {"Text", 13}], 
       "Specifications" :> {
         Pane[
         "Drag \!\(\*\nStyleBox[\"B\",\nFontSlant->\"Italic\"]\) left and \
right to change the area of the arbelos.", {144, Automatic}, 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"4.4\"", "\", Exercise \"", "\"60\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.4, Exercise 60"], "Header"]}, {
   Cell[
    TextData["Section 4.4, Exercise 60"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 4723, 99, 298, "Output"]
}
]
*)
...
(* NotebookSignature qJz1cvrohY5kHK#7jiIGAVub *)
