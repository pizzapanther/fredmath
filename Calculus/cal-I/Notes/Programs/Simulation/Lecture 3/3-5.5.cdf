...
NotebookDataLength[     38055,        877]
NotebookOptionsPosition[      5011,        116]
NotebookOutlinePosition[     38151,        879]
CellTagsIndexPosition[     38108,        876]
WindowTitle->Section 4.7, Exercise 117
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`angle$$ = Rational[1, 4] Pi, 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Rational[1, 2] Pi}}, Typeset`size$$ = {288., {144., 150.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`angle$22571$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`angle$$ = Rational[1, 4] Pi}, 
       "ControllerVariables" :> {
         Hold[$CellContext`angle$$, $CellContext`angle$22571$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Graphics[{
          ...
          Text["\!\(TraditionalForm\`area = f(\[Theta])\)", {0.8, 0}, {1, 5}], 
         ...
         Arrowheads[{0, 0.03}], Axes -> True, Ticks -> None, 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"4.7\"", "\", Exercise \"", "\"117\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.7, Exercise 117"], "Header"]}, {
   Cell[
    TextData["Section 4.7, Exercise 117"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[592, 21, 4415, 93, 358, "Output"]
}
]
*)
...
(* NotebookSignature GJ42VpI1i8NmRLOWgKq9GxV6 *)
