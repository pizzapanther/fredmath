...
NotebookDataLength[     43094,        964]
NotebookOptionsPosition[      9699,        195]
NotebookOutlinePosition[     43189,        966]
CellTagsIndexPosition[     43146,        963]
WindowTitle->Section 4.7, Figure 4.75
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.45, $CellContext`zoomLevel$$ =
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`zoomLevel$$], 0, ""}, 0, 1.5}}, Typeset`size$$ = {
     360., {180., 186.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$22362$$ = 
     0, $CellContext`zoomLevel$22363$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`xValue$$ = 0.45, $CellContext`zoomLevel$$ = 
         0}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$22362$$, 0], 
         Hold[$CellContext`zoomLevel$$, $CellContext`zoomLevel$22363$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
         Typeset`specs$$, Typeset`size$$, Typeset`update$$, 
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Plot[{
          $CellContext`funcC4F75f[$CellContext`x], 
          $CellContext`funcC4F75g[$CellContext`x], 
          Derivative[1][$CellContext`funcC4F75f][1] ($CellContext`x - 
            1) + $CellContext`funcC4F75f[1], 
          Derivative[1][$CellContext`funcC4F75g][1] ($CellContext`x - 
            1) + $CellContext`funcC4F75g[1]}, {$CellContext`x, -1, 5}, 
         PlotStyle -> {{Thick, Black}, {Thick, Black}, {
           Thick, $CellContext`bcR}, {Thick, $CellContext`bcR}}, Epilog -> {
           Text["\!\(TraditionalForm\`y = f(x)\)", {1.7, 
             $CellContext`funcC4F75f[1.7]}, {1.2, -1}], 
           Text["\!\(TraditionalForm\`y = g(x)\)", {0.4, 
             $CellContext`funcC4F75g[0.4]}, {1.2, 1}], 
           AbsolutePointSize[6], Black, 
           Point[{$CellContext`xValue$$ + 1, 
             $CellContext`funcC4F75f[$CellContext`xValue$$ + 1]}], 
           Point[{$CellContext`xValue$$ + 1, 
             $CellContext`funcC4F75g[$CellContext`xValue$$ + 1]}], 
           Text["\!\(TraditionalForm\`f(x)\)", {$CellContext`xValue$$ + 1, 
             $CellContext`funcC4F75f[$CellContext`xValue$$ + 1]}, {1.5, 0}], 
           Text["\!\(TraditionalForm\`g(x)\)", {$CellContext`xValue$$ + 1, 
             $CellContext`funcC4F75g[$CellContext`xValue$$ + 1]}, {1.5, 0}], 
           Black, 
           
           Point[{$CellContext`xValue$$ + 1, 
             Derivative[1][$CellContext`funcC4F75f][1] ($CellContext`xValue$$ + 
               1 - 1) + $CellContext`funcC4F75f[1]}], 
           
           Point[{$CellContext`xValue$$ + 1, 
             Derivative[1][$CellContext`funcC4F75g][1] ($CellContext`xValue$$ + 
               1 - 1) + $CellContext`funcC4F75g[1]}], 
           AbsoluteThickness[1.5], 
           Line[{{$CellContext`xValue$$ + 1, 0}, {$CellContext`xValue$$ + 1, 
              $CellContext`funcC4F75f[$CellContext`xValue$$ + 
               1]}, {$CellContext`xValue$$ + 1, 
              Derivative[1][$CellContext`funcC4F75f][
                1] ($CellContext`xValue$$ + 1 - 1) + $CellContext`funcC4F75f[
               1]}}], 
           AbsoluteThickness[5], 
           GrayLevel[0.5, 0.5], 
           Line[{{$CellContext`xValue$$ + 1, 0}, {$CellContext`xValue$$ + 1, 
              $CellContext`funcC4F75g[$CellContext`xValue$$ + 
               1]}, {$CellContext`xValue$$ + 1, 
              Derivative[1][$CellContext`funcC4F75g][
                1] ($CellContext`xValue$$ + 1 - 1) + $CellContext`funcC4F75g[
               1]}}], 
...
{$CellContext`xValue$$ + 1, 
             Derivative[1][$CellContext`funcC4F75f][1] ($CellContext`xValue$$ + 
               1 - 1) + $CellContext`funcC4F75f[1]}, {-1.5, 0}], 
           Text[
           "\!\(TraditionalForm\`\(TraditionalForm\`g' \((a)\) \((x - \
a)\)\)\)", {$CellContext`xValue$$ + 1, 
             Derivative[1][$CellContext`funcC4F75g][1] ($CellContext`xValue$$ + 
               1 - 1) + $CellContext`funcC4F75g[1]}, {-1.5, 0}], Black, 
...
{$CellContext`i, 1, 3}], Black]}, PlotRange -> 
         ...
         BaseStyle -> {"Text", 13}, ImageSize -> 5 72, AxesOrigin -> {0, 0}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, AxesStyle -> 
         Arrowheads[{0, 0.03}], Method -> {"AxisInFront" -> False}, 
         Ticks -> {{{1, ""}, {$CellContext`xValue$$ + 1, ""}}, None}], 
       "Specifications" :> {{{$CellContext`xValue$$, 0.45, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 
          Dynamic[-10^((-$CellContext`zoomLevel$$)/2)], 
          Dynamic[10^((-$CellContext`zoomLevel$$)/2)], ControlType -> Slider, 
          Exclusions -> {1}, ImageSize -> Small}, Delimiter, 
...
{{$CellContext`zoomLevel$$, 0, ""}, 0, 1.5, ControlType -> Trigger, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{502., {198., 205.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4F75f[
            Pattern[$CellContext`x, 
             Blank[]]] := (1/2) $CellContext`x^2 - 1/
           2, $CellContext`funcC4F75g[
            Pattern[$CellContext`x, 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4F75f[
            Pattern[$CellContext`x, 
             Blank[]]] := (1/2) $CellContext`x^2 - 1/
           2, $CellContext`funcC4F75g[
            Pattern[$CellContext`x, 
             Blank[]]] := 2 - 2^$CellContext`x}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.7, Figure 4.75"], "Header"]}, {
   Cell[
    TextData["Section 4.7, Figure 4.75"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 9104, 172, 430, "Output"]
}
]
*)
...
(* NotebookSignature lJNLSjFOp8pUaLk1VH7lYbDU *)
