...
NotebookDataLength[     43839,        981]
NotebookOptionsPosition[     10444,        212]
NotebookOutlinePosition[     43934,        983]
CellTagsIndexPosition[     43891,        980]
WindowTitle->Section 4.8, Figure 4.80
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`initialRoot$$ = {
     2.64, 0}, $CellContext`nValue$$ = 1, $CellContext`rootValue$$ = 0.664449,
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
        ...
        Hold[$CellContext`initialRoot$$], {2.64, 0}}, {0, 0}, {5, 0}}, {{
        Hold[$CellContext`rootValue$$], 0.664449}, 0}}, Typeset`size$$ = {
     504., {153., 159.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`nValue$9462$$ = 
     False, $CellContext`initialRoot$9463$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`initialRoot$$ = {
          2.64, 0}, $CellContext`nValue$$ = 0, $CellContext`rootValue$$ = 
         0.664449}, "ControllerVariables" :> {
         Hold[$CellContext`nValue$$, $CellContext`nValue$9462$$, False], 
         Hold[$CellContext`initialRoot$$, $CellContext`initialRoot$9463$$, {0,
           0}]}, "OtherVariables" :> {
...
$CellContext`xZero$ = 
          ...
          NestList[# - $CellContext`funcC4F80[#]/Derivative[
            1][$CellContext`funcC4F80][#]& , $CellContext`xZero$, 5]; Show[{
            Plot[
             $CellContext`funcC4F80[$CellContext`x], {$CellContext`x, 0, 3}, 
             PlotStyle -> {Thick, $CellContext`bcB}, Epilog -> {
               Text["\!\(TraditionalForm\`y = f(x)\)", {1.8, 145}, {0, 0}]}], 
...
{$CellContext`i, 1, $CellContext`nValue$$}], Black], 
              ...
              Line[{{$CellContext`rootValue$$, -2}, {$CellContext`rootValue$$,
                  2}}], Black, 
              Text[
               Framed[
               "\!\(TraditionalForm\`r\)", {
              ...
              If[$CellContext`nValue$$ >= 1, 
               Text[
                Row[{"(", 
                 ...
                 $CellContext`funcC4F80[
                  Part[$CellContext`rootList$, $CellContext`nValue$$]]}, {
                1.5, -1}], Black]}]}, PlotRange -> {{-0.5, 3.5}, {-15, 150}}, 
           ImageSize -> 7 72, BaseStyle -> {"Text", 13}, Ticks -> None, 
...
\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)]\).", {124, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], {{$CellContext`initialRoot$$, {2.64, 0}}, {0, 0}, {5, 0}, 
          ControlType -> Locator}, {{$CellContext`rootValue$$, 0.664449}, 0, 
          ControlType -> None}}, 
       "Options" :> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4F80[
            Pattern[$CellContext`x, 
             Blank[]]] := 2 2^(2^$CellContext`x) - 6, 
          Attributes[Derivative] = {
           NHoldAll, ReadProtected}, $CellContext`bcB = RGBColor[0, 0.4, 0.8],
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.8, Figure 4.80"], "Header"]}, {
   Cell[
    TextData["Section 4.8, Figure 4.80"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 9849, 189, 382, "Output"]
}
]
*)
...
(* NotebookSignature vJN7YyEDHNFioK5GHev52paq *)
