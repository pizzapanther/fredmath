...
NotebookDataLength[     41387,        937]
NotebookOptionsPosition[      8346,        176]
NotebookOutlinePosition[     41482,        939]
CellTagsIndexPosition[     41439,        936]
WindowTitle->Section 4.1, Exercise 78
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = {0.6499999999999999, 0}, 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
       Hold[
        Pane[
        "Drag point \!\(\*\nStyleBox[\"A\",\nFontSlant->\"Italic\"]\) to \
change its position.", {108., Automatic}, 
         BaseStyle -> {
          LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
           Left}]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`aValue$$], {1., 0}}, {-2., 0}, {2., 0}, {0.01, 
       0.01}}}, Typeset`size$$ = {288., {144., 150.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`aValue$6833$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`aValue$$ = {1., 0}}, 
       "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$6833$$, {0, 0}]}, 
       "OtherVariables" :> {
       ...
       DynamicModule[{$CellContext`xValue}, $CellContext`xValue = 
          Part[$CellContext`aValue$$, 1]; Show[{
            Plot[
             $CellContext`funcC4FP70[$CellContext`x], {$CellContext`x, -2, 2},
              PlotStyle -> {{Thick, Black}}], 
            Graphics[{
              Text[
              "\!\(\*\nStyleBox[\"O\",\nFontSlant->\"Italic\"]\)", {0, 0}, {
               1.5, 1.5}], 
              Text[
              "\!\(TraditionalForm\`y = \*SuperscriptBox[\(x\), \(2\)]\)", {
               1.5, 4}, {1, 1}], 
              Text["\!\(TraditionalForm\`A\)", {$CellContext`xValue, 
                $CellContext`funcC4FP70[$CellContext`xValue]}, {-
                Sign[$CellContext`xValue], 2}], 
              Text[
              "\!\(TraditionalForm\`B\)", {(-1 - $CellContext`xValue 
                 Derivative[1][$CellContext`funcC4FP70][$CellContext`xValue])/
                Derivative[1][$CellContext`funcC4FP70][$CellContext`xValue], 
                $CellContext`funcC4FP70[(-1 - $CellContext`xValue 
                  Derivative[
                   1][$CellContext`funcC4FP70][$CellContext`xValue])/
                 Derivative[
                 1][$CellContext`funcC4FP70][$CellContext`xValue]]}, {
                Sign[$CellContext`xValue], 2}], 
              Text["\!\(TraditionalForm\`L\)", ({$CellContext`xValue, 
                  $CellContext`funcC4FP70[$CellContext`xValue]} + {(-1 - \
$CellContext`xValue 
                   Derivative[
                    1][$CellContext`funcC4FP70][$CellContext`xValue])/
                  Derivative[1][$CellContext`funcC4FP70][$CellContext`xValue], 
                  $CellContext`funcC4FP70[(-1 - $CellContext`xValue 
                    ...
                    1][$CellContext`funcC4FP70][$CellContext`xValue])/
                   Derivative[
                   1][$CellContext`funcC4FP70][$CellContext`xValue]]})/2, {
               0, -2}], 
              AbsolutePointSize[7], $CellContext`bcR, Thick, 
              Line[{{$CellContext`xValue, 
                  $CellContext`funcC4FP70[$CellContext`xValue]} - 5 
                Normalize[{1, 
                   Derivative[
                   1][$CellContext`funcC4FP70][$CellContext`xValue]}], \
{$CellContext`xValue, 
...
$CellContext`xValue 
                 ...
                 $CellContext`funcC4FP70[(-1 - $CellContext`xValue 
                   Derivative[
                    1][$CellContext`funcC4FP70][$CellContext`xValue])/
                  Derivative[
                  1][$CellContext`funcC4FP70][$CellContext`xValue]]}}], Black, 
              
              Point[{(-1 - $CellContext`xValue 
                 Derivative[1][$CellContext`funcC4FP70][$CellContext`xValue])/
                Derivative[1][$CellContext`funcC4FP70][$CellContext`xValue], 
                $CellContext`funcC4FP70[(-1 - $CellContext`xValue 
                  Derivative[
              ...
              Point[{$CellContext`xValue, 
                $CellContext`funcC4FP70[$CellContext`xValue]}]}]}, 
           PlotRange -> {{-2.5, 2.5}, {-1, 4}}, AspectRatio -> 1, Ticks -> {
             Range[-2, 2], None}, ImageSize -> 4 72, 
...
change its position.", {108., Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], {{$CellContext`aValue$$, {1., 0}}, {-2., 0}, {2., 0}, {
          0.01, 0.01}, ControlType -> Locator, Appearance -> None}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{429., {165., 172.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4FP70[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4FP70[
            Pattern[$CellContext`x, 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"4.1\"", "\", Exercise \"", "\"78\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.1, Exercise 78"], "Header"]}, {
   Cell[
    TextData["Section 4.1, Exercise 78"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 7751, 153, 364, "Output"]
}
]
*)
...
(* NotebookSignature SL4KrtrohMJaHKO706@FaRTO *)
