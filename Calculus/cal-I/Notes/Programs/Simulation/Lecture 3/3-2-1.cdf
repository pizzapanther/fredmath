...
NotebookDataLength[     36775,        850]
NotebookOptionsPosition[      3735,         89]
NotebookOutlinePosition[     36871,        852]
CellTagsIndexPosition[     36828,        849]
WindowTitle->Section 4.3, Exercise 82
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0., Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["Elliptic curve"], Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
       "\!\(TraditionalForm\`\*SuperscriptBox[\(y\), \(2\)] = \
\*SuperscriptBox[\(x\), \(3\)] - a\\ x + 3\)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`aValue$$], 2, "\!\(TraditionalForm\`a\)"}, 0, 10, 
       0.01}}, Typeset`size$$ = {288., {142., 147.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`aValue$7779$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`aValue$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$7779$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`aValue$$ $CellContext`x + 3, {$CellContext`x, -5, 
          5}, {$CellContext`y, -5, 5}, MaxRecursion -> 2, Axes -> True, Frame -> 
         False, ContourStyle -> {{Thick, Black}}, ImageSize -> 4 72, 
           ...
           Text[
            Row[{"\!\(TraditionalForm\`\(\(a\)\(=\)\(\\ \)\)\)", 
              $CellContext`DisplayNumber[
               Round[$CellContext`aValue$$, 0.01]]}], 
            Scaled[{0, 1}], {-1, 1}]}], 
       "Specifications" :> {
        "Elliptic curve", 
         "\!\(TraditionalForm\`\*SuperscriptBox[\(y\), \(2\)] = \
\*SuperscriptBox[\(x\), \(3\)] - a\\ x + 3\)", 
         Delimiter, {{$CellContext`aValue$$, 2, "\!\(TraditionalForm\`a\)"}, 
          0, 10, 0.01, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{429., {159., 166.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({$CellContext`DisplayNumber[
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"4.3\"", "\", Exercise \"", "\"82\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 4.3, Exercise 82"], "Header"]}, {
   Cell[
    TextData["Section 4.3, Exercise 82"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 3140, 66, 352, "Output"]
}
]
*)
...
(* NotebookSignature 2JNoB#bWtlmmcJ#aldSS8nBp *)
