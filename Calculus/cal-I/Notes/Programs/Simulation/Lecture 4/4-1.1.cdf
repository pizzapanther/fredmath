...
NotebookDataLength[     56755,       1220]
NotebookOptionsPosition[     23436,        453]
NotebookOutlinePosition[     56849,       1222]
CellTagsIndexPosition[     56806,       1219]
WindowTitle->Section 5.1, Figure 5.04
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`divisions$$ = 8, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["subintervals"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`divisions$$], 2, ""}, {
       2 -> Pane[
         "\!\(TraditionalForm\`n\\  = 2\)", {48, Automatic}, Alignment -> 
          Center], 4 -> 
        Pane["\!\(TraditionalForm\`n\\  = 4\)", {48, Automatic}, Alignment -> 
          Center], 8 -> 
        Pane["\!\(TraditionalForm\`n\\  = 8\)", {48, Automatic}, Alignment -> 
          Center]}}}, Typeset`size$$ = {360., {149.5, 156.5}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`divisions$386347$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`divisions$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`divisions$$, $CellContext`divisions$386347$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Framed[
            Pane[
            "The midpoint of each subinterval is used to approximate the \
velocity over that subinterval.", {
             4.5 72, Automatic}, $CellContext`bcPBS], $CellContext`bcFO]}, {
           Show[{
             Module[{$CellContext`t$}, 
              $CellContext`RiemannSum[$CellContext`t$^2, {$CellContext`t$, 0, 
                8}, $CellContext`Intervals -> $CellContext`divisions$$, \
$CellContext`ComputationMethod -> "Midpoint"]], 
             Graphics[{
               Text[
               "\!\(TraditionalForm\`v = \*SuperscriptBox[\(t\), \(2\)]\)", {
                8, 70}, {1, 1}]}]}, PlotRange -> {{0, 8.5}, {0, 80}}, Ticks -> {
              Range[0, 8], 
         ...
         BaseStyle -> "TR"], 
       "Specifications" :> {
        "subintervals", {{$CellContext`divisions$$, 2, ""}, {
          2 -> Pane[
            "\!\(TraditionalForm\`n\\  = 2\)", {48, Automatic}, Alignment -> 
             Center], 4 -> 
           Pane["\!\(TraditionalForm\`n\\  = 4\)", {48, Automatic}, Alignment -> 
     ...
     Initialization:>({$CellContext`bcPBS = 
        BaseStyle -> {
         ...
         RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}, $CellContext`t[
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.1, Figure 5.04"], "Header"]}, {
   Cell[
    TextData["Section 5.1, Figure 5.04"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 22841, 430, 370, "Output"]
}
]
*)
...
(* NotebookSignature rKjsQkW#RCmzkK#FXSua4zal *)
