...
NotebookDataLength[     66543,       1415]
NotebookOptionsPosition[     33224,        648]
NotebookOutlinePosition[     66637,       1417]
CellTagsIndexPosition[     66594,       1414]
WindowTitle->Section 5.1, Figure 5.13
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`method$$ = "Right", $CellContext`nValue$$ =
      6, $CellContext`rectangle$$ = 3, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`method$$], "Right", ""}, {
       "Left" -> Pane[
       ...
       1 -> Pane[
        ...
        Pane["\!\(TraditionalForm\`k = 6\)", {48, Automatic}, Alignment -> 
          Center]}}}, Typeset`size$$ = {432., {137., 142.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`method$386701$$ = 
     False, $CellContext`nValue$386702$$ = 
     0, $CellContext`rectangle$386703$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`method$$ = "Right", $CellContext`nValue$$ = 
         6, $CellContext`rectangle$$ = 3}, "ControllerVariables" :> {
         Hold[$CellContext`method$$, $CellContext`method$386701$$, False], 
         Hold[$CellContext`nValue$$, $CellContext`nValue$386702$$, 0], 
         Hold[$CellContext`rectangle$$, $CellContext`rectangle$386703$$, 
          False]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Module[{$CellContext`x$}, 
           $CellContext`RiemannSum[
            $CellContext`funcC5F13[$CellContext`x$], {$CellContext`x$, 0, Pi/
...
\[Pi]\), \(12\)]\)\(\[TildeTilde]\)\)\) ", 
                 Round[
                  ...
                  0.001]}], {0, 1}, {-1.2, 0}]}]}], 
          Plot[
           $CellContext`funcC5F13[$CellContext`x], {$CellContext`x, 0, Pi/2 + 
       ...
       "Specifications" :> {{{$CellContext`method$$, "Right", ""}, {
          "Left" -> Pane[
...
{$CellContext`i, 1, $CellContext`intervals}]]}]], 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F13[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.1, Figure 5.13"], "Header"]}, {
   Cell[
    TextData["Section 5.1, Figure 5.13"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 32629, 625, 342, "Output"]
}
]
*)
...
(* NotebookSignature FKNSvSKLZpFK@KkRKaE5qk@B *)
