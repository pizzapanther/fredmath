...
NotebookDataLength[     39427,        900]
NotebookOptionsPosition[      6109,        133]
NotebookOutlinePosition[     39522,        902]
CellTagsIndexPosition[     39479,        899]
WindowTitle->Section 5.2, Figure 5.30
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`pValue$$ = 7, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`pValue$$], 7, 
        "\!\(\*\nStyleBox[\"p\",\nFontSlant->\"Italic\"]\)"}, 6.1, 9, 0.1}}, 
     Typeset`size$$ = {432., {137., 142.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`pValue$2390$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`pValue$$ = 7}, 
       "ControllerVariables" :> {
         Hold[$CellContext`pValue$$, $CellContext`pValue$2390$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC5F30[$CellContext`x], {$CellContext`x, 1, 6}, 
           PlotStyle -> {{Thin, Black}}, Filling -> 0, FillingStyle -> 
           Lighter[$CellContext`bcAreaPositiveColor]], 
          Plot[
           $CellContext`funcC5F30[$CellContext`x], {$CellContext`x, 
            6, $CellContext`pValue$$}, PlotStyle -> {{Thin, Black}}, Filling -> 
           0, FillingStyle -> Darker[$CellContext`bcAreaPositiveColor]], 
          Plot[
           $CellContext`funcC5F30[$CellContext`x], {$CellContext`x, 0, 10}, 
           PlotStyle -> {{Thick, Black}}], 
          Graphics[{Gray, 
            Arrowheads[{0, 0.02}], 
            Arrow[{{1.5, 9}, {1.5, 2}}], 
            Arrow[{{4, 9}, {(1 + $CellContext`pValue$$)/2, 1}}], 
            Arrow[{{6.5, 9}, {(6 + $CellContext`pValue$$)/2, 2}}], 
            Arrowheads[{-0.02, 0.02}], Black, 
            Arrow[{{1, 1}, {$CellContext`pValue$$, 1}}], 
            Arrow[{{1, 2}, {6, 2}}], 
            Arrow[{{6, 2}, {$CellContext`pValue$$, 2}}], Black, 
            Text["\!\(TraditionalForm\`y = f(x)\)", {9, 7.5}, {1, 1}], 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \
\(a\), \(\(\\ \)\(b\)\)]\(f(x)\) d\[VeryThinSpace]x\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> Lighter[$CellContext`bcAreaPositiveColor]], {
             0.5, 9}, {-1.1, 0}], 
            Text["\!\(\(TraditionalForm\` = \)\)", {2.5, 9}, {-1.1, 0}], 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \
\(a\), \(\(\\ \)\(p\)\)]\(f(x)\) d\[VeryThinSpace]x\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> $CellContext`bcAreaPositiveColor], {3, 
             9}, {-1.1, 0}], 
            Text["\!\(\(TraditionalForm\`-\)\)", {5, 9}, {-1.1, 0}], 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \
\(b\), \(\(\\ \)\(p\)\)]\(f(x)\) d\[VeryThinSpace]x\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> Darker[$CellContext`bcAreaPositiveColor]], {
             5.5, 9}, {-1.1, 0}]}]}, PlotRange -> {{-0.2, 10}, {-1, 11}}, 
         ImageSize -> 6 72, AxesOrigin -> {0, 0}, 
         Ticks -> {{{
            1, "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, \
{$CellContext`pValue$$, 
             "\!\(\*\nStyleBox[\"p\",\nFontSlant->\"Italic\"]\)"}, {
         ...
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         BaseStyle -> {"Text", 13}], 
       "Specifications" :> {{{$CellContext`pValue$$, 7, 
           "\!\(\*\nStyleBox[\"p\",\nFontSlant->\"Italic\"]\)"}, 6.1, 9, 0.1, 
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F30[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F30[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.2, Figure 5.30"], "Header"]}, {
   Cell[
    TextData["Section 5.2, Figure 5.30"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 5514, 110, 342, "Output"]
}
]
*)
...
(* NotebookSignature 2L46rwpPwg3nVI5I1QZ92BV2 *)
