...
NotebookDataLength[     57079,       1226]
NotebookOptionsPosition[     23760,        459]
NotebookOutlinePosition[     57173,       1228]
CellTagsIndexPosition[     57130,       1225]
WindowTitle->Section 5.1, Figure 5.05
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`subintervals$$ = 1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["subintervals"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`subintervals$$], 1, ""}, {
       1 -> Pane[
         "\!\(TraditionalForm\`n\\  = 1\)", {48, Automatic}, Alignment -> 
          Center], 2 -> 
        Pane["\!\(TraditionalForm\`n\\  = 2\)", {48, Automatic}, Alignment -> 
          Center], 4 -> 
        Pane["\!\(TraditionalForm\`n\\  = 4\)", {48, Automatic}, Alignment -> 
          Center], 8 -> 
        Pane["\!\(TraditionalForm\`n\\  = 8\)", {48, Automatic}, Alignment -> 
          Center], 16 -> 
        Pane["\!\(TraditionalForm\`n\\  = 16\)", {48, Automatic}, Alignment -> 
          Center], 32 -> 
        Pane["\!\(TraditionalForm\`n\\  = 32\)", {48, Automatic}, Alignment -> 
          Center], 64 -> 
        Pane["\!\(TraditionalForm\`n\\  = 64\)", {48, Automatic}, Alignment -> 
          Center]}}}, Typeset`size$$ = {360., {126., 131.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`subintervals$386413$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`subintervals$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`subintervals$$, $CellContext`subintervals$386413$$,
           False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Module[{$CellContext`t$}, 
           $CellContext`RiemannSum[$CellContext`t$^2, {$CellContext`t$, 0, 
             8}, $CellContext`Intervals -> $CellContext`subintervals$$, \
$CellContext`ComputationMethod -> "Midpoint", $CellContext`ShowPoints -> 
            False]], 
          Graphics[{
            Text[
            "\!\(TraditionalForm\`v = \*SuperscriptBox[\(t\), \(2\)]\)", {8, 
             70}, {1, 1}]}]}, PlotRange -> {{0, 8.5}, {0, 80}}, Ticks -> {
           Range[0, 8], 
           Range[0, 70, 10]}, BaseStyle -> {"Text", 13}, ImageSize -> 5 72, 
         AxesStyle -> Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`t\)", "\!\(TraditionalForm\`v\)"}], 
       "Specifications" :> {
        "subintervals", {{$CellContext`subintervals$$, 1, ""}, {
          1 -> Pane[
            "\!\(TraditionalForm\`n\\  = 1\)", {48, Automatic}, Alignment -> 
             Center], 2 -> 
           Pane["\!\(TraditionalForm\`n\\  = 2\)", {48, Automatic}, Alignment -> 
           ...
           Pane["\!\(TraditionalForm\`n\\  = 8\)", {48, Automatic}, Alignment -> 
             Center], 16 -> 
           Pane["\!\(TraditionalForm\`n\\  = 16\)", {48, Automatic}, 
             Alignment -> Center], 32 -> 
           Pane["\!\(TraditionalForm\`n\\  = 32\)", {48, Automatic}, 
             Alignment -> Center], 64 -> 
           Pane["\!\(TraditionalForm\`n\\  = 64\)", {48, Automatic}, 
...
$CellContext`varMin, $CellContext`varMax}, 
               Evaluate[$CellContext`optPlot], PlotStyle -> {{Thick, Black}}, 
               Prolog -> Switch[$CellContext`method, "Left", {
                  Table[{
...
{$CellContext`i, 1, $CellContext`intervals}]]}]], 
        Options[$CellContext`RiemannSum] = {$CellContext`Intervals -> 
          ...
          "Left", $CellContext`ShowPoints -> True, $CellContext`ShowAreaValue -> 
          True, $CellContext`PartitionType -> "Uniform"}, $CellContext`i = 1, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.1, Figure 5.05"], "Header"]}, {
   Cell[
    TextData["Section 5.1, Figure 5.05"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 23165, 436, 320, "Output"]
}
]
*)
...
(* NotebookSignature 6LzkZBrVjJw@8K#rBZZ5l7pa *)
