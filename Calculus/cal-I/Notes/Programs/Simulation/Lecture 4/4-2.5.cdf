...
NotebookDataLength[     39138,        896]
NotebookOptionsPosition[      5820,        129]
NotebookOutlinePosition[     39233,        898]
CellTagsIndexPosition[     39190,        895]
WindowTitle->Section 5.2, Figure 5.22
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`dummyVariable$$ = 
     "\!\(TraditionalForm\`x\)", Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["variable of integration"], Manipulate`Dump`ThisIsNotAControl}, {{
       
        Hold[$CellContext`dummyVariable$$], "\!\(TraditionalForm\`x\)", ""}, {
       "\!\(TraditionalForm\`x\)" -> 
        Pane["\!\(TraditionalForm\`x\)", {24, Automatic}, Alignment -> 
          Center], "\!\(TraditionalForm\`\[Omega]\)" -> 
        Pane["\!\(TraditionalForm\`\[Omega]\)", {24, Automatic}, Alignment -> 
          Center], "\!\(TraditionalForm\`s\)" -> 
        Pane["\!\(TraditionalForm\`s\)", {24, Automatic}, Alignment -> 
          Center]}}}, Typeset`size$$ = {360., {119., 125.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`dummyVariable$2260$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`dummyVariable$$ = 
         "\!\(TraditionalForm\`x\)"}, "ControllerVariables" :> {
         Hold[$CellContext`dummyVariable$$, $CellContext`dummyVariable$2260$$,
           False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC5F22[$CellContext`x], {$CellContext`x, 1, 9}, 
           PlotStyle -> {{Thin, Black}}, Filling -> 0, 
           FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[
           $CellContext`funcC5F22[$CellContext`x], {$CellContext`x, 0, 10}, 
           PlotStyle -> {{Thick, Black}}], 
          Graphics[{
            Text[
             
             Row[{"\!\(TraditionalForm\`y = \(\(f\)\((\)\)\)", \
$CellContext`dummyVariable$$, "\!\(\(TraditionalForm\`)\)\)"}], {9, 7}, {1, 
             1}], 
            Text[
             Framed[
              Pane[
               
               Row[{"\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\),\
 \(a\), \(\(\\ \)\(b\)\)]\(\(f\)\((\)\)\)", $CellContext`dummyVariable$$, 
                 "\!\(TraditionalForm\`\(\()\) \
\(d\)\(\[VeryThinSpace]\)\)\)", $CellContext`dummyVariable$$}], \
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], {2.5, 4.5}, {
             0, -1}], 
            Arrow[{{2.5, 4.5}, {5, 2}}], 
            Text[$CellContext`dummyVariable$$, {10, 0}, {1.5, 2}]}]}, 
         PlotRange -> {{-0.2, 10}, {-2, 7}}, ImageSize -> 5 72, 
         AxesOrigin -> {0, 0}, 
         Ticks -> {{{
            1, "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, {
         ...
         BaseStyle -> {"Text", 13}], 
       "Specifications" :> {
        "variable of integration", {{$CellContext`dummyVariable$$, 
           "\!\(TraditionalForm\`x\)", ""}, {
          "\!\(TraditionalForm\`x\)" -> 
           Pane["\!\(TraditionalForm\`x\)", {24, Automatic}, Alignment -> 
             Center], "\!\(TraditionalForm\`\[Omega]\)" -> 
           Pane["\!\(TraditionalForm\`\[Omega]\)", {24, Automatic}, Alignment -> 
             Center], "\!\(TraditionalForm\`s\)" -> 
           Pane["\!\(TraditionalForm\`s\)", {24, Automatic}, Alignment -> 
             Center]}, ControlType -> SetterBar, Appearance -> "Horizontal"}},
        "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{502., {137., 144.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F22[
            Pattern[$CellContext`x, 
             Blank[]]] := -Sin[(Pi/5) $CellContext`x] + 
           5, $CellContext`bcAreaPositiveColor = RGBColor[0.796, 0.91, 0.855],
           $CellContext`bcPBS = 
          BaseStyle -> {
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F22[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.2, Figure 5.22"], "Header"]}, {
   Cell[
    TextData["Section 5.2, Figure 5.22"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 5225, 106, 308, "Output"]
}
]
*)
...
(* NotebookSignature rJ4Y8YiGYmhopKkebutQWaYe *)
