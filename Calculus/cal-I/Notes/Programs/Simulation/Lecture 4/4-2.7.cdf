...
NotebookDataLength[     39441,        900]
NotebookOptionsPosition[      6123,        133]
NotebookOutlinePosition[     39536,        902]
CellTagsIndexPosition[     39493,        899]
WindowTitle->Section 5.2, Figure 5.29
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`pValue$$ = 7, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"p\",\nFontSlant->\"Italic\"]\)"}, 1.1, 8.9, 0.1}},
      Typeset`size$$ = {432., {137., 142.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`pValue$2347$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`pValue$$ = 7}, 
       "ControllerVariables" :> {
         Hold[$CellContext`pValue$$, $CellContext`pValue$2347$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC5F29[$CellContext`x], {$CellContext`x, 
            1, $CellContext`pValue$$}, PlotStyle -> {{Thin, Black}}, Filling -> 
           0, FillingStyle -> Lighter[$CellContext`bcAreaPositiveColor]], 
          Plot[
           $CellContext`funcC5F29[$CellContext`x], {$CellContext`x, \
$CellContext`pValue$$, 9}, PlotStyle -> {{Thin, Black}}, Filling -> 0, 
           FillingStyle -> Darker[$CellContext`bcAreaPositiveColor]], 
          Plot[
           $CellContext`funcC5F29[$CellContext`x], {$CellContext`x, 0, 10}, 
           PlotStyle -> {{Thick, Black}}], 
          Graphics[{Gray, 
            Arrowheads[{0, 0.02}], 
            Arrow[{{1.5, 9}, {1.5, 1}}], 
            Arrow[{{4, 9}, {(1 + $CellContext`pValue$$)/2, 2}}], 
            Arrow[{{6.5, 9}, {(9 + $CellContext`pValue$$)/2, 2}}], 
            Arrowheads[{-0.02, 0.02}], Black, 
            Arrow[{{1, 1}, {9, 1}}], 
            Arrow[{{1, 2}, {$CellContext`pValue$$, 2}}], 
            Arrow[{{$CellContext`pValue$$, 2}, {9, 2}}], Black, 
...
$CellContext`bcFO, Background -> $CellContext`bcAreaPositiveColor], {
             0.5, 9}, {-1.1, 0}], 
...
$CellContext`bcFO, Background -> Lighter[$CellContext`bcAreaPositiveColor]], {
            ...
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \
\(p\), \(\(\\ \)\(b\)\)]\(f(x)\) d\[VeryThinSpace]x\)", $CellContext`bcPBS], \
...
{$CellContext`pValue$$, 
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F29[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC5F29[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.2, Figure 5.29"], "Header"]}, {
   Cell[
    TextData["Section 5.2, Figure 5.29"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 5528, 110, 342, "Output"]
}
]
*)
...
(* NotebookSignature vL4I0fx@fHRyUK#ooMu9GglR *)
