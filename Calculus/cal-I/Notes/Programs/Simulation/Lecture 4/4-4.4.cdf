...
NotebookDataLength[     42445,        966]
NotebookOptionsPosition[      9127,        199]
NotebookOutlinePosition[     42540,        968]
CellTagsIndexPosition[     42497,        965]
WindowTitle->Section 5.3, Figure 5.39
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`areaSelection$$ = 
     1, $CellContext`hValue$$ = 1, $CellContext`xValue$$ = 5, Typeset`show$$ =
      True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold[
       "\!\(TraditionalForm\`A(x) = \*SubsuperscriptBox[\(\[Integral]\), \(\(\
\\ \)\(a\)\), \(\(\\ \)\(x\)\)]\(f(t)\)\\ d\[VeryThinSpace]t\)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`areaSelection$$], 1, ""}, {
       1 -> Pane[
         "\!\(TraditionalForm\`A(x + h)\)", {72, Automatic}, Alignment -> 
          Center], 2 -> 
        Pane["\!\(TraditionalForm\`A(x)\)", {72, Automatic}, Alignment -> 
          Center], 3 -> 
        Pane["\!\(TraditionalForm\`h\\ \(f(x)\)\)", {72, Automatic}, 
          Alignment -> Center]}}, {{
        Hold[$CellContext`xValue$$], 5, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1.1, 6.9, 
       0.1}, {{
        Hold[$CellContext`hValue$$], 1, 
        "\!\(\*\nStyleBox[\"h\",\nFontSlant->\"Italic\"]\)"}, 0.2, 2, 0.1}}, 
     Typeset`size$$ = {432., {137., 144.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`areaSelection$387540$$ = 
     False, $CellContext`xValue$387541$$ = 0, $CellContext`hValue$387542$$ = 
     0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`areaSelection$$ = 
         1, $CellContext`hValue$$ = 1, $CellContext`xValue$$ = 5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`areaSelection$$, \
$CellContext`areaSelection$387540$$, False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$387541$$, 0], 
         Hold[$CellContext`hValue$$, $CellContext`hValue$387542$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC5F39[$CellContext`x], {$CellContext`x, 
            1, $CellContext`xValue$$ + $CellContext`hValue$$}, 
           PlotStyle -> {{Thin, Black}}, Filling -> 0, FillingStyle -> 
           If[$CellContext`areaSelection$$ == 
             1, $CellContext`bcAreaPositiveColor, None]], 
          Plot[
           $CellContext`funcC5F39[$CellContext`x], {$CellContext`x, 
            1, $CellContext`xValue$$}, PlotStyle -> {{Thin, Black}}, Filling -> 
           0, FillingStyle -> 
           If[$CellContext`areaSelection$$ == 
             2, $CellContext`bcAreaPositiveColor, None]], 
          Plot[
           $CellContext`funcC5F39[$CellContext`x], {$CellContext`x, 0, 10}, 
           PlotStyle -> {{Thick, Black}}], 
          Graphics[{Black, 
            Text["\!\(TraditionalForm\`y = f(t)\)", {10, 6}, {1, -1}], 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`A(x + h)\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> 
              If[$CellContext`areaSelection$$ == 
                1, $CellContext`bcAreaPositiveColor, None]], {
             0.5, 7}, {-1.1, 0}], 
            Text["\!\(\(TraditionalForm\`-\)\)", {2.2, 7}, {-1.1, 0}], 
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`A(x)\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> 
              If[$CellContext`areaSelection$$ == 
                2, $CellContext`bcAreaPositiveColor, None]], {
             2.7, 7}, {-1.1, 0}], 
            ...
            Text[
             Framed[
              Pane[
              "\!\(TraditionalForm\`h\\ \(f(x)\)\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> 
              If[$CellContext`areaSelection$$ == 
                3, $CellContext`bcAreaPositiveColor, None]], {
             4.3, 7}, {-1.1, 0}], 
            ...
            If[$CellContext`areaSelection$$ == 
             3, {$CellContext`bcAreaPositiveColor, 
              EdgeForm[{$CellContext`bcAreaPositiveBorderColor, 
                AbsoluteThickness[1]}], 
              Opacity[0.7], 
              Polygon[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 
                 $CellContext`funcC5F39[$CellContext`xValue$$]}, \
{$CellContext`xValue$$ + $CellContext`hValue$$, 
                 $CellContext`funcC5F39[$CellContext`xValue$$]}, \
{$CellContext`xValue$$ + $CellContext`hValue$$, 0}}]}, 
             Black], $CellContext`bcAreaPositiveBorderColor, 
            AbsoluteThickness[1], 
            Line[{{1, 0}, {1, 
               $CellContext`funcC5F39[1]}}], 
            Line[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 
               $CellContext`funcC5F39[$CellContext`xValue$$]}}], 
            
            Line[{{$CellContext`xValue$$ + $CellContext`hValue$$, 
               0}, {$CellContext`xValue$$ + $CellContext`hValue$$, 
               $CellContext`funcC5F39[$CellContext`xValue$$ + \
$CellContext`hValue$$]}}]}]}, PlotRange -> {{-0.2, 10}, {-1, 8}}, ImageSize -> 
         6 72, AxesOrigin -> {0, 0}, 
         Ticks -> {{{
            1, "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, \
{$CellContext`xValue$$, 
             Style[
             "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", \
$CellContext`bcR]}, {$CellContext`xValue$$ + $CellContext`hValue$$, 
             "\!\(TraditionalForm\`x + h\)"}}, None}, AxesStyle -> 
         Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
       ...
       "Specifications" :> {
        "\!\(TraditionalForm\`A(x) = \*SubsuperscriptBox[\(\[Integral]\), \
\(\(\\ \)\(a\)\), \(\(\\ \)\(x\)\)]\(f(t)\)\\ d\[VeryThinSpace]t\)", 
         Delimiter, {{$CellContext`areaSelection$$, 1, ""}, {
          1 -> Pane[
            "\!\(TraditionalForm\`A(x + h)\)", {72, Automatic}, Alignment -> 
             Center], 2 -> 
           Pane["\!\(TraditionalForm\`A(x)\)", {72, Automatic}, Alignment -> 
          ...
          "Vertical"}, 
         Delimiter, {{$CellContext`xValue$$, 5, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 1.1, 6.9, 
          0.1, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`hValue$$, 1, 
           "\!\(\*\nStyleBox[\"h\",\nFontSlant->\"Italic\"]\)"}, 0.2, 2, 0.1, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{574., {155., 162.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC5F39[
            Pattern[$CellContext`x, 
             Blank[]]] := -Sin[(Pi/5) $CellContext`x] + 
           5, $CellContext`bcAreaPositiveColor = 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`bcAreaPositiveBorderColor = 
          RGBColor[0.467, 0.753, 0.651], 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC5F39[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.3, Figure 5.39"], "Header"]}, {
   Cell[
    TextData["Section 5.3, Figure 5.39"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 8532, 176, 344, "Output"]
}
]
*)
...
(* NotebookSignature kKNZsiaY4G9MfK#WUmZ6eutr *)
