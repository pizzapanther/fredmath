...
NotebookDataLength[     60052,       1285]
NotebookOptionsPosition[     26733,        518]
NotebookOutlinePosition[     60146,       1287]
CellTagsIndexPosition[     60103,       1284]
WindowTitle->Section 5.2, Figure 5.18
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`method$$ = "Left", $CellContext`nValue$$ = 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       1}}, Typeset`size$$ = {360., {114., 121.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`method$2124$$ = False, $CellContext`nValue$2125$$ = 
     0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`method$$ = "Left", $CellContext`nValue$$ = 
         5}, "ControllerVariables" :> {
         Hold[$CellContext`method$$, $CellContext`method$2124$$, False], 
         Hold[$CellContext`nValue$$, $CellContext`nValue$2125$$, 0]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Module[{$CellContext`x$}, 
           $CellContext`RiemannSum[
            $CellContext`funcC4F18[$CellContext`x$], {$CellContext`x$, 1, 
...
$CellContext`ShowAreaValue -> False]], 
          Plot[
           $CellContext`funcC4F18[$CellContext`x], {$CellContext`x, 0, 10}, 
             ...
             Table[
              Text[
               ...
               1 + ($CellContext`i - 1) (8/$CellContext`nValue$$), 
                1.75}], {$CellContext`i, 1, $CellContext`nValue$$}], "Right", 
             ...
             Table[
              Text[
               ...
               1 + $CellContext`i (8/$CellContext`nValue$$), 
                1.75}], {$CellContext`i, 1, $CellContext`nValue$$}], 
             "Midpoint", 
             Table[
              Text[
               Subsuperscript[
               "\!\(TraditionalForm\`x\)", $CellContext`i, "*"], {
               1 + ($CellContext`i - 1/2) (8/$CellContext`nValue$$), 
                1.75}], {$CellContext`i, 1, $CellContext`nValue$$}], "Random", 
             Text[
             "Each \!\(TraditionalForm\`\(TraditionalForm\`\*\
SubsuperscriptBox[\(x\), \(k\), \(*\)]\)\) can be any point in the \
\!\(TraditionalForm\`k\)th subinterval.", {5, 1.75}]], 
            Table[
             Text[
              Subscript["\!\(TraditionalForm\`x\)", $CellContext`i], {
              1 + $CellContext`i (8/$CellContext`nValue$$), 
               1}], {$CellContext`i, 1, $CellContext`nValue$$ - 1}], 
            Text[
            "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(0\)] = a\)", {1, 
             1}, {0.75, 0}], 
            Text[
             Row[{
...
$CellContext`bcFO], {1, -7}, {-1, -1}], "Random", 
         ...
         AxesOrigin -> {0, 0}, PlotRange -> {{0, 10}, {-7, 2}}, AxesStyle -> 
         Arrowheads[{0, 0.03}], 
         AxesLabel -> {
...
{$CellContext`i, 1, $CellContext`intervals}], "Trapezoid", 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4F18[
            Pattern[$CellContext`x, 
             Blank[]]] := Sin[(Pi/5) $CellContext`x] - 5}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 5.2, Figure 5.18"], "Header"]}, {
   Cell[
    TextData["Section 5.2, Figure 5.18"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[591, 21, 26138, 495, 298, "Output"]
}
]
*)
...
(* NotebookSignature UKjU9TPkgmjwcK5lesn66Hlq *)
