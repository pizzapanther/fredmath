...
NotebookDataLength[     38350,        885]
NotebookOptionsPosition[      5681,        126]
NotebookOutlinePosition[     39128,        897]
CellTagsIndexPosition[     39085,        894]
WindowTitle->Section 2.6, Figure 2.56a
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`yValue$$ = 2, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"L\",\nFontSlant->\"Italic\"]\)"}, 1., 4.5, 0.1}}, 
     Typeset`size$$ = {252., {81., 86.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`yValue$86976$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`yValue$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`yValue$$, $CellContext`yValue$86976$$, 0]}, 
       "OtherVariables" :> {
            ...
            ReplaceAll[$CellContext`xVar, 
             N[
              Quiet[
               ...
               Solve[$CellContext`funcC2F56a[$CellContext`xVar] == \
$CellContext`yValue$$, $CellContext`xVar]]]], 
            Blank[Real]]; Show[{
            Plot[
             $CellContext`funcC2F56a[$CellContext`x], {$CellContext`x, 1, 4}, 
            ...
            Graphics[{
              ...
              Black, 
              Point[{{1, 
                 $CellContext`funcC2F56a[1]}, {4, 
                 $CellContext`funcC2F56a[4]}}], 
              Text[
              "\!\(TraditionalForm\`L\)", {0, $CellContext`yValue$$}, {2, 0}], 
              Text["\!\(TraditionalForm\`y = f(x)\)", {4, 
                $CellContext`funcC2F56a[4]}, {1.5, 0}], 
              Table[{
                Text["\!\(TraditionalForm\`c\)", {
...
$CellContext`yValue$$}}]}, {$CellContext`i, 1, 
           ...
           PlotRange -> {{-1, 5}, {-1, 5.5}}, AxesOrigin -> {0, 0}, 
           AxesLabel -> {
            "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
           Ticks -> {{{1, "\!\(TraditionalForm\`a\)"}, {
              4, "\!\(TraditionalForm\`b\)"}}, {{
               $CellContext`funcC2F56a[1], "\!\(TraditionalForm\`f(a)\)"}, {
               $CellContext`funcC2F56a[4], "\!\(TraditionalForm\`f(b)\)"}}}, 
           BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.06}], 
           ImageSize -> 3.5 72]], 
       "Specifications" :> {{{$CellContext`yValue$$, 2, 
           "\!\(\*\nStyleBox[\"L\",\nFontSlant->\"Italic\"]\)"}, 1., 4.5, 0.1,
           ControlType -> Slider, Appearance -> "Vertical", ImageSize -> 
          Small}}, 
       "Options" :> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F56a[
            Pattern[$CellContext`x, 
             Blank[]]] := 0.5 2^($CellContext`x - 1) + 0.5, 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F56a[
            Pattern[$CellContext`x, 
             Blank[]]] := 0.5 2^($CellContext`x - 1) + 0.5}}; 
         ...
         GridBox[{{"\"Section \"", "\"2.6\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"2\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"56a\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.56a"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.56a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 4403, 93, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature mLj4KBEIaTx#sI#CqEw3tFI@ *)
