...
NotebookDataLength[     43037,        961]
NotebookOptionsPosition[     10384,        203]
NotebookOutlinePosition[     43814,        973]
CellTagsIndexPosition[     43771,        970]
WindowTitle->Section 2.1, Figure 2.04
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`avgVelocity$$ = {1, 2}, Typeset`show$$ = 
...
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1.1", {108, Automatic}, 
        ...
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1.01", {108, Automatic}, 
          Alignment -> Center], {1, 1.001} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1.001", {108, Automatic}, 
          Alignment -> Center], {1, 1.0001} -> 
        Pane["\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1 to \!\(\*\
\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 1.0001", {108, Automatic}, 
          Alignment -> Center]}}}, Typeset`size$$ = {360., {118., 124.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`avgVelocity$84936$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`avgVelocity$$ = {1, 2}}, 
       "ControllerVariables" :> {
         Hold[$CellContext`avgVelocity$$, $CellContext`avgVelocity$84936$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Graphics[{
            ...
            Line[{{1.3, ($CellContext`funcC2F1[
                  Part[$CellContext`avgVelocity$$, 2]] + $CellContext`funcC2F1[
                  Part[$CellContext`avgVelocity$$, 1]])/2}, {2, 120}}], Black, 
            Text[
             Grid[{{"\!\(\*SubscriptBox[\(v\), \(av\)]\)", " = ", Row[{"s(", 
              ...
              Alignment -> Left, BaseStyle -> "Text"], {2, 125}, {-1, 1}], 
            Text[
             Framed[
              Pane[
              "As the time intervals shrink, the average velocities approach \
64 ft/s \[LongDash] the instantaneous velocity at \!\(TraditionalForm\`t = \
1\).", {175, Automatic}, $CellContext`bcPBS], $CellContext`bcFO], {
             1.75, 100}, {-1, 1}], Gray, 
            Point[{{0.2, 
               $CellContext`funcC2F1[
               ...
               $CellContext`funcC2F1[
                Part[$CellContext`avgVelocity$$, 2]]}}], 
            Polygon[{{0, 75}, {0.1, 75}, {0.1, 130}, {0, 130}}, VertexColors -> {
               GrayLevel[0.4], 
               GrayLevel[0.4], 
               GrayLevel[0.9], 
               GrayLevel[0.9]}]}]}, Ticks -> {None, {0, 80, 86.24, 108, 128}},
          Axes -> {False, True}, PlotRange -> {{-0.5, 4.5}, {75, 130}}, 
         AspectRatio -> 1/1.62, 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) (s)", 
           "\!\(\*\nStyleBox[\"s\",\nFontSlant->\"Italic\"]\) (ft)"}, 
...
$CellContext`bcR = RGBColor[0.8, 0, 0.4], $CellContext`bcPBS = 
          BaseStyle -> {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.1, Figure 2.04"], "Header"]}, {
   Cell[
    TextData["Section 2.1, Figure 2.04"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 9107, 170, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature cI4AeJAB9jd7VKObqE9i93@L *)
