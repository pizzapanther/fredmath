...
NotebookDataLength[     37461,        863]
NotebookOptionsPosition[      4809,        105]
NotebookOutlinePosition[     38239,        875]
CellTagsIndexPosition[     38196,        872]
WindowTitle->Section 2.3, Figure 2.22
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`zoomFactor$$ = 1, Typeset`show$$ = True, 
     ...
     Typeset`size$$ = {360., {111., 117.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`zoomFactor$85893$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`zoomFactor$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`zoomFactor$$, $CellContext`zoomFactor$85893$$, 0]},
        "OtherVariables" :> {
          ...
          Graphics[{
            ...
            "\!\(TraditionalForm\`y = \*SuperscriptBox[\(x\), \(2\)]\)", {
             0.2/$CellContext`zoomFactor$$, 
              0.04/$CellContext`zoomFactor$$^2}, {1.5, -1}], 
            RGBColor[0, 0.4, 0.8], 
            Text[
            "\!\(TraditionalForm\`y = \(-\*SuperscriptBox[\(x\), \(2\)]\)\)", \
...
{(-0.05)/$CellContext`zoomFactor$$^2, 0.05/$CellContext`zoomFactor$$^2}}, 
         Frame -> True, BaseStyle -> {"Text", 13}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         FrameTicks -> {{{-0.04, -0.02, -0.01, 0, 0.01, 0.02, 0.04}, 
            None}, {{-0.2, -0.1, -0.05, 0, 0.05, 0.1, 0.2}, None}}, ImageSize -> 
         5 72], "Specifications" :> {{{$CellContext`zoomFactor$$, 1, "zoom"}, 
          1, 4, ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{525., {129., 134.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.3, Figure 2.22"], "Header"]}, {
   Cell[
    TextData["Section 2.3, Figure 2.22"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 3532, 72, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 9J41Zbe3CvLI7KOOS#tILXCP *)
