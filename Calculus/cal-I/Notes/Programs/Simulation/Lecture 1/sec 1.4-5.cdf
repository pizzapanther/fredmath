...
NotebookDataLength[     40508,        927]
NotebookOptionsPosition[      7855,        169]
NotebookOutlinePosition[     41285,        939]
CellTagsIndexPosition[     41242,        936]
WindowTitle->Section 2.5, Figure 2.31
WindowFrame->Normal*)
    ...
    DynamicModuleBox[{$CellContext`direction$$ = 1, $CellContext`xValue$$ = 2,
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -9.99, 9.99, 
       0.01}}, Typeset`size$$ = {360., {114., 119.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`direction$86168$$ = 
     False, $CellContext`xValue$86169$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`direction$$ = 1, $CellContext`xValue$$ = 
         2}, "ControllerVariables" :> {
         Hold[$CellContext`direction$$, $CellContext`direction$86168$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$86169$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F31[$CellContext`x], {$CellContext`x, -10, 10}, 
           PlotStyle -> {Thick, Black}], 
          Graphics[{
            AbsoluteThickness[1.5], Dashed, 
            If[$CellContext`direction$$ == 1, {$CellContext`bcR, 
              Line[{{0, Pi/2}, {10, Pi/2}}], Black, 
              Text[
              "\!\(TraditionalForm\`L\)", {0, Pi/2}, {
               1.5, 0}]}, {$CellContext`bcR, 
              Line[{{0, (-Pi)/2}, {-10, (-Pi)/2}}], Black, 
              Text[
              "\!\(TraditionalForm\`M\)", {
               0, (-Pi)/2}, {-1.5, 0}]}], $CellContext`bcR, 
            Line[{{0, 
...
$CellContext`bcPBS], $CellContext`bcFO], {$CellContext`xValue$$, 0}, {
              0, Sign[
                 $CellContext`funcC2F31[$CellContext`xValue$$]] 1.5}]], Black, 
            If[$CellContext`direction$$ == 1, 
             Text[
              Framed[
               Pane[
...
, \(x \[Rule] \(-\[Infinity]\)\)]f(x) = M\)\)", $CellContext`bcPBS], \
$CellContext`bcFO], {-2, -2.45}, {1, -1}]], $CellContext`bcR, 
            Arrowheads[0.06], 
            Opacity[0.5], 
            AbsoluteThickness[5], 
            Dashing[{}], 
            Arrow[{{$CellContext`xValue$$, 0}, 
              ...
              If[$CellContext`direction$$ == 
               1, {$CellContext`xValue$$ + 2, 0}, {$CellContext`xValue$$ - 2, 
                0}]}], $CellContext`bcB, 
            AbsolutePointSize[7], 
            Opacity[1], 
         ...
         None, ImageSize -> 5 72, PlotRange -> {{-10, 10}, {-2.55, 2.55}}], 
       "Specifications" :> {
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) goes to ", \
{{$CellContext`direction$$, 1, ""}, {-1 -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{503., {131., 137.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F31[
            Pattern[$CellContext`x, 
             Blank[]]] := ArcTan[$CellContext`x], $CellContext`bcR = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F31[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.31"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.31"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6578, 136, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 8I4XSYKYOqddhKOaImXpKtUe *)
