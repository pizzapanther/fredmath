...
NotebookDataLength[     38350,        880]
NotebookOptionsPosition[      5698,        122]
NotebookOutlinePosition[     39128,        892]
CellTagsIndexPosition[     39085,        889]
WindowTitle->Section 2.6, Figure 2.58
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showRate$$ = False, $CellContext`yValue$$ =
      1400, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`yValue$$], 1400, "Amount"}, 1000, 1800, 5}, {{
        Hold[$CellContext`yValue$$], 1400, ""}, 1000, 1800, 5}, {{
        Hold[$CellContext`showRate$$], False, "Show rate"}, {True, False}}}, 
     Typeset`size$$ = {432., {129., 134.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`yValue$87133$$ = 0, $CellContext`showRate$87134$$ = 
     False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`showRate$$ = False, $CellContext`yValue$$ = 
         1400}, "ControllerVariables" :> {
         Hold[$CellContext`yValue$$, $CellContext`yValue$87133$$, 0], 
         Hold[$CellContext`showRate$$, $CellContext`showRate$87134$$, False]},
        "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[{1000 (
              1 + $CellContext`r/
               12)^60, $CellContext`yValue$$}, {$CellContext`r, 0, 0.12}, 
           PlotStyle -> {{Thick, $CellContext`bcB}, {Black, 
          ...
          Graphics[{
            Text[
             ...
             Row[{"\!\(TraditionalForm\`y\)", 
               " = ", $CellContext`yValue$$}], {
             0.005, $CellContext`yValue$$}, {-1, -1}], 
            If[$CellContext`showRate$$, {Dashed, 
              RGBColor[0.8, 0, 0.4], 
              AbsoluteThickness[1.5], 
              
              Line[{{12 (($CellContext`yValue$$/1000)^(1/60) - 1), 0}, {
                12 (($CellContext`yValue$$/1000)^(1/60) - 
                  1), $CellContext`yValue$$}}], Black, 
              Text[
               Row[{"\!\(TraditionalForm\`r\)", " = ", 
                 Round[
                 12 (($CellContext`yValue$$/1000)^(1/60) - 1), 0.0001]}], {
               12 (($CellContext`yValue$$/1000)^(1/60) - 1), 0}, 
               If[$CellContext`yValue$$ < 1350, {-1.5, -1.5}, {1.5, -1.5}]]}, 
             Black]}]}, PlotRange -> {{0, 0.12}, {0, 2000}}, 
         AxesOrigin -> {0, 0}, ImageSize -> 6 72, 
...
\nFontSlant->\"Italic\"]\)\!\(\*\nStyleBox[\" \",\n\
FontSlant->\"Italic\"]\))", {150, Automatic}]}, BaseStyle -> {"Text", 13}, 
         AxesStyle -> Arrowheads[{0, 0.04}]], 
       "Specifications" :> {{{$CellContext`yValue$$, 1400, "Amount"}, 1000, 
          1800, 5, ControlType -> Slider, Appearance -> "Vertical", ImageSize -> 
          Small}, {{$CellContext`yValue$$, 1400, ""}, 1000, 1800, 5, 
          ControlType -> Trigger, 
          AppearanceElements -> {"StepLeftButton", "StepRightButton"}}, 
         Delimiter, {{$CellContext`showRate$$, False, "Show rate"}, {
          True, False}, ControlType -> Checkbox}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{559., {146., 152.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.58"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.58"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4421, 89, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature nIj#pgARFqyW2I55vGHMrukT *)
