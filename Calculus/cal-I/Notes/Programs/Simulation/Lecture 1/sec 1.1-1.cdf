...
NotebookDataLength[     38152,        881]
NotebookOptionsPosition[      5500,        123]
NotebookOutlinePosition[     38930,        893]
CellTagsIndexPosition[     38887,        890]
WindowTitle->Section 2.1, Figure 2.01
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`tValue$$ = {}, Typeset`show$$ = True, 
     ...
     False, $CellContext`tValue$84814$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`tValue$$ = {}}, 
       "ControllerVariables" :> {
         Hold[$CellContext`tValue$$, $CellContext`tValue$84814$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Graphics[{
            ...
            Map[Point[{-0.35, 
               $CellContext`funcC2F1[#]}]& , $CellContext`tValue$$], 
            Lighter[$CellContext`bcB], 
            Map[Point[{#, 
               $CellContext`funcC2F1[#]}]& , $CellContext`tValue$$], Black, 
            Map[Text[
              
              Row[{"(", #, ", ", "\!\(TraditionalForm\`s\)", "(", #, ")", 
                ")"}], {#, 
               $CellContext`funcC2F1[#]}, {-1, 2}]& , $CellContext`tValue$$], 
            Dashed, 
            AbsoluteThickness[1], $CellContext`bcR, 
            Map[Line[{{-0.35, 
                $CellContext`funcC2F1[#]}, {#, 
                $CellContext`funcC2F1[#]}}]& , $CellContext`tValue$$], Gray, 
            Dashing[{}], Thick, 
            Map[Arrow[{{-0.35, 0}, {-0.35, 
                $CellContext`funcC2F1[#]}}]& , $CellContext`tValue$$]}]}, 
         Ticks -> {
           Range[0, 4], {80, 128, 144}}, 
         PlotRange -> {{-0.5, 4.5}, {-10, 170}}, 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) (s)", 
           "\!\(\*\nStyleBox[\"s\",\nFontSlant->\"Italic\"]\) (ft)"}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.1, Figure 2.01"], "Header"]}, {
   Cell[
    TextData["Section 2.1, Figure 2.01"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4223, 90, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature EJjRSzboSzA5pJk4kaiQgs2g *)
