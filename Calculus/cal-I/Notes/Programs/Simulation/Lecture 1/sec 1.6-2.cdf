...
NotebookDataLength[     45681,       1042]
NotebookOptionsPosition[     13027,        284]
NotebookOutlinePosition[     46457,       1054]
CellTagsIndexPosition[     46414,       1051]
WindowTitle->Section 2.7, Figure 2.61
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`delta$$ = 1, $CellContext`epsilon$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showRangeInterval$87282$$ = 
     False, $CellContext`epsilon$87283$$ = 
     0, $CellContext`showDomainInterval$87284$$ = 
     False, $CellContext`delta$87285$$ = 0}, 
...
$CellContext`showRangeInterval$87282$$, False], 
         Hold[$CellContext`epsilon$$, $CellContext`epsilon$87283$$, 0], 
         Hold[$CellContext`showDomainInterval$$, \
$CellContext`showDomainInterval$87284$$, False], 
         Hold[$CellContext`delta$$, $CellContext`delta$87285$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[
           $CellContext`funcC2F61[$CellContext`x], {$CellContext`x, 0, 7}, 
...
the value of \[Epsilon] or decrease the value of \[Delta].", {
       ...
       "Specifications" :> {{{$CellContext`showRangeInterval$$, True, 
          ...
          Dynamic[$CellContext`showRangeInterval$$], Appearance -> "Vertical",
           ...
           Rational[1, 2], ""}, 0.1, 2, 0.1, ControlType -> Slider, Enabled :> 
          Dynamic[$CellContext`showRangeInterval$$], Appearance -> "Vertical",
         ...
         Grid[{{
          ...
          ControlPlacement -> 4}, {{$CellContext`delta$$, 1, 
           Style["\[Delta]", 14]}, {
          Rational[1, 4] -> 
           Pane["\!\(TraditionalForm\`1/4\)", {24, Automatic}, Alignment -> 
             Center], 1 -> Pane[1, {24, Automatic}, Alignment -> Center], 2 -> 
          ...
          ControlPlacement -> 5}, {{$CellContext`delta$$, 1, 
     ...
     Initialization:>({{$CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC2F61[
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}, 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F61[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.7, Figure 2.61"], "Header"]}, {
   Cell[
    TextData["Section 2.7, Figure 2.61"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 11750, 251, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature ZJzekFcSHAS0fJ#uRCLdfn3j *)
