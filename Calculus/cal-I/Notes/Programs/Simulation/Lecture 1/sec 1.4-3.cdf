...
NotebookDataLength[     37957,        870]
NotebookOptionsPosition[      5305,        112]
NotebookOutlinePosition[     38735,        882]
CellTagsIndexPosition[     38692,        879]
WindowTitle->Section 2.4, Figure 2.28
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`choice$$ = 1, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       1 -> "Calculator graph", 2 -> "Correct graph"}}}, Typeset`size$$ = {
     360., {133.6875, 140.3125}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`choice$86045$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`choice$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`choice$$, $CellContext`choice$86045$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Framed[
            Pane[
            "Graph of \!\(TraditionalForm\`y = \
\*FractionBox[\(\*SuperscriptBox[\(x\), \(2\)] - 4  x + 3\), \
\(\*SuperscriptBox[\(x\), \(2\)] - 1\)]\)", {
             Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO]}, {
           Show[{
             Plot[
              $CellContext`funcC2F28[$CellContext`xVar], {$CellContext`xVar, \
-5, 5}, PlotRange -> 10, PlotStyle -> {Thick, Black}, Exclusions -> 
              If[$CellContext`choice$$ == 1, 
                None, {$CellContext`xVar == -1, $CellContext`xVar == 1}], 
              ExclusionsStyle -> If[$CellContext`choice$$ == 1, None, {{
                  AbsoluteThickness[1.5], Dashed, $CellContext`bcR}}]], 
             Graphics[{
               If[$CellContext`choice$$ == 2, {
                 EdgeForm[Black], White, 
                 Disk[{1, -1}, 0.15 {1, 3.2}]}, Black]}]}, 
            Ticks -> {{{-4, -4}, {-3, -3}, {-2, -2}, {-1, ""}, {0, 0}, {
               1, ""}, {2, 2}, {3, 3}, {4, 4}}, None}, ImageSize -> 5 72, 
            BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.04}], 
            AxesLabel -> {
             "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}]}}, 
         BaseStyle -> {"TR", 13}], 
       "Specifications" :> {{{$CellContext`choice$$, 1, ""}, {
          1 -> "Calculator graph", 2 -> "Correct graph"}, ControlType -> 
     ...
     Initialization:>({{$CellContext`bcPBS = 
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`funcC2F28[
            Pattern[$CellContext`x, 
             Blank[]]] := ($CellContext`x^2 - 4 $CellContext`x + 
            3)/($CellContext`x^2 - 1), 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC2F28[
            Pattern[$CellContext`x, 
             Blank[]]] := ($CellContext`x^2 - 4 $CellContext`x + 
            3)/($CellContext`x^2 - 1)}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.4, Figure 2.28"], "Header"]}, {
   Cell[
    TextData["Section 2.4, Figure 2.28"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4028, 79, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature jKN70c15LL6dnI5K7#RMU0CN *)
