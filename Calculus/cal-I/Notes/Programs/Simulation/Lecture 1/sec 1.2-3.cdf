...
NotebookDataLength[     38972,        899]
NotebookOptionsPosition[      6319,        141]
NotebookOutlinePosition[     39749,        911]
CellTagsIndexPosition[     39706,        908]
WindowTitle->Section 2.2, Figure 2.09
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 1.25, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["Near \!\(TraditionalForm\`x = 2\)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xValue$$], 1.25, "\!\(TraditionalForm\`x\)"}, 1.2, 
       2.8, 0.01}}, Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ = 
     0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$85296$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 1.25}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$85296$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F9[$CellContext`x], {$CellContext`x, 0, 6}, 
           GridLines -> {
             Range[0, 6], 
          ...
          Graphics[{
            ...
            EdgeForm[Black], 
            Disk[{2, 
              $CellContext`funcC2F9[2]}, 0.12], 
            Disk[{3, 
              $CellContext`funcC2F9[3]}, 0.12], Black, 
            Disk[{2, 5}, 0.1], 
...
\!\(TraditionalForm\`f(x)\) approaches 3.", {
              ...
              Background -> White], {0.25, 7}, {-1, 1}], $CellContext`bcR, 
            EdgeForm[$CellContext`bcR], 
            If[1.999 < $CellContext`xValue$$ < 2.001, 
             Disk[{2, 5}, 0.1], 
             Disk[{$CellContext`xValue$$, 
               $CellContext`funcC2F9[$CellContext`xValue$$]}, 0.1]], {White, 
             EdgeForm[Black], 
             Disk[{3, 4}, 0.12]}, 
            RGBColor[0.8, 0, 0.4], 
            Arrowheads[0.06], 
            ...
            Arrow[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$ - 0.7 
               Sign[$CellContext`xValue$$ - 2], 0}}], 
            Arrow[{{0, 
               $CellContext`funcC2F9[$CellContext`xValue$$]}, {
              0, $CellContext`funcC2F9[$CellContext`xValue$$] - 0.7 
               Sign[$CellContext`xValue$$ - 2]}}]}]}, 
         PlotRange -> {{-0.5, 6.5}, {-0.5, 7}}, AxesOrigin -> {0, 0}, Ticks -> {
           Range[0, 6], 
       ...
       "Specifications" :> {
        "Near \!\(TraditionalForm\`x = 2\)", {{$CellContext`xValue$$, 1.25, 
           "\!\(TraditionalForm\`x\)"}, 1.2, 2.8, 0.01, ControlType -> Slider,
           ImageSize -> Small}}, 
       "Options" :> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F9[
          ...
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC2F9[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Sign[$CellContext`x - 2] Abs[$CellContext`x - 2]^(1/3) + 3}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.2, Figure 2.09"], "Header"]}, {
   Cell[
    TextData["Section 2.2, Figure 2.09"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5042, 108, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 3LN8wWX8Ylsg6KOO7grW@QX3 *)
