...
NotebookDataLength[     37206,        856]
NotebookOptionsPosition[      4537,         97]
NotebookOutlinePosition[     37984,        868]
CellTagsIndexPosition[     37941,        865]
WindowTitle->Section 2.5, Figure 2.35b
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`n$$ = 3, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`n$$], 3, "odd powers"}, 3, 19, 2}}, 
     Typeset`size$$ = {252., {134., 140.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`n$86439$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`n$$ = 3}, 
       "ControllerVariables" :> {
         Hold[$CellContext`n$$, $CellContext`n$86439$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
         Typeset`specs$$, Typeset`size$$, Typeset`update$$, 
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> 
       Plot[$CellContext`x^$CellContext`n$$, {$CellContext`x, -4.5, 4.5}, 
         PlotRange -> {-50, 50}, Ticks -> {
           Range[-4, 4], 
           Range[-40, 40, 10]}, PlotStyle -> {Thick, Black}, PlotLabel -> 
         Style["\!\(TraditionalForm\`y\)" == 
           "\!\(TraditionalForm\`x\)"^$CellContext`n$$, Smaller], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         AspectRatio -> 1, ImageSize -> 3.5 72, BaseStyle -> {"Text", 13}, 
         AxesStyle -> Arrowheads[{0, 0.06}], Epilog -> {
           Text[
            Framed[
            "\!\(\*FormBox[GridBox[{\n   {\n    RowBox[{\"n\", \">\", \n     \
RowBox[{\"0\", \" \", \n      RowBox[{\"odd\", \":\"}]}]}]},\n   {\n    \
...
TraditionalForm]\)", $CellContext`bcFO, Background -> White], {4.5, -50}, {
            1, -1}]}], 
       "Specifications" :> {{{$CellContext`n$$, 3, "odd powers"}, 3, 19, 2, 
         ...
         GridBox[{{"\"Section \"", "\"2.5\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"2\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"35b\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.35b"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.35b"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 3259, 64, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature TL4tp332G9MbULOsGgLEJr#X *)
