...
NotebookDataLength[     38848,        893]
NotebookOptionsPosition[      6195,        135]
NotebookOutlinePosition[     39625,        905]
CellTagsIndexPosition[     39582,        902]
WindowTitle->Section 2.3, Figure 2.20
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`boundingFunctions$$ = {}, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`boundingFunctions$$], {}, ""}, {
       2 -> "upper bound \!\(TraditionalForm\`h(x)\)", 1 -> 
        "lower bound \!\(TraditionalForm\`f(x)\)"}}}, Typeset`size$$ = {
     360., {135.6875, 142.3125}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`boundingFunctions$85781$$ = 
     False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`boundingFunctions$$ = {}},
        "ControllerVariables" :> {
         Hold[$CellContext`boundingFunctions$$, \
$CellContext`boundingFunctions$85781$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
             ...
             Graphics[{
               If[
                ...
                MemberQ[$CellContext`boundingFunctions$$, 
                 1], {$CellContext`bcB, 
                 Text["\!\(TraditionalForm\`y = f(x)\)", {4, 1}, {-1.5, 0}]}, 
                Black], 
               If[
                
                MemberQ[$CellContext`boundingFunctions$$, 
                 2], {$CellContext`bcR, 
                 Text["\!\(TraditionalForm\`y = h(x)\)", {4, 9}, {-1.5, 0}]}, 
                Black], 
               Text["\!\(TraditionalForm\`y = g(x)\)", {4, 6.75}, {-1.5, 0}], 
               ...
               Text[
                Row[{
                  ...
                  " \[LessEqual] ", 
                  Style["\!\(TraditionalForm\`h(x)\)", $CellContext`bcR]}], {
                2, 9}], Dashed, $CellContext`bcR, 
               AbsoluteThickness[1.5], 
               Line[{{2, 0}, {2, 5}, {0, 5}}]}]}, 
            PlotRange -> {{-1, 5.5}, {-1, 10}}, AxesOrigin -> {0, 0}, 
           ...
           Framed[
            Pane[
            "As \!\(TraditionalForm\`x \[Rule] a\), \!\(TraditionalForm\`h(x) \
\[Rule] L\) and \!\(TraditionalForm\`f(x) \[Rule] L\). Therefore, \
\!\(TraditionalForm\`g(x) \[Rule] L\).", {
             3.5 72, Automatic}, $CellContext`bcPBS], $CellContext`bcFO]}}, 
         BaseStyle -> {"TR", 13}], 
       "Specifications" :> {{{$CellContext`boundingFunctions$$, {}, ""}, {
          2 -> "upper bound \!\(TraditionalForm\`h(x)\)", 1 -> 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.3, Figure 2.20"], "Header"]}, {
   Cell[
    TextData["Section 2.3, Figure 2.20"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4918, 102, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 1Ij32xAJ5DfKbJ#Qf#c0w3LB *)
