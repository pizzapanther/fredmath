...
NotebookDataLength[     43771,        996]
NotebookOptionsPosition[     11118,        238]
NotebookOutlinePosition[     44548,       1008]
CellTagsIndexPosition[     44505,       1005]
WindowTitle->Section 2.7, Figure 2.69
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`rangeValue$$ = 
     ...
     True, $CellContext`showXValue$$ = False, $CellContext`xValue$$ = 1.6, 
     ...
     360., {181., 187.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showRangeInterval$87656$$ = 
     False, $CellContext`rangeValue$87657$$ = 
     0, $CellContext`showDomainInterval$87658$$ = 
     False, $CellContext`showXValue$87659$$ = 
     False, $CellContext`xValue$87660$$ = 0}, 
...
$CellContext`showRangeInterval$87656$$, False], 
         Hold[$CellContext`rangeValue$$, $CellContext`rangeValue$87657$$, 0], 
         
         Hold[$CellContext`showDomainInterval$$, \
$CellContext`showDomainInterval$87658$$, False], 
         Hold[$CellContext`showXValue$$, $CellContext`showXValue$87659$$, 
          False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$87660$$, 0]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Graphics[{
            If[$CellContext`showRangeInterval$$, {
              ...
              Opacity[0.5], 
              EdgeForm[None], 
              Rectangle[{0, $CellContext`rangeValue$$}, {4, 4}]}, Black], 
            ...
            If[$CellContext`showDomainInterval$$, {
              ...
              Line[{{2 + 1/$CellContext`rangeValue$$, 0}, {
                2 + 1/$CellContext`rangeValue$$, 4}}]}, Black]}], 
          Plot[
           $CellContext`funcC2F69[$CellContext`x], {$CellContext`x, 0, 4}, 
           PlotStyle -> {Thick, Black}, PlotRange -> {0, 4}, 
...
$CellContext`rangeValue$$, 
            ...
            If[$CellContext`showXValue$$, {
              ...
              Text["\!\(TraditionalForm\`f(x)\)", {0, 
                $CellContext`funcC2F69[$CellContext`xValue$$]}, {-1.5, -1.5}], 
...
satisfied.", {Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
         ...
         True, AspectRatio -> 1, ImageSize -> 5 72, Ticks -> {
           ...
           If[$CellContext`showRangeInterval$$, {{$CellContext`rangeValue$$, 
              "\!\(TraditionalForm\`N\)"}}]}, BaseStyle -> {"Text", 13}, 
       ...
       "Specifications" :> {{{$CellContext`showRangeInterval$$, True, 
          ...
          1}, {{$CellContext`rangeValue$$, 1.5, 
           "\!\(\*\nStyleBox[\"N\",\nFontSlant->\"Italic\"]\)"}, 0.6, 3.9, 
          0.01, ControlType -> Slider, Enabled :> 
         ...
         Delimiter, {{$CellContext`showXValue$$, False, 
          ...
          4}, {{$CellContext`xValue$$, 1.6, ""}, 0.1, 4, 0.01, ControlType -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{527., {199., 204.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC2F69[
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}}; {$CellContext`funcC2F69[
            Pattern[$CellContext`x, 
             Blank[]]] := Abs[1/($CellContext`x - 2)]}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.7, Figure 2.69"], "Header"]}, {
   Cell[
    TextData["Section 2.7, Figure 2.69"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 9841, 205, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature VK4Jce4@iJxdkJOjoG1PrYyB *)
