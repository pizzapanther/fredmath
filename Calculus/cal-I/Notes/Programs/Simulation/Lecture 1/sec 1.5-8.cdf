...
NotebookDataLength[     39707,        911]
NotebookOptionsPosition[      7054,        153]
NotebookOutlinePosition[     40484,        923]
CellTagsIndexPosition[     40441,        920]
WindowTitle->Section 2.6, Figure 2.57
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`yValue$$ = 2.5, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`yValue$$], 2.5, 
        "\!\(\*\nStyleBox[\"L\",\nFontSlant->\"Italic\"]\)"}, 1., 5.5, 0.01}},
      Typeset`size$$ = {288., {166., 172.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`yValue$87083$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`yValue$$ = 2.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`yValue$$, $CellContext`yValue$87083$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
         Typeset`specs$$, Typeset`size$$, Typeset`update$$, 
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> 
       DynamicModule[{$CellContext`xValue}, $CellContext`xValue = 
          Piecewise[{{
             1.4426950408889634` Log[4. (-0.5 + $CellContext`yValue$$)], 
              Inequality[0.5, LessEqual, $CellContext`yValue$$, Less, 1.9]}, {
             1.4426950408889634` 
              Log[4. (-1.5 + $CellContext`yValue$$)], $CellContext`funcC2F57[
                2.5] - 0.02 <= $CellContext`yValue$$ <= \
$CellContext`funcC2F57[4]}}]; Show[{
            Plot[
             $CellContext`funcC2F57[$CellContext`x], {$CellContext`x, 1, 4}, 
             PlotStyle -> {{Thick, Black}}, Exclusions -> {2.5}], 
            Graphics[{
              AbsoluteThickness[1.5], 
              AbsolutePointSize[6], Dashed, 
              RGBColor[0.8, 0, 0.4], 
              Line[{{0, $CellContext`yValue$$}, {5, $CellContext`yValue$$}}], 
              Black, 
              Point[{{1, 
                 $CellContext`funcC2F57[1]}, {2.5, 
                 $CellContext`funcC2F57[2.5]}, {4, 
                 $CellContext`funcC2F57[4]}}], 
              Text[
              "\!\(TraditionalForm\`L\)", {0, $CellContext`yValue$$}, {2, 0}], 
              Text[
               Framed[
                Pane[
                 
                 If[$CellContext`xValue != 0, 
                  "\!\(TraditionalForm\`f(c) = L\)", 
                  "There is no \!\(TraditionalForm\`c \[Element] \((a, b)\)\) \
such that \!\(TraditionalForm\`f(c) = L\)"], {
                  If[$CellContext`xValue != 0, Automatic, 90], Automatic}, 
                 BaseStyle -> {
                ...
                RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85], 
                 Background -> White}], {0.2, 6}, {-1, 1}], 
              If[$CellContext`xValue != 0, {
                Text[
                "\!\(TraditionalForm\`c\)", {$CellContext`xValue, 0}, {
                 0, 1.5}], 
              ...
              Disk[{2.5, 
                $CellContext`funcC2F57[2.499]}, 0.1], Black, 
              Text[
               Pane[
               "\!\(TraditionalForm\`y = f(x)\)", 
                BaseStyle -> {Background -> White}], {2.5, 
                $CellContext`funcC2F57[2.5]}, {-2, -1}]}]}, 
           PlotRange -> {{-1, 5}, {-1, 6}}, AxesOrigin -> {0, 0}, AspectRatio -> 
           Automatic, 
           AxesLabel -> {
            "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
           Ticks -> {{{1, "\!\(TraditionalForm\`a\)"}, {
              4, "\!\(TraditionalForm\`b\)"}}, {{
               $CellContext`funcC2F57[1], "\!\(TraditionalForm\`f(a)\)"}, {
               $CellContext`funcC2F57[4], "\!\(TraditionalForm\`f(b)\)"}}}, 
           BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.06}], 
           ImageSize -> 4 72]], 
       "Specifications" :> {{{$CellContext`yValue$$, 2.5, 
           "\!\(\*\nStyleBox[\"L\",\nFontSlant->\"Italic\"]\)"}, 1., 5.5, 
          0.01, ControlType -> Slider, Appearance -> "Vertical", ImageSize -> 
          Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{345., {184., 189.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F57[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{
             0.5 2^($CellContext`x - 1) + 0.5, $CellContext`x < 2.5}, {
             0.5 2^($CellContext`x - 1) + 1.5, $CellContext`x >= 2.5}}], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F57[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Piecewise[{{
             0.5 2^($CellContext`x - 1) + 0.5, $CellContext`x < 2.5}, {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.57"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.57"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5777, 120, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature QLzpnX7IPWHV1IOPYhZ2O2Lm *)
