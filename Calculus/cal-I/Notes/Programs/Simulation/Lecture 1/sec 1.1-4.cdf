...
NotebookDataLength[     39571,        907]
NotebookOptionsPosition[      6918,        149]
NotebookOutlinePosition[     40348,        919]
CellTagsIndexPosition[     40305,        916]
WindowTitle->Section 2.1, Figure 2.05
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`timeValue$$ = 1.9, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold[" "], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`timeValue$$], 1.9, "time"}, 0.01, 2.5, 0.01}}, 
     Typeset`size$$ = {360., {120., 125.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`timeValue$85009$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`timeValue$$ = 1.9}, 
       "ControllerVariables" :> {
         Hold[$CellContext`timeValue$$, $CellContext`timeValue$85009$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`funcC2F1[1])/($CellContext`timeValue$$ - 1)) ($CellContext`t - 
          ...
          Graphics[{
            ...
            Text[
            "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(tan\)] = 64\)", {2, 
             155}, {1.5, 0}], $CellContext`bcG, 
            Text[
             Row[{"\!\(\*SubscriptBox[\(m\), \(sec\)]\) = ", 
               
               Round[($CellContext`funcC2F1[$CellContext`timeValue$$] - \
$CellContext`funcC2F1[1])/($CellContext`timeValue$$ - 1), 0.001]}], {
             2.25, 155}, {-1, 0}], $CellContext`bcB, 
            Arrowheads[0.04], 
            
            Arrow[{{$CellContext`timeValue$$, -10}, {$CellContext`timeValue$$,
                0}}], 
            Point[{1, 
...
The secant lines approach the tangent line.", {
            ...
            Text[
             Pane[
              ...
              $CellContext`funcC2F1[$CellContext`timeValue$$]}, {-1, 3}]}]}, 
         Ticks -> {
...
\(2\)] + 96  t\)", 13], ImageSize -> 5 72], 
       "Specifications" :> {
        Delimiter, 
         " ", {{$CellContext`timeValue$$, 1.9, "time"}, 0.01, 2.5, 0.01, 
          ControlType -> Slider, ImageSize -> Small, Exclusions -> {1., 1}}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{519., {137., 143.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.1, Figure 2.05"], "Header"]}, {
   Cell[
    TextData["Section 2.1, Figure 2.05"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5641, 116, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 3IjQyblvciqiwIkyUV@Ytbma *)
