...
NotebookDataLength[     38954,        898]
NotebookOptionsPosition[      6301,        140]
NotebookOutlinePosition[     39731,        910]
CellTagsIndexPosition[     39688,        907]
WindowTitle->Section 2.6, Figure 2.52
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`domain$$ = 1, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       ...
       1 -> Pane[
         "\!\(TraditionalForm\`\((\(-3\), 3)\)\)", {48, Automatic}, Alignment -> 
          Center], 2 -> 
        Pane["\!\(TraditionalForm\`x = \(-3\)\)", {48, Automatic}, Alignment -> 
          Center], 3 -> 
        Pane["\!\(TraditionalForm\`x = 3\)", {48, Automatic}, Alignment -> 
          Center], 4 -> 
        Pane["\!\(TraditionalForm\`\([\(-3\), 3]\)\)", {48, Automatic}, 
          Alignment -> Center]}}}, Typeset`size$$ = {288., {115., 120.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`domain$86923$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`domain$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`domain$$, $CellContext`domain$86923$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F52[$CellContext`x], {$CellContext`x, -3, 3}, 
           PlotStyle -> {{Thick, 
              
              Switch[$CellContext`domain$$, 1, Black, 2, LightGray, 3, 
               LightGray, 4, Black]}}], 
          Graphics[{Black, 
            Text[
            "\!\(TraditionalForm\`g(x) = \*SqrtBox[\(9 - \*SuperscriptBox[\(x\
\), \(2\)]\)]\)", {0.5, 3}, {-1, -1}], 
            Text[
             Framed[
              Pane[
               ...
               Switch[$CellContext`domain$$, 1, 
                "Continuous on \!\(TraditionalForm\`\((\(-3\), 3)\)\)", 2, 
                "Right-continuous at \!\(TraditionalForm\`x = \(-3\)\)", 3, 
                "Left-continuous at \!\(TraditionalForm\`x = 3\)", 4, 
                "Continuous on \!\(TraditionalForm\`\([\(-3\), 3]\)\)"], {
               100, Automatic}, 
               BaseStyle -> {
                LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                 LineBreakWithin -> Automatic, Hyphenation -> True, 
                 TextAlignment -> Left, FontSize -> 13}], {
              RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}], {-3.5, 
             4.5}, {-1, 1}], 
            EdgeForm[Black], 
            
            Switch[$CellContext`domain$$, 1, LightGray, 2, LightGray, 3, 
             Black, 4, Black], 
            Disk[{3, 0}, 0.1], 
            
            Switch[$CellContext`domain$$, 1, LightGray, 2, Black, 3, 
             LightGray, 4, Black], 
            Disk[{-3, 0}, 0.1]}]}, ImageSize -> 4 72, AspectRatio -> 
         Automatic, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.05}], Ticks -> {
           Range[-3, 3], 
           Range[0, 4, 1]}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         PlotRange -> {{-3.5, 3.5}, {-1, 4.5}}], 
       "Specifications" :> {
        "Domain", {{$CellContext`domain$$, 1, ""}, {
          1 -> Pane[
            "\!\(TraditionalForm\`\((\(-3\), 3)\)\)", {48, Automatic}, 
             Alignment -> Center], 2 -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{380., {132., 138.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC2F52[
            Pattern[$CellContext`x, 
             Blank[]]] := Sqrt[9 - $CellContext`x^2], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F52[
            Pattern[$CellContext`x, 
             Blank[]]] := (9 - $CellContext`x^2)^Rational[1, 2]}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.6, Figure 2.52"], "Header"]}, {
   Cell[
    TextData["Section 2.6, Figure 2.52"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5024, 107, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature tKzqgGTCMtgJCIOyDfrOwvko *)
