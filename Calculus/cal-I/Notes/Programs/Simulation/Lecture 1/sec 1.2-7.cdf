...
NotebookDataLength[     37720,        869]
NotebookOptionsPosition[      5068,        111]
NotebookOutlinePosition[     38498,        881]
CellTagsIndexPosition[     38455,        878]
WindowTitle->Section 2.2, Figure 2.14
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`parameter$$ = 1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`parameter$$], 1, "zoom"}, 1, 10, 1}}, 
     Typeset`size$$ = {504., {113.84375, 119.15625}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`parameter$85512$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`parameter$$ = 1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`parameter$$, $CellContext`parameter$85512$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Framed[
            Pane[
            "The values of \!\(TraditionalForm\`cos\\ \((\*FractionBox[\(1\), \
\(x\)])\)\) oscillate between \!\(TraditionalForm\`\(-1\)\) and 1, over \
shorter and shorter intervals, as \!\(TraditionalForm\`x\) approaches 0 from \
the right.", {320, Automatic}, 
             BaseStyle -> {
              LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
               LineBreakWithin -> Automatic, Hyphenation -> True, 
               TextAlignment -> Left, FontSize -> 12, FontFamily -> 
               "Times"}], {
           ...
           Show[{
             Plot[
              ...
              1/$CellContext`x], {$CellContext`x, 0, 
               1/($CellContext`parameter$$ Pi)}, PlotPoints -> 
              100 $CellContext`parameter$$, PlotStyle -> Black], 
             ListPlot[
              Table[{$CellContext`xValues, 
                Cos[1/$CellContext`xValues]}, {$CellContext`xValues, 
                Table[
                1/($CellContext`i 
                 Pi), {$CellContext`i, 200 $CellContext`parameter$$, 
                  1, -1}]}], PlotStyle -> {Red, 
                AbsolutePointSize[5]}]}, Ticks -> {
              Table[{1/($CellContext`i Pi), 
                If[
                Abs[$CellContext`i - $CellContext`parameter$$] <= 4, 
                 1/($CellContext`i Pi), 
                 ""]}, {$CellContext`i, $CellContext`parameter$$ + 
                100, $CellContext`parameter$$, -1}], {-1, 0, 1}}, 
            PlotRange -> {{0, 1/($CellContext`parameter$$ Pi)}, {-1.3, 1.3}}, 
            AxesOrigin -> {0, 0}, BaseStyle -> {"Text", 13}, 
            AxesLabel -> {
             "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
            ImageSize -> 7 72, AspectRatio -> 1/3]}}], 
       "Specifications" :> {{{$CellContext`parameter$$, 1, "zoom"}, 1, 10, 1, 
          ControlType -> Slider, ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{669., {132., 137.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.2, Figure 2.14"], "Header"]}, {
   Cell[
    TextData["Section 2.2, Figure 2.14"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 3791, 78, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature YKNZUYgc7YgXuK#5swcTQBDH *)
