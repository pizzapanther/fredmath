...
NotebookDataLength[     37611,        870]
NotebookOptionsPosition[      4959,        112]
NotebookOutlinePosition[     38389,        882]
CellTagsIndexPosition[     38346,        879]
WindowTitle->Section 2.2, Figure 2.07
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.25, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0, 6, 0.01}}, 
     Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$85187$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 0.25}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$85187$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F7[$CellContext`x], {$CellContext`x, 0, 6}, 
           GridLines -> {
             Range[0, 6], 
          ...
          Graphics[{White, 
            EdgeForm[Black], 
            Disk[{2, 
              $CellContext`funcC2F7[2]}, 0.12], 
            Disk[{3, 
              $CellContext`funcC2F7[3]}, 0.12], Black, 
            Disk[{2, 5}, 0.1], 
            Text[
            "\!\(TraditionalForm\`y = f(x)\)", {5, 3.5}], $CellContext`bcR, 
            EdgeForm[$CellContext`bcR], 
            If[1.999 < $CellContext`xValue$$ < 2.001, 
             Disk[{2, 5}, 0.1], 
             Disk[{$CellContext`xValue$$, 
               $CellContext`funcC2F7[$CellContext`xValue$$]}, 0.1]], {White, 
             EdgeForm[Black], 
             Disk[{3, 4}, 0.12]}}]}, PlotRange -> {{-0.5, 6.5}, {-0.5, 7}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.2, Figure 2.07"], "Header"]}, {
   Cell[
    TextData["Section 2.2, Figure 2.07"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 3682, 79, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature tLNNwNjbDx1juI#C4egZYI3G *)
