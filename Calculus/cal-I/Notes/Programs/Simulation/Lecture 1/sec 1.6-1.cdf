...
NotebookDataLength[     45572,       1039]
NotebookOptionsPosition[     12918,        281]
NotebookOutlinePosition[     46348,       1051]
CellTagsIndexPosition[     46305,       1048]
WindowTitle->Section 2.7, Figure 2.60
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`delta$$ = 2, $CellContext`epsilon$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showRangeInterval$87195$$ = 
     False, $CellContext`epsilon$87196$$ = 
     0, $CellContext`showDomainInterval$87197$$ = 
     False, $CellContext`delta$87198$$ = 0}, 
...
$CellContext`showRangeInterval$87195$$, False], 
         Hold[$CellContext`epsilon$$, $CellContext`epsilon$87196$$, 0], 
         Hold[$CellContext`showDomainInterval$$, \
$CellContext`showDomainInterval$87197$$, False], 
         Hold[$CellContext`delta$$, $CellContext`delta$87198$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[
           $CellContext`funcC2F60[$CellContext`x], {$CellContext`x, 0, 7}, 
...
the value of \[Epsilon] or decrease the value of \[Delta].", {
       ...
       "Specifications" :> {{{$CellContext`showRangeInterval$$, True, 
          ...
          Dynamic[$CellContext`showRangeInterval$$], Appearance -> "Vertical",
           ControlPlacement -> 2}, {{$CellContext`epsilon$$, 1, ""}, 0.1, 2, 
          0.1, ControlType -> Slider, Enabled :> 
          Dynamic[$CellContext`showRangeInterval$$], Appearance -> "Vertical",
         ...
         Grid[{{
          ...
          ControlPlacement -> 4}, {{$CellContext`delta$$, 2, 
           Style["\[Delta]", 14]}, {
          Rational[1, 4] -> 
           Pane["\!\(TraditionalForm\`1/4\)", {24, Automatic}, Alignment -> 
             Center], 1 -> Pane[1, {24, Automatic}, Alignment -> Center], 2 -> 
          ...
          ControlPlacement -> 5}, {{$CellContext`delta$$, 2, 
     ...
     Initialization:>({{$CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`funcC2F60[
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}, 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F60[
            Pattern[$CellContext`x, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.7, Figure 2.60"], "Header"]}, {
   Cell[
    TextData["Section 2.7, Figure 2.60"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 11641, 248, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature dK4KQHGTwLpXoJ5Myb7oH9zC *)
