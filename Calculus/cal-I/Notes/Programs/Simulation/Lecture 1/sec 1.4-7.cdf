...
NotebookDataLength[     39203,        905]
NotebookOptionsPosition[      6550,        147]
NotebookOutlinePosition[     39980,        917]
CellTagsIndexPosition[     39937,        914]
WindowTitle->Section 2.5, Figure 2.33
WindowFrame->Normal*)
...
\[Infinity]"], Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0.01, 49.99, 
       0.01}}, Typeset`size$$ = {360., {114., 119.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$86276$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$86276$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC2F33[$CellContext`x], {$CellContext`x, 0, 50}, 
           PlotStyle -> {Thick, Black}], 
          Graphics[{
            AbsoluteThickness[1.5], Dashed, {$CellContext`bcR, 
             Line[{{0, 5}, {50, 5}}]}, $CellContext`bcR, 
            Line[{{0, 
...
$CellContext`bcPBS], $CellContext`bcFO], {$CellContext`xValue$$, 0}, {
             0, Sign[
                $CellContext`funcC2F33[$CellContext`xValue$$]] 1.5}], Black, 
            Text[
             Framed[
              Pane[
...
\[Infinity]\)]f(x) = 5\)", $CellContext`bcPBS], $CellContext`bcFO], {40, 4}, {
            ...
            Arrow[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$ + 5, 
               0}}], 
            Opacity[1], $CellContext`bcB, 
            AbsolutePointSize[7], 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC2F33[$CellContext`xValue$$]}], Black, 
            AbsolutePointSize[8], 
            Point[{0, 5}], White, 
            AbsolutePointSize[6], 
            Point[{0, 5}]}]}, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         Ticks -> {None, 
           Table[{$CellContext`i, ""}, {$CellContext`i, 0, 10}]}, ImageSize -> 
         5 72, AxesOrigin -> {0, 0}, PlotRange -> {{-10, 50}, {-1.5, 7.5}}], 
       "Specifications" :> {
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) goes to \
\[Infinity]", 
     ...
     Initialization:>({{$CellContext`funcC2F33[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          5 + Sin[$CellContext`x]/Sqrt[$CellContext`x], $CellContext`bcR = 
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC2F33[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          5 + Sin[$CellContext`x]/$CellContext`x^Rational[1, 2]}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 2.5, Figure 2.33"], "Header"]}, {
   Cell[
    TextData["Section 2.5, Figure 2.33"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5273, 114, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature bJNK1zWYlYT9PLOi1pyQwkv# *)
