...
NotebookDataLength[     40104,        912]
NotebookOptionsPosition[      7801,        162]
NotebookOutlinePosition[     40881,        924]
CellTagsIndexPosition[     40838,        921]
WindowTitle->Section 3.4, Exercise 85c
WindowFrame->Normal*)
...
StyleBox[\"b\",\nFontSlant->\"Italic\"]\) to change their locations."], 
     ...
     288., {94., 100.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`aValue$72362$$ = {0, 
     0}, $CellContext`bValue$72363$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = {
          0.5, 0}, $CellContext`bValue$$ = {3, 0}}, 
       "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$72362$$, {0, 0}], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$72363$$, {0, 0}]}, 
       "OtherVariables" :> {
       ...
       Module[{$CellContext`cValue$}, $CellContext`cValue$ = (2 
            Part[$CellContext`aValue$$, 1]) (Part[$CellContext`bValue$$, 1]/(
            Part[$CellContext`aValue$$, 1] + Part[$CellContext`bValue$$, 1])); 
         Show[{
            Plot[
             $CellContext`funcC3FP85c[$CellContext`x], {$CellContext`x, 0, 4},
              PlotStyle -> {{Thick, Black}}, PlotRange -> {{0, 4}, {0, 4}}], 
            Plot[{Derivative[1][$CellContext`funcC3FP85c][
                 Part[$CellContext`aValue$$, 1]] ($CellContext`x - 
                Part[$CellContext`aValue$$, 1]) + $CellContext`funcC3FP85c[
                Part[$CellContext`aValue$$, 1]], 
              Derivative[1][$CellContext`funcC3FP85c][
                 Part[$CellContext`bValue$$, 1]] ($CellContext`x - 
                Part[$CellContext`bValue$$, 1]) + $CellContext`funcC3FP85c[
                Part[$CellContext`bValue$$, 1]]}, {$CellContext`x, 0, 4}, 
             PlotStyle -> {{Thick, $CellContext`bcR}}], 
            Graphics[{
              Text[
              "\!\(TraditionalForm\`f(x) = \*FractionBox[\(1\), \(x\)]\)", {3,
                4}, {-1, 1}], 
              Text[
              "\!\(TraditionalForm\`c = \*FractionBox[\(2  a\\ b\), \(a + \
b\)]\)", {3, 4}, {-1, 4}], $CellContext`bcB, 
              AbsolutePointSize[7], 
              Point[{
                Part[$CellContext`aValue$$, 1], 
                $CellContext`funcC3FP85c[
                 Part[$CellContext`aValue$$, 1]]}], 
              Point[{
                Part[$CellContext`bValue$$, 1], 
                $CellContext`funcC3FP85c[
                 Part[$CellContext`bValue$$, 1]]}], $CellContext`bcR, Dashed, 
              ...
              Line[{{$CellContext`cValue$, 0}, {$CellContext`cValue$, 
                 Derivative[1][$CellContext`funcC3FP85c][
                   ...
                   Part[$CellContext`aValue$$, 1]]}}], Black, 
              Point[{$CellContext`cValue$, 
                Derivative[1][$CellContext`funcC3FP85c][
                   Part[$CellContext`aValue$$, 1]] ($CellContext`cValue$ - 
                  Part[$CellContext`aValue$$, 1]) + $CellContext`funcC3FP85c[
                  Part[$CellContext`aValue$$, 1]]}]}]}, 
           ...
           Axes -> {True, False}, BaseStyle -> {"Text", 13}, AxesStyle -> 
           Arrowheads[{0, 0.04}], ImageSize -> 4 72]], 
       "Specifications" :> {{{$CellContext`aValue$$, {0.5, 0}}, {0.1, 0}, {4, 
...
StyleBox[\"b\",\nFontSlant->\"Italic\"]\) to change their locations."}, 
      ...
      ImageSizeCache->{314., {126., 132.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3FP85c[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3FP85c[
            Pattern[$CellContext`x, 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.4\"", "\", Exercise \"", "\"85c\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.4, Exercise 85c"], "Header"]}, {
   Cell[
    TextData["Section 3.4, Exercise 85c"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 6523, 129, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 2K4#GoK7Msui9JOdDzVlg084 *)
