...
NotebookDataLength[     39171,        898]
NotebookOptionsPosition[      6518,        140]
NotebookOutlinePosition[     39948,        910]
CellTagsIndexPosition[     39905,        907]
WindowTitle->Section 3.1, Figure 3.08
WindowFrame->Normal*)
       ...
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F08[$CellContext`x], 
            Derivative[
              1][$CellContext`funcC3F08][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F08[$CellContext`xValue$$]}, {$CellContext`x, 0, 10}, 
...
FontSlant->\"Italic\"], \"tan\"]\)", 
            ...
            Line[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 
               $CellContext`funcC3F08[$CellContext`xValue$$]}}], 
            Dashing[{}], LightGray, 
...
$CellContext`bcB, 
            ...
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F08[$CellContext`xValue$$]}]}]}, 
         Ticks -> {{{$CellContext`xValue$$, "\!\(TraditionalForm\`a\)"}}, 
           None}, PlotRange -> {{-1, 11}, {-5, 6}}, AxesOrigin -> {0, 0}, 
         AxesLabel -> {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{501., {131., 137.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F08[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F08[
            Pattern[$CellContext`x, 
             Blank[]]] := (((-5)/17) ($CellContext`x - 2)) ($CellContext`x - 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.1, Figure 3.08"], "Header"]}, {
   Cell[
    TextData["Section 3.1, Figure 3.08"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5241, 107, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5Jjvo0RHD3tiXIOOwJ030Xal *)
