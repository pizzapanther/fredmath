...
NotebookDataLength[     39651,        910]
NotebookOptionsPosition[      6998,        152]
NotebookOutlinePosition[     40428,        922]
CellTagsIndexPosition[     40385,        919]
WindowTitle->Section 3.3, Figure 3.27
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.5, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -0.2, 5.8, 
       0.01}, {{
        Hold[$CellContext`xValue$$], 0.5, ""}, -0.2, 5.8, 0.01}, {
       Hold[
        Button[
        "\!\(TraditionalForm\`x = 0.697\)", $CellContext`xValue$$ = 0.697, 
         BaseStyle -> 11]], Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
        Button[
        "\!\(TraditionalForm\`x = 4.303\)", $CellContext`xValue$$ = 4.303, 
         BaseStyle -> 11]], Manipulate`Dump`ThisIsNotAControl}}, 
     Typeset`size$$ = {288., {144., 149.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$72042$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 0.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$72042$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F27[$CellContext`x], 
            Derivative[
              1][$CellContext`funcC3F27][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F27[$CellContext`xValue$$]}, {$CellContext`x, -0.5, 6}, 
           PlotStyle -> {{Thick, Black}, {Thick, $CellContext`bcR}}], 
          Graphics[{
            Text[
            "\!\(TraditionalForm\`y = 2 \*SuperscriptBox[\(x\), \(3\)] - 15 \
\*SuperscriptBox[\(x\), \(2\)] + 24  x\)", {5, 15}, {1, 1}], 
            Text[
             Framed[
              Pane[
...
\",\nFontSlant->\"Italic\"]\)", 
              ...
              Background -> White], {0.2, -7}, {-1, 1}], $CellContext`bcB, 
            AbsolutePointSize[7], 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F27[$CellContext`xValue$$]}], \
$CellContext`bcR, 
            AbsoluteThickness[1.5], Dashed, 
            Line[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 
               $CellContext`funcC3F27[$CellContext`xValue$$]}}]}]}, 
         PlotRange -> {-17, 17}, AspectRatio -> 1, Ticks -> {
           Range[0, 6], 
           Range[-15, 15, 5]}, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], AxesStyle -> Arrowheads[{0, 0.04}], ImageSize -> 
         4 72, AxesLabel -> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F27[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F27[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          2 $CellContext`x^3 - 15 $CellContext`x^2 + 24 $CellContext`x}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.3, Figure 3.27"], "Header"]}, {
   Cell[
    TextData["Section 3.3, Figure 3.27"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5721, 119, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature WJjT2bHtaIRXtJ5MEHk1DgI8 *)
