...
NotebookDataLength[     38569,        890]
NotebookOptionsPosition[      5917,        132]
NotebookOutlinePosition[     39347,        902]
CellTagsIndexPosition[     39304,        899]
WindowTitle->Section 3.9, Figure 3.61
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.9, Typeset`show$$ = True, 
     ...
     False, $CellContext`xValue$74382$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 0.9}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$74382$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F61[$CellContext`x]}, {$CellContext`x, -2, 2}, 
           PlotStyle -> {{Thick, Black}}, 
           PlotRange -> {{-0.5, 2}, {-0.5, 4.5}}], 
          Graphics[{
            EdgeForm[Black], White, 
            Disk[{0, 1}, 0.015 {3, 5}], Black, 
            Text[
...
$CellContext`bcFO], {0.75, 0.65}, {-1, 1}], Black]}], 
          
          Plot[{Derivative[
              1][$CellContext`funcC3F61][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F61[$CellContext`xValue$$]}, {$CellContext`x, -2, 2}, 
           PlotStyle -> {{Thick, $CellContext`bcR}}, 
           PlotRange -> {{-0.5, 2}, {-0.5, 4.5}}], 
          Graphics[{Gray, 
            Line[{{$CellContext`xValue$$, 0}, {$CellContext`xValue$$, 4.5}}], 
            
            AbsolutePointSize[7], Black, 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F61[$CellContext`xValue$$]}]}]}, 
         PlotRange -> {{-0.5, 2}, {-0.5, 4.5}}, AxesOrigin -> {0, 0}, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         AspectRatio -> 1, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], ImageSize -> 4 72, Ticks -> {
           Table[{$CellContext`i, 
             If[Mod[$CellContext`i, 0.5] == 0, $CellContext`i, ""], 
             0.01}, {$CellContext`i, 0, 2, 0.1}], 
           Range[0, 4]}], 
       "Specifications" :> {{{$CellContext`xValue$$, 0.9, "x"}, 0.02, 2., 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{430., {161., 167.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F61[
          ...
          RGBColor[0.8, 0, 0.4]}; {$CellContext`funcC3F61[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x^$CellContext`x}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.9, Figure 3.61"], "Header"]}, {
   Cell[
    TextData["Section 3.9, Figure 3.61"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4640, 99, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5INK9aSsu5Z4jKOA8QCgec98 *)
