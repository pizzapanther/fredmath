...
NotebookDataLength[     40939,        939]
NotebookOptionsPosition[      8286,        181]
NotebookOutlinePosition[     41716,        951]
CellTagsIndexPosition[     41673,        948]
WindowTitle->Section 3.8, Figure 3.54
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = -0.8, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xValue$$], -0.8, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -1, 1, 0.01}, {{
       
        Hold[$CellContext`xValue$$], -0.8, ""}, -1., 1., 0.01}, {
       Hold[
        Button[
        "\!\(TraditionalForm\`x = 1/2\)", $CellContext`xValue$$ = 1/2, 
         BaseStyle -> 11]], Manipulate`Dump`ThisIsNotAControl}}, 
     Typeset`size$$ = {288., {166., 172.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$73688$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = -0.8}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$73688$$, 0]}, 
       "OtherVariables" :> {
...
\*SuperscriptBox[\(y\), \(2\)] = 1\\ has\\ two\\ tangent\\ lines\\ for\\ \
all\\  - 1 < x < 1. \)", {
               120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], {1.5, 2}, {1, 1}], 
            Text[
             Pane[
              Row[{"\!\(TraditionalForm\`y\)", " = ", 
                If[$CellContext`xValue$$ == 1/2, 3^Rational[1, 2]/2, 
                 
                 Round[(1 - $CellContext`xValue$$^2)^Rational[1, 2], 
                  0.01]]}], {
              Automatic, Automatic}, $CellContext`bcPBS], {-1.4, (
               1 - $CellContext`xValue$$^2)^Rational[1, 2]}, {-1, 0}], 
            Text[
             Pane[
              Row[{"\!\(TraditionalForm\`y\)", " = ", 
                If[$CellContext`xValue$$ == 1/2, -(3^Rational[1, 2]/2), 
                 ...
                 Round[-(1 - $CellContext`xValue$$^2)^Rational[1, 2], 
                  0.01]]}], {
              Automatic, 
               Automatic}, $CellContext`bcPBS], {-1.4, -(
                1 - $CellContext`xValue$$^2)^Rational[1, 2]}, {-1, 0}], 
            Text[
             Pane[
              Row[{"\!\(TraditionalForm\`x\)", " = ", 
                If[$CellContext`xValue$$ == 1/2, 1/2, 
                 Round[$CellContext`xValue$$, 0.01]]}], {
              Automatic, 
               Automatic}, $CellContext`bcPBS], {$CellContext`xValue$$, \
-1.4}, {0, -1}], 
            If[$CellContext`xValue$$ == 1/2, {
              Text[
              "\!\(TraditionalForm\`Slope = \(-\*FractionBox[\(1\), \
SqrtBox[\(3\)]]\)\)", {1/2, 3^Rational[1, 2]/2}, {-1.5, -0.5}], 
              Text[
              "\!\(TraditionalForm\`Slope = \*FractionBox[\(1\), \
SqrtBox[\(3\)]]\)", {1/2, (-3^Rational[1, 2])/2}, {-1.5, 0.5}]}, 
             Black], $CellContext`bcR, 
            
            Line[{{$CellContext`xValue$$, (1 - $CellContext`xValue$$^2)^
                Rational[1, 2]} - {(1 - $CellContext`xValue$$^2)^
               Rational[
                1, 2], -$CellContext`xValue$$}, {$CellContext`xValue$$, (
                 1 - $CellContext`xValue$$^2)^
                Rational[1, 2]} + {(1 - $CellContext`xValue$$^2)^
            ...
            Line[{{$CellContext`xValue$$, -(1 - $CellContext`xValue$$^2)^
               ...
               Rational[
                1, 2], $CellContext`xValue$$}, {$CellContext`xValue$$, -(
                  1 - $CellContext`xValue$$^2)^Rational[1, 2]} + {(
                 1 - $CellContext`xValue$$^2)^
                Rational[1, 2], $CellContext`xValue$$}}], Dashed, 
            Line[{{
              0, (1 - $CellContext`xValue$$^2)^
               Rational[1, 2]}, {$CellContext`xValue$$, (
                1 - $CellContext`xValue$$^2)^
               Rational[
                1, 2]}, {$CellContext`xValue$$, -(
                 1 - $CellContext`xValue$$^2)^Rational[1, 2]}, {
              0, -(1 - $CellContext`xValue$$^2)^Rational[1, 2]}}], Black, 
            
            Point[{$CellContext`xValue$$, (1 - $CellContext`xValue$$^2)^
              Rational[1, 2]}], 
            
            Point[{$CellContext`xValue$$, -(1 - $CellContext`xValue$$^2)^
               Rational[1, 2]}]}]}, PlotRange -> {{-1.5, 1.5}, {-1.5, 2}}, 
         Ticks -> {
           Range[-1, 1, 1/2], 
           Range[-1, 1, 1/2]}, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], ImageSize -> 4 72, 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}], 
       "Specifications" :> {{{$CellContext`xValue$$, -0.8, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -1, 1, 0.01, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`xValue$$, -0.8, ""}, -1., 1., 0.01, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.8, Figure 3.54"], "Header"]}, {
   Cell[
    TextData["Section 3.8, Figure 3.54"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7009, 148, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature bLNRmCx#ZLb0wK#HdKDBlwCi *)
