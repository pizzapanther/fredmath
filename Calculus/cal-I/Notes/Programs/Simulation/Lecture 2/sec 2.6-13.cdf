...
NotebookDataLength[     39854,        919]
NotebookOptionsPosition[      7555,        169]
NotebookOutlinePosition[     40631,        931]
CellTagsIndexPosition[     40588,        928]
WindowTitle->Section 3.6, Exercise 51
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`tValue$$ = 0, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`tValue$$], 0, "time"}, 0, 4}, {{
        Hold[$CellContext`tValue$$], 0, ""}, 0, 4}, {
       Hold[
        Button[
        "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\) = 2", \
$CellContext`tValue$$ = 2, BaseStyle -> 11]], 
       Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     512., {151.84375, 157.15625}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`tValue$73630$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`tValue$$ = 0}, 
       "ControllerVariables" :> {
         Hold[$CellContext`tValue$$, $CellContext`tValue$73630$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Grid[{{
           Graphics[{Black, 
             Text["Circular track", {0, 1.7}, {0, 1}], 
             Circle[{0, 0}, 1], 
             AbsolutePointSize[7], $CellContext`bcB, 
             Point[{
               Cos[
                $CellContext`funcC3FP51a[$CellContext`tValue$$]], 
               Sin[
                $CellContext`funcC3FP51a[$CellContext`tValue$$]]}], 
             Text["Jean", {
               Cos[
                $CellContext`funcC3FP51a[$CellContext`tValue$$]], 
               Sin[
                $CellContext`funcC3FP51a[$CellContext`tValue$$]]}, {-2, -2}], 
             
             Arrow[{{0, 0}, {
                Cos[
                 $CellContext`funcC3FP51a[$CellContext`tValue$$]], 
                Sin[
                 $CellContext`funcC3FP51a[$CellContext`tValue$$]]}}], Black, 
             Point[{
               Cos[
                $CellContext`funcC3FP51b[$CellContext`tValue$$]], 
               Sin[
                $CellContext`funcC3FP51b[$CellContext`tValue$$]]}], 
             Text["Juan", {
               Cos[
                $CellContext`funcC3FP51b[$CellContext`tValue$$]], 
               Sin[
                $CellContext`funcC3FP51b[$CellContext`tValue$$]]}, {-2, 0}], 
             Arrow[{{0, 0}, {
                Cos[
                 $CellContext`funcC3FP51b[$CellContext`tValue$$]], 
                Sin[
                 $CellContext`funcC3FP51b[$CellContext`tValue$$]]}}]}, 
            PlotRange -> {{-2, 2}, {-2, 2}}, BaseStyle -> {"Text", 13}, 
            ImageSize -> 3 72], 
           Show[{
             Plot[{
               $CellContext`funcC3FP51a[$CellContext`t], 
               $CellContext`funcC3FP51b[$CellContext`t]}, {$CellContext`t, 0, 
               4}, PlotStyle -> {{Thick, $CellContext`bcB}, {Thick, Black}}], 
             
             Graphics[{
               Text[
               "Jean, \!\(TraditionalForm\`\[Theta](t)\)", {3, Pi}, {-1, 1}], 
               
               Text[
               "Juan, \!\(TraditionalForm\`\[Phi](t)\)", {1, 2 Pi}, {-1, 1}], 
               
               AbsolutePointSize[7], $CellContext`bcB, 
               Point[{$CellContext`tValue$$, 
                 $CellContext`funcC3FP51a[$CellContext`tValue$$]}], 
               Line[{{0, 
                  $CellContext`funcC3FP51a[$CellContext`tValue$$]}, {4, 
                  $CellContext`funcC3FP51a[$CellContext`tValue$$]}}], Black, 
               Point[{$CellContext`tValue$$, 
                 $CellContext`funcC3FP51b[$CellContext`tValue$$]}], 
               Line[{{0, 
                  $CellContext`funcC3FP51b[$CellContext`tValue$$]}, {4, 
                  $CellContext`funcC3FP51b[$CellContext`tValue$$]}}]}]}, 
            PlotRange -> {{0, 4.5}, {0, 2 Pi + Pi/4}}, AspectRatio -> 1, 
            BaseStyle -> {"Text", 13}, Ticks -> {
              Range[0, 4], 
              Range[0, 2 Pi, Pi/2]}, ImageSize -> 4 72, 
            AxesLabel -> {"\!\(TraditionalForm\`t\)", 
              Pane["Angular\nposition", {Automatic, Automatic}]}]}}], 
       "Specifications" :> {{{$CellContext`tValue$$, 0, "time"}, 0, 4, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`tValue$$, 0, ""}, 0, 4, ControlType -> 
...
$CellContext`tValue$$ = 2, BaseStyle -> 11]}, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{671., {170., 175.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`bcB = 
          RGBColor[0, 0.4, 0.8], $CellContext`funcC3FP51a[
            Pattern[$CellContext`t, 
             Blank[]]] := Pi ($CellContext`t^2/8), $CellContext`t[
            Pattern[$CellContext`df, 
             Blank[]]] := PDF[
            
            StudentTDistribution[$CellContext`df], $CellContext`x], \
$CellContext`funcC3FP51b[
            Pattern[$CellContext`t, 
             Blank[]]] := (Pi $CellContext`t) ((8 - $CellContext`t)/8), 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3FP51a[
           
            Pattern[$CellContext`t, 
             Blank[]]] := Pi ($CellContext`t^2/8), $CellContext`funcC3FP51b[
            Pattern[$CellContext`t, 
             Blank[]]] := (Pi $CellContext`t) ((8 - $CellContext`t)/8)}}; 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.6\"", "\", Exercise \"", "\"51\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Exercise 51"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Exercise 51"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6278, 136, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature GKj3SNh#MX1oNK#hPB6qz11u *)
