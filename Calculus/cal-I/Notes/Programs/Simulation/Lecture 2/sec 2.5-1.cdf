...
NotebookDataLength[     41553,        946]
NotebookOptionsPosition[      8900,        188]
NotebookOutlinePosition[     42330,        958]
CellTagsIndexPosition[     42287,        955]
WindowTitle->Section 3.5, Figure 3.30
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`deltaX$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       0.01}, {
       Hold[
       "\!\(\*Cell[TextData[StyleBox[\"x\",\nFontSlant->\"Italic\"]]]\) goes \
to 0 from the"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`direction$$], -1, ""}, {-1 -> 
        Pane["left", {48, Automatic}, Alignment -> Center], 1 -> 
        Pane["right", {48, Automatic}, Alignment -> Center]}}}, 
     Typeset`size$$ = {432., {101., 107.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`deltaX$72423$$ = 0, $CellContext`direction$72424$$ = 
     False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`deltaX$$ = 
         0.1, $CellContext`direction$$ = -1}, "ControllerVariables" :> {
         Hold[$CellContext`deltaX$$, $CellContext`deltaX$72423$$, 0], 
         Hold[$CellContext`direction$$, $CellContext`direction$72424$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F30[$CellContext`x], {$CellContext`x, -5, 5}, 
           PlotStyle -> {Thick, Black}, PlotRange -> {-0.5, 2}], 
...
\)", BaseStyle -> {
            ...
            If[$CellContext`direction$$ == 1, {
              Text["\!\(TraditionalForm\`y = f(x)\)", {0, 
                $CellContext`funcC3F30[0 + $CellContext`deltaX$$]}, {
               1.25, 0}], $CellContext`bcR, Dashed, 
              AbsoluteThickness[1.5], 
              
              Line[{{0 + $CellContext`deltaX$$, 0}, {
                0 + $CellContext`deltaX$$, 
                 $CellContext`funcC3F30[0 + $CellContext`deltaX$$]}, {0, 
                 $CellContext`funcC3F30[0 + $CellContext`deltaX$$]}}], 
              Opacity[0.5], 
              AbsoluteThickness[4], 
              Dashing[{}], 
              ...
              Text["\!\(TraditionalForm\`y = f(x)\)", {0, 
                $CellContext`funcC3F30[-2 + $CellContext`deltaX$$]}, {-1.25, 
                0}], $CellContext`bcR, Dashed, 
              AbsoluteThickness[1.5], 
              
              Line[{{-2 + $CellContext`deltaX$$, 
                 0}, {-2 + $CellContext`deltaX$$, 
                 $CellContext`funcC3F30[-2 + $CellContext`deltaX$$]}, {0, 
                 $CellContext`funcC3F30[-2 + $CellContext`deltaX$$]}}], 
              Opacity[0.5], 
              AbsoluteThickness[4], 
              Dashing[{}], 
            ...
            Opacity[1], 
            Text[
            "\!\(TraditionalForm\`f(x) = \*FractionBox[\(sin\\ x\), \
\(x\)]\)", {3, 2}, {1, 1}], 
            Text[
             Framed[
              Pane[
              "The graph of \!\(TraditionalForm\`y = \*FractionBox[\(sin\\ \
x\), \(x\)]\) suggests that \!\(TraditionalForm\`\*SubscriptBox[\(lim\), \(x \
\[Rule] 0\)]\*FractionBox[\(sin\\ x\), \(x\)] = 1\).", {2.5 72, Automatic}, 
               BaseStyle -> {
                LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                 LineBreakWithin -> Automatic, Hyphenation -> True, 
                 TextAlignment -> Left, FontSize -> 13}], {
              RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}], {-4, 
             3}, {-1, 1}], $CellContext`bcB, 
            AbsolutePointSize[6], 
            If[$CellContext`direction$$ == 1, 
            ...
            Disk[{0, 1}, 0.08]}]}, ImageSize -> 6 72, 
         PlotRange -> {{-4, 4}, {-0.75, 3}}, AspectRatio -> Automatic, 
       ...
       "Specifications" :> {{{$CellContext`deltaX$$, 0.1, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0.01, 1.99, 
          0.01, ControlType -> Slider, ImageSize -> Small}, Delimiter, 
         "\!\(\*Cell[TextData[StyleBox[\"x\",\nFontSlant->\"Italic\"]]]\) \
goes to 0 from the", {{$CellContext`direction$$, -1, ""}, {-1 -> 
           Pane["left", {48, Automatic}, Alignment -> Center], 1 -> 
           Pane["right", {48, Automatic}, Alignment -> Center]}, ControlType -> 
          SetterBar, Appearance -> "Vertical"}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{575., {119., 124.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F30[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F30[
            Pattern[$CellContext`x, 
             Blank[]]] := Sin[$CellContext`x]/$CellContext`x}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.5, Figure 3.30"], "Header"]}, {
   Cell[
    TextData["Section 3.5, Figure 3.30"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7623, 155, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature SIz1rkRzJPP6jLOWw337#wVS *)
