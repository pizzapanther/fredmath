...
NotebookDataLength[     37428,        863]
NotebookOptionsPosition[      5130,        113]
NotebookOutlinePosition[     38206,        875]
CellTagsIndexPosition[     38163,        872]
WindowTitle->Section 3.8, Exercise 65
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`pointP$$ = {2, 2}, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`pointP$$], {2, 2}, ""}, Automatic}, {
       Hold["Select and drag \!\(TraditionalForm\`P\) along the curve."], 
       Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     288., {119., 124.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`pointP$$ = {2, 2}}, 
       "ControllerVariables" :> {}, 
       "OtherVariables" :> {
       ...
       ParametricPlot[{
          $CellContext`funcC4FP65[$CellContext`t], 
          Derivative[1][$CellContext`funcC4FP65][
             
             Part[$CellContext`pointP$$, 
              2]] $CellContext`t + $CellContext`funcC4FP65[
            Part[$CellContext`pointP$$, 2]], Dot[
             Derivative[1][$CellContext`funcC4FP65][
              Part[$CellContext`pointP$$, 2]], {{0, 1}, {-1, 
             0}}] $CellContext`t + $CellContext`funcC4FP65[
            Part[$CellContext`pointP$$, 2]]}, {$CellContext`t, -5, 5}, 
         PlotStyle -> {{Thick, Black}, {Thick, $CellContext`bcR}, {
           Thick, $CellContext`bcR}}, PlotRange -> {{0, 5}, {0, 4}}, Epilog -> {
           AbsolutePointSize[6], 
           Locator[
            $CellContext`funcC4FP65[
             Part[$CellContext`pointP$$, 2]], Appearance -> None], Black, 
           Point[
            $CellContext`funcC4FP65[
             Part[$CellContext`pointP$$, 2]]], 
           Text["\!\(TraditionalForm\`P\)", 
            $CellContext`funcC4FP65[
             Part[$CellContext`pointP$$, 2]], {0, 2}]}, 
         BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.04}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, Ticks -> 
         None, ImageSize -> 4 72], 
       "Specifications" :> {{{$CellContext`pointP$$, {2, 2}, ""}, Automatic, 
          ControlType -> Locator, Appearance -> None}, 
         "Select and drag \!\(TraditionalForm\`P\) along the curve."}, 
       "Options" :> {
        LabelStyle -> 11, Paneled -> False, Deployed -> True, 
         AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
      ImageSizeCache->{314., {151., 156.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC4FP65[
            Pattern[$CellContext`t, 
             Blank[]]] := {($CellContext`t - 1)^2 + 
          ...
          Attributes[Derivative] = {
           NHoldAll, ReadProtected}, $CellContext`bcR = RGBColor[0.8, 0, 0.4],
           Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC4FP65[
           
            Pattern[$CellContext`t, 
             Blank[]]] := {($CellContext`t - 1)^2 + 1, $CellContext`t}}}; 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.8\"", "\", Exercise \"", "\"65\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.8, Exercise 65"], "Header"]}, {
   Cell[
    TextData["Section 3.8, Exercise 65"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 3853, 80, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature uLNTrga02M7WgJ5o9iu9HO6N *)
