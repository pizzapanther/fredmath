...
NotebookDataLength[     39173,        899]
NotebookOptionsPosition[      6516,        141]
NotebookOutlinePosition[     39950,        911]
CellTagsIndexPosition[     39907,        908]
WindowTitle->Section 3.10, Figure 3.62
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`angle$$ = Rational[-1, 2] Pi, 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`angle$$], Rational[-1, 2] Pi, "plot inverse sine"}, 
       Rational[-1, 2] Pi, Rational[1, 2] Pi}}, Typeset`size$$ = {
     288., {144., 149.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`angle$74451$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`angle$$ = Rational[-1, 2] Pi}, 
       "ControllerVariables" :> {
         Hold[$CellContext`angle$$, $CellContext`angle$74451$$, 0]}, 
       "OtherVariables" :> {
...
\*SuperscriptBox[\(sin\), \(-1\)] x\)\)", {-1.2, -1.5}, {-1, 2}], Gray, 
            ...
            Rectangle[{-1, 0}, {
              Sin[$CellContext`angle$$], 0.07}], 
            EdgeForm[$CellContext`bcB], 
            Opacity[0.5], 
            Lighter[$CellContext`bcB], 
            Rectangle[{-0.07, -1}, {0., 
              Sin[$CellContext`angle$$]}], 
            Rectangle[{0, (-Pi)/2}, {0.07, $CellContext`angle$$}], Black, 
            Opacity[1], 
            Text[
             Framed[
              Pane[
              "Domain of \!\(TraditionalForm\`\*SuperscriptBox[\(sin\), \
\(-1\)] x\): \!\(TraditionalForm\`\(-1\) \[LessEqual] x \[LessEqual] 1\)\n\
Range of \!\(TraditionalForm\`\*SuperscriptBox[\(sin\), \(-1\)] x\): \
\!\(TraditionalForm\`\(-\*FractionBox[\(\[Pi]\), \(2\)]\) \[LessEqual] y \
\[LessEqual] \*FractionBox[\(\[Pi]\), \(2\)]\)", {
               110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO], {
             0.2, -0.5}, {-1, 1}]}]}, AspectRatio -> Automatic, 
         PlotRange -> {{-2, 2}, {-2, 2}}, 
       ...
       "Specifications" :> {{{$CellContext`angle$$, Rational[-1, 2] Pi, 
           "plot inverse sine"}, Rational[-1, 2] Pi, Rational[1, 2] Pi, 
          ControlType -> Trigger, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.10, Figure 3.62"], "Header"]}, {
   Cell[
    TextData["Section 3.10, Figure 3.62"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 5238, 108, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature NJ4Ulj3wP4BZKL#FJHRS37X@ *)
