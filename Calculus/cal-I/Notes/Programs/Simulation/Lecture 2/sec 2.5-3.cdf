...
NotebookDataLength[     42224,        965]
NotebookOptionsPosition[      9554,        206]
NotebookOutlinePosition[     43001,        977]
CellTagsIndexPosition[     42958,        974]
WindowTitle->Section 3.5, Figure 3.32a
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`drawDerivative$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xValue$72520$$ = 
     0, $CellContext`showHorizontalTangents$72521$$ = 
     False, $CellContext`drawDerivative$72522$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`drawDerivative$$ = 
         False, $CellContext`showHorizontalTangents$$ = 
         False, $CellContext`xValue$$ = 0.01}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$72520$$, 0], 
         Hold[$CellContext`showHorizontalTangents$$, \
$CellContext`showHorizontalTangents$72521$$, False], 
         Hold[$CellContext`drawDerivative$$, \
$CellContext`drawDerivative$72522$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           Derivative[
           1][$CellContext`funcC3F32a][$CellContext`x], {$CellContext`x, 
            0, $CellContext`xValue$$}, PlotStyle -> {
             
             If[$CellContext`drawDerivative$$, {Thick, $CellContext`bcR}, 
              None]}], 
          Plot[
           $CellContext`funcC3F32a[$CellContext`x], {$CellContext`x, 0, 4 Pi},
            PlotStyle -> {{Thick, Black}}], 
          Graphics[{
            AbsolutePointSize[7], Black, 
            Text[
            "\!\(TraditionalForm\`f(x) = sin\\ x\)", {3.25 Pi, 1}, {-1, -5}], 
            
            If[$CellContext`drawDerivative$$, {$CellContext`bcR, 
              Text[
              "\!\(TraditionalForm\`f' \((x)\) = cos\\ x\)", {
               3.25 Pi, 1}, {-1, -2}]}, Black], 
            If[$CellContext`showHorizontalTangents$$, {Gray, Dashed, 
              ...
              Text[
              "\!\(TraditionalForm\`f' \((\[Pi]/2)\) = 0\)", {Pi/2, 1}, {
               0, -1.25}], 
              Text[
              ...
              Point[{{Pi/2, 0}, {3 (Pi/2), 0}, {5 (Pi/2), 0}, {7 (Pi/2), 0}}],
               Black, 
              
              Point[{{Pi/2, 1}, {3 (Pi/2), -1}, {5 (Pi/2), 1}, {
                7 (Pi/2), -1}}]}, Black], 
            If[$CellContext`drawDerivative$$, {Gray, 
              ...
              Point[{$CellContext`xValue$$, 
                Derivative[
                1][$CellContext`funcC3F32a][$CellContext`xValue$$]}]}, 
             Black], $CellContext`bcR, 
            AbsoluteThickness[2], 
            Dashing[{}], 
            Line[{{$CellContext`xValue$$, 
                $CellContext`funcC3F32a[$CellContext`xValue$$]} - 
              Normalize[{1, 
                Derivative[
                1][$CellContext`funcC3F32a][$CellContext`xValue$$]}], \
{$CellContext`xValue$$, 
            ...
            Black, 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F32a[$CellContext`xValue$$]}]}]}, ImageSize -> 
     ...
     Initialization:>({{
         Attributes[Derivative] = {
           NHoldAll, ReadProtected}, $CellContext`funcC3F32a[
            Pattern[$CellContext`x, 
             Blank[]]] := Sin[$CellContext`x], $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F32a[
            Pattern[$CellContext`x, 
         ...
         GridBox[{{"\"Section \"", "\"3.5\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"3\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"32a\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.5, Figure 3.32a"], "Header"]}, {
   Cell[
    TextData["Section 3.5, Figure 3.32a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 8276, 173, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature EIzO9aPUoXBsfK5zKQHqxpN6 *)
