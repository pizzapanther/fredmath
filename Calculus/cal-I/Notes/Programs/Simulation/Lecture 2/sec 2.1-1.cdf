...
NotebookDataLength[     38547,        884]
NotebookOptionsPosition[      5895,        126]
NotebookOutlinePosition[     39325,        896]
CellTagsIndexPosition[     39282,        893]
WindowTitle->Section 3.1, Figure 3.01
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = -3.5, Typeset`show$$ = True, 
     ...
     False, $CellContext`xValue$71077$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = -3.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$71077$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            ...
            Derivative[
              1][$CellContext`funcC3F1][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F1[$CellContext`xValue$$]}, {$CellContext`x, -5, 5}, 
             ...
             Framed[
              Pane[
               ...
               Derivative[1][$CellContext`funcC3F1][$CellContext`xValue$$] < 
                0, "Slope of tangent line and instantaneous rate of change \
are \!\(\*\nStyleBox[\"negative\",\nFontWeight->\"Bold\"]\).", 
...
\!\(\*\nStyleBox[\"positive\",\nFontWeight->\"Bold\"]\)."], {
         ...
         4.1 72, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}]], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.1, Figure 3.01"], "Header"]}, {
   Cell[
    TextData["Section 3.1, Figure 3.01"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4618, 93, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 3INXSimk6NsdyJkvWTpAt32g *)
