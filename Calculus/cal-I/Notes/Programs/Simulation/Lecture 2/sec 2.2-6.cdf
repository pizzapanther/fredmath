...
NotebookDataLength[     40666,        928]
NotebookOptionsPosition[      8013,        170]
NotebookOutlinePosition[     41443,        940]
CellTagsIndexPosition[     41400,        937]
WindowTitle->Section 3.2, Figure 3.19
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = 0.2, Typeset`show$$ = True, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xValue$82701$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 0.2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$82701$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[{Derivative[1][$CellContext`funcC3F19][1.999] ($CellContext`x - 
              1.999) + $CellContext`funcC3F19[1.999], 
            Derivative[1][$CellContext`funcC3F19][2.001] ($CellContext`x - 
              2.001) + $CellContext`funcC3F19[2.001]}, {$CellContext`x, -0.5, 
            5}, PlotStyle -> {{Thick, 
              Lighter[$CellContext`bcR, 0.75]}}], 
          Plot[
           $CellContext`funcC3F19[$CellContext`x], {$CellContext`x, 0, 4.5}, 
           PlotStyle -> {Thick, Black}], 
          Plot[
          Derivative[
             1][$CellContext`funcC3F19][$CellContext`xValue$$] \
($CellContext`x - $CellContext`xValue$$) + \
$CellContext`funcC3F19[$CellContext`xValue$$], {$CellContext`x, -0.5, 5}, 
...
\(1\)] \[NotEqual] slope\\ \*SubscriptBox[\(\[ScriptL]\), \(2\)]\\ implies\\ \
f' \((a)\)\\ does\\ not\\ \(\(exist\)\(.\)\)\)", {
               120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
            ...
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F19[$CellContext`xValue$$]}]}]}, ImageSize -> 
       ...
       "Specifications" :> {{{$CellContext`xValue$$, 0.2, 
          ...
          ControlType -> Trigger, DefaultDuration -> 20, 
          AppearanceElements -> {
     ...
     Initialization:>({{
         Attributes[Derivative] = {
           NHoldAll, ReadProtected}, $CellContext`funcC3F19[
          ...
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F19[
            Pattern[$CellContext`x, 
             Blank[]]] := 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.2, Figure 3.19"], "Header"]}, {
   Cell[
    TextData["Section 3.2, Figure 3.19"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6736, 137, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature pINh#7JoN4gFVLOmt40gukPN *)
