...
NotebookDataLength[     45167,       1019]
NotebookOptionsPosition[     12513,        261]
NotebookOutlinePosition[     45943,       1031]
CellTagsIndexPosition[     45900,       1028]
WindowTitle->Section 3.1, Figure 3.06
WindowFrame->Normal*)
...
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]],
     ...
     Typeset`skipInitDone$$ = False, $CellContext`hValue$71208$$ = 
     0, $CellContext`aValue$71209$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1.5, $CellContext`hValue$$ = 
         4}, "ControllerVariables" :> {
         Hold[$CellContext`hValue$$, $CellContext`hValue$71208$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$71209$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`resetAValue} = {1.5, False}]; Show[{
           Plot[{
             $CellContext`funcC3F06[$CellContext`x], \
(($CellContext`funcC3F06[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F06[$CellContext`aValue$$])/$CellContext`hValue$$) \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F06[$CellContext`aValue$$], 
             Derivative[
               1][$CellContext`funcC3F06][$CellContext`aValue$$] \
($CellContext`x - $CellContext`aValue$$) + \
$CellContext`funcC3F06[$CellContext`aValue$$]}, {$CellContext`x, 0, 10}, 
           ...
           Graphics[{Black, 
             ...
             Text["\!\(TraditionalForm\`y = f(x)\)", {10, 
               $CellContext`funcC3F06[10]}, {1, 3}], 
             Text[
             "\!\(TraditionalForm\`f(a + h) - f(a)\)", {$CellContext`aValue$$ + \
$CellContext`hValue$$, ($CellContext`funcC3F06[$CellContext`aValue$$] + \
$CellContext`funcC3F06[$CellContext`aValue$$ + $CellContext`hValue$$])/
               2}, {-1.1, 0}], 
             Text[
             "\!\(TraditionalForm\`h\)", {$CellContext`aValue$$ + \
$CellContext`hValue$$/2, 
               $CellContext`funcC3F06[$CellContext`aValue$$]}, {0, 1.5}], 
             Text["\!\(TraditionalForm\`P\)", {$CellContext`aValue$$, 
               $CellContext`funcC3F06[$CellContext`aValue$$]}, {1.5, -1.5}], 
             Text[
...
\*SubscriptBox[\(lim\), \(h \[Rule] 0\)]\*FractionBox[\(f \((a + h)\) - f \
\((a)\)\), \(h\)]\)", $CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], {(
                 10.5 - $CellContext`funcC3F06[$CellContext`aValue$$])/
                Derivative[
                1][$CellContext`funcC3F06][$CellContext`aValue$$] + \
...
\*FractionBox[\(f \((a + h)\) - f \((a)\)\), \(h\)]\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> 
               White], {(
                 7 - $CellContext`funcC3F06[$CellContext`aValue$$])/(($\
CellContext`funcC3F06[$CellContext`aValue$$ + $CellContext`hValue$$] - \
$CellContext`funcC3F06[$CellContext`aValue$$])/$CellContext`hValue$$) + \
...
$CellContext`hValue$$]}}], Dashed, 
             Line[{{$CellContext`aValue$$, 
                $CellContext`funcC3F06[$CellContext`aValue$$]}, {0, 
                $CellContext`funcC3F06[$CellContext`aValue$$]}}], 
...
$CellContext`hValue$$]}}], 
             ...
             Arrow[{{0, 
                $CellContext`funcC3F06[$CellContext`aValue$$ + \
$CellContext`hValue$$]}, {
               0, $CellContext`funcC3F06[$CellContext`aValue$$ + \
...
$CellContext`hValue$$, "\!\(TraditionalForm\`a + h\)"}}, {{
              $CellContext`funcC3F06[$CellContext`aValue$$], 
              "\!\(TraditionalForm\`f(a)\)"}, {
              $CellContext`funcC3F06[$CellContext`aValue$$ + \
$CellContext`hValue$$], "\!\(TraditionalForm\`f(a + h)\)"}}}]), 
       "Specifications" :> {
         Pane[
         "Change location of point \!\(\*\nStyleBox[\"Q\",\n\
FontSlant->\"Italic\"]\)", {144, Automatic}, 
...
FontSlant->\"Italic\"]\)", $CellContext`resetAValue = True, BaseStyle -> 11]},
     ...
     Initialization:>({{$CellContext`resetAValue = 
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F06[
            Pattern[$CellContext`x, 
             Blank[]]] := 1.5 Log[$CellContext`x - 1] + 4}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.1, Figure 3.06"], "Header"]}, {
   Cell[
    TextData["Section 3.1, Figure 3.06"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 11236, 228, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature FL4mgRsopfzG0LO9VXJwy#9K *)
