...
NotebookDataLength[     39096,        899]
NotebookOptionsPosition[      6443,        141]
NotebookOutlinePosition[     39873,        911]
CellTagsIndexPosition[     39830,        908]
WindowTitle->Section 3.2, Figure 3.16
WindowFrame->Normal*)
       ...
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           $CellContext`funcC3F16[$CellContext`x], {$CellContext`x, -3, 3}, 
            ...
            If[
             And[$CellContext`xValue$$ != -1, $CellContext`xValue$$ != 
              ...
              Line[{{$CellContext`xValue$$, 
                  $CellContext`funcC3F16[$CellContext`xValue$$]} - 
                Normalize[{1, 
                  $CellContext`funcC3F16[$CellContext`xValue$$]}], \
{$CellContext`xValue$$, 
                  $CellContext`funcC3F16[$CellContext`xValue$$]} + 
              ...
              Point[{$CellContext`xValue$$, 
                $CellContext`funcC3F16[$CellContext`xValue$$]}]}, Black], 
            If[
             ...
             And[$CellContext`xValue$$ != -1, $CellContext`xValue$$ != 
              ...
              Point[{$CellContext`xValue$$, 
                $CellContext`funcC3F16[$CellContext`xValue$$]}]}, Black]}]}, 
         PlotRange -> {{-3, 3}, {-3, 3}}, AspectRatio -> 1, ImageSize -> 6 72,
          Ticks -> {
       ...
       "Specifications" :> {{{$CellContext`xValue$$, -2.2, 
          ...
          Exclusions -> {-1, 1}}, {{$CellContext`xValue$$, -2.2, ""}, -2.9, 
          2.9, 0.01, ControlType -> Trigger, DefaultDuration -> 20, 
          AppearanceElements -> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F16[
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.2, Figure 3.16"], "Header"]}, {
   Cell[
    TextData["Section 3.2, Figure 3.16"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 5166, 108, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature dL40fku31EvQFLkJ9dgnAk@J *)
