...
NotebookDataLength[     37948,        880]
NotebookOptionsPosition[      5296,        122]
NotebookOutlinePosition[     38726,        892]
CellTagsIndexPosition[     38683,        889]
WindowTitle->Section 3.3, Figure 3.25
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`bValue$$ = E, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`bValue$$], E, "\!\(TraditionalForm\`b\)"}, 1, 4, 
       0.01}, {
       Hold[
        Button[
       ...
       Hold[
        Button[
        "\!\(TraditionalForm\`b = 3\)", $CellContext`bValue$$ = 3, BaseStyle -> 
         11]], Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     288., {115., 120.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`bValue$71979$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`bValue$$ = E}, 
       "ControllerVariables" :> {
         Hold[$CellContext`bValue$$, $CellContext`bValue$71979$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[{$CellContext`bValue$$^$CellContext`x, 
           ...
           PlotStyle -> {{Thick, Black}, {Thick, Dashed, $CellContext`bcR}}], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.3, Figure 3.25"], "Header"]}, {
   Cell[
    TextData["Section 3.3, Figure 3.25"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4019, 89, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature SJ4m#ABvIN01lK#XcGDd@WzJ *)
