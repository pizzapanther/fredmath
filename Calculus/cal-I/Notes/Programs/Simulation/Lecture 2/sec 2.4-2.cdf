...
NotebookDataLength[     41296,        942]
NotebookOptionsPosition[      8643,        184]
NotebookOutlinePosition[     42073,        954]
CellTagsIndexPosition[     42030,        951]
WindowTitle->Section 3.4, Figure 3.29
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`tValue$$ = 0.5, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`tValue$$], 0.5, "time"}, 0, 13, 0.1}, {{
        Hold[$CellContext`tValue$$], 0.5, ""}, 0, 13, 0.01}, {{
        Hold[$CellContext`tValue$$], Null, ""}, {
       0 -> Pane[
         "initial growth rate", {144, Automatic}, Alignment -> Center], 2.2 -> 
        Pane["maximum growth rate", {144, Automatic}, Alignment -> Center], 
        13 -> Pane[
         "growth rate as \!\(TraditionalForm\`t \[Rule] \[Infinity]\)", {
          144, Automatic}, Alignment -> Center]}}}, Typeset`size$$ = {
     504., {127., 132.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`tValue$72172$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`tValue$$ = 0.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`tValue$$, $CellContext`tValue$72172$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC3F29[$CellContext`t], 
            Derivative[1][$CellContext`funcC3F29][$CellContext`t], 
            400}, {$CellContext`t, 0, 14}, 
           PlotStyle -> {{Thick, Black}, {
             Thick, $CellContext`bcR}, {$CellContext`bcB}}, 
           PlotRange -> {-50, 450}], 
          Plot[
          Derivative[
             1][$CellContext`funcC3F29][$CellContext`tValue$$] \
($CellContext`t - $CellContext`tValue$$) + \
$CellContext`funcC3F29[$CellContext`tValue$$], {$CellContext`t, \
$CellContext`tValue$$ - 1.5, $CellContext`tValue$$ + 1.5}, 
           PlotStyle -> {{Thick, $CellContext`bcR}}], 
          Graphics[{
            Text[
             
             Row[{"Cell population: ", 
               "\!\(TraditionalForm\`p(t) = \*FractionBox[\(400\), \(1 + 3 \
\*SuperscriptBox[\(e\), \(\(-0.5\) t\)]\)]\)"}], {6, 
              $CellContext`funcC3F29[6]}, {-1, 1.5}], 
            Text[
             Row[{"Growth rate: ", "\!\(TraditionalForm\`p' \((t)\)\)"}], {
             6, 
              Derivative[1][$CellContext`funcC3F29][6]}, {-1, -1.5}], 
            Text[
             Framed[
              Pane["steady state", $CellContext`bcPBS], {
              RoundingRadius -> 5, FrameStyle -> $CellContext`bcB}], {
             0.5, 400}, {-1, 1.5}], 
            If[$CellContext`tValue$$ == 0, {Gray, 
              Line[{{0, 37.5}, {8, 175}}], Black, 
              Text[
               Framed[
                Pane[
                "Initial growth rate occurs at \!\(TraditionalForm\`\((0, \
37.5)\)\).", {150, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {8, 175}, {0, 0}]}, Black], 
            If[$CellContext`tValue$$ == 2.2, {Gray, 
              Line[{{2.2, 50}, {8, 175}}], Black, 
              Text[
               Framed[
                Pane[
                "Maximum growth rate occurs at approximately \
\!\(TraditionalForm\`\((2.20, 50)\)\).", {
                 150, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {8, 175}, {0, 0}]}, Black], 
            If[$CellContext`tValue$$ == 13, {Gray, 
              Line[{{13, 0}, {8, 175}}], Black, 
              Text[
               Framed[
                Pane[
                "Growth rate approaches 0 as \!\(TraditionalForm\`t \[Rule] \
\[Infinity]\).", {150, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {8, 175}, {0, 0}]}, 
             Black], $CellContext`bcB, 
            AbsolutePointSize[7], 
            Point[{$CellContext`tValue$$, 
              $CellContext`funcC3F29[$CellContext`tValue$$]}], Black, 
            Point[{$CellContext`tValue$$, 
              Derivative[1][$CellContext`funcC3F29][$CellContext`tValue$$]}], 
            
            Text[
            "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)", {13, 0}, {
             1, 1.5}], 
            Text["\!\(TraditionalForm\`p, p'\)", {0, 450}, {1.5, 1}], 
            Text["Time (hours)", {6.5, -35}, {0, 1}]}]}, 
         PlotRange -> {{-1, 13}, {-70, 450}}, AspectRatio -> 1/2, Ticks -> {
           Range[0, 12, 2], 
           Range[0, 450, 50]}, 
         FrameLabel -> {{
           "Number of cells \!\(TraditionalForm\`p(t)\)", None}, {
           "Time (hours)", None}}, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.025}], ImageSize -> 7 72], 
       "Specifications" :> {{{$CellContext`tValue$$, 0.5, "time"}, 0, 13, 0.1,
           ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`tValue$$, 0.5, ""}, 0, 13, 0.01, ControlType -> 
          Trigger, DefaultDuration -> 10, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", 
            "StepRightButton"}}, {{$CellContext`tValue$$, Null, ""}, {
          0 -> Pane[
            "initial growth rate", {144, Automatic}, Alignment -> Center], 
           2.2 -> Pane[
            "maximum growth rate", {144, Automatic}, Alignment -> Center], 13 -> 
           Pane["growth rate as \!\(TraditionalForm\`t \[Rule] \
\[Infinity]\)", {144, Automatic}, Alignment -> Center]}, ControlType -> 
          SetterBar, Appearance -> "Vertical"}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{716., {144., 150.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F29[
            Pattern[$CellContext`t, 
             Blank[]]] := 400/(1 + 3/E^(0.5 $CellContext`t)), $CellContext`t[
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}}; {$CellContext`funcC3F29[
            Pattern[$CellContext`t, 
             Blank[]]] := 400/(1 + 3 E^((-0.5) $CellContext`t))}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.4, Figure 3.29"], "Header"]}, {
   Cell[
    TextData["Section 3.4, Figure 3.29"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 7366, 151, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature YL4Zc6pCxRLJML#zIpZd#0DV *)
