...
NotebookDataLength[     38362,        886]
NotebookOptionsPosition[      5710,        128]
NotebookOutlinePosition[     39140,        898]
CellTagsIndexPosition[     39097,        895]
WindowTitle->Section 3.5, Figure 3.31
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`\[Theta]Value$$ = 0.6, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`\[Theta]Value$$], 0.6, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, 0.01, 1., 
       0.01}}, Typeset`size$$ = {288., {141., 147.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`\[Theta]Value$72473$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`\[Theta]Value$$ = 0.6}, 
       "ControllerVariables" :> {
         Hold[$CellContext`\[Theta]Value$$, \
$CellContext`\[Theta]Value$72473$$, 0]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Graphics[{
          ...
          Text[
           ...
           Row[{"\!\(TraditionalForm\`x\)", 
             ...
             Sin[$CellContext`\[Theta]Value$$/2]}, {-1, 0}]}, Axes -> True, 
         Ticks -> {None, {1}}, PlotRange -> {{-0.25, 1.25}, {-0.25, 1.25}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.5, Figure 3.31"], "Header"]}, {
   Cell[
    TextData["Section 3.5, Figure 3.31"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 4433, 95, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5Iz#zn0Tx9YTzL5LF9scD9Hz *)
