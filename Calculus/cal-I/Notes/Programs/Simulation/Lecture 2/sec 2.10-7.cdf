...
NotebookDataLength[     40413,        920]
NotebookOptionsPosition[      7756,        162]
NotebookOutlinePosition[     41190,        932]
CellTagsIndexPosition[     41147,        929]
WindowTitle->Section 3.10, Figure 3.69
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`bValue$$ = -6, $CellContext`mValue$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold["\!\(\*\nStyleBox[\"m\",\nFontSlant->\"Italic\"]\) (slope)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`mValue$$], 2, ""}, -5., 5., 0.1}, {
       Hold[""], Manipulate`Dump`ThisIsNotAControl}, {
       Hold["\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\) (intercept)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`bValue$$], -6, ""}, -10., 10., 0.1}}, 
     Typeset`size$$ = {324., {160., 165.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`steps$74775$$ = False, $CellContext`mValue$74776$$ = 
     0, $CellContext`bValue$74777$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`bValue$$ = -6, $CellContext`mValue$$ = 
         2, $CellContext`steps$$ = {1}}, "ControllerVariables" :> {
         Hold[$CellContext`steps$$, $CellContext`steps$74775$$, False], 
         Hold[$CellContext`mValue$$, $CellContext`mValue$74776$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$74777$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          Plot[{$CellContext`mValue$$ $CellContext`x + $CellContext`bValue$$, \
$CellContext`x, (
              1/$CellContext`mValue$$) $CellContext`x - \
$CellContext`bValue$$/$CellContext`mValue$$}, {$CellContext`x, -10, 10}, 
           PlotStyle -> {
             If[
...
\)\)\)", Rationalize[$CellContext`mValue$$] "\!\(TraditionalForm\`x\)" + 
                   Rationalize[$CellContext`bValue$$], "\n", 
                   "\!\(TraditionalForm\`\(\(slope\)\(\\ \)\(=\)\(\\ \)\)\)", 
                   
                   Rationalize[$CellContext`mValue$$]}], {
                 110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {10, -4}, {1, 1}]}, Black], 
            If[
              ...
              Text[
               Framed[
                Pane[
                 ...
                 Row[{"\!\(TraditionalForm\`\*SuperscriptBox[\(f\), \
\(-1\)](x)\) = ", (1/Rationalize[$CellContext`mValue$$]) 
                    "\!\(TraditionalForm\`x\)" - 
                   Rationalize[$CellContext`bValue$$]/
                   Rationalize[$CellContext`mValue$$], "\n", 
                   "\!\(TraditionalForm\`\(\(slope\)\(\\ \)\(=\)\(\\ \)\)\)", 
                   1/Rationalize[$CellContext`mValue$$]}], {
                 120, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> White], {-10, 10}, {-1, 1}]}, Black], Black, 
            If[
             MemberQ[$CellContext`steps$$, 2], 
             Text["\!\(TraditionalForm\`y = x\)", {6, 6}, {-2, 0}], Black]}]},
          PlotRange -> {{-10, 10}, {-10, 10}}, AspectRatio -> Automatic, 
         ImageSize -> 4.5 72, Ticks -> {
           Range[-10, 10, 2], 
           Range[-10, 10, 2]}, BaseStyle -> {"Text", 13}, AxesStyle -> 
         Arrowheads[{0, 0.04}], 
         AxesLabel -> {
       ...
       "Specifications" :> {{{$CellContext`steps$$, {1}, ""}, {
         ...
         "\!\(\*\nStyleBox[\"m\",\nFontSlant->\"Italic\"]\) (slope)", \
{{$CellContext`mValue$$, 2, ""}, -5., 5., 0.1, ControlType -> Slider, 
          Exclusions -> {0., 0}, ImageSize -> Small}, "", 
         "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\) (intercept)", \
{{$CellContext`bValue$$, -6, ""}, -10., 10., 0.1, ControlType -> Slider, 
          ImageSize -> Small}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         Deployed -> True, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
      ImageSizeCache->{459., {177., 183.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.10, Figure 3.69"], "Header"]}, {
   Cell[
    TextData["Section 3.10, Figure 3.69"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 6478, 129, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature NI4ommbO9jGJ4J#yoUsNwCkC *)
