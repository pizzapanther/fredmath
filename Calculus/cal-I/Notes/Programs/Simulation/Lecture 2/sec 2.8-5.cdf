...
NotebookDataLength[     40267,        915]
NotebookOptionsPosition[      7968,        165]
NotebookOutlinePosition[     41044,        927]
CellTagsIndexPosition[     41001,        924]
WindowTitle->Section 3.8, Exercise 79
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`a$$ = 1, $CellContext`m$$ = 
     1, $CellContext`showCircleTangents$$ = 
     False, $CellContext`showLineTangents$$ = False, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold["Show tangent lines"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`showLineTangents$$], False, 
        "\!\(TraditionalForm\`y = m\\ x\)"}, {True, False}}, {{
        Hold[$CellContext`showCircleTangents$$], False, 
        "\!\(TraditionalForm\`\*SuperscriptBox[\(x\), \(2\)] + \
\*SuperscriptBox[\(y\), \(2\)] = \*SuperscriptBox[\(a\), \(2\)]\)"}, {
       True, False}}}, Typeset`size$$ = {288., {143., 149.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`m$73947$$ = 0, $CellContext`a$73948$$ = 
     0, $CellContext`showLineTangents$73949$$ = 
     False, $CellContext`showCircleTangents$73950$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`a$$ = 1, $CellContext`m$$ = 
         1, $CellContext`showCircleTangents$$ = 
         False, $CellContext`showLineTangents$$ = False}, 
       "ControllerVariables" :> {
         Hold[$CellContext`m$$, $CellContext`m$73947$$, 0], 
         Hold[$CellContext`a$$, $CellContext`a$73948$$, 0], 
         Hold[$CellContext`showLineTangents$$, \
$CellContext`showLineTangents$73949$$, False], 
         Hold[$CellContext`showCircleTangents$$, \
$CellContext`showCircleTangents$73950$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          ...
          ParametricPlot[{$CellContext`x, $CellContext`m$$ $CellContext`x}, \
{$CellContext`x, -2, 2}, PlotStyle -> {Thick, Black}], 
          ...
          Plot[{$CellContext`m$$ ($CellContext`x - $CellContext`a$$/(
               1 + $CellContext`m$$^2)^
              Rational[1, 2]) + $CellContext`m$$ ($CellContext`a$$/(
               1 + $CellContext`m$$^2)^
              Rational[
               1, 2]), $CellContext`m$$ ($CellContext`x + $CellContext`a$$/(
                1 + $CellContext`m$$^2)^
               Rational[1, 2]) + (-$CellContext`m$$) ($CellContext`a$$/(
               1 + $CellContext`m$$^2)^Rational[1, 2])}, {$CellContext`x, -2, 
            2}, PlotStyle -> If[$CellContext`showLineTangents$$, {{Thick, 
               Lighter[$CellContext`bcB, 0.7]}}, None]], 
          
          Plot[{((-1)/$CellContext`m$$) ($CellContext`x - $CellContext`a$$/(
               1 + $CellContext`m$$^2)^
              Rational[1, 2]) + $CellContext`m$$ ($CellContext`a$$/(
               1 + $CellContext`m$$^2)^
              Rational[
               1, 2]), ((-1)/$CellContext`m$$) ($CellContext`x + \
$CellContext`a$$/(1 + $CellContext`m$$^2)^
               Rational[1, 2]) + (-$CellContext`m$$) ($CellContext`a$$/(
               1 + $CellContext`m$$^2)^Rational[1, 2])}, {$CellContext`x, -2, 
            2}, PlotStyle -> If[$CellContext`showCircleTangents$$, {{Thick, 
               Lighter[$CellContext`bcB, 0.7]}}, None]], 
          Graphics[{$CellContext`bcB, 
            AbsolutePointSize[7], 
            
            Point[{$CellContext`a$$/(1 + $CellContext`m$$^2)^
              Rational[
               1, 2], $CellContext`m$$ ($CellContext`a$$/(
                1 + $CellContext`m$$^2)^Rational[1, 2])}], 
       ...
       "Specifications" :> {{{$CellContext`m$$, 1, 
          ...
          ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], {{$CellContext`a$$, 1, 
           "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0.1, 2, 
          ControlType -> Slider, ImageSize -> Small, ControlPlacement -> 2}, 
         Row[{
           Manipulate`Place[2]}], Delimiter, 
         "Show tangent lines", {{$CellContext`showLineTangents$$, False, 
           "\!\(TraditionalForm\`y = m\\ x\)"}, {True, False}, ControlType -> 
          Checkbox}, {{$CellContext`showCircleTangents$$, False, 
           "\!\(TraditionalForm\`\*SuperscriptBox[\(x\), \(2\)] + \
\*SuperscriptBox[\(y\), \(2\)] = \*SuperscriptBox[\(a\), \(2\)]\)"}, {
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"3.8\"", "\", Exercise \"", "\"79\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.8, Exercise 79"], "Header"]}, {
   Cell[
    TextData["Section 3.8, Exercise 79"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6691, 132, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 8K48SiCAJW96JJk2xYtVjPX1 *)
