...
NotebookDataLength[     42084,        963]
NotebookOptionsPosition[      9414,        204]
NotebookOutlinePosition[     42861,        975]
CellTagsIndexPosition[     42818,        972]
WindowTitle->Section 3.5, Figure 3.32b
WindowFrame->Normal*)
    ...
    DynamicModuleBox[{$CellContext`drawDerivative$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       12.556370614359173`, 0.01}, {{
        Hold[$CellContext`xValue$$], 0.01, ""}, 0.01, 12.556370614359173`, 
       0.01}, {{
     ...
     504., {87., 93.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xValue$72595$$ = 
     0, $CellContext`showHorizontalTangents$72596$$ = 
     False, $CellContext`drawDerivative$72597$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`drawDerivative$$ = 
         False, $CellContext`showHorizontalTangents$$ = 
         False, $CellContext`xValue$$ = 0.01}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$72595$$, 0], 
         Hold[$CellContext`showHorizontalTangents$$, \
$CellContext`showHorizontalTangents$72596$$, False], 
         Hold[$CellContext`drawDerivative$$, \
$CellContext`drawDerivative$72597$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[
           Derivative[
           1][$CellContext`funcC3F32b][$CellContext`x], {$CellContext`x, 
            0, $CellContext`xValue$$}, PlotStyle -> {
             
             If[$CellContext`drawDerivative$$, {Thick, $CellContext`bcR}, 
              None]}], 
          Plot[
           $CellContext`funcC3F32b[$CellContext`x], {$CellContext`x, 0, 4 Pi},
            PlotStyle -> {{Thick, Black}}], 
          Graphics[{Black, 
            AbsolutePointSize[7], 
            Text[
            "\!\(TraditionalForm\`f(x) = cos\\ x\)", {3.25 Pi, 1}, {-1, -5}], 
            ...
            If[$CellContext`showHorizontalTangents$$, {Gray, Dashed, 
              ...
              "\!\(TraditionalForm\`f' \((\[Pi])\) = 0\)", {Pi, -1}, {
               0, 1.25}], 
              Text[
              "\!\(TraditionalForm\`f' \((2  \[Pi])\) = 0\)", {2 Pi, 1}, {
               0, -1.25}], 
              Text[
              "\!\(TraditionalForm\`f' \((3  \[Pi])\) = 0\)", {3 Pi, -1}, {
               0, 1.25}], 
              AbsolutePointSize[7], $CellContext`bcR, 
              Point[{{0, 0}, {Pi, 0}, {2 Pi, 0}, {3 Pi, 0}, {4 Pi, 0}}], 
              Black, 
              Point[{{0, 1}, {Pi, -1}, {2 Pi, 1}, {3 Pi, -1}, {4 Pi, 1}}]}, 
             Black], 
            If[$CellContext`drawDerivative$$, {Gray, 
              Dashing[{}], 
              If[$CellContext`xValue$$ < 4 Pi - 0.1, 
               
               Line[{{$CellContext`xValue$$, -2}, {$CellContext`xValue$$, 
                  2}}], Black], $CellContext`bcR, 
              Point[{$CellContext`xValue$$, 
                Derivative[
                1][$CellContext`funcC3F32b][$CellContext`xValue$$]}]}, 
             Black], $CellContext`bcR, 
            AbsoluteThickness[2], 
            Dashing[{}], 
            Line[{{$CellContext`xValue$$, 
                $CellContext`funcC3F32b[$CellContext`xValue$$]} - 
              Normalize[{1, 
                Derivative[
                1][$CellContext`funcC3F32b][$CellContext`xValue$$]}], \
{$CellContext`xValue$$, 
            ...
            Black, 
            Point[{$CellContext`xValue$$, 
              $CellContext`funcC3F32b[$CellContext`xValue$$]}]}]}, ImageSize -> 
         7 72, PlotRange -> {{0, 4 Pi}, {-2, 2.2}}, BaseStyle -> {"Text", 13},
          AxesStyle -> Arrowheads[{0, 0.025}], Ticks -> {
       ...
       "Specifications" :> {{{$CellContext`xValue$$, 0.01, 
          ...
          12.556370614359173`, 0.01, ControlType -> Trigger, DefaultDuration -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{647., {105., 110.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{
         Attributes[Derivative] = {
           NHoldAll, ReadProtected}, $CellContext`funcC3F32b[
            Pattern[$CellContext`x, 
             Blank[]]] := Cos[$CellContext`x], $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], 
          Attributes[PlotRange] = {ReadProtected}}; {$CellContext`funcC3F32b[
            Pattern[$CellContext`x, 
             Blank[]]] := Cos[$CellContext`x]}}; Typeset`initDone$$ = True),
         ...
         GridBox[{{"\"Section \"", "\"3.5\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"3\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"32b\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.5, Figure 3.32b"], "Header"]}, {
   Cell[
    TextData["Section 3.5, Figure 3.32b"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 8136, 171, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 1I4iSBYAp1NMzJ#AXcu0FTBq *)
