...
NotebookDataLength[     40592,        931]
NotebookOptionsPosition[      7939,        173]
NotebookOutlinePosition[     41369,        943]
CellTagsIndexPosition[     41326,        940]
WindowTitle->Section 3.6, Figure 3.39
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showAcceleration$$ = 
     True, $CellContext`showVelocity$$ = False, $CellContext`tValue$$ = 0, 
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`tValue$$], 0, "time"}, 0, 5, 0.01}, {{
        Hold[$CellContext`tValue$$], 0, ""}, 0, 5, 0.01}, {{
     ...
     576., {159., 163.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`tValue$73068$$ = 
     0, $CellContext`showVelocity$73069$$ = 
     False, $CellContext`showAcceleration$73070$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showAcceleration$$ = 
         True, $CellContext`showVelocity$$ = False, $CellContext`tValue$$ = 
         0}, "ControllerVariables" :> {
         Hold[$CellContext`tValue$$, $CellContext`tValue$73068$$, 0], 
         Hold[$CellContext`showVelocity$$, $CellContext`showVelocity$73069$$, 
          False], 
         Hold[$CellContext`showAcceleration$$, \
$CellContext`showAcceleration$73070$$, False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> GraphicsGrid[{{
           Graphics[{Black, 
             AbsolutePointSize[7], 
             Point[{
               $CellContext`funcC3F39[$CellContext`tValue$$], 1}]}, 
            PlotRange -> {{-7, 1}, {-1, 1.5}}, ImageSize -> 3 72, 
            Axes -> {True, False}, Ticks -> {
              Range[-7, 4], None}, BaseStyle -> {"Text", 13}, 
            AxesLabel -> {"\!\(TraditionalForm\`s\)", None}], 
           Show[{
             Plot[{
               $CellContext`funcC3F39[$CellContext`t], 
               Derivative[1][$CellContext`funcC3F39][$CellContext`t], 
               Derivative[
               2][$CellContext`funcC3F39][$CellContext`t]}, {$CellContext`t, 
               0, 5}, PlotStyle -> {{Thick, Black}, 
                
                If[$CellContext`showVelocity$$, {Thick, $CellContext`bcR}, 
                 None], 
                
                If[$CellContext`showAcceleration$$, {Thick, $CellContext`bcB},
                  None]}], 
             Graphics[{
               AbsolutePointSize[7], Gray, 
               
               Line[{{$CellContext`tValue$$, -7}, {$CellContext`tValue$$, 
                  5}}], Black, 
               Point[{$CellContext`tValue$$, 
                 $CellContext`funcC3F39[$CellContext`tValue$$]}], 
               Text[
                
                Row[{"Position: ", 
                  "\!\(TraditionalForm\`s = \*SuperscriptBox[\(t\), \(2\)] - \
5  t\)"}], {1, -7}, {-1, 1}], 
               If[$CellContext`showVelocity$$, {$CellContext`bcR, 
                 Point[{$CellContext`tValue$$, 
                   Derivative[
                   1][$CellContext`funcC3F39][$CellContext`tValue$$]}], 
                 Text[
                  
                  Row[{"Velocity: ", 
                    "\!\(TraditionalForm\`v = \(s' = 2  t - 5\)\)"}], {
                  1, -3}, {-1, 1}]}, Black], 
               If[$CellContext`showAcceleration$$, {$CellContext`bcB, 
                 Point[{$CellContext`tValue$$, 
                   Derivative[
                   2][$CellContext`funcC3F39][$CellContext`tValue$$]}], 
                 Text[
                  
                  Row[{"Acceleration: ", 
                    "\!\(TraditionalForm\`a = \(s'' \((t)\) = 2\)\)"}], {
                  0.5, 2}, {-1, -1.5}]}, Black]}]}, ImageSize -> 4 72, 
            AspectRatio -> 1, PlotRange -> {{-0.5, 5.5}, {-8.5, 5}}, Ticks -> {
              Range[0, 5], 
              Range[-7, 5]}, BaseStyle -> {"Text", 13}, 
            AxesLabel -> {
             "\!\(TraditionalForm\`t\)", "\!\(TraditionalForm\`s\)"}]}}, 
         ImageSize -> 8 72], 
       "Specifications" :> {{{$CellContext`tValue$$, 0, "time"}, 0, 5, 0.01, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`tValue$$, 0, ""}, 0, 5, 0.01, ControlType -> 
          Trigger, DefaultDuration -> 10, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
         Delimiter, {{$CellContext`showVelocity$$, False, "show velocity"}, {
          True, False}, ControlType -> Checkbox, ControlPlacement -> 
          1}, {{$CellContext`showAcceleration$$, True, "show acceleration"}, {
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{735., {176., 181.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC3F39[
            Pattern[$CellContext`t, 
             Blank[]]] := $CellContext`t^2 - 5 $CellContext`t, $CellContext`t[
          ...
          RGBColor[0, 0.4, 0.8]}; {$CellContext`funcC3F39[
            Pattern[$CellContext`t, 
             Blank[]]] := $CellContext`t^2 - 5 $CellContext`t}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.6, Figure 3.39"], "Header"]}, {
   Cell[
    TextData["Section 3.6, Figure 3.39"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 6662, 140, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature hLNyv@6Vkfjk2IO67rfamaxU *)
