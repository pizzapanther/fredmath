...
NotebookDataLength[     41945,        953]
NotebookOptionsPosition[      9292,        195]
NotebookOutlinePosition[     42722,        965]
CellTagsIndexPosition[     42679,        962]
WindowTitle->Section 3.1, Figure 3.03
WindowFrame->Normal*)
...
FontSlant->\"Italic\"]\)", {100, Automatic}, 
       ...
       0.01}}, Typeset`size$$ = {432., {216., 221.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$71156$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = 5.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$71156$$, 0]}, 
       "OtherVariables" :> {
...
(($CellContext`funcC3F3[$CellContext`xValue$$] - $CellContext`funcC3F3[
          ...
          Graphics[{Black, 
            ...
            Text[
            "\!\(TraditionalForm\`f(x) - f(a)\)", {$CellContext`xValue$$, \
($CellContext`funcC3F3[1.5] + $CellContext`funcC3F3[$CellContext`xValue$$])/
              2}, {-1.1, 0}], 
            Text[
            "\!\(TraditionalForm\`x - a\)", {($CellContext`xValue$$ + 1.5)/
              2, 
              $CellContext`funcC3F3[1.5]}, {0, 1.5}], 
            Text[
             Framed["\!\(TraditionalForm\`x > a\)", $CellContext`bcFO], {7, 
             0}, {-1, -2}], 
            Text["\!\(TraditionalForm\`P\)", {1.5, 
...
\*SubscriptBox[\(lim\), \(x \[Rule] a\)]\*FractionBox[\(f \((x)\) - f \((a)\)\
\), \(x - a\)]\)", $CellContext`bcPBS], $CellContext`bcFO, Background -> 
...
\*FractionBox[\(f \((x)\) - f \((a)\)\), \(x - a\)]\)", $CellContext`bcPBS], \
...
CellContext`funcC3F3[$CellContext`xValue$$] - $CellContext`funcC3F3[
         ...
         1, ImageSize -> 6 72, PlotRange -> {{-1.5, 10}, {-1, 11}}, 
         BaseStyle -> {"Text", 13}, AxesStyle -> Arrowheads[{0, 0.04}], 
         AxesLabel -> {
          "\!\(TraditionalForm\`x\)", "\!\(TraditionalForm\`y\)"}, 
         Ticks -> {{{
            1.5, "\!\(TraditionalForm\`a\)"}, {$CellContext`xValue$$, 
             "\!\(TraditionalForm\`x\)"}}, {{
             $CellContext`funcC3F3[1.5], "\!\(TraditionalForm\`f(a)\)"}, {
             $CellContext`funcC3F3[$CellContext`xValue$$], 
             "\!\(TraditionalForm\`f(x)\)"}}}], "Specifications" :> {
         Pane[
         "Change location of point \!\(\*\nStyleBox[\"Q\",\n\
FontSlant->\"Italic\"]\)", {100, Automatic}, 
          BaseStyle -> {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 3.1, Figure 3.03"], "Header"]}, {
   Cell[
    TextData["Section 3.1, Figure 3.03"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1273, 31, 8015, 162, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature kIzizEfaF5KX6J5iQje9fDco *)
