...
NotebookDataLength[     20033,        417]
NotebookOptionsPosition[      7633,        155]
NotebookOutlinePosition[     20127,        419]
CellTagsIndexPosition[     20084,        416]
WindowTitle->Section 12.3, Figure 12.46
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`uVector$$ = {3, 
    0}, $CellContext`vVector$$ = {2.7700000000000005`, 4.48}, Typeset`show$$ =
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`uVector$$], {3, 0}}, {-5, -5}, {5, 5}}, {{
       Hold[$CellContext`vVector$$], {1.8, 4}}, {-5, -5}, {5, 5}}, {
      Hold[
       Pane[
...
\nStyleBox[\".\",\nFontWeight->\"Bold\"]\)", {110, Automatic}, 
    ...
    False, $CellContext`uVector$188957$$ = {0, 
    0}, $CellContext`vVector$188958$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`uVector$$ = {3, 
         0}, $CellContext`vVector$$ = {1.8, 4}}, "ControllerVariables" :> {
        Hold[$CellContext`uVector$$, $CellContext`uVector$188957$$, {0, 0}], 
        Hold[$CellContext`vVector$$, $CellContext`vVector$188958$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         "\!\(\*\nStyleBox[FormBox[\n  StyleBox[\"u\",\nFontWeight->\"Bold\",\
\nFontSlant->\"Plain\"],\n  TraditionalForm],\nFontSlant->\"Italic\"]\)", \
$CellContext`uVector$$/2, {-2, 1}], 
         Text[
         "\!\(\*\nStyleBox[FormBox[\n  StyleBox[\"v\",\nFontWeight->\"Bold\",\
\nFontSlant->\"Plain\"],\n  TraditionalForm],\nFontSlant->\"Italic\"]\)", \
$CellContext`vVector$$/2, {2, -1}], 
         Text[
         "\!\(\*\nStyleBox[FormBox[\n  RowBox[{\n   StyleBox[\"u\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"-\", \n   StyleBox[\"v\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"]}],\n  TraditionalForm],\n\
FontSlant->\"Italic\"]\)", $CellContext`vVector$$ + ($CellContext`uVector$$ - \
$CellContext`vVector$$)/2, {-2, -1}], 
         Text[
          Framed[
           Pane[
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], {0, -5}, {
         ...
         Arrow[{{0, 0}, $CellContext`vVector$$}], $CellContext`bcG, 
         Arrow[{$CellContext`vVector$$, $CellContext`uVector$$}], 
        ...
        PlotRange -> {{-5, 5}, {-5, 5}}, ImageSize -> 4 72, 
        BaseStyle -> {"Text", 13}], 
      "Specifications" :> {{{$CellContext`uVector$$, {3, 0}}, {-5, -5}, {5, 
         5}, ControlType -> Locator, Appearance -> 
         "\[CircleTimes]"}, {{$CellContext`vVector$$, {1.8, 4}}, {-5, -5}, {5,
...
\nStyleBox[\".\",\nFontWeight->\"Bold\"]\)", {110, Automatic}, 
      ...
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, Deployed -> True, 
        ...
        Style["FIGURE 12.46", "FigureFont", Smaller]}, "DefaultOptions" :> {}],
...
(*NotebookFileOutline
Notebook[{
Cell[592, 21, 7037, 132, 390, "Output"]
}
]
*)
...
(* NotebookSignature 5LzAKeK@uOb44I5NDtD##2uQ *)
