...
NotebookDataLength[     32785,        690]
NotebookOptionsPosition[     20375,        428]
NotebookOutlinePosition[     32878,        692]
CellTagsIndexPosition[     32835,        689]
WindowTitle->Section 12.7, Figure 12.81
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`showAcceleration$$ = 
    False, $CellContext`showGrids$$ = True, $CellContext`showPosition$$ = 
    True, $CellContext`showVelocity$$ = True, $CellContext`tMax$$ = 
    5, $CellContext`tMin$$ = -1, $CellContext`tValue$$ = 
    4.5, $CellContext`uVector$$ = {2, -4, 1}, $CellContext`vVector$$ = {3, 
    ...
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`showPosition$$], True, "show position"}, {
      True, False}}, {{
       Hold[$CellContext`showVelocity$$], True, "show velocity"}, {
      True, False}}, {{
       Hold[$CellContext`showAcceleration$$], False, "show acceleration"}, {
      True, False}}, {
      Hold[
       Grid[{{
          Manipulate`Place[1]}, {
      ...
      Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`tValue$$], 0.5, 
       "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -0.5, 4.5}, {{
       Hold[$CellContext`tValue$$], 0.5, ""}, -0.5, 4.5}, {{
      ...
      Hold[
       ...
       Hold[$CellContext`tMin$$], -1}, 0}, {{
       Hold[$CellContext`tMax$$], 5}, 0}}, Typeset`size$$ = {
    432., {213., 219.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`showPosition$190878$$ = 
    False, $CellContext`showVelocity$190879$$ = 
    False, $CellContext`showAcceleration$190880$$ = 
    False, $CellContext`tValue$190881$$ = 0, $CellContext`showGrids$190882$$ =
     False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`showAcceleration$$ = 
        False, $CellContext`showGrids$$ = False, $CellContext`showPosition$$ = 
        True, $CellContext`showVelocity$$ = True, $CellContext`tMax$$ = 
        5, $CellContext`tMin$$ = -1, $CellContext`tValue$$ = 
        0.5, $CellContext`uVector$$ = {2, -4, 1}, $CellContext`vVector$$ = {3,
          0, -1}, $CellContext`xMax$$ = 
        5, $CellContext`xMin$$ = -5, $CellContext`yMax$$ = 
        5, $CellContext`yMin$$ = -2, $CellContext`zMax$$ = 
        5, $CellContext`zMin$$ = -5}, "ControllerVariables" :> {
        Hold[$CellContext`showPosition$$, $CellContext`showPosition$190878$$, 
         False], 
        Hold[$CellContext`showVelocity$$, $CellContext`showVelocity$190879$$, 
         False], 
        Hold[$CellContext`showAcceleration$$, \
$CellContext`showAcceleration$190880$$, False], 
        Hold[$CellContext`tValue$$, $CellContext`tValue$190881$$, 0], 
        Hold[$CellContext`showGrids$$, $CellContext`showGrids$190882$$, 
         False]}, 
      "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
         ...
         Graphics3D[{
           AbsolutePointSize[6], 
           Arrowheads[0.03], 
           If[$CellContext`showPosition$$, {$CellContext`bcB, 
             Arrow[
              Tube[{{0, 0, 0}, 
                $CellContext`funcLTC12F81[$CellContext`tValue$$]}]], Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"r\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F81[$CellContext`tValue$$]/2, {2, 
              0}]}, Black], 
           If[$CellContext`showVelocity$$, {$CellContext`bcR, 
             Arrow[
              Tube[{
                $CellContext`funcLTC12F81[$CellContext`tValue$$], \
$CellContext`funcLTC12F81[$CellContext`tValue$$] + 
                Derivative[
                 1][$CellContext`funcLTC12F81][$CellContext`tValue$$]}]], 
             Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"v\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F81[$CellContext`tValue$$] + 
              1.1 Derivative[
                1][$CellContext`funcLTC12F81][$CellContext`tValue$$], {0, 
              0}]}, Black], 
           If[$CellContext`showAcceleration$$, {Orange, 
             Arrow[
              Tube[{
                $CellContext`funcLTC12F81[$CellContext`tValue$$], \
$CellContext`funcLTC12F81[$CellContext`tValue$$] + 
                Derivative[
                 2][$CellContext`funcLTC12F81][$CellContext`tValue$$]}]], 
             Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"a\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F81[$CellContext`tValue$$] + 
              1.1 Derivative[
                2][$CellContext`funcLTC12F81][$CellContext`tValue$$], {0, 
              0}]}, Black], Black, 
           Point[
            $CellContext`funcLTC12F81[$CellContext`tValue$$]], 
           Text[
           "Trajectory \!\(\*FormBox[\n RowBox[{\n  StyleBox[\"r\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", {0, 0, $CellContext`zMax$$}, {1.5, -1}]}], 
         ParametricPlot3D[
          $CellContext`funcLTC12F81[$CellContext`t], {$CellContext`t, \
...
$CellContext`zMax$$}}, BaseStyle -> {"Text", 13}, ViewPoint -> {3, 2, 1.5}, 
      ...
      "Specifications" :> {{{$CellContext`showPosition$$, True, 
          "show position"}, {True, False}, ControlType -> Checkbox, 
         ControlPlacement -> 
         1}, {{$CellContext`showVelocity$$, True, "show velocity"}, {
         True, False}, ControlType -> Checkbox, ControlPlacement -> 
         2}, {{$CellContext`showAcceleration$$, False, "show acceleration"}, {
         True, False}, ControlType -> Checkbox, ControlPlacement -> 3}, 
        Grid[{{
           Manipulate`Place[1]}, {
           Manipulate`Place[2]}, {
           Manipulate`Place[3]}}, Alignment -> Right], 
        Delimiter, {{$CellContext`tValue$$, 0.5, 
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -0.5, 4.5, 
         ControlType -> Slider, ImageSize -> 
         Small}, {{$CellContext`tValue$$, 0.5, ""}, -0.5, 4.5, ControlType -> 
        ...
        Row[{
          Manipulate`Place[4]}], {{$CellContext`uVector$$, {2, -4, 1}}, 0, 
         ...
         None}, {{$CellContext`tMin$$, -1}, 0, ControlType -> 
         None}, {{$CellContext`tMax$$, 5}, 0, ControlType -> None}}, 
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, AppearanceElements -> 
        "ResetButton", FrameLabel -> 
        Style["FIGURE 12.81", "FigureFont", Smaller]}, "DefaultOptions" :> {}],
...
$CellContext`PlaneGrids}, {$CellContext`opts}], 
         ...
         RGBColor[0, 0.4, 0.8], $CellContext`funcLTC12F81[
...
$CellContext`bcR = RGBColor[0.8, 0, 0.4], 
...
(*NotebookFileOutline
Notebook[{
Cell[592, 21, 19779, 405, 528, "Output"]
}
]
*)
...
(* NotebookSignature ULjrQnKSX4Z8gJ#FLtHWmOgu *)
