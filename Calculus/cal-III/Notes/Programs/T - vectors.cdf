...
NotebookDataLength[     34050,        718]
NotebookOptionsPosition[     21560,        454]
NotebookOutlinePosition[     34143,        720]
CellTagsIndexPosition[     34100,        717]
WindowTitle->Section 12.6, Figure 12.80
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`showGrids$$ = 
    ...
    False, $CellContext`showUnitTangent$$ = True, $CellContext`tMax$$ = 
...
\", \")\"}]}],\n TraditionalForm]\)"}, {True, False}}, {{
       Hold[$CellContext`showUnitTangent$$], True, 
       "show \!\(\*FormBox[\n RowBox[{\n  StyleBox[\"T\",\nFontWeight->\"Bold\
\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n TraditionalForm]\)"}, {
      True, False}}, {{
    ...
    Typeset`skipInitDone$$ = False, $CellContext`tValue$190801$$ = 
    0, $CellContext`showTangent$190802$$ = 
    False, $CellContext`showUnitTangent$190803$$ = 
    False, $CellContext`showGrids$190804$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`showGrids$$ = 
        ...
        Hold[$CellContext`tValue$$, $CellContext`tValue$190801$$, 0], 
        Hold[$CellContext`showTangent$$, $CellContext`showTangent$190802$$, 
         False], 
        Hold[$CellContext`showUnitTangent$$, \
$CellContext`showUnitTangent$190803$$, False], 
        Hold[$CellContext`showGrids$$, $CellContext`showGrids$190804$$, 
         False]}, 
      "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
         ...
         Graphics3D[{
           ...
           Point[
            $CellContext`funcLTC12F80[$CellContext`tValue$$]], 
           Text[
           "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   StyleBox[\"r\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}], \"=\", \n\
...
$CellContext`funcLTC12F80[$CellContext`tValue$$] + 
                Derivative[
                 1][$CellContext`funcLTC12F80][$CellContext`tValue$$]}, 
               0.04]], Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   StyleBox[\"r\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"'\"}], \n  RowBox[{\"(\", \"t\
...
$CellContext`funcLTC12F80[$CellContext`tValue$$] + 
              Derivative[
               1][$CellContext`funcLTC12F80][$CellContext`tValue$$], {
              0, -2}]}, Black], 
           If[$CellContext`showUnitTangent$$, {Orange, 
             Arrowheads[0.02], 
             Arrow[
              Tube[{
                $CellContext`funcLTC12F80[$CellContext`tValue$$], \
$CellContext`funcLTC12F80[$CellContext`tValue$$] + Normalize[
                  Derivative[
                  1][$CellContext`funcLTC12F80][$CellContext`tValue$$]]}, 
               0.05]], Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"T\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F80[$CellContext`tValue$$] + 
              Normalize[
                Derivative[
                1][$CellContext`funcLTC12F80][$CellContext`tValue$$]], {0, 
              2}]}, Black]}], 
         ParametricPlot3D[
          $CellContext`funcLTC12F80[$CellContext`t], {$CellContext`t, \
...
$CellContext`zMax$$ + 0.5}}, BaseStyle -> {"Text", 13}, 
        ViewPoint -> {1, 5, 1}, Boxed -> False, Lighting -> "Neutral", 
        ImageSize -> 6 {72, 72}, Epilog -> {
          Inset[
           Graphics3D[
            If[$CellContext`showUnitTangent$$, 
             Text[
              Framed[
               Pane[
               "Unit tangent vectors change direction along the curve, but \
always have length 1.", {
                180, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> White], {0, 0, 0}, {0, 0}], Black], Boxed -> 
            False, ViewPoint -> {0, -Infinity, 0}, ImageSize -> 6 72, 
      ...
      "Specifications" :> {{{$CellContext`tValue$$, 2, 
         ...
         1}, {{$CellContext`tValue$$, 2, ""}, 0.98, 3, 0.01, ControlType -> 
...
\", \")\"}]}],\n TraditionalForm]\)"}, {True, False}, ControlType -> 
         Checkbox}, {{$CellContext`showUnitTangent$$, True, 
...
(*NotebookFileOutline
Notebook[{
Cell[592, 21, 20964, 431, 528, "Output"]
}
]
*)
...
(* NotebookSignature FLju1s#zQzzs@L5RfWTRPEwA *)
