...
NotebookDataLength[     18424,        404]
NotebookOptionsPosition[      5961,        140]
NotebookOutlinePosition[     18518,        406]
CellTagsIndexPosition[     18475,        403]
WindowTitle->Section 12.9, Figure 12.108
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`tValue$$ = 2.2, Typeset`show$$ = True, 
...
\)", 
    ...
    Typeset`skipInitDone$$ = False, $CellContext`tValue$192540$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, "Variables" :> {$CellContext`tValue$$ = -1.5}, 
      "ControllerVariables" :> {
        Hold[$CellContext`tValue$$, $CellContext`tValue$192540$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         ParametricPlot[
          $CellContext`funcLTC12F108[$CellContext`t], {$CellContext`t, -2.5, 
           2.5}, PlotStyle -> {{
             AbsoluteThickness[0.5], Black}}], 
         ParametricPlot[
          $CellContext`funcLTC12F108[$CellContext`t], {$CellContext`t, \
...
{-3, -1}, {-1, -1}], $CellContext`tValue$$ == 0, Black, $CellContext`tValue$$ > 
           ...
           AbsolutePointSize[7], 
           Point[
            $CellContext`funcLTC12F108[$CellContext`tValue$$]], 
           Text[
            Framed[
             Pane[
...
TraditionalForm]\)", 
      ...
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, Deployed -> True, 
        ...
        Style["FIGURE 12.108", "FigureFont", Smaller]}, 
      "DefaultOptions" :> {}],
     ImageSizeCache->{525., {220., 225.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>({{$CellContext`funcLTC12F108[
...
(*NotebookFileOutline
Notebook[{
Cell[593, 21, 5364, 117, 462, "Output"]
}
]
*)
...
(* NotebookSignature II4QOHWX4VdMbK52hTusolfM *)
