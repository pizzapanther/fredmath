...
NotebookDataLength[     35650,        743]
NotebookOptionsPosition[     23186,        479]
NotebookOutlinePosition[     35743,        745]
CellTagsIndexPosition[     35700,        742]
WindowTitle->Section 12.9, Figure 12.106
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
    0.2, $CellContext`showGrids$$ = False, $CellContext`showNormal$$ = 
    True, $CellContext`showTangent$$ = True, $CellContext`tMax$$ = 4 
    Pi, $CellContext`tMin$$ = (-4) Pi, $CellContext`tValue$$ = 
    0, $CellContext`xMax$$ = 
...
\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n TraditionalForm]\)"}, {
      ...
      Manipulate`Dump`ThisIsNotAControl}, {{
       ...
       "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0.5, 3}, {{
       Hold[$CellContext`bValue$$], 0.2, 
       "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0.01, 2}, {{
       Hold[$CellContext`tValue$$], 0, 
       "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, (-4) Pi, 4 Pi, 
      0.01}, {{
       Hold[$CellContext`tValue$$], 0, ""}, (-4) Pi, 4 Pi}, {{
      ...
      Hold[
       ...
       Hold[$CellContext`tMin$$], (-4) Pi}, 0}, {{
       Hold[$CellContext`tMax$$], 4 Pi}, 0}}, Typeset`size$$ = {
    432., {213., 219.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`showTangent$192370$$ = 
    False, $CellContext`showNormal$192371$$ = 
    False, $CellContext`aValue$192372$$ = 0, $CellContext`bValue$192373$$ = 
    0, $CellContext`tValue$192374$$ = 0, $CellContext`showGrids$192375$$ = 
    False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
        0.2, $CellContext`showGrids$$ = False, $CellContext`showNormal$$ = 
        True, $CellContext`showTangent$$ = True, $CellContext`tMax$$ = 
        4 Pi, $CellContext`tMin$$ = (-4) Pi, $CellContext`tValue$$ = 
        0, $CellContext`xMax$$ = 
        3, $CellContext`xMin$$ = -3, $CellContext`yMax$$ = 
        3, $CellContext`yMin$$ = -3, $CellContext`zMax$$ = 
        3, $CellContext`zMin$$ = -3}, "ControllerVariables" :> {
        Hold[$CellContext`showTangent$$, $CellContext`showTangent$192370$$, 
         False], 
        Hold[$CellContext`showNormal$$, $CellContext`showNormal$192371$$, 
         False], 
        Hold[$CellContext`aValue$$, $CellContext`aValue$192372$$, 0], 
        Hold[$CellContext`bValue$$, $CellContext`bValue$192373$$, 0], 
        Hold[$CellContext`tValue$$, $CellContext`tValue$192374$$, 0], 
        Hold[$CellContext`showGrids$$, $CellContext`showGrids$192375$$, 
         False]}, 
      "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
         ...
         Graphics3D[{
           ...
           If[$CellContext`showTangent$$, {$CellContext`bcR, 
             Arrow[
              Tube[{
                $CellContext`funcLTC12F106[$CellContext`tValue$$, \
$CellContext`aValue$$, $CellContext`bValue$$], \
$CellContext`funcLTC12F106[$CellContext`tValue$$, $CellContext`aValue$$, \
$CellContext`bValue$$] + Normalize[
                  ReplaceAll[
                   D[
                    $CellContext`funcLTC12F106[$CellContext`t, \
$CellContext`aValue$$, $CellContext`bValue$$], $CellContext`t], \
$CellContext`t -> $CellContext`tValue$$]]}, 0.04]], Black, 
             Text[
             "\!\(\*FormBox[\n StyleBox[\"T\",\nFontWeight->\"Bold\",\n\
FontSlant->\"Plain\"],\n TraditionalForm]\)", \
$CellContext`funcLTC12F106[$CellContext`tValue$$, $CellContext`aValue$$, \
$CellContext`bValue$$] + 1.5 Normalize[
                 ReplaceAll[
                  D[
                   $CellContext`funcLTC12F106[$CellContext`t, \
$CellContext`aValue$$, $CellContext`bValue$$], $CellContext`t], \
$CellContext`t -> $CellContext`tValue$$]], {0, 0}]}, Black], 
           If[$CellContext`showNormal$$, {$CellContext`bcB, 
             Arrow[
              Tube[{
                $CellContext`funcLTC12F106[$CellContext`tValue$$, \
$CellContext`aValue$$, $CellContext`bValue$$], \
...
$CellContext`bValue$$] + Normalize[
                  ReplaceAll[
                   D[D[
                    $CellContext`funcLTC12F106[$CellContext`t, \
$CellContext`aValue$$, $CellContext`bValue$$], $CellContext`t]/Sqrt[
                    Dot[
                    D[
                    $CellContext`funcLTC12F106[$CellContext`t, \
$CellContext`aValue$$, $CellContext`bValue$$], $CellContext`t], 
                    ...
                    $CellContext`funcLTC12F106[$CellContext`t, \
$CellContext`aValue$$, $CellContext`bValue$$], $CellContext`t]]], \
$CellContext`t], $CellContext`t -> $CellContext`tValue$$]]}, 0.04]], Black, 
             Text[
             "\!\(\*FormBox[\n StyleBox[\"N\",\nFontWeight->\"Bold\",\n\
FontSlant->\"Plain\"],\n TraditionalForm]\)", \
$CellContext`funcLTC12F106[$CellContext`tValue$$, $CellContext`aValue$$, \
$CellContext`bValue$$] + 1.5 Normalize[
                 ReplaceAll[
                  D[
                   $CellContext`funcLTC12F106[$CellContext`t, \
$CellContext`aValue$$, $CellContext`bValue$$], {$CellContext`t, 
                    2}], $CellContext`t -> $CellContext`tValue$$]], {0, 0}]}, 
            Black], Black, 
           Point[
            $CellContext`funcLTC12F106[$CellContext`tValue$$, \
$CellContext`aValue$$, $CellContext`bValue$$]], 
...
\[RightAngleBracket]\"}]}],\n TraditionalForm]\)", {
            ...
            0, $CellContext`yMin$$, $CellContext`zMax$$}, {-0.3, 1}], 
           Text[
            Framed[
             Pane[
             "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   StyleBox[\"T\",\n\
...
StyleBox[\"N\",\nFontWeight->\"Bold\",\nFontSlant->\"Plain\"]}], \"=\", \
\"0\"}],\n TraditionalForm]\) at all points of the curve.\n\!\(\*FormBox[\n \
StyleBox[\"T\",\nFontWeight->\"Bold\",\nFontSlant->\"Plain\"],\n \
TraditionalForm]\) points in the direction of the curve.\n\!\(\*FormBox[\n \
StyleBox[\"N\",\nFontWeight->\"Bold\",\nFontSlant->\"Plain\"],\n \
TraditionalForm]\) points to the inside of the curve.", {
              Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], {0, 0, $CellContext`zMin$$}, {0, 2}]}], 
         ParametricPlot3D[
          $CellContext`funcLTC12F106[$CellContext`t, $CellContext`aValue$$, \
$CellContext`bValue$$], {$CellContext`t, $CellContext`tMin$$, \
...
$CellContext`zMax$$}}, BaseStyle -> {"Text", 13}, ViewPoint -> {3, 2, 1.5}, 
      ...
      "Specifications" :> {{{$CellContext`showTangent$$, True, 
          "show \!\(\*FormBox[\n RowBox[{\n  StyleBox[\"T\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)"}, {True, False}, ControlType -> Checkbox, 
         ControlPlacement -> 
         1}, {{$CellContext`showNormal$$, True, 
          "show \!\(\*FormBox[\n RowBox[{\n  StyleBox[\"N\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)"}, {True, False}, ControlType -> Checkbox, 
         ControlPlacement -> 2}, 
        ...
        Delimiter, {{$CellContext`aValue$$, 1, 
         ...
         Small}, {{$CellContext`bValue$$, 0.2, 
          "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0.01, 2, 
         ControlType -> Slider, ImageSize -> Small}, 
        Delimiter, {{$CellContext`tValue$$, 0, 
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, (-4) Pi, 4 Pi,
          0.01, ControlType -> Slider, ImageSize -> 
         Small}, {{$CellContext`tValue$$, 0, ""}, (-4) Pi, 4 Pi, ControlType -> 
        ...
        Row[{
          Manipulate`Place[3]}], {{$CellContext`xMin$$, -3}, 0, ControlType -> 
         ...
         None}, {{$CellContext`tMin$$, (-4) Pi}, 0, ControlType -> 
         None}, {{$CellContext`tMax$$, 4 Pi}, 0, ControlType -> None}}, 
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, AppearanceElements -> 
        "ResetButton", FrameLabel -> 
        Style["FIGURE 12.106", "FigureFont", Smaller]}, 
      "DefaultOptions" :> {}],
     ImageSizeCache->{599., {253., 258.}},
...
$CellContext`PlaneGrids}, {$CellContext`opts}], 
         ...
         RGBColor[0.8, 0, 0.4], $CellContext`funcLTC12F106[
           Pattern[$CellContext`t, 
            Blank[]], 
           Pattern[$CellContext`a, 
            Blank[]], 
           Pattern[$CellContext`b, 
            Blank[]]] := {$CellContext`a Cos[$CellContext`t], $CellContext`a 
           Sin[$CellContext`t], $CellContext`b $CellContext`t}, $CellContext`t[
           Pattern[$CellContext`df, 
            Blank[]]] := PDF[
           
           StudentTDistribution[$CellContext`df], $CellContext`x], \
$CellContext`bcB = RGBColor[0, 0.4, 0.8], $CellContext`bcPBS = 
         BaseStyle -> {
...
(*NotebookFileOutline
Notebook[{
Cell[593, 21, 22589, 456, 528, "Output"]
}
]
*)
...
(* NotebookSignature oINzFjBY5XXQxLktTvwt5sIy *)
