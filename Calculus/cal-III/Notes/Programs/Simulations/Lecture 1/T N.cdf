...
NotebookDataLength[     33619,        709]
NotebookOptionsPosition[     21155,        445]
NotebookOutlinePosition[     33712,        711]
CellTagsIndexPosition[     33669,        708]
WindowTitle->Section 12.9, Figure 12.104
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`showGrids$$ = 
    False, $CellContext`showNormal$$ = True, $CellContext`showTangent$$ = 
    True, $CellContext`tMax$$ = 
    5, $CellContext`tMin$$ = -1, $CellContext`tValue$$ = 
    3.2, $CellContext`xMax$$ = 
...
\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n TraditionalForm]\)"}, {
      ...
      Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`tValue$$], 3.2, 
       "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -0.5, 4.8}, {{
       Hold[$CellContext`tValue$$], 3.2, ""}, -0.5, 4.8}, {{
    ...
    Typeset`skipInitDone$$ = False, $CellContext`showTangent$192235$$ = 
    False, $CellContext`showNormal$192236$$ = 
    False, $CellContext`tValue$192237$$ = 0, $CellContext`showGrids$192238$$ =
     False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`showGrids$$ = 
        ...
        Hold[$CellContext`showTangent$$, $CellContext`showTangent$192235$$, 
         False], 
        Hold[$CellContext`showNormal$$, $CellContext`showNormal$192236$$, 
         False], 
        Hold[$CellContext`tValue$$, $CellContext`tValue$192237$$, 0], 
        Hold[$CellContext`showGrids$$, $CellContext`showGrids$192238$$, 
         False]}, 
      "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
         ...
         Graphics3D[{
           ...
           If[$CellContext`showTangent$$, {$CellContext`bcR, 
             Arrow[
              Tube[{
                $CellContext`funcLTC12F104[$CellContext`tValue$$], \
$CellContext`funcLTC12F104[$CellContext`tValue$$] + Normalize[
                  Derivative[
                  1][$CellContext`funcLTC12F104][$CellContext`tValue$$]]}, 
               0.04]], Black, 
             Text[
             "\!\(\*FormBox[\n StyleBox[\"T\",\nFontWeight->\"Bold\",\n\
FontSlant->\"Plain\"],\n TraditionalForm]\)", \
$CellContext`funcLTC12F104[$CellContext`tValue$$] + 1.5 Normalize[
                 Derivative[
                 1][$CellContext`funcLTC12F104][$CellContext`tValue$$]], {0, 
              0}]}, Black], 
...
$CellContext`funcLTC12F104[$CellContext`tValue$$] + Normalize[
                  ReplaceAll[
                   D[D[
                    $CellContext`funcLTC12F104[$CellContext`t], \
$CellContext`t]/Dot[
                    D[
                    $CellContext`funcLTC12F104[$CellContext`t], \
$CellContext`t], 
...
$CellContext`tValue$$]]}, 0.04]], Black, 
             Text[
             "\!\(\*FormBox[\n StyleBox[\"N\",\nFontWeight->\"Bold\",\n\
FontSlant->\"Plain\"],\n TraditionalForm]\)", \
$CellContext`funcLTC12F104[$CellContext`tValue$$] + 1.5 Normalize[
                 Derivative[
                 2][$CellContext`funcLTC12F104][$CellContext`tValue$$]], {0, 
              0}]}, Black], Black, 
           Point[
            $CellContext`funcLTC12F104[$CellContext`tValue$$]], 
           Text[
...
FontSlant->\"Plain\"]}], \"=\", \"0\"}],\n TraditionalForm]\).", {
             ...
             Background -> White], {
            0, $CellContext`yMax$$, $CellContext`zMax$$}, {1.5, 1}], 
           Text[
            Framed[
             Pane[
             "\!\(\*\nStyleBox[\"N\",\nFontWeight->\"Bold\"]\) points to the \
inside of the curve \[LongDash] in the direction the curve is turning.", {
              160, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], {0, 0, $CellContext`zMin$$}, {0, 2}]}], 
         ParametricPlot3D[
          $CellContext`funcLTC12F104[$CellContext`t], {$CellContext`t, \
...
TraditionalForm]\)"}, {True, False}, ControlType -> Checkbox, 
        ...
        Grid[{{
           Manipulate`Place[1]}, {
           Manipulate`Place[2]}}, Alignment -> Right], 
        Delimiter, {{$CellContext`tValue$$, 3.2, 
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -0.5, 4.8, 
         ControlType -> Slider, ImageSize -> 
         Small}, {{$CellContext`tValue$$, 3.2, ""}, -0.5, 4.8, ControlType -> 
        ...
        Row[{
          Manipulate`Place[3]}], {{$CellContext`xMin$$, -2}, 0, ControlType -> 
      ...
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, AppearanceElements -> 
        ...
        Style["FIGURE 12.104", "FigureFont", Smaller]}, 
      "DefaultOptions" :> {}],
...
$CellContext`PlaneGrids}, {$CellContext`opts}], 
         ...
         RGBColor[0.8, 0, 0.4], $CellContext`funcLTC12F104[
...
(*NotebookFileOutline
Notebook[{
Cell[593, 21, 20558, 422, 528, "Output"]
}
]
*)
...
(* NotebookSignature 1LNwGCbI3xOKAJkl4TH6Y7jt *)
