...
NotebookDataLength[     41207,        860]
NotebookOptionsPosition[     28800,        598]
NotebookOutlinePosition[     41300,        862]
CellTagsIndexPosition[     41257,        859]
WindowTitle->Section 12.4, Figure 12.58
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`showCrossProduct$$ = 
    ...
    1, $CellContext`uVector2$$ = 1, $CellContext`uVector3$$ = 
    0, $CellContext`vVector1$$ = 1, $CellContext`vVector2$$ = 
    1, $CellContext`vVector3$$ = 2^Rational[1, 2], $CellContext`xMax$$ = 
...
TraditionalForm],\n TraditionalForm]\)", Larger]}, -1.5, 1.5, 0.1}, {{
       ...
       "\!\(\*FormBox[SubscriptBox[\"v\", \"2\"],\n TraditionalForm]\)", 
        Larger]}, -1.5, 1.5, 0.1}, {{
       Hold[$CellContext`vVector3$$], 2^Rational[1, 2], 
       Style[
    ...
    Typeset`skipInitDone$$ = False, $CellContext`showCrossProduct$189224$$ = 
    False, $CellContext`showMagnitude$189225$$ = 
    False, $CellContext`showGrids$189226$$ = 
    False, $CellContext`showLabels$189227$$ = 
    False, $CellContext`uVector1$189228$$ = 
    0, $CellContext`uVector2$189229$$ = 0, $CellContext`uVector3$189230$$ = 
    0, $CellContext`vVector1$189231$$ = 0, $CellContext`vVector2$189232$$ = 
    0, $CellContext`vVector3$189233$$ = 0}, 
...
$CellContext`showCrossProduct$189224$$, False], 
        Hold[$CellContext`showMagnitude$$, \
$CellContext`showMagnitude$189225$$, False], 
        Hold[$CellContext`showGrids$$, $CellContext`showGrids$189226$$, 
         False], 
        Hold[$CellContext`showLabels$$, $CellContext`showLabels$189227$$, 
         False], 
        Hold[$CellContext`uVector1$$, $CellContext`uVector1$189228$$, 0], 
        Hold[$CellContext`uVector2$$, $CellContext`uVector2$189229$$, 0], 
        Hold[$CellContext`uVector3$$, $CellContext`uVector3$189230$$, 0], 
        Hold[$CellContext`vVector1$$, $CellContext`vVector1$189231$$, 0], 
        Hold[$CellContext`vVector2$$, $CellContext`vVector2$189232$$, 0], 
        Hold[$CellContext`vVector3$$, $CellContext`vVector3$189233$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`uVector2$$, $CellContext`uVector3$$}], {0, 1.5}], 
             Text[
              Framed[
              "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"v\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"=\", \n  RowBox[{\"\
...
$CellContext`vVector2$$, $CellContext`vVector3$$}], {0, -1.5}]}, 
...
$CellContext`zMax$$}}, BaseStyle -> {"Text", 13}, ViewPoint -> {6, 1, 2}, 
...
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"\[Cross]\", \n  \
StyleBox[\"v\",\nFontWeight->\"Bold\",\nFontSlant->\"Plain\"]}],\n \
TraditionalForm]\) is orthogonal to \!\(\*FormBox[\n StyleBox[\"u\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"],\n TraditionalForm]\) and \
\!\(\*FormBox[\n StyleBox[\"v\",\nFontWeight->\"Bold\",\n\
...
TraditionalForm]\)", {144, Automatic}, $CellContext`bcPBS], $CellContext`bcFO,
...
$CellContext`vVector3$$}])], 0.001], 0]]}}], 
        Delimiter, {{$CellContext`showGrids$$, False, "show grids"}, {
         ...
         True, False}, ControlType -> Checkbox}, {{$CellContext`uVector1$$, 1, 
          Style[
          "\!\(\*FormBox[SubscriptBox[\"u\", \"1\"],\n TraditionalForm]\)", 
           Larger]}, -1.5, 1.5, 0.1, ControlType -> None, 
         ImageSize -> {72, 20}}, {{$CellContext`uVector2$$, 1, 
          Style[
          "\!\(\*FormBox[SubscriptBox[\"u\", \"2\"],\n TraditionalForm]\)", 
           Larger]}, -1.5, 1.5, 0.1, ControlType -> None, 
...
TraditionalForm],\n TraditionalForm]\)", Larger]}, -1.5, 1.5, 0.1, 
         ControlType -> None, 
         ImageSize -> {72, 20}}, {{$CellContext`vVector1$$, 1, 
          Style[
          "\!\(\*FormBox[SubscriptBox[\"v\", \"1\"],\n TraditionalForm]\)", 
           Larger]}, -1.5, 1.5, 0.1, ControlType -> None, 
         ImageSize -> {72, 20}}, {{$CellContext`vVector2$$, 1, 
          Style[
          "\!\(\*FormBox[SubscriptBox[\"v\", \"2\"],\n TraditionalForm]\)", 
           Larger]}, -1.5, 1.5, 0.1, ControlType -> None, 
         ImageSize -> {72, 20}}, {{$CellContext`vVector3$$, 2^Rational[1, 2], 
      ...
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, AppearanceElements -> 
        ...
        Style["FIGURE 12.58", "FigureFont", Smaller]}, "DefaultOptions" :> {}],
     ImageSizeCache->{569., {252., 257.}},
...
(*NotebookFileOutline
Notebook[{
Cell[592, 21, 28204, 575, 526, "Output"]
}
]
*)
...
(* NotebookSignature 1KjG#LTxXIy05JOLBnJz3LoF *)
