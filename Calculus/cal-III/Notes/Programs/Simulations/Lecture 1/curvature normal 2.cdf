...
NotebookDataLength[     17935,        388]
NotebookOptionsPosition[      5472,        124]
NotebookOutlinePosition[     18029,        390]
CellTagsIndexPosition[     17986,        387]
WindowTitle->Section 12.9, Figure 12.103
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`tValue$$ = -1.98, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`tValue$$], -1.5, 
       "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -2, 2, 0.01}}, 
    Typeset`size$$ = {432., {105.5, 110.5}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`tValue$192153$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`tValue$$ = -1.5}, 
      "ControllerVariables" :> {
        Hold[$CellContext`tValue$$, $CellContext`tValue$192153$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Grid[{{
          ParametricPlot[
           Drop[
            $CellContext`funcLTC12F103[$CellContext`t], -1], {$CellContext`t, \
-2, 2}, PlotStyle -> {{Thick, Black}}, 
           PlotRange -> {{-2.5, 2.5}, {-0.5, 4.75}}, ImageSize -> 3 {72, 72}, 
           AxesStyle -> Arrowheads[{0, 0.05}], 
           AxesLabel -> {
            "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)", 
             "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, Ticks -> {
             Range[-2, 2, 1], 
             Range[-1, 4, 1]}, BaseStyle -> {"Text", 13}, Epilog -> {
             AbsolutePointSize[6], 
             Point[
              Drop[
               $CellContext`funcLTC12F103[$CellContext`tValue$$], -1]], \
$CellContext`bcR, 
             AbsoluteThickness[2], 
             Arrowheads[0.06], 
             Arrow[{
               Drop[
                $CellContext`funcLTC12F103[$CellContext`tValue$$], -1], Drop[
                 $CellContext`funcLTC12F103[$CellContext`tValue$$], -1] + 
               Normalize[
                 Drop[
                  Derivative[
                  1][$CellContext`funcLTC12F103][$CellContext`tValue$$], \
-1]]}]}], 
          ParametricPlot[{$CellContext`t, Norm[
              Cross[
               Derivative[2][$CellContext`funcLTC12F103][$CellContext`t], 
               Derivative[1][$CellContext`funcLTC12F103][$CellContext`t]]]/
            Norm[
              Derivative[
              1][$CellContext`funcLTC12F103][$CellContext`t]]^3}, \
{$CellContext`t, -2, 2}, PlotStyle -> {{Thick, $CellContext`bcB}}, 
           PlotRange -> {{-2.5, 2.5}, {-0.5, 4.75}}, ImageSize -> 3 {72, 72}, 
           AxesStyle -> Arrowheads[{0, 0.05}], 
           AxesLabel -> {
            "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)", 
           ...
           Ticks -> {
             ...
             Point[{$CellContext`tValue$$, Norm[
                 Cross[
                  Derivative[
                  2][$CellContext`funcLTC12F103][$CellContext`tValue$$], 
                  Derivative[
                  1][$CellContext`funcLTC12F103][$CellContext`tValue$$]]]/Norm[
                 Derivative[
                 1][$CellContext`funcLTC12F103][$CellContext`tValue$$]]^3}]}]}\
}, Spacings -> 0], 
      "Specifications" :> {{{$CellContext`tValue$$, -1.5, 
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -2, 2, 0.01, 
      ...
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, Deployed -> True, 
        ...
        Style["FIGURE 12.103", "FigureFont", Smaller]}, 
      "DefaultOptions" :> {}],
     ImageSizeCache->{597., {146., 151.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>({{$CellContext`funcLTC12F103[
           Pattern[$CellContext`t, 
            Blank[]]] := {$CellContext`t, $CellContext`t^2, 0}, $CellContext`t[
...
(*NotebookFileOutline
Notebook[{
Cell[593, 21, 4875, 101, 314, "Output"]
}
]
*)
...
(* NotebookSignature HJNAuigCWriZdKO9sAvrOpwd *)
