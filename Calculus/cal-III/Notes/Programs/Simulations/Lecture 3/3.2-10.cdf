...
NotebookDataLength[    167462,       3105]
NotebookOptionsPosition[    134798,       2347]
NotebookOutlinePosition[    168236,       3117]
CellTagsIndexPosition[    168193,       3114]
WindowTitle->Section 13.2, Figure 13.10
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0.8417, $CellContext`bValue$$ = 
     4.1583, $CellContext`delta$$ = False, $CellContext`showGrids$$ = 
     False, $CellContext`showVolume$$ = False, $CellContext`xDivisions$$ = 
     ...
     0, $CellContext`yStart$$ = 0.8, $CellContext`zMax$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xDivisions$212246$$ = 
     0, $CellContext`yDivisions$212247$$ = 0, $CellContext`delta$212248$$ = 
     False, $CellContext`showVolume$212249$$ = 
     False, $CellContext`showGrids$212250$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0.8417, $CellContext`bValue$$ = 
         4.1583, $CellContext`delta$$ = False, $CellContext`showGrids$$ = 
         False, $CellContext`showVolume$$ = True, $CellContext`xDivisions$$ = 
         8, $CellContext`xEnd$$ = 4.3, $CellContext`xMax$$ = 
         5, $CellContext`xMin$$ = 0, $CellContext`xStart$$ = 
         0.7, $CellContext`yDivisions$$ = 13, $CellContext`yEnd$$ = 
         4.2, $CellContext`yMax$$ = 5, $CellContext`yMin$$ = 
         ...
         Hold[$CellContext`xDivisions$$, $CellContext`xDivisions$212246$$, 0], 
         Hold[$CellContext`yDivisions$$, $CellContext`yDivisions$212247$$, 0], 
         Hold[$CellContext`delta$$, $CellContext`delta$212248$$, False], 
         Hold[$CellContext`showVolume$$, $CellContext`showVolume$212249$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$212250$$, 
          False]}, 
       "OtherVariables" :> {
...
$CellContext`yStart$$)/$CellContext`yDivisions$$), {$CellContext`i, 
             0, $CellContext`yDivisions$$ + 1}]; If[
           Not[$CellContext`delta$$], $CellContext`showVolume$$ = False]; 
         Show[{
...
$CellContext`aValue$$, 
                   ...
                   Part[$CellContext`yPartition$, $CellContext`j] > Max[
                    $CellContext`funcC13F10a[
                    Part[$CellContext`xPartition$, $CellContext`i]], 
                    $CellContext`funcC13F10a[
                    Part[$CellContext`xPartition$, $CellContext`i + 1]]], 
                   Part[$CellContext`yPartition$, $CellContext`j + 1] < Min[
                    $CellContext`funcC13F10b[
                    Part[$CellContext`xPartition$, $CellContext`i]], 
                    $CellContext`funcC13F10b[
                    Part[$CellContext`xPartition$, $CellContext`i + 1]]]], 
                  Polygon[{{
                    Part[$CellContext`xPartition$, $CellContext`i], 
                    Part[$CellContext`yPartition$, $CellContext`j], 0}, {
                    Part[$CellContext`xPartition$, $CellContext`i + 1], 
                    Part[$CellContext`yPartition$, $CellContext`j], 0}, {
                    Part[$CellContext`xPartition$, $CellContext`i + 1], 
                    Part[$CellContext`yPartition$, $CellContext`j + 1], 0}, {
                    Part[$CellContext`xPartition$, $CellContext`i], 
                    Part[$CellContext`yPartition$, $CellContext`j + 1], 0}}], 
                  
                  
                  Darker[$CellContext`bcAreaPositiveColor]], {$CellContext`i, \
$CellContext`xDivisions$$}, {$CellContext`j, $CellContext`yDivisions$$}], 
                ...
                Table[
                 Line[{{
                    ...
                    Part[$CellContext`xPartition$, $CellContext`i], \
$CellContext`yStart$$, 0}, {
                    
                    Part[$CellContext`xPartition$, $CellContext`i], \
$CellContext`yEnd$$, 0}}], {$CellContext`i, $CellContext`xDivisions$$ + 1}], 
                Table[
                 Line[{{$CellContext`xStart$$, 
                    Part[$CellContext`yPartition$, $CellContext`i], 
                    0}, {$CellContext`xEnd$$, 
                    Part[$CellContext`yPartition$, $CellContext`i], 
                    0}}], {$CellContext`i, $CellContext`yDivisions$$ + 1}]}, 
               Black], 
              Text[
               Style["\!\(TraditionalForm\`R\)", Bold, Larger], {
               3.2, 3, 0}]}], 
            ParametricPlot3D[{{$CellContext`x, 
               $CellContext`funcC13F10a[$CellContext`x], 
               0}, {$CellContext`x, 
               $CellContext`funcC13F10b[$CellContext`x], 0}}, {$CellContext`x,
               0.8417, 4.1583}, 
             PlotStyle -> {{Thick, Black}}], $CellContext`plotC13F10, 
            If[$CellContext`delta$$, $CellContext`plotC13F10R, 
             Graphics3D[{}]], 
            If[$CellContext`showVolume$$, 
             Plot3D[
              $CellContext`funcC13F10[$CellContext`x, $CellContext`y], \
{$CellContext`x, 0, 5}, {$CellContext`y, 0, 5}, PlotStyle -> None, Filling -> 
              0, FillingStyle -> 
              Directive[{$CellContext`bcAreaPositiveColor, 
                 Opacity[0.8]}], Mesh -> None, RegionFunction -> 
              Function[{$CellContext`x, $CellContext`y, $CellContext`z}, 
                
                And[$CellContext`x >= 0.8417, $CellContext`x <= 4.1583, 
                 0.5 ($CellContext`x - 2)^2 + 
                  1 <= $CellContext`y <= (-0.5) ($CellContext`x - 3)^2 + 4]]], 
             Graphics3D[{}]]}, 
           PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
              1.5, $CellContext`zMax$$ + 0.5}}, ImageSize -> 6 {72, 72}, 
           BaseStyle -> {"Text", 13}, Lighting -> "Neutral", Boxed -> False, 
           ViewPoint -> {4, 1, 2}, Epilog -> {
             Inset[
              Framed[
               Pane[
               "\!\(TraditionalForm\`\(TraditionalForm\`Volume\\ of\\ solid = \
\(\*UnderscriptBox[\(\[Integral]\[Integral]\), \(R\)] \(f(x, y)\)\\ d\
\[VeryThinSpace]A = \*UnderscriptBox[\(lim\), \(\[CapitalDelta] \[Rule] \
0\)]\(\*UnderoverscriptBox[\(\[Sum]\), \(k = 1\), \(n\)]\(f(\(TraditionalForm\
\`\*SubsuperscriptBox[\(x\), \(k\), \(*\)]\), \
\(TraditionalForm\`\*SubsuperscriptBox[\(y\), \(k\), \(*\)]\))\) \
\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(A\), \(k\)]\)\)\)\)", \
...
{{$CellContext`yDivisions$$, 13, ""}, 2, 40, 1, ControlType -> Slider, 
         ...
         Delimiter, {{$CellContext`delta$$, False, 
          ...
          1}, {{$CellContext`showVolume$$, True, "show volume"}, {
          True, False}, ControlType -> Checkbox, Enabled :> 
          Dynamic[$CellContext`delta$$], ControlPlacement -> 2}, 
         Column[{
           Manipulate`Place[1], 
           Manipulate`Place[2]}, Alignment -> Right], 
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`i = 1, $CellContext`CoordinatePlane[
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`bcAreaPositiveColor = 
          RGBColor[
           0.796, 0.91, 
...
q4qm3Mo+j067MHc3zQrB/wEjdEYz
                "]}, {
               Automatic}]}}, $CellContext`funcC13F10a[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          0.5 ($CellContext`x - 2)^2 + 1, $CellContext`funcC13F10b[
            Pattern[$CellContext`x, 
             Blank[]]] := (-0.5) ($CellContext`x - 3)^2 + 
           4, $CellContext`plotC13F10 = Graphics3D[
            GraphicsComplex[CompressedData["
1:
             "], {{{
                EdgeForm[], 
                Opacity[0.8], 
...
1:
                   "]], 
                  Polygon[CompressedData["
1:
                   "]]}]}, {}, {}, {}, {}}, {{
                GrayLevel[0], 
                Line[CompressedData["
1:
                 
                 "]]}}}, VertexNormals -> CompressedData["
1:
n/vh/wDUjM16
              "]], {
            Axes -> True, BoxRatios -> {1, 1, 0.4}, 
             Method -> {"RotationControl" -> "Globe"}, 
             PlotRange -> {{0, 5}, {0, 5}, {2.209427878988917, 
               4.498724495262385}}, PlotRangePadding -> {
               Scaled[0.02], 
               Scaled[0.02], 
               Scaled[0.02]}}], 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`plotC13F10R = 
          Graphics3D[
            GraphicsComplex[CompressedData["
...
zjnnnHPOOef89QMvmKXu
            ...
            Axes -> True, 
             PlotRange -> {{0.8417002369, 4.1582997631}, {1.0003434021671984`,
               ...
               Scaled[0.02], 
               Scaled[0.02], 
               Scaled[0.02]}}], $CellContext`funcC13F10[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
          4.5 - 0.5 ($CellContext`x - 2)^2 - 
           0.5 ($CellContext`y - 3)^2, $CellContext`bcPBS = 
          BaseStyle -> {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.2, Figure 13.10"], "Header"]}, {
   Cell[
    TextData["Section 13.2, Figure 13.10"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 133519, 2314, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature TLj4KP7ik4qvSI#dXaxhY3EA *)
