...
NotebookDataLength[     64958,       1396]
NotebookOptionsPosition[     32296,        638]
NotebookOutlinePosition[     65734,       1408]
CellTagsIndexPosition[     65691,       1405]
WindowTitle->Section 13.5, Figure 13.59
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = 
     ...
     True, $CellContext`showRegion\[Theta]$$ = 
     False, $CellContext`showRegion\[Phi]$$ = False, $CellContext`xMax$$ = 
     5, $CellContext`xMin$$ = -5, $CellContext`yMax$$ = 
     5, $CellContext`yMin$$ = -5, $CellContext`zMax$$ = 
     5, $CellContext`zMin$$ = -1, $CellContext`\[Theta]End$$ = 
     1.0995574287564276`, $CellContext`\[Theta]Start$$ = 
     0.3141592653589793, $CellContext`\[Phi]End$$ = 
     1.0995574287564276`, $CellContext`\[Phi]Start$$ = 0.3141592653589793, 
     Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showRegionD$$], True, 
        "show region \!\(TraditionalForm\`\(TraditionalForm\`D\)\)"}, {
       True, False}}, {{
        Hold[$CellContext`showRegion\[Phi]$$], False, 
        Style[
        "\!\(TraditionalForm\`a \[LessEqual] \[Phi] \[LessEqual] b\)", 
         Larger]}, {True, False}}, {{
        Hold[$CellContext`showRegion\[Theta]$$], False, 
        Style[
        "\!\(TraditionalForm\`\[Alpha] \[LessEqual] \[Theta] \[LessEqual] \
\[Beta]\)", Larger]}, {True, False}}, {
       Hold[
        Grid[{{
           Manipulate`Place[1]}, {
           Manipulate`Place[2]}, {
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`\[Phi]Start$$], 0.3141592653589793, 
        "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0, 
       Rational[1, 2] Pi}, {{
        Hold[$CellContext`\[Phi]End$$], 1.0995574287564276`, 
        "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0, 
       Rational[1, 2] Pi}, {{
        Hold[$CellContext`\[Theta]Start$$], 0.3141592653589793, 
        Style["\[Alpha]", Larger]}, 0, Rational[1, 2] Pi}, {{
        Hold[$CellContext`\[Theta]End$$], 1.0995574287564276`, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showRegionD$215974$$ = 
     False, $CellContext`showRegion\[Phi]$215975$$ = 
     False, $CellContext`showRegion\[Theta]$215976$$ = 
     False, $CellContext`\[Phi]Start$215977$$ = 
     0, $CellContext`\[Phi]End$215978$$ = 
     0, $CellContext`\[Theta]Start$215979$$ = 
     0, $CellContext`\[Theta]End$215980$$ = 
     0, $CellContext`showLabels$215981$$ = 
     False, $CellContext`showGrids$215982$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = 
         ...
         1.0995574287564276`, $CellContext`\[Theta]Start$$ = 
         0.3141592653589793, $CellContext`\[Phi]End$$ = 
         1.0995574287564276`, $CellContext`\[Phi]Start$$ = 
         0.3141592653589793}, "ControllerVariables" :> {
         Hold[$CellContext`showRegionD$$, $CellContext`showRegionD$215974$$, 
          False], 
         Hold[$CellContext`showRegion\[Phi]$$, \
$CellContext`showRegion\[Phi]$215975$$, False], 
         Hold[$CellContext`showRegion\[Theta]$$, $CellContext`showRegion\
\[Theta]$215976$$, False], 
         Hold[$CellContext`\[Phi]Start$$, $CellContext`\[Phi]Start$215977$$, 
          0], 
         Hold[$CellContext`\[Phi]End$$, $CellContext`\[Phi]End$215978$$, 0], 
         Hold[$CellContext`\[Theta]Start$$, \
$CellContext`\[Theta]Start$215979$$, 0], 
         Hold[$CellContext`\[Theta]End$$, $CellContext`\[Theta]End$215980$$, 
          0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$215981$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$215982$$, 
          False]}, 
       "OtherVariables" :> {
       ...
       "Body" :> (
        If[$CellContext`\[Phi]Start$$ >= $CellContext`\[Phi]End$$ - 
           0.01, $CellContext`\[Phi]Start$$ = $CellContext`\[Phi]End$$ - 
           0.01]; If[$CellContext`\[Theta]Start$$ >= \
$CellContext`\[Theta]End$$ - 
           0.01, $CellContext`\[Theta]Start$$ = $CellContext`\[Theta]End$$ - 
           0.01]; Show[{
...
{$CellContext`xMax$$, 0, 0}, {-2, 0}], 
           ...
           If[$CellContext`showRegion\[Theta]$$, {
             
             ParametricPlot3D[{{($CellContext`u Sin[$CellContext`\[Phi]]) 
                Cos[$CellContext`\[Theta]Start$$], ($CellContext`u 
                 Sin[$CellContext`\[Phi]]) 
                Sin[$CellContext`\[Theta]Start$$], $CellContext`u 
                Cos[$CellContext`\[Phi]]}, {($CellContext`u 
                 Sin[$CellContext`\[Phi]]) 
                Cos[$CellContext`\[Theta]End$$], ($CellContext`u 
                 Sin[$CellContext`\[Phi]]) 
                Sin[$CellContext`\[Theta]End$$], $CellContext`u 
                Cos[$CellContext`\[Phi]]}}, {$CellContext`\[Phi], 0, Pi/
               2}, {$CellContext`u, 0, 5}, Mesh -> None, PlotStyle -> {{
                 Opacity[0.4], $CellContext`bcB}, {
                 Opacity[0.4], $CellContext`bcB}}, PlotPoints -> 10, 
              MaxRecursion -> 2], 
             Graphics3D[{
               If[$CellContext`showLabels$$, {
                 Text[
                 "\!\(TraditionalForm\`\[Theta] = \[Alpha]\)", 
                  5 {Sin[0.5 Pi] Cos[$CellContext`\[Theta]Start$$ - 0.05], 
                    Sin[0.5 Pi] Sin[$CellContext`\[Theta]Start$$ - 0.05], 
                    Cos[0.5 Pi]}, {0, 1.5}], 
                 Text[
                 "\!\(TraditionalForm\`\[Theta] = \[Beta]\)", 
                  5 {Sin[0.5 Pi] Cos[$CellContext`\[Theta]End$$ + 0.05], 
                    Sin[0.5 Pi] Sin[$CellContext`\[Theta]End$$ + 0.05], 
                    Cos[0.5 Pi]}, {0, 1.5}]}, Black]}]}, 
            Graphics3D[{}]], 
           If[$CellContext`showRegion\[Phi]$$, {
             ...
             ParametricPlot3D[{{($CellContext`u 
                ...
                Cos[$CellContext`\[Phi]Start$$]}, {($CellContext`u 
                 Sin[$CellContext`\[Phi]End$$]) 
                Cos[$CellContext`\[Theta]], ($CellContext`u 
                 Sin[$CellContext`\[Phi]End$$]) 
                Sin[$CellContext`\[Theta]], $CellContext`u 
                Cos[$CellContext`\[Phi]End$$]}}, {$CellContext`\[Theta], 0, 2 
               Pi}, {$CellContext`u, 0, 5}, Mesh -> None, PlotStyle -> {{
                 Opacity[0.4], $CellContext`bcG}, {
                 Opacity[0.4], $CellContext`bcG}}, PlotPoints -> 10, 
              MaxRecursion -> 2], 
             Graphics3D[{
               If[$CellContext`showLabels$$, {
                 Text[
                 "\!\(TraditionalForm\`\[Phi] = a\)", {(5 
                    Sin[$CellContext`\[Phi]Start$$]) 
                   Cos[Pi/2], (5 Sin[$CellContext`\[Phi]Start$$]) Sin[Pi/2], 
                   5 Cos[$CellContext`\[Phi]Start$$]}, {0, -1}], 
                 Text[
                 "\!\(TraditionalForm\`\[Phi] = b\)", {(5 
                    Sin[$CellContext`\[Phi]End$$]) 
                   Cos[Pi/2], (5 Sin[$CellContext`\[Phi]End$$]) Sin[Pi/2], 5 
                   Cos[$CellContext`\[Phi]End$$]}, {0, -1}]}, Black]}]}, 
            Graphics3D[{}]], 
           If[$CellContext`showRegionD$$, {
             
             ParametricPlot3D[{{(($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi]Start$$, $CellContext`\[Theta]] + \
(1 - $CellContext`u) $CellContext`funcC13F59h[$CellContext`\[Phi]Start$$, \
$CellContext`\[Theta]]) Sin[$CellContext`\[Phi]Start$$]) 
                Cos[$CellContext`\[Theta]], (($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi]Start$$, $CellContext`\[Theta]] + \
(1 - $CellContext`u) $CellContext`funcC13F59h[$CellContext`\[Phi]Start$$, \
$CellContext`\[Theta]]) Sin[$CellContext`\[Phi]Start$$]) 
...
$CellContext`\[Theta]]) 
                Cos[$CellContext`\[Phi]Start$$]}, {(($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi]End$$, $CellContext`\[Theta]] + (
                    1 - $CellContext`u) \
$CellContext`funcC13F59h[$CellContext`\[Phi]End$$, $CellContext`\[Theta]]) 
                 Sin[$CellContext`\[Phi]End$$]) 
                Cos[$CellContext`\[Theta]], (($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi]End$$, $CellContext`\[Theta]] + (
                    1 - $CellContext`u) \
$CellContext`funcC13F59h[$CellContext`\[Phi]End$$, $CellContext`\[Theta]]) 
                ...
                Sin[$CellContext`\[Theta]], ($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi]End$$, $CellContext`\[Theta]] + (
                   1 - $CellContext`u) $CellContext`funcC13F59h[$CellContext`\
\[Phi]End$$, $CellContext`\[Theta]]) 
                Cos[$CellContext`\[Phi]End$$]}}, {$CellContext`u, 0, 
               1}, {$CellContext`\[Theta], $CellContext`\[Theta]Start$$, \
$CellContext`\[Theta]End$$}, Mesh -> None, 
              PlotStyle -> {{$CellContext`bcAreaPositiveColor, 
                 Opacity[0.5]}, {$CellContext`bcAreaPositiveColor, 
                 Opacity[0.5]}}, PlotPoints -> 10, MaxRecursion -> 2], 
             
             ParametricPlot3D[{{(($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]Start$$] + \
(1 - $CellContext`u) $CellContext`funcC13F59h[$CellContext`\[Phi], \
$CellContext`\[Theta]Start$$]) Sin[$CellContext`\[Phi]]) 
                Cos[$CellContext`\[Theta]Start$$], (($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]Start$$] + \
(1 - $CellContext`u) $CellContext`funcC13F59h[$CellContext`\[Phi], \
$CellContext`\[Theta]Start$$]) Sin[$CellContext`\[Phi]]) 
...
$CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]Start$$] + \
(1 - $CellContext`u) $CellContext`funcC13F59h[$CellContext`\[Phi], \
$CellContext`\[Theta]Start$$]) 
                Cos[$CellContext`\[Phi]]}, {(($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]End$$] + (
                    1 - $CellContext`u) \
$CellContext`funcC13F59h[$CellContext`\[Phi], $CellContext`\[Theta]End$$]) 
                 Sin[$CellContext`\[Phi]]) 
                Cos[$CellContext`\[Theta]End$$], (($CellContext`u \
$CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]End$$] + (
                    1 - $CellContext`u) \
...
$CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]End$$] + (
                   1 - $CellContext`u) $CellContext`funcC13F59h[$CellContext`\
\[Phi], $CellContext`\[Theta]End$$]) 
                Cos[$CellContext`\[Phi]]}}, {$CellContext`u, 0, 
               1}, {$CellContext`\[Phi], $CellContext`\[Phi]Start$$, \
$CellContext`\[Phi]End$$}, Mesh -> None, 
              PlotStyle -> {{$CellContext`bcAreaPositiveColor, 
                 Opacity[0.5]}, {$CellContext`bcAreaPositiveColor, 
                 Opacity[0.5]}}, PlotPoints -> 10, MaxRecursion -> 2], 
             
             ParametricPlot3D[{{($CellContext`funcC13F59g[$CellContext`\[Phi],\
 $CellContext`\[Theta]] Sin[$CellContext`\[Phi]]) 
                Cos[$CellContext`\[Theta]], \
($CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]] 
                 Sin[$CellContext`\[Phi]]) 
                Sin[$CellContext`\[Theta]], \
$CellContext`funcC13F59g[$CellContext`\[Phi], $CellContext`\[Theta]] 
                Cos[$CellContext`\[Phi]]}, \
{($CellContext`funcC13F59h[$CellContext`\[Phi], $CellContext`\[Theta]] 
                 Sin[$CellContext`\[Phi]]) 
                Cos[$CellContext`\[Theta]], \
($CellContext`funcC13F59h[$CellContext`\[Phi], $CellContext`\[Theta]] 
                 Sin[$CellContext`\[Phi]]) 
...
$CellContext`\[Phi]Start$$, $CellContext`\[Phi]End$$}, \
{$CellContext`\[Theta], $CellContext`\[Theta]Start$$, \
$CellContext`\[Theta]End$$}, Mesh -> None, PlotStyle -> {{
                 Opacity[0.7], $CellContext`bcB, 
                 Specularity[White, 100]}, {
                 Opacity[0.7], $CellContext`bcSurfaceTop, 
                 Specularity[White, 100]}}, PlotPoints -> 10, MaxRecursion -> 
              2], 
             Graphics3D[{
               If[$CellContext`showLabels$$, {
                 Text[
                 "\!\(TraditionalForm\`\[Rho] = h(\[Phi], \[Theta])\)", {(5 
                    Sin[($CellContext`\[Phi]Start$$ + \
$CellContext`\[Phi]End$$)/2]) 
                   Cos[$CellContext`\[Theta]End$$], (5 
                    Sin[($CellContext`\[Phi]Start$$ + \
$CellContext`\[Phi]End$$)/2]) Sin[$CellContext`\[Theta]End$$], 5 
                   Cos[($CellContext`\[Phi]Start$$ + \
$CellContext`\[Phi]End$$)/2]}, {-1, -1}], 
                 Text[
                 "\!\(TraditionalForm\`D\)", {(5 
                    Sin[$CellContext`\[Phi]End$$]) 
                   Cos[$CellContext`\[Theta]Start$$ + 0.2], (5 
                    Sin[$CellContext`\[Phi]End$$]) 
                   Sin[$CellContext`\[Theta]Start$$ + 0.2], 5 
                   Cos[$CellContext`\[Phi]End$$]}, {0, -1}], 
                 Text[
                 "\!\(TraditionalForm\`\[Rho] = g(\[Phi], \[Theta])\)", 
                  2 {(1 Sin[($CellContext`\[Phi]Start$$ + \
$CellContext`\[Phi]End$$)/2]) 
                    Cos[$CellContext`\[Theta]Start$$ - 0.5], (1 
                    Sin[($CellContext`\[Phi]Start$$ + \
$CellContext`\[Phi]End$$)/2]) Sin[$CellContext`\[Theta]Start$$ - 0.5], 1 
                    
                    Cos[($CellContext`\[Phi]Start$$ + \
$CellContext`\[Phi]End$$)/2]}, {1, 1}]}, Black]}]}, 
            Graphics3D[{}]]}, 
          PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$}}, ImageSize -> 6 {72, 72}, BaseStyle -> {"Text", 13}, 
          ...
          Epilog -> {
            If[$CellContext`showLabels$$, 
             Inset[
              Framed[
               Pane[
               " \!\(TraditionalForm\`g(\[Phi], \[Theta]) \[LessEqual] \[Rho] \
\[LessEqual] h(\[Phi], \[Theta])\)", $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> White], 
              ImageScaled[{0.5, 0.01}], 
              ImageScaled[{0.5, 0.01}]], Black]}]), 
       "Specifications" :> {{{$CellContext`showRegionD$$, True, 
           "show region \!\(TraditionalForm\`\(TraditionalForm\`D\)\)"}, {
          True, False}, ControlType -> Checkbox, ControlPlacement -> 
          1}, {{$CellContext`showRegion\[Phi]$$, False, 
           Style[
           "\!\(TraditionalForm\`a \[LessEqual] \[Phi] \[LessEqual] b\)", 
            Larger]}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 
          2}, {{$CellContext`showRegion\[Theta]$$, False, 
           Style[
           "\!\(TraditionalForm\`\[Alpha] \[LessEqual] \[Theta] \[LessEqual] \
\[Beta]\)", Larger]}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 3}, 
         Grid[{{
            Manipulate`Place[1]}, {
            Manipulate`Place[2]}, {
            Manipulate`Place[3]}}, Alignment -> Right], 
         Delimiter, {{$CellContext`\[Phi]Start$$, 0.3141592653589793, 
           "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0, 
          Rational[1, 2] Pi, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`\[Phi]End$$, 1.0995574287564276`, 
           "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0, 
          Rational[1, 2] Pi, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`\[Theta]Start$$, 0.3141592653589793, 
           Style["\[Alpha]", Larger]}, 0, Rational[1, 2] Pi, ControlType -> 
          Slider, ImageSize -> 
          Small}, {{$CellContext`\[Theta]End$$, 1.0995574287564276`, 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0, 0.6, 0.4], $CellContext`funcC13F59g[
            Pattern[$CellContext`\[Phi], 
             Blank[]], 
            Pattern[$CellContext`\[Theta], 
             Blank[]]] := 
          2.5 + 0.7 Cos[4 $CellContext`\[Phi]], $CellContext`funcC13F59h[
            Pattern[$CellContext`\[Phi], 
             Blank[]], 
            Pattern[$CellContext`\[Theta], 
             Blank[]]] := 
          4.5 + 0.5 
            Sin[(-4) $CellContext`\[Theta]], $CellContext`bcAreaPositiveColor = 
          RGBColor[0.796, 0.91, 0.855], $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.59"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.59"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 31017, 605, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature mLj#dWSxiUeRNJ5cnnqOkd9@ *)
