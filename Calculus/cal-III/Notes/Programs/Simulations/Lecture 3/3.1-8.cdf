...
NotebookDataLength[     56777,       1265]
NotebookOptionsPosition[     24115,        507]
NotebookOutlinePosition[     57553,       1277]
CellTagsIndexPosition[     57510,       1274]
WindowTitle->Section 13.1, Figure 13.08
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
     2, $CellContext`cValue$$ = 0, $CellContext`dValue$$ = 
     2, $CellContext`showAvg$$ = True, $CellContext`showGrids$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showAvg$$], True, "show average value"}, {
       True, False}}, {
       Hold[
       "region \!\(\*\nStyleBox[FormBox[\n  RowBox[{\"R\", \" \"}],\n  \
TraditionalForm],\nFontSlant->\"Italic\"]\) "], 
       ...
       Rational[12, 5], 
       Rational[1, 10]}, {{
        Hold[$CellContext`dValue$$], 2, 
        "\!\(\*\nStyleBox[\"d\",\nFontSlant->\"Italic\"]\)"}, 
       Rational[-12, 5], 
       Rational[5, 2], 
       Rational[1, 10]}, {
       Hold[
        Column[{"\!\(TraditionalForm\`a \[LessEqual] x \[LessEqual] b\)", 
          Manipulate`Place[1], 
          Manipulate`Place[2], 
          "\!\(TraditionalForm\`c \[LessEqual] y \[LessEqual] d\)", 
          Manipulate`Place[3], 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showAvg$212001$$ = 
     False, $CellContext`aValue$212002$$ = 0, $CellContext`bValue$212003$$ = 
     0, $CellContext`cValue$212004$$ = 0, $CellContext`dValue$212005$$ = 
     0, $CellContext`showSurface$212006$$ = 
     False, $CellContext`showGrids$212007$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
         ...
         Hold[$CellContext`showAvg$$, $CellContext`showAvg$212001$$, False], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$212002$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$212003$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$212004$$, 0], 
         Hold[$CellContext`dValue$$, $CellContext`dValue$212005$$, 0], 
         Hold[$CellContext`showSurface$$, $CellContext`showSurface$212006$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$212007$$, 
          False]}, 
       "OtherVariables" :> {
       ...
       Module[{$CellContext`avg$}, $CellContext`avg$ = ((((-(1/
                2)) ($CellContext`aValue$$ - $CellContext`bValue$$)) \
($CellContext`cValue$$ - $CellContext`dValue$$)) (-4 + $CellContext`aValue$$ + \
$CellContext`bValue$$ + $CellContext`cValue$$ + \
$CellContext`dValue$$))/(($CellContext`bValue$$ - $CellContext`aValue$$) \
($CellContext`dValue$$ - $CellContext`cValue$$)); 
         If[$CellContext`aValue$$ >= $CellContext`bValue$$ - 
            0.1, $CellContext`aValue$$ = 
           Round[$CellContext`bValue$$ - 0.1, 0.1]]; 
         If[$CellContext`cValue$$ >= $CellContext`dValue$$ - 
            0.1, $CellContext`cValue$$ = 
           Round[$CellContext`dValue$$ - 0.1, 0.1]]; Show[{
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
            ...
            Graphics3D[{$CellContext`bcB, 
              ...
              Polygon[{{$CellContext`aValue$$, $CellContext`cValue$$, 
                 0.001}, {$CellContext`aValue$$, $CellContext`dValue$$, 
                 0.001}, {$CellContext`bValue$$, $CellContext`dValue$$, 
                 0.001}, {$CellContext`bValue$$, $CellContext`cValue$$, 0}}], 
              
              If[$CellContext`showAvg$$, {Black, 
                Opacity[1], 
                Text[
                 Framed[
                  
                  Row[{"\!\(TraditionalForm\`\(\*OverscriptBox[\(f\), \
\(_\)]\(=\)\(\\ \)\)\)", 
                    Round[$CellContext`avg$, 0.01]}], $CellContext`bcFO, 
                  Background -> 
                  White], {$CellContext`bValue$$, $CellContext`dValue$$, \
$CellContext`avg$}, {-1.5, 0}], $CellContext`bcR, 
                Opacity[0.2], 
                EdgeForm[None], 
                
                Cuboid[{{$CellContext`aValue$$, $CellContext`cValue$$, 
                   0}, {$CellContext`bValue$$, $CellContext`dValue$$, \
$CellContext`avg$}}], 
                EdgeForm[Black], 
                Opacity[1], 
                Arrowheads[0.03], 
                If[Abs[$CellContext`avg$] > 0.3, 
                 Arrow[
                  
                  Tube[{{$CellContext`bValue$$, $CellContext`dValue$$, 
                    0}, {$CellContext`bValue$$, $CellContext`dValue$$, \
$CellContext`avg$}}]], $CellContext`bcR], 
                Opacity[0.5], 
                
                Polygon[{{$CellContext`aValue$$, $CellContext`cValue$$, \
$CellContext`avg$}, {$CellContext`aValue$$, $CellContext`dValue$$, \
$CellContext`avg$}, {$CellContext`bValue$$, $CellContext`dValue$$, \
$CellContext`avg$}, {$CellContext`bValue$$, $CellContext`cValue$$, \
$CellContext`avg$}}]}, Black]}], 
            If[$CellContext`showSurface$$, 
             Plot3D[
              $CellContext`funcC13F08[$CellContext`x, $CellContext`y], \
{$CellContext`x, $CellContext`aValue$$, $CellContext`bValue$$}, \
{$CellContext`y, $CellContext`cValue$$, $CellContext`dValue$$}, Mesh -> None, 
              Filling -> 0, FillingStyle -> {{$CellContext`bcG, 
                 Opacity[0.2]}, {$CellContext`bcG, 
                 Opacity[0.2]}}, PlotStyle -> {{$CellContext`bcSurfaceTop, 
                 Opacity[0.8], 
                 Specularity[White, 100]}}], 
             Graphics3D[{}]]}, Lighting -> "Neutral", ImageSize -> 6 {72, 72},
            Boxed -> False, BaseStyle -> {"Text", 13}, 
           ViewPoint -> {4, 2.5, 2}, 
           PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$}}, Epilog -> {
             Inset[
             "\!\(TraditionalForm\`f(x, y) = 2 - x - y\)", {Center, Top}, {
              Center, Top}], 
             Inset[
              Row[{
                $CellContext`DisplayNumber[
                 Round[$CellContext`aValue$$, 0.1]], 
                "\!\(TraditionalForm\`\(\(\[LessEqual]\)\(x\)\(\[LessEqual]\)\
\(\\ \)\)\)", 
                $CellContext`DisplayNumber[
             ...
             Inset[
              Row[{
                $CellContext`DisplayNumber[
                 Round[$CellContext`cValue$$, 0.1]], 
                "\!\(TraditionalForm\`\(\(\[LessEqual]\)\(y\)\(\[LessEqual]\)\
\(\\ \)\)\)", 
                $CellContext`DisplayNumber[
                 Round[$CellContext`dValue$$, 0.1]]}], 
              Scaled[{0, 0.85}], {-1, 1.5}]}]], 
       "Specifications" :> {{{$CellContext`showAvg$$, True, 
           "show average value"}, {True, False}, ControlType -> Checkbox}, 
         Delimiter, 
         "region \!\(\*\nStyleBox[FormBox[\n  RowBox[{\"R\", \" \"}],\n  \
TraditionalForm],\nFontSlant->\"Italic\"]\) ", {{$CellContext`aValue$$, 0, 
           "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 
          Rational[-5, 2], 
          Rational[12, 5], 
          Rational[1, 10], ControlType -> Slider, ImageSize -> Small, 
          ControlPlacement -> 
          1}, {{$CellContext`bValue$$, 2, 
           "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 
          Rational[-12, 5], 
          Rational[5, 2], 
          Rational[1, 10], ControlType -> Slider, ImageSize -> Small, 
          ControlPlacement -> 
          2}, {{$CellContext`cValue$$, 0, 
           "\!\(\*\nStyleBox[\"c\",\nFontSlant->\"Italic\"]\)"}, 
          Rational[-5, 2], 
          Rational[12, 5], 
          Rational[1, 10], ControlType -> Slider, ImageSize -> Small, 
          ControlPlacement -> 
          3}, {{$CellContext`dValue$$, 2, 
           "\!\(\*\nStyleBox[\"d\",\nFontSlant->\"Italic\"]\)"}, 
          Rational[-12, 5], 
          Rational[5, 2], 
          Rational[1, 10], ControlType -> Slider, ImageSize -> Small, 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0.8, 0, 0.4], $CellContext`funcC13F08[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
          2 - $CellContext`x - $CellContext`y, $CellContext`bcG = 
          RGBColor[0, 0.6, 0.4], $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.1, Figure 13.08"], "Header"]}, {
   Cell[
    TextData["Section 13.1, Figure 13.08"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 22836, 474, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 1KznsoNKNvegWIkiqAPUx4PZ *)
