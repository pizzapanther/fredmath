...
NotebookDataLength[     59199,       1291]
NotebookOptionsPosition[     26537,        533]
NotebookOutlinePosition[     59975,       1303]
CellTagsIndexPosition[     59932,       1300]
WindowTitle->Section 13.5, Figure 13.50
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`deltaR$$ = 0.7, $CellContext`deltaZ$$ = 
     0.5, $CellContext`delta\[Theta]$$ = 1, $CellContext`rStart$$ = 
     1, $CellContext`showGrids$$ = False, $CellContext`showLabels$$ = 
     True, $CellContext`xMax$$ = 2, $CellContext`xMin$$ = 
     0, $CellContext`yMax$$ = 2, $CellContext`yMin$$ = 
     0, $CellContext`zMax$$ = 2, $CellContext`zMin$$ = 
     0, $CellContext`zStart$$ = 1, $CellContext`\[Theta]Start$$ = 
     Rational[1, 12] Pi, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
     Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`rStart$$], 1, "\!\(TraditionalForm\`r\)"}, 0.1, 
       1}, {{
        Hold[$CellContext`deltaR$$], 0.7, 
        "\!\(TraditionalForm\`\[CapitalDelta]\\ r\)"}, 0.1, 1}, {{
        Hold[$CellContext`delta\[Theta]$$], 1, 
        "\!\(TraditionalForm\`\[CapitalDelta]\\ \[Theta]\)"}, 0.1, 1}, {{
        Hold[$CellContext`deltaZ$$], 0.5, 
        "\!\(TraditionalForm\`\[CapitalDelta]\\ z\)"}, 0.1, 1}, {{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`rStart$$], 1}, 0}, {{
        Hold[$CellContext`\[Theta]Start$$], Rational[1, 12] Pi}, 0}, {{
        Hold[$CellContext`zStart$$], 1}, 0}}, Typeset`size$$ = {
     432., {213., 219.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`rStart$215094$$ = 
     0, $CellContext`deltaR$215095$$ = 
     0, $CellContext`delta\[Theta]$215096$$ = 
     0, $CellContext`deltaZ$215097$$ = 0, $CellContext`showLabels$215098$$ = 
     False, $CellContext`showGrids$215099$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`deltaR$$ = 0.7, $CellContext`deltaZ$$ = 
         0.5, $CellContext`delta\[Theta]$$ = 1, $CellContext`rStart$$ = 
         1, $CellContext`showGrids$$ = False, $CellContext`showLabels$$ = 
         True, $CellContext`xMax$$ = 2, $CellContext`xMin$$ = 
         0, $CellContext`yMax$$ = 2, $CellContext`yMin$$ = 
         ...
         Hold[$CellContext`rStart$$, $CellContext`rStart$215094$$, 0], 
         Hold[$CellContext`deltaR$$, $CellContext`deltaR$215095$$, 0], 
         Hold[$CellContext`delta\[Theta]$$, \
$CellContext`delta\[Theta]$215096$$, 0], 
         Hold[$CellContext`deltaZ$$, $CellContext`deltaZ$215097$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$215098$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$215099$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {-2, 0}], 
          ...
          ParametricPlot3D[{{$CellContext`r 
             ...
             Sin[$CellContext`\[Theta]], $CellContext`zStart$$}, \
{$CellContext`r Cos[$CellContext`\[Theta]], $CellContext`r 
             Sin[$CellContext`\[Theta]], $CellContext`zStart$$ + \
$CellContext`deltaZ$$}}, {$CellContext`r, $CellContext`rStart$$, \
$CellContext`rStart$$ + $CellContext`deltaR$$}, {$CellContext`\[Theta], \
...
$CellContext`delta\[Theta]$$}, Mesh -> None, PlotStyle -> {{
          ...
          ParametricPlot3D[{{$CellContext`r 
             Cos[$CellContext`\[Theta]Start$$], $CellContext`r 
             Sin[$CellContext`\[Theta]Start$$], $CellContext`u \
$CellContext`zStart$$ + (
               1 - $CellContext`u) ($CellContext`zStart$$ + \
$CellContext`deltaZ$$)}, {$CellContext`r 
             Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`r 
             Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`u $CellContext`zStart$$ + (
               1 - $CellContext`u) ($CellContext`zStart$$ + \
$CellContext`deltaZ$$)}}, {$CellContext`r, $CellContext`rStart$$, \
$CellContext`rStart$$ + $CellContext`deltaR$$}, {$CellContext`u, 0, 1}, Mesh -> 
           None, PlotStyle -> {{
              Opacity[0.4], $CellContext`bcB, 
              Specularity[White, 100]}}], 
          
          ParametricPlot3D[{{$CellContext`rStart$$ 
             Cos[$CellContext`\[Theta]], $CellContext`rStart$$ 
             Sin[$CellContext`\[Theta]], $CellContext`u $CellContext`zStart$$ + \
(1 - $CellContext`u) ($CellContext`zStart$$ + $CellContext`deltaZ$$)}, \
{($CellContext`rStart$$ + $CellContext`deltaR$$) 
             Cos[$CellContext`\[Theta]], ($CellContext`rStart$$ + \
$CellContext`deltaR$$) 
             Sin[$CellContext`\[Theta]], $CellContext`u $CellContext`zStart$$ + \
(1 - $CellContext`u) ($CellContext`zStart$$ + $CellContext`deltaZ$$)}}, \
{$CellContext`\[Theta], $CellContext`\[Theta]Start$$, \
$CellContext`\[Theta]Start$$ + $CellContext`delta\[Theta]$$}, {$CellContext`u,
             0, 1}, Mesh -> None, PlotStyle -> {{
              Opacity[0.4], $CellContext`bcB, 
              Specularity[White, 100]}}], 
          Graphics3D[{
...
{($CellContext`rStart$$ + $CellContext`deltaR$$/2) 
                Cos[$CellContext`\[Theta]Start$$], ($CellContext`rStart$$ + \
$CellContext`deltaR$$/2) 
                Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$}, {
               0, 1.5}], 
              Text[
              "\!\(TraditionalForm\`r\)", {($CellContext`rStart$$/2) 
                Cos[$CellContext`\[Theta]Start$$], ($CellContext`rStart$$/2) 
                Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$}, {
               0, 1.5}], 
              Text[
              "\!\(TraditionalForm\`\[CapitalDelta]\\ z\)", \
{($CellContext`rStart$$ + $CellContext`deltaR$$ + 0.2) 
                Cos[$CellContext`\[Theta]Start$$], ($CellContext`rStart$$ + \
$CellContext`deltaR$$ + 0.2) 
                Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$ + \
$CellContext`deltaZ$$/2}, {0, 0}], 
              Text[
              "\!\(TraditionalForm\`\[CapitalDelta]\\ \[Theta]\)", {
               0.1 Cos[$CellContext`\[Theta]Start$$], 0.1 
                Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$}, {
               0, -2}], 
              Text[
              "\!\(TraditionalForm\`\((\(TraditionalForm\`\*SubsuperscriptBox[\
\(r\), \(k\), \(*\)]\), \(TraditionalForm\`\*SubsuperscriptBox[\(\[Theta]\), \
\(k\), \(*\)]\), \(TraditionalForm\`\*SubsuperscriptBox[\(z\), \(k\), \
\(*\)]\))\)\)", {($CellContext`rStart$$ + $CellContext`deltaR$$ + 0.2) 
                Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/
                   2], ($CellContext`rStart$$ + $CellContext`deltaR$$ + 0.2) 
                Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/
                   2], $CellContext`zStart$$ + $CellContext`deltaZ$$ + 
                0.1}, {-1, -1}], 
              
              Line[{{($CellContext`rStart$$ + $CellContext`deltaR$$ + 0.2) 
                 Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/
                    2], ($CellContext`rStart$$ + $CellContext`deltaR$$ + 0.2) 
                 Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/
                    2], $CellContext`zStart$$ + $CellContext`deltaZ$$ + 
                 0.1}, {($CellContext`rStart$$ + $CellContext`deltaR$$/2) 
                 Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/
                    2], ($CellContext`rStart$$ + $CellContext`deltaR$$/2) 
                 Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/
                    2], $CellContext`zStart$$ + $CellContext`deltaZ$$/2}}], 
              Text[
              "\!\(TraditionalForm\`Base\\ area \[TildeTilde] \
\(\*SubsuperscriptBox[\(r\), \(k\), \(*\)] \(\[CapitalDelta]\)\(\
\[VeryThinSpace]\)\(r\)\(\\ \)\(\[CapitalDelta]\)\(\[VeryThinSpace]\)\(\
\[Theta]\)\(\\ \)\)\)", {($CellContext`rStart$$ + 0.8 $CellContext`deltaR$$) 
                Cos[$CellContext`\[Theta]Start$$], ($CellContext`rStart$$ + 
                 0.8 $CellContext`deltaR$$) 
                Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$ - 
                0.2}, {-1, 1}], 
              
              Line[{{($CellContext`rStart$$ + 0.8 $CellContext`deltaR$$) 
                 Cos[$CellContext`\[Theta]Start$$], ($CellContext`rStart$$ + 
                  0.8 $CellContext`deltaR$$) 
                 Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$ - 
                 0.2}, {($CellContext`rStart$$ + 0.7 $CellContext`deltaR$$) 
                 Cos[$CellContext`\[Theta]Start$$ + 
                   0.3 $CellContext`delta\[Theta]$$], ($CellContext`rStart$$ + 
                  0.7 $CellContext`deltaR$$) 
                 Sin[$CellContext`\[Theta]Start$$ + 
                   0.3 $CellContext`delta\[Theta]$$], \
$CellContext`zStart$$}}]}, Black], Black, 
            AbsolutePointSize[6], 
            
            Point[{($CellContext`rStart$$ + $CellContext`deltaR$$/2) 
              Cos[$CellContext`\[Theta]Start$$ + $CellContext`delta\[Theta]$$/
                 2], ($CellContext`rStart$$ + $CellContext`deltaR$$/2) 
              Sin[$CellContext`\[Theta]Start$$ + $CellContext`delta\[Theta]$$/
                 2], $CellContext`zStart$$ + $CellContext`deltaZ$$/2}], 
            Dashed, 
            AbsoluteThickness[1], Black, 
            
            Line[{{$CellContext`rStart$$ 
               Cos[$CellContext`\[Theta]Start$$], $CellContext`rStart$$ 
               Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$ + \
$CellContext`deltaZ$$}, {
              0, 0, $CellContext`zStart$$ + $CellContext`deltaZ$$}, \
{$CellContext`rStart$$ 
               Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`rStart$$ 
               Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`zStart$$ + \
$CellContext`deltaZ$$}}], 
            
            Line[{{$CellContext`rStart$$ 
               Cos[$CellContext`\[Theta]Start$$], $CellContext`rStart$$ 
               Sin[$CellContext`\[Theta]Start$$], $CellContext`zStart$$}, {
              0, 0, $CellContext`zStart$$}, {$CellContext`rStart$$ 
               Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`rStart$$ 
               Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`zStart$$}}]}]}, 
...
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
         ...
         ViewPoint -> {2, -5, 1.5}, Epilog -> {
           Inset[
            Framed[
             Pane[
             "Approximate volume\!\(TraditionalForm\`\(\(\\ \)\(\
\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(V\), \(k\)] \[TildeTilde] \
\*SubsuperscriptBox[\(r\), \(k\), \(*\)] \[CapitalDelta]\[VeryThinSpace]r\\ \
\[CapitalDelta]\[VeryThinSpace]\[Theta]\\ \
\[CapitalDelta]\[VeryThinSpace]z\)\)\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> White], 
            ImageScaled[{0.01, 0.01}], 
            ImageScaled[{0.01, 0.01}]]}], 
       "Specifications" :> {{{$CellContext`rStart$$, 1, 
           "\!\(TraditionalForm\`r\)"}, 0.1, 1, ControlType -> Slider, 
          ImageSize -> Small}, 
         Delimiter, {{$CellContext`deltaR$$, 0.7, 
           "\!\(TraditionalForm\`\[CapitalDelta]\\ r\)"}, 0.1, 1, ControlType -> 
          Slider, ImageSize -> 
          Small}, {{$CellContext`delta\[Theta]$$, 1, 
           "\!\(TraditionalForm\`\[CapitalDelta]\\ \[Theta]\)"}, 0.1, 1, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`deltaZ$$, 0.5, 
           "\!\(TraditionalForm\`\[CapitalDelta]\\ z\)"}, 0.1, 1, ControlType -> 
         ...
         Grid[{{
          ...
          None}, {{$CellContext`rStart$$, 1}, 0, ControlType -> 
          None}, {{$CellContext`\[Theta]Start$$, Rational[1, 12] Pi}, 0, 
          ControlType -> None}, {{$CellContext`zStart$$, 1}, 0, ControlType -> 
          None}}, "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
      ImageSizeCache->{583., {231., 236.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.50"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.50"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 25258, 500, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature IJNafAjc5rWOuIkg@8LIus8D *)
