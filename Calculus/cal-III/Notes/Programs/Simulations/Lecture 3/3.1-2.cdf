...
NotebookDataLength[     70614,       1491]
NotebookOptionsPosition[     37952,        733]
NotebookOutlinePosition[     71390,       1503]
CellTagsIndexPosition[     71347,       1500]
WindowTitle->Section 13.1, Figure 13.02
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
     ...
     False, $CellContext`showSurface$$ = True, $CellContext`xDivisions$$ = 
...
divisions"], Manipulate`Dump`ThisIsNotAControl}, {{
       ...
       0}, {{
        Hold[$CellContext`showSingleColumn$$], False, "show single box"}, 
       0}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showPartition$211477$$ = 
     False, $CellContext`xDivisions$211478$$ = 
     0, $CellContext`yDivisions$211479$$ = 0, $CellContext`nValue$211480$$ = 
     0, $CellContext`aValue$211481$$ = 0, $CellContext`bValue$211482$$ = 
     0, $CellContext`cValue$211483$$ = 0, $CellContext`dValue$211484$$ = 
     0, $CellContext`showLabels$211485$$ = 
     False, $CellContext`showGrids$211486$$ = False}, 
...
$CellContext`showPartition$211477$$, False], 
         Hold[$CellContext`xDivisions$$, $CellContext`xDivisions$211478$$, 0], 
         Hold[$CellContext`yDivisions$$, $CellContext`yDivisions$211479$$, 0], 
         Hold[$CellContext`nValue$$, $CellContext`nValue$211480$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$211481$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$211482$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$211483$$, 0], 
         Hold[$CellContext`dValue$$, $CellContext`dValue$211484$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$211485$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$211486$$, 
          False]}, 
       "OtherVariables" :> {
...
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    ...
                    1) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 
                  $CellContext`funcC13F02[$CellContext`aValue$$ + (
                    Mod[$CellContext`i - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`i - 1, $CellContext`xDivisions$$] + 
...
$CellContext`cValue$$)/$CellContext`yDivisions$$)]}]}, Black]}], 
           If[$CellContext`showSurface$$, 
            Plot3D[
             $CellContext`funcC13F02[$CellContext`x, $CellContext`y], \
...
$CellContext`zMax$$ + 0.5}}, Lighting -> "Neutral", ImageSize -> 6 {72, 72}, 
          ...
          Epilog -> {
            Inset[
             Framed[
              Pane[
              "\!\(TraditionalForm\`\((\(TraditionalForm\`\*SubsuperscriptBox[\
\(x\), \(k\), \(*\)]\), \*SubsuperscriptBox[\(y\), \(k\), \(*\)])\)\) is a \
point in the \!\(TraditionalForm\`k\)th rectangle, which has area \
\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(A\), \(k\
\)] = \[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(x\), \(k\)] \
\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(y\), \(k\)]\).", {
               140, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], 
             ImageScaled[{1, 1}], 
             ImageScaled[{1, 1}]]}]), 
...
$CellContext`yDivisions$$]/2], Enabled :> 
         ...
         Grid[{{
          ...
          Dynamic[$CellContext`showPartition$$]}, \
{{$CellContext`showSingleColumn$$, False, "show single box"}, 0, ControlType -> 
          None, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, \
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0.8, 0, 0.4], $CellContext`funcC13F02[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
          5 - ($CellContext`x - 3)^2/5 - 
           2 (($CellContext`y - 1)^2/5), $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.1, Figure 13.02"], "Header"]}, {
   Cell[
    TextData["Section 13.1, Figure 13.02"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 36673, 700, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 0Ijj1mMRYBWnsJkoTyWZcRwd *)
