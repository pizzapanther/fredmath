...
NotebookDataLength[     55016,       1223]
NotebookOptionsPosition[     22354,        465]
NotebookOutlinePosition[     55792,       1235]
CellTagsIndexPosition[     55749,       1232]
WindowTitle->Section 13.4, Figure 13.43
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
     ...
     3, $CellContext`xMax$$ = 3, $CellContext`xMin$$ = 
     0, $CellContext`xStart$$ = 0, $CellContext`xValue$$ = 
     0.5, $CellContext`yEnd$$ = 2, $CellContext`yMax$$ = 
     7, $CellContext`yMin$$ = 0, $CellContext`yStart$$ = 
     0, $CellContext`zMax$$ = 7, $CellContext`zMin$$ = 
     0, $CellContext`zValue$$ = 1.5, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold[
        ...
        Hold[$CellContext`zValue$$], 1.5, ""}, 0, 6, 0.1}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xValue$214460$$ = 
     0, $CellContext`zValue$214461$$ = 0, $CellContext`showLabels$214462$$ = 
     False, $CellContext`showGrids$214463$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
         ...
         7, $CellContext`yMin$$ = 0, $CellContext`yStart$$ = 
         0, $CellContext`zMax$$ = 7, $CellContext`zMin$$ = 
         0, $CellContext`zValue$$ = 1.5}, "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$214460$$, 0], 
         Hold[$CellContext`zValue$$, $CellContext`zValue$214461$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$214462$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$214463$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          Graphics3D[{$CellContext`bcSurfaceTop, 
            ...
            Polygon[{{0, 0, 0}, {0, 4, 0}, {0, 4, 6}, {0, 0, 6}, {0, 0, 0}, {
             2, 0, 0}, {0, 4, 0}, {0, 0, 0}}], 
            
            Polygon[{{0, 4, 6}, {0, 0, 6}, {2, 0, 6}, {0, 4, 6}, {0, 4, 0}, {
             2, 0, 0}, {2, 0, 6}, {0, 4, 6}}], 
            Darker[$CellContext`bcAreaPositiveColor], 
            Opacity[0.6], 
            Polygon[{{0, 0, 0}, {2, 0, 0}, {2, 0, 6}, {0, 0, 6}}], Black, 
            Opacity[1], 
            If[$CellContext`showLabels$$, {
              Text[
              "\!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)", {1, 0, 5}], 
              Text["2", {2, 0, 0}, {2, 1}], 
              Text["\!\(TraditionalForm\`z = 6\)", {1, 2, 6}, {-1, -3}], 
              Text["\!\(TraditionalForm\`D\)", {1, 2, 0}, {0, -3}], 
              Text[
              "\!\(TraditionalForm\`y = 4 - 2  x\)", {1.5, 3, 1}, {-1, 0}]}, 
             Black]}], 
          Graphics3D[{
            AbsoluteThickness[2.5], 
            Arrowheads[0.04], $CellContext`bcR, 
            Arrow[{{0, 0, 0}, {0, 0, 6}}], $CellContext`bcB, 
            
            Arrow[{{0, 0, $CellContext`zValue$$}, {
              2, 0, $CellContext`zValue$$}}], $CellContext`bcG, 
            
            Arrow[{{$CellContext`xValue$$, 
               0, $CellContext`zValue$$}, {$CellContext`xValue$$, 4 - 
               2 $CellContext`xValue$$, $CellContext`zValue$$}}], 
            AbsolutePointSize[6], Black, 
            
            Point[{$CellContext`xValue$$, 4 - 
              2 $CellContext`xValue$$, $CellContext`zValue$$}], Gray, Thin, 
            
            Line[{{$CellContext`xValue$$, 4 - 
               2 $CellContext`xValue$$, $CellContext`zValue$$}, \
{$CellContext`xValue$$, $CellContext`yMax$$, $CellContext`zValue$$}}]}]}, 
...
\!\(TraditionalForm\`0\) to \!\(TraditionalForm\`4 - 2  x\).", {
                108, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> White], 
              ImageScaled[{1, 1}], 
              ImageScaled[{1, 1}]], 
             Inset[
              Framed[
               Pane[
               "Middle integral: \!\(TraditionalForm\`x\) varies from 0 to \
2.", {108, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], 
              ImageScaled[{1, 0.8}], 
              ImageScaled[{1, 1}]], 
             Inset[
              Framed[
               Pane[
               "Outer integral: \!\(TraditionalForm\`z\) varies from 0 to \
6.", {108, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], 
              ImageScaled[{1, 0.6}], 
              ImageScaled[{1, 1}]], 
             Inset[
...
\(\(\\ \)\(0\)\), \(\(\\ \)\(6\)\)]\(TraditionalForm\`\*SubsuperscriptBox[\(\
\[Integral]\), \(\(\\ \)\(0\)\), \(\(\\ \
\)\(2\)\)]\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\\ \
\)\(0\)\), \(\(\\ \)\(4 - 2  x\)\)]\\ \\ d\[VeryThinSpace]y\)\\ d\
\[VeryThinSpace]x\)\\ d\[VeryThinSpace]z\)", $CellContext`bcPBS], \
       ...
       "Specifications" :> {{{$CellContext`xValue$$, 0.5, 
         ...
         Spacer[{0, 
          8}], {{$CellContext`zValue$$, 1.5, 
           "\!\(\*\nStyleBox[\"z\",\nFontSlant->\"Italic\"]\)"}, 0, 6, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`zValue$$, 1.5, ""}, 0, 6, 0.1, ControlType -> 
          Trigger, DefaultDuration -> 20, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
         ...
         Grid[{{
          ...
          None}, {{$CellContext`zMax$$, 7}, 0, ControlType -> 
...
$CellContext`PlaneGrids}, {$CellContext`opts}], 
        ...
        RGBColor[
         0.5306666666666667, 0.6066666666666667, 
          0.5700000000000001], $CellContext`i = 1, $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.4, Figure 13.43"], "Header"]}, {
   Cell[
    TextData["Section 13.4, Figure 13.43"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 21075, 432, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5K4XbeHRQGxgsK5r2tLpZLkz *)
