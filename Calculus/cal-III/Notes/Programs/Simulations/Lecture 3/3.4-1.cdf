...
NotebookDataLength[    122502,       2344]
NotebookOptionsPosition[     89839,       1586]
NotebookOutlinePosition[    123277,       2356]
CellTagsIndexPosition[    123234,       2353]
WindowTitle->Section 13.4, Figure 13.38
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`delta$$ = False, $CellContext`showGrids$$ =
      False, $CellContext`showLabels$$ = True, $CellContext`showRegionD$$ = 
     True, $CellContext`xDivisions$$ = 4, $CellContext`xEnd$$ = 
     4, $CellContext`xMax$$ = 6, $CellContext`xMin$$ = 
     0, $CellContext`xStart$$ = 0, $CellContext`yDivisions$$ = 
     4, $CellContext`yEnd$$ = 4, $CellContext`yMax$$ = 
     6, $CellContext`yMin$$ = 0, $CellContext`yStart$$ = 
     0, $CellContext`zDivisions$$ = 4, $CellContext`zEnd$$ = 
     4, $CellContext`zMax$$ = 6, $CellContext`zMin$$ = 
     0, $CellContext`zStart$$ = 0, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`xDivisions$$], 4, ""}, 2, 12, 1}, {{
        Hold[$CellContext`yDivisions$$], 4, ""}, 2, 12, 1}, {{
        Hold[$CellContext`zDivisions$$], 4, ""}, 2, 12, 1}, {
       Hold[
        Grid[{{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`xEnd$$], 4}, 0}, {{
        Hold[$CellContext`yStart$$], 0}, 0}, {{
        Hold[$CellContext`yEnd$$], 4}, 0}, {{
        Hold[$CellContext`zStart$$], 0}, 0}, {{
        Hold[$CellContext`zEnd$$], 4}, 0}}, Typeset`size$$ = {
     432., {213., 219.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`xDivisions$213983$$ = 
     0, $CellContext`yDivisions$213984$$ = 
     0, $CellContext`zDivisions$213985$$ = 0, $CellContext`delta$213986$$ = 
     False, $CellContext`showRegionD$213987$$ = 
     False, $CellContext`showLabels$213988$$ = 
     False, $CellContext`showGrids$213989$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`delta$$ = False, $CellContext`showGrids$$ = 
         False, $CellContext`showLabels$$ = True, $CellContext`showRegionD$$ = 
         True, $CellContext`xDivisions$$ = 4, $CellContext`xEnd$$ = 
         4, $CellContext`xMax$$ = 6, $CellContext`xMin$$ = 
         0, $CellContext`xStart$$ = 0, $CellContext`yDivisions$$ = 
         ...
         0, $CellContext`zDivisions$$ = 4, $CellContext`zEnd$$ = 
         4, $CellContext`zMax$$ = 6, $CellContext`zMin$$ = 
         0, $CellContext`zStart$$ = 0}, "ControllerVariables" :> {
         Hold[$CellContext`xDivisions$$, $CellContext`xDivisions$213983$$, 0], 
         Hold[$CellContext`yDivisions$$, $CellContext`yDivisions$213984$$, 0], 
         Hold[$CellContext`zDivisions$$, $CellContext`zDivisions$213985$$, 0], 
         Hold[$CellContext`delta$$, $CellContext`delta$213986$$, False], 
         Hold[$CellContext`showRegionD$$, $CellContext`showRegionD$213987$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$213988$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$213989$$, 
          False]}, 
       "OtherVariables" :> {
...
$CellContext`zPartition$}, $CellContext`xPartition$ = 
...
$CellContext`yStart$$)/$CellContext`yDivisions$$), {$CellContext`i, 
             0, $CellContext`yDivisions$$ + 1}]; $CellContext`zPartition$ = 
          Table[$CellContext`zStart$$ + $CellContext`i (($CellContext`zEnd$$ - \
$CellContext`zStart$$)/$CellContext`zDivisions$$), {$CellContext`i, 
             0, $CellContext`zDivisions$$ + 1}]; Show[{
...
$CellContext`yEnd$$, 0}}], {$CellContext`i, $CellContext`xDivisions$$ + 1}], 
                ...
                Table[
                 Line[{{
                    Part[$CellContext`xPartition$, $CellContext`i], 
                    0, $CellContext`zStart$$}, {
                    Part[$CellContext`xPartition$, $CellContext`i], 
                    0, $CellContext`zEnd$$}}], {$CellContext`i, \
$CellContext`xDivisions$$ + 1}], 
                Table[
                 Line[{{$CellContext`xStart$$, 0, 
                    
                    Part[$CellContext`zPartition$, $CellContext`i]}, \
{$CellContext`xEnd$$, 0, 
                    
                    Part[$CellContext`zPartition$, $CellContext`i]}}], \
{$CellContext`i, $CellContext`zDivisions$$ + 1}], 
                Table[
                 Line[{{0, 
                    
                    Part[$CellContext`yPartition$, $CellContext`i], \
$CellContext`zStart$$}, {0, 
                    
                    Part[$CellContext`yPartition$, $CellContext`i], \
$CellContext`zEnd$$}}], {$CellContext`i, $CellContext`yDivisions$$ + 1}], 
                Table[
                 Line[{{0, $CellContext`yStart$$, 
                    Part[$CellContext`zPartition$, $CellContext`i]}, {
                   0, $CellContext`yEnd$$, 
                    
                    Part[$CellContext`zPartition$, $CellContext`i]}}], \
{$CellContext`i, $CellContext`zDivisions$$ + 1}]}, Black], 
              If[
               Not[$CellContext`delta$$], {$CellContext`bcB, 
                Opacity[0.4], 
                Table[
                 If[
                 Part[$CellContext`zPartition$, $CellContext`k] <= \
$CellContext`funcC13F38[
                    Part[$CellContext`xPartition$, $CellContext`i], 
                    Part[$CellContext`yPartition$, $CellContext`j]], {
                   Cuboid[{{
                    Part[$CellContext`xPartition$, $CellContext`i - 1], 
                    Part[$CellContext`yPartition$, $CellContext`j - 1], 
                    Part[$CellContext`zPartition$, $CellContext`k - 1]}, {
                    Part[$CellContext`xPartition$, $CellContext`i], 
                    Part[$CellContext`yPartition$, $CellContext`j], 
                    
                    Part[$CellContext`zPartition$, $CellContext`k]}}]}, \
$CellContext`bcB], {$CellContext`i, 2, $CellContext`xDivisions$$ + 
                  1}, {$CellContext`j, 2, $CellContext`yDivisions$$ + 
                  1}, {$CellContext`k, 2, $CellContext`zDivisions$$ + 1}]}, 
               Black], 
              If[
               And[$CellContext`showLabels$$, $CellContext`showRegionD$$], 
               Text["\!\(TraditionalForm\`D\)", {0, 4, 0}, {3, -4}], Black]}], 
            If[$CellContext`showRegionD$$, 
             Graphics3D[{
               Opacity[0.6], $CellContext`bcSurfaceTop, 
               Specularity[White, 300], 
               Polygon[{{4, 0, 0}, {0, 4, 0}, {0, 0, 4}}], 
               Polygon[{{4, 0, 0}, {0, 0, 0}, {0, 0, 4}}], 
               Polygon[{{0, 0, 0}, {0, 4, 0}, {0, 0, 4}}], 
               Polygon[{{4, 0, 0}, {0, 4, 0}, {0, 0, 0}}]}], 
             Graphics3D[{}]]}, 
           PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$ + 0.5}}, Boxed -> False, ViewPoint -> {4, 1, 1}, 
           ImageSize -> 6 {72, 72}, BaseStyle -> {"Text", 13}, Lighting -> 
           "Neutral", Epilog -> {
             If[
              ...
              Inset[
               Framed[
                Graphics3D[
                 If[
                 Part[$CellContext`zPartition$, 2] <= $CellContext`funcC13F38[
                   
                    Part[$CellContext`xPartition$, 2], 
                    Part[$CellContext`yPartition$, 2]], {
                   Text[
                   "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*\
SubscriptBox[\(x\), \(k\)]\)", {Part[$CellContext`xPartition$, 2]/2, 
                    Part[$CellContext`yPartition$, 2], 0}, {-1, 1}], 
                   Text[
                   "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*\
SubscriptBox[\(y\), \(k\)]\)", {
                    Part[$CellContext`xPartition$, 2], 
                    Part[$CellContext`yPartition$, 2]/2, 0}, {0, 1}], 
                   Text[
                   "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*\
SubscriptBox[\(z\), \(k\)]\)", {0, 
                    Part[$CellContext`yPartition$, 2], 
                    Part[$CellContext`zPartition$, 2]/2}, {-1.5, 0}], 
                   Text[
                   "\!\(TraditionalForm\`\((\*SubsuperscriptBox[\(x\), \(k\), \
\(*\)], \*SubsuperscriptBox[\(y\), \(k\), \(*\)], \*SubsuperscriptBox[\(z\), \
\(k\), \(*\)])\)\)", {0, Part[$CellContext`yPartition$, 2]/2, 
                    Part[$CellContext`zPartition$, 2]}, {0, -1}], 
                   AbsolutePointSize[6], Black, 
                   
                   Point[{Part[$CellContext`xPartition$, 2]/2, 
                    Part[$CellContext`yPartition$, 2]/2, 
                    Part[$CellContext`zPartition$, 2]/2}], $CellContext`bcB, 
                   Opacity[0.4], 
                   Cuboid[{{
                    Part[$CellContext`xPartition$, 1], 
                    Part[$CellContext`yPartition$, 1], 
                    Part[$CellContext`zPartition$, 1]}, {
                    Part[$CellContext`xPartition$, 2], 
                    Part[$CellContext`yPartition$, 2], 
                    Part[$CellContext`zPartition$, 2]}}]}, {}], Boxed -> 
                 False, ViewPoint -> {4, 1, 1}, ImageSize -> (5.5/3) {72, 72},
                  BaseStyle -> {"Text", 13}, Lighting -> "Neutral", 
                 PlotRange -> {{0, 2}, {0, 2}, {-0.2, 2}}, Epilog -> {
                   If[
                   Part[$CellContext`zPartition$, 
                    2] <= $CellContext`funcC13F38[
                    Part[$CellContext`xPartition$, 2], 
                    Part[$CellContext`yPartition$, 2]], 
                    Inset[
                    Pane[
                    "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*\
SubscriptBox[\(V\), \(k\)] = \
\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(x\), \(k\)] \[CapitalDelta]\
\[VeryThinSpace]\*SubscriptBox[\(y\), \(k\)] \
\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(z\), \(k\)]\)", \
$CellContext`bcPBS], 
                    ImageScaled[{0.5, 0}], 
                    ImageScaled[{0.5, 0}]], Black]}], $CellContext`bcFO, 
                Background -> White], 
               ImageScaled[{1, 1}], 
               ImageScaled[{1, 1}]], Black]}]], 
       "Specifications" :> {{{$CellContext`xDivisions$$, 4, ""}, 2, 12, 1, 
          ControlType -> Slider, ImageSize -> Small, Enabled :> Dynamic[
            Not[$CellContext`delta$$]], ControlPlacement -> 
          1}, {{$CellContext`yDivisions$$, 4, ""}, 2, 12, 1, ControlType -> 
          Slider, ImageSize -> Small, Enabled :> Dynamic[
            Not[$CellContext`delta$$]], ControlPlacement -> 
          2}, {{$CellContext`zDivisions$$, 4, ""}, 2, 12, 1, ControlType -> 
          Slider, ImageSize -> Small, Enabled :> Dynamic[
            Not[$CellContext`delta$$]], ControlPlacement -> 3}, 
         Grid[{{
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) divisions"}, {
            Manipulate`Place[1]}, {
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\) divisions"}, {
         ...
         Grid[{{
          ...
          None}, {{$CellContext`xEnd$$, 4}, 0, ControlType -> 
          None}, {{$CellContext`yStart$$, 0}, 0, ControlType -> 
          None}, {{$CellContext`yEnd$$, 4}, 0, ControlType -> 
          None}, {{$CellContext`zStart$$, 0}, 0, ControlType -> 
          None}, {{$CellContext`zEnd$$, 4}, 0, ControlType -> None}}, 
       "Options" :> {
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`bcB = 
          RGBColor[0, 0.4, 0.8], $CellContext`funcC13F38[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
          4 - $CellContext`x - $CellContext`y, $CellContext`j = \
{{$CellContext`x -> 
...
q4qm3Mo+j067MHc3zQrB/wEjdEYz
                "]}, {
               Automatic}]}}, $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.4, Figure 13.38"], "Header"]}, {
   Cell[
    TextData["Section 13.4, Figure 13.38"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 88560, 1553, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature #JzoOjhH913w4L#Z57#pNOs6 *)
