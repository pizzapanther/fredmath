...
NotebookDataLength[     73489,       1553]
NotebookOptionsPosition[     40827,        795]
NotebookOutlinePosition[     74265,       1565]
CellTagsIndexPosition[     74222,       1562]
WindowTitle->Section 13.5, Figure 13.58
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`delta\[Theta]$$ = Rational[1, 6] 
     Pi, $CellContext`delta\[Rho]$$ = 0.5, $CellContext`delta\[Phi]$$ = 
     Rational[1, 6] Pi, $CellContext`showGrids$$ = 
     ...
     2, $CellContext`zMin$$ = 0, $CellContext`\[Theta]Start$$ = 
     0.8975979010256552, $CellContext`\[Rho]Start$$ = 
     1.4, $CellContext`\[Phi]Start$$ = Rational[1, 6] Pi, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`\[Rho]Start$$], 1.4, 
        Style["\!\(TraditionalForm\`\[Rho]\)", Larger]}, 0.1, 1.5}, {{
        Hold[$CellContext`\[Phi]Start$$], Rational[1, 6] Pi, 
        Style["\!\(TraditionalForm\`\[Phi]\)", Larger]}, 0.1, Rational[1, 3] 
       Pi}, {{
        Hold[$CellContext`\[Theta]Start$$], 0.8975979010256552, 
        Style["\!\(TraditionalForm\`\[Theta]\)", Larger]}, 0.1, 
       Rational[1, 3] Pi}, {{
        Hold[$CellContext`delta\[Rho]$$], 0.5, 
        Style[
        "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\[Rho]\)", 
         Larger]}, 0.1, 0.5}, {{
        Hold[$CellContext`delta\[Phi]$$], Rational[1, 6] Pi, 
        Style["\!\(TraditionalForm\`\[CapitalDelta]\\ \[Phi]\)", Larger]}, 
       0.1, Rational[1, 6] Pi}, {{
        Hold[$CellContext`delta\[Theta]$$], Rational[1, 6] Pi, 
        Style["\!\(TraditionalForm\`\[CapitalDelta]\\ \[Theta]\)", Larger]}, 
       0.1, Rational[1, 6] Pi}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`\[Rho]Start$215876$$ = 
     0, $CellContext`\[Phi]Start$215877$$ = 
     0, $CellContext`\[Theta]Start$215878$$ = 
     0, $CellContext`delta\[Rho]$215879$$ = 
     0, $CellContext`delta\[Phi]$215880$$ = 
     0, $CellContext`delta\[Theta]$215881$$ = 
     0, $CellContext`showLabels$215882$$ = 
     False, $CellContext`showGrids$215883$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`delta\[Theta]$$ = 
         Rational[1, 6] Pi, $CellContext`delta\[Rho]$$ = 
         0.5, $CellContext`delta\[Phi]$$ = 
         Rational[1, 6] Pi, $CellContext`showGrids$$ = 
         False, $CellContext`showLabels$$ = True, $CellContext`xMax$$ = 
         2, $CellContext`xMin$$ = 0, $CellContext`yMax$$ = 
         2, $CellContext`yMin$$ = 0, $CellContext`zMax$$ = 
         2, $CellContext`zMin$$ = 0, $CellContext`\[Theta]Start$$ = 
         0.8975979010256552, $CellContext`\[Rho]Start$$ = 
         1.4, $CellContext`\[Phi]Start$$ = Rational[1, 6] Pi}, 
       "ControllerVariables" :> {
         Hold[$CellContext`\[Rho]Start$$, $CellContext`\[Rho]Start$215876$$, 
          0], 
         Hold[$CellContext`\[Phi]Start$$, $CellContext`\[Phi]Start$215877$$, 
          0], 
         Hold[$CellContext`\[Theta]Start$$, \
$CellContext`\[Theta]Start$215878$$, 0], 
         Hold[$CellContext`delta\[Rho]$$, $CellContext`delta\[Rho]$215879$$, 
          0], 
         Hold[$CellContext`delta\[Phi]$$, $CellContext`delta\[Phi]$215880$$, 
          0], 
         Hold[$CellContext`delta\[Theta]$$, \
$CellContext`delta\[Theta]$215881$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$215882$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$215883$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {-2, 0}], 
          ...
          ParametricPlot3D[{{($CellContext`\[Rho]Start$$ 
              Cos[$CellContext`\[Theta]]) 
             Sin[$CellContext`\[Phi]], ($CellContext`\[Rho]Start$$ 
              Sin[$CellContext`\[Phi]]) 
             Sin[$CellContext`\[Theta]], $CellContext`\[Rho]Start$$ 
             Cos[$CellContext`\[Phi]]}, {(($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) Cos[$CellContext`\[Theta]]) 
             Sin[$CellContext`\[Phi]], (($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) Sin[$CellContext`\[Phi]]) 
             Sin[$CellContext`\[Theta]], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) 
             Cos[$CellContext`\[Phi]]}}, {$CellContext`\[Theta], \
$CellContext`\[Theta]Start$$, $CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$}, {$CellContext`\[Phi], \
$CellContext`\[Phi]Start$$, $CellContext`\[Phi]Start$$ + $CellContext`delta\
\[Phi]$$}, Mesh -> None, PlotStyle -> {{
              Opacity[0.4], $CellContext`bcB, 
              Specularity[White, 100]}}], 
          
          ParametricPlot3D[{{($CellContext`\[Rho] 
              Cos[$CellContext`\[Theta]Start$$]) 
             Sin[$CellContext`\[Phi]], ($CellContext`\[Rho] 
              Sin[$CellContext`\[Phi]]) 
             Sin[$CellContext`\[Theta]Start$$], $CellContext`\[Rho] 
             Cos[$CellContext`\[Phi]]}, {($CellContext`\[Rho] 
              Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$]) 
             Sin[$CellContext`\[Phi]], ($CellContext`\[Rho] 
              Sin[$CellContext`\[Phi]]) 
             Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`\[Rho] 
             Cos[$CellContext`\[Phi]]}}, {$CellContext`\[Rho], $CellContext`\
\[Rho]Start$$, $CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$}, \
{$CellContext`\[Phi], $CellContext`\[Phi]Start$$, $CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$}, Mesh -> None, PlotStyle -> {{
              Opacity[0.4], $CellContext`bcB, 
              Specularity[White, 100]}}], 
          
          ParametricPlot3D[{{($CellContext`\[Rho] Cos[$CellContext`\[Theta]]) 
             Sin[$CellContext`\[Phi]Start$$], ($CellContext`\[Rho] 
              Sin[$CellContext`\[Phi]Start$$]) 
             Sin[$CellContext`\[Theta]], $CellContext`\[Rho] 
             Cos[$CellContext`\[Phi]Start$$]}, {($CellContext`\[Rho] 
              Cos[$CellContext`\[Theta]]) 
             Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$], \
($CellContext`\[Rho] 
              Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$]) 
             Sin[$CellContext`\[Theta]], $CellContext`\[Rho] 
             Cos[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$]}, \
{($CellContext`\[Rho] Cos[$CellContext`\[Theta]]) 
             Sin[Pi/2], ($CellContext`\[Rho] Sin[Pi/2]) 
             Sin[$CellContext`\[Theta]], $CellContext`\[Rho] 
             Cos[Pi/2]}}, {$CellContext`\[Rho], $CellContext`\[Rho]Start$$, \
$CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$}, {$CellContext`\
\[Theta], $CellContext`\[Theta]Start$$, $CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$}, Mesh -> None, PlotStyle -> {{
              Opacity[0.4], $CellContext`bcB, 
              Specularity[White, 100]}}], 
          
          ParametricPlot3D[{{(($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) Cos[$CellContext`\[Theta]Start$$]) 
             Sin[$CellContext`\[Phi]], (($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) Sin[$CellContext`\[Phi]]) 
             Sin[$CellContext`\[Theta]Start$$], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) 
             Cos[$CellContext`\[Phi]]}, {(($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) 
              Cos[$CellContext`\[Theta]Start$$ + \
...
$CellContext`delta\[Rho]$$) Sin[$CellContext`\[Phi]]) 
             ...
             Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) 
             Cos[$CellContext`\[Phi]]}, {($CellContext`\[Rho]Start$$ 
              Cos[$CellContext`\[Theta]Start$$]) 
             Sin[$CellContext`\[Phi]], ($CellContext`\[Rho]Start$$ 
...
$CellContext`delta\[Theta]$$]) 
             ...
             Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], $CellContext`\[Rho]Start$$ 
             Cos[$CellContext`\[Phi]]}}, {$CellContext`\[Phi], 0, Pi/2}, 
           PlotStyle -> {{
              AbsoluteThickness[1], Gray}}], 
          
          ParametricPlot3D[{{($CellContext`\[Rho]Start$$ + $CellContext`delta\
\[Rho]$$) 
             Cos[$CellContext`\[Theta]], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) Sin[$CellContext`\[Theta]], 
             0}, {$CellContext`\[Rho]Start$$ 
             Cos[$CellContext`\[Theta]], $CellContext`\[Rho]Start$$ 
             Sin[$CellContext`\[Theta]], 0}}, {$CellContext`\[Theta], 
            0, $CellContext`\[Theta]Start$$ + $CellContext`delta\[Theta]$$}, 
           PlotStyle -> {{
              AbsoluteThickness[1], Gray}}], 
          Graphics3D[{
            AbsoluteThickness[1], Gray, 
            ...
            Line[{{0, 0, 
              0}, {($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$ + 
                0.2) Cos[$CellContext`\[Theta]Start$$], \
($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$ + 0.2) 
               Sin[$CellContext`\[Theta]Start$$], 0}}], 
            
            Line[{{0, 0, 
              0}, {($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$ + 
                0.2) Cos[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$], ($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$ + 0.2) 
               Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$], 0}}], 
            Line[{{0, 0, 
              0}, {($CellContext`\[Rho]Start$$ 
                Cos[$CellContext`\[Theta]Start$$]) 
               Sin[$CellContext`\[Phi]Start$$], ($CellContext`\[Rho]Start$$ 
                Sin[$CellContext`\[Phi]Start$$]) 
               Sin[$CellContext`\[Theta]Start$$], $CellContext`\[Rho]Start$$ 
...
$CellContext`delta\[Theta]$$], $CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$]}}], $CellContext`bcR, 
            AbsoluteThickness[2.5], 
            
            Line[{{$CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Theta]Start$$], $CellContext`\[Rho]Start$$ 
               Sin[$CellContext`\[Theta]Start$$], 
               0}, {($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$) 
               Cos[$CellContext`\[Theta]Start$$], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$) Sin[$CellContext`\[Theta]Start$$], 0}}], 
            
            Line[{{($CellContext`\[Rho]Start$$ 
                Cos[$CellContext`\[Theta]Start$$]) 
               Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$], \
($CellContext`\[Rho]Start$$ Sin[$CellContext`\[Theta]Start$$]) 
               Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$], \
$CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$]}, \
{(($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$) 
                Cos[$CellContext`\[Theta]Start$$]) 
               Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$], \
(($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$) 
                Sin[$CellContext`\[Theta]Start$$]) 
...
($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$) 
               Cos[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$]}}], $CellContext`bcG, 
            ...
            Line[{{($CellContext`\[Rho]Start$$ 
               ...
               Sin[$CellContext`\[Phi]Start$$], ($CellContext`\[Rho]Start$$ 
                Sin[$CellContext`\[Theta]Start$$]) 
               Sin[$CellContext`\[Phi]Start$$], $CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$]}, {($CellContext`\[Rho]Start$$ 
                Cos[$CellContext`\[Theta]Start$$]) 
               Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$], \
($CellContext`\[Rho]Start$$ Sin[$CellContext`\[Theta]Start$$]) 
               Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$], \
$CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$]}}], $CellContext`bcB, 
...
$CellContext`delta\[Theta]$$]) 
               Sin[$CellContext`\[Phi]Start$$], $CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$]}}], Orange, 
            ...
            Line[{{($CellContext`\[Rho]Start$$ 
               ...
               Sin[$CellContext`\[Phi]Start$$], $CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$]}, {
              0, 0, $CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$]}}], Black, Thin, 
...
$CellContext`delta\[Theta]$$]) 
               ...
               Cos[$CellContext`\[Phi]Start$$]}, {
              0, 0, $CellContext`\[Rho]Start$$ 
               Cos[$CellContext`\[Phi]Start$$]}}], Black, 
            AbsolutePointSize[5], 
            
            Point[{(($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$/
                 2) Cos[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$/2]) 
              Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                 2], (($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$/2) 
               Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/2]) 
              Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                 2], ($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$/
                2) Cos[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$/2]}]}], 
          Graphics3D[{
            If[$CellContext`showLabels$$, {
              Arrowheads[0.02], 
              Text[
              "\!\(TraditionalForm\`\(\(\[TildeTilde]\)\(\*SubsuperscriptBox[\
\(\[Rho]\), \(k\), \(*\)] \(sin\)\(\\ \)\*SubsuperscriptBox[\(\[Phi]\), \
\(k\), \(*\)] \(\[CapitalDelta]\)\(\[VeryThinSpace]\)\(\[Theta]\)\(\\ \
\)\)\)\)", {($CellContext`\[Rho]Start$$ 
                 Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/2]) 
                Sin[$CellContext`\[Phi]Start$$], ($CellContext`\[Rho]Start$$ 
...
$CellContext`delta\[Theta]$$/2]) 
                Sin[$CellContext`\[Phi]Start$$], $CellContext`\[Rho]Start$$ 
                 Cos[$CellContext`\[Phi]Start$$] + 0.7}, {0, -1}], 
              
              Arrow[{{($CellContext`\[Rho]Start$$ 
                  Cos[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$/2]) Sin[$CellContext`\[Phi]Start$$], ($CellContext`\[Rho]Start$$ 
                  Sin[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$/2]) Sin[$CellContext`\[Phi]Start$$], $CellContext`\[Rho]Start$$ 
                  Cos[$CellContext`\[Phi]Start$$] + 
                 0.7}, ({($CellContext`\[Rho]Start$$ 
                    Cos[$CellContext`\[Theta]Start$$]) 
                   Sin[$CellContext`\[Phi]Start$$], \
($CellContext`\[Rho]Start$$ Sin[$CellContext`\[Theta]Start$$]) 
                   Sin[$CellContext`\[Phi]Start$$], \
...
{($CellContext`\[Rho]Start$$ 
                    Cos[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$]) Sin[$CellContext`\[Phi]Start$$], ($CellContext`\[Rho]Start$$ 
                    Sin[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$]) Sin[$CellContext`\[Phi]Start$$], $CellContext`\[Rho]Start$$ 
                   Cos[$CellContext`\[Phi]Start$$]})/2}], 
              Text[
              "\!\(TraditionalForm\`\(\(\[TildeTilde]\)\(\*SubsuperscriptBox[\
\(\[Rho]\), \(k\), \(*\)] \(sin\)\(\\ \)\*SubsuperscriptBox[\(\[Phi]\), \
\(k\), \(*\)]\(\\ \)\)\)\)", {($CellContext`\[Rho]Start$$ 
                 Cos[$CellContext`\[Theta]Start$$]) 
                Sin[$CellContext`\[Phi]Start$$/2], 
                0, $CellContext`\[Rho]Start$$ 
                Cos[$CellContext`\[Phi]Start$$]}, {1, -1}], 
              Text[
              "\!\(TraditionalForm\`\(\(\[TildeTilde]\)\(\*SubsuperscriptBox[\
\(\[Rho]\), \(k\), \(*\)] \(\[CapitalDelta]\)\(\[VeryThinSpace]\)\(\[Phi]\)\(\
\\ \)\)\)\)", ({($CellContext`\[Rho]Start$$ Cos[$CellContext`\[Theta]Start$$])
                    Sin[$CellContext`\[Phi]Start$$], 
                  0, $CellContext`\[Rho]Start$$ 
                  Cos[$CellContext`\[Phi]Start$$]} + \
{($CellContext`\[Rho]Start$$ Cos[$CellContext`\[Theta]Start$$]) 
                  Sin[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$], 0, $CellContext`\[Rho]Start$$ 
                  Cos[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$]})/2, {1, 0}], 
              
              Arrow[{{($CellContext`\[Rho]Start$$ 
                  Cos[$CellContext`\[Theta]Start$$]) 
                 Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2], 0, $CellContext`\[Rho]Start$$ 
                 Cos[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2]}, ({($CellContext`\[Rho]Start$$ 
                    Cos[$CellContext`\[Theta]Start$$]) 
                   Sin[$CellContext`\[Phi]Start$$], \
...
{($CellContext`\[Rho]Start$$ Cos[$CellContext`\[Theta]Start$$]) 
                   Sin[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$], ($CellContext`\[Rho]Start$$ 
                    Sin[$CellContext`\[Theta]Start$$]) 
                   Sin[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$], $CellContext`\[Rho]Start$$ 
                   Cos[$CellContext`\[Phi]Start$$ + \
$CellContext`delta\[Phi]$$]})/2}], 
              Text[
              "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\[Rho]\)", \
{($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$/2) 
                Cos[$CellContext`\[Theta]Start$$ - 
                  0.1], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$/2) Sin[$CellContext`\[Theta]Start$$ - 0.1], 0}, {0,
                0}], 
              Text[
               Pane[
               "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\[Phi]\)",
                 BaseStyle -> {Background -> White}], {(0.2 
                 Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2]) Cos[$CellContext`\[Theta]Start$$], (0.2 
                 Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2]) Sin[$CellContext`\[Theta]Start$$], 0.2 
                Cos[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                   2]}, {0, 0}], 
              Text[
              "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\[Theta]\)\
", {($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$ + 0.1) 
                Cos[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/
                   2], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$ + 0.1) 
                Sin[$CellContext`\[Theta]Start$$ + \
$CellContext`delta\[Theta]$$/2], 0}, {0, 0}], 
              Text[
              "\!\(TraditionalForm\`\((\*SubsuperscriptBox[\(\[Rho]\), \(k\), \
\(*\)], \*SubsuperscriptBox[\(\[Phi]\), \(k\), \(*\)], \*SubsuperscriptBox[\(\
\[Theta]\), \(k\), \(*\)])\)\)", {(($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$ + 0.2) 
                 Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2]) Cos[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$/2], (($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$ + 
                  0.2) Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\
\[Phi]$$/2]) Sin[$CellContext`\[Theta]Start$$ + $CellContext`delta\[Theta]$$/
                   2], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$ + 0.2) 
                Cos[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                   2]}, {-1, -1}], 
...
$CellContext`delta\[Rho]$$ + 0.2) 
                 Cos[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2]}, {(($CellContext`\[Rho]Start$$ + $CellContext`delta\
\[Rho]$$/2) Cos[$CellContext`\[Theta]Start$$ + $CellContext`delta\[Theta]$$/
                    2]) Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\
\[Phi]$$/2], (($CellContext`\[Rho]Start$$ + $CellContext`delta\[Rho]$$/2) 
                  Sin[$CellContext`\[Theta]Start$$ + $CellContext`delta\
\[Theta]$$/2]) Sin[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2], ($CellContext`\[Rho]Start$$ + \
$CellContext`delta\[Rho]$$/2) 
                 Cos[$CellContext`\[Phi]Start$$ + $CellContext`delta\[Phi]$$/
                    2]}}]}, Black]}]}, 
...
$CellContext`zMax$$ + 0.2}}, ImageSize -> 6 {72, 72}, 
         BaseStyle -> {"Text", 13}, Lighting -> "Neutral", Boxed -> False, 
         ViewPoint -> {4, 0.5, 1}, Epilog -> {
           If[$CellContext`showLabels$$, 
            Inset[
             Framed[
              Pane[
              "Approximate volume\!\(TraditionalForm\`\(\(\\ \)\(\
\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(V\), \(k\)] \[TildeTilde] \
\*SuperscriptBox[SubsuperscriptBox[\(\[Rho]\), \(k\), \(*\)], \(2\)] sin\\ \
\*SubsuperscriptBox[\(\[Phi]\), \(k\), \(*\)]\\ \[CapitalDelta]\
\[VeryThinSpace]\[Rho]\\ \[CapitalDelta]\[VeryThinSpace]\[Phi]\\ \
\[CapitalDelta]\[VeryThinSpace]\[Theta]\)\)\)", $CellContext`bcPBS], \
$CellContext`bcFO, Background -> White], 
             ImageScaled[{0.5, 0.01}], 
             ImageScaled[{0.5, 0.01}]], Black]}], 
       "Specifications" :> {{{$CellContext`\[Rho]Start$$, 1.4, 
           Style["\!\(TraditionalForm\`\[Rho]\)", Larger]}, 0.1, 1.5, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`\[Phi]Start$$, Rational[1, 6] Pi, 
           Style["\!\(TraditionalForm\`\[Phi]\)", Larger]}, 0.1, 
          Rational[1, 3] Pi, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`\[Theta]Start$$, 0.8975979010256552, 
           Style["\!\(TraditionalForm\`\[Theta]\)", Larger]}, 0.1, 
          Rational[1, 3] Pi, ControlType -> Slider, ImageSize -> Small}, 
         Delimiter, {{$CellContext`delta\[Rho]$$, 0.5, 
           Style[
           "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\[Rho]\)", 
            Larger]}, 0.1, 0.5, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`delta\[Phi]$$, Rational[1, 6] Pi, 
           Style["\!\(TraditionalForm\`\[CapitalDelta]\\ \[Phi]\)", Larger]}, 
          0.1, Rational[1, 6] Pi, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`delta\[Theta]$$, Rational[1, 6] Pi, 
           Style[
           "\!\(TraditionalForm\`\[CapitalDelta]\\ \[Theta]\)", Larger]}, 0.1,
           Rational[1, 6] Pi, ControlType -> Slider, ImageSize -> Small}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.58"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.58"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 39548, 762, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5IzeqFwR0YFwXJ#Q3vn00P09 *)
