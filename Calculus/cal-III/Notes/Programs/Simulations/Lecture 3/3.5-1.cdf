...
NotebookDataLength[     61322,       1367]
NotebookOptionsPosition[     28660,        609]
NotebookOutlinePosition[     62098,       1379]
CellTagsIndexPosition[     62055,       1376]
WindowTitle->Section 13.5, Figure 13.47
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`rValue$$ = 3, $CellContext`showGrids$$ = 
     False, $CellContext`showLabels$$ = True, $CellContext`showSurfaceR$$ = 
     False, $CellContext`showSurfaceZ$$ = 
     False, $CellContext`showSurface\[Theta]$$ = False, $CellContext`xMax$$ = 
     5, $CellContext`xMin$$ = -5, $CellContext`yMax$$ = 
     5, $CellContext`yMin$$ = -5, $CellContext`zMax$$ = 
     5, $CellContext`zMin$$ = -5, $CellContext`zValue$$ = 
     2.5, $CellContext`\[Theta]Value$$ = Rational[1, 3] Pi, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`rValue$$], 3, 
        "\!\(\*\nStyleBox[\"r\",\nFontSlant->\"Italic\"]\)"}, 0, 5}, {{
        Hold[$CellContext`rValue$$], 3, ""}, 0, 5, 0.1}, {{
        Hold[$CellContext`showSurfaceR$$], False, 
        "constant \!\(\*\nStyleBox[\"r\",\nFontSlant->\"Italic\"]\) \
surface"}, {True, False}}, {
       Hold[
        Row[{
        ...
        Hold[$CellContext`\[Theta]Value$$], Rational[1, 3] Pi, ""}, 0, 2 Pi, 
       0.01}, {{
       ...
       Hold[
        ...
        Hold[$CellContext`zValue$$], 2.5, "z"}, -5, 5}, {{
        Hold[$CellContext`zValue$$], 2.5, ""}, -5, 5, 0.1}, {{
        Hold[$CellContext`showSurfaceZ$$], False, 
        "constant \!\(\*\nStyleBox[\"z\",\nFontSlant->\"Italic\"]\) \
surface"}, {True, False}}, {
       Hold[
        Row[{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`rValue$214899$$ = 
     0, $CellContext`showSurfaceR$214900$$ = 
     False, $CellContext`\[Theta]Value$214901$$ = 
     0, $CellContext`showSurface\[Theta]$214902$$ = 
     False, $CellContext`zValue$214903$$ = 
     0, $CellContext`showSurfaceZ$214904$$ = 
     False, $CellContext`showLabels$214905$$ = 
     False, $CellContext`showGrids$214906$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`rValue$$ = 3, $CellContext`showGrids$$ = 
         False, $CellContext`showLabels$$ = True, $CellContext`showSurfaceR$$ = 
         False, $CellContext`showSurfaceZ$$ = 
         False, $CellContext`showSurface\[Theta]$$ = 
         False, $CellContext`xMax$$ = 
         5, $CellContext`xMin$$ = -5, $CellContext`yMax$$ = 
         5, $CellContext`yMin$$ = -5, $CellContext`zMax$$ = 
         5, $CellContext`zMin$$ = -5, $CellContext`zValue$$ = 
         2.5, $CellContext`\[Theta]Value$$ = Rational[1, 3] Pi}, 
       "ControllerVariables" :> {
         Hold[$CellContext`rValue$$, $CellContext`rValue$214899$$, 0], 
         Hold[$CellContext`showSurfaceR$$, $CellContext`showSurfaceR$214900$$,
           False], 
         Hold[$CellContext`\[Theta]Value$$, \
$CellContext`\[Theta]Value$214901$$, 0], 
         Hold[$CellContext`showSurface\[Theta]$$, $CellContext`showSurface\
\[Theta]$214902$$, False], 
         Hold[$CellContext`zValue$$, $CellContext`zValue$214903$$, 0], 
         Hold[$CellContext`showSurfaceZ$$, $CellContext`showSurfaceZ$214904$$,
           False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$214905$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$214906$$, 
          False]}, 
       "OtherVariables" :> {
          ...
          Graphics3D[{
            If[$CellContext`showLabels$$, {
              Text[
               Style[
               "\!\(TraditionalForm\`r\)", 
                Larger], {(0.5 $CellContext`rValue$$) 
                Cos[$CellContext`\[Theta]Value$$], (0.5 $CellContext`rValue$$)
                  Sin[$CellContext`\[Theta]Value$$], 0}, {0, 1.5}], 
              Text[
               Style[
               "\!\(TraditionalForm\`z\)", 
                Larger], {($CellContext`rValue$$ + 0.5) 
                Cos[$CellContext`\[Theta]Value$$], ($CellContext`rValue$$ + 
                 0.5) Sin[$CellContext`\[Theta]Value$$], \
$CellContext`zValue$$/2}, {0, 0}], 
              Text[
              "\!\(TraditionalForm\`P(r, \[Theta], z)\)", \
{($CellContext`rValue$$ + 0.5) 
                Cos[$CellContext`\[Theta]Value$$], ($CellContext`rValue$$ + 
                 0.5) Sin[$CellContext`\[Theta]Value$$], \
$CellContext`zValue$$}, {0, (-Sign[$CellContext`zValue$$]) 3}], 
              Text[
              "\!\(TraditionalForm\`\*SuperscriptBox[\(P\), \(*\)]\)", \
{($CellContext`rValue$$ + 0.75) 
                Cos[$CellContext`\[Theta]Value$$], ($CellContext`rValue$$ + 
                 0.75) Sin[$CellContext`\[Theta]Value$$], 0}, {0, 0}], 
              Text[
               Style["\!\(TraditionalForm\`\[Theta]\)", Larger], {
               2 Cos[0.2], 2 Sin[0.2], 0}, {0, 1.5}]}, Black], 
            AbsoluteThickness[3], $CellContext`bcR, 
            
            Line[{{0, 0, 
              0}, {$CellContext`rValue$$ 
               Cos[$CellContext`\[Theta]Value$$], $CellContext`rValue$$ 
               Sin[$CellContext`\[Theta]Value$$], 0}}], $CellContext`bcG, 
            
            Line[{{$CellContext`rValue$$ 
               Cos[$CellContext`\[Theta]Value$$], $CellContext`rValue$$ 
               Sin[$CellContext`\[Theta]Value$$], 0}, {$CellContext`rValue$$ 
               Cos[$CellContext`\[Theta]Value$$], $CellContext`rValue$$ 
               Sin[$CellContext`\[Theta]Value$$], $CellContext`zValue$$}}], \
$CellContext`bcB, 
            Opacity[0.5], 
            EdgeForm[None], 
            ...
            Polygon[{{0, 0, 
              0}, {$CellContext`rValue$$ 
               Cos[$CellContext`\[Theta]Value$$ + 
                 0.001], $CellContext`rValue$$ 
               Sin[$CellContext`\[Theta]Value$$ + 0.001], 
               0}, {$CellContext`rValue$$ 
               Cos[$CellContext`\[Theta]Value$$ + 
                 0.001], $CellContext`rValue$$ 
               Sin[$CellContext`\[Theta]Value$$ + 
                 0.001], $CellContext`zValue$$}, {
              0, 0, $CellContext`zValue$$}}], Gray, 
            Opacity[1], Thin}], 
            ...
            Graphics3D[{
              ...
              Table[
               ...
               Line[{{$CellContext`i 
                  ...
                  Sin[$CellContext`\[Theta]Value$$], -5}, {$CellContext`i 
                  Cos[$CellContext`\[Theta]Value$$], $CellContext`i 
                  Sin[$CellContext`\[Theta]Value$$], 5}}], {$CellContext`i, 1,
                 5, 1}], 
              Table[
               
               Line[{{0, 0, $CellContext`i}, {
                 5 Cos[$CellContext`\[Theta]Value$$], 5 
                  Sin[$CellContext`\[Theta]Value$$], $CellContext`i}}], \
{$CellContext`i, -5, 5, 1}]}]}, 
           Graphics3D[{}]], 
          If[$CellContext`showSurfaceZ$$, {
            Graphics3D[{
              Opacity[0.4], 
              Specularity[White, 100], $CellContext`bcG, 
              
              Polygon[{{-5, -5, $CellContext`zValue$$}, {
                5, -5, $CellContext`zValue$$}, {
                5, 5, $CellContext`zValue$$}, {-5, 
                 5, $CellContext`zValue$$}}], 
              Opacity[1], 
              GrayLevel[0.5], 
              Table[
               
               Line[{{0, 0, $CellContext`zValue$$}, {
                 5 Cos[$CellContext`i], 5 
                  Sin[$CellContext`i], $CellContext`zValue$$}}], \
{$CellContext`i, 0, 23 (Pi/12), Pi/12}]}], 
            ParametricPlot3D[
             
             Table[{$CellContext`i Cos[$CellContext`t], $CellContext`i 
               Sin[$CellContext`t], $CellContext`zValue$$}, {$CellContext`i, 
               1, 5}], {$CellContext`t, 0, 2 Pi}, PlotStyle -> 
             GrayLevel[0.5]]}, 
           Graphics3D[{}]], 
          If[$CellContext`showSurfaceR$$, {
            Graphics3D[{
              Opacity[0.4], 
              Specularity[White, 100], $CellContext`bcR, 
              Cylinder[{{0, 0, -6}, {0, 0, 6}}, $CellContext`rValue$$], 
              Opacity[1], 
              GrayLevel[0.5], 
              Table[
               
               Line[{{$CellContext`rValue$$ 
                  Cos[$CellContext`i], $CellContext`rValue$$ 
                  Sin[$CellContext`i], -5}, {$CellContext`rValue$$ 
                  Cos[$CellContext`i], $CellContext`rValue$$ 
                  Sin[$CellContext`i], 5}}], {$CellContext`i, 0, 23 (Pi/12), 
                Pi/12}]}], 
            ParametricPlot3D[
             
             Table[{$CellContext`rValue$$ 
               Cos[$CellContext`t], $CellContext`rValue$$ 
               Sin[$CellContext`t], $CellContext`i}, {$CellContext`i, -5, 
               5}], {$CellContext`t, 0, 2 Pi}, PlotStyle -> GrayLevel[0.5]]}, 
...
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
         ...
         ViewPoint -> {4, 3, 1}, Epilog -> {
           Inset[
            Framed[
             Pane[
             " \!\(TraditionalForm\`0 \[LessEqual] r < \[Infinity]\), \
\!\(TraditionalForm\`0 \[LessEqual] \[Theta] \[LessEqual] 2  \[Pi]\), \
\!\(TraditionalForm\`\(-\[Infinity]\) < z < \[Infinity]\)", \
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], 
           ...
           Inset[
            Framed[
             Pane[
             "\!\(TraditionalForm\`\*SuperscriptBox[\(P\), \(*\)]\) is the \
projection of\n\!\(TraditionalForm\`P\) onto the \!\(TraditionalForm\`x\
\[VeryThinSpace]y\)\[Hyphen]plane.", $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], 
            ImageScaled[{1, 0}], {1, -1}], 
           Inset[
           ...
           Inset[
            ...
            ImageScaled[{0, 0.95}], {-1, 1}], 
           Inset[
            Row[{"\!\(TraditionalForm\`\(\(z\)\(=\)\(\\ \)\)\)", 
              $CellContext`DisplayNumber[
               Round[$CellContext`zValue$$, 0.01]]}], 
            ImageScaled[{0, 0.9}], {-1, 1}]}], 
       "Specifications" :> {{{$CellContext`rValue$$, 3, 
           "\!\(\*\nStyleBox[\"r\",\nFontSlant->\"Italic\"]\)"}, 0, 5, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`rValue$$, 3, ""}, 0, 5, 0.1, ControlType -> 
          Trigger, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", 
            "StepRightButton"}}, {{$CellContext`showSurfaceR$$, False, 
           "constant \!\(\*\nStyleBox[\"r\",\nFontSlant->\"Italic\"]\) \
surface"}, {True, False}, ControlType -> Checkbox, ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], 
         Delimiter, {{$CellContext`\[Theta]Value$$, Rational[1, 3] Pi, 
           Style["\[Theta]", Larger]}, 0, 2 Pi, ControlType -> Slider, 
          ImageSize -> 
          Small}, {{$CellContext`\[Theta]Value$$, Rational[1, 3] Pi, ""}, 0, 
         ...
         Row[{
           Manipulate`Place[2]}], 
         Delimiter, {{$CellContext`zValue$$, 2.5, "z"}, -5, 5, ControlType -> 
          Slider, ImageSize -> Small}, {{$CellContext`zValue$$, 2.5, ""}, -5, 
          5, 0.1, ControlType -> Trigger, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", 
            "StepRightButton"}}, {{$CellContext`showSurfaceZ$$, False, 
           "constant \!\(\*\nStyleBox[\"z\",\nFontSlant->\"Italic\"]\) \
surface"}, {True, False}, ControlType -> Checkbox, ControlPlacement -> 3}, 
         Row[{
           Manipulate`Place[3]}], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.47"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.47"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 27381, 576, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature oI4LBbfhxzfRwJ5hNHcgT4GA *)
