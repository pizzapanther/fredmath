...
NotebookDataLength[     64953,       1422]
NotebookOptionsPosition[     32291,        664]
NotebookOutlinePosition[     65729,       1434]
CellTagsIndexPosition[     65686,       1431]
WindowTitle->Section 13.5, Figure 13.57
WindowFrame->Normal*)
      ...
      TagBox[
       StyleBox[
        DynamicModuleBox[{$CellContext`aValue$$ = 
         4, $CellContext`showGrids$$ = False, $CellContext`xMax$$ = 
         ...
         Typeset`skipInitDone$$ = False, $CellContext`aValue$215768$$ = 
         0, $CellContext`showGrids$215769$$ = False}, 
         DynamicBox[Manipulate`ManipulateBoxes[
          2, StandardForm, 
           "Variables" :> {$CellContext`aValue$$ = 
             ...
             Hold[$CellContext`aValue$$, $CellContext`aValue$215768$$, 0], 
             
             Hold[$CellContext`showGrids$$, $CellContext`showGrids$215769$$, 
              False]}, 
           "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
              ...
              Graphics3D[{
                ...
                Sphere[{0, 0, $CellContext`aValue$$}, $CellContext`aValue$$], 
                Black, 
                Opacity[1], 
                Text[
                "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)", {
                 0, 0, $CellContext`aValue$$}, {1.5, 0}]}]}, 
...
$CellContext`zMax$$ + 0.5}}, ImageSize -> 3.5 {72, 72}, 
             BaseStyle -> {"Text", 13}, Lighting -> "Neutral", Boxed -> False,
              ViewPoint -> {4, 3, 1.5}], 
           "Specifications" :> {{{$CellContext`aValue$$, 4, 
               "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0.2, 5, 
             ...
             Row[{
               Manipulate`Place[1], 
               Spacer[10], 
               Manipulate`Place[2]}], {{$CellContext`xMin$$, -5}, 0, 
      ...
      TagBox[
       StyleBox[
        DynamicModuleBox[{$CellContext`showGrids$$ = 
         ...
         252., {123., 129.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
         Typeset`skipInitDone$$ = False, $CellContext`showGrids$215795$$ = 
         False}, 
         DynamicBox[Manipulate`ManipulateBoxes[
          2, StandardForm, 
           "Variables" :> {$CellContext`showGrids$$ = 
             ...
             Hold[$CellContext`showGrids$$, $CellContext`showGrids$215795$$, 
              False]}, 
           "OtherVariables" :> {
            Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
             Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
              ...
              Graphics3D[{
                ...
                Polygon[{{$CellContext`xMin$$, $CellContext`yMin$$, 
                   4}, {$CellContext`xMax$$, $CellContext`yMin$$, 
                   4}, {$CellContext`xMax$$, $CellContext`yMax$$, 
                   4}, {$CellContext`xMin$$, $CellContext`yMax$$, 4}}], Black, 
                Opacity[1], 
                Text["4", {0, 0, 4}, {1.5, -1.5}]}]}, 
             PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$ + 0.5}}, ImageSize -> 3.5 {72, 72}, 
             BaseStyle -> {"Text", 13}, Lighting -> "Neutral", Boxed -> False,
           ...
           "Specifications" :> {{{$CellContext`showGrids$$, False, 
              ...
              ControlPlacement -> 1}, 
             Row[{
               Manipulate`Place[1]}], {{$CellContext`xMin$$, -3}, 0, 
              ControlType -> None}, {{$CellContext`xMax$$, 3}, 0, ControlType -> 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.57"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.57"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 31012, 631, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5Kzh2Yn71d9sRK5G#he#xBOD *)
