...
NotebookDataLength[     50539,       1133]
NotebookOptionsPosition[     17877,        375]
NotebookOutlinePosition[     51315,       1145]
CellTagsIndexPosition[     51272,       1142]
WindowTitle->Section 13.2, Figure 13.19
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
     1, $CellContext`cValue$$ = 3, $CellContext`showGrids$$ = 
     False, $CellContext`xMax$$ = 5, $CellContext`xMin$$ = 
     0, $CellContext`yMax$$ = 5, $CellContext`yMin$$ = 
     0, $CellContext`zMax$$ = 5, $CellContext`zMin$$ = 0, Typeset`show$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`aValue$212730$$ = 
     0, $CellContext`bValue$212731$$ = 0, $CellContext`cValue$212732$$ = 
     0, $CellContext`showGrids$212733$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
         ...
         False, $CellContext`xMax$$ = 5, $CellContext`xMin$$ = 
         0, $CellContext`yMax$$ = 5, $CellContext`yMin$$ = 
         0, $CellContext`zMax$$ = 5, $CellContext`zMin$$ = 0}, 
       "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$212730$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$212731$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$212732$$, 0], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$212733$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          Graphics3D[{
            Text[
            "\!\(TraditionalForm\`c\)", {
             0, 0, $CellContext`cValue$$}, {-2, -1}], 
            Text[
            "\!\(TraditionalForm\`\*FractionBox[\(c\), \(b\)]\)", {
             0, $CellContext`cValue$$/$CellContext`bValue$$, 0}, {0, -1}], 
            Text[
            "\!\(TraditionalForm\`\*FractionBox[\(c\), \(a\)]\)", \
{$CellContext`cValue$$/$CellContext`aValue$$, 0, 0}, {1, -1}], 
            Text[
            "\!\(TraditionalForm\`z = c - a\\ x - b\\ y\)", {
             0, ($CellContext`cValue$$/$CellContext`bValue$$)/
              2, $CellContext`cValue$$/
              2}, {-1, -1}], {$CellContext`bcSurfaceTop, 
             Opacity[0.8], 
             Specularity[White, 100], 
             
             Polygon[{{$CellContext`cValue$$/$CellContext`aValue$$, 0, 0}, {
               0, $CellContext`cValue$$/$CellContext`bValue$$, 0}, {
               0, 0, $CellContext`cValue$$}}]}, \
$CellContext`bcAreaPositiveColor, 
            
            Polygon[{{$CellContext`cValue$$/$CellContext`aValue$$, 0, 0}, {
              0, $CellContext`cValue$$/$CellContext`bValue$$, 0}, {0, 0, 0}}], 
            
            Polygon[{{$CellContext`cValue$$/$CellContext`aValue$$, 0, 0}, {0, 
              0, 0}, {0, 0, $CellContext`cValue$$}}], 
            
            Polygon[{{0, $CellContext`cValue$$/$CellContext`bValue$$, 0}, {0, 
              0, 0}, {0, 0, $CellContext`cValue$$}}]}]}, 
         PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$ + 
            0.5}, {$CellContext`zMin$$, $CellContext`zMax$$ + 0.5}}, 
         ImageSize -> 5 {72, 72}, BaseStyle -> {"Text", 13}, Lighting -> 
         "Neutral", Boxed -> False, ViewPoint -> {4, 1, 1}], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.2, Figure 13.19"], "Header"]}, {
   Cell[
    TextData["Section 13.2, Figure 13.19"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 16598, 342, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature oLNZjEV9AuGtKJ5ubOaIe6Zb *)
