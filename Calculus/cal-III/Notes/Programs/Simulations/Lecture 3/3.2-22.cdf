...
NotebookDataLength[     43074,        981]
NotebookOptionsPosition[     10413,        223]
NotebookOutlinePosition[     43851,        993]
CellTagsIndexPosition[     43808,        990]
WindowTitle->Section 13.2, Figure 13.26
WindowFrame->Normal*)
   ...
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = -1.5, Typeset`show$$ = True, 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)"}, -2, 3, 0.1}, {{
        Hold[$CellContext`xValue$$], -1.5, ""}, -2, 3, 0.01}}, 
     Typeset`size$$ = {360., {180., 185.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`xValue$213073$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = -1.5}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$213073$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC13F26a[$CellContext`x], 
            $CellContext`funcC13F26b[$CellContext`x]}, {$CellContext`x, -2, 
            0}, PlotStyle -> None, Filling -> {2 -> {1}}, FillingStyle -> 
           Lighter[$CellContext`bcAreaPositiveColor, 0.7]], 
          Plot[{
            $CellContext`funcC13F26a[$CellContext`x], 
            $CellContext`funcC13F26c[$CellContext`x]}, {$CellContext`x, 0, 3},
            PlotStyle -> None, Filling -> {2 -> {1}}, FillingStyle -> 
           Lighter[$CellContext`bcAreaPositiveColor, 0.7]], 
          Plot[{
            $CellContext`funcC13F26a[$CellContext`x], 
            $CellContext`funcC13F26b[$CellContext`x]}, {$CellContext`x, \
-1.999, 
            Min[$CellContext`xValue$$, 0]}, PlotStyle -> None, 
           Filling -> {2 -> {1}}, 
           FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[{
            $CellContext`funcC13F26a[$CellContext`x], 
            $CellContext`funcC13F26c[$CellContext`x]}, {$CellContext`x, \
-0.001, 
            Min[
             Max[$CellContext`xValue$$, 0], 3]}, PlotStyle -> None, 
           Filling -> {2 -> {1}}, 
           FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[{
            $CellContext`funcC13F26a[$CellContext`x], 
            $CellContext`funcC13F26b[$CellContext`x], 
            $CellContext`funcC13F26c[$CellContext`x]}, {$CellContext`x, -2.5, 
            3.5}, PlotStyle -> {{Thick, $CellContext`bcR}, {Thick, 
              If[$CellContext`xValue$$ <= 0, Black, Gray]}, {Thick, 
              If[$CellContext`xValue$$ > 0, Black, Gray]}}], 
          Graphics[{
            Text[
            "\!\(TraditionalForm\`\*SubscriptBox[\(R\), \(1\)]\)", {-1, 4}, {
             0, 0}], 
            Text[
            "\!\(TraditionalForm\`\*SubscriptBox[\(R\), \(2\)]\)", {1, 4}, {0,
              0}], 
            Text["\!\(TraditionalForm\`y = 4  x + 12\)", {-1, 8}, {1.5, 0}], 
            Text[
            "\!\(TraditionalForm\`y = \(-x\) + 12\)", {1, 11}, {-1, -1.5}], 
            Orange, 
            AbsoluteThickness[3], 
            Arrowheads[0.05], 
            Arrow[{{$CellContext`xValue$$, 
               $CellContext`funcC13F26a[$CellContext`xValue$$]}, \
{$CellContext`xValue$$, 
               If[$CellContext`xValue$$ < 0, 
                $CellContext`funcC13F26b[$CellContext`xValue$$], 
                $CellContext`funcC13F26c[$CellContext`xValue$$]]}}], \
$CellContext`bcB, 
            Opacity[0.2], 
            AbsoluteThickness[6], 
            Arrowheads[0.07], 
            Arrow[{{-2, 0}, {3, 0}}], 
            Opacity[0.5], 
            Arrow[{{-2, 0}, {$CellContext`xValue$$, 0}}]}]}, AspectRatio -> 1,
          BaseStyle -> {"Text", 13}, ImageSize -> 5 72, AxesOrigin -> {0, 0}, 
         Ticks -> {
           Range[-2, 3], 
           Range[0, 14, 2]}, AxesStyle -> Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         PlotRange -> {{-3, 4}, {-5, 15}}, Epilog -> {
           Inset[
            Framed[
             Pane[
              If[$CellContext`xValue$$ <= 0, 
...
\)\(\(d\)\(\[VeryThinSpace]\)\(y\)\(\\ \)\)\)\)", 
       ...
       "Specifications" :> {{{$CellContext`xValue$$, -1.5, 
          ...
          Small}, {{$CellContext`xValue$$, -1.5, ""}, -2, 3, 0.01, 
          ControlType -> Trigger, 
          AppearanceElements -> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC13F26a[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x^2, $CellContext`funcC13F26b[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          4 $CellContext`x + 12, $CellContext`bcAreaPositiveColor = 
          RGBColor[0.796, 0.91, 0.855], $CellContext`funcC13F26c[
            Pattern[$CellContext`x, 
             Blank[]]] := 12 - $CellContext`x, $CellContext`bcR = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.2, Figure 13.26"], "Header"]}, {
   Cell[
    TextData["Section 13.2, Figure 13.26"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 9134, 190, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 3JzvJzgHqlPEaI5b56yRmoER *)
