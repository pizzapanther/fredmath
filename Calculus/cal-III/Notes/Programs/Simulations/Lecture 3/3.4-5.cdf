...
NotebookDataLength[     50165,       1126]
NotebookOptionsPosition[     17503,        368]
NotebookOutlinePosition[     50941,       1138]
CellTagsIndexPosition[     50898,       1135]
WindowTitle->Section 13.4, Figure 13.42
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
     ...
     2, $CellContext`yMax$$ = 5, $CellContext`yMin$$ = 
     0, $CellContext`yStart$$ = 0, $CellContext`zMax$$ = 
     7, $CellContext`zMin$$ = 0, Typeset`show$$ = True, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showLabels$214387$$ = 
     False, $CellContext`showGrids$214388$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
         ...
         2, $CellContext`yMax$$ = 5, $CellContext`yMin$$ = 
         0, $CellContext`yStart$$ = 0, $CellContext`zMax$$ = 
         7, $CellContext`zMin$$ = 0}, "ControllerVariables" :> {
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$214387$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$214388$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          Graphics3D[{$CellContext`bcSurfaceTop, 
            ...
            Polygon[{{0, 0, 0}, {2, 0, 0}, {2, 0, 6}, {0, 0, 6}, {0, 0, 0}, {
             0, 4, 0}, {0, 4, 6}, {0, 0, 6}, {0, 0, 0}, {2, 0, 0}, {0, 4, 
             0}, {0, 0, 0}}], 
            
            Polygon[{{0, 4, 6}, {0, 0, 6}, {2, 0, 6}, {0, 4, 6}, {0, 4, 0}, {
             2, 0, 0}, {2, 0, 6}, {0, 4, 6}}], Black, 
            Opacity[1], 
...
$CellContext`PlaneGrids}, {$CellContext`opts}], 
        ...
        RGBColor[0.85, 0.6, 0.2], Attributes[PlotRange] = {ReadProtected}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.4, Figure 13.42"], "Header"]}, {
   Cell[
    TextData["Section 13.4, Figure 13.42"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 16224, 335, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature HJzKHWkCL@DVmJkdzynquJyJ *)
