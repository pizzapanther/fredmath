...
NotebookDataLength[     38642,        889]
NotebookOptionsPosition[      6339,        139]
NotebookOutlinePosition[     39419,        901]
CellTagsIndexPosition[     39376,        898]
WindowTitle->Section 13.3, Exercise 67
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 2, 
     ...
     1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold[
        Button[
        "\!\(TraditionalForm\`a = 2\)", $CellContext`aValue$$ = 2, BaseStyle -> 
         11]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`bValue$$], 2, 
        "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, -2, 2, 0.1}, {
       Hold[
        Button[
        "\!\(TraditionalForm\`b = 1\)", $CellContext`bValue$$ = 1, BaseStyle -> 
         11]], Manipulate`Dump`ThisIsNotAControl}, {
       Hold[
        Button[
        "\!\(TraditionalForm\`b = 2\)", $CellContext`bValue$$ = 2, BaseStyle -> 
         11]], Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
     360., {177., 183.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`aValue$213907$$ = 
     0, $CellContext`bValue$213908$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$213907$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$213908$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
         Typeset`specs$$, Typeset`size$$, Typeset`update$$, 
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> 
       PolarPlot[$CellContext`bValue$$ + $CellContext`aValue$$ 
         ...
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         BaseStyle -> {"Text", 13}, ImageSize -> 5 {72, 72}, Epilog -> {
           Text[
            Pane[
...
$CellContext`bcPBS], 
       ...
       "Specifications" :> {{{$CellContext`aValue$$, 1, 
         ...
         Button[
         "\!\(TraditionalForm\`a = 2\)", $CellContext`aValue$$ = 2, BaseStyle -> 
          11], Delimiter, {{$CellContext`bValue$$, 2, 
           "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, -2, 2, 0.1, 
          ControlType -> Slider, ImageSize -> Small}, 
         Button[
         "\!\(TraditionalForm\`b = 1\)", $CellContext`bValue$$ = 1, BaseStyle -> 
...
S\[VeryThinSpace]O\[VeryThinSpace]N\"", 
       ...
       PaneBox[
        TagBox[
         GridBox[{{"\"Section \"", "\"13.3\"", "\", Exercise \"", "\"67\""}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.3, Exercise 67"], "Header"]}, {
   Cell[
    TextData["Section 13.3, Exercise 67"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1274, 31, 5061, 106, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature xLNp1GniQAkUyK#DrknBef@l *)
