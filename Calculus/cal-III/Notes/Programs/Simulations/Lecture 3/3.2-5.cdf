...
NotebookDataLength[     71798,       1508]
NotebookOptionsPosition[     39136,        750]
NotebookOutlinePosition[     72574,       1520]
CellTagsIndexPosition[     72531,       1517]
WindowTitle->Section 13.1, Figure 13.05
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = False, $CellContext`xMax$$ = 
     2, $CellContext`xMin$$ = 0, $CellContext`xValue$$ = 
     0.5, $CellContext`yMax$$ = 3, $CellContext`yMin$$ = 
     0, $CellContext`zMax$$ = 7, $CellContext`zMin$$ = 0, Typeset`show$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xValue$211811$$ = 
     0, $CellContext`showGrids$211812$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = False, $CellContext`xMax$$ = 
         2, $CellContext`xMin$$ = 0, $CellContext`xValue$$ = 
         0.5, $CellContext`yMax$$ = 3, $CellContext`yMin$$ = 
         0, $CellContext`zMax$$ = 7, $CellContext`zMin$$ = 0}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$211811$$, 0], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$211812$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
            ...
            Text[
            "\!\(\*\nStyleBox[\"z\",\nFontSlant->\"Italic\"]\)", {
             0, 0, $CellContext`zMax$$}, {0, -2}]}], $CellContext`plotC13F05, 
          
          Graphics3D[{
            Text[
            "\!\(TraditionalForm\`z = 6 - 2  x - y\)", {0, 1, 5}, {-1, -1}], 
            Text[
            "\!\(TraditionalForm\`A(x)\)", {$CellContext`xValue$$, 1, 0}, {
             0, -6}], 
            AbsoluteThickness[1.5], $CellContext`bcB, 
            Line[{{1, 0, 0}, {1, 2.2, 0}}], 
            Line[{{0, 2, 0}, {1.2, 2, 0}}], $CellContext`bcR, Thick, 
            Line[{{$CellContext`xValue$$, 0, 
               $CellContext`funcC13F05[$CellContext`xValue$$, 
                0]}, {$CellContext`xValue$$, 2, 
               $CellContext`funcC13F05[$CellContext`xValue$$, 2]}}], 
            
            Line[{{$CellContext`xValue$$, 0, 0}, {$CellContext`xValue$$, 2, 
               0}}], 
            Opacity[0.3], 
            
            Polygon[{{$CellContext`xValue$$, 0, 0}, {$CellContext`xValue$$, 2,
                0}, {$CellContext`xValue$$, 2, 
               $CellContext`funcC13F05[$CellContext`xValue$$, 
                2]}, {$CellContext`xValue$$, 0, 
               $CellContext`funcC13F05[$CellContext`xValue$$, 0]}}]}]}, 
...
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
           ...
           Inset[
            Framed[
             Pane[
             "A slice at a fixed value of \!\(TraditionalForm\`x\) has area \
\!\(TraditionalForm\`A(x)\), where \!\(TraditionalForm\`0 \[LessEqual] x \
\[LessEqual] 1\).", {200, Automatic}, $CellContext`bcPBS], $CellContext`bcFO], 
            ImageScaled[{0.5, 0}], 
            ImageScaled[{0.5, 0}]]}], 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`plotC13F05 = 
          Graphics3D[
...
T2/vuy4cx3Ecx3Ecx3Ecx3Ecx3EcHwr/BLsZhQo=
          ...
          RGBColor[0.8, 0, 0.4], $CellContext`funcC13F05[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.1, Figure 13.05"], "Header"]}, {
   Cell[
    TextData["Section 13.1, Figure 13.05"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 37857, 717, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature CIzgARWssItiyLOcwT105tlO *)
