...
NotebookDataLength[     45957,       1037]
NotebookOptionsPosition[     13295,        279]
NotebookOutlinePosition[     46733,       1049]
CellTagsIndexPosition[     46690,       1046]
WindowTitle->Section 13.3, Figure 13.37
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showPolarGrid$$ = 
     ...
     Pi, $CellContext`\[Beta]Value$$ = Rational[1, 6] 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        Style["\[Theta]", Larger]}, Rational[-1, 6] Pi, Rational[1, 6] Pi, 
       Rational[1, 24] Pi}, {{
        Hold[$CellContext`\[Theta]Value$$], Rational[1, 12] Pi, ""}, 
       Rational[-1, 6] Pi, Rational[1, 6] Pi, 0.01}, {{
       ...
       Hold[
        ...
        Hold[$CellContext`\[Beta]Value$$], Rational[1, 6] Pi, 
        Style["\[Beta]", Larger]}, 0, Rational[2, 3] Pi}}, Typeset`size$$ = {
     360., {177., 183.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`\[Theta]Value$213834$$ = 
     0, $CellContext`showPolarGrid$213835$$ = 
     False, $CellContext`\[Alpha]Value$213836$$ = 
     0, $CellContext`\[Beta]Value$213837$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showPolarGrid$$ = 
         False, $CellContext`\[Alpha]Value$$ = 
         Rational[-1, 6] Pi, $CellContext`\[Beta]Value$$ = 
         Rational[1, 6] Pi, $CellContext`\[Theta]Value$$ = 
         Rational[1, 12] Pi}, "ControllerVariables" :> {
         Hold[$CellContext`\[Theta]Value$$, \
$CellContext`\[Theta]Value$213834$$, 0], 
         Hold[$CellContext`showPolarGrid$$, \
$CellContext`showPolarGrid$213835$$, False], 
         Hold[$CellContext`\[Alpha]Value$$, \
$CellContext`\[Alpha]Value$213836$$, 0], 
         Hold[$CellContext`\[Beta]Value$$, $CellContext`\[Beta]Value$213837$$,
           0]}, "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          PolarPlot[{
            $CellContext`funcC13F37a[$CellContext`t], 
            $CellContext`funcC13F37b[$CellContext`t]}, {$CellContext`t, 0, 2 
            Pi}, PlotStyle -> {{Thick, $CellContext`bcR}, {Thick, Black}}, 
           Prolog -> {$CellContext`bcAreaPositiveColor, 
             Polygon[
              Join[{$CellContext`funcC13F37a[$CellContext`\[Alpha]Value$$] {
                  Cos[$CellContext`\[Alpha]Value$$], 
                  Sin[$CellContext`\[Alpha]Value$$]}}, 
               
               Table[$CellContext`funcC13F37b[$CellContext`\[Alpha]Value$$ + \
...
(($CellContext`\[Beta]Value$$ - $CellContext`\[Alpha]Value$$)/
               ...
               Table[$CellContext`funcC13F37a[$CellContext`\[Beta]Value$$ - \
$CellContext`i (($CellContext`\[Beta]Value$$ - $CellContext`\[Alpha]Value$$)/
                   25)] {
...
(($CellContext`\[Beta]Value$$ - $CellContext`\[Alpha]Value$$)/
           ...
           Epilog -> {$CellContext`bcB, 
             ...
             Line[{{0, 
               0}, $CellContext`funcC13F37a[$CellContext`\[Beta]Value$$] {
                 Cos[$CellContext`\[Beta]Value$$], 
                 Sin[$CellContext`\[Beta]Value$$]}}], 
             Line[{$CellContext`funcC13F37b[$CellContext`\[Beta]Value$$] {
                 Cos[$CellContext`\[Beta]Value$$], 
                 Sin[$CellContext`\[Beta]Value$$]}, 2 {
                 Cos[$CellContext`\[Beta]Value$$], 
                 Sin[$CellContext`\[Beta]Value$$]}}], 
             
             Line[{{0, 
               0}, $CellContext`funcC13F37a[$CellContext`\[Alpha]Value$$] {
                 Cos[$CellContext`\[Alpha]Value$$], 
                 Sin[$CellContext`\[Alpha]Value$$]}}], 
             Line[{$CellContext`funcC13F37b[$CellContext`\[Alpha]Value$$] {
                 Cos[$CellContext`\[Alpha]Value$$], 
                 Sin[$CellContext`\[Alpha]Value$$]}, 2 {
                 Cos[$CellContext`\[Alpha]Value$$], 
                 Sin[$CellContext`\[Alpha]Value$$]}}], 
             Dashing[{}], 
             Line[{$CellContext`funcC13F37a[$CellContext`\[Beta]Value$$] {
                 Cos[$CellContext`\[Beta]Value$$], 
                 
                 Sin[$CellContext`\[Beta]Value$$]}, \
$CellContext`funcC13F37b[$CellContext`\[Beta]Value$$] {
                 Cos[$CellContext`\[Beta]Value$$], 
                 Sin[$CellContext`\[Beta]Value$$]}}], 
             Line[{$CellContext`funcC13F37a[$CellContext`\[Alpha]Value$$] {
                 Cos[$CellContext`\[Alpha]Value$$], 
                 
                 Sin[$CellContext`\[Alpha]Value$$]}, \
$CellContext`funcC13F37b[$CellContext`\[Alpha]Value$$] {
                 Cos[$CellContext`\[Alpha]Value$$], 
                 Sin[$CellContext`\[Alpha]Value$$]}}], $CellContext`bcG, 
             AbsoluteThickness[1.5], 
             Arrow[{$CellContext`funcC13F37a[$CellContext`\[Theta]Value$$] {
                 Cos[$CellContext`\[Theta]Value$$], 
                 
                 Sin[$CellContext`\[Theta]Value$$]}, \
$CellContext`funcC13F37b[$CellContext`\[Theta]Value$$] {
                 Cos[$CellContext`\[Theta]Value$$], 
                 Sin[$CellContext`\[Theta]Value$$]}}], Dashed, 
             
             Line[{{0, 
               0}, $CellContext`funcC13F37a[$CellContext`\[Theta]Value$$] {
                 Cos[$CellContext`\[Theta]Value$$], 
                 Sin[$CellContext`\[Theta]Value$$]}}], 
             Line[{$CellContext`funcC13F37b[$CellContext`\[Theta]Value$$] {
                 Cos[$CellContext`\[Theta]Value$$], 
                 Sin[$CellContext`\[Theta]Value$$]}, 3 {
                 Cos[$CellContext`\[Theta]Value$$], 
                 Sin[$CellContext`\[Theta]Value$$]}}], Black, 
             Text[
             "\!\(TraditionalForm\`r = 2\\ \*SqrtBox[\(cos\\ 2  \
\[Theta]\)]\)", $CellContext`funcC13F37b[Pi/24] {
                Cos[Pi/24], 
                Sin[Pi/24]}, {-1, -2}], 
             Text[
             "\!\(TraditionalForm\`r = \*SqrtBox[\(2\)]\)", \
$CellContext`funcC13F37a[Pi/3] {
                Cos[Pi/3], 
                Sin[Pi/3]}, {1, -3}], 
             Text[
             "\!\(TraditionalForm\`\[Theta] = \(-\*FractionBox[\(\[Pi]\), \(6\
\)]\)\)", 2 {
                Cos[$CellContext`\[Alpha]Value$$], 
...
\)", 2 {
          ...
          If[$CellContext`showPolarGrid$$, 
           $CellContext`PolarGrid[
            Range[0, 3, 0.5], 
            Range[0, 2 Pi, Pi/12]], 
           Graphics[{}]]}, ImageSize -> 5 {72, 72}, 
         PlotRange -> {{-1, 3}, {-2, 2}}, Ticks -> None, AxesStyle -> 
         Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         BaseStyle -> {"Text", 13}], 
       "Specifications" :> {{{$CellContext`\[Theta]Value$$, Rational[1, 12] 
           Pi, 
           Style["\[Theta]", Larger]}, Rational[-1, 6] Pi, Rational[1, 6] Pi, 
          Rational[1, 24] Pi, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`\[Theta]Value$$, Rational[1, 12] Pi, ""}, 
          Rational[-1, 6] Pi, Rational[1, 6] Pi, 0.01, ControlType -> Trigger,
           DefaultDuration -> 10, 
          AppearanceElements -> {
         ...
         Row[{
          ...
          None, ImageSize -> 
          Small}, {{$CellContext`\[Beta]Value$$, Rational[1, 6] Pi, 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{500., {195., 200.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC13F37a[
            Pattern[$CellContext`t, 
             Blank[]]] := Sqrt[2], $CellContext`t[
            Pattern[$CellContext`df, 
             Blank[]]] := PDF[
            
            StudentTDistribution[$CellContext`df], $CellContext`x], \
$CellContext`funcC13F37b[
            Pattern[$CellContext`t, 
             Blank[]]] := 2 Sqrt[
             Cos[2 $CellContext`t]], $CellContext`bcR = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.3, Figure 13.37"], "Header"]}, {
   Cell[
    TextData["Section 13.3, Figure 13.37"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 12016, 246, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature QLjnPTcPo203tL5@02oCq2cJ *)
