...
NotebookDataLength[    136433,       2572]
NotebookOptionsPosition[    103769,       1814]
NotebookOutlinePosition[    137207,       2584]
CellTagsIndexPosition[    137164,       2581]
WindowTitle->Section 13.3, Figure 13.27
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`coords$$ = 1, $CellContext`showGrids$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
       ...
       True, False}}, {{
        Hold[$CellContext`coords$$], 1, ""}, {
       1 -> Pane[
         "rectangular coordinates", {144, Automatic}, Alignment -> Center], 2 -> 
        Pane["polar coordinates", {144, Automatic}, Alignment -> Center]}}, {
       Hold[
        Row[{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showSurface$213148$$ = 
     False, $CellContext`showRegion$213149$$ = 
     False, $CellContext`coords$213150$$ = 
     False, $CellContext`showGrids$213151$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`coords$$ = 1, $CellContext`showGrids$$ = 
         False, $CellContext`showRegion$$ = True, $CellContext`showSurface$$ = 
         True, $CellContext`xMax$$ = 
         4, $CellContext`xMin$$ = -4, $CellContext`yMax$$ = 
         4, $CellContext`yMin$$ = -4, $CellContext`zMax$$ = 
         10, $CellContext`zMin$$ = 0}, "ControllerVariables" :> {
         Hold[$CellContext`showSurface$$, $CellContext`showSurface$213148$$, 
          False], 
         Hold[$CellContext`showRegion$$, $CellContext`showRegion$213149$$, 
          False], 
         Hold[$CellContext`coords$$, $CellContext`coords$213150$$, False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$213151$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          If[$CellContext`showRegion$$, $CellContext`plotC13F27b, 
           Graphics3D[{}]], 
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          If[$CellContext`showSurface$$, $CellContext`plotC13F27a, 
           Graphics3D[{}]], 
          Graphics3D[{
            If[$CellContext`showSurface$$, 
             Text[
              
              Switch[$CellContext`coords$$, 1, 
               "Surface\n\!\(TraditionalForm\`z = 9 - \*SuperscriptBox[\(x\), \
\(2\)] - \*SuperscriptBox[\(y\), \(2\)]\)", 2, 
...
\*SuperscriptBox[\(x\), \(2\)] + \*SuperscriptBox[\(y\), \(2\)] \[LessEqual] \
9}\)", 2, 
               "Region of integration\n\!\(TraditionalForm\`{\((r, \
\[Theta])\) : 0 \[LessEqual] r \[LessEqual] 3, 0 \[LessEqual] \[Theta] \
\[LessEqual] 2  \[Pi]}\)"], {3, 1, 0}, {-1, 1.5}], Black]}]}, 
         PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
            2, $CellContext`zMax$$ + 0.5}}, ImageSize -> 5 {72, 72}, 
         BaseStyle -> {"Text", 13}, Lighting -> "Neutral", Boxed -> False, 
         ViewPoint -> {4, 4, 2}, Axes -> None], 
       "Specifications" :> {{{$CellContext`showSurface$$, True, 
         ...
         Delimiter, {{$CellContext`coords$$, 1, ""}, {
          1 -> Pane[
            "rectangular coordinates", {144, Automatic}, Alignment -> Center],
            2 -> Pane[
            "polar coordinates", {144, Automatic}, Alignment -> Center]}, 
          ControlType -> SetterBar, Appearance -> "Vertical", 
          ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], 
         Delimiter, {{$CellContext`showGrids$$, False, "show grids"}, {
          True, False}, ControlType -> Checkbox}, {{$CellContext`xMin$$, -4}, 
          0, ControlType -> None}, {{$CellContext`xMax$$, 4}, 0, ControlType -> 
      ...
      ImageSizeCache->{548., {195., 200.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`plotC13F27b = Graphics3D[
            GraphicsComplex[CompressedData["
1:
             "], {{{
                EdgeForm[], 
                Opacity[1], 
                RGBColor[
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`plotC13F27a = 
          Graphics3D[
            GraphicsComplex[CompressedData["
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.3, Figure 13.27"], "Header"]}, {
   Cell[
    TextData["Section 13.3, Figure 13.27"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 102490, 1781, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature bLz2H7taXSauYKOlzoYpAUvB *)
