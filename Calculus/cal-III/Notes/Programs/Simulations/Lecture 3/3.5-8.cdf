...
NotebookDataLength[    145907,       2718]
NotebookOptionsPosition[    113226,       1959]
NotebookOutlinePosition[    146681,       2730]
CellTagsIndexPosition[    146638,       2727]
WindowTitle->Section 13.5, Figure 13.54a
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`rValue$$ = 1, $CellContext`showGrids$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showGrids$215495$$ = 
     False, $CellContext`rValue$215496$$ = 
     0, $CellContext`\[Theta]Value$215497$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`rValue$$ = 1, $CellContext`showGrids$$ = 
         ...
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$215495$$, 
          False], 
         Hold[$CellContext`rValue$$, $CellContext`rValue$215496$$, 0], 
         Hold[$CellContext`\[Theta]Value$$, \
$CellContext`\[Theta]Value$215497$$, 0]}, 
       "OtherVariables" :> {
          ...
          Graphics3D[{
            If[
             And[$CellContext`showLabels$$, $CellContext`showRegionD$$], {
              ...
              Text[
              "\!\(TraditionalForm\`z = 12 - \*SuperscriptBox[\(x\), \(2\)] - \
\*SuperscriptBox[\(y\), \(2\)]\)", {3 Cos[(-Pi)/4], 3 Sin[(-Pi)/4], 7}, {1, 
               0}], 
              Text[
              "\!\(TraditionalForm\`z = \*SqrtBox[\(\*SuperscriptBox[\(x\), \
\(2\)]\\  + \*SuperscriptBox[\(y\), \(2\)]\)]\)", {
               3 Cos[(-Pi)/4], 3 Sin[(-Pi)/4], 1.5}, {1, 0}]}, Black]}], 
          If[$CellContext`showRegionD$$, $CellContext`plotC13F54a, 
           Graphics3D[{}]]}, 
...
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
       ...
       "Specifications" :> {{{$CellContext`showGrids$$, False, 
           "show grids"}, {True, False}, ControlType -> 
          Checkbox}, {{$CellContext`rValue$$, 1, 
           Style["r", Larger]}, 0, 3, ControlType -> None, ImageSize -> 
          Small}, {{$CellContext`rValue$$, 1, ""}, 0, 3, 0.01, ControlType -> 
          None, DefaultDuration -> 20, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", 
            "StepRightButton"}}, {{$CellContext`\[Theta]Value$$, 
           Rational[2, 3] Pi, 
           Style["\[Theta]", Larger]}, 0, 2 Pi, ControlType -> None, 
          ImageSize -> 
          Small}, {{$CellContext`\[Theta]Value$$, Rational[2, 3] Pi, ""}, 0, 
          2 Pi, 0.01, ControlType -> None, DefaultDuration -> 20, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", 
            "StepRightButton"}}, {{$CellContext`showRegionD$$, True, 
           "show region \!\(\*\nStyleBox[\"D\",\nFontSlant->\"Italic\"]\)"}, 
          0, ControlType -> None, ControlPlacement -> 
          1}, {{$CellContext`showRegionR$$, True, 
           "show region \!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)"}, 
          0, ControlType -> None, ControlPlacement -> 2}, 
         Grid[{{
            Manipulate`Place[1]}, {
            Manipulate`Place[2]}}, Alignment -> 
          Right], {{$CellContext`showLabels$$, True, "show labels"}, 0, 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`plotC13F54a = {
            Graphics3D[
         ...
         GridBox[{{"\"Section \"", "\"13.5\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"13\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"54a\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.54a"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.54a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1276, 31, 111946, 1926, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 3L4cKfbJt@#CqI5EshGhmruw *)
