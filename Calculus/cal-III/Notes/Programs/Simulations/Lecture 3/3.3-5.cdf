...
NotebookDataLength[     56867,       1249]
NotebookOptionsPosition[     24205,        491]
NotebookOutlinePosition[     57643,       1261]
CellTagsIndexPosition[     57600,       1258]
WindowTitle->Section 13.3, Figure 13.32
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`restrictDomain$$ = 
     False, $CellContext`showBottomFunction$$ = 
     False, $CellContext`showFirstOctant$$ = False, $CellContext`showGrids$$ =
      False, $CellContext`showIntegrationDomain$$ = 
     False, $CellContext`showIntersection$$ = 
     False, $CellContext`showTopFunction$$ = True, $CellContext`xMax$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        Hold[$CellContext`showTopFunction$$], True, 
        "\!\(TraditionalForm\`z = \(8 - \*SuperscriptBox[\(x\), \(2\)] - \
\*SuperscriptBox[\(y\), \(2\)] = 8 - \*SuperscriptBox[\(r\), \(2\)]\)\)"}, {
       True, False}}, {{
        Hold[$CellContext`showBottomFunction$$], False, 
        "\!\(TraditionalForm\`z = \(\*SuperscriptBox[\(x\), \(2\)] + \
\*SuperscriptBox[\(y\), \(2\)] = \*SuperscriptBox[\(r\), \(2\)]\)\)"}, {
       True, False}}, {{
        Hold[$CellContext`restrictDomain$$], False, "restrict domain"}, {
       True, False}}, {{
        Hold[$CellContext`showIntersection$$], False, 
        "show intersection \!\(\*\nStyleBox[\"C\",\n\
FontSlant->\"Italic\"]\)"}, {True, False}}, {{
        Hold[$CellContext`showIntegrationDomain$$], False, 
        "show region \!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)"}, {
       True, False}}, {{
        Hold[$CellContext`showFirstOctant$$], False, 
        "restrict to first quadrant"}, {True, False}}, {{
        Hold[$CellContext`showGrids$$], False, "show grids"}, {True, False}}},
      Typeset`size$$ = {432., {213., 219.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`showTopFunction$213454$$ = 
     False, $CellContext`showBottomFunction$213455$$ = 
     False, $CellContext`restrictDomain$213456$$ = 
     False, $CellContext`showIntersection$213457$$ = 
     False, $CellContext`showIntegrationDomain$213458$$ = 
     False, $CellContext`showFirstOctant$213459$$ = 
     False, $CellContext`showGrids$213460$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`restrictDomain$$ = 
         False, $CellContext`showBottomFunction$$ = 
         False, $CellContext`showFirstOctant$$ = 
         ...
         Hold[$CellContext`showTopFunction$$, \
$CellContext`showTopFunction$213454$$, False], 
         Hold[$CellContext`showBottomFunction$$, \
$CellContext`showBottomFunction$213455$$, False], 
         Hold[$CellContext`restrictDomain$$, \
$CellContext`restrictDomain$213456$$, False], 
         Hold[$CellContext`showIntersection$$, \
$CellContext`showIntersection$213457$$, False], 
         Hold[$CellContext`showIntegrationDomain$$, \
$CellContext`showIntegrationDomain$213458$$, False], 
         Hold[$CellContext`showFirstOctant$$, \
$CellContext`showFirstOctant$213459$$, False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$213460$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          ParametricPlot3D[{{$CellContext`r 
             ...
             $CellContext`funcC13F23a[$CellContext`r, \
$CellContext`\[Theta]]}, {$CellContext`r 
             Cos[$CellContext`\[Theta]], $CellContext`r 
             Sin[$CellContext`\[Theta]], 
             $CellContext`funcC13F23b[$CellContext`r, \
$CellContext`\[Theta]]}}, {$CellContext`r, 0, 
            
            If[$CellContext`restrictDomain$$, 2, 8^
             Rational[1, 2]]}, {$CellContext`\[Theta], 0, 
            If[$CellContext`showFirstOctant$$, Pi/2, 2 Pi]}, PlotStyle -> {
             If[$CellContext`showTopFunction$$, {
               Opacity[0.8], $CellContext`bcSurfaceTop, 
               Specularity[White, 100]}, None], 
             If[$CellContext`showBottomFunction$$, {
               Opacity[0.8], $CellContext`bcB, 
               Specularity[White, 100]}, None]}, Mesh -> None], 
          If[$CellContext`showFirstOctant$$, {
            
            ParametricPlot3D[{{$CellContext`r, 
               0, (1 - $CellContext`u) \
$CellContext`funcC13F23a[$CellContext`r, 0] + $CellContext`u 
                If[$CellContext`restrictDomain$$, 4, 0]}, {$CellContext`r, 
               0, $CellContext`u $CellContext`funcC13F23b[$CellContext`r, 
                  0] + (1 - $CellContext`u) 
                If[$CellContext`restrictDomain$$, 4, 8]}}, {$CellContext`r, 0, 
              
              If[$CellContext`restrictDomain$$, 2, 8^
               Rational[1, 2]]}, {$CellContext`u, 0, 1}, PlotStyle -> {
               If[$CellContext`showTopFunction$$, 
                Darker[$CellContext`bcAreaPositiveColor], None], 
               If[$CellContext`showBottomFunction$$, 
                Darker[$CellContext`bcAreaPositiveColor], None]}, Mesh -> 
             None], 
            
            ParametricPlot3D[{{
              0, $CellContext`r, (
                 1 - $CellContext`u) $CellContext`funcC13F23a[$CellContext`r, 
                  Pi/2] + $CellContext`u 
                If[$CellContext`restrictDomain$$, 4, 0]}, {
              0, $CellContext`r, $CellContext`u \
$CellContext`funcC13F23b[$CellContext`r, Pi/2] + (1 - $CellContext`u) 
                If[$CellContext`restrictDomain$$, 4, 8]}}, {$CellContext`r, 0, 
             ...
             None]}, 
           Graphics3D[{}]], 
          If[$CellContext`showIntersection$$, 
           
           ParametricPlot3D[{
            2 Cos[$CellContext`\[Theta]], 2 Sin[$CellContext`\[Theta]], 
             4}, {$CellContext`\[Theta], 0, 
             If[$CellContext`showFirstOctant$$, Pi/2, 2 Pi]}, PlotStyle -> {{
               AbsoluteThickness[3], $CellContext`bcR}}], 
           Graphics3D[{}]], 
          If[$CellContext`showIntegrationDomain$$, {
            
            ParametricPlot3D[{$CellContext`r 
              Cos[$CellContext`\[Theta]], $CellContext`r 
              Sin[$CellContext`\[Theta]], 0}, {$CellContext`r, 0, 
              2}, {$CellContext`\[Theta], 0, 
              If[$CellContext`showFirstOctant$$, Pi/2, 2 Pi]}, Mesh -> None, 
             PlotStyle -> {{
            ...
            Inset[
             Framed[
              Pane[
               ...
               If[$CellContext`showFirstOctant$$, 
                "Projection of \!\(TraditionalForm\`C\) on\n\!\(\*\nStyleBox[\
\"xy\",\nFontSlant->\"Italic\"]\)-plane: \!\(TraditionalForm\`r = 2\)", 
                "Projection of \!\(TraditionalForm\`C\) on\n\!\(\*\nStyleBox[\
\"xy\",\nFontSlant->\"Italic\"]\)-plane: \!\(TraditionalForm\`r = 2\)"], \
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], 
             ImageScaled[{0.01, 0.01}], 
             ImageScaled[{0, 0}]], Black]}], 
       "Specifications" :> {{{$CellContext`xMin$$, -4}, 0, ControlType -> 
          ...
          None}, {{$CellContext`showTopFunction$$, True, 
           "\!\(TraditionalForm\`z = \(8 - \*SuperscriptBox[\(x\), \(2\)] - \
\*SuperscriptBox[\(y\), \(2\)] = 8 - \*SuperscriptBox[\(r\), \(2\)]\)\)"}, {
          True, False}, ControlType -> 
          Checkbox}, {{$CellContext`showBottomFunction$$, False, 
           "\!\(TraditionalForm\`z = \(\*SuperscriptBox[\(x\), \(2\)] + \
\*SuperscriptBox[\(y\), \(2\)] = \*SuperscriptBox[\(r\), \(2\)]\)\)"}, {
          True, False}, ControlType -> Checkbox}, 
         Delimiter, {{$CellContext`restrictDomain$$, False, 
           "restrict domain"}, {True, False}, ControlType -> 
          Checkbox}, {{$CellContext`showIntersection$$, False, 
           "show intersection \!\(\*\nStyleBox[\"C\",\nFontSlant->\"Italic\"]\
\)"}, {True, False}, ControlType -> 
          Checkbox}, {{$CellContext`showIntegrationDomain$$, False, 
           "show region \!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)"}, {
          True, False}, ControlType -> 
          Checkbox}, {{$CellContext`showFirstOctant$$, False, 
           "restrict to first quadrant"}, {True, False}, ControlType -> 
          Checkbox}, 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          1, $CellContext`funcC13F23a[
            Pattern[$CellContext`r, 
             Blank[]], 
            Pattern[$CellContext`\[Theta], 
             Blank[]]] := 8 - $CellContext`r^2, $CellContext`funcC13F23a[
            Pattern[$CellContext`x, 
             Blank[]]] := 4 - $CellContext`x^2, $CellContext`funcC13F23b[
            Pattern[$CellContext`r, 
             Blank[]], 
            Pattern[$CellContext`\[Theta], 
             Blank[]]] := $CellContext`r^2, $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.3, Figure 13.32"], "Header"]}, {
   Cell[
    TextData["Section 13.3, Figure 13.32"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 22926, 458, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature VLjCtodY6FeQJIkBetd9yKgm *)
