...
NotebookDataLength[    112052,       2158]
NotebookOptionsPosition[     79372,       1399]
NotebookOutlinePosition[    112827,       2170]
CellTagsIndexPosition[    112784,       2167]
WindowTitle->Section 13.5, Figure 13.53a
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`rValue$$ = 1, $CellContext`showGrids$$ = 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showGrids$215332$$ = 
     False, $CellContext`rValue$215333$$ = 
     0, $CellContext`\[Theta]Value$215334$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`rValue$$ = 1, $CellContext`showGrids$$ = 
         ...
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$215332$$, 
          False], 
         Hold[$CellContext`rValue$$, $CellContext`rValue$215333$$, 0], 
         Hold[$CellContext`\[Theta]Value$$, \
$CellContext`\[Theta]Value$215334$$, 0]}, 
       "OtherVariables" :> {
...
\(2\)]\)", {1.5 Cos[(-Pi)/4], 1.5 Sin[(-Pi)/4], 3.5}]}, Black]}], 
          If[$CellContext`showRegionR$$, {
           ...
           Graphics3D[{}]], 
          If[$CellContext`showRegionD$$, $CellContext`plotC13F53a, 
           Graphics3D[{}]]}, 
...
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
       ...
       "Specifications" :> {{{$CellContext`showGrids$$, False, 
          ...
          Checkbox}, {{$CellContext`rValue$$, 1, 
           Style["r", Larger]}, 0, 2, ControlType -> None, ImageSize -> 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          1, $CellContext`bcAreaPositiveColor = 
          RGBColor[0.796, 0.91, 0.855], $CellContext`plotC13F53a = {
            Graphics3D[
         ...
         GridBox[{{"\"Section \"", "\"13.5\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"13\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"53a\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.53a"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.53a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1276, 31, 78092, 1366, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature NK4koXictPWTiKk96tQcCCZs *)
