...
NotebookDataLength[     59424,       1318]
NotebookOptionsPosition[     26762,        560]
NotebookOutlinePosition[     60200,       1330]
CellTagsIndexPosition[     60157,       1327]
WindowTitle->Section 13.4, Figure 13.45
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
     ...
     3, $CellContext`xMax$$ = 2, $CellContext`xMin$$ = 
     0, $CellContext`xStart$$ = 0, $CellContext`yEnd$$ = 
     2, $CellContext`yMax$$ = 2, $CellContext`yMin$$ = 
     0, $CellContext`yStart$$ = 0, $CellContext`yValue$$ = 
     0.5, $CellContext`zMax$$ = 2, $CellContext`zMin$$ = 
     0, $CellContext`zValue$$ = 1.2, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`yValue$$], 0.5, 
        "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 0, 2, 0.01}, {{
        Hold[$CellContext`yValue$$], 0.5, ""}, 0, 2, 0.01}, {
       Hold[
        Spacer[{0, 8}]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`zValue$$], 1.2, "z"}, 0, 2, 0.01}, {{
        Hold[$CellContext`zValue$$], 1.2, ""}, 0, 2, 0.01}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`yValue$214697$$ = 
     0, $CellContext`zValue$214698$$ = 0, $CellContext`showRegionD$214699$$ = 
     False, $CellContext`showRegionR$214700$$ = 
     False, $CellContext`showLabels$214701$$ = 
     False, $CellContext`showGrids$214702$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
         ...
         0, $CellContext`yStart$$ = 0, $CellContext`yValue$$ = 
         0.5, $CellContext`zMax$$ = 2, $CellContext`zMin$$ = 
         0, $CellContext`zValue$$ = 1.2}, "ControllerVariables" :> {
         Hold[$CellContext`yValue$$, $CellContext`yValue$214697$$, 0], 
         Hold[$CellContext`zValue$$, $CellContext`zValue$214698$$, 0], 
         Hold[$CellContext`showRegionD$$, $CellContext`showRegionD$214699$$, 
          False], 
         Hold[$CellContext`showRegionR$$, $CellContext`showRegionR$214700$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$214701$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$214702$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          Graphics3D[{
            ...
            If[
             ...
             And[$CellContext`yValue$$ <= $CellContext`zValue$$, \
$CellContext`zValue$$ <= Pi^0.25], {Thin, Gray, 
              
              Line[{{0, $CellContext`yValue$$, $CellContext`zValue$$}, \
{$CellContext`yValue$$, $CellContext`yValue$$, $CellContext`zValue$$}}], 
              AbsoluteThickness[2.5], 
              Arrowheads[0.03], $CellContext`bcG, 
              Arrow[
               
               Tube[{{$CellContext`yValue$$, $CellContext`yValue$$, \
$CellContext`zValue$$}, {$CellContext`zValue$$, $CellContext`yValue$$, \
$CellContext`zValue$$}}]], Thin, Gray, 
              
              Line[{{$CellContext`zValue$$, $CellContext`yValue$$, \
$CellContext`zValue$$}, {$CellContext`xMax$$, $CellContext`yValue$$, \
$CellContext`zValue$$}}], 
              AbsolutePointSize[5], $CellContext`bcR, 
              
              Point[{$CellContext`yValue$$, $CellContext`yValue$$, \
$CellContext`zValue$$}], 
              
              Point[{$CellContext`zValue$$, $CellContext`yValue$$, \
$CellContext`zValue$$}]}, {Thin, Gray, 
              
              Line[{{0, $CellContext`yValue$$, $CellContext`zValue$$}, \
{$CellContext`xMax$$, $CellContext`yValue$$, $CellContext`zValue$$}}]}]}], 
          If[$CellContext`showRegionD$$, 
           Graphics3D[{$CellContext`bcSurfaceTop, 
             Opacity[0.5], 
             Specularity[White, 100], 
             Polygon[{{0, 0, 0}, {Pi^0.25, 0, Pi^0.25}, {0, 0, Pi^0.25}}], 
             
             Polygon[{{0, 0, 0}, {Pi^0.25, Pi^0.25, Pi^0.25}, {
               0, 0, Pi^0.25}}], 
             
             Polygon[{{0, 0, Pi^0.25}, {Pi^0.25, 0, Pi^0.25}, {
...
{$CellContext`xMax$$, $CellContext`yValue$$, $CellContext`zValue$$}}]}], 
             ...
             If[$CellContext`showLabels$$, {
               Text[
               "\!\(TraditionalForm\`\*RadicalBox[\(\[Pi]\), \(4\)]\)", {
                0, 0, Pi^0.25}, {1.5, -1.5}], 
               Text[
               "\!\(TraditionalForm\`z = \*RadicalBox[\(\[Pi]\), \(4\)]\)", {
                1, 0, 1.5}, {1, -1}], 
               Line[{{1, 0, 1.5}, {1, 0.3, Pi^0.25}}], 
               Text["\!\(TraditionalForm\`D\)", {1, 0.5, 1}, {0, 2}], 
               Text[
               "The plane\n\!\(TraditionalForm\`x = z\)", {1, 0, 0.7}, {1, 
                1}], 
               Line[{{1, 0, 0.7}, {1, 0.3, 1}}], 
               Text[
               "The plane\n\!\(TraditionalForm\`x = y\)", {
                0, 0.5, 1.5}, {-1, -1}], 
               Line[{{0, 0.5, 1.5}, {0.3, 0.3, 1.2}}]}, Black]}], 
           Graphics3D[{Thin, Gray, 
...
{$CellContext`xMax$$, $CellContext`yValue$$, $CellContext`zValue$$}}]}]], 
          If[$CellContext`showRegionR$$, 
           Graphics3D[{
             If[$CellContext`showLabels$$, {
               Text["\!\(TraditionalForm\`R\)", {0, 0.9, 1}, {0, -1}], 
               Text[
                Pane[
                "The line \!\(TraditionalForm\`y = z\)\nin the \!\(\*\n\
StyleBox[\"yz\",\nFontSlant->\"Italic\"]\)-plane", $CellContext`bcPBS], {
                0, 1, 0.8}, {-1, 1}], 
               Line[{{0, 1, 0.8}, {0, 0.8, 0.8}}]}, Black], 
             AbsoluteThickness[3], 
             Arrowheads[0.03], $CellContext`bcR, 
             Arrow[{{0, 0, 0}, {0, 0, Pi^0.25}}], 
             If[$CellContext`zValue$$ <= Pi^0.25, {
               AbsoluteThickness[2], $CellContext`bcB, 
               
               Arrow[{{0, 0, $CellContext`zValue$$}, {
                 0, $CellContext`zValue$$, $CellContext`zValue$$}}]}, Black], 
             
             Darker[$CellContext`bcAreaPositiveColor, 0.3], 
             Opacity[0.5], 
             Polygon[{{0, 0, 0}, {0, Pi^0.25, Pi^0.25}, {0, 0, Pi^0.25}}]}], 
           Graphics3D[{}]]}, 
         PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$}}, ImageSize -> 6 {72, 72}, BaseStyle -> {"Text", 13}, 
         Lighting -> "Neutral", Boxed -> False, ViewPoint -> {4, 3, 1.5}, 
         Epilog -> {
           If[
            And[$CellContext`showLabels$$, $CellContext`showRegionR$$], {
             Inset[
              Framed[
               Pane[
               "\!\(TraditionalForm\`R\) is a triangular region in the \!\(\*\
\nStyleBox[\"yz\",\nFontSlant->\"Italic\"]\)\[Hyphen]plane", {
             ...
             Inset[
              Framed[
               Pane[
               "Middle integral:\n\!\(TraditionalForm\`y\) varies from 0 to \
\!\(TraditionalForm\`z\).\nOuter integral:\n\!\(TraditionalForm\`z\) varies \
from 0 to \!\(TraditionalForm\`\*RadicalBox[\(\[Pi]\), \(4\)]\).", {
                Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO,
                Background -> White], 
              ImageScaled[{0.8, 0.01}], 
           ...
           If[
            And[$CellContext`showLabels$$, $CellContext`showRegionD$$], {
             Inset[
              Framed[
               Pane[
               "Inner integral:\n\!\(TraditionalForm\`x\) varies from \
\!\(TraditionalForm\`y\) to \!\(TraditionalForm\`z\).", {
                110, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> White], 
              ImageScaled[{0.01, 0.01}], 
              ImageScaled[{0, 0}]]}, Black]}], 
       "Specifications" :> {{{$CellContext`yValue$$, 0.5, 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 0, 2, 0.01, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`yValue$$, 0.5, ""}, 0, 2, 0.01, ControlType -> 
          Trigger, DefaultDuration -> 20, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
         Spacer[{0, 8}], {{$CellContext`zValue$$, 1.2, "z"}, 0, 2, 0.01, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`zValue$$, 1.2, ""}, 0, 2, 0.01, ControlType -> 
          Trigger, DefaultDuration -> 20, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
...
$CellContext`PlaneGrids}, {$CellContext`opts}], 
        ...
        BaseStyle -> {
          LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           ...
           Left, FontSize -> 13}, $CellContext`bcB = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.4, Figure 13.45"], "Header"]}, {
   Cell[
    TextData["Section 13.4, Figure 13.45"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 25483, 527, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 8IzpY5l6WH3FdJ5SupSNqMWu *)
