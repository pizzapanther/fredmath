...
NotebookDataLength[     58759,       1305]
NotebookOptionsPosition[     26097,        547]
NotebookOutlinePosition[     59535,       1317]
CellTagsIndexPosition[     59492,       1314]
WindowTitle->Section 13.4, Figure 13.46
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
     ...
     0.5, $CellContext`yEnd$$ = 2, $CellContext`yMax$$ = 
     2, $CellContext`yMin$$ = 0, $CellContext`yStart$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        Hold[$CellContext`xValue$$], 0.5, ""}, 0, 2, 0.01}, {
       Hold[
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xValue$214798$$ = 
     0, $CellContext`zValue$214799$$ = 0, $CellContext`showRegionD$214800$$ = 
     False, $CellContext`showRegionR$214801$$ = 
     False, $CellContext`showLabels$214802$$ = 
     False, $CellContext`showGrids$214803$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0, $CellContext`bValue$$ = 
         ...
         Hold[$CellContext`xValue$$, $CellContext`xValue$214798$$, 0], 
         Hold[$CellContext`zValue$$, $CellContext`zValue$214799$$, 0], 
         Hold[$CellContext`showRegionD$$, $CellContext`showRegionD$214800$$, 
          False], 
         Hold[$CellContext`showRegionR$$, $CellContext`showRegionR$214801$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$214802$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$214803$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          Graphics3D[{
            ...
            If[
             ...
             And[$CellContext`xValue$$ <= $CellContext`zValue$$, \
$CellContext`zValue$$ <= Pi^0.25], {
...
$CellContext`xValue$$, $CellContext`zValue$$}}]], Thin, Gray, 
              
              Line[{{$CellContext`xValue$$, $CellContext`xValue$$, \
$CellContext`zValue$$}, {$CellContext`xValue$$, $CellContext`yMax$$, \
$CellContext`zValue$$}}], 
              AbsolutePointSize[5], $CellContext`bcR, 
              Point[{$CellContext`xValue$$, 0, $CellContext`zValue$$}], 
              
              Point[{$CellContext`xValue$$, $CellContext`xValue$$, \
$CellContext`zValue$$}]}, {Thin, Gray, 
              
              Line[{{$CellContext`xValue$$, 
                 0, $CellContext`zValue$$}, {$CellContext`xValue$$, \
$CellContext`yMax$$, $CellContext`zValue$$}}]}], Black}], 
...
$CellContext`yMax$$, $CellContext`zValue$$}}]}]], 
          If[$CellContext`showRegionR$$, 
           Graphics3D[{
             If[$CellContext`showLabels$$, {
               Text["\!\(TraditionalForm\`R\)", {0.9, 0, 1.1}, {0, -1}]}, 
              Black], 
             AbsoluteThickness[3], 
             ...
             If[$CellContext`zValue$$ <= Pi^0.25, {
               ...
               Arrow[{{
                 0, 0, $CellContext`zValue$$}, {$CellContext`zValue$$, 
                  0, $CellContext`zValue$$}}]}, Black], 
...
\nStyleBox[\"xz\",\nFontSlant->\"Italic\"]\)\[Hyphen]plane", {
             ...
             Inset[
              Framed[
               Pane[
               "Middle integral:\n\!\(TraditionalForm\`x\) varies from 0 to \
           ...
           If[
            And[$CellContext`showLabels$$, $CellContext`showRegionD$$], {
             Inset[
              Framed[
               Pane[
               "Inner integral:\ny varies from \!\(TraditionalForm\`0\) to \!\
\(TraditionalForm\`x\).", {
       ...
       "Specifications" :> {{{$CellContext`xValue$$, 0.5, 
          ...
          Small}, {{$CellContext`xValue$$, 0.5, ""}, 0, 2, 0.01, ControlType -> 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.4, Figure 13.46"], "Header"]}, {
   Cell[
    TextData["Section 13.4, Figure 13.46"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 24818, 514, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature yIjpRGbyhxeYRL#@TNyCjMiO *)
