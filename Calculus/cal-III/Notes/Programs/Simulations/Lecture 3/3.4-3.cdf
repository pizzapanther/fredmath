...
NotebookDataLength[    230212,       4163]
NotebookOptionsPosition[    197548,       3405]
NotebookOutlinePosition[    230986,       4175]
CellTagsIndexPosition[    230943,       4172]
WindowTitle->Section 13.4, Figure 13.40
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0.8417, $CellContext`bValue$$ = 
     ...
     3, $CellContext`yEnd$$ = 4.2, $CellContext`yMax$$ = 
     5, $CellContext`yMin$$ = 0, $CellContext`yStart$$ = 
     0.8, $CellContext`yValue$$ = 2, $CellContext`zMax$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        ...
        Hold[$CellContext`xValue$$], 3, ""}, 0, 5, 0.1}, {
       Hold[
        Spacer[{0, 8}]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`yValue$$], 2, 
        "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 0, 5}, {{
        Hold[$CellContext`yValue$$], 3, ""}, 0, 5, 0.1}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`xValue$214180$$ = 
     0, $CellContext`yValue$214181$$ = 0, $CellContext`showRegionD$214182$$ = 
     False, $CellContext`showRegionR$214183$$ = 
     False, $CellContext`showLabels$214184$$ = 
     False, $CellContext`showGrids$214185$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0.8417, $CellContext`bValue$$ = 
         ...
         Hold[$CellContext`xValue$$, $CellContext`xValue$214180$$, 0], 
         Hold[$CellContext`yValue$$, $CellContext`yValue$214181$$, 0], 
         Hold[$CellContext`showRegionD$$, $CellContext`showRegionD$214182$$, 
          False], 
         Hold[$CellContext`showRegionR$$, $CellContext`showRegionR$214183$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$214184$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$214185$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          Graphics3D[{
            ...
            If[
             ...
             And[$CellContext`aValue$$ <= $CellContext`xValue$$ <= \
$CellContext`bValue$$, $CellContext`showRegionR$$], {Thin, Gray, 
              
              Line[{{$CellContext`xValue$$, 0, 
                 0.02}, {$CellContext`xValue$$, 
                 $CellContext`funcC13F40a[$CellContext`xValue$$], 0.02}}], 
              AbsoluteThickness[2], Orange, 
              Arrow[{{$CellContext`xValue$$, 
                 $CellContext`funcC13F40a[$CellContext`xValue$$], 
                 0.02}, {$CellContext`xValue$$, 
                 $CellContext`funcC13F40b[$CellContext`xValue$$], 0.02}}], 
              Thin, Gray, 
            ...
            If[$CellContext`showLabels$$, {
              If[$CellContext`showRegionR$$, {
                Text[
                 Style["\!\(TraditionalForm\`R\)", Larger], {3.2, 3, 0}], 
                Text["\!\(TraditionalForm\`y = g(x)\)", {3.5, 
                  $CellContext`funcC13F40a[3.5], 0}, {1.5, 0}], 
                Text["\!\(TraditionalForm\`y = h(x)\)", {2, 
                  $CellContext`funcC13F40b[2], 0}, {-1.5, 0}]}, Black], 
              Text[
              "\!\(TraditionalForm\`a\)", {$CellContext`aValue$$, 0, 0}, {
               1.5, -1}], 
              Text[
              "\!\(TraditionalForm\`b\)", {$CellContext`bValue$$, 0, 0}, {
               1.5, -1}], 
              Text[
               Framed[
                Pane[
                "\!\(TraditionalForm\`x\) varies\nfrom \!\(TraditionalForm\`a\
\) to \!\(TraditionalForm\`b\)", $CellContext`bcPBS], $CellContext`bcFO, 
                Background -> 
              ...
              If[$CellContext`showRegionD$$, {
                Text[
                 Style["\!\(TraditionalForm\`D\)", Larger], {2.5, 
                  $CellContext`funcC13F40a[2.5], 
                  0.85 $CellContext`funcC13F40c[2.5, 
                    $CellContext`funcC13F40a[2.5]]}], 
                Text["\!\(TraditionalForm\`H(x, y)\)", {2, 
                  $CellContext`funcC13F40b[2], 
                  $CellContext`funcC13F40c[2, 
                   $CellContext`funcC13F40b[2]]}, {-1.5, -1}], 
                Text["\!\(TraditionalForm\`G(x, y)\)", {2, 
                  $CellContext`funcC13F40b[2], 
                  $CellContext`funcC13F40d[2, 
                   $CellContext`funcC13F40b[2]]}, {-1.5, 4}]}, Black]}, 
             Black]}], 
          If[$CellContext`showRegionR$$, {
            ParametricPlot3D[{{$CellContext`x, 
               $CellContext`funcC13F40a[$CellContext`x], 
               0}, {$CellContext`x, 
               $CellContext`funcC13F40b[$CellContext`x], 
               0}}, {$CellContext`x, $CellContext`aValue$$, \
$CellContext`bValue$$}, 
             PlotStyle -> {{Thick, $CellContext`bcR}, {
               Thick, Black}}], $CellContext`plotC13F40R}, 
           Graphics3D[{}]], 
          If[$CellContext`showRegionD$$, {$CellContext`plotC13F40, 
            ParametricPlot3D[{{$CellContext`x, 
               $CellContext`funcC13F40a[$CellContext`x], $CellContext`u \
$CellContext`funcC13F40d[$CellContext`x, 
                  $CellContext`funcC13F40a[$CellContext`x]] + (
                 1 - $CellContext`u) $CellContext`funcC13F40c[$CellContext`x, \

                  $CellContext`funcC13F40a[$CellContext`x]]}, {$CellContext`x, 
               $CellContext`funcC13F40b[$CellContext`x], $CellContext`u \
$CellContext`funcC13F40d[$CellContext`x, 
                  $CellContext`funcC13F40b[$CellContext`x]] + (
                 1 - $CellContext`u) $CellContext`funcC13F40c[$CellContext`x, \
...
$CellContext`bValue$$, 
             ...
             If[$CellContext`funcC13F40a[$CellContext`xValue$$] <= \
$CellContext`yValue$$ <= $CellContext`funcC13F40b[$CellContext`xValue$$], {
              Thin, Gray, 
               
               Line[{{$CellContext`xValue$$, $CellContext`yValue$$, 
                  0}, {$CellContext`xValue$$, $CellContext`yValue$$, 
                  $CellContext`funcC13F40d[$CellContext`xValue$$, \
$CellContext`yValue$$]}}], 
...
$CellContext`yValue$$]}, {$CellContext`xValue$$, $CellContext`yValue$$, 
                  $CellContext`funcC13F40c[$CellContext`xValue$$, \
           ...
           If[
            And[$CellContext`showLabels$$, $CellContext`showRegionR$$], {
             Inset[
              Framed[
               Pane[
               "Lines parallel to \!\(TraditionalForm\`y\)\[Hyphen]axis enter \
\!\(TraditionalForm\`R\) at \!\(TraditionalForm\`y = g(x)\) and exit at \
\!\(TraditionalForm\`y = h(x)\).", {
...
\[VeryThinSpace]V = \*SubsuperscriptBox[\(\[Integral]\), \(\(\\ \)\(a\)\), \(\
\(\\ \)\(b\)\)]\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\\ \
\)\(g \((x)\)\)\), \(\(\\ \)\(h \
\((x)\)\)\)]\(TraditionalForm\`\*SubsuperscriptBox[\(\[Integral]\), \(\(\\ \)\
\(G \((x, y)\)\)\), \(\(\\ \)\(H \((x, y)\)\)\)]\(f(x, y, z)\)\\ d\
\[VeryThinSpace]z\)\\ d\[VeryThinSpace]y\)\\ d\[VeryThinSpace]x\)\)", \
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], 
       ...
       "Specifications" :> {{{$CellContext`xValue$$, 3, 
          ...
          Small}, {{$CellContext`xValue$$, 3, ""}, 0, 5, 0.1, ControlType -> 
          Trigger, DefaultDuration -> 20, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
         Spacer[{0, 
          8}], {{$CellContext`yValue$$, 2, 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 0, 5, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`yValue$$, 3, ""}, 0, 5, 0.1, ControlType -> 
          Trigger, DefaultDuration -> 20, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0, 0.4, 0.8], $CellContext`funcC13F40a[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          0.5 ($CellContext`x - 2)^2 + 1, $CellContext`funcC13F40b[
            Pattern[$CellContext`x, 
          ...
          BaseStyle -> {
           ...
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`funcC13F40c[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
          4.5 - 0.3 ($CellContext`x - 2)^2 - 
           0.2 ($CellContext`y - 3)^2, $CellContext`funcC13F40d[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
          0.2 ($CellContext`x - 3)^2 + 0.2 ($CellContext`y - 2)^2 + 
           1.5, $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`plotC13F40R = Graphics3D[
...
zjnnnHPOOef89QMvmKXu
            ...
            Axes -> True, 
             PlotRange -> {{0.8417002369, 4.1582997631}, {1.0003434021671984`,
               ...
               Scaled[0.02], 
               Scaled[0.02]}}], 
          Attributes[PlotRange] = {ReadProtected}, $CellContext`plotC13F40 = 
          Graphics3D[
            GraphicsComplex[CompressedData["
...
r+0jnRww/TWaeLbrGRGsx16XVtaUo9Zd2e+4sb72f0S/gt8=
          ...
          RGBColor[0, 0.6, 0.4]}; {Null, Null, Null, Null, 
          Graphics3D[
           GraphicsComplex[CompressedData["
1:eJxVXXlADV/7v/e2L3cjJAkhW/YiS82xZS9LJYmUZN8Soigka0noayvZKnuW
IlQKoexCEpJK2lfd9t+ZufOc83u//8x7P6aZcz7n2c9z5u3htm7OUpFAIGin
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.4, Figure 13.40"], "Header"]}, {
   Cell[
    TextData["Section 13.4, Figure 13.40"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 196269, 3372, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature uI4Xq1dg0mUouJ5tyi29zCuz *)
