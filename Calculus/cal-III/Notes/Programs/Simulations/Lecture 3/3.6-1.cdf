...
NotebookDataLength[     39993,        904]
NotebookOptionsPosition[      7332,        146]
NotebookOutlinePosition[     40770,        916]
CellTagsIndexPosition[     40727,        913]
WindowTitle->Section 13.6, Figure 13.65
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`mass1$$ = 15, $CellContext`mass2$$ = 
    10, $CellContext`point1$$ = {1.5, 0}, $CellContext`point2$$ = {-1.5, 0}, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      Hold[
       Pane[
       "Drag the two masses to change their positions.", {144, Automatic}, 
        BaseStyle -> {
         LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
          LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
          Left}]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`mass1$$], 15, 
       "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(1\)]\)"}, 5, 30}, {{
       Hold[$CellContext`point1$$], {1.5, 0}}, {-5, 0}, {5, 0}}, {{
       Hold[$CellContext`mass2$$], 10, 
       "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(2\)]\)"}, 5, 30}, {{
       Hold[$CellContext`point2$$], {-1.5, 0}}, {-5, 0}, {5, 0}}}, 
    Typeset`size$$ = {504., {96., 102.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`mass1$216469$$ = 0, $CellContext`point1$216470$$ = {0,
     0}, $CellContext`mass2$216471$$ = 0, $CellContext`point2$216472$$ = {0, 
    0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`mass1$$ = 15, $CellContext`mass2$$ = 
        10, $CellContext`point1$$ = {
         1.5, 0}, $CellContext`point2$$ = {-1.5, 0}}, "ControllerVariables" :> {
        Hold[$CellContext`mass1$$, $CellContext`mass1$216469$$, 0], 
        Hold[$CellContext`point1$$, $CellContext`point1$216470$$, {0, 0}], 
        Hold[$CellContext`mass2$$, $CellContext`mass2$216471$$, 0], 
        Hold[$CellContext`point2$$, $CellContext`point2$216472$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Graphics[{$CellContext`bcR, 
         AbsolutePointSize[$CellContext`mass1$$], 
         Point[$CellContext`point1$$], 
         Line[{$CellContext`point1$$ {1, 0} + {
            0, -0.5}, $CellContext`point1$$ {1, 0}}], $CellContext`bcB, 
         AbsolutePointSize[$CellContext`mass2$$], 
         Point[$CellContext`point2$$], 
         Line[{$CellContext`point2$$ {1, 0} + {
            0, -0.5}, $CellContext`point2$$ {1, 0}}], Orange, 
         AbsolutePointSize[7], 
         Arrowheads[0.03], 
         Point[($CellContext`mass1$$ $CellContext`point1$$ + \
$CellContext`mass2$$ $CellContext`point2$$)/($CellContext`mass1$$ + \
$CellContext`mass2$$)], 
         Arrow[{(($CellContext`mass1$$ $CellContext`point1$$ + \
$CellContext`mass2$$ $CellContext`point2$$)/($CellContext`mass1$$ + \
$CellContext`mass2$$)) {1, 0} + {
            0, -2}, (($CellContext`mass1$$ $CellContext`point1$$ + \
$CellContext`mass2$$ $CellContext`point2$$)/($CellContext`mass1$$ + \
$CellContext`mass2$$)) {1, 0} + {0, -0.3}}], Black, 
         Text[
         "\!\(TraditionalForm\`\*OverscriptBox[\(x\), \(_\)] = \*FractionBox[\
\(\*SubscriptBox[\(m\), \(1\)] \*SubscriptBox[\(x\), \(1\)] + \*SubscriptBox[\
\(m\), \(2\)] \*SubscriptBox[\(x\), \(2\)]\), \(\*SubscriptBox[\(m\), \(1\)] \
+ \*SubscriptBox[\(m\), \(2\)]\)]\)", (($CellContext`mass1$$ \
$CellContext`point1$$ + $CellContext`mass2$$ \
$CellContext`point2$$)/($CellContext`mass1$$ + $CellContext`mass2$$)) {1, 
            0} + {0, -3}, {0, -1}], 
         Text[
         "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(1\)]\)", \
$CellContext`point1$$ {1, 0} + {0, -0.5}, {-0.5, 1}], 
         Text[
         "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(1\)]\)", \
$CellContext`point1$$ {1, 0} + {0, 0.5}, {-0.5, -1}], 
         Text[
         "\!\(TraditionalForm\`\*SubscriptBox[\(x\), \(2\)]\)", \
$CellContext`point2$$ {1, 0} + {0, -0.5}, {-0.5, 1}], 
         Text[
         "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(2\)]\)", \
$CellContext`point2$$ {1, 0} + {0, 0.5}, {-0.5, -1}]}, Axes -> {True, False}, 
        BaseStyle -> {"Text", 13}, PlotRange -> {{-5, 5}, {-3, 1}}, 
        Ticks -> {
          Range[-5, 5], None}, AxesStyle -> Arrowheads[{-0.03, 0.03}], 
        ImageSize -> 7 72], "Specifications" :> {
        Pane[
        "Drag the two masses to change their positions.", {144, Automatic}, 
         BaseStyle -> {
          LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
           Left}], Delimiter, {{$CellContext`mass1$$, 15, 
          "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(1\)]\)"}, 5, 30, 
         ControlType -> Slider, ImageSize -> 
         Small}, {{$CellContext`point1$$, {1.5, 0}}, {-5, 0}, {5, 0}, 
         ControlType -> Locator, Appearance -> 
         None}, {{$CellContext`mass2$$, 10, 
          "\!\(TraditionalForm\`\*SubscriptBox[\(m\), \(2\)]\)"}, 5, 30, 
         ControlType -> Slider, ImageSize -> 
         Small}, {{$CellContext`point2$$, {-1.5, 0}}, {-5, 0}, {5, 0}, 
         ControlType -> Locator, Appearance -> None}}, 
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, Deployed -> 
        True, AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
     ImageSizeCache->{681., {117., 122.}},
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.6, Figure 13.65"], "Header"]}, {
   Cell[
    TextData["Section 13.6, Figure 13.65"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 6053, 113, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature #KzH@03BIUidlIkod9Bje0Lx *)
