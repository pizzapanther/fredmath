...
NotebookDataLength[     74241,       1553]
NotebookOptionsPosition[     41579,        795]
NotebookOutlinePosition[     75017,       1565]
CellTagsIndexPosition[     74974,       1562]
WindowTitle->Section 13.1, Figure 13.03
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
     4, $CellContext`cValue$$ = 1, $CellContext`dValue$$ = 
     4, $CellContext`nValue$$ = 2, $CellContext`showApproximation$$ = 
     False, $CellContext`showGrids$$ = False, $CellContext`showLabels$$ = 
     True, $CellContext`showPartition$$ = 
     True, $CellContext`showSingleColumn$$ = 
     True, $CellContext`showSurface$$ = True, $CellContext`xDivisions$$ = 
     5, $CellContext`xMax$$ = 5, $CellContext`xMin$$ = 
     0, $CellContext`yDivisions$$ = 5, $CellContext`yMax$$ = 
     5, $CellContext`yMin$$ = 0, $CellContext`zMax$$ = 
     5, $CellContext`zMin$$ = 0, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showPartition$$], True, "show partition"}, {
       True, False}}, {
       Hold[
        Row[{
       ...
       Hold[
       "number of \!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) \
divisions"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xDivisions$$], 5, ""}, 2, 20, 1}, {
       Hold[
       "number of \!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\) \
divisions"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`yDivisions$$], 5, ""}, 2, 20, 1}, {
       Hold["\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)th subregion"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`nValue$$], 2, 
        "\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)"}, 1, 
       Dynamic[$CellContext`xDivisions$$ $CellContext`yDivisions$$], 1}, {{
        Hold[$CellContext`nValue$$], 2, ""}, 1, 
       Dynamic[$CellContext`xDivisions$$ $CellContext`yDivisions$$], 1}, {{
       ...
       Hold[
        ...
        Hold[$CellContext`showApproximation$$], False, "show approximation"}, 
       0}, {{
        Hold[$CellContext`showSingleColumn$$], True, "show single box"}, 0}, {{
        Hold[$CellContext`showSurface$$], True, "show surface"}, 0}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showPartition$211591$$ = 
     False, $CellContext`xDivisions$211592$$ = 
     0, $CellContext`yDivisions$211593$$ = 0, $CellContext`nValue$211594$$ = 
     0, $CellContext`aValue$211595$$ = 0, $CellContext`bValue$211596$$ = 
     0, $CellContext`cValue$211597$$ = 0, $CellContext`dValue$211598$$ = 
     0, $CellContext`showLabels$211599$$ = 
     False, $CellContext`showGrids$211600$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
         ...
         Hold[$CellContext`showPartition$$, \
$CellContext`showPartition$211591$$, False], 
         Hold[$CellContext`xDivisions$$, $CellContext`xDivisions$211592$$, 0], 
         Hold[$CellContext`yDivisions$$, $CellContext`yDivisions$211593$$, 0], 
         Hold[$CellContext`nValue$$, $CellContext`nValue$211594$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$211595$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$211596$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$211597$$, 0], 
         Hold[$CellContext`dValue$$, $CellContext`dValue$211598$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$211599$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$211600$$, 
          False]}, 
       "OtherVariables" :> {
...
$CellContext`cValue$$ = $CellContext`dValue$$]; 
        If[$CellContext`nValue$$ > $CellContext`xDivisions$$ \
$CellContext`yDivisions$$, $CellContext`nValue$$ = $CellContext`xDivisions$$ \
$CellContext`yDivisions$$]; Show[{
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
           ...
           Graphics3D[{
             If[$CellContext`showLabels$$, {
               Text["\!\(TraditionalForm\`z = f(x, y)\)", {2, 4, 3}, {-1, 0}], 
               Text[
               "\!\(TraditionalForm\`R\)", {$CellContext`bValue$$, \
$CellContext`dValue$$, 0}, {-2, 0}], 
               Text[
               "\!\(TraditionalForm\`a\)", {$CellContext`aValue$$, -0.3, 0}, {
                0, 0}], 
               Text[
               "\!\(TraditionalForm\`b\)", {$CellContext`bValue$$, -0.3, 0}, {
                0, 0}], 
               Text[
               "\!\(TraditionalForm\`c\)", {-0.25, $CellContext`cValue$$, 
                 0}, {0, -1}], 
               Text[
               "\!\(TraditionalForm\`d\)", {-0.25, $CellContext`dValue$$, 
                 0}, {0, -1}]}, Black], 
             AbsoluteThickness[1.5], $CellContext`bcB, 
             
             Line[{{$CellContext`aValue$$, 0, 
                0}, {$CellContext`aValue$$, $CellContext`dValue$$, 0}}], 
             
             Line[{{$CellContext`bValue$$, 0, 
                0}, {$CellContext`bValue$$, $CellContext`dValue$$, 0}}], 
             
             Line[{{0, $CellContext`cValue$$, 
                0}, {$CellContext`bValue$$, $CellContext`cValue$$, 0}}], 
             
             Line[{{0, $CellContext`dValue$$, 
                0}, {$CellContext`bValue$$, $CellContext`dValue$$, 0}}], 
             AbsoluteThickness[1], $CellContext`bcG, 
             Opacity[0.3], 
             
             Polygon[{{$CellContext`aValue$$, $CellContext`cValue$$, 
                0}, {$CellContext`bValue$$, $CellContext`cValue$$, 
                0}, {$CellContext`bValue$$, $CellContext`dValue$$, 
                0}, {$CellContext`aValue$$, $CellContext`dValue$$, 0}}], 
             If[$CellContext`showPartition$$, {Black, 
               Opacity[1], 
               If[$CellContext`showLabels$$, {
                 Text[
                 "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*\
SubscriptBox[\(x\), \(k\)]\)", {$CellContext`aValue$$ + (
                    Mod[$CellContext`nValue$$ - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`dValue$$ + 
                   0.5, 0}, {0, 0}], 
                 Text[
                 "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*\
SubscriptBox[\(y\), \(k\)]\)", {$CellContext`bValue$$ + 
                   0.5, $CellContext`cValue$$ + (
                    Quotient[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 0}, {0, 0}], 
                 Text[
                 "\!\(TraditionalForm\`\((\(TraditionalForm\`\*\
SubsuperscriptBox[\(x\), \(k\), \(*\)]\), \*SubsuperscriptBox[\(y\), \(k\), \
\(*\)])\)\)", {4.5, 0.5, 2}, {1, -1}], 
                 Text[
                 "Height of \!\(TraditionalForm\`k\)th box\n\
\!\(TraditionalForm\`\(\(\[InvisiblePostfixScriptBase]\)\(=\)\(f(\(\
TraditionalForm\`\*SubsuperscriptBox[\(x\), \(k\), \(*\)]\), \
\*SubsuperscriptBox[\(y\), \(k\), \(*\)])\)\)\)", {1, 0, 4}, {1, -1}], 
                 
                 Line[{{1, 0, 
                    4.5}, {$CellContext`aValue$$ + (
                    Mod[$CellContext`nValue$$ - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), \
$CellContext`funcC13F03[$CellContext`aValue$$ + (
                    Mod[$CellContext`nValue$$ - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$)]/2}}], 
...
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    ...
                    1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 0}}]}, Black], 
               Table[
                
                Line[{{$CellContext`aValue$$ + $CellContext`i \
(($CellContext`bValue$$ - $CellContext`aValue$$)/$CellContext`xDivisions$$), \
$CellContext`cValue$$, 
                   0}, {$CellContext`aValue$$ + $CellContext`i \
(($CellContext`bValue$$ - $CellContext`aValue$$)/$CellContext`xDivisions$$), \
$CellContext`dValue$$, 0}}], {$CellContext`i, 0, $CellContext`xDivisions$$}], 
               
               Table[
                
                Line[{{$CellContext`aValue$$, $CellContext`cValue$$ + \
$CellContext`i (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 
                   0}, {$CellContext`bValue$$, $CellContext`cValue$$ + \
$CellContext`i (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 0}}], {$CellContext`i, 
                 0, $CellContext`yDivisions$$}], 
               AbsolutePointSize[3], 
               Table[
                
                Point[{$CellContext`aValue$$ + (
                    Mod[$CellContext`i - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`i - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 0}], {$CellContext`i, 
                 1, $CellContext`yDivisions$$ $CellContext`xDivisions$$}], \
$CellContext`bcR, 
               Opacity[0.5], 
               
               Polygon[{{$CellContext`aValue$$ + 
                  Mod[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + 
                  Quotient[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 
...
$CellContext`cValue$$)/$CellContext`yDivisions$$), 0}, {$CellContext`aValue$$ + 
                  Mod[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] + 
                    1) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$), 0}}], 
               If[$CellContext`showSingleColumn$$, {$CellContext`bcR, 
                 EdgeForm[Black], 
                 Opacity[0.3], 
                 
                 Cuboid[{$CellContext`aValue$$ + 
                   Mod[$CellContext`nValue$$ - 
                    1, $CellContext`xDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + 
                   Quotient[$CellContext`nValue$$ - 
...
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    ...
                    1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$)]}}], Black, 
                 AbsolutePointSize[5], 
...
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    ...
                    1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$)]}]}, Black]}, Black], 
             If[$CellContext`showApproximation$$, {$CellContext`bcB, 
               Opacity[0.5], 
               Table[
...
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`i - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$)]}], {$CellContext`i, 
                 1, $CellContext`xDivisions$$ $CellContext`yDivisions$$}], \
$CellContext`bcSurfaceTop, 
               Opacity[1], 
...
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`i - 1, $CellContext`xDivisions$$] + 
                    1/2) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`yDivisions$$)]}, {$CellContext`aValue$$ + 
                   Mod[$CellContext`i - 
                    1, $CellContext`xDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`xDivisions$$), $CellContext`cValue$$ + (
                    Quotient[$CellContext`i - 1, $CellContext`xDivisions$$] + 
...
$CellContext`cValue$$)/$CellContext`yDivisions$$)]}}], {$CellContext`i, 
           ...
           If[$CellContext`showSurface$$, 
            Plot3D[
             $CellContext`funcC13F03[$CellContext`x, $CellContext`y], \
{$CellContext`x, $CellContext`aValue$$ - 
              0.01, $CellContext`bValue$$}, {$CellContext`y, \
$CellContext`cValue$$ - 0.001, $CellContext`dValue$$}, PlotStyle -> {{
                Opacity[0.9], $CellContext`bcSurfaceTop, 
                Specularity[White, 100]}}, Mesh -> None, Filling -> 0, 
             FillingStyle -> {{$CellContext`bcG, 
                Opacity[0.15]}, {$CellContext`bcG, 
                Opacity[0.15]}}], 
            Graphics3D[{}]]}, 
          PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$ + 0.5}}, Lighting -> "Neutral", ImageSize -> 6 {72, 72}, 
          Boxed -> False, BaseStyle -> {"Text", 13}, ViewPoint -> {4, 2, 2}, 
          Epilog -> {
            Inset[
             Framed[
              Pane[
              "Volume of \!\(TraditionalForm\`k\)th box\n\
\!\(TraditionalForm\`\(\(\[InvisiblePostfixScriptBase]\)\(=\)\(\(f(\(\
TraditionalForm\`\*SubsuperscriptBox[\(x\), \(k\), \(*\)]\), \
\*SubsuperscriptBox[\(y\), \(k\), \(*\)])\) \
\[CapitalDelta]\[VeryThinSpace]\*SubscriptBox[\(A\), \(k\)]\)\)\)", {
               Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], 
             ImageScaled[{1, 1}], 
             ImageScaled[{1, 1}]]}]), 
       "Specifications" :> {{{$CellContext`showPartition$$, True, 
           "show partition"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], 
         "number of \!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) \
divisions", {{$CellContext`xDivisions$$, 5, ""}, 2, 20, 1, ControlType -> 
          Slider, ImageSize -> Small, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, 
         "number of \!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\) \
divisions", {{$CellContext`yDivisions$$, 5, ""}, 2, 20, 1, ControlType -> 
          Slider, ImageSize -> Small, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, 
         "\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)th subregion", \
{{$CellContext`nValue$$, 2, 
           "\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)"}, 1, 
          Dynamic[$CellContext`xDivisions$$ $CellContext`yDivisions$$], 1, 
          ControlType -> Slider, ImageSize -> Small, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, {{$CellContext`nValue$$, 2, 
           ""}, 1, 
          Dynamic[$CellContext`xDivisions$$ $CellContext`yDivisions$$], 1, 
          ControlType -> Trigger, DefaultDuration :> 
          Dynamic[Dynamic[$CellContext`xDivisions$$ \
$CellContext`yDivisions$$]/2], Enabled :> 
          Dynamic[$CellContext`showPartition$$], 
          AppearanceElements -> {
         ...
         Delimiter, {{$CellContext`aValue$$, 1, 
          ...
          Small}, {{$CellContext`bValue$$, 4, 
           "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0, 5, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`cValue$$, 1, 
           "\!\(\*\nStyleBox[\"c\",\nFontSlant->\"Italic\"]\)"}, 0, 5, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`dValue$$, 4, 
           "\!\(\*\nStyleBox[\"d\",\nFontSlant->\"Italic\"]\)"}, 0, 5, 
         ...
         Grid[{{
            Manipulate`Place[2]}, {
            Manipulate`Place[3]}}], {{$CellContext`showApproximation$$, False,
            "show approximation"}, 0, ControlType -> None, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, \
{{$CellContext`showSingleColumn$$, True, "show single box"}, 0, ControlType -> 
          None, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, \
{{$CellContext`showSurface$$, True, "show surface"}, 0, ControlType -> 
          None}, {{$CellContext`xMin$$, 0}, 0, ControlType -> 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0, 0.6, 0.4], $CellContext`funcC13F03[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
          5 - ($CellContext`x - 3)^2/5 - 
           2 (($CellContext`y - 1)^2/5), $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.1, Figure 13.03"], "Header"]}, {
   Cell[
    TextData["Section 13.1, Figure 13.03"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 40300, 762, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature TI4BlfYKJLBlIJOOT5DqGelK *)
