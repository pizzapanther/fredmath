...
NotebookDataLength[     65523,       1432]
NotebookOptionsPosition[     32861,        674]
NotebookOutlinePosition[     66299,       1444]
CellTagsIndexPosition[     66256,       1441]
WindowTitle->Section 13.5, Figure 13.48
WindowFrame->Normal*)
      ...
      TagBox[
       StyleBox[
        DynamicModuleBox[{$CellContext`showGrids$$ = 
         ...
         252., {123., 129.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
         Typeset`skipInitDone$$ = False, $CellContext`showGrids$215010$$ = 
         False}, 
         DynamicBox[Manipulate`ManipulateBoxes[
          2, StandardForm, 
           "Variables" :> {$CellContext`showGrids$$ = 
             ...
             Hold[$CellContext`showGrids$$, $CellContext`showGrids$215010$$, 
              False]}, 
           "OtherVariables" :> {
...
\[Theta], 0, 2 Pi}, {$CellContext`z, 0, 5}, PlotStyle -> {{
              ...
              ParametricPlot3D[{$CellContext`u 
                ...
                Pi}, {$CellContext`u, 1, 3}, PlotStyle -> {{
                  Opacity[0.9], $CellContext`bcSurfaceTop, 
                  Specularity[White, 100]}}, Mesh -> None, MaxRecursion -> 
               1]}, PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$ + 0.5}}, ImageSize -> 3.5 {72, 72}, 
           ...
           "Specifications" :> {{{$CellContext`showGrids$$, False, 
              ...
              ControlPlacement -> 1}, 
             Row[{
               Manipulate`Place[1]}], {{$CellContext`xMin$$, -5}, 0, 
              ControlType -> None}, {{$CellContext`xMax$$, 5}, 0, ControlType -> 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
            ...
            1, $CellContext`bcSurfaceTop = RGBColor[0.85, 0.6, 0.2], 
      ...
      TagBox[
       StyleBox[
        DynamicModuleBox[{$CellContext`showGrids$$ = 
         ...
         1.5, $CellContext`zMin$$ = -0.5, Typeset`show$$ = True, 
         Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
         Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
         "\"untitled\"", Typeset`specs$$ = {{{
            Hold[$CellContext`showGrids$$], False, "show grids"}, {
           ...
           Hold[
            ...
            Hold[$CellContext`zMax$$], 1.5}, 0}}, Typeset`size$$ = {
         252., {123., 129.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
         Typeset`skipInitDone$$ = False, $CellContext`showGrids$215034$$ = 
         False}, 
         DynamicBox[Manipulate`ManipulateBoxes[
          2, StandardForm, 
           "Variables" :> {$CellContext`showGrids$$ = 
             ...
             1.5, $CellContext`xMin$$ = -1.5, $CellContext`yMax$$ = 
             1.5, $CellContext`yMin$$ = -1.5, $CellContext`zMax$$ = 
             1.5, $CellContext`zMin$$ = -0.5}, "ControllerVariables" :> {
             
             Hold[$CellContext`showGrids$$, $CellContext`showGrids$215034$$, 
              False]}, 
           "OtherVariables" :> {
            Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
             Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
              ...
              ParametricPlot3D[{$CellContext`r 
                ...
                1 - $CellContext`r}, {$CellContext`\[Theta], 0, 2 
                Pi}, {$CellContext`r, 0, 1}, PlotStyle -> {{
                  Opacity[0.7], $CellContext`bcSurfaceTop, 
                  Specularity[White, 100]}}, Mesh -> None, MaxRecursion -> 1], 
              ...
              ParametricPlot3D[{$CellContext`u 
                Cos[$CellContext`\[Theta]], $CellContext`u 
                Sin[$CellContext`\[Theta]], 0}, {$CellContext`\[Theta], 0, 2 
                Pi}, {$CellContext`u, 0, 1}, PlotStyle -> {{
                  Opacity[0.9], $CellContext`bcSurfaceTop, 
                  Specularity[White, 100]}}, Mesh -> None, MaxRecursion -> 
               1]}, PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
                0.5, $CellContext`zMax$$ + 0.5}}, ImageSize -> 3.5 {72, 72}, 
             BaseStyle -> {"Text", 13}, Lighting -> "Neutral", Boxed -> False,
              ViewPoint -> {4, 3, 1.5}], 
           "Specifications" :> {{{$CellContext`showGrids$$, False, 
               "show grids"}, {True, False}, ControlType -> Checkbox, 
              ControlPlacement -> 1}, 
             Row[{
               Manipulate`Place[1]}], {{$CellContext`xMin$$, -1.5}, 0, 
              ControlType -> None}, {{$CellContext`xMax$$, 1.5}, 0, 
              ControlType -> None}, {{$CellContext`yMin$$, -1.5}, 0, 
              ControlType -> None}, {{$CellContext`yMax$$, 1.5}, 0, 
              ControlType -> None}, {{$CellContext`zMin$$, -0.5}, 0, 
              ControlType -> None}, {{$CellContext`zMax$$, 1.5}, 0, 
              ControlType -> None}}, 
           "Options" :> {
            ControlPlacement -> Top, LabelStyle -> 11, Paneled -> False, 
             AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.48"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.48"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 31582, 641, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature CINGfhtIpl2PCLOq2fbLOcHY *)
