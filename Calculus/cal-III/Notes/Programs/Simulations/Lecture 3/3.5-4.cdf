...
NotebookDataLength[     88054,       1800]
NotebookOptionsPosition[     55374,       1041]
NotebookOutlinePosition[     88829,       1812]
CellTagsIndexPosition[     88786,       1809]
WindowTitle->Section 13.5, Figure 13.52a
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = 
     ...
     3, $CellContext`zMin$$ = -2, Typeset`show$$ = True, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showGrids$215183$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = 
         ...
         4, $CellContext`xMin$$ = 0, $CellContext`yMax$$ = 
         4, $CellContext`yMin$$ = -4, $CellContext`zMax$$ = 
         3, $CellContext`zMin$$ = -2}, "ControllerVariables" :> {
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$215183$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 1.5}], 
          ...
          If[$CellContext`showRegionR$$, {
            ...
            ParametricPlot3D[2 {
             ...
             None, MaxRecursion -> 1]}, 
           Graphics3D[{}]], 
          If[$CellContext`showRegionD$$, $CellContext`plotC13F52aD, 
           Graphics3D[{}]]}, 
...
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
       ...
       "Specifications" :> {{{$CellContext`showGrids$$, False, 
          ...
          Checkbox}, {{$CellContext`showRegionD$$, True, 
           "show region \!\(\*\nStyleBox[\"D\",\nFontSlant->\"Italic\"]\)"}, 
          0, ControlType -> 
          None}, {{$CellContext`showRegionR$$, False, 
           "show region \!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)"}, 
          0, ControlType -> 
          None}, {{$CellContext`showLabels$$, True, "show labels"}, 0, 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0, 0.4, 0.8], $CellContext`plotC13F52aD = {
            Graphics3D[
         ...
         GridBox[{{"\"Section \"", "\"13.5\"", 
            ...
            TemplateBox[{"\", Figure \"", "\"13\"", "\".\""}, "Row", 
             ...
             InterpretationFunction -> (RowBox[{"Row", "[", 
                RowBox[{"{", 
                  RowBox[{#, ",", #2, ",", #3}], "}"}], "]"}]& )], 
            "\"52a\""}}, GridBoxAlignment -> {"Columns" -> {{Left}}}, 
          AutoDelete -> False, 
          GridBoxItemSize -> {
           "Columns" -> {{Automatic}}, "Rows" -> {{Automatic}}}, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.5, Figure 13.52a"], "Header"]}, {
   Cell[
    TextData["Section 13.5, Figure 13.52a"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1276, 31, 54094, 1008, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature tJzge5qsd1r8NJkrOhHauyTV *)
