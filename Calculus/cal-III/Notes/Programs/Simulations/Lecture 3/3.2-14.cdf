...
NotebookDataLength[     40796,        930]
NotebookOptionsPosition[      8135,        172]
NotebookOutlinePosition[     41573,        942]
CellTagsIndexPosition[     41530,        939]
WindowTitle->Section 13.2, Figure 13.16
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`yValue$$ = 2, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`yValue$$], 2, 
        "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 1, 4, 0.1}, {{
        Hold[$CellContext`yValue$$], 2, ""}, 1, 4, 0.01}}, Typeset`size$$ = {
     360., {180., 185.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`yValue$212528$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`yValue$$ = 2}, 
       "ControllerVariables" :> {
         Hold[$CellContext`yValue$$, $CellContext`yValue$212528$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{1, 
            $CellContext`funcC13F16a[$CellContext`x]}, {$CellContext`x, 1, 4},
            PlotStyle -> None, Filling -> {2 -> {1}}, FillingStyle -> 
           Lighter[$CellContext`bcAreaPositiveColor, 0.7]], 
          Plot[{1, 
            $CellContext`funcC13F16b[$CellContext`x]}, {$CellContext`x, 4, 7},
            PlotStyle -> None, Filling -> {2 -> {1}}, FillingStyle -> 
           Lighter[$CellContext`bcAreaPositiveColor, 0.7]], 
          
          Plot[{1, $CellContext`yValue$$}, {$CellContext`x, \
$CellContext`yValue$$, 8.001 - $CellContext`yValue$$}, PlotStyle -> None, 
           Filling -> {2 -> {1}}, 
           FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[{1, 
            $CellContext`funcC13F16a[$CellContext`x]}, {$CellContext`x, 
            0.999, $CellContext`yValue$$}, PlotStyle -> None, 
           Filling -> {2 -> {1}}, 
           FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[{1, 
            $CellContext`funcC13F16b[$CellContext`x]}, {$CellContext`x, 
            8.001 - $CellContext`yValue$$, 7}, PlotStyle -> None, 
           Filling -> {2 -> {1}}, 
           FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[{1, 
            $CellContext`funcC13F16a[$CellContext`x], 
            $CellContext`funcC13F16b[$CellContext`x]}, {$CellContext`x, -0.5, 
            9}, PlotStyle -> {{Thick, $CellContext`bcB}, {
             Thick, $CellContext`bcR}, {Thick, Black}}], 
          Graphics[{
            Text["\!\(TraditionalForm\`R\)", {2, 1}, {0, -1.5}], 
            Text[
            "\!\(\*FormBox[GridBox[{\n   {\n    RowBox[{\"y\", \"=\", \
\"x\"}], \"or\"},\n   {\n    RowBox[{\"x\", \"=\", \"y\"}], \" \"}\n  }],\n \
...
RowBox[{\"8\", \"-\", \"x\"}]}], \"or\"},\n   {\n    RowBox[{\"x\", \"=\", \n \
    RowBox[{\"8\", \"-\", \"y\"}]}], \" \"}\n  }],\n TraditionalForm]\)", {6, 
             2}, {-1.2, -1}], 
            Text["\!\(TraditionalForm\`\((4, 4)\)\)", {4, 4}, {1.5, 0}], 
            Orange, 
            AbsoluteThickness[6], 
            Arrowheads[0.07], 
            Opacity[0.2], 
            Arrow[{{0, 1}, {0, 4}}], 
            Opacity[1], 
            Arrow[{{0, 1}, {0, $CellContext`yValue$$}}], $CellContext`bcB, 
            Opacity[1], 
            AbsoluteThickness[3], 
            Arrowheads[0.05], 
            
            Arrow[{{$CellContext`yValue$$, $CellContext`yValue$$}, {
              8 - $CellContext`yValue$$, $CellContext`yValue$$}}]}]}, 
         AspectRatio -> 1, BaseStyle -> {"Text", 13}, ImageSize -> 5 72, 
         AxesOrigin -> {0, 0}, Ticks -> {
           Range[0, 8], 
           Range[0, 5]}, AxesStyle -> Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         PlotRange -> {{-1, 9}, {-1.5, 5.5}}, Epilog -> {
           Inset[
            Framed[
             Pane[
             "The projection of \!\(TraditionalForm\`R\) on the \
\!\(TraditionalForm\`y\)\[Hyphen]axis determines the limits of integration in \
\!\(TraditionalForm\`y\).", {
           ...
           Inset[
            Framed[
             Pane[
             "The bounding curves determine the limits of integration in \
\!\(TraditionalForm\`x\).", {
              130, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], 
            ImageScaled[{0.51, 0.94}], 
            ImageScaled[{0, 1}]]}], 
       "Specifications" :> {{{$CellContext`yValue$$, 2, 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 1, 4, 0.1, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`yValue$$, 2, ""}, 1, 4, 0.01, ControlType -> 
       ...
       "DefaultOptions" :> {}],
      ImageSizeCache->{502., {197., 203.}},
      SingleEvaluation->True],
     Deinitialization:>None,
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC13F16a[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x, $CellContext`bcAreaPositiveColor = 
          RGBColor[0.796, 0.91, 0.855], $CellContext`funcC13F16b[
            Pattern[$CellContext`x, 
             Blank[]]] := 8 - $CellContext`x, $CellContext`bcB = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.2, Figure 13.16"], "Header"]}, {
   Cell[
    TextData["Section 13.2, Figure 13.16"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 6856, 139, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature UJz722e48joACI5lJwdzoT3y *)
