...
NotebookDataLength[     42456,        969]
NotebookOptionsPosition[      9795,        211]
NotebookOutlinePosition[     43233,        981]
CellTagsIndexPosition[     43190,        978]
WindowTitle->Section 13.2, Figure 13.18
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`integrationOrder$$ = 
     1, $CellContext`xValue$$ = 0.15, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{
       Hold["boundaries"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`integrationOrder$$], 1, ""}, {
       1 -> "above/below", 2 -> "right/left"}}, {{
        Hold[$CellContext`xValue$$], 0.15, 
        Dynamic[
         Switch[$CellContext`integrationOrder$$, 1, 
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 2, 
          "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"]]}, 0, 1, 
       0.01}, {{
        Hold[$CellContext`xValue$$], 0.15, ""}, 0, 1, 0.01}}, 
     Typeset`size$$ = {360., {180., 185.}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`integrationOrder$212676$$ = 
     False, $CellContext`xValue$212677$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`integrationOrder$$ = 
         1, $CellContext`xValue$$ = 0.15}, "ControllerVariables" :> {
         Hold[$CellContext`integrationOrder$$, \
$CellContext`integrationOrder$212676$$, False], 
         Hold[$CellContext`xValue$$, $CellContext`xValue$212677$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC13F18a[$CellContext`x], 
            $CellContext`funcC13F18b[$CellContext`x]}, {$CellContext`x, \
-0.001, 1}, PlotStyle -> None, Filling -> {2 -> {1}}, FillingStyle -> 
           Lighter[$CellContext`bcAreaPositiveColor, 0.7]], 
          Switch[$CellContext`integrationOrder$$, 1, 
           Plot[{
             $CellContext`funcC13F18a[$CellContext`x], 
             $CellContext`funcC13F18b[$CellContext`x]}, {$CellContext`x, \
-0.001, $CellContext`xValue$$}, PlotStyle -> None, Filling -> {2 -> {1}}, 
            FillingStyle -> $CellContext`bcAreaPositiveColor], 2, {
            Plot[{
              $CellContext`funcC13F18a[$CellContext`x], 
              $CellContext`funcC13F18b[$CellContext`x]}, {$CellContext`x, \
-0.001, $CellContext`xValue$$^3}, PlotStyle -> None, Filling -> {2 -> {1}}, 
             FillingStyle -> $CellContext`bcAreaPositiveColor], 
            Plot[{
              $CellContext`funcC13F18a[$CellContext`x], \
$CellContext`xValue$$}, {$CellContext`x, $CellContext`xValue$$^3 - 
              0.001, $CellContext`xValue$$^0.5}, PlotStyle -> None, 
             Filling -> {2 -> {1}}, 
             FillingStyle -> $CellContext`bcAreaPositiveColor]}], 
          Plot[{
            $CellContext`funcC13F18a[$CellContext`x], 
            $CellContext`funcC13F18b[$CellContext`x]}, {$CellContext`x, \
-0.001, 1.5}, PlotStyle -> 
           Switch[$CellContext`integrationOrder$$, 
             1, {{Thick, $CellContext`bcR}, {Thick, Black}}, 
             2, {{Thick, Black}, {Thick, $CellContext`bcR}}]], 
          Graphics[{
            Text["\!\(TraditionalForm\`R\)", {0.2, 0.3}, {0, 1}], 
            Text[
             
             Switch[$CellContext`integrationOrder$$, 1, 
              "\!\(TraditionalForm\`y = \*SuperscriptBox[\(x\), \(1/3\)]\)", 
              2, "\!\(TraditionalForm\`x = \*SuperscriptBox[\(y\), \
\(3\)]\)"], {0.5, 1}, {-1, 0}], 
            Text[
             
             Switch[$CellContext`integrationOrder$$, 1, 
              "\!\(TraditionalForm\`y = \*SuperscriptBox[\(x\), \(2\)]\)", 2, 
              "\!\(TraditionalForm\`x = \*SqrtBox[\(y\)]\)"], {1, 0.5}, {0, 
             0}], 
            Switch[$CellContext`integrationOrder$$, 1, {Orange, 
              AbsoluteThickness[3], 
              Arrowheads[0.04], 
              Arrow[{{$CellContext`xValue$$, 
                 $CellContext`funcC13F18a[$CellContext`xValue$$]}, \
{$CellContext`xValue$$, 
                 $CellContext`funcC13F18b[$CellContext`xValue$$]}}], \
$CellContext`bcB, 
              Opacity[0.2], 
              AbsoluteThickness[5], 
              Arrowheads[0.05], 
              Arrow[{{0, 0}, {1, 0}}], 
              Opacity[0.5], 
              Arrow[{{0, 0}, {$CellContext`xValue$$, 0}}]}, 
             2, {$CellContext`bcB, 
              AbsoluteThickness[3], 
              Arrowheads[0.04], 
              Arrow[{{
                 $CellContext`funcC13F18d[$CellContext`xValue$$], \
$CellContext`xValue$$}, {
                 $CellContext`funcC13F18c[$CellContext`xValue$$], \
$CellContext`xValue$$}}], Orange, 
              Opacity[0.2], 
              AbsoluteThickness[5], 
              Arrowheads[0.05], 
              Arrow[{{0, 0}, {0, 1}}], 
              Opacity[0.5], 
              Arrow[{{0, 0}, {0, $CellContext`xValue$$}}]}]}]}, AspectRatio -> 
         1, BaseStyle -> {"Text", 13}, ImageSize -> 5 72, 
         AxesOrigin -> {0, 0}, Ticks -> {{1}, {1}}, AxesStyle -> 
         Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         PlotRange -> {{-0.2, 1.3}, {-0.4, 1.3}}, Epilog -> {
           Inset[
            Framed[
             Pane[
             "\!\(TraditionalForm\`R\) is bounded above and below, and on the \
right and left by curves.", {
              280, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], 
            ImageScaled[{0.5, 0}], 
            ImageScaled[{0.5, 0}]]}], 
       "Specifications" :> {
        "boundaries", {{$CellContext`integrationOrder$$, 1, ""}, {
          1 -> "above/below", 2 -> "right/left"}, ControlType -> 
          RadioButtonBar, Appearance -> "Vertical"}, 
         Delimiter, {{$CellContext`xValue$$, 0.15, 
           Dynamic[
          ...
          Small}, {{$CellContext`xValue$$, 0.15, ""}, 0, 1, 0.01, ControlType -> 
          Trigger, 
          AppearanceElements -> {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC13F18a[
            Pattern[$CellContext`x, 
             Blank[]]] := $CellContext`x^2, $CellContext`funcC13F18b[
            Pattern[$CellContext`x, 
          ...
          RGBColor[0, 0.4, 0.8], $CellContext`funcC13F18d[
            Pattern[$CellContext`y, 
             Blank[]]] := $CellContext`y^3, $CellContext`y[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          0.125 $CellContext`x^2 - 
           0.625 $CellContext`x, $CellContext`funcC13F18c[
            Pattern[$CellContext`y, 
             Blank[]]] := Sqrt[$CellContext`y], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.2, Figure 13.18"], "Header"]}, {
   Cell[
    TextData["Section 13.2, Figure 13.18"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 8516, 178, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature eKNf8Y4sfHo4EL5uVZend9#F *)
