...
NotebookDataLength[     39814,        913]
NotebookOptionsPosition[      7153,        155]
NotebookOutlinePosition[     40591,        925]
CellTagsIndexPosition[     40548,        922]
WindowTitle->Section 13.2, Figure 13.13
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`xValue$$ = -1, Typeset`show$$ = True, 
     ...
     False, $CellContext`xValue$212398$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, "Variables" :> {$CellContext`xValue$$ = -1}, 
       "ControllerVariables" :> {
         Hold[$CellContext`xValue$$, $CellContext`xValue$212398$$, 0]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Plot[{
            $CellContext`funcC13F13a[$CellContext`x], 
            $CellContext`funcC13F13b[$CellContext`x]}, {$CellContext`x, \
-1.999, 2}, PlotStyle -> None, Filling -> {2 -> {1}}, FillingStyle -> 
           Lighter[$CellContext`bcAreaPositiveColor, 0.7]], 
          Plot[{
            $CellContext`funcC13F13a[$CellContext`x], 
            $CellContext`funcC13F13b[$CellContext`x]}, {$CellContext`x, \
-1.999, $CellContext`xValue$$}, PlotStyle -> None, Filling -> {2 -> {1}}, 
           FillingStyle -> $CellContext`bcAreaPositiveColor], 
          Plot[{
            $CellContext`funcC13F13a[$CellContext`x], 
            $CellContext`funcC13F13b[$CellContext`x]}, {$CellContext`x, -2.5, 
            2.5}, PlotStyle -> {{Thick, $CellContext`bcR}, {Thick, Black}}], 
          Graphics[{
            Text["\!\(TraditionalForm\`R\)", {-2, 12}, {-4, 0}], 
            Text[
            "\!\(TraditionalForm\`y = 16 - \*SuperscriptBox[\(x\), \(2\)]\)", \
{0, 16}, {1.5, -1}], 
            Text[
            "\!\(TraditionalForm\`y = 3 \*SuperscriptBox[\(x\), \(2\)]\)", {1,
              3}, {-1.5, 0}], Orange, 
            AbsoluteThickness[3], 
            Arrowheads[0.05], 
            Arrow[{{$CellContext`xValue$$, 
               $CellContext`funcC13F13a[$CellContext`xValue$$]}, \
{$CellContext`xValue$$, 
               $CellContext`funcC13F13b[$CellContext`xValue$$]}}], \
$CellContext`bcB, 
            Opacity[0.2], 
            AbsoluteThickness[6], 
            Arrowheads[0.07], 
         ...
         Ticks -> {
           Range[-2, 2], None}, AxesStyle -> Arrowheads[{0, 0.03}], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\)"}, 
         PlotRange -> {{-2.5, 2.5}, {-5, 21}}, Epilog -> {
           Inset[
            Framed[
             Pane[
             "The projection of \!\(TraditionalForm\`R\) on the \
\!\(TraditionalForm\`x\)\[Hyphen]axis determines the limits of integration in \
\!\(TraditionalForm\`x\).", {
...
\!\(TraditionalForm\`y\).", {
     ...
     DynamicModuleValues:>{},
     Initialization:>({{$CellContext`funcC13F13a[
            Pattern[$CellContext`x, 
             Blank[]]] := 3 $CellContext`x^2, $CellContext`funcC13F13b[
            Pattern[$CellContext`x, 
             Blank[]]] := 
          16 - $CellContext`x^2, $CellContext`bcAreaPositiveColor = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.2, Figure 13.13"], "Header"]}, {
   Cell[
    TextData["Section 13.2, Figure 13.13"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 5874, 122, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5J4T3M5RXwo2fK#q1P#v1x37 *)
