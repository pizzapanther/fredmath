...
NotebookDataLength[     62015,       1334]
NotebookOptionsPosition[     29353,        576]
NotebookOutlinePosition[     62791,       1346]
CellTagsIndexPosition[     62748,       1343]
WindowTitle->Section 13.1, Figure 13.04
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
     ...
     4, $CellContext`showApproximation$$ = True, $CellContext`showGrids$$ = 
     False, $CellContext`showPartition$$ = True, $CellContext`showSurface$$ = 
     True, $CellContext`xDivisions$$ = 3, $CellContext`xMax$$ = 
     5, $CellContext`xMin$$ = 0, $CellContext`yDivisions$$ = 
     4, $CellContext`yMax$$ = 5, $CellContext`yMin$$ = 
     0, $CellContext`zMax$$ = 5, $CellContext`zMin$$ = -1, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showSurface$$], True, "show surface"}, {
       True, False}}, {{
        Hold[$CellContext`showApproximation$$], True, "show boxes"}, {
       True, False}}, {
       Hold[
        Column[{
          Manipulate`Place[1], 
...
divisions"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xDivisions$$], 3, ""}, 2, 20, 1}, {
       Hold[
       "number of \!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\) \
divisions"], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`yDivisions$$], 4, ""}, 2, 20, 1}, {{
       ...
       Hold[
        ...
        Hold[$CellContext`showPartition$$], True, "show partition"}, 0}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showSurface$211706$$ = 
     False, $CellContext`showApproximation$211707$$ = 
     False, $CellContext`xDivisions$211708$$ = 
     0, $CellContext`yDivisions$211709$$ = 0, $CellContext`aValue$211710$$ = 
     0, $CellContext`bValue$211711$$ = 0, $CellContext`cValue$211712$$ = 
     0, $CellContext`dValue$211713$$ = 0, $CellContext`showGrids$211714$$ = 
     False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1, $CellContext`bValue$$ = 
         4, $CellContext`cValue$$ = 1, $CellContext`dValue$$ = 
         4, $CellContext`showApproximation$$ = True, $CellContext`showGrids$$ = 
         False, $CellContext`showPartition$$ = 
         True, $CellContext`showSurface$$ = True, $CellContext`xDivisions$$ = 
         3, $CellContext`xMax$$ = 5, $CellContext`xMin$$ = 
         0, $CellContext`yDivisions$$ = 4, $CellContext`yMax$$ = 
         5, $CellContext`yMin$$ = 0, $CellContext`zMax$$ = 
         5, $CellContext`zMin$$ = -1}, "ControllerVariables" :> {
         Hold[$CellContext`showSurface$$, $CellContext`showSurface$211706$$, 
          False], 
         Hold[$CellContext`showApproximation$$, \
$CellContext`showApproximation$211707$$, False], 
         Hold[$CellContext`xDivisions$$, $CellContext`xDivisions$211708$$, 0], 
         Hold[$CellContext`yDivisions$$, $CellContext`yDivisions$211709$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$211710$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$211711$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$211712$$, 0], 
         Hold[$CellContext`dValue$$, $CellContext`dValue$211713$$, 0], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$211714$$, 
          False]}, 
       "OtherVariables" :> {
...
$CellContext`cValue$$)/$CellContext`yDivisions$$), 0}}], {$CellContext`i, 
                 0, $CellContext`yDivisions$$}]}, Black], 
...
$CellContext`cValue$$)/$CellContext`yDivisions$$), 
                  $CellContext`funcC13F04[$CellContext`aValue$$ + (
                    Mod[$CellContext`i - 1, $CellContext`xDivisions$$] + 
...
$CellContext`cValue$$)/$CellContext`yDivisions$$)]}}], {$CellContext`i, 
           ...
           If[$CellContext`showSurface$$, 
            Plot3D[
             $CellContext`funcC13F04[$CellContext`x, $CellContext`y], \
...
$CellContext`zMax$$}}, Lighting -> "Neutral", ImageSize -> 5 {72, 72}, Boxed -> 
          False, BaseStyle -> {"Text", 13}, ViewPoint -> {3, 4, 1}, Epilog -> {
            Inset[
             Framed[
              Pane[
              "\!\(TraditionalForm\`Volume = \*UnderscriptBox[\(lim\), \(\
\[CapitalDelta] \[Rule] 0\)]\(\*UnderoverscriptBox[\(\[Sum]\), \(k = 1\), \(n\
\)]\(f(\(TraditionalForm\`\*SubsuperscriptBox[\(x\), \(k\), \(*\)]\), \
...
$CellContext`xDivisions$$, 
                 "\!\(TraditionalForm\`\(\(\\ \)\(\(\[Times]\)\(\\ \)\)\)\)", \
$CellContext`yDivisions$$, 
                 " \!\(TraditionalForm\`\(\(\[InvisiblePostfixScriptBase]\)\(=\
\)\(\\ \)\)\)", $CellContext`xDivisions$$ $CellContext`yDivisions$$}], {
               Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
              Background -> White], 
             ImageScaled[{1, 1}], 
             ImageScaled[{1, 1}]]}]), 
       "Specifications" :> {{{$CellContext`showSurface$$, True, 
           "show surface"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 
          1}, {{$CellContext`showApproximation$$, True, "show boxes"}, {
          True, False}, ControlType -> Checkbox, Enabled :> 
          Dynamic[$CellContext`showPartition$$], ControlPlacement -> 2}, 
         Column[{
           Manipulate`Place[1], 
           Manipulate`Place[2]}, Alignment -> Right], Delimiter, 
         "number of \!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) \
divisions", {{$CellContext`xDivisions$$, 3, ""}, 2, 20, 1, ControlType -> 
          Slider, ImageSize -> Small, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, 
         "number of \!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\) \
divisions", {{$CellContext`yDivisions$$, 4, ""}, 2, 20, 1, ControlType -> 
          Slider, ImageSize -> Small, Enabled :> 
          Dynamic[$CellContext`showPartition$$]}, 
         ...
         Row[{
           Manipulate`Place[3]}], {{$CellContext`showPartition$$, True, 
           "show partition"}, 0, ControlType -> 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0, 0.4, 0.8], $CellContext`funcC13F04[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 13.1, Figure 13.04"], "Header"]}, {
   Cell[
    TextData["Section 13.1, Figure 13.04"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 28074, 543, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 4K4@66jDEnppcK#1PlR#HH83 *)
