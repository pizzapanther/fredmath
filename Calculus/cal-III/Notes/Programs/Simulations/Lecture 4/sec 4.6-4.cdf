...
NotebookDataLength[     57232,       1258]
NotebookOptionsPosition[     24570,        500]
NotebookOutlinePosition[     58008,       1270]
CellTagsIndexPosition[     57965,       1267]
WindowTitle->Section 14.6, Figure 14.46
WindowFrame->Normal*)
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
     ...
     False, $CellContext`aValue$32763$$ = 0, $CellContext`showLabels$32764$$ =
      False, $CellContext`showGrids$32765$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 2, $CellContext`showGrids$$ = 
         ...
         Hold[$CellContext`aValue$$, $CellContext`aValue$32763$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$32764$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$32765$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`uValue$$, $CellContext`vMax$$}}]}, Black]], Black, 
               ...
               BaseStyle -> {"Text", 13}, AspectRatio -> 2, Ticks -> {
                 Range[0, Pi, Pi/4], 
                 Range[0, 2 Pi, Pi/2]}, AxesStyle -> Arrowheads[0.05], 
               AxesLabel -> {
                "\!\(\*\nStyleBox[\"u\",\nFontSlant->\"Italic\"]\)", 
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
              ...
              Graphics3D[{
                ...
                Arrow[
                 Tube[{{0, 0, 0}, 
                   $CellContext`funcC14F46[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$]}]]}], 
              ParametricPlot3D[
               $CellContext`funcC14F46[$CellContext`u, $CellContext`v, \
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F46[
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.46"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.46"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 23291, 467, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 5I4zdLcNs5IWtJk0UDgA0FAv *)
