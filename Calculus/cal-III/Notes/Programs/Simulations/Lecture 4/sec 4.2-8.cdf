...
NotebookDataLength[     54481,       1217]
NotebookOptionsPosition[     21819,        459]
NotebookOutlinePosition[     55257,       1229]
CellTagsIndexPosition[     55214,       1226]
WindowTitle->Section 14.2, Figure 14.25
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = 
     False, $CellContext`showLabels$$ = True, $CellContext`showVectors$$ = {
     1}, $CellContext`tMax$$ = 2 Pi, $CellContext`tMin$$ = 
     0, $CellContext`xMax$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showVectors$$], {1}, ""}, {1 -> Panel[
          Pane[
          "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain], \"=\", \n  RowBox[{\"\[LeftAngleBracket]\", \n   \
RowBox[{\"z\", \",\", \"x\", \",\", \n    RowBox[{\"-\", \"y\"}]}], \"\
\[RightAngleBracket]\"}]}],\n TraditionalForm]\) on \
\!\(TraditionalForm\`C\)", {110, Automatic}, 
           BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left}]], 2 -> Panel[
          Pane[
          "Unit tangent vectors of \!\(TraditionalForm\`C\)", {
           110, Automatic}, 
           BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
...
FontSlant->Plain]\) on unit tangent vectors of \!\(TraditionalForm\`C\)", {
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showVectors$31137$$ = 
     False, $CellContext`showLabels$31138$$ = 
     False, $CellContext`showGrids$31139$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = 
         False, $CellContext`showLabels$$ = 
         True, $CellContext`showVectors$$ = {1}, $CellContext`tMax$$ = 
         2 Pi, $CellContext`tMin$$ = 0, $CellContext`xMax$$ = 
         2, $CellContext`xMin$$ = -2, $CellContext`yMax$$ = 
         2, $CellContext`yMin$$ = -2, $CellContext`zMax$$ = 
         2, $CellContext`zMin$$ = -2}, "ControllerVariables" :> {
         Hold[$CellContext`showVectors$$, $CellContext`showVectors$31137$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$31138$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$31139$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          ParametricPlot3D[
           $CellContext`funcC14F25r[$CellContext`t], {$CellContext`t, 0, 2 
            ...
            If[
             MemberQ[$CellContext`showVectors$$, 1], {$CellContext`bcR, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F25r[$CellContext`i], \
$CellContext`funcC14F25r[$CellContext`i] + $CellContext`funcC14F25f[
                    Part[
                    $CellContext`funcC14F25r[$CellContext`i], 1], 
                    Part[
                    $CellContext`funcC14F25r[$CellContext`i], 2], 
                    Part[
                    $CellContext`funcC14F25r[$CellContext`i], 
             ...
             MemberQ[$CellContext`showVectors$$, 2], {$CellContext`bcG, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F25r[$CellContext`i], \
$CellContext`funcC14F25r[$CellContext`i] + Normalize[
                    Derivative[
                    1][$CellContext`funcC14F25r][$CellContext`i]]}]], \
             ...
             MemberQ[$CellContext`showVectors$$, 3], {$CellContext`bcB, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F25r[$CellContext`i], \
$CellContext`funcC14F25r[$CellContext`i] + Projection[
                    $CellContext`funcC14F25f[
                    Part[
                    $CellContext`funcC14F25r[$CellContext`i], 1], 
                    Part[
                    $CellContext`funcC14F25r[$CellContext`i], 2], 
                    Part[
                    $CellContext`funcC14F25r[$CellContext`i], 3]], 
                    Derivative[
                    1][$CellContext`funcC14F25r][$CellContext`i]]}]], \
{$CellContext`i, 0, 2 Pi, Pi/12}]}, Black]}]}, 
...
$CellContext`zMax$$}}, ImageSize -> 6 {72, 72}, BaseStyle -> {"Text", 13}, 
         Lighting -> "Neutral", Boxed -> False, ViewPoint -> {-1, 4, 2}], 
       "Specifications" :> {{{$CellContext`showVectors$$, {1}, ""}, {
          1 -> Panel[
             Pane[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"F\",\nFontWeight->Bold,\
\nFontSlant->Plain], \"=\", \n  RowBox[{\"\[LeftAngleBracket]\", \n   \
...
FontSlant->Plain]\) on unit tangent vectors of \!\(TraditionalForm\`C\)", {
          ...
          Appearance -> "Vertical", ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], 
...
$CellContext`bcR = RGBColor[0.8, 0, 0.4], $CellContext`funcC14F25f[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]], 
            Pattern[$CellContext`z, 
             ...
             Blank[]]] := {$CellContext`z, $CellContext`x, -$CellContext`y}, \
$CellContext`bcG = RGBColor[0, 0.6, 0.4], 
          Attributes[Derivative] = {
           NHoldAll, ReadProtected}, $CellContext`bcB = 
          RGBColor[0, 0.4, 0.8]}; {Null, Null}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.2, Figure 14.25"], "Header"]}, {
   Cell[
    TextData["Section 14.2, Figure 14.25"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 20540, 426, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 6INhF8Ypd#@QUIkKPfr5lrF9 *)
