...
NotebookDataLength[     60039,       1316]
NotebookOptionsPosition[     27377,        558]
NotebookOutlinePosition[     60815,       1328]
CellTagsIndexPosition[     60772,       1325]
WindowTitle->Section 14.6, Figure 14.49
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 2, $CellContext`showGrids$$ = 
     ...
     Pi, $CellContext`uMin$$ = 0, $CellContext`uValue$$ = Rational[1, 2] 
     Pi, $CellContext`vMax$$ = 6, $CellContext`vMin$$ = 
     0, $CellContext`vValue$$ = 4, $CellContext`xMax$$ = 
     5, $CellContext`xMin$$ = -5, $CellContext`yMax$$ = 
     5, $CellContext`yMin$$ = -5, $CellContext`zMax$$ = 
     9, $CellContext`zMin$$ = -1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`aValue$$], 2, 
        "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0.1, 3, 0.01}, {{
        Hold[$CellContext`aValue$$], 2, ""}, 0.1, 3, 0.01}, {
       Hold[
        Pane[
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`vMax$$], 6}, 0}, {{
        Hold[$CellContext`uValue$$], Rational[1, 2] Pi}, 0}, {{
        Hold[$CellContext`vValue$$], 4}, 0}}, Typeset`size$$ = {
     512., {159.34375, 164.65625}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`aValue$33123$$ = 
     0, $CellContext`showLabels$33124$$ = 
     False, $CellContext`showGrids$33125$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 2, $CellContext`showGrids$$ = 
         ...
         Rational[1, 2] Pi, $CellContext`vMax$$ = 6, $CellContext`vMin$$ = 
         0, $CellContext`vValue$$ = 4, $CellContext`xMax$$ = 
         5, $CellContext`xMin$$ = -5, $CellContext`yMax$$ = 
         5, $CellContext`yMin$$ = -5, $CellContext`zMax$$ = 
         9, $CellContext`zMin$$ = -1}, "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$33123$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$33124$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$33125$$, 
          False]}, 
       "OtherVariables" :> {
            ...
            Show[{
              Graphics[{
                ...
                Dynamic[
                 ...
                 Rectangle[{$CellContext`uMin$$, $CellContext`vMin$$}, \
{$CellContext`uMax$$, $CellContext`vMax$$}]], 
                Dynamic[
...
{$CellContext`uValue$$, $CellContext`vMax$$}}]}, Black]], 
                If[$CellContext`showLabels$$, {Black, 
                  Dynamic[
                   Text[
                   "\!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)", {
                    Min[$CellContext`uMin$$, $CellContext`uMax$$], 
                    Max[$CellContext`vMin$$, $CellContext`vMax$$]}, {-1.5, 
                    1.5}]]}, Black], Black, 
                Locator[
               ...
               BaseStyle -> {"Text", 13}, AspectRatio -> 1.5, Ticks -> {
                 Range[0, 2 Pi, Pi/2], 
                 Range[0, 10]}, AxesStyle -> Arrowheads[0.06], 
               AxesLabel -> {
                "\!\(\*\nStyleBox[\"u\",\nFontSlant->\"Italic\"]\)", 
                 "\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\)"}, Axes -> 
               True, ImageSize -> 2.5 72, 
               PlotRange -> {{0, 2 Pi + 1}, {0, 10}}]}]], 
           Dynamic[
            Show[{
...
$CellContext`vValue$$ <= $CellContext`vMax$$], {
                  ...
                  "\!\(\*\nStyleBox[FormBox[\n  StyleBox[\"n\",\n\
FontWeight->Bold,\nFontSlant->Plain],\n  TraditionalForm],\n\
FontSlant->\"Italic\"]\)", $CellContext`funcC14F49[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$] + 
                   1.1 $CellContext`funcC14F49N[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$], {0, 0}]}, Black], 
                Arrowheads[0.03], Orange, 
                Arrow[
                 Tube[{{0, 0, 0}, 
                   $CellContext`funcC14F49[$CellContext`uValue$$, \
...
$CellContext`vMax$$], 
                 Arrow[
                  Tube[{
                    $CellContext`funcC14F49[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$], \
$CellContext`funcC14F49[$CellContext`uValue$$, $CellContext`vValue$$, \
$CellContext`aValue$$] + $CellContext`funcC14F49N[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$]}]], Black]}], 
              ParametricPlot3D[
               $CellContext`funcC14F49[$CellContext`u, $CellContext`v, \
...
\"=\", \"a\"}],\n TraditionalForm]\)", $CellContext`bcPBS], $CellContext`bcFO,
       ...
       "Specifications" :> {{{$CellContext`aValue$$, 2, 
          ...
          Small}, {{$CellContext`aValue$$, 2, ""}, 0.1, 3, 0.01, ControlType -> 
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
         ...
         Grid[{{
          ...
          None}, {{$CellContext`vMax$$, 6}, 0, ControlType -> 
          None}, {{$CellContext`uValue$$, Rational[1, 2] Pi}, 0, ControlType -> 
          None}, {{$CellContext`vValue$$, 4}, 0, ControlType -> None}}, 
       "Options" :> {
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F49[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]], 
            Pattern[$CellContext`a, 
             Blank[]]] := {$CellContext`a Cos[$CellContext`u], $CellContext`a 
            Sin[$CellContext`u], $CellContext`v}, $CellContext`u[
...
$CellContext`v[
            Pattern[$CellContext`t, 
             Blank[]]] := 3 - $CellContext`t/2, $CellContext`funcC14F49N[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]], 
            Pattern[$CellContext`a, 
             Blank[]]] := {$CellContext`a Cos[$CellContext`u], $CellContext`a 
            Sin[$CellContext`u], 0}, $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.49"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.49"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 26098, 525, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature XL4QpWtj3qJKTJk5q6QHL4bM *)
