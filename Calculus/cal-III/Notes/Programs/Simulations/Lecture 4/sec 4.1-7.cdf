...
NotebookDataLength[     52279,       1173]
NotebookOptionsPosition[     19617,        415]
NotebookOutlinePosition[     53055,       1185]
CellTagsIndexPosition[     53012,       1182]
WindowTitle->Section 14.1, Figure 14.09
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = 
     False, $CellContext`showPoints$$ = True, $CellContext`showVectors$$ = 
     True, $CellContext`xDivisions$$ = 3, $CellContext`xMax$$ = 
     1.5, $CellContext`xMin$$ = -1.5, $CellContext`yDivisions$$ = 
     3, $CellContext`yMax$$ = 
     1.5, $CellContext`yMin$$ = -1.5, $CellContext`zDivisions$$ = 
     3, $CellContext`zMax$$ = 2.5, $CellContext`zMin$$ = 0, Typeset`show$$ = 
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showPoints$$], True, "show field points"}, {
       True, False}}, {
       Hold[
        Row[{
          Manipulate`Place[1]}]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`xDivisions$$], 3, 
        "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) divisions"}, 2, 8, 
       1}, {{
        Hold[$CellContext`yDivisions$$], 3, 
        "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\) divisions"}, 2, 8, 
       1}, {{
        Hold[$CellContext`zDivisions$$], 3, 
        "\!\(\*\nStyleBox[\"z\",\nFontSlant->\"Italic\"]\) divisions"}, 2, 8, 
       1}, {
       Hold[
        Grid[{{
        ...
        Hold[$CellContext`showVectors$$], True, "show vector field"}, {
       True, False}}, {{
       ...
       True, False}}, {{
        ...
        Hold[$CellContext`zMax$$], 2.5}, 0}}, Typeset`size$$ = {
     432., {213., 219.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showPoints$29939$$ = 
     False, $CellContext`xDivisions$29940$$ = 
     0, $CellContext`yDivisions$29941$$ = 0, $CellContext`zDivisions$29942$$ =
      0, $CellContext`showVectors$29943$$ = 
     False, $CellContext`showGrids$29944$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = 
         ...
         3, $CellContext`yMax$$ = 
         1.5, $CellContext`yMin$$ = -1.5, $CellContext`zDivisions$$ = 
         3, $CellContext`zMax$$ = 2.5, $CellContext`zMin$$ = 0}, 
       "ControllerVariables" :> {
         Hold[$CellContext`showPoints$$, $CellContext`showPoints$29939$$, 
          False], 
         Hold[$CellContext`xDivisions$$, $CellContext`xDivisions$29940$$, 0], 
         
         Hold[$CellContext`yDivisions$$, $CellContext`yDivisions$29941$$, 0], 
         
         Hold[$CellContext`zDivisions$$, $CellContext`zDivisions$29942$$, 0], 
         
         Hold[$CellContext`showVectors$$, $CellContext`showVectors$29943$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$29944$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          If[$CellContext`showVectors$$, 
           VectorPlot3D[{$CellContext`x, $CellContext`y, 
             Exp[-$CellContext`z]}, {$CellContext`x, -1, 
             1}, {$CellContext`y, -1, 1}, {$CellContext`z, 0, 2}, 
            VectorStyle -> {{"Arrow3D", $CellContext`bcR}}, 
            VectorScale -> {0.15, 0.3, Automatic}, 
            VectorPoints -> {$CellContext`xDivisions$$, \
$CellContext`yDivisions$$, $CellContext`zDivisions$$}], 
           Graphics3D[{}]], 
          If[$CellContext`showPoints$$, 
           Graphics3D[{Black, 
             AbsolutePointSize[3], 
             Table[
              
              Point[{$CellContext`i, $CellContext`j, $CellContext`k}], \
{$CellContext`i, -1, 1, 2/($CellContext`xDivisions$$ - 
               1)}, {$CellContext`j, -1, 1, 2/($CellContext`yDivisions$$ - 
               1)}, {$CellContext`k, 0, 2, 2/($CellContext`zDivisions$$ - 
               1)}]}], 
           Graphics3D[{}]]}, 
         PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
            0.5, $CellContext`zMax$$}}, ImageSize -> 6 {72, 72}, 
...
\[LeftAngleBracket]\", \n     RowBox[{\"x\", \",\", \"y\", \",\", \
SuperscriptBox[\"e\", \n       RowBox[{\"-\", \"z\"}]]}], \"\
\[RightAngleBracket]\"}], \" \", \"for\", \" \", \"z\"}], \
\"\[GreaterEqual]\", \"0\"}]}],\n TraditionalForm]\)", {
              Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], 
            ImageScaled[{0.5, 0}], 
            ImageScaled[{0.5, 0}]]}], 
       "Specifications" :> {{{$CellContext`showPoints$$, True, 
           "show field points"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], {{$CellContext`xDivisions$$, 3, 
           "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\) divisions"}, 2, 
          8, 1, ControlType -> PopupMenu, ImageSize -> Small, 
          ControlPlacement -> 
          2}, {{$CellContext`yDivisions$$, 3, 
           "\!\(\*\nStyleBox[\"y\",\nFontSlant->\"Italic\"]\) divisions"}, 2, 
          8, 1, ControlType -> PopupMenu, ImageSize -> Small, 
          ControlPlacement -> 
          3}, {{$CellContext`zDivisions$$, 3, 
           "\!\(\*\nStyleBox[\"z\",\nFontSlant->\"Italic\"]\) divisions"}, 2, 
          8, 1, ControlType -> PopupMenu, ImageSize -> Small, 
          ControlPlacement -> 4}, 
         Grid[{{
            ...
            Manipulate`Place[3]}, {
            Manipulate`Place[4]}}], 
         Delimiter, {{$CellContext`showVectors$$, True, 
         ...
         Delimiter, {{$CellContext`showGrids$$, False, "show grids"}, {
          ...
          None}, {{$CellContext`zMax$$, 2.5}, 0, ControlType -> None}}, 
       "Options" :> {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.1, Figure 14.09"], "Header"]}, {
   Cell[
    TextData["Section 14.1, Figure 14.09"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 18338, 382, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature HJji7gc0TjEWaKkej@6t0Cz@ *)
