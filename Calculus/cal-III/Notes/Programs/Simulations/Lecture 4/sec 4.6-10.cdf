...
NotebookDataLength[     42979,        968]
NotebookOptionsPosition[     10318,        210]
NotebookOutlinePosition[     43756,        980]
CellTagsIndexPosition[     43713,        977]
WindowTitle->Section 14.6, Figure 14.52
WindowFrame->Normal*)
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
     ...
     288., {121.1875, 127.8125}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`aValue$33418$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 2, $CellContext`showGrids$$ = 
         ...
         Hold[$CellContext`aValue$$, $CellContext`aValue$33418$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`uMax$$, {$CellContext`bcG, 
                ...
                If[$CellContext`showLabels$$, {Black, 
                  ...
                  "\!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)", {0, 
                   0}, {-2, -2}], 
                  Text[
                  "\!\(TraditionalForm\`v = 16 - 8  cos\\ u\)", {
                   1.4 Pi, 20}, {-1, -2}]}, Black], Black, Orange, 
                Locator[
                 Dynamic[{$CellContext`uValue$$, $CellContext`vValue$$}]]}]}, 
             BaseStyle -> {"Text", 13}, Ticks -> {
               Range[0, 2 Pi, Pi/2], 
               Range[0, 25, 5]}, AxesStyle -> Arrowheads[0.03], 
             AxesLabel -> {
              "\!\(\*\nStyleBox[\"u\",\nFontSlant->\"Italic\"]\)", 
               "\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\)"}, Axes -> 
             True, AxesOrigin -> {0, 0}, ImageSize -> 4 72, 
             PlotRange -> {{0, 2 Pi + 1}, {0, 25}}]]}, {
           Framed[
            Pane[
            "Region of integration in the \!\(\*\nStyleBox[\"uv\",\n\
FontSlant->\"Italic\"]\)\!\(\*\nStyleBox[\"\[Hyphen]\",\n\
FontSlant->\"Italic\"]\)plane is \!\(TraditionalForm\`R = {\((u, v)\) : 0 \
\[LessEqual] u \[LessEqual] 2  \[Pi], 0 \[LessEqual] v \[LessEqual] 16 - 8  \
cos\\ u}\).", {250, Automatic}, $CellContext`bcPBS], $CellContext`bcFO]}}, 
         BaseStyle -> {"TR", 13}], 
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
          BaseStyle -> {
           ...
           "show labels"}, 0, ControlType -> None, ControlPlacement -> 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.52"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.52"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 9039, 177, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature fJNRkTVdjXfchL#dG8UIniJj *)
