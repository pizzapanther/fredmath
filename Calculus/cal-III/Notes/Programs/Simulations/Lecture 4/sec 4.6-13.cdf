...
NotebookDataLength[     60825,       1330]
NotebookOptionsPosition[     28163,        572]
NotebookOutlinePosition[     61601,       1342]
CellTagsIndexPosition[     61558,       1339]
WindowTitle->Section 14.6, Figure 14.55
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1.5, $CellContext`showGrids$$ = 
     False, $CellContext`showLabels$$ = False, $CellContext`uMax$$ = 
     1, $CellContext`uMin$$ = -1, $CellContext`uValue$$ = 
     0, $CellContext`vMax$$ = 2 Pi, $CellContext`vMin$$ = 
     0, $CellContext`vValue$$ = 0, $CellContext`xMax$$ = 
     3, $CellContext`xMin$$ = -3, $CellContext`yMax$$ = 
     3, $CellContext`yMin$$ = -3, $CellContext`zMax$$ = 
     3, $CellContext`zMin$$ = -3, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`vValue$$], 0, 
        "\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\)"}, 0, 2 Pi, 
       0.01}, {{
        Hold[$CellContext`vValue$$], 0, ""}, 0, 2 Pi, 0.01}, {{
        Hold[$CellContext`aValue$$], 1.5, 
        "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0.1, 2, 0.01}, {{
        Hold[$CellContext`aValue$$], 1.5, ""}, 0.1, 2, 0.01}, {
       Hold[
        Pane[
        "Drag the \[CircleTimes] symbols to change the rectangle R.", {
         144, Automatic}, 
         BaseStyle -> {
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
         BaseStyle -> {
          LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
           LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
           Left}]], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`showLabels$$], False, "show labels"}, {
       True, False}}, {{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`uMin$$], -1}, 0}, {{
        Hold[$CellContext`uMax$$], 1}, 0}, {{
        Hold[$CellContext`vMin$$], 0}, 0}, {{
        Hold[$CellContext`vMax$$], 2 Pi}, 0}, {{
        Hold[$CellContext`uValue$$], 0}, 0}, {{
        Hold[$CellContext`vValue$$], 0}, 0}}, Typeset`size$$ = {
     512., {177.34375, 182.65625}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`vValue$33651$$ = 
     0, $CellContext`aValue$33652$$ = 0, $CellContext`showLabels$33653$$ = 
     False, $CellContext`showGrids$33654$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1.5, $CellContext`showGrids$$ = 
         False, $CellContext`showLabels$$ = False, $CellContext`uMax$$ = 
         1, $CellContext`uMin$$ = -1, $CellContext`uValue$$ = 
         0, $CellContext`vMax$$ = 2 Pi, $CellContext`vMin$$ = 
         0, $CellContext`vValue$$ = 0, $CellContext`xMax$$ = 
         ...
         Hold[$CellContext`vValue$$, $CellContext`vValue$33651$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$33652$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$33653$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$33654$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`uValue$$, $CellContext`vMax$$}}]}, Black]], Black, 
                Locator[
                 Dynamic[{$CellContext`uMin$$, $CellContext`vMin$$}], 
                 Style["\[CircleTimes]", Larger]], 
                Locator[
                 Dynamic[{$CellContext`uMax$$, $CellContext`vMax$$}], 
                 Style["\[CircleTimes]", Larger]], Orange, 
                Locator[
                 Dynamic[{$CellContext`uValue$$, $CellContext`vValue$$}]]}, 
               BaseStyle -> {"Text", 13}, AspectRatio -> 2, Ticks -> {
                 Range[-1, 1], 
...
$CellContext`vValue$$ <= $CellContext`vMax$$], {
                  ...
                  "\!\(\*FormBox[\n StyleBox[\"n\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", \
$CellContext`funcC14F55[$CellContext`uValue$$, $CellContext`vValue$$, \
$CellContext`aValue$$] + 
                   1.2 $CellContext`funcC14F55N[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$], {0, 0}]}, Black], 
                Arrowheads[0.03], Orange, 
                Arrow[
                 Tube[{{0, 0, 0}, 
                   $CellContext`funcC14F55[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$]}]], Brown, 
                If[
...
$CellContext`vMax$$], 
                 Arrow[
                  Tube[{
                    $CellContext`funcC14F55[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$], \
$CellContext`funcC14F55[$CellContext`uValue$$, $CellContext`vValue$$, \
$CellContext`aValue$$] + 
                    0.7 $CellContext`funcC14F55N[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$]}]], Black]}], 
              ParametricPlot3D[
               $CellContext`funcC14F55[$CellContext`u, $CellContext`v, \
$CellContext`aValue$$], {$CellContext`u, $CellContext`uMin$$, \
$CellContext`uMax$$}, {$CellContext`v, $CellContext`vMin$$, \
$CellContext`vMax$$}, 
               ...
               MeshStyle -> {{
                  ...
                  FaceForm[$CellContext`bcSurfaceTop, \
$CellContext`bcSurfaceBottom], 
...
\[LeftAngleBracket]\", \n   RowBox[{\n    RowBox[{\n     RowBox[{\"(\", \n    \
  RowBox[{\"a\", \" \", \"+\", \n       RowBox[{\"u\", \" \", \"cos\", \" \", \
\n        RowBox[{\"(\", FractionBox[\"v\", \"2\"], \")\"}]}]}], \")\"}], \
\"cos\", \" \", \"v\"}], \",\", \n    RowBox[{\n     RowBox[{\"(\", \n      \
RowBox[{\"a\", \"+\", \n       RowBox[{\"u\", \" \", \"cos\", \" \", \n       \
 RowBox[{\"(\", FractionBox[\"v\", \"2\"], \")\"}]}]}], \")\"}], \"sin\", \" \
\", \"v\"}], \",\", \n    RowBox[{\"u\", \" \", \n     RowBox[{\"sin\", \
\"(\", FractionBox[\"v\", \"2\"], \")\"}]}]}], \"\[RightAngleBracket]\"}]}],\n\
 TraditionalForm]\)", 
                   BaseStyle -> {
                    LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                 ...
                 Inset[
                  ...
                  ImageScaled[{0, 0.5}], {-1, 1}]}, Black]}]]}}], 
       "Specifications" :> {{{$CellContext`vValue$$, 0, 
           "\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\)"}, 0, 2 Pi, 
          0.01, ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`vValue$$, 0, ""}, 0, 2 Pi, 0.01, ControlType -> 
         ...
         Delimiter, {{$CellContext`aValue$$, 1.5, 
          ...
          Small}, {{$CellContext`aValue$$, 1.5, ""}, 0.1, 2, 0.01, 
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], Delimiter, {{$CellContext`showLabels$$, False, 
         ...
         Grid[{{
          ...
          None}, {{$CellContext`uMin$$, -1}, 0, ControlType -> 
          None}, {{$CellContext`uMax$$, 1}, 0, ControlType -> 
          None}, {{$CellContext`vMin$$, 0}, 0, ControlType -> 
          None}, {{$CellContext`vMax$$, 2 Pi}, 0, ControlType -> 
          None}, {{$CellContext`uValue$$, 0}, 0, ControlType -> 
          None}, {{$CellContext`vValue$$, 0}, 0, ControlType -> None}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
      ImageSizeCache->{683., {195., 201.}},
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F55[
            ...
            Pattern[$CellContext`r, 
             ...
             Blank[]]] := {($CellContext`r + $CellContext`u 
              Cos[(1/2) $CellContext`v]) 
            Cos[$CellContext`v], ($CellContext`r + $CellContext`u 
              Cos[(1/2) $CellContext`v]) Sin[$CellContext`v], $CellContext`u 
            Sin[$CellContext`v/2]}, $CellContext`u[
...
$CellContext`v[
            Pattern[$CellContext`t, 
             Blank[]]] := 3 - $CellContext`t/2, $CellContext`funcC14F55N[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]], 
            Pattern[$CellContext`r, 
             Blank[]]] := {((-$CellContext`r) Cos[$CellContext`v]) 
             Sin[$CellContext`v/2] - (($CellContext`u Cos[$CellContext`v/2]) 
             Cos[$CellContext`v]) 
            Sin[$CellContext`v/2] + (((1/2) $CellContext`u) 
              Cos[$CellContext`v/2]^2) 
             Sin[$CellContext`v] + (((1/2) $CellContext`u) 
              Sin[$CellContext`v/2]^2) 
             Sin[$CellContext`v], (((-(1/2)) $CellContext`u) 
              Cos[$CellContext`v/2]^2) 
             Cos[$CellContext`v] - (((1/2) $CellContext`u) 
             Cos[$CellContext`v]) 
            Sin[$CellContext`v/2]^2 - ($CellContext`r Sin[$CellContext`v/2]) 
            Sin[$CellContext`v] - (($CellContext`u Cos[$CellContext`v/2]) 
             Sin[$CellContext`v/2]) 
            Sin[$CellContext`v], ($CellContext`r Cos[$CellContext`v/2]) 
             Cos[$CellContext`v]^2 + ($CellContext`u Cos[$CellContext`v/2]^2) 
             Cos[$CellContext`v]^2 + ($CellContext`r Cos[$CellContext`v/2]) 
             Sin[$CellContext`v]^2 + ($CellContext`u Cos[$CellContext`v/2]^2) 
             Sin[$CellContext`v]^2}, $CellContext`bcSurfaceTop = 
          RGBColor[0.85, 0.6, 0.2], $CellContext`DisplayNumber[
            Pattern[$CellContext`num, 
             Blank[]]] := 
          If[Abs[$CellContext`num - Round[$CellContext`num, 1]] < 0.001, 
            Round[$CellContext`num, 1], $CellContext`num]}; {Null, Null}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.55"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.55"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 26884, 539, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 9I4Aeyaxf7rxEI5eukhFT2aR *)
