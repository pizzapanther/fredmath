...
NotebookDataLength[     42146,        957]
NotebookOptionsPosition[      9485,        199]
NotebookOutlinePosition[     42923,        969]
CellTagsIndexPosition[     42880,        966]
WindowTitle->Section 14.2, Figure 14.24
WindowFrame->Normal*)
...
\"\[RightAngleBracket]\"}]}],\n TraditionalForm]\) rotation field", {
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showField$31076$$ = False}, 
     ...
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showField$$ = 1, $CellContext`showGrids$$ = 
         ...
         Hold[$CellContext`showField$$, $CellContext`showField$31076$$, 
          False]}, 
       "OtherVariables" :> {
...
\!\(TraditionalForm\`C\) and has zero circulation on \
\!\(TraditionalForm\`C\).", {
...
\!\(TraditionalForm\`C\) and has positive circulation on \
\!\(TraditionalForm\`C\).", {
                250, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> White], 
              ImageScaled[{0.5, 0}], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.2, Figure 14.24"], "Header"]}, {
   Cell[
    TextData["Section 14.2, Figure 14.24"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 8206, 166, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 8JjRHSg#OpnnTLkXAwkCkiIw *)
