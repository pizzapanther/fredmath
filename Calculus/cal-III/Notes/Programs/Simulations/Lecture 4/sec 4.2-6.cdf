...
NotebookDataLength[     68283,       1494]
NotebookOptionsPosition[     35621,        736]
NotebookOutlinePosition[     69059,       1506]
CellTagsIndexPosition[     69016,       1503]
WindowTitle->Section 14.2, Figure 14.23
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = 
     ...
     True, $CellContext`showVectors$$ = {}, $CellContext`tMax$$ = Rational[
     3, 2], $CellContext`tMin$$ = 0, $CellContext`tValue$$ = 
     0, $CellContext`xMax$$ = 
     1, $CellContext`xMin$$ = -3.5, $CellContext`yMax$$ = 
     3.5, $CellContext`yMin$$ = -1, $CellContext`zMax$$ = 
     3, $CellContext`zMin$$ = -1, Typeset`show$$ = True, 
...
FontWeight->Bold,\nFontSlant->Plain]}],\n TraditionalForm]\)"}}, {
       ...
       Hold[
        ...
        Hold[$CellContext`showVectors$$], {}, ""}, {1 -> Panel[
          Pane[
          "show \!\(\*FormBox[\n StyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\) on \!\(TraditionalForm\`C\)", {
           110, Automatic}, 
           BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             ...
             Left}]], 2 -> Panel[
          Pane[
          "show unit tangent vectors of \!\(TraditionalForm\`C\)", {
           110, Automatic}, 
           BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
          ...
          Pane[
          "show projection of \!\(\*\nStyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain]\) on unit tangent vectors of \!\(TraditionalForm\`C\)", {
           110, Automatic}, 
           BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
       ...
       True, False}}, {{
        ...
        Hold[$CellContext`yMax$$], 3.5}, 0}, {{
        Hold[$CellContext`zMin$$], -1}, 0}, {{
        Hold[$CellContext`zMax$$], 3}, 0}, {{
        Hold[$CellContext`tMin$$], 0}, 0}, {{
        Hold[$CellContext`tMax$$], 
        Rational[3, 2]}, 0}}, Typeset`size$$ = {432., {213., 219.}}, 
     Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`showItems$30991$$ = 
     False, $CellContext`tValue$30992$$ = 
     0, $CellContext`showVectors$30993$$ = 
     False, $CellContext`showLabels$30994$$ = 
     False, $CellContext`showGrids$30995$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = 
         False, $CellContext`showItems$$ = {2, 3}, $CellContext`showLabels$$ = 
         True, $CellContext`showVectors$$ = {}, $CellContext`tMax$$ = 
         Rational[3, 2], $CellContext`tMin$$ = 0, $CellContext`tValue$$ = 
         0, $CellContext`xMax$$ = 
         1, $CellContext`xMin$$ = -3.5, $CellContext`yMax$$ = 
         3.5, $CellContext`yMin$$ = -1, $CellContext`zMax$$ = 
         3, $CellContext`zMin$$ = -1}, "ControllerVariables" :> {
         Hold[$CellContext`showItems$$, $CellContext`showItems$30991$$, 
          False], 
         Hold[$CellContext`tValue$$, $CellContext`tValue$30992$$, 0], 
         Hold[$CellContext`showVectors$$, $CellContext`showVectors$30993$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$30994$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$30995$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          ParametricPlot3D[
           $CellContext`funcC14F23r[$CellContext`t], {$CellContext`t, \
$CellContext`tMin$$, $CellContext`tMax$$}, PlotStyle -> {{Black, Thick}}], 
          Graphics3D[{
            Arrowheads[0.03], 
            AbsoluteThickness[1.5], 
            AbsolutePointSize[6], 
            Point[
             $CellContext`funcC14F23r[$CellContext`tValue$$]], 
            If[
             MemberQ[$CellContext`showVectors$$, 1], {$CellContext`bcR, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F23r[$CellContext`i], \
$CellContext`funcC14F23r[$CellContext`i] + $CellContext`funcC14F23f[
                    Part[
                    $CellContext`funcC14F23r[$CellContext`i], 1], 
                    Part[
                    $CellContext`funcC14F23r[$CellContext`i], 2], 
                    Part[
                    $CellContext`funcC14F23r[$CellContext`i], 
                    3]]}]], {$CellContext`i, $CellContext`tMin$$, \
$CellContext`tMax$$, ($CellContext`tMax$$ - $CellContext`tMin$$)/12}]}, 
             Black], 
            If[
             MemberQ[$CellContext`showVectors$$, 2], {$CellContext`bcG, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F23r[$CellContext`i], \
$CellContext`funcC14F23r[$CellContext`i] + Normalize[
                    Derivative[
                    1][$CellContext`funcC14F23r][$CellContext`i]]}]], \
{$CellContext`i, $CellContext`tMin$$, $CellContext`tMax$$, \
($CellContext`tMax$$ - $CellContext`tMin$$)/12}]}, Black], 
            If[
             MemberQ[$CellContext`showVectors$$, 3], {$CellContext`bcB, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F23r[$CellContext`i], \
$CellContext`funcC14F23r[$CellContext`i] + Projection[
                    $CellContext`funcC14F23f[
                    Part[
                    $CellContext`funcC14F23r[$CellContext`i], 1], 
                    Part[
                    $CellContext`funcC14F23r[$CellContext`i], 2], 
                    Part[
                    $CellContext`funcC14F23r[$CellContext`i], 3]], 
                    Derivative[
                    1][$CellContext`funcC14F23r][$CellContext`i]]}]], \
{$CellContext`i, $CellContext`tMin$$, $CellContext`tMax$$, \
($CellContext`tMax$$ - $CellContext`tMin$$)/12}]}, Black], 
...
StyleBox[\"r\",\nFontWeight->Bold,\nFontSlant->Plain], \"(\", \"t\", \")\"}],\
\n   TraditionalForm],\nFontWeight->Bold,\nFontSlant->Plain],\n \
TraditionalForm]\)", 1.2 $CellContext`funcC14F23r[$CellContext`tValue$$]], 
               Black], Orange, 
              Arrow[
               Tube[{{0, 0, 0}, 
                 $CellContext`funcC14F23r[$CellContext`tValue$$]}]]}, Black], 
            ...
            If[
             MemberQ[$CellContext`showItems$$, 2], {Black, 
              If[$CellContext`showLabels$$, 
               ...
               "\!\(\*FormBox[\n StyleBox[\"T\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", \
$CellContext`funcC14F23r[$CellContext`tValue$$] + 1.2 Normalize[
                   Derivative[
                   1][$CellContext`funcC14F23r][$CellContext`tValue$$]]], 
               Black], $CellContext`bcG, 
              Arrow[
               Tube[{
                 $CellContext`funcC14F23r[$CellContext`tValue$$], \
$CellContext`funcC14F23r[$CellContext`tValue$$] + Normalize[
                   Derivative[
                   1][$CellContext`funcC14F23r][$CellContext`tValue$$]]}]]}, 
             Black], 
            If[
...
StyleBox[\"F\",\nFontWeight->Bold,\nFontSlant->Plain], \"(\", \n    RowBox[{\n\
     StyleBox[\"r\",\nFontWeight->Bold,\nFontSlant->Plain], \"(\", \"t\", \")\
\"}], \")\"}],\n   TraditionalForm],\nFontWeight->Bold,\nFontSlant->Plain],\n \
TraditionalForm]\)", $CellContext`funcC14F23r[$CellContext`tValue$$] + 
                1.3 $CellContext`funcC14F23f[
                   Part[
                    $CellContext`funcC14F23r[$CellContext`tValue$$], 1], 
                   Part[
                    $CellContext`funcC14F23r[$CellContext`tValue$$], 2], 
                   Part[
                    $CellContext`funcC14F23r[$CellContext`tValue$$], 3]]], 
               Black], $CellContext`bcR, 
              Arrow[
               Tube[{
                 $CellContext`funcC14F23r[$CellContext`tValue$$], \
$CellContext`funcC14F23r[$CellContext`tValue$$] + $CellContext`funcC14F23f[
                   Part[
                    $CellContext`funcC14F23r[$CellContext`tValue$$], 1], 
                   Part[
                    $CellContext`funcC14F23r[$CellContext`tValue$$], 2], 
...
StyleBox[\"T\",\nFontWeight->Bold,\nFontSlant->Plain]], \n  StyleBox[\"F\",\n\
FontWeight->Bold,\nFontSlant->Plain]}],\n TraditionalForm]\)", \
$CellContext`funcC14F23r[$CellContext`tValue$$] + 1.1 Projection[
                   $CellContext`funcC14F23f[
                    Part[
                    $CellContext`funcC14F23r[$CellContext`tValue$$], 1], 
                    Part[
              ...
              Arrow[
               Tube[{
                 $CellContext`funcC14F23r[$CellContext`tValue$$], \
$CellContext`funcC14F23r[$CellContext`tValue$$] + Projection[
                   $CellContext`funcC14F23f[
                    Part[
                    $CellContext`funcC14F23r[$CellContext`tValue$$], 1], 
                    Part[
...
$CellContext`zMax$$}}, ImageSize -> 6 {72, 72}, BaseStyle -> {"Text", 13}, 
         Lighting -> "Neutral", Boxed -> False, ViewPoint -> {4, 1, 1}, 
         Epilog -> {
           If[$CellContext`showLabels$$, {
             Inset[
              Framed[
               Graphics[{Black, 
                 Text[
                  Which[Dot[
                    ...
                    Normalize[
                    Derivative[
                    1][$CellContext`funcC14F23r][$CellContext`tValue$$]]] < 0,
                    "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   \
...
TraditionalForm]\)"], {
             ...
             If[
              Or[
               MemberQ[$CellContext`showItems$$, 4], 
              ...
              Inset[
               Framed[
                ...
                "\!\(\*FormBox[\n RowBox[{SubscriptBox[\"proj\", \n   \
StyleBox[\"T\",\nFontWeight->Bold,\nFontSlant->Plain]], \n  StyleBox[\"F\",\n\
FontWeight->Bold,\nFontSlant->Plain]}],\n TraditionalForm]\) is the component \
of \!\(\*\nStyleBox[\"F\",\nFontWeight->Bold,\nFontSlant->Plain]\) in the \
direction of motion:\n\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   \
StyleBox[\"F\",\nFontWeight->Bold,\nFontSlant->Plain], \"\[CenterDot]\", \n   \
StyleBox[\"T\",\nFontWeight->Bold,\nFontSlant->Plain]}], \"=\", \n  RowBox[{\n\
...
\[Theta]\"}]}],\n TraditionalForm]\)", {
             ...
             Inset[
              Framed[
               Pane[
               "\!\(\*FormBox[\n RowBox[{\"Work\", \"=\", \n  \
RowBox[{SubscriptBox[\"\[Integral]\", \"C\"], \n   RowBox[{\n    RowBox[{\n   \
  StyleBox[\"F\",\nFontWeight->Bold,\nFontSlant->Plain], \"\[CenterDot]\", \n \
    StyleBox[\"T\",\nFontWeight->Bold,\nFontSlant->Plain]}], \" \", \"d\", \"\
\[VeryThinSpace]\", \"s\"}]}]}],\n TraditionalForm]\)", {
                Automatic, 
...
FontWeight->Bold,\nFontSlant->Plain]}],\n TraditionalForm]\)"}, ControlType -> 
          CheckboxBar, Appearance -> "Small", ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], "", 
         "location on \!\(\*\nStyleBox[\"C\",\nFontSlant->\"Italic\"]\)", \
{{$CellContext`tValue$$, 0, ""}, 0, 
          Rational[3, 2], ControlType -> Slider, ImageSize -> Small, 
          ControlPlacement -> 2}, 
         Row[{
           Manipulate`Place[2]}], {{$CellContext`tValue$$, 0, ""}, 0, 
          Rational[3, 2], 0.01, ControlType -> Trigger, 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}, 
          DefaultDuration -> 20, ControlPlacement -> 3}, 
         Row[{
           Manipulate`Place[3]}], 
         Delimiter, {{$CellContext`showVectors$$, {}, ""}, {1 -> Panel[
             Pane[
             "show \!\(\*FormBox[\n StyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\) on \!\(TraditionalForm\`C\)", {
              110, Automatic}, 
...
FontSlant->Plain]\) on unit tangent vectors of \!\(TraditionalForm\`C\)", {
              ...
              BaseStyle -> {
               LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
                LineBreakWithin -> Automatic, Hyphenation -> True, 
                TextAlignment -> Left}]]}, ControlType -> CheckboxBar, 
          Appearance -> "Vertical", ControlPlacement -> 4}, 
         Row[{
           Manipulate`Place[4]}], 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          1, $CellContext`funcC14F23r[
            Pattern[$CellContext`t, 
             Blank[]]] := {(2 ($CellContext`t + 0.2)) 
            Cos[3 (Pi/4)], (2 ($CellContext`t + 0.2)) Sin[3 (Pi/4)], 
            Sin[Pi $CellContext`t] + 1}, $CellContext`t[
            Pattern[$CellContext`df, 
             Blank[]]] := PDF[
            
            StudentTDistribution[$CellContext`df], $CellContext`x], \
$CellContext`bcR = RGBColor[0.8, 0, 0.4], $CellContext`funcC14F23f[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]], 
            Pattern[$CellContext`z, 
             Blank[]]] := 1 {
             Sin[$CellContext`x ($CellContext`y/2)], 1 Cos[$CellContext`y/3], 
             
             Sin[
              Cos[
              1.5 $CellContext`z + $CellContext`x + $CellContext`y]]}, \
$CellContext`bcG = RGBColor[0, 0.6, 0.4], 
          ...
          BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left, FontSize -> 13}}; {Null, Null}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.2, Figure 14.23"], "Header"]}, {
   Cell[
    TextData["Section 14.2, Figure 14.23"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 34342, 703, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature QKzRVUorZBEh#K5K42lLplCd *)
