...
NotebookDataLength[     79224,       1625]
NotebookOptionsPosition[     46562,        867]
NotebookOutlinePosition[     80000,       1637]
CellTagsIndexPosition[     79957,       1634]
WindowTitle->Section 14.6, Figure 14.48
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0.5, $CellContext`bValue$$ = 
     4, $CellContext`cValue$$ = 0.5, $CellContext`dValue$$ = 
     3.7, $CellContext`kValue$$ = 1, $CellContext`showGrids$$ = 
     False, $CellContext`showLabels$$ = True, $CellContext`showNormal$$ = 
     True, $CellContext`showParallelogram$$ = 
     True, $CellContext`showSurface$$ = True, $CellContext`showTangents$$ = 
     True, $CellContext`uDivisions$$ = 4, $CellContext`uMax$$ = 
     3.25, $CellContext`uMin$$ = 0.5, $CellContext`uValue$$ = 
     1, $CellContext`vDivisions$$ = 4, $CellContext`vMax$$ = 
     3.25, $CellContext`vMin$$ = 0.5, $CellContext`vValue$$ = 
     1, $CellContext`xMax$$ = 
     6, $CellContext`xMin$$ = -3, $CellContext`yMax$$ = 
     6, $CellContext`yMin$$ = -3, $CellContext`zMax$$ = 
     6, $CellContext`zMin$$ = -1, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showTangents$$], True, "show tangent vectors"}, {
       True, False}}, {{
        Hold[$CellContext`showParallelogram$$], True, "show parallelogram"}, {
       True, False}}, {{
        Hold[$CellContext`showNormal$$], True, "show normal vector"}, {
       True, False}}, {
       Hold[
        Grid[{{
           Manipulate`Place[1]}, {
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`uDivisions$$], 4, ""}, 1, 10, 1}, {
       Hold["\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\) divisions"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`vDivisions$$], 4, ""}, 1, 10, 1}, {
       Hold[""], Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`kValue$$], 1, 
        "\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)"}, 1, 
       Dynamic[$CellContext`uDivisions$$ $CellContext`vDivisions$$], 1}, {{
        Hold[$CellContext`kValue$$], 1, ""}, 1, 
       Dynamic[$CellContext`uDivisions$$ $CellContext`vDivisions$$], 1}, {{
        Hold[$CellContext`aValue$$], 0.5, 
        "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0, 4}, {{
        Hold[$CellContext`bValue$$], 4, 
        "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0, 4}, {{
        Hold[$CellContext`cValue$$], 0.5, 
        "\!\(\*\nStyleBox[\"c\",\nFontSlant->\"Italic\"]\)"}, 0, 4}, {{
        Hold[$CellContext`dValue$$], 3.7, 
        "\!\(\*\nStyleBox[\"d\",\nFontSlant->\"Italic\"]\)"}, 0, 4}, {{
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`uMin$$], 0.5}, 0}, {{
        Hold[$CellContext`uMax$$], 3.25}, 0}, {{
        Hold[$CellContext`vMin$$], 0.5}, 0}, {{
        Hold[$CellContext`vMax$$], 3.25}, 0}, {{
        Hold[$CellContext`uValue$$], 1}, 0}, {{
        Hold[$CellContext`vValue$$], 1}, 0}}, Typeset`size$$ = {
     432., {213., 219.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showTangents$32981$$ = 
     False, $CellContext`showParallelogram$32982$$ = 
     False, $CellContext`showNormal$32983$$ = 
     False, $CellContext`uDivisions$32984$$ = 
     0, $CellContext`vDivisions$32985$$ = 0, $CellContext`kValue$32986$$ = 
     0, $CellContext`aValue$32987$$ = 0, $CellContext`bValue$32988$$ = 
     0, $CellContext`cValue$32989$$ = 0, $CellContext`dValue$32990$$ = 
     0, $CellContext`showSurface$32991$$ = 
     False, $CellContext`showLabels$32992$$ = 
     False, $CellContext`showGrids$32993$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0.5, $CellContext`bValue$$ = 
         ...
         6, $CellContext`xMin$$ = -3, $CellContext`yMax$$ = 
         6, $CellContext`yMin$$ = -3, $CellContext`zMax$$ = 
         6, $CellContext`zMin$$ = -1}, "ControllerVariables" :> {
         Hold[$CellContext`showTangents$$, $CellContext`showTangents$32981$$, 
          False], 
         Hold[$CellContext`showParallelogram$$, \
$CellContext`showParallelogram$32982$$, False], 
         Hold[$CellContext`showNormal$$, $CellContext`showNormal$32983$$, 
          False], 
         Hold[$CellContext`uDivisions$$, $CellContext`uDivisions$32984$$, 0], 
         
         Hold[$CellContext`vDivisions$$, $CellContext`vDivisions$32985$$, 0], 
         
         Hold[$CellContext`kValue$$, $CellContext`kValue$32986$$, 0], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$32987$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$32988$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$32989$$, 0], 
         Hold[$CellContext`dValue$$, $CellContext`dValue$32990$$, 0], 
         Hold[$CellContext`showSurface$$, $CellContext`showSurface$32991$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$32992$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$32993$$, 
          False]}, 
       "OtherVariables" :> {
       ...
       "Body" :> (
        If[$CellContext`kValue$$ > $CellContext`uDivisions$$ \
$CellContext`vDivisions$$, $CellContext`kValue$$ = $CellContext`uDivisions$$ \
$CellContext`vDivisions$$]; 
        If[$CellContext`aValue$$ >= $CellContext`bValue$$, \
$CellContext`aValue$$ = $CellContext`bValue$$ - 0.1]; 
        If[$CellContext`cValue$$ >= $CellContext`dValue$$, \
$CellContext`cValue$$ = $CellContext`dValue$$ - 0.1]; Dynamic[
          Show[{
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
            ...
            If[$CellContext`showSurface$$, 
             ParametricPlot3D[
              $CellContext`funcC14F48[$CellContext`u, $CellContext`v], \
{$CellContext`u, $CellContext`aValue$$, $CellContext`bValue$$}, \
{$CellContext`v, $CellContext`cValue$$, $CellContext`dValue$$}, Mesh -> {
                
                Table[$CellContext`aValue$$ + $CellContext`i \
(($CellContext`bValue$$ - $CellContext`aValue$$)/$CellContext`uDivisions$$), \
{$CellContext`i, 0, $CellContext`uDivisions$$}], 
                
                Table[$CellContext`cValue$$ + $CellContext`j \
(($CellContext`dValue$$ - $CellContext`cValue$$)/$CellContext`vDivisions$$), \
{$CellContext`j, 0, $CellContext`vDivisions$$}]}, PlotStyle -> {{
                 Opacity[1], $CellContext`bcSurfaceTop, 
                 Specularity[White, 100]}}, MaxRecursion -> 2], 
             Graphics3D[{}]], 
            
            ParametricPlot3D[$CellContext`funcC14F48[$CellContext`u, \
$CellContext`v] + {0, 0, 0.01}, {$CellContext`u, $CellContext`aValue$$ + 
              Mod[$CellContext`kValue$$ - 
                 1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`aValue$$ + (
                Mod[$CellContext`kValue$$ - 1, $CellContext`uDivisions$$] + 
                1) (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$)}, {$CellContext`v, \
$CellContext`cValue$$ + 
              Quotient[$CellContext`kValue$$ - 
                 1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$), $CellContext`cValue$$ + (
                Quotient[$CellContext`kValue$$ - 
                  1, $CellContext`uDivisions$$] + 
                1) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)}, Mesh -> None, 
             PlotStyle -> {{
            ...
            Graphics3D[{Black, 
              ...
              Point[$CellContext`funcC14F48[$CellContext`aValue$$ + 
                 Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                 Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + {0, 0, 0.01}], Orange, 
              Arrow[
               Tube[{{0, 0, 0}, 
                 $CellContext`funcC14F48[$CellContext`aValue$$ + 
                  Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                  Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)]}]], 
              If[$CellContext`showTangents$$, {$CellContext`bcG, 
                Arrow[
                 
                 Tube[{$CellContext`funcC14F48[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
...
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + {
                    0, 0, 0.01} + \
$CellContext`funcC14F48U[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$)}]], 
                Arrow[
...
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + {
                    0, 0, 0.01} + \
$CellContext`funcC14F48V[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)}]]}, Black], 
              If[$CellContext`showParallelogram$$, {$CellContext`bcG, 
                Opacity[1], 
                
                Polygon[{$CellContext`funcC14F48[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + {
                   0, 0, 0.01}, $CellContext`funcC14F48[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
...
$CellContext`cValue$$)/$CellContext`vDivisions$$)}], 
                Opacity[1]}, Black], 
              If[$CellContext`showNormal$$, {Brown, 
                Arrow[
...
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + {0, 0, 0.01} + 
                   0.5 Cross[
                    $CellContext`funcC14F48U[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
...
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)]]}]]}, Black], Black, 
              If[$CellContext`showLabels$$, {
                Text[
                "\!\(TraditionalForm\`P(\*SubscriptBox[\(x\), \(k\)], \
\*SubscriptBox[\(y\), \(k\)], \*SubscriptBox[\(z\), \(k\)])\)", 
                 $CellContext`funcC14F48[$CellContext`aValue$$ + 
                  Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                  Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)], {1.2, -1.5}], 
...
FontWeight->\"Plain\"]}],\nFontSlant->Plain],\n    TraditionalForm], \n   \
RowBox[{SubscriptBox[\n     StyleBox[\"t\",\nFontWeight->Bold,\n\
FontSlant->Plain], \"u\"], \" \", \"\[Cross]\", \" \", SubscriptBox[\n     \
StyleBox[\"t\",\nFontWeight->Bold,\nFontSlant->Plain], \"v\"]}]}],\n  \
TraditionalForm],\n TraditionalForm]\)", \
$CellContext`funcC14F48[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
...
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + 0.3 Cross[
                    $CellContext`funcC14F48U[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
...
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)]], {1.2, -1.5}], Black], 
                If[$CellContext`showTangents$$, {
                  Text[
                  "\!\(\*FormBox[FormBox[\n  RowBox[{SubscriptBox[\n    \
StyleBox[\"t\",\nFontWeight->Bold,\nFontSlant->Plain], \"u\"], \"\
\[CapitalDelta]\", \"\[VeryThinSpace]\", \"u\", \" \"}],\n  TraditionalForm],\
\n TraditionalForm]\)", {
                    0.5, 0, 
                    0} + $CellContext`funcC14F48[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + (
                    1.3 $CellContext`funcC14F48U[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)]) (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), {0, -1}], 
                  Text[
                  "\!\(\*FormBox[FormBox[\n  RowBox[{SubscriptBox[\n    \
StyleBox[\"t\",\nFontWeight->Bold,\nFontSlant->Plain], \"v\"], \"\
\[CapitalDelta]\", \"\[VeryThinSpace]\", \"v\", \" \"}],\n  TraditionalForm],\
\n TraditionalForm]\)", $CellContext`funcC14F48[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + (
                    1.3 $CellContext`funcC14F48V[$CellContext`aValue$$ + 
                    Mod[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + 
                    Quotient[$CellContext`kValue$$ - 
                    1, $CellContext`uDivisions$$] (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)]) (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$), {0, -1}]}, Black], 
                Text["\!\(TraditionalForm\`S\)", 
                 $CellContext`funcC14F48[$CellContext`bValue$$, \
$CellContext`dValue$$], {-1, -1}]}, Black]}]}, 
           PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$, \
$CellContext`zMax$$ + 0.2}}, ImageSize -> 6 {72, 72}, ImagePadding -> None, 
           BaseStyle -> {"Text", 13}, Lighting -> "Neutral", Boxed -> False, 
           ViewPoint -> {4, 1.5, 3}, Epilog -> {
             If[$CellContext`showLabels$$, {
               Inset[
                Pane[
                "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   StyleBox[\"r\",\n\
...
$CellContext`bcPBS], 
                ...
                ImageScaled[{0., 1}]], 
               If[$CellContext`showParallelogram$$, {
                 Inset[
                  Framed[
                   Pane[
                   "Parallelogram in tangent plane has area \!\(\*FormBox[\n \
RowBox[{\"\[LeftBracketingBar]\", \n  RowBox[{SubscriptBox[\n    StyleBox[\"t\
\",\nFontWeight->Bold,\nFontSlant->Plain], \"u\"], \"\[CapitalDelta]\", \"\
\[VeryThinSpace]\", \n   RowBox[{\"u\", \" \", \"\[Cross]\", \" \", \
SubscriptBox[\n     StyleBox[\"t\",\nFontWeight->Bold,\nFontSlant->Plain], \
\"v\"]}], \"\[CapitalDelta]\", \"\[VeryThinSpace]\", \"v\"}], \"\
                 ...
                 Inset[
                  Framed[
                   Pane[
                    ...
                    "\!\(\*FormBox[\n RowBox[{\"\[LeftBracketingBar]\", \n  \
RowBox[{SubscriptBox[\n    StyleBox[\"t\",\nFontWeight->Bold,\n\
FontSlant->Plain], \"u\"], \"\[CapitalDelta]\", \"\[VeryThinSpace]\", \n   \
RowBox[{\"u\", \" \", \"\[Cross]\", \" \", SubscriptBox[\n     \
StyleBox[\"t\",\nFontWeight->Bold,\nFontSlant->Plain], \"v\"]}], \"\
\[CapitalDelta]\", \"\[VeryThinSpace]\", \"v\"}], \
\"\[RightBracketingBar]\"}],\n TraditionalForm]\)", Black], 
                    "\!\(TraditionalForm\`\(\(\\ \)\(\(\
...
\[RightBracketingBar]\"}],\n  TraditionalForm],\n TraditionalForm]\)", Black], 
                    Style[
                    "\!\(TraditionalForm\`\(TraditionalForm\`\[CapitalDelta]\
\[VeryThinSpace]u\\ \[CapitalDelta]\[VeryThinSpace]v\)\)", Black], 
                    "\!\(TraditionalForm\`\(\(\\ \)\(\(\[TildeTilde]\)\(\\ \)\
\)\)\)", 
                    Style[
                    "\!\(TraditionalForm\`\[CapitalDelta]\[VeryThinSpace]\*\
SubscriptBox[\(S\), \(k\)]\)", 
                    Black]}], $CellContext`bcPBS], $CellContext`bcFO, 
                   Background -> White], 
                  ImageScaled[{1, 0.95}], 
                  ImageScaled[{1, 1}]]}, Black]}, Black]}]]), 
       "Specifications" :> {{{$CellContext`showTangents$$, True, 
           "show tangent vectors"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 
          1}, {{$CellContext`showParallelogram$$, True, 
           "show parallelogram"}, {True, False}, ControlType -> Checkbox, 
          ControlPlacement -> 
          2}, {{$CellContext`showNormal$$, True, "show normal vector"}, {
          True, False}, ControlType -> Checkbox, ControlPlacement -> 3}, 
         Grid[{{
            Manipulate`Place[1]}, {
            Manipulate`Place[2]}, {
            Manipulate`Place[3]}}, Alignment -> Right], Delimiter, 
         "\!\(\*\nStyleBox[\"u\",\nFontSlant->\"Italic\"]\) divisions", \
{{$CellContext`uDivisions$$, 4, ""}, 1, 10, 1, ControlType -> Slider, 
          ImageSize -> Small}, 
         "\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\) divisions", \
{{$CellContext`vDivisions$$, 4, ""}, 1, 10, 1, ControlType -> Slider, 
          ImageSize -> Small}, 
         "", {{$CellContext`kValue$$, 1, 
           "\!\(\*\nStyleBox[\"k\",\nFontSlant->\"Italic\"]\)"}, 1, 
          Dynamic[$CellContext`uDivisions$$ $CellContext`vDivisions$$], 1, 
          ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`kValue$$, 1, ""}, 1, 
          Dynamic[$CellContext`uDivisions$$ $CellContext`vDivisions$$], 1, 
          ControlType -> Trigger, DefaultDuration :> 
          Dynamic[Dynamic[$CellContext`uDivisions$$ \
$CellContext`vDivisions$$]/2], 
          AppearanceElements -> {
           "PlayPauseButton", "StepLeftButton", "StepRightButton"}}, 
         Delimiter, {{$CellContext`aValue$$, 0.5, 
           "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0, 4, 
          ControlType -> None, ImageSize -> 
          Small}, {{$CellContext`bValue$$, 4, 
           "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)"}, 0, 4, 
          ControlType -> None, ImageSize -> 
          Small}, {{$CellContext`cValue$$, 0.5, 
           "\!\(\*\nStyleBox[\"c\",\nFontSlant->\"Italic\"]\)"}, 0, 4, 
          ControlType -> None, ImageSize -> 
          Small}, {{$CellContext`dValue$$, 3.7, 
           "\!\(\*\nStyleBox[\"d\",\nFontSlant->\"Italic\"]\)"}, 0, 4, 
         ...
         Delimiter, {{$CellContext`showSurface$$, True, "show surface"}, {
          ...
          4}, {{$CellContext`showLabels$$, True, "show labels"}, {
          True, False}, ControlType -> Checkbox, ControlPlacement -> 
          5}, {{$CellContext`showGrids$$, False, "show grids"}, {True, False},
           ControlType -> Checkbox, ControlPlacement -> 6}, 
         Grid[{{
            Manipulate`Place[4]}, {
            Manipulate`Place[5]}, {
            Manipulate`Place[6]}}, Alignment -> 
          ...
          None}, {{$CellContext`uMin$$, 0.5}, 0, ControlType -> 
          None}, {{$CellContext`uMax$$, 3.25}, 0, ControlType -> 
          None}, {{$CellContext`vMin$$, 0.5}, 0, ControlType -> 
          None}, {{$CellContext`vMax$$, 3.25}, 0, ControlType -> 
          None}, {{$CellContext`uValue$$, 1}, 0, ControlType -> 
          None}, {{$CellContext`vValue$$, 1}, 0, ControlType -> None}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
      ImageSizeCache->{598., {231., 236.}},
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F48[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]]] := {
           0.3 ($CellContext`v - 1.5)^2 + 1.5 ($CellContext`u - 1.5), 
            0.2 ($CellContext`u - 1.5)^2 + 2 ($CellContext`v - 1.5), 3 - 
            0.3 (($CellContext`u - 1.5) + 0.5)^2 - 
            0.2 ($CellContext`v - 1.5)^2}, $CellContext`u[
...
$CellContext`v[
            Pattern[$CellContext`t, 
             Blank[]]] := 3 - $CellContext`t/2, $CellContext`bcSurfaceTop = 
          RGBColor[0.85, 0.6, 0.2], $CellContext`bcB = 
          RGBColor[0, 0.4, 0.8], $CellContext`bcG = 
          RGBColor[0, 0.6, 0.4], $CellContext`funcC14F48U[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]]] := {
           1.5, 0.4 (-1.5 + $CellContext`u), (-0.6) (-1. + $CellContext`u)}, \
$CellContext`funcC14F48V[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]]] := {
           0.6 (-1.5 + $CellContext`v), 
            2, (-0.4) (-1.5 + $CellContext`v)}, $CellContext`bcPBS = 
          BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left, FontSize -> 13}, $CellContext`bcFO = {
           RoundingRadius -> 5, FrameStyle -> GrayLevel[0.85]}}; {
         Null, Null, Null}}; Typeset`initDone$$ = True),
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.48"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.48"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 45283, 834, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature PJ4B6CjUZaT7lK5nV2XhbwZX *)
