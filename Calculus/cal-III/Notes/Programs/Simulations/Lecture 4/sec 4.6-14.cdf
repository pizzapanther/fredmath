...
NotebookDataLength[     69624,       1493]
NotebookOptionsPosition[     36962,        735]
NotebookOutlinePosition[     70400,       1505]
CellTagsIndexPosition[     70357,       1502]
WindowTitle->Section 14.6, Figure 14.57
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 0.2, $CellContext`bValue$$ = 
     3.8, $CellContext`cValue$$ = 0.2, $CellContext`dValue$$ = 
     3.8, $CellContext`showField$$ = False, $CellContext`showGrids$$ = 
     False, $CellContext`showLabels$$ = True, $CellContext`uDivisions$$ = 
     8, $CellContext`uMax$$ = 3.25, $CellContext`uMin$$ = 
     0.5, $CellContext`uValue$$ = 2.5, $CellContext`vDivisions$$ = 
     8, $CellContext`vMax$$ = 3.25, $CellContext`vMin$$ = 
     0.5, $CellContext`vValue$$ = 1, $CellContext`xMax$$ = 
     ...
     "\"untitled\"", Typeset`specs$$ = {{
       Hold[
        Pane[
        "Drag \[CirclePlus] to change the location of the point \
\!\(TraditionalForm\`\((u, v)\)\), \!\(\*FormBox[\n StyleBox[\"n\",\n\
FontWeight->Bold,\nFontSlant->Plain],\n TraditionalForm]\), and \
\!\(\*FormBox[\n StyleBox[\"F\",\nFontWeight->Bold,\nFontSlant->Plain],\n \
TraditionalForm]\).", {144, Automatic}, 
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`uValue$$], 2.5}, 0}, {{
        Hold[$CellContext`vValue$$], 1}, 0}, {{
        Hold[$CellContext`aValue$$], 0.2, "a"}, 0, 4}, {{
        Hold[$CellContext`bValue$$], 3.8, "b"}, 0, 4}, {{
        Hold[$CellContext`cValue$$], 0.2, "c"}, 0, 4}, {{
        Hold[$CellContext`dValue$$], 3.8, "d"}, 0, 4}, {{
        Hold[$CellContext`uDivisions$$], 8}, 0}, {{
        Hold[$CellContext`vDivisions$$], 8}, 0}}, Typeset`size$$ = {
     512., {188.34375, 193.65625}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showField$33741$$ = 
     False, $CellContext`showLabels$33742$$ = 
     False, $CellContext`showGrids$33743$$ = 
     False, $CellContext`aValue$33744$$ = 0, $CellContext`bValue$33745$$ = 
     0, $CellContext`cValue$33746$$ = 0, $CellContext`dValue$33747$$ = 0}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 0.2, $CellContext`bValue$$ = 
         3.8, $CellContext`cValue$$ = 0.2, $CellContext`dValue$$ = 
         3.8, $CellContext`showField$$ = False, $CellContext`showGrids$$ = 
         False, $CellContext`showLabels$$ = True, $CellContext`uDivisions$$ = 
         8, $CellContext`uMax$$ = 3.25, $CellContext`uMin$$ = 
         ...
         Hold[$CellContext`showField$$, $CellContext`showField$33741$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$33742$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$33743$$, 
          False], 
         Hold[$CellContext`aValue$$, $CellContext`aValue$33744$$, 0], 
         Hold[$CellContext`bValue$$, $CellContext`bValue$33745$$, 0], 
         Hold[$CellContext`cValue$$, $CellContext`cValue$33746$$, 0], 
         Hold[$CellContext`dValue$$, $CellContext`dValue$33747$$, 0]}, 
       "OtherVariables" :> {
...
$CellContext`cValue$$ = $CellContext`dValue$$ - 0.1]; Grid[{{
            Column[{
              Deploy[
               Show[{
                 Graphics[{
                   ...
                   Rectangle[{$CellContext`aValue$$, $CellContext`cValue$$}, \
{$CellContext`bValue$$, $CellContext`dValue$$}], 
                   Dynamic[
                    
                    If[$CellContext`cValue$$ <= $CellContext`vValue$$ <= \
$CellContext`dValue$$, {$CellContext`bcB, 
                    
                    Line[{{$CellContext`aValue$$, $CellContext`vValue$$}, \
{$CellContext`bValue$$, $CellContext`vValue$$}}]}, Black]], 
                   Dynamic[
                    
                    If[$CellContext`aValue$$ <= $CellContext`uValue$$ <= \
$CellContext`bValue$$, {$CellContext`bcG, 
                    
                    Line[{{$CellContext`uValue$$, $CellContext`cValue$$}, \
{$CellContext`uValue$$, $CellContext`dValue$$}}]}, Black]], Orange, 
                   Locator[
                    Dynamic[{$CellContext`uValue$$, $CellContext`vValue$$}]], 
                   
                   If[$CellContext`showLabels$$, {}, Black]}, 
                  BaseStyle -> {"Text", 13}, AspectRatio -> 1, 
...
{$CellContext`dValue$$, 
                    "\!\(\*\nStyleBox[\"d\",\nFontSlant->\"Italic\"]\)"}}}, 
                  AxesStyle -> Arrowheads[0.06], 
                  AxesLabel -> {
                   "\!\(\*\nStyleBox[\"u\",\nFontSlant->\"Italic\"]\)", 
                    "\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\)"}, 
                  Axes -> True, ImageSize -> 2.5 72, 
                  PlotRange -> {{0, 4}, {0, 4}}]}]], 
              Framed[
               Graphics[{Black, 
                 Text[
                  Which[Dot[
                    $CellContext`funcC14F57N[$CellContext`uValue$$, \
$CellContext`vValue$$], 
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]] < -0.015, 
                   "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   StyleBox[\"F\",\
...
$CellContext`vValue$$], 
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]], 0}, {0, -1}], $CellContext`bcR, 
...
\"\[RightBracketingBar]\"}],\n TraditionalForm]\)", {
                   Norm[
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]], 0}, {0, 3}]}, Axes -> {True, False}, AxesStyle -> 
                Arrowheads[{-0.08, 0.08}], Ticks -> {{0}, None}, 
                PlotRange -> {{-8, 8}, {-1, 1}}, AspectRatio -> 0.5, 
                BaseStyle -> {"Text", 14}, ImageSize -> 2 72, AspectRatio -> 
                0.5], $CellContext`bcFO, Background -> White], 
              Framed[
               Graphics[{Black, 
                 Text["\!\(TraditionalForm\`\[Theta]\)", {
                   ArcCos[Dot[
                    $CellContext`funcC14F57N[$CellContext`uValue$$, \
$CellContext`vValue$$], 
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]]/(Sqrt[
                    Dot[
                    $CellContext`funcC14F57N[$CellContext`uValue$$, \
$CellContext`vValue$$], 
                    $CellContext`funcC14F57N[$CellContext`uValue$$, \
...
$CellContext`vValue$$]]])], 0}, {0, -1}]}, Axes -> {True, False}, AxesStyle -> 
                Arrowheads[{-0.08, 0.08}], Ticks -> {{0, Pi/2, Pi}, None}, 
                PlotRange -> {{-1, 4}, {-1, 1}}, AspectRatio -> 0.5, 
                BaseStyle -> {"Text", 14}, ImageSize -> 
                2 72], $CellContext`bcFO, Background -> White], 
              "\[Theta] is the angle between \!\(\*\nStyleBox[\"n\",\n\
FontWeight->Bold,\nFontSlant->Plain]\) and \!\(\*\nStyleBox[\"F\",\n\
FontWeight->Bold,\nFontSlant->Plain]\)\!\(\*\nStyleBox[\".\",\n\
FontSlant->Plain]\)"}, Alignment -> Center, BaseStyle -> "TR"], 
            Dynamic[
             Show[{
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
               ...
               ParametricPlot3D[
                $CellContext`funcC14F57[$CellContext`u, $CellContext`v], \
{$CellContext`u, $CellContext`aValue$$, $CellContext`bValue$$}, \
{$CellContext`v, $CellContext`cValue$$, $CellContext`dValue$$}, 
                Mesh -> {{$CellContext`uValue$$}, {$CellContext`vValue$$}}, 
                MeshStyle -> {{
                   AbsoluteThickness[1], $CellContext`bcG}, {
                   AbsoluteThickness[1], $CellContext`bcB}}, PlotStyle -> {{
               ...
               Graphics3D[{
                 ...
                 Arrow[
                  Tube[{{0, 0, 0}, 
                    $CellContext`funcC14F57[$CellContext`uValue$$, \
$CellContext`vValue$$]}]], 
                 If[
                  
                  And[$CellContext`aValue$$ <= $CellContext`uValue$$ <= \
$CellContext`bValue$$, $CellContext`cValue$$ <= $CellContext`vValue$$ <= \
$CellContext`dValue$$], {Brown, 
                   Arrow[
                    Tube[{
                    $CellContext`funcC14F57[$CellContext`uValue$$, \
$CellContext`vValue$$], $CellContext`funcC14F57[$CellContext`uValue$$, \
$CellContext`vValue$$] + $CellContext`funcC14F57N[$CellContext`uValue$$, \
$CellContext`vValue$$]}]], $CellContext`bcR, 
                   Arrow[
                    Tube[{
                    $CellContext`funcC14F57[$CellContext`uValue$$, \
$CellContext`vValue$$], $CellContext`funcC14F57[$CellContext`uValue$$, \
$CellContext`vValue$$] + $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]}]], 
                   If[$CellContext`showLabels$$, {Black, 
                    Text["\!\(TraditionalForm\`S\)", 
                    $CellContext`funcC14F57[$CellContext`bValue$$, \
$CellContext`dValue$$], {-1.5, -2}], 
                    Text["\!\(TraditionalForm\`P\)", 
                    $CellContext`funcC14F57[$CellContext`uValue$$, \
$CellContext`vValue$$], {-1.5, -1}], 
                    Text[
                    "\!\(\*FormBox[\n StyleBox[\"n\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", \
$CellContext`funcC14F57[$CellContext`uValue$$, $CellContext`vValue$$] + 
                    1.2 $CellContext`funcC14F57N[$CellContext`uValue$$, \
$CellContext`vValue$$]], 
                    Text[
                    "\!\(\*FormBox[\n StyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", \
$CellContext`funcC14F57[$CellContext`uValue$$, $CellContext`vValue$$] + \
$CellContext`funcC14F57F[$CellContext`uValue$$, $CellContext`vValue$$] + 
                    0.2 Normalize[
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
               ...
               If[$CellContext`showField$$, 
                Graphics3D[{$CellContext`bcR, 
                  ...
                  Table[
                   Arrow[
                    Tube[{
                    $CellContext`funcC14F57[$CellContext`aValue$$ + \
$CellContext`i (($CellContext`bValue$$ - \
$CellContext`aValue$$)/$CellContext`uDivisions$$), $CellContext`cValue$$ + \
$CellContext`j (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)], \
$CellContext`funcC14F57[$CellContext`aValue$$ + $CellContext`i \
(($CellContext`bValue$$ - $CellContext`aValue$$)/$CellContext`uDivisions$$), \
$CellContext`cValue$$ + $CellContext`j (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)] + \
$CellContext`funcC14F57F[$CellContext`aValue$$ + $CellContext`i \
(($CellContext`bValue$$ - $CellContext`aValue$$)/$CellContext`uDivisions$$), \
$CellContext`cValue$$ + $CellContext`j (($CellContext`dValue$$ - \
$CellContext`cValue$$)/$CellContext`vDivisions$$)]}]], {$CellContext`i, 
                    0, $CellContext`uDivisions$$}, {$CellContext`j, 
                    0, $CellContext`vDivisions$$}]}], 
                Graphics3D[{}]]}, 
              PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}, {$CellContext`zMin$$ - 
                 1, $CellContext`zMax$$ + 0.2}}, ImageSize -> 4.5 {72, 72}, 
              ImagePadding -> None, BaseStyle -> {"Text", 13}, Lighting -> 
              "Neutral", Boxed -> False, ViewPoint -> {4, 1.5, 1}, 
              Epilog -> {
...
$CellContext`vValue$$], 
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]] < -0.015, 
                    "Flow is through \!\(TraditionalForm\`S\) at \
\!\(TraditionalForm\`P\) in the direction of \!\(\*FormBox[\n RowBox[{\n  \
StyleBox[\"-\",\nFontWeight->\"Plain\",\nFontSlant->Plain], \n  \
StyleBox[\"n\",\nFontWeight->Bold,\nFontSlant->\"Plain\"]}],\n \
TraditionalForm]\).", Abs[
                    Dot[
...
$CellContext`vValue$$], 
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]]] < 0.015, 
                    "No flow through \!\(TraditionalForm\`S\) at \
\!\(TraditionalForm\`P\).", Dot[
                    $CellContext`funcC14F57N[$CellContext`uValue$$, \
$CellContext`vValue$$], 
                    $CellContext`funcC14F57F[$CellContext`uValue$$, \
$CellContext`vValue$$]] > 0.015, 
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], 
                   ...
                   ImageScaled[{0.5, 0}]]}, Black]}]]}}]), "Specifications" :> {
         Pane[
         "Drag \[CirclePlus] to change the location of the point \
\!\(TraditionalForm\`\((u, v)\)\), \!\(\*FormBox[\n StyleBox[\"n\",\n\
FontWeight->Bold,\nFontSlant->Plain],\n TraditionalForm]\), and \
...
TraditionalForm]\).", {144, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left}], Delimiter, {{$CellContext`showField$$, False, 
           "show field on \!\(\*\nStyleBox[\"S\",\n\
FontSlant->\"Italic\"]\)"}, {True, False}, ControlType -> Checkbox}, 
         ...
         Grid[{{
          ...
          None}, {{$CellContext`uValue$$, 2.5}, 0, ControlType -> 
          None}, {{$CellContext`vValue$$, 1}, 0, ControlType -> 
          None}, {{$CellContext`aValue$$, 0.2, "a"}, 0, 4, ControlType -> 
          None, ImageSize -> Small}, {{$CellContext`bValue$$, 3.8, "b"}, 0, 4,
           ControlType -> None, ImageSize -> 
          Small}, {{$CellContext`cValue$$, 0.2, "c"}, 0, 4, ControlType -> 
          None, ImageSize -> Small}, {{$CellContext`dValue$$, 3.8, "d"}, 0, 4,
           ControlType -> None, ImageSize -> 
          Small}, {{$CellContext`uDivisions$$, 8}, 0, ControlType -> 
          None}, {{$CellContext`vDivisions$$, 8}, 0, ControlType -> None}}, 
       "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
      ImageSizeCache->{683., {206., 212.}},
     ...
     Initialization:>({{$CellContext`bcAreaPositiveColor = 
          ...
          RGBColor[0, 0.6, 0.4], $CellContext`funcC14F57N[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             
             Blank[]]] := {(-1.56 + $CellContext`u (1.44 - 
               0.163 $CellContext`v) + 0.245 $CellContext`v)/Sqrt[
            Abs[2.46 + $CellContext`u (0.36 - 0.24 $CellContext`v) + 
                0.36 $CellContext`v]^2 + 
             Abs[1.56 - 1.44 $CellContext`u - 
                0.24 $CellContext`v + (0.16 $CellContext`u) $CellContext`v]^2 + 
             Abs[1.44 - 0.54 $CellContext`u - 
                0.96 $CellContext`v + (
                  0.36 $CellContext`u) $CellContext`v]^2], (-1.44 + \
$CellContext`u (0.54 - 0.36 $CellContext`v) + 0.96 $CellContext`v)/Sqrt[
            Abs[2.46 + $CellContext`u (0.36 - 0.24 $CellContext`v) + 
                0.36 $CellContext`v]^2 + 
             Abs[1.56 - 1.44 $CellContext`u - 
                0.245 $CellContext`v + (
                  0.16 $CellContext`u) $CellContext`v]^2 + 
             Abs[1.44 - 0.54 $CellContext`u - 
                0.96 $CellContext`v + (
                  0.36 $CellContext`u) $CellContext`v]^2], (
             2.46 + $CellContext`u (0.36 - 0.24 $CellContext`v) + 
             0.36 $CellContext`v)/Sqrt[
            Abs[2.46 + $CellContext`u (0.36 - 0.24 $CellContext`v) + 
                0.36 $CellContext`v]^2 + 
             Abs[1.56 - 1.44 $CellContext`u - 
                0.24 $CellContext`v + (0.16 $CellContext`u) $CellContext`v]^2 + 
             Abs[1.44 - 0.54 $CellContext`u - 
                0.96 $CellContext`v + (
                  0.36 $CellContext`u) $CellContext`v]^2]}, $CellContext`u[
...
$CellContext`v[
            Pattern[$CellContext`t, 
             Blank[]]] := 3 - $CellContext`t/2, $CellContext`funcC14F57F[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]]] := 
          2 {0.15 (2 $CellContext`u - $CellContext`v), (-0.2) (
              0.5 $CellContext`u - $CellContext`v), (
              0.4 ($CellContext`v - 3)) (
              2 - $CellContext`u)}, $CellContext`bcR = 
          RGBColor[0.8, 0, 0.4], $CellContext`bcFO = {
           RoundingRadius -> 5, FrameStyle -> 
            GrayLevel[0.85]}, $CellContext`CoordinatePlane[
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F57[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]]] := {
           0.3 ($CellContext`v - 1.5)^2 + 1.5 ($CellContext`u - 1.5), 
            ...
            0.2 ($CellContext`v - 1.5)^2}, $CellContext`bcSurfaceTop = 
          RGBColor[0.85, 0.6, 0.2], $CellContext`bcPBS = 
          BaseStyle -> {
            LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
             LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
             Left, FontSize -> 13}}; {Null, Null, Null}}; 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.57"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.57"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 35683, 702, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature kLjA4DnuumJWXKO8@J1FutRp *)
