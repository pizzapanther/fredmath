...
NotebookDataLength[     61955,       1354]
NotebookOptionsPosition[     29293,        596]
NotebookOutlinePosition[     62731,       1366]
CellTagsIndexPosition[     62688,       1363]
WindowTitle->Section 14.5, Figure 14.41
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`magnitudeA$$ = 3^
     Rational[1, 2], $CellContext`pointP$$ = {0, 0, 
...
FontWeight->Bold,\nFontSlant->Plain]],\n TraditionalForm]\)", Larger]}, 0, 2 
       ...
       1 -> Pane["show vector field", {108, Automatic}, Alignment -> Center], 
        2 -> Pane[
...
LineBox[{{0, 0}, {0.3, 0}}]}},\nImageSize->24]\)", {108, Automatic}, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`magnitudeA$32132$$ = 
     0, $CellContext`\[Phi]ValueA$32133$$ = 
     0, $CellContext`\[Theta]ValueA$32134$$ = 
     0, $CellContext`showItems$32135$$ = 
     False, $CellContext`showLabels$32136$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`magnitudeA$$ = 
         ...
         Hold[$CellContext`magnitudeA$$, $CellContext`magnitudeA$32132$$, 0], 
         
         Hold[$CellContext`\[Phi]ValueA$$, $CellContext`\[Phi]ValueA$32133$$, 
          0], 
         Hold[$CellContext`\[Theta]ValueA$$, \
$CellContext`\[Theta]ValueA$32134$$, 0], 
         Hold[$CellContext`showItems$$, $CellContext`showItems$32135$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$32136$$, 
          False]}, 
       "OtherVariables" :> {
             ...
             Table[
              Arrow[
               ...
               Tube[{{$CellContext`i, $CellContext`j, $CellContext`k} - 
                 0.15 $CellContext`funcC14F41[$CellContext`i, $CellContext`j, \
$CellContext`k, ($CellContext`magnitudeA$$ Cos[$CellContext`\[Theta]ValueA$$])
...
$CellContext`magnitudeA$$ 
                ...
                3, 2}, {$CellContext`j, -3, 3, 2}, {$CellContext`k, -3, 3, 
               2}]}], 
           Graphics3D[{}]], 
          Graphics3D[{
          ...
          If[$CellContext`showLabels$$, 
           Graphics3D[{
             Text[
             "\!\(\*FormBox[\n StyleBox[\"a\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", (0.8 $CellContext`magnitudeA$$) {
               Cos[$CellContext`\[Theta]ValueA$$] 
                Sin[$CellContext`\[Phi]ValueA$$], 
                Sin[$CellContext`\[Theta]ValueA$$] 
                Sin[$CellContext`\[Phi]ValueA$$], 
             ...
             "\!\(\*FormBox[\n RowBox[{\"\[Del]\", \n  RowBox[{\"\[Cross]\", \
\n   StyleBox[\"F\",\nFontWeight->Bold,\nFontSlant->Plain]}]}],\n \
TraditionalForm]\)", (1.7 $CellContext`magnitudeA$$) {
               Cos[$CellContext`\[Theta]ValueA$$] 
                Sin[$CellContext`\[Phi]ValueA$$], 
                Sin[$CellContext`\[Theta]ValueA$$] 
                Sin[$CellContext`\[Phi]ValueA$$], 
...
$CellContext`zMax$$ + 0.5}}, ImageSize -> 5 {72, 72}, ImagePadding -> None, 
             ...
             Inset[
              Framed[
               Pane[
                ...
                Row[{"\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"a\",\n\
FontWeight->Bold,\nFontSlant->Plain], \"=\", \"\[LeftAngleBracket]\"}],\n \
TraditionalForm]\)", 
...
$CellContext`bcPBS], $CellContext`bcFO, Background -> White], 
       ...
       "Specifications" :> {{{$CellContext`magnitudeA$$, 3^Rational[1, 2], 
           "\!\(\*FormBox[\n RowBox[{\"\[LeftBracketingBar]\", \n  \
StyleBox[\"a\",\nFontWeight->Bold,\nFontSlant->Plain], \
\"\[RightBracketingBar]\"}],\n TraditionalForm]\)"}, 0.1, 3, 0.1, ControlType -> 
...
FontWeight->Bold,\nFontSlant->Plain]],\n TraditionalForm]\)", Larger]}, 0, Pi,
          ...
          2}, {{$CellContext`\[Theta]ValueA$$, Rational[7, 4] Pi, 
           ...
           "\!\(\*FormBox[SubscriptBox[\"\[Theta]\", \n  StyleBox[\"a\",\n\
FontWeight->Bold,\nFontSlant->Plain]],\n TraditionalForm]\)", Larger]}, 0, 2 
          Pi, 0.1, ControlType -> Slider, ImageSize -> Small, 
          ControlPlacement -> 3}, 
         Grid[{{
            Manipulate`Place[1]}, {
            Manipulate`Place[2]}, {
         ...
         Delimiter, {{$CellContext`showItems$$, 2, ""}, {
          1 -> Pane[
            "show vector field", {108, Automatic}, Alignment -> Center], 2 -> 
           Pane["show \!\(\*\nGraphicsBox[\n {GrayLevel[0], \
...
-0.25980762113533157`}}], LineBox[{{0, 0}, {0.3, 0}}]}},\nImageSize->24]\)", {
             108, Automatic}, Alignment -> Center]}, ControlType -> SetterBar,
           Appearance -> "Vertical"}, 
         ...
         Grid[{{
          ...
          None}}, "Options" :> {
        ControlPlacement -> Left, ControlPlacement -> Left, LabelStyle -> 11, 
         Paneled -> False, AppearanceElements -> "ResetButton"}, 
       "DefaultOptions" :> {}],
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[0.8, 0, 0.4], $CellContext`funcC14F41[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.5, Figure 14.41"], "Header"]}, {
   Cell[
    TextData["Section 14.5, Figure 14.41"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 28014, 563, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature RKjG4pwEY1DD2IOG9s3cU@gF *)
