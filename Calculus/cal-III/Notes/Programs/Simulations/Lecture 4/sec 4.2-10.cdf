...
NotebookDataLength[     42131,        956]
NotebookOptionsPosition[      9470,        198]
NotebookOutlinePosition[     42908,        968]
CellTagsIndexPosition[     42865,        965]
WindowTitle->Section 14.2, Figure 14.27
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showField$$ = 1, $CellContext`showGrids$$ =
      False, $CellContext`showLabels$$ = True, $CellContext`xMax$$ = 
     2.5, $CellContext`xMin$$ = -2.5, $CellContext`yMax$$ = 
     2, $CellContext`yMin$$ = -3, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`showField$$], 1, ""}, {
       1 -> Pane[
         "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain], \"=\", \n  RowBox[{\"\[LeftAngleBracket]\", \n   \
RowBox[{\"x\", \",\", \"y\"}], \"\[RightAngleBracket]\"}]}],\n \
TraditionalForm]\) radial field", {144, Automatic}, Alignment -> Center], 2 -> 
        Pane["\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"F\",\nFontWeight->Bold,\
\nFontSlant->Plain], \"=\", \n  RowBox[{\"\[LeftAngleBracket]\", \n   \
RowBox[{\n    RowBox[{\"-\", \"y\"}], \",\", \"x\"}], \
\"\[RightAngleBracket]\"}]}],\n TraditionalForm]\) rotation field", {
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showField$31283$$ = False}, 
     
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showField$$ = 1, $CellContext`showGrids$$ = 
         False, $CellContext`showLabels$$ = True, $CellContext`xMax$$ = 
         2.5, $CellContext`xMin$$ = -2.5, $CellContext`yMax$$ = 
         2, $CellContext`yMin$$ = -3}, "ControllerVariables" :> {
         Hold[$CellContext`showField$$, $CellContext`showField$31283$$, 
          False]}, 
       "OtherVariables" :> {
        Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Switch[$CellContext`showField$$, 1, 
             ...
             Table[
              Arrow[{{
                 ...
                 Sin[$CellContext`i]}, {
                  ...
                  Sin[$CellContext`i]} + {
                  Cos[$CellContext`i], 
                  Sin[$CellContext`i]}}], {$CellContext`i, 0, 2 Pi, Pi/12}]}],
            2, 
           Graphics[{$CellContext`bcR, 
             AbsoluteThickness[1.5], 
             Arrowheads[0.03], 
          ...
          Graphics[{Black, 
            ...
            Arrow[{{
               ...
               Cos[0.25], 
               Sin[0.25]}}], 
            Circle[{0, 0}, 1]}]}, AspectRatio -> 1, AxesStyle -> 
         Arrowheads[0.03], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
...
{$CellContext`yMin$$, $CellContext`yMax$$}}, BaseStyle -> {"Text", 13}, Ticks -> {
         ...
         5 {72, 72}, GridLinesStyle -> LightGray, GridLines -> 
           ...
           If[$CellContext`showLabels$$, 
            Switch[$CellContext`showField$$, 1, 
             Inset[
              Framed[
               Pane[
               "On the unit circle, \!\(\*FormBox[\n RowBox[{\n  StyleBox[\"F\
\",\nFontWeight->Bold,\nFontSlant->Plain], \"=\", \n  RowBox[{\"\
\[LeftAngleBracket]\", \n   RowBox[{\"x\", \",\", \"y\"}], \"\
\[RightAngleBracket]\"}]}],\n TraditionalForm]\) is orthogonal to \
\!\(TraditionalForm\`C\) and has positive outward flux on \!\(TraditionalForm\
\`C\).", {250, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, Background -> 
               White], 
              ImageScaled[{0.5, 0}], 
              ImageScaled[{0.5, 0}]], 2, 
             Inset[
...
\",\nFontWeight->Bold,\nFontSlant->Plain], \"=\", \n  RowBox[{\"\
\[LeftAngleBracket]\", \n   RowBox[{\n    RowBox[{\"-\", \"y\"}], \",\", \
\"x\"}], \"\[RightAngleBracket]\"}]}],\n TraditionalForm]\) is tangent to \
\!\(TraditionalForm\`C\) and has zero outward flux on \
\!\(TraditionalForm\`C\).", {
                250, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
               Background -> White], 
              ImageScaled[{0.5, 0}], 
              ImageScaled[{0.5, 0}]]], Black]}], 
       "Specifications" :> {{{$CellContext`showField$$, 1, ""}, {
          1 -> Pane[
            "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain], \"=\", \n  RowBox[{\"\[LeftAngleBracket]\", \n   \
RowBox[{\"x\", \",\", \"y\"}], \"\[RightAngleBracket]\"}]}],\n \
...
FontWeight->Bold,\nFontSlant->Plain], \"=\", \n  \
RowBox[{\"\[LeftAngleBracket]\", \n   RowBox[{\n    RowBox[{\"-\", \"y\"}], \
\",\", \"x\"}], \"\[RightAngleBracket]\"}]}],\n TraditionalForm]\) rotation \
field", {144, Automatic}, Alignment -> Center]}, ControlType -> SetterBar, 
          Appearance -> "Vertical", ControlPlacement -> 1}, 
         Row[{
           Manipulate`Place[1]}], {{$CellContext`showLabels$$, True, 
           "show labels"}, 0, ControlType -> 
          None}, {{$CellContext`showGrids$$, False, "show grids"}, 0, 
          ControlType -> None}, {{$CellContext`xMin$$, -2.5}, 0, ControlType -> 
     ...
     Initialization:>({$CellContext`bcR = 
        RGBColor[0.8, 0, 0.4], $CellContext`i = 1, $CellContext`bcPBS = 
        BaseStyle -> {
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.2, Figure 14.27"], "Header"]}, {
   Cell[
    TextData["Section 14.2, Figure 14.27"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 8191, 165, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature 9JzU#tREp1WmjK5LwmUl9cRk *)
