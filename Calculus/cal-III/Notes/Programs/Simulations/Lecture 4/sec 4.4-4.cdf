...
NotebookDataLength[     43776,        993]
NotebookOptionsPosition[     11115,        235]
NotebookOutlinePosition[     44553,       1005]
CellTagsIndexPosition[     44510,       1002]
WindowTitle->Section 14.4, Figure 14.34
WindowFrame->Normal*)
...
Cell[BoxData[
 FrameBox[
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`pointXY$$ = {0.5, 
     0.5}, $CellContext`showGrids$$ = False, $CellContext`xMax$$ = 
...
\!\(TraditionalForm\`P\).", {144, Automatic}, 
        ...
        Hold[$CellContext`pointXY$$], {0.5, 0.5}}, {-1.5, -1.5}, {1.5, 1.5}, {
       0.1, 0.1}}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showGrids$31528$$ = 
     False, $CellContext`pointXY$31529$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`pointXY$$ = {0.5, 
          0.5}, $CellContext`showGrids$$ = False, $CellContext`xMax$$ = 
         3, $CellContext`xMin$$ = -3, $CellContext`yMax$$ = 
         3, $CellContext`yMin$$ = -3}, "ControllerVariables" :> {
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$31528$$, 
          False], 
         Hold[$CellContext`pointXY$$, $CellContext`pointXY$31529$$, {0, 0}]}, 
       "OtherVariables" :> {
         ...
         Typeset`initDone$$, Typeset`skipInitDone$$}, "Body" :> Show[{
          Graphics[{
            ...
            Arrow[{{
               ...
               Cos[Pi/3 + 0.1], 
               Sin[Pi/3 + 0.1]}}], 
            Circle[{0, 0}, 1], $CellContext`bcR, 
            Table[
             Arrow[{{
                Cos[$CellContext`i], 
                Sin[$CellContext`i]}, {
                 Cos[$CellContext`i], 
                 Sin[$CellContext`i]} + $CellContext`funcC14F34F[
                 Cos[$CellContext`i], 
             ...
             Circle[$CellContext`pointXY$$, 0.35], 
             Opacity[1], 
             If[$CellContext`funcC14F34GY[
                 Part[$CellContext`pointXY$$, 1], 
                 Part[$CellContext`pointXY$$, 2]] + $CellContext`funcC14F34FX[
                
                 Part[$CellContext`pointXY$$, 1], 
                 Part[$CellContext`pointXY$$, 2]] != 0, 
              Map[
              Circle[$CellContext`pointXY$$, 0.35 + 
                Sign[$CellContext`funcC14F34GY[
                    Part[$CellContext`pointXY$$, 1], 
                    
                    Part[$CellContext`pointXY$$, 
                    2]] + $CellContext`funcC14F34FX[
                    Part[$CellContext`pointXY$$, 1], 
                    Part[$CellContext`pointXY$$, 2]]] #]& , 
               Dynamic[
                Clock[0.15, 2/Abs[$CellContext`funcC14F34GY[
                    Part[$CellContext`pointXY$$, 1], 
              ...
              Which[$CellContext`funcC14F34GY[
                  Part[$CellContext`pointXY$$, 1], 
                  Part[$CellContext`pointXY$$, 2]] + $CellContext`funcC14F34FX[
                  Part[$CellContext`pointXY$$, 1], 
                  Part[$CellContext`pointXY$$, 2]] < 0, {
                Table[
                 Arrow[{$CellContext`pointXY$$ + 0.35 {
                    Cos[$CellContext`i], 
                  ...
                  4}]}, $CellContext`funcC14F34GY[
                  Part[$CellContext`pointXY$$, 1], 
                  Part[$CellContext`pointXY$$, 2]] + $CellContext`funcC14F34FX[
                  Part[$CellContext`pointXY$$, 1], 
                  Part[$CellContext`pointXY$$, 2]] == 
               0, {}, $CellContext`funcC14F34GY[
                  Part[$CellContext`pointXY$$, 1], 
                  Part[$CellContext`pointXY$$, 2]] + $CellContext`funcC14F34FX[
                  Part[$CellContext`pointXY$$, 1], 
                  Part[$CellContext`pointXY$$, 2]] > 0, {
            ...
            "\!\(TraditionalForm\`P\)", $CellContext`pointXY$$, {1.5, 
             1.5}]}]}, AspectRatio -> 1, AxesStyle -> Arrowheads[0.03], 
         AxesLabel -> {
          "\!\(\*\nStyleBox[\"x\",\nFontSlant->\"Italic\"]\)", 
...
{$CellContext`yMin$$, $CellContext`yMax$$}}, BaseStyle -> {"Text", 13}, Ticks -> 
         None, ImageSize -> 5 {72, 72}, GridLinesStyle -> LightGray, 
...
\*SubscriptBox[\(g\), \(y\)] = 2\) on \!\(TraditionalForm\`R\) \
\!\(\(TraditionalForm\`\[DoubleLongRightArrow]\)\) outward flux across \
\!\(TraditionalForm\`C\).", {
              165, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], 
            ImageScaled[{0.99, 0.01}], 
            ImageScaled[{1, 0}]]}], 
       "Specifications" :> {{{$CellContext`showGrids$$, False, 
           "show grids"}, {True, False}, ControlType -> Checkbox}, "", 
         Pane[
...
\`P\).", {144, Automatic}, 
          BaseStyle -> {
           LineIndent -> 0, LinebreakAdjustments -> {1, 1, 0, 0, 0}, 
            LineBreakWithin -> Automatic, Hyphenation -> True, TextAlignment -> 
            Left, FontSize -> 11}], {{$CellContext`pointXY$$, {0.5, 
           0.5}}, {-1.5, -1.5}, {1.5, 1.5}, {0.1, 0.1}, ControlType -> 
     ...
     Initialization:>({{$CellContext`bcR = 
          ...
          0.125 $CellContext`x^2 - 
           0.625 $CellContext`x, $CellContext`funcC14F34GY[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 1, $CellContext`funcC14F34FX[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.4, Figure 14.34"], "Header"]}, {
   Cell[
    TextData["Section 14.4, Figure 14.34"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 9836, 202, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature mJNwQMhajUku2KkFhVj6w0c# *)
