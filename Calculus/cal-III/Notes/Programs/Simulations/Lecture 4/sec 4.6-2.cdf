...
NotebookDataLength[     57636,       1271]
NotebookOptionsPosition[     24974,        513]
NotebookOutlinePosition[     58412,       1283]
CellTagsIndexPosition[     58369,       1280]
WindowTitle->Section 14.6, Figure 14.44
WindowFrame->Normal*)
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
     ...
     Typeset`skipInitDone$$ = False, $CellContext`aValue$32567$$ = 
     0, $CellContext`showLabels$32568$$ = 
     False, $CellContext`showGrids$32569$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 2, $CellContext`showGrids$$ = 
         ...
         Hold[$CellContext`aValue$$, $CellContext`aValue$32567$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$32568$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$32569$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
              ...
              Graphics3D[{
                If[$CellContext`showLabels$$, {
                  Text["\!\(\*\nStyleBox[\"S\",\nFontSlant->\"Italic\"]\)", 
                   $CellContext`funcC14F44[
                    Min[$CellContext`uMin$$, $CellContext`uMax$$], 
                    
                    Max[$CellContext`vMin$$, $CellContext`vMax$$], \
$CellContext`aValue$$], {0, 0}]}, Black], 
                Arrowheads[0.03], Orange, 
                Arrow[
                 Tube[{{0, 0, 0}, 
                   $CellContext`funcC14F44[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$]}]]}], 
              ParametricPlot3D[
               $CellContext`funcC14F44[$CellContext`u, $CellContext`v, \
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F44[
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.44"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.44"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 23695, 480, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature @INUnIpXuFfrGK5sTrdf1Uwy *)
