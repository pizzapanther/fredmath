...
NotebookDataLength[     60308,       1321]
NotebookOptionsPosition[     27646,        563]
NotebookOutlinePosition[     61084,       1333]
CellTagsIndexPosition[     61041,       1330]
WindowTitle->Section 14.6, Figure 14.50
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`aValue$$ = 1.5, $CellContext`showGrids$$ = 
     ...
     Pi, $CellContext`uMin$$ = 0, $CellContext`uValue$$ = Rational[1, 4] 
     Pi, $CellContext`vMax$$ = 2 Pi, $CellContext`vMin$$ = 
     0, $CellContext`vValue$$ = Rational[1, 2] Pi, $CellContext`xMax$$ = 
     4, $CellContext`xMin$$ = -4, $CellContext`yMax$$ = 
     4, $CellContext`yMin$$ = -4, $CellContext`zMax$$ = 
     4, $CellContext`zMin$$ = -4, Typeset`show$$ = True, 
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
     Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
     "\"untitled\"", Typeset`specs$$ = {{{
        Hold[$CellContext`aValue$$], 1.5, 
        "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0.1, 3, 0.01}, {{
        Hold[$CellContext`aValue$$], 1.5, ""}, 0.1, 3, 0.01}, {
       Hold[
        Row[{
          Spacer[{12, 0}], 
          "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)", " = ", 
       ...
       Hold[
        Pane[
        "Drag the \[CircleTimes] symbols to change the region \
\!\(TraditionalForm\`R\).", {144, Automatic}, 
         BaseStyle -> {
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`zMin$$], -4}, 0}, {{
        Hold[$CellContext`zMax$$], 4}, 0}, {{
        ...
        Hold[$CellContext`vValue$$], Rational[1, 2] Pi}, 0}}, 
     Typeset`size$$ = {512., {165.34375, 170.65625}}, Typeset`update$$ = 0, 
     Typeset`initDone$$, Typeset`skipInitDone$$ = 
     False, $CellContext`aValue$33227$$ = 0, $CellContext`showLabels$33228$$ =
      False, $CellContext`showGrids$33229$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`aValue$$ = 1.5, $CellContext`showGrids$$ = 
         ...
         4, $CellContext`xMin$$ = -4, $CellContext`yMax$$ = 
         4, $CellContext`yMin$$ = -4, $CellContext`zMax$$ = 
         4, $CellContext`zMin$$ = -4}, "ControllerVariables" :> {
         Hold[$CellContext`aValue$$, $CellContext`aValue$33227$$, 0], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$33228$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$33229$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`uValue$$, $CellContext`vMax$$}}]}, Black]], Black, 
               ...
               True, ImageSize -> 2.5 72, 
               PlotRange -> {{0, Pi + 1}, {0, 2 Pi + 1}}]}]], 
           Dynamic[
            Show[{
...
$CellContext`vValue$$ <= $CellContext`vMax$$], {
                  ...
                  "\!\(\*\nStyleBox[FormBox[\n  StyleBox[\"n\",\n\
FontWeight->Bold,\nFontSlant->Plain],\n  TraditionalForm],\n\
FontSlant->\"Italic\"]\)", $CellContext`funcC14F50[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$] + 
                   1.2 $CellContext`funcC14F50N[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$], {0, 0}]}, Black], 
                Arrowheads[0.03], Orange, 
                Arrow[
                 Tube[{{0, 0, 0}, 
                   $CellContext`funcC14F50[$CellContext`uValue$$, \
...
$CellContext`vMax$$], 
                 Arrow[
                  Tube[{
                    $CellContext`funcC14F50[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$], \
$CellContext`funcC14F50[$CellContext`uValue$$, $CellContext`vValue$$, \
$CellContext`aValue$$] + $CellContext`funcC14F50N[$CellContext`uValue$$, \
$CellContext`vValue$$, $CellContext`aValue$$]}]], Black]}], 
              ParametricPlot3D[
               $CellContext`funcC14F50[$CellContext`u, $CellContext`v, \
...
TraditionalForm]\)", $CellContext`bcPBS], $CellContext`bcFO, Background -> 
       ...
       "Specifications" :> {{{$CellContext`aValue$$, 1.5, 
           "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)"}, 0.1, 3, 0.01,
           ControlType -> Slider, ImageSize -> 
          Small}, {{$CellContext`aValue$$, 1.5, ""}, 0.1, 3, 0.01, 
         ...
         Row[{
           Spacer[{12, 0}], 
           "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)", " = ", 
           Dynamic[$CellContext`aValue$$]}], Delimiter, 
         Pane[
         "Drag the \[CircleTimes] symbols to change the region \
\!\(TraditionalForm\`R\).", {144, Automatic}, 
          BaseStyle -> {
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
         ...
         Grid[{{
          ...
          None}, {{$CellContext`zMin$$, -4}, 0, ControlType -> 
          None}, {{$CellContext`zMax$$, 4}, 0, ControlType -> 
          ...
          None}, {{$CellContext`vValue$$, Rational[1, 2] Pi}, 0, ControlType -> 
          None}}, "Options" :> {
        ControlPlacement -> Left, LabelStyle -> 11, Paneled -> False, 
         AppearanceElements -> "ResetButton"}, "DefaultOptions" :> {}],
      ImageSizeCache->{683., {183., 189.}},
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F50[
...
$CellContext`v[
            Pattern[$CellContext`t, 
             Blank[]]] := 3 - $CellContext`t/2, $CellContext`funcC14F50N[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]], 
            Pattern[$CellContext`a, 
             Blank[]]] := {($CellContext`a^2 Sin[$CellContext`u]^2) 
            Cos[$CellContext`v], ($CellContext`a^2 Sin[$CellContext`u]^2) 
            Sin[$CellContext`v], ($CellContext`a^2 Sin[$CellContext`u]) 
            Cos[$CellContext`u]}, $CellContext`bcSurfaceTop = 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.50"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.50"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 26367, 530, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature eK4qQt6j#ToZeJ#LsRUOtDIy *)
