...
NotebookDataLength[     42584,        968]
NotebookOptionsPosition[      9923,        210]
NotebookOutlinePosition[     43361,        980]
CellTagsIndexPosition[     43318,        977]
WindowTitle->Section 14.4, Figure 14.31
WindowFrame->Normal*)
...
\!\(TraditionalForm\`P\).", {144, Automatic}, 
       ...
       0.1, 0.1}}, {{
        ...
        Hold[$CellContext`yMax$$], 2.5}, 0}}, Typeset`size$$ = {
     360., {177., 183.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showGrids$31346$$ = 
     False, $CellContext`pointXY$31347$$ = {0, 0}}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      1, StandardForm, 
       "Variables" :> {$CellContext`pointXY$$ = {0.5, 
         ...
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$31346$$, 
          False], 
         Hold[$CellContext`pointXY$$, $CellContext`pointXY$31347$$, {0, 0}]}, 
       "OtherVariables" :> {
          ...
          Graphics[{
            ...
            Table[
             Arrow[{{
                ...
                Sin[$CellContext`i]}, {
                 Cos[$CellContext`i], 
                 Sin[$CellContext`i]} + $CellContext`funcC14F31F[
                 Cos[$CellContext`i], 
                 Sin[$CellContext`i]]}], {$CellContext`i, 0, 2 Pi, Pi/4}], {
             AbsoluteThickness[1], Purple, 
             Arrowheads[0.03], 
             AbsoluteThickness[1.5], 
             Circle[$CellContext`pointXY$$, 0.3], 
             If[$CellContext`funcC14F31GX[
                 Part[$CellContext`pointXY$$, 1], 
                 Part[$CellContext`pointXY$$, 2]] - $CellContext`funcC14F31FY[
               
                Part[$CellContext`pointXY$$, 1], 
                Part[$CellContext`pointXY$$, 2]] != 0, 
              Map[Table[
                Line[{$CellContext`pointXY$$, $CellContext`pointXY$$ + 0.3 {
                    Cos[$CellContext`i + Sign[$CellContext`funcC14F31GX[
                    Part[$CellContext`pointXY$$, 1], 
                    
                    Part[$CellContext`pointXY$$, 
                    2]] - $CellContext`funcC14F31FY[
                    Part[$CellContext`pointXY$$, 1], 
                    Part[$CellContext`pointXY$$, 2]]] #], 
                    Sin[$CellContext`i + Sign[$CellContext`funcC14F31GX[
                    Part[$CellContext`pointXY$$, 1], 
                 ...
                 0, 2 Pi, 2 (Pi/3)}]& , 
               Dynamic[
                Clock[2 Pi, 6 Abs[1/($CellContext`funcC14F31GX[
                    Part[$CellContext`pointXY$$, 1], 
...
RowBox[{\n    RowBox[{\"-\", \"y\"}], \",\", \"x\"}], \
\"\[RightAngleBracket]\"}]}],\n TraditionalForm]\) positive \
(counterclockwise) circulation on \!\(TraditionalForm\`C\).", {
...
\`P\).", {144, Automatic}, 
     ...
     Initialization:>({{$CellContext`bcR = 
          ...
          0.125 $CellContext`x^2 - 
           0.625 $CellContext`x, $CellContext`funcC14F31GX[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := 1, $CellContext`funcC14F31FY[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.4, Figure 14.31"], "Header"]}, {
   Cell[
    TextData["Section 14.4, Figure 14.31"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 8644, 177, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature BKjpsHuyTarobK#gQSculMz5 *)
