...
NotebookDataLength[     66174,       1454]
NotebookOptionsPosition[     33512,        696]
NotebookOutlinePosition[     66950,       1466]
CellTagsIndexPosition[     66907,       1463]
WindowTitle->Section 14.2, Figure 14.19
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = 
     ...
     True, $CellContext`showVectors$$ = {}, $CellContext`tMax$$ = 2 
     Pi, $CellContext`tMin$$ = 0, $CellContext`tValue$$ = Rational[1, 6] 
     Pi, $CellContext`xMax$$ = 
...
FontWeight->Bold,\nFontSlant->Plain]}],\n TraditionalForm]\)"}}, {
       ...
       Hold["location on \!\(\*\nStyleBox[\"C\",\nFontSlant->\"Italic\"]\)"], 
       Manipulate`Dump`ThisIsNotAControl}, {{
        Hold[$CellContext`tValue$$], Rational[1, 6] Pi, ""}, 0, 2 Pi}, {
       Hold[
        Row[{
...
FontSlant->Plain]\) on unit tangent vectors of \!\(TraditionalForm\`C\)", {
       ...
       True, False}}, {{
        ...
        Hold[$CellContext`tMax$$], 2 Pi}, 0}}, Typeset`size$$ = {
     432., {213., 219.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
     Typeset`skipInitDone$$ = False, $CellContext`showItems$30795$$ = 
     False, $CellContext`tValue$30796$$ = 
     0, $CellContext`showVectors$30797$$ = 
     False, $CellContext`showLabels$30798$$ = 
     False, $CellContext`showGrids$30799$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = 
         False, $CellContext`showItems$$ = {2, 3}, $CellContext`showLabels$$ = 
         True, $CellContext`showVectors$$ = {}, $CellContext`tMax$$ = 
         2 Pi, $CellContext`tMin$$ = 0, $CellContext`tValue$$ = 
         Rational[1, 6] Pi, $CellContext`xMax$$ = 
         2, $CellContext`xMin$$ = -2, $CellContext`yMax$$ = 
         2, $CellContext`yMin$$ = -2, $CellContext`zMax$$ = 
         2, $CellContext`zMin$$ = -2}, "ControllerVariables" :> {
         Hold[$CellContext`showItems$$, $CellContext`showItems$30795$$, 
          False], 
         Hold[$CellContext`tValue$$, $CellContext`tValue$30796$$, 0], 
         Hold[$CellContext`showVectors$$, $CellContext`showVectors$30797$$, 
          False], 
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$30798$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$30799$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
          ...
          ParametricPlot3D[
           $CellContext`funcC14F19r[$CellContext`t], {$CellContext`t, 0, 2 
            Pi}, PlotStyle -> {{Black, Thick}}], 
          Graphics3D[{
            Arrowheads[0.03], 
            AbsoluteThickness[1.5], 
            AbsolutePointSize[6], 
            Point[
             $CellContext`funcC14F19r[$CellContext`tValue$$]], 
            If[
             MemberQ[$CellContext`showVectors$$, 1], {$CellContext`bcR, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F19r[$CellContext`i], \
$CellContext`funcC14F19r[$CellContext`i] + $CellContext`funcC14F19f[
                    Part[
                    $CellContext`funcC14F19r[$CellContext`i], 1], 
                    Part[
                    $CellContext`funcC14F19r[$CellContext`i], 2], 
                    Part[
                    $CellContext`funcC14F19r[$CellContext`i], 
                    3]]}]], {$CellContext`i, 0, 2 Pi, Pi/12}]}, Black], 
            If[
             MemberQ[$CellContext`showVectors$$, 2], {$CellContext`bcG, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F19r[$CellContext`i], \
$CellContext`funcC14F19r[$CellContext`i] + Normalize[
                    Derivative[
                    1][$CellContext`funcC14F19r][$CellContext`i]]}]], \
{$CellContext`i, 0, 2 Pi, Pi/12}]}, Black], 
            If[
             MemberQ[$CellContext`showVectors$$, 3], {$CellContext`bcB, 
              Table[
               Arrow[
                Tube[{
                  $CellContext`funcC14F19r[$CellContext`i], \
$CellContext`funcC14F19r[$CellContext`i] + Projection[
                    $CellContext`funcC14F19f[
                    Part[
                    $CellContext`funcC14F19r[$CellContext`i], 1], 
                    Part[
                    $CellContext`funcC14F19r[$CellContext`i], 2], 
                    Part[
                    $CellContext`funcC14F19r[$CellContext`i], 3]], 
                    Derivative[
                    1][$CellContext`funcC14F19r][$CellContext`i]]}]], \
{$CellContext`i, 0, 2 Pi, Pi/12}]}, Black], 
            If[
             MemberQ[$CellContext`showItems$$, 1], {Black, 
              If[$CellContext`showLabels$$, 
               ...
               "\!\(\*FormBox[\n StyleBox[\"r\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", 
                1.2 $CellContext`funcC14F19r[$CellContext`tValue$$]], Black], 
              Orange, 
              Arrow[
               Tube[{{0, 0, 0}, 
                 $CellContext`funcC14F19r[$CellContext`tValue$$]}]]}, Black], 
            ...
            If[
             MemberQ[$CellContext`showItems$$, 2], {Black, 
              If[$CellContext`showLabels$$, 
               ...
               "\!\(\*FormBox[\n StyleBox[\"T\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", \
$CellContext`funcC14F19r[$CellContext`tValue$$] + 1.2 Normalize[
                   Derivative[
                   1][$CellContext`funcC14F19r][$CellContext`tValue$$]]], 
               Black], $CellContext`bcG, 
              Arrow[
               Tube[{
                 $CellContext`funcC14F19r[$CellContext`tValue$$], \
$CellContext`funcC14F19r[$CellContext`tValue$$] + Normalize[
                   Derivative[
                   1][$CellContext`funcC14F19r][$CellContext`tValue$$]]}]]}, 
             Black], 
            If[
             MemberQ[$CellContext`showItems$$, 3], {Black, 
              If[$CellContext`showLabels$$, 
               ...
               "\!\(\*FormBox[\n StyleBox[\"F\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\)", \
$CellContext`funcC14F19r[$CellContext`tValue$$] + 1.2 $CellContext`funcC14F19f[
                   Part[
                    $CellContext`funcC14F19r[$CellContext`tValue$$], 1], 
                   Part[
                    $CellContext`funcC14F19r[$CellContext`tValue$$], 2], 
                   Part[
                    $CellContext`funcC14F19r[$CellContext`tValue$$], 3]]], 
               Black], $CellContext`bcR, 
              Arrow[
               Tube[{
                 $CellContext`funcC14F19r[$CellContext`tValue$$], \
$CellContext`funcC14F19r[$CellContext`tValue$$] + $CellContext`funcC14F19f[
                   Part[
                    $CellContext`funcC14F19r[$CellContext`tValue$$], 1], 
                   Part[
                    $CellContext`funcC14F19r[$CellContext`tValue$$], 2], 
...
StyleBox[\"T\",\nFontWeight->Bold,\nFontSlant->Plain]], \n  StyleBox[\"F\",\n\
FontWeight->Bold,\nFontSlant->Plain]}],\n TraditionalForm]\)", \
$CellContext`funcC14F19r[$CellContext`tValue$$] + 1.2 Projection[
                   $CellContext`funcC14F19f[
                    Part[
                    $CellContext`funcC14F19r[$CellContext`tValue$$], 1], 
                    Part[
              ...
              Arrow[
               Tube[{
                 $CellContext`funcC14F19r[$CellContext`tValue$$], \
$CellContext`funcC14F19r[$CellContext`tValue$$] + Projection[
                   $CellContext`funcC14F19f[
                    Part[
                    $CellContext`funcC14F19r[$CellContext`tValue$$], 1], 
                    Part[
...
$CellContext`zMax$$}}, ImageSize -> 6 {72, 72}, BaseStyle -> {"Text", 13}, 
         Lighting -> "Neutral", Boxed -> False, ViewPoint -> {4, 1, 2}, 
         Epilog -> {
           If[$CellContext`showLabels$$, {
             Inset[
              Framed[
               Graphics[{Black, 
                 Text[
                  Which[Dot[
                    ...
                    Normalize[
                    Derivative[
                    1][$CellContext`funcC14F19r][$CellContext`tValue$$]]] < 0,
                    "\!\(\*FormBox[\n RowBox[{\n  RowBox[{\n   \
             ...
             If[
              ...
              Inset[
               Framed[
                Pane[
                "\!\(\*FormBox[\n StyleBox[\"T\",\nFontWeight->Bold,\n\
FontSlant->Plain],\n TraditionalForm]\) points in the forward or positive \
direction of \!\(TraditionalForm\`C\).", {
                 200, Automatic}, $CellContext`bcPBS], $CellContext`bcFO], 
               ImageScaled[{0.99, 0.01}], 
               ImageScaled[{1, 0}]], Black]}, Black]}], 
       "Specifications" :> {
        "show vectors on \!\(\*\nStyleBox[\"C\",\nFontSlant->\"Italic\"]\)", \
...
FontWeight->Bold,\nFontSlant->Plain]}],\n TraditionalForm]\)"}, ControlType -> 
         ...
         Row[{
           Manipulate`Place[1]}], "", 
         "location on \!\(\*\nStyleBox[\"C\",\nFontSlant->\"Italic\"]\)", \
{{$CellContext`tValue$$, Rational[1, 6] Pi, ""}, 0, 2 Pi, ControlType -> 
          Slider, ImageSize -> Small, ControlPlacement -> 2}, 
         Row[{
           Manipulate`Place[2]}], {{$CellContext`tValue$$, Rational[1, 6] Pi, 
           ""}, 0, 2 Pi, ControlType -> Trigger, 
          AppearanceElements -> {
...
FontSlant->Plain]\) on unit tangent vectors of \!\(TraditionalForm\`C\)", {
         ...
         Delimiter, {{$CellContext`showLabels$$, True, "show labels"}, {
          ...
          None}, {{$CellContext`tMax$$, 2 Pi}, 0, ControlType -> None}}, 
       "Options" :> {
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          1, $CellContext`funcC14F19r[
            Pattern[$CellContext`t, 
             Blank[]]] := {
           1.1 Cos[$CellContext`t], 1.3 
            Sin[$CellContext`t], (0.5 Cos[$CellContext`t]) 
            Sin[2 $CellContext`t]}, $CellContext`t[
            Pattern[$CellContext`df, 
             Blank[]]] := PDF[
            
            StudentTDistribution[$CellContext`df], $CellContext`x], \
$CellContext`bcR = RGBColor[0.8, 0, 0.4], $CellContext`funcC14F19f[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]], 
            Pattern[$CellContext`z, 
             Blank[]]] := 0.8 {1, -1, 1/2}, $CellContext`bcG = 
          RGBColor[0, 0.6, 0.4], 
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.2, Figure 14.19"], "Header"]}, {
   Cell[
    TextData["Section 14.2, Figure 14.19"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 32233, 663, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature ZJj@p7GoFBj6iLkjxGtxijJF *)
