...
NotebookDataLength[     57984,       1281]
NotebookOptionsPosition[     25322,        523]
NotebookOutlinePosition[     58760,       1293]
CellTagsIndexPosition[     58717,       1290]
WindowTitle->Section 14.6, Figure 14.43
WindowFrame->Normal*)
  ...
  TagBox[
   StyleBox[
    DynamicModuleBox[{$CellContext`showGrids$$ = 
     ...
     1.5, $CellContext`uMin$$ = -1, $CellContext`uValue$$ = 
     1, $CellContext`vMax$$ = 
     1.5, $CellContext`vMin$$ = -1, $CellContext`vValue$$ = 
     1, $CellContext`xMax$$ = 
     6, $CellContext`xMin$$ = -4, $CellContext`yMax$$ = 
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
       ...
       Manipulate`Dump`ThisIsNotAControl}, {{
        ...
        Hold[$CellContext`uMax$$], 1.5}, 0}, {{
        Hold[$CellContext`vMin$$], -1}, 0}, {{
        Hold[$CellContext`vMax$$], 1.5}, 0}, {{
     ...
     Typeset`skipInitDone$$ = False, $CellContext`showLabels$32488$$ = 
     False, $CellContext`showGrids$32489$$ = False}, 
     DynamicBox[Manipulate`ManipulateBoxes[
      2, StandardForm, 
       "Variables" :> {$CellContext`showGrids$$ = 
         ...
         Hold[$CellContext`showLabels$$, $CellContext`showLabels$32488$$, 
          False], 
         Hold[$CellContext`showGrids$$, $CellContext`showGrids$32489$$, 
          False]}, 
       "OtherVariables" :> {
...
{$CellContext`uValue$$, $CellContext`vMax$$}}]}, Black]], 
                If[$CellContext`showLabels$$, 
                 Dynamic[{Black, 
                   Text[
                   "\!\(\*\nStyleBox[\"a\",\nFontSlant->\"Italic\"]\)", {
                    Min[$CellContext`uMin$$, $CellContext`uMax$$], 0}, {1.2, 
                    1.5}], 
                   Text[
                   "\!\(\*\nStyleBox[\"b\",\nFontSlant->\"Italic\"]\)", {
                    Max[$CellContext`uMin$$, $CellContext`uMax$$], 0}, {-1.2, 
                    1.5}], 
                   Text[
                   "\!\(\*\nStyleBox[\"c\",\nFontSlant->\"Italic\"]\)", {0, 
                    Min[$CellContext`vMin$$, $CellContext`vMax$$]}, {1.5, 
                    1.2}], 
                   Text[
                   "\!\(\*\nStyleBox[\"d\",\nFontSlant->\"Italic\"]\)", {0, 
                    Max[$CellContext`vMin$$, $CellContext`vMax$$]}, {
                    1.5, -1.2}], 
                   Text[
                   "\!\(\*\nStyleBox[\"R\",\nFontSlant->\"Italic\"]\)", {
               ...
               BaseStyle -> {"Text", 13}, AspectRatio -> 1, Ticks -> None, 
               AxesStyle -> Arrowheads[0.05], 
               AxesLabel -> {
                "\!\(\*\nStyleBox[\"u\",\nFontSlant->\"Italic\"]\)", 
                 "\!\(\*\nStyleBox[\"v\",\nFontSlant->\"Italic\"]\)"}, Axes -> 
               True, ImageSize -> 2.5 72, PlotRange -> {{-2, 2}, {-2, 2}}]}]], 
           Dynamic[
            Show[{
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
              ...
              Graphics3D[{
                If[$CellContext`showLabels$$, {
                  Text["\!\(\*\nStyleBox[\"S\",\nFontSlant->\"Italic\"]\)", 
                   $CellContext`funcC14F43[
                    Min[$CellContext`uMin$$, $CellContext`uMax$$], 
                    Max[$CellContext`vMin$$, $CellContext`vMax$$]], {0, 0}]}, 
                 Black], 
                Arrowheads[0.03], Orange, 
                Arrow[
                 Tube[{{0, 0, 0}, 
                   $CellContext`funcC14F43[$CellContext`uValue$$, \
$CellContext`vValue$$]}]]}], 
              ParametricPlot3D[
               $CellContext`funcC14F43[$CellContext`u, $CellContext`v], \
{$CellContext`u, $CellContext`uMin$$, $CellContext`uMax$$}, {$CellContext`v, \
$CellContext`vMin$$, $CellContext`vMax$$}, 
...
$CellContext`bcPBS], 
                 ...
                 Inset[
                  Framed[
                   ...
                   "A rectangle in \!\(\*\nStyleBox[\"uv\",\n\
FontSlant->\"Italic\"]\)\!\(\*\nStyleBox[\"\[Hyphen]\",\n\
FontSlant->\"Italic\"]\)plane is mapped to a surface in \
\!\(TraditionalForm\`x\[VeryThinSpace]y\[VeryThinSpace]z\)\!\(\*\nStyleBox[\"\
\[Hyphen]\",\nFontSlant->\"Italic\"]\)space.", {
...
\!\(TraditionalForm\`\((u, v)\)\).", {144, Automatic}, 
         ...
         Grid[{{
          ...
          None}, {{$CellContext`uMax$$, 1.5}, 0, ControlType -> 
          None}, {{$CellContext`vMin$$, -1}, 0, ControlType -> 
          None}, {{$CellContext`vMax$$, 1.5}, 0, ControlType -> 
...
$CellContext`PlaneOpacity, $CellContext`PlaneGrids}, {$CellContext`opts}], 
          ...
          RGBColor[
           0.5306666666666667, 0.6066666666666667, 
            0.5700000000000001], $CellContext`i = 1, $CellContext`funcC14F43[
            Pattern[$CellContext`u, 
             Blank[]], 
            Pattern[$CellContext`v, 
             Blank[]]] := {
           0.3 $CellContext`v^2 + 1.5 $CellContext`u, 0.2 $CellContext`u^2 + 
            2 $CellContext`v, 3 - 0.3 ($CellContext`u + 0.5)^2 - 
            0.2 $CellContext`v^2}, $CellContext`u[
...
PageHeaders->{{
   ...
   Cell[
    TextData["Section 14.6, Figure 14.43"], "Header"]}, {
   Cell[
    TextData["Section 14.6, Figure 14.43"], "Header"], "", 
   Cell[
    TextData[
...
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 24043, 490, 70, "Output"]
}
]
*)

(* End of internal cache information *)
(* NotebookSignature ZLN0VWTzLkTAMJktABWiknIo *)
