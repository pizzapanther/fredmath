...
NotebookDataLength[     37082,        782]
NotebookOptionsPosition[     24618,        518]
NotebookOutlinePosition[     37175,        784]
CellTagsIndexPosition[     37132,        781]
WindowTitle->Section 12.9, Figure 12.107
WindowFrame->Normal*)
...
TraditionalForm]\)"}, {True, False}}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`tValue$$], 3.3, 
       "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -0.5, 4.8}, {{
       Hold[$CellContext`tValue$$], 3.3, ""}, -0.5, 4.8}, {{
    ...
    Typeset`skipInitDone$$ = False, $CellContext`showAcceleration$192457$$ = 
    False, $CellContext`showTangent$192458$$ = 
    False, $CellContext`showNormal$192459$$ = 
    False, $CellContext`tValue$192460$$ = 0, $CellContext`showGrids$192461$$ =
     False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`showAcceleration$$ = 
        ...
        True, $CellContext`showTangent$$ = True, $CellContext`tMax$$ = 
        5, $CellContext`tMin$$ = -1, $CellContext`tValue$$ = 
        3.3, $CellContext`xMax$$ = 
        5, $CellContext`xMin$$ = -2, $CellContext`yMax$$ = 
        5, $CellContext`yMin$$ = -2, $CellContext`zMax$$ = 
        5, $CellContext`zMin$$ = -1}, "ControllerVariables" :> {
        Hold[$CellContext`showAcceleration$$, \
$CellContext`showAcceleration$192457$$, False], 
        Hold[$CellContext`showTangent$$, $CellContext`showTangent$192458$$, 
         False], 
        Hold[$CellContext`showNormal$$, $CellContext`showNormal$192459$$, 
         False], 
        Hold[$CellContext`tValue$$, $CellContext`tValue$192460$$, 0], 
        Hold[$CellContext`showGrids$$, $CellContext`showGrids$192461$$, 
         False]}, 
      "OtherVariables" :> {
...
{$CellContext`xMax$$, 0, 0}, {2, 0}], 
         ...
         Graphics3D[{
           ...
           If[$CellContext`showTangent$$, {$CellContext`bcR, 
             Arrow[
              Tube[{
                $CellContext`funcLTC12F107[$CellContext`tValue$$], \
$CellContext`funcLTC12F107[$CellContext`tValue$$] + Dot[
                   Derivative[
                   2][$CellContext`funcLTC12F107][$CellContext`tValue$$], 
                   Normalize[
                    Derivative[
                    1][$CellContext`funcLTC12F107][$CellContext`tValue$$]]] 
                 Normalize[
                   Derivative[
                   1][$CellContext`funcLTC12F107][$CellContext`tValue$$]]}, 
               0.03]], Black, 
             ...
             "\!\(\*FormBox[\n RowBox[{SubscriptBox[\"a\", \"T\"], \n  \
StyleBox[\"T\",\nFontWeight->\"Bold\",\nFontSlant->\"Plain\"]}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F107[$CellContext`tValue$$] + (1.2 
                Dot[
                  Derivative[
                  2][$CellContext`funcLTC12F107][$CellContext`tValue$$], 
                  Normalize[
               ...
               Normalize[
                 Derivative[
                 1][$CellContext`funcLTC12F107][$CellContext`tValue$$]], {0, 
              0}]}, Black], 
...
$CellContext`funcLTC12F107[$CellContext`tValue$$] + Dot[
                   ...
                   Normalize[
                    ReplaceAll[
                    D[D[
                    $CellContext`funcLTC12F107[$CellContext`t], \
$CellContext`t]/Dot[
                    D[
                    $CellContext`funcLTC12F107[$CellContext`t], \
$CellContext`t], 
...
$CellContext`funcLTC12F107[$CellContext`tValue$$] + 
              1.2 Derivative[
                2][$CellContext`funcLTC12F107][$CellContext`tValue$$], {0, 
              0}]}, Black], Black, 
           Point[
            $CellContext`funcLTC12F107[$CellContext`tValue$$]], 
           Text[
            Framed[
             Pane[
             "Trajectory in \!\(\*FormBox[SuperscriptBox[\n  StyleBox[\"R\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"3\"],\n TraditionalForm]\)", {
              Automatic, Automatic}, $CellContext`bcPBS], $CellContext`bcFO, 
             Background -> White], {0, 0, $CellContext`zMax$$}, {0, 1}], 
           Text[
            Framed[
             Pane[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"a\",\n\
...
TraditionalForm]\)", {
         ...
         ParametricPlot3D[
          $CellContext`funcLTC12F107[$CellContext`t], {$CellContext`t, \
...
StyleBox[\"N\",\nFontWeight->\"Bold\",\nFontSlant->\"Plain\"]}],\n \
TraditionalForm]\)"}, {True, False}, ControlType -> Checkbox}, "", 
        Delimiter, {{$CellContext`tValue$$, 3.3, 
          "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, -0.5, 4.8, 
         ControlType -> Slider, ImageSize -> 
         Small}, {{$CellContext`tValue$$, 3.3, ""}, -0.5, 4.8, ControlType -> 
        ...
        Row[{
          Manipulate`Place[1]}], {{$CellContext`xMin$$, -2}, 0, ControlType -> 
      ...
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, AppearanceElements -> 
        ...
        Style["FIGURE 12.107", "FigureFont", Smaller]}, 
      "DefaultOptions" :> {}],
     ImageSizeCache->{649., {253., 258.}},
...
$CellContext`PlaneGrids}, {$CellContext`opts}], 
         ...
         RGBColor[0.8, 0, 0.4], $CellContext`funcLTC12F107[
...
(*NotebookFileOutline
Notebook[{
Cell[593, 21, 24021, 495, 528, "Output"]
}
]
*)
...
(* NotebookSignature YJz9W3bRhE0XNK#AES41qEuD *)
