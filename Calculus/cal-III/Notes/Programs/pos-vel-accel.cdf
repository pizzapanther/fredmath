...
NotebookDataLength[     21916,        465]
NotebookOptionsPosition[      9507,        203]
NotebookOutlinePosition[     22010,        467]
CellTagsIndexPosition[     21967,        464]
WindowTitle->Section 12.7, Figure 12.82
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`showAcceleration$$ = 
    True, $CellContext`showPosition$$ = True, $CellContext`showVelocity$$ = 
    True, $CellContext`tMax$$ = 3, $CellContext`tMin$$ = 
    0, $CellContext`tValue$$ = 0., $CellContext`xMax$$ = 
    8, $CellContext`xMin$$ = -1, $CellContext`yMax$$ = 
    7, $CellContext`yMin$$ = -1, Typeset`show$$ = True, 
    ...
    "\"untitled\"", Typeset`specs$$ = {{{
      ...
      True, False}}, {{
       Hold[$CellContext`showAcceleration$$], True, "show acceleration"}, {
      True, False}}, {
      Hold[
       Grid[{{
          Manipulate`Place[1]}, {
      ...
      Manipulate`Dump`ThisIsNotAControl}, {{
       ...
       "\!\(\*\nStyleBox[\"t\",\nFontSlant->\"Italic\"]\)"}, 0, 3, 0.01}, {{
       Hold[$CellContext`tValue$$], 0, ""}, 0, 3, 0.01}, {
      Hold[
       Grid[{{
       ...
       Hold[$CellContext`xMax$$], 8}, 0}, {{
       Hold[$CellContext`yMin$$], -1}, 0}, {{
       Hold[$CellContext`yMax$$], 7}, 0}, {{
       Hold[$CellContext`tMin$$], 0}, 0}, {{
       Hold[$CellContext`tMax$$], 3}, 0}}, Typeset`size$$ = {
    288., {129., 135.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`showPosition$190963$$ = 
    False, $CellContext`showVelocity$190964$$ = 
    False, $CellContext`showAcceleration$190965$$ = 
    False, $CellContext`tValue$190966$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`showAcceleration$$ = 
        ...
        0, $CellContext`tValue$$ = 0, $CellContext`xMax$$ = 
        8, $CellContext`xMin$$ = -1, $CellContext`yMax$$ = 
        7, $CellContext`yMin$$ = -1}, "ControllerVariables" :> {
        Hold[$CellContext`showPosition$$, $CellContext`showPosition$190963$$, 
         False], 
        Hold[$CellContext`showVelocity$$, $CellContext`showVelocity$190964$$, 
         False], 
        Hold[$CellContext`showAcceleration$$, \
$CellContext`showAcceleration$190965$$, False], 
        Hold[$CellContext`tValue$$, $CellContext`tValue$190966$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Graphics[{
           ...
           AbsolutePointSize[7], 
           Point[
            $CellContext`funcLTC12F82[$CellContext`tValue$$]], 
           If[$CellContext`showPosition$$, {$CellContext`bcB, 
             Arrow[{{0, 0}, 
               $CellContext`funcLTC12F82[$CellContext`tValue$$]}], Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"r\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F82[$CellContext`tValue$$]/
              2, {-2.5, 0}]}, Black], 
...
$CellContext`funcLTC12F82[$CellContext`tValue$$] + 
               Derivative[
                1][$CellContext`funcLTC12F82][$CellContext`tValue$$]}], Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"v\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F82[$CellContext`tValue$$] + 
              Derivative[
               1][$CellContext`funcLTC12F82][$CellContext`tValue$$], {-1.5, \
-1}]}, Black], 
...
$CellContext`funcLTC12F82[$CellContext`tValue$$] + 
               Derivative[
                2][$CellContext`funcLTC12F82][$CellContext`tValue$$]}], Black, 
             Text[
             "\!\(\*FormBox[\n RowBox[{\n  StyleBox[\"a\",\n\
FontWeight->\"Bold\",\nFontSlant->\"Plain\"], \"(\", \"t\", \")\"}],\n \
TraditionalForm]\)", $CellContext`funcLTC12F82[$CellContext`tValue$$] + 
              Derivative[
               2][$CellContext`funcLTC12F82][$CellContext`tValue$$], {0, 2}]},
             Black]}], 
         ParametricPlot[
          $CellContext`funcLTC12F82[$CellContext`t], {$CellContext`t, \
$CellContext`tMin$$, $CellContext`tMax$$}, PlotStyle -> {{Thick, Black}}]}, 
        PlotRange -> {{$CellContext`xMin$$, $CellContext`xMax$$}, \
{$CellContext`yMin$$, $CellContext`yMax$$}}, AxesOrigin -> {0, 0}, Axes -> 
        True, Ticks -> {
          Range[0, 8], 
          Range[0, 8, 2]}, AspectRatio -> Automatic, ImageSize -> 4 72, 
      ...
      "Specifications" :> {{{$CellContext`showPosition$$, True, 
         ...
         2}, {{$CellContext`showAcceleration$$, True, "show acceleration"}, {
        ...
        Delimiter, {{$CellContext`tValue$$, 0, 
         ...
         4}, {{$CellContext`tValue$$, 0, ""}, 0, 3, 0.01, ControlType -> 
        ...
        Grid[{{
           ...
           Grid[{{"\!\(\*FormBox[\"t\",\n TraditionalForm]\)", 
              ...
              Dynamic[
               Round[$CellContext`tValue$$, 0.01]]}}, 
            Alignment -> {{Right, Center, Left}, Automatic}]}}, Alignment -> 
         Left], {{$CellContext`xMin$$, -1}, 0, ControlType -> 
         None}, {{$CellContext`xMax$$, 8}, 0, ControlType -> 
         None}, {{$CellContext`yMin$$, -1}, 0, ControlType -> 
         None}, {{$CellContext`yMax$$, 7}, 0, ControlType -> 
         None}, {{$CellContext`tMin$$, 0}, 0, ControlType -> 
         None}, {{$CellContext`tMax$$, 3}, 0, ControlType -> None}}, 
      "Options" :> {
       ControlPlacement -> Left, LabelStyle -> 11, Deployed -> True, 
        AppearanceElements -> "ResetButton", FrameLabel -> 
        Style["FIGURE 12.82", "FigureFont", Smaller]}, "DefaultOptions" :> {}],
     ImageSizeCache->{455., {169., 174.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>({{$CellContext`funcLTC12F82[
           Pattern[$CellContext`t, 
            Blank[]]] := {
          7 - $CellContext`t^2, $CellContext`t + 3}, $CellContext`t[
...
(*NotebookFileOutline
Notebook[{
Cell[592, 21, 8911, 180, 360, "Output"]
}
]
*)
...
(* NotebookSignature TJNYNJW#Y245dK5ErN#LixHZ *)
